...
public final class BirtReportParameters {
     ...
     */
    public static Object convertTo(final IScalarParameterDefn definition, final Object parameterValue)
            throws ReportException {
        final Object result;
    ...
    private static Object convertStringTo(final IScalarParameterDefn definition, final String parameterValue)
            throws ReportException {
        final Object result;
    ...
    private static Date convertStringToDate(final String format, final String value) throws ReportException {
        ...
        try {
            ...
            throw new ReportException("Datum '" + value + "' is niet volgens opmaak '" + format + "'.");
        }
    }
    ...
    private static Object convertStringToInteger(final String value) throws ReportException {
        try {
            ...
            throw new ReportException("Nummer '" + value + "' is niet een nummer.");
        }
    }
}
