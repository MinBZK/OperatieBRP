...
public class MaakVerhuizingGeluktAntwoordActionTest {
    private final MaakVerhuizingGeluktAntwoordAction subject = new MaakVerhuizingGeluktAntwoordAction();
    ...
    public void test() {
        ...
        Assert.assertEquals(StatusType.OK, verhuizingAntwoord.getStatus());
    }
}
