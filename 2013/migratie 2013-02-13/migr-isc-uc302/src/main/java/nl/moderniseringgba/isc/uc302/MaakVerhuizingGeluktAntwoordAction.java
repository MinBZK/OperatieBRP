 ...
 */
@Component("uc302MaakVerhuizingGeluktAntwoordAction")
public final class MaakVerhuizingGeluktAntwoordAction implements SpringAction {
    ...
    public Map<String, Object> execute(final Map<String, Object> parameters) {
        ...
        verhuizingAntwoord.setStatus(StatusType.OK);
