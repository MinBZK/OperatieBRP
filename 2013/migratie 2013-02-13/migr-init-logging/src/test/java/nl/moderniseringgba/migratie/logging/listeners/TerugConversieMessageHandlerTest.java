...
public class TerugConversieMessageHandlerTest {

    private static final String QUERY_RESPONSE_BERICHT_FORMAT =
            "<queryResponse xmlns=\"http://www.moderniseringgba.nl/SYNC/0001\"><status>Ok</status><lo3Pl>%s</lo3Pl></queryResponse>";
    ...
    public void sendAndDiffTest() {
        ...
        final String lg01Bericht = service.findLog(Long.valueOf(3832803548L)).getLo3Bericht();
        final String messageId = "3832803548";
        jmsTemplate.send(initVullingNaarLo3Queue, new MessageCreator() {
            @Override
            public Message createMessage(final Session session) throws JMSException {
                final Message message =
                        session.createTextMessage(String.format(QUERY_RESPONSE_BERICHT_FORMAT, lg01Bericht));
