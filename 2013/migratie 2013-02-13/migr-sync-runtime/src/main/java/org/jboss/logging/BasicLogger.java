...
/**
 * An interface which specifies the basic logger methods. When used as the base interface of a typed logger, these
 * methods will delegate to the corresponding underlying logger instance.
 * 
