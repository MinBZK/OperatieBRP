...
public class Casus08aNationaliteitTest extends CasusTest {

    private final List<Lo3Categorie<Lo3NationaliteitInhoud>> categorieen =
            new ArrayList<Lo3Categorie<Lo3NationaliteitInhoud>>();

    private final BrpNationaliteitInhoud brpNederlands = new BrpNationaliteitInhoud(new BrpNationaliteitCode(
...

    {
        ...
        lo1.vul(lo3Nederlands, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));

        // verwachte BRP output
        brp1.vul(brpNederlands, 19900101, 19900101, 19900102000000L, 19900102000000L, actie1, actie2, actie1);
        // @formatter:on
