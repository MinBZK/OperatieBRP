...
public class Casus38aNationaliteitTest extends CasusTest {
    ...
    private final BrpNationaliteitInhoud brpNederlands001033 = new BrpNationaliteitInhoud(new BrpNationaliteitCode(
    ...
    private final BrpNationaliteitInhoud brpNederlands002 = new BrpNationaliteitInhoud(new BrpNationaliteitCode(
            Integer.valueOf("0001")), new BrpRedenVerkrijgingNederlandschapCode(new BigDecimal("002")), null);
...

    {
        ...
        lo1.vul(lo3Nederlands001, null,    20000101, 20000102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 2));
        ...
        brp1.vul(brpNederlands002,    20040101, null,     20040103000000L, null,            actie3, null,   null);
        brp2.vul(brpNederlands001,    20000101, 20040101, 20000102000000L, null,            actie1, null,   null);
        brp3.vul(brpNederlands001033, 20000101, 20040101, 20000102000100L, 20000102000100L, actie1, actie2, actie1);
        // @formatter:on
