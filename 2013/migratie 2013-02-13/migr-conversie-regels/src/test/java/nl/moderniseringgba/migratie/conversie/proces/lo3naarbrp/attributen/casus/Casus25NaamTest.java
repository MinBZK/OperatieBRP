...
public class Casus25NaamTest extends CasusTest {
    ...
    private final BrpSamengesteldeNaamInhoud brpInhoudDickJansen = new BrpSamengesteldeNaamInhoud(null, "Dick", null,
            null, null, "Jansen", false, true);
    private final BrpSamengesteldeNaamInhoud brpInhoudAbJansen = new BrpSamengesteldeNaamInhoud(null, "Ab", null,
            null, null, "Jansen", false, true);
...

    {
        ...
        final BrpActie actie5 = buildBrpActie(BrpDatumTijd.fromDatum(19970102), "A5");
        final BrpActie actie4 = buildBrpActie(BrpDatumTijd.fromDatum(19960102), "A4");
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(19950102), "A3");
        final BrpActie actie2 = buildBrpActie(BrpDatumTijd.fromDatum(19940102), "A2");
        final BrpActie actie1 = buildBrpActie(BrpDatumTijd.fromDatum(19930102), "A1");
        ...
        lo5.vul(lo3AbJansen,   null,    19910101, 19970102, 5, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 4));
        ...
        brpKasJansen. vul(brpInhoudAbJansen,   19910101, 19920101, 19970102000000L, null,            actie5, null, null);
        brpDickJansen.vul(brpInhoudDickJansen, 19950101, null,     19960102000000L, null,            actie4, null, null);
