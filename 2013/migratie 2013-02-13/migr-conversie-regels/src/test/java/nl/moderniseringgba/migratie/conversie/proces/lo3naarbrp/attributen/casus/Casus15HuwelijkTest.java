...
public class Casus15HuwelijkTest extends CasusTest {
...

    {
        ...
        lo3.vul(buildHuwelijk(19940101, rotterdam, null,      null),    ONJUIST, 19940101, 19940103, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_05, 0, 2));
        ...
        // 1-1-1994, Rotterdam 2-1-1994, Utrecht   4-1-1994    4-1-1994    <A4>    <A4>
        // 1-1-1994, Rotterdam Xxxxxxxxxxxxxxxx    3-1-1994    3-1-1994    <A3>    <A3>
        // 1-1-1990, Den Haag  1-1-1994, Utrecht   2-1-1994    2-1-1994    <A2>    <A2>
        // 1-1-1990, Den Haag  xxxxxxxxxxxxxxxx    2-1-1990    2-1-1994    <A1>    <A5>

        // verwachte BRP output
        brp1.vulHuwelijk(19940101, rotterdam, 19940102, utrecht, 19940104000000L, 19950102000000L, actie4, actie5);
        brp2.vulHuwelijk(19940101, rotterdam, null,     null,    19940103000000L, 19940103000000L, actie3, actie3);
        brp3.vulHuwelijk(19900101, denhaag,   19940101, utrecht, 19940102000000L, 19940102000000L, actie2, actie2);
        brp4.vulHuwelijk(19900101, denhaag,   null,     null,    19900102000000L, 19950102000000L, actie1, actie5);
