...
public class Casus42OmzettenPartnerschapTest extends CasusTest {
...

    {
        ...
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(19900203), "A3", "PL - Verbintenis stapel 1"); // omzetting-1
        // final BrpActie actie2 = buildBrpActie(new BrpDatumTijd(19800211), "A2", "PL - Verbintenis stapel 1"); // pl
        // gerelateerde
        ...
        lo3.vul(buildHuwelijk(19900201, rotterdam, null,     null,      P), null, 19900201, 19900203, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_05, 0, 1));
        lo2.vul(buildHuwelijk(19800201, denhaag,   null,     null,      H), null, 19800211, 19800211, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_05, 0, 2));
        ...
        brp1.vulHuwelijk(19900201, rotterdam, 19950103, rotterdam, 19950104000000L, null,            actie4, null);
        brp2.vulHuwelijk(19900201, rotterdam, null,     null,      19900203000000L, 19950104000000L, actie3, null);
        ...
        brp3.vulHuwelijk(19800201, denhaag, 19900201, rotterdam, "Z",  19900203000000L, null,            actie3, null);
        //brp4.vulHuwelijk(19800201, denhaag, null,     null,      null, 19800211000000L, 19900203000000L, actie2, null);
        brp5.vulHuwelijk(19800201, denhaag, null,     null,      null, 19800202000000L, 19900203000000L, actie1, null);
