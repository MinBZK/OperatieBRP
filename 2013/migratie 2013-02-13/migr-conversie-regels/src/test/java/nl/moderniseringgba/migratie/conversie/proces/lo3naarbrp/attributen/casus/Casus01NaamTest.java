...
public class Casus01NaamTest extends CasusTest {
...

    {
        ...
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(19950110), "A3");

        // @formatter:off
        // LO3 input
        lo3.vul(lo3Klaas, null,    19950101, 19950110, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 2));
        ...
        brp1.vul(brpPiet,  19950101, null,     19950102000000L, 19950102000000L, actie2, null, actie2);
        brp2.vul(brpKlaas, 19950101, null,     19950110000000L, null,            actie3, null, null);
        brp3.vul(brpJan,   19900101, 19950101, 19900102000000L, null,            actie1, null, null);
        // @formatter:on
