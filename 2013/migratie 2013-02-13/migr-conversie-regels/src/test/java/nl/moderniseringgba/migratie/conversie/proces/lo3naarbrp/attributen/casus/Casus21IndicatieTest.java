...
public class Casus21IndicatieTest extends CasusTest {
    ...
    private final BrpTestObject<BrpBehandeldAlsNederlanderIndicatieInhoud> brp3 =
            new BrpTestObject<BrpBehandeldAlsNederlanderIndicatieInhoud>();
    private final BrpTestObject<BrpBehandeldAlsNederlanderIndicatieInhoud> brp4 =
            new BrpTestObject<BrpBehandeldAlsNederlanderIndicatieInhoud>();

    {
        ...
        final BrpActie actie2 = buildBrpActie(BrpDatumTijd.fromDatum(19900103), "A2");
        ...
        lo3.vul(lo3Leeg,       ONJUIST, 19950101, 19950102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 1));
        lo2.vul(lo3BijzonderNl, null,    19890101, 19900103, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 2));
        lo1.vul(lo3BijzonderNl, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 3));
        ...
        brp1.vul(brpBehandeldAlsNl, 19950101, null,     19950103000000L, null,            actie4, null,   null);
        brp2.vul(brpBehandeldAlsNl, 19890101, 19950101, 19900103000000L, null,            actie2, null,   null);
        brp3.vul(brpBehandeldAlsNl, 19890101, 19950101, 19900103000100L, 19900103000100L, actie2, actie3, actie2);
        brp4.vul(brpBehandeldAlsNl, 19900101, null,     19900102000000L, 19900102000000L, actie1, null,   actie1);
        // @formatter:on
    ...
    public void testLo3NaarBrp() throws Exception {
        ...
        System.out.println(indicatieStapel.get(3));
        // aanvang=1990
        assertBehandeldAlsNederlander(indicatieStapel.get(0), brp4);
        // aanvang=1989
        assertBehandeldAlsNederlander(indicatieStapel.get(1), brp2);
        // aanvang=1989, vervallen
        assertBehandeldAlsNederlander(indicatieStapel.get(2), brp3);
        // aanvang=1995
        assertBehandeldAlsNederlander(indicatieStapel.get(3), brp1);
    }
