...
public class Lo3Ouder1PrecondtiesTest extends AbstractLo3OuderPreconditiesTest {

    private static final Lo3Herkomst LO3_HERKOMST_OUDER1 = new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_02, 0, 0);

    @Inject
    private Lo3Ouder1Precondities preconditiesOuder1;

    @Override
    public Lo3OuderPrecondities getPrecondities() {
        return preconditiesOuder1;
    }
    ...
    public void testHappy() {
        final Lo3Stapel<Lo3OuderInhoud> stapel =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(builder().build(), Lo3StapelHelper.lo3His(20000101),
                        Lo3StapelHelper.lo3Akt(1), LO3_HERKOMST_OUDER1));
    ...
    public void testContr104() {
        ...
        final Lo3Categorie<Lo3OuderInhoud> onjuist2 =
                Lo3StapelHelper.lo3Cat(builder().build(), Lo3StapelHelper.lo3His("O", 19990101, 20000101),
                        Lo3StapelHelper.lo3Akt(2), LO3_HERKOMST_OUDER1);
        final Lo3Categorie<Lo3OuderInhoud> juist3 =
                Lo3StapelHelper.lo3Cat(builder().build(), Lo3StapelHelper.lo3His(null, 19990101, 20000101),
                        Lo3StapelHelper.lo3Akt(3), LO3_HERKOMST_OUDER1);
    ...
    public void testContr112() {
        final Lo3Stapel<Lo3OuderInhoud> stapel2 =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(builder().build(), Lo3StapelHelper.lo3His(20000101),
                        Lo3StapelHelper.lo3Doc(1L, "0514", 00000000, "Doc"), LO3_HERKOMST_OUDER1));
        ...
        final Lo3Stapel<Lo3OuderInhoud> stapel =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(builder().build(), Lo3StapelHelper.lo3His(20000101),
                        Lo3StapelHelper.lo3Doc(1L, "0514", 20000100, "Doc"), LO3_HERKOMST_OUDER1));
    ...
    public void testContr214a() {
        ...
        // assertAantalErrors(1);
        assertPreconditie(Precondities.PRE069);
    }
    ...
    public void testContr40121() {
        final Lo3Stapel<Lo3OuderInhoud> stapel =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(builder().build(), Lo3StapelHelper.lo3His(20000101),
                        Lo3StapelHelper.lo3Doc(1L, "0514", 20050155, "Doc"), LO3_HERKOMST_OUDER1));
    ...
    public void testContr459() {
        final Lo3Stapel<Lo3OuderInhoud> stapel =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(builder().build(),
                        ...
                        LO3_HERKOMST_OUDER1), Lo3StapelHelper.lo3Cat(builder().build(),
                        Lo3StapelHelper.lo3His(20010101), Lo3StapelHelper.lo3Akt(2), LO3_HERKOMST_OUDER1));
