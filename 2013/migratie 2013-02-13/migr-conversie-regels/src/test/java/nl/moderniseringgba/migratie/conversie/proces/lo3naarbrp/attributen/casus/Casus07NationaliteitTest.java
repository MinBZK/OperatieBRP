...
public class Casus07NationaliteitTest extends CasusTest {
...

    {
        ...
        lo3.vul(lo3Leeg,  null,    19941231, 19950103, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 2));
        lo2.vul(lo3Leeg,  ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 1));
        lo1.vul(lo3Duits, null,    19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));

        // verwachte BRP output
        // Duits    1-1-1990    31-12-1994  2-1-1990    xxxxxxxx    A1  A3
        // Duits    1-1-1990    1-1-1995    2-1-1990    2-1-1990    A1  A2  A1
        brp1.vul(brpDuits, 19900101, 19941231, 19900102000000L, null,            actie1, actie3, null);
