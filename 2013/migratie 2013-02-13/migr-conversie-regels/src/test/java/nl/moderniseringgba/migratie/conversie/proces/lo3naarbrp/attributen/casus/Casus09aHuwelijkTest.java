...
public class Casus09aHuwelijkTest extends CasusTest {
...
//        1-1-1990    <leeg>      O   1-1-1990    2-1-1990    <A1>
        ...
        // LO3 input
        lo3.vul(buildHuwelijk(null,     null),     null,    19900101, 19950103, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 2));
        lo2.vul(buildHuwelijk(null,     19950101), ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 1));
        lo1.vul(buildHuwelijk(19900101, null),     ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
