...
public class Casus03NaamTest extends CasusTest {
...

    {
        ...
        // @formatter:off
        // LO3 input
        lo3.vul(lo3Klaas, null,    19941231, 19950110, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 2));
        ...
        brp2.vul(brpKlaas, 19941231, null,     19950110000000L, null,            actie3, null, null);
        brp3.vul(brpJan,   19900101, 19941231, 19900102000000L, null,            actie1, null, null);
        // @formatter:on
