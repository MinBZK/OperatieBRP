...
public class Casus35NationaliteitTest extends CasusTest {
...

    {
        ...
        lo3.vul(lo3Duits, null,    19890101, 20000102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        ...
        brp1.vul(brpDuits, 19890101, 19950101, 20000102000000L, null,            actie3, actie2,   null);
        brp2.vul(brpDuits, 19900101, null, 19900102000000L, 19900102000000L, actie1, null, actie1);
        // @formatter:on
