...
public class Casus19IndicatieTest extends CasusTest {
...

    {
        ...
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(19960102), "A3");
        ...
        brp2.vul(brpBehandeldAlsNl, 19900101, 19960101, 19900102000000L, null,            actie1, actie3, null);
        // @formatter:on
