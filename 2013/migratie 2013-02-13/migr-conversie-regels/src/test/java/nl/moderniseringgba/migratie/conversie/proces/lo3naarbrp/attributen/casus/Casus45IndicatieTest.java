...
public class Casus45IndicatieTest extends CasusTest {
...

    {
        ...
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(20010102), "A3");
        final BrpActie actie2 = buildBrpActie(BrpDatumTijd.fromDatum(20000102), "A2");
        ...
        // LO3 input
        lo3.vul(lo3VastgesteldNietNl, null,    19900108, 20010102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        lo2.vul(lo3Leeg,              null,    20000101, 20000102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 1));
        ...
        brpVastgesteldNietNl1.vul(brpVastgesteldNietNl, 19900108, 20000101, 20010102000000L, null, actie3, actie2,   null);
        // @formatter:on
