...
public class Casus46aIndicatieTest extends CasusTest {
...

    {
        ...
        lo2.vul(lo3Leeg,  null,    19910101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 1));
        lo1.vul(lo3Duits, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 2));

        // verwachte BRP output

        brp1.vul(brpDuits, 19900101, null,     19900102000000L, 19900102000000L, actie1, null,   actie1);
        brp2.vul(brpDuits, 19890101, 19910101, 19950103000000L, null,            actie3, actie2, null);
        // @formatter:on
