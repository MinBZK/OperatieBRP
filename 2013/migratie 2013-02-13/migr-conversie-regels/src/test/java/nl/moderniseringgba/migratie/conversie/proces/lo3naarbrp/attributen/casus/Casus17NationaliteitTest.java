...
public class Casus17NationaliteitTest extends CasusTest {
...

    {
        ...
        lo3.vul(lo3Leeg,  ONJUIST, 19950110, 19950111, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 1));
        lo2.vul(lo3Leeg,  ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 2));
        lo1.vul(lo3Duits, null,    19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 3));


        // verwachte BRP output
        brp1.vul(brpDuits, 19900101, 19941231, 19900102000000L, null,            actie1, actie4, null);
        brp2.vul(brpDuits, 19900101, 19950101, 19900102000100L, 19900102000100L, actie1, actie2, actie1);
        brp3.vul(brpDuits, 19900101, 19950110, 19900102000200L, 19900102000200L, actie1, actie3, actie1);
        // @formatter:on
