...
public class RegistreerFoutActionTest {
    ...
    public void test() {
        ...
        // Expected
        Mockito.when(foutenDao.registreerFout("test.fout.001", "blablabla", "testdef", 42L, null, null)).thenReturn(
                13L);
        ...
        Assert.assertEquals(Long.valueOf(13L), result.get(FoutafhandelingConstants.REGISTRATIE_ID));
    }
}
