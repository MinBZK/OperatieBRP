...
package nl.moderniseringgba.isc.test;
...
public class PropertyTestUtil {
    ...
    public static <T> void testMutableProperty(
            final Object object,
            final String property,
            final T initialValue,
            final T checkValue) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
