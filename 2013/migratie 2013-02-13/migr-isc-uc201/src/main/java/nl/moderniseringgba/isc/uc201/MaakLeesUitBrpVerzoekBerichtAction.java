 ...
 * Maak query.
 */
@Component("uc201MaakLeesUitBrpVerzoekBericht")
public final class MaakLeesUitBrpVerzoekBerichtAction implements SpringAction {
    ...
    public Map<String, Object> execute(final Map<String, Object> parameters) {
        ...
        final SynchronisatieSignaalBericht input = (SynchronisatieSignaalBericht) parameters.get("input");
        final String aNummer = input.getANummer();
