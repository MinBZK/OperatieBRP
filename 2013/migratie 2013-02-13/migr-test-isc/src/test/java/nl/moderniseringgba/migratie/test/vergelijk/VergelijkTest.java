...
public class VergelijkTest {
    ...
    public void testPraktijk() throws IOException {
        final String expected =
                IOUtils.toString(VergelijkTest.class
                        .getResourceAsStream("0003-in0002-vospg-vrij bericht.expected.txt"));
        final String actual =
                IOUtils.toString(VergelijkTest.class.getResourceAsStream("0003-in0002-vospg-vrij bericht.txt"));
