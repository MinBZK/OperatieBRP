 ...
 * 
 */
@Component("uc307MaakBrpGeboorteAntwoordWaarschuwingAction")
public class MaakBrpGeboorteAntwoordWaarschuwingAction implements SpringAction {
    ...
    public final Map<String, Object> execute(final Map<String, Object> parameters) {
        ...
        final Tf11Bericht tf11Bericht = (Tf11Bericht) parameters.get(UC307Constants.TV01_ANTWOORD_BERICHT);

        final GeboorteAntwoordBericht brpGeboorteAntwoordBericht = new GeboorteAntwoordBericht();
        brpGeboorteAntwoordBericht.setCorrelationId(tf11Bericht.getMessageId());
