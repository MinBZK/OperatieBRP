 ...
 */
@Component("uc307ControleerZoekPersoonAntwoordBerichtDecision")
public final class ControleerZoekPersoonAntwoordBerichtDecision implements SpringDecision {
    ...
    public String execute(final Map<String, Object> parameters) {
        ...
        LOG.info("zoekPersoonAntwoordBericht: {}", zoekAntwoord);
