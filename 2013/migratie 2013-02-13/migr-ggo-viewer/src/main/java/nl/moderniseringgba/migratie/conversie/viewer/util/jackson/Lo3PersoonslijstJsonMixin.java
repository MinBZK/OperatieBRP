 ...
 */
public abstract class Lo3PersoonslijstJsonMixin {
    /**
     * isGroep80VanInschrijvingStapelLeeg verandert steeds van volgorde in de gegenereerde JSON. We hebben deze velden
     * niet nodig in de Viewer.
     * 
     * @return niks dus.
     */
    @JsonIgnore
    public abstract boolean isGroep80VanInschrijvingStapelLeeg();
}
