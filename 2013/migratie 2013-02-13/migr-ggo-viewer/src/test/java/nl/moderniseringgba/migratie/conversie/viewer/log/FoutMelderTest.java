...
public class FoutMelderTest {
    ...
    public void testFoutRegelObject() {
        final FoutRegel foutRegel1 = new FoutRegel(null, LogSeverity.ERROR, null, "code", "omschrijving");
        final FoutRegel foutRegel2 = new FoutRegel(null, LogSeverity.ERROR, null, "code", "omschrijving");
