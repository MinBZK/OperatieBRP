 ...
 *
 */
@TldTag(name = "listProcessInstancesForProcessInstance",
        description = "Read a list of child process instances from a process instance.", attributes = {
                ...
                @TldAttribute(name = "processInstance",
                        description = "The process instance whose child process instances are to be read.",
...
public final class ListProcessInstancesForProcessInstanceHandler extends AbstractHandler {
    ...
    protected JbpmActionListener getListener(final FaceletContext ctx) {
        return new ListProcessInstancesForProcessInstanceActionListener(getValueExpression(
                processInstanceTagAttribute, ctx, ProcessInstance.class), getValueExpression(targetTagAttribute, ctx,
                List.class));
    }
}
