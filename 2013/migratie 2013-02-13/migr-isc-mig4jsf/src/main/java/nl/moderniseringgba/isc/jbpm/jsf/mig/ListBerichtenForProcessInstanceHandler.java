...
@TldTag(name = "listBerichtenForProcessInstance", description = "Read a list of berichten from a process instance.",
        attributes = {
                @TldAttribute(name = "target",
                        description = "An EL expression into which the berichten instance list should be stored.",
...
public final class ListBerichtenForProcessInstanceHandler extends AbstractHandler {
    ...
    protected JbpmActionListener getListener(final FaceletContext ctx) {
        return new ListBerichtenForProcessInstanceActionListener(getValueExpression(processInstanceTagAttribute, ctx,
