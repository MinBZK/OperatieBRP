...
/**
 * Controleer deblokkeren antwoord.
 */
@Component("uc202ControleerDeblokkerenAntwoordDecision")
public final class ControleerDeblokkerenAntwoordDecision implements SpringDecision {
    ...
    public String execute(final Map<String, Object> parameters) {
        ...
        final DeblokkeringAntwoordBericht deblokkeringAntwoord =
                (DeblokkeringAntwoordBericht) parameters.get("deblokkerenAntwoordBericht");

        return deblokkeringAntwoord.getStatus() == StatusType.OK ? null : "10d. Fout";
    }
}
