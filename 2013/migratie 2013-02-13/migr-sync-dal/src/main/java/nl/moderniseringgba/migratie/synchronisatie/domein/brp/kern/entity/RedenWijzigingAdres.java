...
/**
 * The persistent class for the rdnwijzadres database table.
 * 
 */
@Entity
@Table(name = "rdnwijzadres", schema = "kern")
/*
 ...
 */
public class RedenWijzigingAdres implements Serializable, DynamischeStamtabel {
