...
/**
 * The persistent class for the redenvervallenreisdocument database table.
 * 
 */
@Entity
@Table(name = "redeninhoudingvermissingreisdocument", schema = "conversietabel")
/*
 ...
 */
public class RedenInhoudingVermissingReisdocument implements Serializable {
    ...
    @Column(name = "brpcode", insertable = false, updatable = false, unique = true, nullable = false, length = 1)
