...
/**
 * The persistent class for the autvanafgiftereisdoc database table.
 * 
 */
@Entity
@Table(name = "autvanafgiftereisdoc", schema = "kern")
/*
 ...
 */
public class AutoriteitVanAfgifteReisdocument implements Serializable, DynamischeStamtabel {
    ...
    @Column(insertable = false, updatable = false, nullable = false, length = 6, unique = true)
    private String code;
    ...
    public AutoriteitVanAfgifteReisdocument() {
    }
