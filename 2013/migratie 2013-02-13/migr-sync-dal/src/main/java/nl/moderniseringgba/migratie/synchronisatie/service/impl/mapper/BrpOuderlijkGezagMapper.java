 ...
 */
@Component
public final class BrpOuderlijkGezagMapper extends
        BrpMapper<BetrokkenheidOuderlijkGezagHistorie, BrpOuderlijkGezagInhoud> {

    @Override
    protected BrpOuderlijkGezagInhoud mapInhoud(final BetrokkenheidOuderlijkGezagHistorie historie) {
        // @formatter:off
        return new BrpOuderlijkGezagInhoud(
