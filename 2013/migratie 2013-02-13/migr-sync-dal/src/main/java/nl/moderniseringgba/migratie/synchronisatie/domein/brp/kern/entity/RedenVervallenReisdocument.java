 ...
 */
@Entity
@Table(name = "rdnvervallenreisdoc", schema = "kern")
/*
 ...
 */
public class RedenVervallenReisdocument implements Serializable, DynamischeStamtabel {
    ...
    public RedenVervallenReisdocument() {
    }
