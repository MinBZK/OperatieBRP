...
/**
 * The persistent class for the aangadresh database table.
 * 
 */
@Entity
@Table(name = "aangadresh", schema = "kern")
/*
 ...
 */
public class AangeverAdreshouding implements Serializable, DynamischeStamtabel {
