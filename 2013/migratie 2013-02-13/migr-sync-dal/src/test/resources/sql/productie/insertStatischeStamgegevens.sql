--Bron: https://modernodam.nl/svn/brp-code/BRP/trunk/dataaccess/src/main/resources/db/stamgegevensStatisch.sql
-- RM: COMPLEET
...
INSERT INTO Kern.RdnBeeindRelatie (ID, Code, Oms) VALUES (7, 'V', 'Naar vreemd recht anders beëindigd');
