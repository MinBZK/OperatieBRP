...
public class BetrokkenheidOuderlijkGezagHistorieTest {
    ...
    private final BetrokkenheidOuderlijkGezagHistorie betOudGezagHistorie = new BetrokkenheidOuderlijkGezagHistorie();
    private final BetrokkenheidOuderlijkGezagHistorie betOudGezagHistorie2 =
    ...
    public void isInhoudelijkGelijk() {
        ...
        betOudGezagHistorie2.setIndicatieOuderHeeftGezag(true);
        betOudGezagHistorie.setIndicatieOuderHeeftGezag(true);
    ...
    public void isInhoudelijkGelijkIndicatieOuderHeeftGezag() {
        ...
        betOudGezagHistorie.setIndicatieOuderHeeftGezag(true);
        betOudGezagHistorie2.setIndicatieOuderHeeftGezag(null);
        Assert.assertFalse(betOudGezagHistorie.isInhoudelijkGelijkAan(betOudGezagHistorie2));
    }
}
