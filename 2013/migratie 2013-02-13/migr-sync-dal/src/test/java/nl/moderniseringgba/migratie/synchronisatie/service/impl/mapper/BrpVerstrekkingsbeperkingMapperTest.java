...
public class BrpVerstrekkingsbeperkingMapperTest extends BrpAbstractTest {

    @Inject
    private BrpVerstrekkingsbeperkingMapper mapper;
    ...
    public void testMapInhoud() {
        ...
        final BrpVerstrekkingsbeperkingInhoud result = mapper.mapInhoud(historie);
