...
public class RequirementsTest {
    ...
    public void testVolledigheidRequirements() {
        ...
        final List<Requirements> missing = new ArrayList<Requirements>();
    ...
    private Map<Requirements, List<String>> maakOverzicht() {
        ...
        final Map<Requirements, List<String>> overzicht = new HashMap<Requirements, List<String>>();
        ...
        for (final Method method : methodsAnnotated) {
            ...
            for (final Requirements requirement : value) {
                if (overzicht.containsKey(requirement)) {
                    ...
                    overzicht.put(requirement, new ArrayList<String>(Arrays.asList(method.toString())));
                }
            }
        }
        ...
        for (final Class<?> clazz : classesAnnotated) {
            ...
            for (final Requirements requirement : value) {
                if (overzicht.containsKey(requirement)) {
                    ...
                    overzicht.put(requirement, new ArrayList<String>(Arrays.asList(clazz.toString())));
                }
            }
        }
        return overzicht;
    ...
    private void prettyPrint(final Map<Requirements, List<String>> overzicht) {
        ...
        final List<Requirements> unsorted = new ArrayList<Requirements>(overzicht.keySet());
