...
public class SoortVerbintenisConversietabelTest {
    ...
    public void testNaarBrp() {
        ...
        assertEquals(BrpSoortRelatieCode.GEREGISTREERD_PARTNERSCHAP,
                tabel.converteerNaarBrp(Lo3SoortVerbintenisEnum.GEREGISTREERD_PARTNERSCHAP.asElement()));
        assertEquals(BrpSoortRelatieCode.HUWELIJK,
                tabel.converteerNaarBrp(Lo3SoortVerbintenisEnum.HUWELIJK.asElement()));
    }
    ...
    public void testNaarLo3() {
        ...
        assertEquals(Lo3SoortVerbintenisEnum.GEREGISTREERD_PARTNERSCHAP.asElement(),
                tabel.converteerNaarLo3(BrpSoortRelatieCode.GEREGISTREERD_PARTNERSCHAP));
        assertEquals(Lo3SoortVerbintenisEnum.HUWELIJK.asElement(),
                tabel.converteerNaarLo3(BrpSoortRelatieCode.HUWELIJK));
    }
