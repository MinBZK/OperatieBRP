...
public class BrpStatenloosIndicatieMapperTest extends BrpAbstractTest {

    @Inject
    private BrpStatenloosIndicatieMapper mapper;
    ...
    public void testMapInhoud() {
        ...
        final BrpStatenloosIndicatieInhoud result = mapper.mapInhoud(historie);
