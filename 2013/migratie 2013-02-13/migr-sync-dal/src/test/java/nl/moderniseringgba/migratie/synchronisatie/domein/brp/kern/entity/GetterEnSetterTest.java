...
public class GetterEnSetterTest {
    ...
    private static final String ROOT_PACKAGE = "nl.moderniseringgba.migratie.synchronisatie.domein.brp.kern.entity";

    private static final Map<Class<? extends Object>, Object> VALUES = new HashMap<Class<? extends Object>, Object>();
    ...
    private List<Class<? extends Object>> filterClassesOpEntities(final List<Class<? extends Object>> classes) {
        final List<Class<? extends Object>> entities = new ArrayList<Class<? extends Object>>();
        for (final Class<? extends Object> clazz : classes) {
    ...
    private List<Class<? extends Object>> filterClassesOpModelClasses(final List<Class<? extends Object>> classes) {
        final List<Class<? extends Object>> modelClasses = new ArrayList<Class<? extends Object>>();
        for (final Class<? extends Object> clazz : classes) {
    ...
    private List<Class<? extends Object>> filterClassesOpEnums(final List<Class<? extends Object>> classes) {
        final List<Class<? extends Object>> enums = new ArrayList<Class<? extends Object>>();
        for (final Class<? extends Object> clazz : classes) {
            if (clazz.isEnum()) {
                enums.add(clazz);
            }
    ...
    private static List<Class<? extends Object>> getClassesInPackage(final String packageNaam)
        ...
        final List<File> bestanden = new ArrayList<File>();
     ...
     *             indien een class niet gevonden kan worden.
     */
    private static List<Class<? extends Object>> vindClassesInPackageFolderEnSubpackages(
            final File folder,
