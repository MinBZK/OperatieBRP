...
public class BrpBezitBuitenlandsReisdocumentIndicatieMapperTest extends BrpAbstractTest {

    @Inject
    private BrpBezitBuitenlandsReisdocumentIndicatieMapper mapper;
    ...
    public void testMapInhoud() {
        ...
        final BrpBezitBuitenlandsReisdocumentIndicatieInhoud result = mapper.mapInhoud(historie);
