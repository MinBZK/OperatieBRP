...
public final class RedenVerliesNLNationaliteitConverter implements PropertyConverter<RedenVerliesNLNationaliteit> {
    ...
    @Override
    public Class<RedenVerliesNLNationaliteit> getType() {
        return RedenVerliesNLNationaliteit.class;
    }

    @Override
    public RedenVerliesNLNationaliteit convert(final String value) {
        return value == null ? null : em.find(RedenVerliesNLNationaliteit.class, Integer.valueOf(value));
    }
