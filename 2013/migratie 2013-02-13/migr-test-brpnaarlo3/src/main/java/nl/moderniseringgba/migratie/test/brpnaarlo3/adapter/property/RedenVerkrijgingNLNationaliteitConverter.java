 ...
 */
@Component
public final class RedenVerkrijgingNLNationaliteitConverter implements
        PropertyConverter<RedenVerkrijgingNLNationaliteit> {
    @PersistenceContext
    private EntityManager em;

    @Override
    public Class<RedenVerkrijgingNLNationaliteit> getType() {
        return RedenVerkrijgingNLNationaliteit.class;
    }

    @Override
    public RedenVerkrijgingNLNationaliteit convert(final String value) {
        return value == null ? null : em.find(RedenVerkrijgingNLNationaliteit.class, Integer.valueOf(value));
    }
