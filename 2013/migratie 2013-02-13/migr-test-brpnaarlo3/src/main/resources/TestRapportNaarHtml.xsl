...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="input|lezen|conversie">
	...
	<xsl:template name="totalen">
		...
		<xsl:variable name="totaalLezenOk" select="count(//resultaat/lezen[@status='OK'])" />
		<xsl:variable name="totaalLezenNok" select="count(//resultaat/lezen[@status='NOK'])" />
		<xsl:variable name="totaalLezenExceptie" select="count(//resultaat/lezen[@status='EXCEPTIE'])" />
