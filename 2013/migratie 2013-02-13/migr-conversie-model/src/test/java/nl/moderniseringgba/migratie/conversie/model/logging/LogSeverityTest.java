...
public class LogSeverityTest {
    ...
    public void testLogSeverity() {
        ...
        assertEquals(250, LogSeverity.REMOVED.getSeverity());
    ...
    public void testCompareSeverity() {
        ...
        assertTrue(LogSeverity.REMOVED.compareTo(LogSeverity.ERROR) < 0);
        assertTrue(LogSeverity.WARNING.compareTo(LogSeverity.REMOVED) < 0);
    ...
    public void testValueOfSeverity() {
        ...
        assertEquals(LogSeverity.REMOVED, LogSeverity.valueOfSeverity(250));
