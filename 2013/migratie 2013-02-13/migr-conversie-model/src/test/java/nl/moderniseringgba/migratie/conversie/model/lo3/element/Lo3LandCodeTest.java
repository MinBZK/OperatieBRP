...
public class Lo3LandCodeTest {
    ...
    public void testHashCode() {
        final Lo3LandCode landCode = new Lo3LandCode("1234");
        final Lo3LandCode landCode2 = new Lo3LandCode("1234");
    ...
    public void testLo3LandCodeFout1() {
        new Lo3LandCode(null);
    }

    @Test
    public void testGetCode() {
        final Lo3LandCode landCode = new Lo3LandCode("1234");
        assertEquals("1234", landCode.getCode());
    }
