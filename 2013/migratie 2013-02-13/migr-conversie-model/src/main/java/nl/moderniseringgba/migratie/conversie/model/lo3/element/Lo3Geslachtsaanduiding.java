 ...
 */
public final class Lo3Geslachtsaanduiding implements Lo3Element, Serializable {
     ...
     *            code
     */
    public Lo3Geslachtsaanduiding(@Text final String code) {
        this.code = code;
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof Lo3Geslachtsaanduiding)) {
            return false;
        }
        final Lo3Geslachtsaanduiding castOther = (Lo3Geslachtsaanduiding) other;
