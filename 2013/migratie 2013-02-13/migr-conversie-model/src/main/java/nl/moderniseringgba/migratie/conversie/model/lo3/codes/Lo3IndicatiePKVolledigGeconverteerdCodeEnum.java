...
public enum Lo3IndicatiePKVolledigGeconverteerdCodeEnum {
    ...
    private static final Map<String, Lo3IndicatiePKVolledigGeconverteerdCodeEnum> CODE_MAP =
            new HashMap<String, Lo3IndicatiePKVolledigGeconverteerdCodeEnum>() {
                private static final long serialVersionUID = 1L;
                {
                    final Lo3IndicatiePKVolledigGeconverteerdCodeEnum[] values =
                            Lo3IndicatiePKVolledigGeconverteerdCodeEnum.values();
    ...
    private Lo3IndicatiePKVolledigGeconverteerdCodeEnum(final String code) {
        this.code = code;
    }
     ...
     * @return de enumeratie waarde, null als de code niet gevonden kan worden
     */
    public static Lo3IndicatiePKVolledigGeconverteerdCodeEnum getByElement(
            final Lo3IndicatiePKVolledigGeconverteerdCode element) {
