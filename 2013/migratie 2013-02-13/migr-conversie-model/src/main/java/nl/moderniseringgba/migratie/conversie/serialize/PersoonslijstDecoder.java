...
public final class PersoonslijstDecoder {
    ...
    /**
     * Leest de inputstream en parsed deze naar object in het Migratie model.
     * 
     * @param in
     *            de inputstream
     * @return de migratie persoonslijst
     */
    public static MigratiePersoonslijst decodeMigratiePersoonslijst(final InputStream in) {
        return decode(MigratiePersoonslijst.class, in);
    }
