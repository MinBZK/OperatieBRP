 ...
 * 36.10 Signalering.
 */
public final class Lo3Signalering implements Lo3Element, Serializable {
     ...
     *            code
     */
    public Lo3Signalering(@Text final Integer code) {
        this.code = code;
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof Lo3Signalering)) {
            return false;
        }
        final Lo3Signalering castOther = (Lo3Signalering) other;
