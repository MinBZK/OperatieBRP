...
public enum Lo3IndicatieGezagMinderjarigeEnum {
    ...
    private static final Map<String, Lo3IndicatieGezagMinderjarigeEnum> CODE_MAP =
            new HashMap<String, Lo3IndicatieGezagMinderjarigeEnum>() {
    ...
    private Lo3IndicatieGezagMinderjarigeEnum(final String code) {
        this.code = code;
    }
