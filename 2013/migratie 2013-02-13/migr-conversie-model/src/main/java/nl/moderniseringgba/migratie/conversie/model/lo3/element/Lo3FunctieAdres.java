 ...
 * 
 */
public final class Lo3FunctieAdres implements Lo3Element, Serializable {
     ...
     *            code
     */
    public Lo3FunctieAdres(@Text final String code) {
        this.code = code;
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof Lo3FunctieAdres)) {
            return false;
        }
        final Lo3FunctieAdres castOther = (Lo3FunctieAdres) other;
