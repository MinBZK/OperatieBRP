...
/**
 * Deze class representeert de inhoud van de BRP indicatie Belemmering verstrekking reisdocument.
 * 
 * Deze class is immutable en threadsafe.
 * 
 */
@Root
public final class BrpBelemmeringVerstrekkingReisdocumentIndicatieInhoud extends AbstractBrpGroepInhoud implements
        BrpIndicatieGroepInhoud {
    @Element(name = "heeftIndicatie", required = false)
    private final Boolean heeftIndicatie;

    /**
     * Maakt een BrpBelemmeringVerstrekkingReisdocumentIndicatieInhoud object.
     * 
     * @param heeftIndicatie
     *            true als de indicatie bestaat, anders false, mag null zijn
     */
    public BrpBelemmeringVerstrekkingReisdocumentIndicatieInhoud(
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpBelemmeringVerstrekkingReisdocumentIndicatieInhoud)) {
            return false;
        }
        final BrpBelemmeringVerstrekkingReisdocumentIndicatieInhoud castOther =
                (BrpBelemmeringVerstrekkingReisdocumentIndicatieInhoud) other;
