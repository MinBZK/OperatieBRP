...
/**
 * Deze class representeert de inhoud van de BRP indicatie 'Statenloos'.
 * 
 * Deze class is immutable en threadsafe.
 */
public final class BrpStatenloosIndicatieInhoud extends AbstractBrpGroepInhoud implements BrpIndicatieGroepInhoud {
    @Element(name = "heeftIndicatie", required = false)
    private final Boolean heeftIndicatie;

    /**
     * Maakt een BrpStatenloosIndicatieInhoud object.
     * 
     * @param heeftIndicatie
     *            true als de indicatie bestaat, anders false, mag null zijn
     */
    public BrpStatenloosIndicatieInhoud(
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpStatenloosIndicatieInhoud)) {
            return false;
        }
        final BrpStatenloosIndicatieInhoud castOther = (BrpStatenloosIndicatieInhoud) other;
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("heeftIndicatie", heeftIndicatie)
                .toString();
    }
