 ...
 * 
 */
public final class BrpVastgesteldNietNederlanderIndicatieInhoud extends AbstractBrpGroepInhoud implements
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpVastgesteldNietNederlanderIndicatieInhoud)) {
            return false;
        }
        final BrpVastgesteldNietNederlanderIndicatieInhoud castOther =
                (BrpVastgesteldNietNederlanderIndicatieInhoud) other;
