...
public enum Requirements {
     ...
     * Statenloos.
     */
    CCA04_BL03("CCA04-BL03", "Statenloos"),
    /**
     * Nationaliteit.
     */
     ...
     * Opschorting.
     */
    CCA07_LB05("CCA07-LB05", "Opschorting"),
     ...
     */
    CHP001_LB21("CHP001-LB21",
            "Converteren historiestructuur. Geen lege LO3 rijen, BRP groep met zowel formele als materiële historie"),
    /**
     ...
     */
    CHP001_LB22("CHP001-LB22",
            "Converteren historiestructuur. Geen lege LO3 rijen, BRP groep met uitsluitend formele historie"),
    /**
     ...
     */
    CHP001_LB23("CHP001-LB23", "Converteren historiestructuur. Mogelijk lege LO3 rijen, "
            + "BRP groep met zowel formele als materiële historie"),
    /**
     * Converteren historiestructuur. Bron is een LO3 categorie waar lege rijen kunnen voorkomen. Doel is een BRP groep
     * die uitsluitend formele historie heeft
     */
    CHP001_LB24("CHP001-LB24",
            "Converteren historiestructuur. Mogelijk lege LO3 rijen, BRP groep met uitsluitend formele historie"),
    ...
    private Requirements(final String code, final String omschrijving) {
        this.code = code;
