...
public final class BrpOuder1GezagInhoud extends AbstractBrpGroepInhoud {
     ...
     */
    public BrpOuder1GezagInhoud(final Boolean ouderHeeftGezag) {
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpOuder1GezagInhoud)) {
            return false;
        }
        final BrpOuder1GezagInhoud castOther = (BrpOuder1GezagInhoud) other;
