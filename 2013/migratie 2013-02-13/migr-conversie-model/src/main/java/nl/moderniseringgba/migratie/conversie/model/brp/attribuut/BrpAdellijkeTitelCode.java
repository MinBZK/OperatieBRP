 ...
 * 
 */
public final class BrpAdellijkeTitelCode implements BrpAttribuut {
     ...
     *             als code null is
     */
    public BrpAdellijkeTitelCode(@Text final String code) {
        if (code == null) {
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpAdellijkeTitelCode)) {
            return false;
        }
        final BrpAdellijkeTitelCode castOther = (BrpAdellijkeTitelCode) other;
