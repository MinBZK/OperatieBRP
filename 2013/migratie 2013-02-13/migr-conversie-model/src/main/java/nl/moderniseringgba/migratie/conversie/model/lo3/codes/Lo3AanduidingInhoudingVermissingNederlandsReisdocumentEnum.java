...
public enum Lo3AanduidingInhoudingVermissingNederlandsReisdocumentEnum {
    ...
    private static final Map<String, Lo3AanduidingInhoudingVermissingNederlandsReisdocumentEnum> CODE_MAP =
            new HashMap<String, Lo3AanduidingInhoudingVermissingNederlandsReisdocumentEnum>() {
                private static final long serialVersionUID = 1L;
                {
                    final Lo3AanduidingInhoudingVermissingNederlandsReisdocumentEnum[] values =
                            Lo3AanduidingInhoudingVermissingNederlandsReisdocumentEnum.values();
    ...
    private Lo3AanduidingInhoudingVermissingNederlandsReisdocumentEnum(final String code) {
        this.code = code;
    }
