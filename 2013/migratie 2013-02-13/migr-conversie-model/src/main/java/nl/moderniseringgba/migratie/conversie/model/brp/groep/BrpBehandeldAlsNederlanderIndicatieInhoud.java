...
/**
 * Deze class representeert de inhoud van de BRP indicatie 'Behandeld Als Nederlander'.
 * 
 * Deze class is immutable en threadsafe.
 * 
 */
public final class BrpBehandeldAlsNederlanderIndicatieInhoud extends AbstractBrpGroepInhoud implements
        BrpIndicatieGroepInhoud {
    @Element(name = "heeftIndicatie", required = false)
    private final Boolean heeftIndicatie;

    /**
     * Maakt een BrpBehandeldAlsNederlanderIndicatieInhoud object.
     * 
     * @param heeftIndicatie
     *            true als de indicatie bestaat, anders false, mag null zijn
     */
    public BrpBehandeldAlsNederlanderIndicatieInhoud(
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpBehandeldAlsNederlanderIndicatieInhoud)) {
            return false;
        }
        final BrpBehandeldAlsNederlanderIndicatieInhoud castOther = (BrpBehandeldAlsNederlanderIndicatieInhoud) other;
