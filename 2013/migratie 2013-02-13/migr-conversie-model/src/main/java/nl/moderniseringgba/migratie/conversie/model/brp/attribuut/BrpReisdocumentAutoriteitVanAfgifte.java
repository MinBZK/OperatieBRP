 ...
 * 
 */
public final class BrpReisdocumentAutoriteitVanAfgifte implements BrpAttribuut {
     ...
     *             als code null is
     */
    public BrpReisdocumentAutoriteitVanAfgifte(@Text final String code) {
        if (code == null) {
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpReisdocumentAutoriteitVanAfgifte)) {
            return false;
        }
        final BrpReisdocumentAutoriteitVanAfgifte castOther = (BrpReisdocumentAutoriteitVanAfgifte) other;
