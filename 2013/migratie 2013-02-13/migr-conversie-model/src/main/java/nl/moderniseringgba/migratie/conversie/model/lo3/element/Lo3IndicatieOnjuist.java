 ...
 * 
 */
public final class Lo3IndicatieOnjuist implements Comparable<Lo3IndicatieOnjuist>, Lo3Element, Serializable {
     ...
     *            code
     */
    public Lo3IndicatieOnjuist(@Text final String code) {
        this.code = code;
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof Lo3IndicatieOnjuist)) {
            return false;
        }
        final Lo3IndicatieOnjuist castOther = (Lo3IndicatieOnjuist) other;
