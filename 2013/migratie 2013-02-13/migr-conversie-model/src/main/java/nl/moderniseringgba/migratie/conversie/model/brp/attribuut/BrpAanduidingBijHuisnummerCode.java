 ...
 * 
 */
// TODO uitzoeken of dit een enum kan worden
public final class BrpAanduidingBijHuisnummerCode implements BrpAttribuut {
     ...
     *             als code null is
     */
    public BrpAanduidingBijHuisnummerCode(@Text final String code) {
        if (code == null) {
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BrpAanduidingBijHuisnummerCode)) {
            return false;
        }
        final BrpAanduidingBijHuisnummerCode castOther = (BrpAanduidingBijHuisnummerCode) other;
