...
public enum Lo3GeslachtsaanduidingEnum {
    ...
    private static final Map<String, Lo3GeslachtsaanduidingEnum> CODE_MAP =
            new HashMap<String, Lo3GeslachtsaanduidingEnum>() {
    ...
    private Lo3GeslachtsaanduidingEnum(final String code) {
        this.code = code;
    }
