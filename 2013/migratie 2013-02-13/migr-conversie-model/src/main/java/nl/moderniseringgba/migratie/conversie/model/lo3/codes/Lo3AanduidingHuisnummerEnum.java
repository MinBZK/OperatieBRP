...
public enum Lo3AanduidingHuisnummerEnum {
    ...
    private static final Map<String, Lo3AanduidingHuisnummerEnum> CODE_MAP =
            new HashMap<String, Lo3AanduidingHuisnummerEnum>() {
    ...
    private Lo3AanduidingHuisnummerEnum(final String code) {
        this.code = code;
    }
