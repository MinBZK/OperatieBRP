 ...
 * Lg01.
 */
public final class Lg01Bericht extends AbstractLo3Bericht implements Lo3Bericht, Serializable {
    private static final long serialVersionUID = 1L;

    private static final Lo3Header HEADER = new Lo3Header(Lo3HeaderVeld.RANDOM_KEY, Lo3HeaderVeld.BERICHTNUMMER,
            Lo3HeaderVeld.DATUM_TIJD, Lo3HeaderVeld.A_NUMMER, Lo3HeaderVeld.OUD_A_NUMMER);
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof Lg01Bericht)) {
            return false;
        }
        final Lg01Bericht castOther = (Lg01Bericht) other;
