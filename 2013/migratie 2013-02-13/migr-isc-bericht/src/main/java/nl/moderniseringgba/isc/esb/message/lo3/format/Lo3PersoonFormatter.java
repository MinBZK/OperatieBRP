...
import static nl.moderniseringgba.migratie.conversie.model.lo3.Lo3ElementEnum.ELEMENT_2010;
import static nl.moderniseringgba.migratie.conversie.model.lo3.Lo3ElementEnum.ELEMENT_2020;
import static nl.moderniseringgba.migratie.conversie.model.lo3.Lo3ElementEnum.ELEMENT_6110;
...
public final class Lo3PersoonFormatter implements Lo3CategorieFormatter<Lo3PersoonInhoud> {
    ...
    public void format(final Lo3PersoonInhoud categorie, final Lo3Formatter formatter) {
        ...
        formatter.element(ELEMENT_2010, Lo3Format.format(categorie.getVorigANummer()));
        formatter.element(ELEMENT_2020, Lo3Format.format(categorie.getVolgendANummer()));
        formatter.element(ELEMENT_6110, Lo3Format.format(categorie.getAanduidingNaamgebruikCode()));
    }
}
