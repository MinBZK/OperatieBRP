...
/**
 * Ontkenning vaderschap antwoord.
 */
public final class OntkenningVaderschapAntwoordBericht extends AbstractBrpBericht implements BrpAntwoordBericht,
        Serializable {
    ...
    private OntkenningVaderschapAntwoordType ontkenningVaderschapAntwoordType;
     ...
     * Default constructor.
     */
    public OntkenningVaderschapAntwoordBericht() {
        ontkenningVaderschapAntwoordType = new OntkenningVaderschapAntwoordType();
        ontkenningVaderschapAntwoordType.setStatus(StatusType.OK);
    }

    /**
     * Deze constructor wordt gebruikt door de factory om op basis van een Jaxb element een ontkenning vaderschap te
     * maken.
     * 
     * @param type
     *            het ontkenningVaderschapAntwoord type
     */
    public OntkenningVaderschapAntwoordBericht(final OntkenningVaderschapAntwoordType type) {
        ontkenningVaderschapAntwoordType = type;
    }
    ...
    public String getBerichtType() {
        return "OntkenningVaderschapAntwoord";
    }
    ...
    public String format() throws BerichtInhoudException {
        return BrpBerichtFactory.SINGLETON.elementToString(new ObjectFactory()
                .createOntkenningVaderschapAntwoord(ontkenningVaderschapAntwoordType));
    }

    @Override
    public void parse(final Document document) throws BerichtInhoudException {
        try {
            ontkenningVaderschapAntwoordType =
                    BrpBerichtFactory.SINGLETON.getUnmarshaller()
                            .unmarshal(document, OntkenningVaderschapAntwoordType.class).getValue();
        } catch (final JAXBException e) {
            throw new BerichtInhoudException(
                    "Onbekende fout tijdens het unmarshallen van een Ontkenning vaderschap Antwoord bericht.", e);
        }
    }
    ...
    public StatusType getStatus() {
        return ontkenningVaderschapAntwoordType.getStatus();
    }
    ...
    public void setStatus(final StatusType status) {
        ontkenningVaderschapAntwoordType.setStatus(status);
    }
    ...
    public String getToelichting() {
        return ontkenningVaderschapAntwoordType.getToelichting();
    }
    ...
    public void setToelichting(final String toelichting) {
        ontkenningVaderschapAntwoordType.setToelichting(toelichting);
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof OntkenningVaderschapAntwoordBericht)) {
            return false;
        }
        final OntkenningVaderschapAntwoordBericht castOther = (OntkenningVaderschapAntwoordBericht) other;
