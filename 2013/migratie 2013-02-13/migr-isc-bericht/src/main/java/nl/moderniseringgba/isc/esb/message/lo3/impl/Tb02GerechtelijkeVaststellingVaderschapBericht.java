...
/**
 * Tb02GerechtelijkeVaststellingVaderschap.
 */
public final class Tb02GerechtelijkeVaststellingVaderschapBericht extends Tb02Bericht {
     ...
     *            De registratiegemeente van de ontkenning van het vaderschap.
     * @param aktenummer
     *            Het aktenummer van de ontkenning van het vaderschap.
     * @param ingangsdatumGeldigheid
     *            De ingangsdatum van de ontkenning van het vaderschap.
     */
    public Tb02GerechtelijkeVaststellingVaderschapBericht(
