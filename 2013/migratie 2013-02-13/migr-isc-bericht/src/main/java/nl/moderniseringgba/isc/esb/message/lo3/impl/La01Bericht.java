 ...
 * La01.
 */
public final class La01Bericht extends AbstractLo3Bericht implements Lo3Bericht, Serializable {
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof La01Bericht)) {
            return false;
        }
        final La01Bericht castOther = (La01Bericht) other;
