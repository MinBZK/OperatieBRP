...
public class Tb02OntkenningVaderschapDoorMoederBerichtTest {
    ...
    private Tb02Bericht maakTb02Bericht(final Lo3Persoonslijst lo3PersoonsLijst) {
        final Tb02Bericht tb02Bericht =
                new Tb02OntkenningVaderschapDoorMoederBericht(BRON_GEMEENTE, AKTENUMMER, new Lo3Datum(20130115));
    ...
    public void testGettersEnSetters() throws Exception {
        final Lo3Persoonslijst pl = maakLo3Persoonslijst();
        final Tb02Bericht tb02Bericht = maakTb02Bericht(pl);
        ((Tb02OntkenningVaderschapDoorMoederBericht) tb02Bericht).setAktenummer(AKTENUMMER);
        ((Tb02OntkenningVaderschapDoorMoederBericht) tb02Bericht).setIngangsdatumGeldigheid(INGANGSDATUM);
        ((Tb02OntkenningVaderschapDoorMoederBericht) tb02Bericht).setRegistratieGemeente(BRON_GEMEENTE);
        ...
        assertEquals("Registratiegemeente ongelijk.", BRON_GEMEENTE,
                ((Tb02OntkenningVaderschapDoorMoederBericht) tb02Bericht).getRegistratieGemeente());
        assertEquals("Aktenummer ongelijk.", AKTENUMMER,
                ((Tb02OntkenningVaderschapDoorMoederBericht) tb02Bericht).getAktenummer());
        assertEquals("Aktenummer ongelijk.", INGANGSDATUM,
                ((Tb02OntkenningVaderschapDoorMoederBericht) tb02Bericht).getIngangsdatumGeldigheid());
        ...
        Assert.assertEquals(tb02Bericht.format(), ((Tb02Bericht) deserialized).format());
    }
