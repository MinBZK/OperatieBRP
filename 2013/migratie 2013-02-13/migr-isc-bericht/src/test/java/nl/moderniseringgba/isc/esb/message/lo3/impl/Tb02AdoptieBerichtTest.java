...
public class Tb02AdoptieBerichtTest {
    ...
    private Tb02Bericht maakTb02Bericht(final Lo3Persoonslijst lo3PersoonsLijst) {
        final Tb02Bericht tb02Bericht = new Tb02AdoptieBericht(BRON_GEMEENTE, AKTENUMMER, new Lo3Datum(20130115));
    ...
    public void testGettersEnSetters() throws Exception {
        final Lo3Persoonslijst pl = maakLo3Persoonslijst();
        final Tb02Bericht tb02Bericht = maakTb02Bericht(pl);
        ((Tb02AdoptieBericht) tb02Bericht).setAktenummer(AKTENUMMER);
        ((Tb02AdoptieBericht) tb02Bericht).setIngangsdatumGeldigheid(INGANGSDATUM);
        ((Tb02AdoptieBericht) tb02Bericht).setRegistratieGemeente(BRON_GEMEENTE);
        ...
        assertEquals("Registratiegemeente ongelijk.", BRON_GEMEENTE,
                ((Tb02AdoptieBericht) tb02Bericht).getRegistratieGemeente());
        assertEquals("Aktenummer ongelijk.", AKTENUMMER, ((Tb02AdoptieBericht) tb02Bericht).getAktenummer());
        assertEquals("Aktenummer ongelijk.", INGANGSDATUM,
                ((Tb02AdoptieBericht) tb02Bericht).getIngangsdatumGeldigheid());
    ...
    private static Lo3Persoonslijst maakLo3Persoonslijst() {
        ...
        final Lo3Categorie<Lo3PersoonInhoud> persoon1 =
                new Lo3Categorie<Lo3PersoonInhoud>(lo3PersoonInhoud, null, historie, new Lo3Herkomst(
                        Lo3CategorieEnum.CATEGORIE_01, 0, 1));
        final Lo3Categorie<Lo3PersoonInhoud> persoon1historie =
                new Lo3Categorie<Lo3PersoonInhoud>(lo3PersoonInhoud, null, historie, new Lo3Herkomst(
                        Lo3CategorieEnum.CATEGORIE_01, 0, 0));
        final List<Lo3Categorie<Lo3PersoonInhoud>> persoonInhoudLijst =
                new ArrayList<Lo3Categorie<Lo3PersoonInhoud>>();
        persoonInhoudLijst.add(0, persoon1historie);
        persoonInhoudLijst.add(1, persoon1);
        @SuppressWarnings("unchecked")
        final Lo3Stapel<Lo3PersoonInhoud> lo3PersoonStapel =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(Lo3StapelHelper.lo3Persoon(5675675678L, "Klaas",
                        "Pietersen", 19770101, "0517", "6030", "M"), Lo3StapelHelper.lo3His(19770101),
                        Lo3StapelHelper.lo3Akt(1), new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 1)),
                        Lo3StapelHelper.lo3Cat(Lo3StapelHelper.lo3Persoon(5675675678L, "Piet", "Pietersen", 19770101,
                                "0517", "6030", "M"), Lo3StapelHelper.lo3His(19770101), Lo3StapelHelper.lo3Akt(1),
                                new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 0)));
        @SuppressWarnings("unchecked")
        final Lo3Stapel<Lo3OuderInhoud> ouder =
                Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(Lo3StapelHelper.lo3Ouder(1321513L, 513203156L,
                        "Piet", null, "van", "Veen", 19500601, "1905", "0030", "M", 20120202), Lo3StapelHelper
                        .lo3His(19770101), null, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_58, 0, 1)),
                        Lo3StapelHelper.lo3Cat(Lo3StapelHelper.lo3Ouder(1321513L, 513203156L, "Herman", null, "van",
                                "Veen", 19500601, "1905", "0030", "M", 20120202), Lo3StapelHelper.lo3His(19770101),
                                null, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_58, 0, 0)));
