...
public class Tb02VoornaamswijzigingBerichtTest {
    ...
    private Tb02Bericht maakTb02Bericht(final Lo3Persoonslijst lo3PersoonsLijst) {
        final Tb02Bericht tb02Bericht =
                new Tb02VoornaamswijzigingBericht(BRON_GEMEENTE, AKTENUMMER, new Lo3Datum(20130115));
    ...
    public void testGettersEnSetters() throws Exception {
        final Lo3Persoonslijst pl = maakLo3Persoonslijst();
        final Tb02Bericht tb02Bericht = maakTb02Bericht(pl);
        ((Tb02VoornaamswijzigingBericht) tb02Bericht).setAktenummer(AKTENUMMER);
        ((Tb02VoornaamswijzigingBericht) tb02Bericht).setIngangsdatumGeldigheid(INGANGSDATUM);
        ((Tb02VoornaamswijzigingBericht) tb02Bericht).setRegistratieGemeente(BRON_GEMEENTE);
        ...
        assertEquals("Registratiegemeente ongelijk.", BRON_GEMEENTE,
                ((Tb02VoornaamswijzigingBericht) tb02Bericht).getRegistratieGemeente());
        assertEquals("Aktenummer ongelijk.", AKTENUMMER,
                ((Tb02VoornaamswijzigingBericht) tb02Bericht).getAktenummer());
        assertEquals("Aktenummer ongelijk.", INGANGSDATUM,
                ((Tb02VoornaamswijzigingBericht) tb02Bericht).getIngangsdatumGeldigheid());
