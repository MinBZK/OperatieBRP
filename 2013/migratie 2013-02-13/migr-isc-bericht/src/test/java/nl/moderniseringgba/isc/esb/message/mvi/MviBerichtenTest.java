...
public class MviBerichtenTest {
    ...
    private final MviBerichtFactory factory = new MviBerichtFactory();

    @Test
    public void testPlSync() throws Exception {
        testFormatAndParseBericht(new PlSyncBericht(maakLo3Persoonslijst()));
    }
    ...
    private void testFormatAndParseBericht(final MviBericht bericht) throws Exception {
        ...
        final MviBericht parsed = factory.getBericht(formatted);
        ...
        Assert.assertEquals(parsed.getMessageId(), ((MviBericht) deserialized).getMessageId());
    }
