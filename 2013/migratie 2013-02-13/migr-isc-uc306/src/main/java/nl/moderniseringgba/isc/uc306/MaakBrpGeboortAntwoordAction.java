...
/**
 * 
 * Maakt een BRP geboorte antwoord bericht aan zodat deze verzonden kan worden.
 * 
 */
@Component("uc306MaakBrpGeboorteAntwoordAction")
public class MaakBrpGeboortAntwoordAction implements SpringAction {
    ...
    public final Map<String, Object> execute(final Map<String, Object> parameters) {
        ...
        result.put("brpGeboorteAntwoordBericht", brpGeboorteAntwoordBericht);
