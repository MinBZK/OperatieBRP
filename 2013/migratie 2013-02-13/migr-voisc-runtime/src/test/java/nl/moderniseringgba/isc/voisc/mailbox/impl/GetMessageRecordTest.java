...
public class GetMessageRecordTest {
    ...
    public void testMessageBody() {
        ...
        final String getEnvelope =
                "00041" + "220" + "1234567" + "2" + "1" + "0408121045Z" + "0408121045Z" + "1831010";
        ...
        final GetMessageRecord gmr =
                new GetMessageRecord(msEntry + getEnvelope + messageHeading + messageBody + TERMINATOR);
        try {
    ...
    public void testStatusResult() {
        ...
        // ActualRecipientORName
        final String getEnvelope =
                "00041" + "220" + "1831010" + "2" + "1" + "0408121045Z" + "0408121045Z" + "1831010";
    ...
    public void testDeliveryReport() {
        ...
        final String deliveryReport =
                "00048" + "260" + "0408231236Z" + "081200200" + "001" + "1234567" + "           " + "0001";

        final GetMessageRecord gmr = new GetMessageRecord(msEntry + deliveryReport + TERMINATOR);
        try {
            gmr.determineMessageType();

            assertEquals("Verwacht een DELIVERY_REPORT type", GetMessageRecord.MT_DELIVERY_REPORT,
                    gmr.getMessageType());
            assertEquals(msEntry, gmr.getMsEntry());
    ...
    public void testGetMessageConfirmation() {
        ...
        try {
            ...
            assertEquals("Verwacht een MESSAGE_CONFIRMATION type", GetMessageRecord.MT_MESSAGE_CONFIRMATION,
                    gmr.getMessageType());
