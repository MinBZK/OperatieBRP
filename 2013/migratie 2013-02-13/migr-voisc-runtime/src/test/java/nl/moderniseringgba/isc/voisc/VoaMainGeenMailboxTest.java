...
@ContextConfiguration("classpath:inmemory-datasource.xml")
public class VoaMainGeenMailboxTest extends AbstractVoaMainTest {

    @Test
    public void test() {
        setupSecurityManager(5);
        final String[] args = new String[] { "localhost", "1213" };
        ...
        assertTrue("System exit door geen connectie naar mailbox.", systemExit);
    }
}
