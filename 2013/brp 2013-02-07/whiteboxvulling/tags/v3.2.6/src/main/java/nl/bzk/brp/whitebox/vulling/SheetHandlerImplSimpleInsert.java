            ...
            for (final Gemeente gemeente : Generator.gemeenten) {
                ...
                for (int ambtenaarCount = 0; ambtenaarCount < WhiteBoxFiller.ambtenarenCount; ambtenaarCount++) {
                    ...
                    for (int i = 0; i < colCountCopy; i++) {
                        ...
                        // if (getColValue(stringRowCopy, i, colCountCopy) != null && getColValue(stringRowCopy, i,
                        // colCountCopy).trim().length() > 0) {
                        // sbCopy.append(getColValue(stringRowCopy, i, colCountCopy));
                        // } else {
                        // sbCopy.append("\\N");
                        // }
                    }
