--RvdP-- Versie d.d. 9 juli 2012, aangepast voor september 2012.
...
--Antek- gewijzigd: kolomnaam 'betrokkene' gewijzigd in 'Pers'
...
--Antek-- gewijzigd: kolom 'tsreg'-> 'tijdstipreg'
...
--Antek- gewijzigd: kolomnaam 'betrokkene' gewijzigd in 'Pers'
--Antek- gewijzigd: kolomnaam 'ouderstatushis' gewijzigd in 'ouderschapstatushis'
...
--Antek-- gewijzigd: kolomnaam 'betrokkene' gewijzigd in 'Pers'    
--Antek-- gewijzigd: tabelnaam 'kern.his_betrouder' gewijzigd in 'kern.his_betrouderschap'
...
insert into kern.persnation (id, pers, nation, persnationstatushis)
	select id, id, 2, 'A' from kern.pers where srt=1;
...
insert into kern.his_persnation (id, persnation, dataanvgel, tsreg, actieinh)
	select A.id, A.id, B.datgeboorte, B.tsreg, B.actieinh from kern.persnation A, kern.his_persgeboorte B
...
--Antek-- gewijzigd: 'his_betrouder' -> 'his_betrouderschap'
...
--Antek-- gewijzigd: 'his_gem' -> 'his_partijgem'
...
--Antek-- gewijzigd: 'his_regelimplementatiesituat' -> 'his_regelsituatie'
