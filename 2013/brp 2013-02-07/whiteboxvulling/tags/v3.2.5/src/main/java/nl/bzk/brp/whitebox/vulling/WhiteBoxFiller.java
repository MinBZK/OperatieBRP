...
public class WhiteBoxFiller {
     ...
     *
     * @param ambtenarenSize de ambtenaren size
     * @param sqlFileName de sql file name
     * @param dbReset de db reset
     * @throws Exception de exception
     */
    private void runFromCommandLine(final Integer ambtenarenSize, final String sqlFileName, final Boolean dbReset)
            throws Exception
    {
    ...
    private void resetDatabase() throws Exception {
        ...
        final List<String> sqlFiles =
            Arrays.asList(new String[] { "brp.sql", "stamgegevensLand.sql", "stamgegevensNationaliteit.sql",
                "stamgegevensPlaats.sql", "stamgegevensStatisch.sql", "stamgegevensPartijGemeente.sql" , "stamgegevensVerkrijgingVerliesNLNationaliteit.sql"});
