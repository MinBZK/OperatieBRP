...
public class AbstractBmrTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testSpringContext() {
        ...
        Assert.assertTrue(this.applicationContext.containsBean("javaModelGenerator"));
    ...
    protected String toUnixString(final Writer writer) {
        return writer.toString().replace("${metaregister.version}", metaregisterVersie).replace("\r", "");
    }
}
