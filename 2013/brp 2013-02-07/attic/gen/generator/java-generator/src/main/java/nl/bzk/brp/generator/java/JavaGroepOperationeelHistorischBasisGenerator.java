...
@Component
@Transactional
public class JavaGroepOperationeelHistorischBasisGenerator extends AbstractGroepGenerator {
    ...
    public GenerationReport genereer() {
        ...
        for (Groep groep : groepen) {
            Writer writer = creeerWriter(getTypeIdentifier(groep).getUpperCamel());
    ...
    public void genereerElement(final Writer writer, final GenerationReport report, final Groep groep) {
        ...
        type.addImport(GenerationPackageNames.OBJECTTYPE_OPERATIONEEL_PACKAGE.createImportStatement(new Identifier(fieldType)));
    ...
    private Identifier getTypeIdentifier(final Groep groep) {
