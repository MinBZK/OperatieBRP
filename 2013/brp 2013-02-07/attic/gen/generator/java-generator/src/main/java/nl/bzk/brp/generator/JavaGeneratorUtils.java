...
public class JavaGeneratorUtils {
    ...
    public static boolean isId(final Attribuut attribuut) {
        return "ID".equalsIgnoreCase(attribuut.getIdentDb());
    }

    public static String createImportStatement(final GeneriekElement element) {
        return JavaGeneratorUtils.getImportPackageForGroup(element).createImportStatement(new Identifier(getJavaType(element)));
    }
    ...
    public static String getJavaType(final GeneriekElement type) {
        String resultaat = new Identifier(type.getIdentCode()).toString();
