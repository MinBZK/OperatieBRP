...
public class JavaObjectTypeLogischGenerator extends AbstractJavaGenerator<ObjectType> {
    ...
    private String genereerObjectType(final ObjectType objectType) {
        ...
        objectInterface.addExtendInterface(interfaceDefinition);
        objectInterface.addExtendInterface("RootObject");
        ...
        objectInterface.addImport(GenerationPackageNames.OBJECTTYPE_LOGISCH_BASIS_PACKAGE.createImportStatement(new Identifier(interfaceDefinition)));
