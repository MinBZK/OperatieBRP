...
public class BsnLockerImpl implements BsnLocker {
        ...
        try {
            ...
            String message =
                MessageFormatter.arrayFormat(
                        "Kan geen read-locks krijgen voor BSN's {} en/of write-locks voor BSN's {}, referentie nummer {}.",
                        new Object[] { readBsnLocks, writeBsnLocks, referentieNummer}).getMessage();
     ...
     * @param referentieNummer referentie naar een bericht
    ...
    private void creeerConnectieVoorTransactieEnPlaatsLock(final Collection<String> readBsnLocks,
        final Collection<String> writeBsnLocks, final Long referentieNummer) throws SQLException
    {
        /*
