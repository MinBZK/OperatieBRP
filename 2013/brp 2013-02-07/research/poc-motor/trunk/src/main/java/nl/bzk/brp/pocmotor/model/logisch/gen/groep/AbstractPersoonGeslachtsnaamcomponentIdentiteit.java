...
public abstract class AbstractPersoonGeslachtsnaamcomponentIdentiteit extends AbstractGroep {
   ...
   public PersoonGeslachtsnaamID getID() {
      return iD;
   }

   public void setID(final PersoonGeslachtsnaamID iD) {
      this.iD = iD;
   }
