...
public abstract class AbstractRelatie extends AbstractTabel {
   ...
   @AttributeOverride(name = "waarde", column = @Column(name = "RelatieStatusHis"))
   protected StatusHistorie relatieStatusHis;
   ...
   public StatusHistorie getRelatieStatusHis() {
      return relatieStatusHis;
   }

   public void setRelatieStatusHis(final StatusHistorie relatieStatusHis) {
