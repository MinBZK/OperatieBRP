...
public interface PersoonGeslachtsnaamComponentOGMRepositoryCustom {

    void verwerkGeslachtsNaamWijzigingInHistorie(final PersoonGeslachtsnaamcomponent persGeslachtsNaamComp,
