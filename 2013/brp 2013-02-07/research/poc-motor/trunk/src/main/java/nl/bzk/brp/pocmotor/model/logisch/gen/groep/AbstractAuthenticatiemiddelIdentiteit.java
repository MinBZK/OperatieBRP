...
public abstract class AbstractAuthenticatiemiddelIdentiteit extends AbstractGroep {
   ...
   public AuthenticatiemiddelID getID() {
      return iD;
   }

   public void setID(final AuthenticatiemiddelID iD) {
      this.iD = iD;
   }
