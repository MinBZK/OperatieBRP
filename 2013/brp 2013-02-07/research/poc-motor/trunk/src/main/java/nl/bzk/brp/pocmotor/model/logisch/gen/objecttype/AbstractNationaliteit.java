...
public abstract class AbstractNationaliteit extends AbstractStatischObjectType {
   ...
   // Groepen
   protected NationaliteitIdentiteit identiteit = new NationaliteitIdentiteit();
   ...
   public void setId(final Integer id) {
        if (identiteit == null) {
            identiteit = new NationaliteitIdentiteit();
        }
        identiteit.setID(new NationaliteitID());
        identiteit.getID().setWaarde(id);
   }

   public NationaliteitIdentiteit getIdentiteit() {
      return identiteit;
   }

   public void setIdentiteit(final NationaliteitIdentiteit identiteit) {
