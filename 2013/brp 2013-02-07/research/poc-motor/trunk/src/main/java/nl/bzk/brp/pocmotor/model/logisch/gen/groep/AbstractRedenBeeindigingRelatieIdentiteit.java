...
public abstract class AbstractRedenBeeindigingRelatieIdentiteit extends AbstractGroep {
   ...
   public RedenBeeindigingRelatieID getID() {
      return iD;
   }

   public void setID(final RedenBeeindigingRelatieID iD) {
      this.iD = iD;
   }
