...
import nl.bzk.brp.pocmotor.model.logisch.usr.groep.RegelIdentiteit;
...
public abstract class AbstractRegel extends AbstractStatischObjectType {

   // Groepen
   protected RegelIdentiteit identiteit = new RegelIdentiteit();
   ...
   public void setId(final Integer id) {
        if (identiteit == null) {
            identiteit = new RegelIdentiteit();
        }
        identiteit.setID(new RegelID());
        identiteit.getID().setWaarde(id);
   }

   public RegelIdentiteit getIdentiteit() {
      return identiteit;
   }

   public void setIdentiteit(final RegelIdentiteit identiteit) {
