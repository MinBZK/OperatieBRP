...
public interface AangeverAdreshoudingLGMRepository extends JpaRepository<AangeverAdreshouding, Long> {

    AangeverAdreshouding findByIdentiteitCode(final AangeverAdreshoudingCode code);
}
