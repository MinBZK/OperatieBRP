...
import nl.bzk.brp.pocmotor.model.gedeeld.gen.attribuuttype.AbstractProtocolleringsniveauCode;

/**
 * Protocolleringsniveau code

 */
@Embeddable
public class ProtocolleringsniveauCode extends AbstractProtocolleringsniveauCode {

    public ProtocolleringsniveauCode() {
        super();
    }
