...
public interface RedenWijzigingAdresLGMRepository extends JpaRepository<RedenWijzigingAdres, Short> {

    RedenWijzigingAdres findByIdentiteitCode(final RedenWijzigingAdresCode redenWijzigingAdresCode);
}
