...
import nl.bzk.brp.pocmotor.model.gedeeld.usr.attribuuttype.His_PersoonAdresID;
...
import nl.bzk.brp.pocmotor.model.operationeel.usr.tabel.PersoonAdres;
...
public abstract class AbstractHis_PersoonAdres extends AbstractMaterieleEnFormeleHisTabel {

   @Transient
   protected His_PersoonAdresID id;

   @ManyToOne
   @JoinColumn(name = "PersAdres")
   protected PersoonAdres persoonAdres;
   ...
   @Id
   @SequenceGenerator(name = "seq_His_PersAdres", sequenceName = "Kern.seq_His_PersAdres")
   @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_His_PersAdres")
