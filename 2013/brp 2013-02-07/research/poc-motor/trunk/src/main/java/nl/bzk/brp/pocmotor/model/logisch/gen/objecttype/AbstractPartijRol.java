...
import nl.bzk.brp.pocmotor.model.logisch.usr.groep.PartijRolIdentiteit;
...
public abstract class AbstractPartijRol extends AbstractStatischObjectType {
   ...
   // Groepen
   protected PartijRolIdentiteit identiteit = new PartijRolIdentiteit();
   ...
   public void setId(final Integer id) {
        if (identiteit == null) {
            identiteit = new PartijRolIdentiteit();
        }
        identiteit.setID(new PartijRolID());
        identiteit.getID().setWaarde(id);
   }

   public PartijRolIdentiteit getIdentiteit() {
      return identiteit;
   }

   public void setIdentiteit(final PartijRolIdentiteit identiteit) {
