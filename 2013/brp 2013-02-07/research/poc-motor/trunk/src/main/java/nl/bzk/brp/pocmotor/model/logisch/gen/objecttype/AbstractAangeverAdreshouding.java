...
import nl.bzk.brp.pocmotor.model.logisch.usr.groep.AangeverAdreshoudingIdentiteit;
...
public abstract class AbstractAangeverAdreshouding extends AbstractStatischObjectType {
   ...
   // Groepen
   protected AangeverAdreshoudingIdentiteit identiteit = new AangeverAdreshoudingIdentiteit();
   ...
   public void setId(final Short id) {
        if (identiteit == null) {
            identiteit = new AangeverAdreshoudingIdentiteit();
        }
        identiteit.setID(new AangeverAdreshoudingID());
        identiteit.getID().setWaarde(id);
   }

   public AangeverAdreshoudingIdentiteit getIdentiteit() {
      return identiteit;
   }

   public void setIdentiteit(final AangeverAdreshoudingIdentiteit identiteit) {
