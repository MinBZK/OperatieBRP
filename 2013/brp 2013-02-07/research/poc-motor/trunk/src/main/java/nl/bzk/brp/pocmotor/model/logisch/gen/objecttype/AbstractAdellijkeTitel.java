...
import nl.bzk.brp.pocmotor.model.logisch.usr.groep.AdellijkeTitelIdentiteit;
...
public abstract class AbstractAdellijkeTitel extends AbstractStatischObjectType {
   ...
   // Groepen
   protected AdellijkeTitelIdentiteit identiteit = new AdellijkeTitelIdentiteit();
   ...
   public void setId(final Short id) {
        if (identiteit == null) {
            identiteit = new AdellijkeTitelIdentiteit();
        }
        identiteit.setID(new AdellijkeTitelID());
        identiteit.getID().setWaarde(id);
   }

   public AdellijkeTitelIdentiteit getIdentiteit() {
      return identiteit;
   }

   public void setIdentiteit(final AdellijkeTitelIdentiteit identiteit) {
