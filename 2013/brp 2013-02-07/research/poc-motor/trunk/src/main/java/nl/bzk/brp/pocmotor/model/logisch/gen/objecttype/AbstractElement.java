...
import nl.bzk.brp.pocmotor.model.logisch.usr.groep.ElementIdentiteit;
...
public abstract class AbstractElement extends AbstractStatischObjectType {

   // Groepen
   protected ElementIdentiteit identiteit = new ElementIdentiteit();
   ...
   public void setId(final Integer id) {
        if (identiteit == null) {
            identiteit = new ElementIdentiteit();
        }
        identiteit.setID(new ElementID());
        identiteit.getID().setWaarde(id);
   }

   public ElementIdentiteit getIdentiteit() {
      return identiteit;
   }

   public void setIdentiteit(final ElementIdentiteit identiteit) {
