 ...
 */
public class BsnValidator implements ConstraintValidator<Bsn, Burgerservicenummer> {
    ...
    @Override
    public boolean isValid(final Burgerservicenummer bsn, final ConstraintValidatorContext context) {
        boolean resultaat;
     ...
     */
    private boolean isGeldigeBsn(final Burgerservicenummer bsn) {
        boolean resultaat = false;
        final String waarde = bsn.getWaarde();
