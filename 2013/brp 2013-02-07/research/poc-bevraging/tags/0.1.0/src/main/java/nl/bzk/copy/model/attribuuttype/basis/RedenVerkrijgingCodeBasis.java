...
/**
 * RedenVerkrijgingCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class RedenVerkrijgingCodeBasis extends AbstractStatischAttribuutType<Short> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RedenVerkrijgingCodeBasis() {
        super(null);
    }
     ...
     */
    public RedenVerkrijgingCodeBasis(final Short waarde) {
        super(waarde);
    }
}
