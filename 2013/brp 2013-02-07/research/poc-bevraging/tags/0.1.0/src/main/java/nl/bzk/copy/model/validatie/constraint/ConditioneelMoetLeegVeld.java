...
import nl.bzk.copy.model.validatie.validator.ConditioneelVerplichtVeldValidator;
...
public @interface ConditioneelMoetLeegVeld {
    ...
    /**
     * Veld dat verplicht LEEG moet zijn afhankelijk van de waarde (bevatWaarde) in de veld gespecificeerd in
     * naamAfhankelijkVeld.
     */
    String naamLeegVeld();
