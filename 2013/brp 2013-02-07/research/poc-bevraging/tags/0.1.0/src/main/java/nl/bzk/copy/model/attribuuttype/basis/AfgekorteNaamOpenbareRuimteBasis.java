...
/**
 * AfgekorteNaamOpenbareRuimteBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class AfgekorteNaamOpenbareRuimteBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private AfgekorteNaamOpenbareRuimteBasis() {
        super(null);
    }
     ...
     */
    public AfgekorteNaamOpenbareRuimteBasis(final String waarde) {
        super(waarde);
    }
}
