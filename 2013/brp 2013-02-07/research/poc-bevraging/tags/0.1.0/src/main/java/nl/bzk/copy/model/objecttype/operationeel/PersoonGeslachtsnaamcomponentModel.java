...
import nl.bzk.copy.model.objecttype.operationeel.basis.AbstractPersoonGeslachtsnaamcomponentModel;
        ...
        PersoonGeslachtsnaamcomponent
{
     ...
     * @param pers     Persoon
     */
    public PersoonGeslachtsnaamcomponentModel(final PersoonGeslachtsnaamcomponentBasis geslComp,
     ...
     */
    public PersoonGeslachtsnaamcomponentModel() {
    }
}
