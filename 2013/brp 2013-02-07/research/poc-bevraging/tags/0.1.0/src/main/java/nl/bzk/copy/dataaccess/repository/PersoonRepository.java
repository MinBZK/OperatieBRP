...
/** Repository voor de {@link nl.bzk.copy.model.objecttype.operationeel.PersoonModel} class. */
@Repository
public interface PersoonRepository {
     ...
     *
     * @param persoon .
     * @param inclFormeleHistorie .
     */
    void vulaanAdresMetHistorie(final PersoonModel persoon, boolean inclFormeleHistorie);
}
