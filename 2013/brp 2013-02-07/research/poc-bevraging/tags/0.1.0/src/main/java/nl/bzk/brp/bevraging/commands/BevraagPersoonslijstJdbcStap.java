 ...
 */
@Component
public class BevraagPersoonslijstJdbcStap implements Command {

    private static final Logger LOGGER = LoggerFactory.getLogger(BevraagPersoonslijstJdbcStap.class);
