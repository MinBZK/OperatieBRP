...
/**
 * LangeNaamEnumeratiewaardeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class LangeNaamEnumeratiewaardeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private LangeNaamEnumeratiewaardeBasis() {
        super(null);
    }
     ...
     */
    public LangeNaamEnumeratiewaardeBasis(final String waarde) {
        super(waarde);
    }
}
