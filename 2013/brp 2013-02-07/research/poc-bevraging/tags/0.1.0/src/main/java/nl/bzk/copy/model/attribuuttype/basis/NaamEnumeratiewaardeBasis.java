...
/**
 * NaamEnumeratiewaardeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class NaamEnumeratiewaardeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private NaamEnumeratiewaardeBasis() {
        super(null);
    }
     ...
     */
    public NaamEnumeratiewaardeBasis(final String waarde) {
        super(waarde);
    }
}
