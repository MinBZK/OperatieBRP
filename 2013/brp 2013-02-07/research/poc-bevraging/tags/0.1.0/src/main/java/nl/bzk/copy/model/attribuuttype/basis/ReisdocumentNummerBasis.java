...
/**
 * ReisdocumentNummerBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class ReisdocumentNummerBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private ReisdocumentNummerBasis() {
        super(null);
    }
     ...
     */
    public ReisdocumentNummerBasis(final String waarde) {
        super(waarde);
    }
}
