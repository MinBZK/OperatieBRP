...
import nl.bzk.copy.model.groep.operationeel.historisch.basis.AbstractPersoonSamengesteldeNaamHisModel;
import nl.bzk.copy.model.objecttype.operationeel.PersoonModel;


/**
 * User implementatie van PersoonSamengesteldeNaamHis.
 */
@Entity
