...
public abstract class ISO31661Alpha2Basis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private ISO31661Alpha2Basis() {
        super(null);
    }
     ...
     */
    public ISO31661Alpha2Basis(final String waarde) {
        super(waarde);
    }
}
