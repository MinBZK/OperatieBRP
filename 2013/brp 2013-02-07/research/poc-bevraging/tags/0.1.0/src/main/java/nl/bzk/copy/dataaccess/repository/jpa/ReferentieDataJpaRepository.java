...
import nl.bzk.copy.dataaccess.exceptie.OnbekendeReferentieExceptie;
import nl.bzk.copy.dataaccess.repository.ReferentieDataRepository;
 ...
 * {@link nl.bzk.copy.dataaccess.repository.ReferentieDataRepository} class.
 */
@Repository
class ReferentieDataJpaRepository implements ReferentieDataRepository {

    private static final Logger LOGGER = LoggerFactory.getLogger(
            nl.bzk.copy.dataaccess.repository.jpa.ReferentieDataJpaRepository.class);
