...
/**
 * SoortPersoonCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class SoortPersoonCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SoortPersoonCodeBasis() {
        super(null);
    }
     ...
     */
    public SoortPersoonCodeBasis(final String waarde) {
        super(waarde);
    }
}
