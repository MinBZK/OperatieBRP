...
public abstract class GemeentecodeBasis extends AbstractStatischAttribuutType<Short> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private GemeentecodeBasis() {
        super(null);
    }
     ...
     */
    public GemeentecodeBasis(final Short waarde) {
        super(waarde);
    }
}
