...
package nl.bzk.copy.model.validatie.validator;

import javax.validation.ConstraintValidator;
import javax.validation.ConstraintValidatorContext;

import nl.bzk.copy.model.validatie.constraint.Postcode;
 ...
 */
public class PostcodeValidator implements ConstraintValidator<Postcode, nl.bzk.copy.model.attribuuttype.Postcode> {
    ...
    @Override
    public boolean isValid(final nl.bzk.copy.model.attribuuttype.Postcode postcode,
     ...
     */
    private boolean isGeldigePostcode(final nl.bzk.copy.model.attribuuttype.Postcode postcode) {
