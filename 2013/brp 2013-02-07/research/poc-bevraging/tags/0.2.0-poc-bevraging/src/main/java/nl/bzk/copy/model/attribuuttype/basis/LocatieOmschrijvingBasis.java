...
/**
 * LocatieOmschrijvingBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class LocatieOmschrijvingBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private LocatieOmschrijvingBasis() {
        super(null);
    }
     ...
     */
    public LocatieOmschrijvingBasis(final String waarde) {
        super(waarde);
    }
}
