...
import nl.bzk.copy.model.objecttype.operationeel.AuthenticatieMiddelModel;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;


/** Spring data JPA repository voor {@link nl.bzk.copy.model.objecttype.operationeel.AuthenticatieMiddelModel}. */
public interface AuthenticatieMiddelRepository extends JpaRepository<AuthenticatieMiddelModel, Integer> {
    ...
    List<AuthenticatieMiddelModel> zoekAuthMiddelenVoorPartijMetCertificaat(final Short partijId, final Subject subject,
                                                                            final Serial serial,
