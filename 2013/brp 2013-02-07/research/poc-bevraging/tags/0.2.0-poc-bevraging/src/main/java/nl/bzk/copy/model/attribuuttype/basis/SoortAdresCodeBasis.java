...
public abstract class SoortAdresCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SoortAdresCodeBasis() {
        super(null);
    }
     ...
     */
    public SoortAdresCodeBasis(final String waarde) {
        super(waarde);
    }
}
