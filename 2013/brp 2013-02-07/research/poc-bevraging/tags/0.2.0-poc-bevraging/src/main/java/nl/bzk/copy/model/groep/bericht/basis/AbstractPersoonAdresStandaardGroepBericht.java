...
@ConditioneelVerplichteVelden({
                                      ...
                                      @ConditioneelVerplichtVeld(naamVerplichtVeld = "soort",
                                                                 naamAfhankelijkVeld = "land.code",
                                                                 waardeAfhankelijkVeld = BrpConstanten.NL_LAND_CODE_STRING,
                                                                 code = MeldingCode.BRAL2032, message = "BRAL2032"),
                                      @ConditioneelVerplichtVeld(naamVerplichtVeld = "datumAanvangAdreshouding",
                                                                 naamAfhankelijkVeld = "land.code",
                                                                 waardeAfhankelijkVeld = BrpConstanten.NL_LAND_CODE_STRING,
                                                                 code = MeldingCode.BRAL2033, message = "BRAL2033"),
                                      @ConditioneelVerplichtVeld(naamVerplichtVeld = "gemeente.gemeentecode",
                                                                 naamAfhankelijkVeld = "land.code",
                                                                 waardeAfhankelijkVeld = BrpConstanten.NL_LAND_CODE_STRING,
                                                                 code = MeldingCode.BRAL2033, message = "BRAL2033"),
                                      @ConditioneelVerplichtVeld(
                                              naamVerplichtVeld = "redenwijziging.redenWijzigingAdresCode",
                                              naamAfhankelijkVeld = "land.code",
                                              waardeAfhankelijkVeld = BrpConstanten.NL_LAND_CODE_STRING,
                                              code = MeldingCode.BRAL2033, message = "BRAL2033"),
                                      @ConditioneelVerplichtVeld(naamVerplichtVeld = "aangeverAdreshouding",
                                                                 naamAfhankelijkVeld = "redenwijziging.redenWijzigingAdresCode",
