...
/**
 * SoortMeldingCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class SoortMeldingCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SoortMeldingCodeBasis() {
        super(null);
    }
     ...
     */
    public SoortMeldingCodeBasis(final String waarde) {
        super(waarde);
    }
}
