...
/**
 * NaamOpenbareRuimteBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class NaamOpenbareRuimteBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private NaamOpenbareRuimteBasis() {
        super(null);
    }
     ...
     */
    public NaamOpenbareRuimteBasis(final String waarde) {
        super(waarde);
    }
}
