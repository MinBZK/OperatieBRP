...
/**
 * SoortNederlandsReisdocumentCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class SoortNederlandsReisdocumentCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SoortNederlandsReisdocumentCodeBasis() {
        super(null);
    }
     ...
     */
    public SoortNederlandsReisdocumentCodeBasis(final String waarde) {
        super(waarde);
    }
}
