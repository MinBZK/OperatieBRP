...
/**
 * Repository voor de {@link nl.bzk.copy.model.objecttype.operationeel.PersoonAdresModel} class en standaard implementatie van de
 * {@link nl.bzk.copy.dataaccess.repository.PersoonAdresRepository} class.
 */
@Repository
