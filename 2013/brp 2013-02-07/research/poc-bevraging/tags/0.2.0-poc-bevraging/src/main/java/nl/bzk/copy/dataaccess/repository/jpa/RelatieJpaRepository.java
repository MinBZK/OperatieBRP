...
import nl.bzk.copy.dataaccess.exceptie.VerplichteDataNietAanwezigExceptie;
import nl.bzk.copy.dataaccess.repository.RelatieRepository;
import nl.bzk.copy.dataaccess.repository.historie.BetrokkenheidOuderlijkgezagHistorieRepository;
...
import nl.bzk.copy.dataaccess.selectie.RelatieSelectieFilter;
...
/**
 * JPA specifieke implementatie van de {@link nl.bzk.copy.dataaccess.repository.RelatieRepository} repository.
...
public class RelatieJpaRepository implements RelatieRepository {
    ...
    private static final Logger LOGGER =
        LoggerFactory.getLogger(nl.bzk.copy.dataaccess.repository.jpa.RelatieJpaRepository.class);
