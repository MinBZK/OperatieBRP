...
package nl.bzk.copy.dataaccess.repository.jpa;
...
import nl.bzk.copy.dataaccess.exceptie.ObjectReedsBestaandExceptie;
import nl.bzk.copy.dataaccess.repository.PersoonAdresRepository;
...
import nl.bzk.copy.dataaccess.repository.historie.PersoonAdresHistorieRepository;
...
import nl.bzk.copy.model.attribuuttype.Huisletter;
import nl.bzk.copy.model.attribuuttype.Huisnummer;
import nl.bzk.copy.model.attribuuttype.Huisnummertoevoeging;
import nl.bzk.copy.model.attribuuttype.IdentificatiecodeNummeraanduiding;
import nl.bzk.copy.model.attribuuttype.NaamOpenbareRuimte;
import nl.bzk.copy.model.attribuuttype.Postcode;
import nl.bzk.copy.model.basis.AttribuutType;
...
import nl.bzk.copy.model.groep.operationeel.historisch.PersoonBijhoudingsverantwoordelijkheidHisModel;
import nl.bzk.copy.model.groep.operationeel.historisch.PersoonGeslachtsaanduidingHisModel;
...
import nl.bzk.copy.model.groep.operationeel.historisch.PersoonSamengesteldeNaamHisModel;
import nl.bzk.copy.model.groep.operationeel.historisch.PersoonVoornaamHisModel;
...
/**
 * Repository voor de {@link nl.bzk.copy.model.objecttype.operationeel.PersoonModel} class en standaard implementatie
 * van de {@link nl.bzk.copy.dataaccess.repository.PersoonRepository} class.
 */
@Repository
public class PersoonJpaRepository implements PersoonRepository {

    private static final Logger LOGGER = LoggerFactory.getLogger(
            nl.bzk.copy.dataaccess.repository.jpa.PersoonJpaRepository.class);
    ...
    private Object creerZelfdeTypeUppercased(final AttribuutType<String> origineel) {
        if (origineel != null && origineel.getWaarde() != null) {
            try {
                Constructor cons = origineel.getClass().getConstructor(String.class);
