...
import nl.bzk.copy.model.validatie.constraint.Datum;
 ...
 */
public class DatumValidator implements ConstraintValidator<Datum, nl.bzk.copy.model.attribuuttype.Datum> {
    ...
    @Override
    public boolean isValid(final nl.bzk.copy.model.attribuuttype.Datum datum,
     ...
     */
    private boolean isGeldigeDatum(final nl.bzk.copy.model.attribuuttype.Datum datum) {
