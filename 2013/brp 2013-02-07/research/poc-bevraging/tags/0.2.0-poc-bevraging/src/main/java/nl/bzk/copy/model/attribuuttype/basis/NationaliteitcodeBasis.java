...
/**
 * NationaliteitcodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class NationaliteitcodeBasis extends AbstractStatischAttribuutType<Short> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private NationaliteitcodeBasis() {
        super(null);
    }
     ...
     */
    public NationaliteitcodeBasis(final Short waarde) {
        super(waarde);
    }
}
