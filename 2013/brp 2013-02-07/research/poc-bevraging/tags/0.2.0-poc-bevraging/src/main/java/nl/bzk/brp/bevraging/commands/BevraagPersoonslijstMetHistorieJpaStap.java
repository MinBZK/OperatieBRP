 ...
 */
@Service
public class BevraagPersoonslijstMetHistorieJpaStap implements Command {

    private static final Logger LOGGER = LoggerFactory.getLogger(BevraagPersoonslijstMetHistorieJpaStap.class);
    ...
    class BevraagDB implements Callable<BevraagInfo> {
        ...
        public BevraagInfo call() {
            ...
            PersoonsLijst lijst =  persoonsLijstService.getPersoonsLijstMetHistorieJpa(this.bsn);
