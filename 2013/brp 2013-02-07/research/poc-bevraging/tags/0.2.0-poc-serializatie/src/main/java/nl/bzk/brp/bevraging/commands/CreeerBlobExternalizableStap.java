...
import nl.bzk.brp.dataaccess.repository.jpa.serialization.ExternalizableBlobSerializer;
 ...
 */
@Component
public class CreeerBlobExternalizableStap extends AbstractAsynchroonStap {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreeerBlobExternalizableStap.class);
    ...
    public boolean doExecute(final Context context) throws Exception {
        blobOpslagplaats.setBlobSerializer(new ExternalizableBlobSerializer());
