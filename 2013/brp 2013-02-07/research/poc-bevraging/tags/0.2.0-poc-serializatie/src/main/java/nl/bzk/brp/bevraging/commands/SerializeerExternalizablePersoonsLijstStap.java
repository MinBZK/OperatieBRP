 ...
 */
@Component
public class SerializeerExternalizablePersoonsLijstStap extends AbstractAsynchroonStap {

    private static final Logger LOGGER = LoggerFactory.getLogger(SerializeerExternalizablePersoonsLijstStap.class);
