...
import nl.bzk.brp.dataaccess.repository.PlBlobOpslagplaats;
import nl.bzk.brp.dataaccess.repository.jpa.serialization.JacksonSmileAfterburnerBlobSerializer;
 ...
 */
@Component
public class CreeerBlobAfterburnerStap extends AbstractAsynchroonStap {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreeerBlobAfterburnerStap.class);
    ...
    public boolean doExecute(final Context context) throws Exception {
        blobOpslagplaats.setBlobSerializer(new JacksonSmileAfterburnerBlobSerializer());
    ...
    class CreeerBlob implements Callable<BevraagInfo> {
        ...
        public BevraagInfo call() {
            ...
            try {
                ...
                model = blobOpslagplaats.leesPlBlob(persoon.getId());
