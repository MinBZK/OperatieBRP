 ...
 */
@Component
public class SerializeerAfterburnerPersoonsLijstStap extends AbstractAsynchroonStap {

    private static final Logger LOGGER = LoggerFactory.getLogger(SerializeerAfterburnerPersoonsLijstStap.class);
