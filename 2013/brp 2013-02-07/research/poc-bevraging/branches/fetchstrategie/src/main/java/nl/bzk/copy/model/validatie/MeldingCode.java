...
public enum MeldingCode {
     ...
     */
    BRAL0203(
            "Datum aanvang betrokkenheid mag alleen gevuld worden voor familierechtelijke betrekkingen, en dan voor de rol van Ouder."),
    /**
     ...
     */
    BRBY0165(
            "Het is verplicht om een reden verkrijging op te geven bij het verkrijgen van de Nederlandse nationaliteit"),
