...
/**
 * RedenWijzigingAdresCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class RedenWijzigingAdresCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RedenWijzigingAdresCodeBasis() {
        super(null);
    }
     ...
     */
    public RedenWijzigingAdresCodeBasis(final String waarde) {
        super(waarde);
    }
}
