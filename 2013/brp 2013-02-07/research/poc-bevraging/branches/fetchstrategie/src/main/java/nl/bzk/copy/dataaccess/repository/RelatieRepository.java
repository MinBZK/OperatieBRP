...
/** Repository voor de {@link nl.bzk.copy.model.objecttype.operationeel.RelatieModel} class. */
@Repository
public interface RelatieRepository {
     ...
     * {@link nl.bzk.copy.model.objecttype.operationeel.RelatieModel} instantie aanwezig zijn.
     *
    ...
    List<RelatieModel> vindSoortRelatiesMetPersonenInRol(final PersoonModel persoon1, final PersoonModel persoon2,
                                                         ...
                                                         final Datum peilDatum, final SoortRelatie... soorten);
