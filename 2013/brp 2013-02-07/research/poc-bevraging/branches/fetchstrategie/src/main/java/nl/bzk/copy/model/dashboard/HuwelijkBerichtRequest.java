 ...
 */
public class HuwelijkBerichtRequest extends nl.bzk.copy.model.dashboard.AbstractBerichtRequest {

    private final nl.bzk.copy.model.dashboard.Datum datumAanvang = new Datum();
