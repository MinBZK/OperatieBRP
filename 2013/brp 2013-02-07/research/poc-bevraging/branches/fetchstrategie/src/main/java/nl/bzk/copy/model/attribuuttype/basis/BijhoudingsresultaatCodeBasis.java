...
/**
 * BijhoudingsresultaatCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class BijhoudingsresultaatCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private BijhoudingsresultaatCodeBasis() {
        super(null);
    }
     ...
     */
    public BijhoudingsresultaatCodeBasis(final String waarde) {
        super(waarde);
    }
}
