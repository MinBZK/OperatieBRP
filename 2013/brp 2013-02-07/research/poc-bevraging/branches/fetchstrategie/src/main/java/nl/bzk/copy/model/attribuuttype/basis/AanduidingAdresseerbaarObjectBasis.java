...
/**
 * AanduidingAdresseerbaarObjectBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class AanduidingAdresseerbaarObjectBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private AanduidingAdresseerbaarObjectBasis() {
        super(null);
    }
     ...
     */
    public AanduidingAdresseerbaarObjectBasis(final String waarde) {
        super(waarde);
    }
}
