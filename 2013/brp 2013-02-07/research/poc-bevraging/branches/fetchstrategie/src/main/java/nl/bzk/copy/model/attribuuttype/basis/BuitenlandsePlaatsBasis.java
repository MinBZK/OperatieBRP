...
/**
 * BuitenlandsePlaatsBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class BuitenlandsePlaatsBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private BuitenlandsePlaatsBasis() {
        super(null);
    }
     ...
     */
    public BuitenlandsePlaatsBasis(final String waarde) {
        super(waarde);
    }
}
