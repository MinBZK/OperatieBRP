...
public abstract class GemeentedeelBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private GemeentedeelBasis() {
        super(null);
    }
     ...
     */
    public GemeentedeelBasis(final String waarde) {
        super(waarde);
    }
}
