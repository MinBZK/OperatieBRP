...
package nl.bzk.copy.model.binding;

import java.util.HashMap;
import java.util.Map;

import nl.bzk.copy.model.attribuuttype.Ja;
import nl.bzk.copy.model.groep.bericht.PersoonIndicatieStandaardGroepBericht;
...
public class PersoonIndicatieMapper implements IMarshaller, IUnmarshaller, IAliasable {
    ...
    /**
     * Retourneert de {@link nl.bzk.copy.model.objecttype.operationeel.statisch.SoortIndicatie} op basis van de opgegeven indicatie naam. Indien de naam onbekend is, zal
