...
import nl.bzk.copy.model.objecttype.bericht.basis.AbstractPersoonNationaliteitBericht;
        ...
        if (!(obj instanceof PersoonNationaliteitBericht)) {
            ...
            if (this == obj) {
                ...
                resultaat = new EqualsBuilder()
                        ...
                        .append(getNationaliteit().getNationaliteitcode(), pn.getNationaliteit().getNationaliteitcode())
                        .isEquals();
            }
        }
        return resultaat;
