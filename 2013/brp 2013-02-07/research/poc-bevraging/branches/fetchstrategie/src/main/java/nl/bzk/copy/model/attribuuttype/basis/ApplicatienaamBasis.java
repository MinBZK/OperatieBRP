...
public abstract class ApplicatienaamBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private ApplicatienaamBasis() {
        super(null);
    }
     ...
     */
    public ApplicatienaamBasis(final String waarde) {
        super(waarde);
    }
}
