...
/**
 * AutoriteitVanAfgifteReisdocumentCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class AutoriteitVanAfgifteReisdocumentCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private AutoriteitVanAfgifteReisdocumentCodeBasis() {
        super(null);
    }
     ...
     */
    public AutoriteitVanAfgifteReisdocumentCodeBasis(final String waarde) {
        super(waarde);
    }
}
