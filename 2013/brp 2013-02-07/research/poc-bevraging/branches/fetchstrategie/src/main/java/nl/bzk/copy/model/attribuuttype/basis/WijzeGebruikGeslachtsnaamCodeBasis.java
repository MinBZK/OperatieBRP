...
/**
 * WijzeGebruikGeslachtsnaamCodeBasis.
 *
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class WijzeGebruikGeslachtsnaamCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private WijzeGebruikGeslachtsnaamCodeBasis() {
        super(null);
    }
     ...
     */
    public WijzeGebruikGeslachtsnaamCodeBasis(final String waarde) {
        super(waarde);
    }
}
