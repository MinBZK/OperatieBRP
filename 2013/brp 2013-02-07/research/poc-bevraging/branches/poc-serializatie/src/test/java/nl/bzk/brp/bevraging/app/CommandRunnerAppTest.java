...
public class CommandRunnerAppTest {
    ...
    public void setUp() throws Exception {
        ...
        context.put(ContextParameterNames.SCENARIO, "bevragen-jpa");
    }
    ...
    public void verifyScenarioBevragingJpa() {
        ...
        Assert.assertThat(lijst.size(), Matchers.lessThanOrEqualTo(aantalLijsten));
    }
