...
import nl.bzk.brp.model.groep.logisch.PersoonIndicatieStandaardGroep;
...
public class PersoonsLijst {
    ...
    private String identificatieNummersToString(PersoonIdentificatienummersGroep identificatienummers) {
        ...
        String bsn = identificatienummers.getBurgerservicenummer() != null ?
                identificatienummers.getBurgerservicenummer().getWaarde() : "[BSN]";
    ...
    private String aanschrijvingToString(PersoonAanschrijvingGroep aanschrijving, Geslachtsaanduiding geslacht) {
        ...
        String geslachtsnaam =
                aanschrijving.getGeslachtsnaam() != null ? aanschrijving.getGeslachtsnaam().getWaarde() : "";
    ...
    private String geboorteToString(PersoonGeboorteGroep geboorte) {
        ...
        String omschr = geboorte.getOmschrijvingGeboorteLocatie() != null ?
                geboorte.getOmschrijvingGeboorteLocatie().getWaarde() : "[omschr]";
    ...
    private String nationaliteitToString(PersoonNationaliteit nationaliteit) {
        ...
        String reden = nationaliteit.getGegevens() != null &&
                nationaliteit.getGegevens().getRedenVerkregenNlNationaliteit() != null ?
                nationaliteit.getGegevens().getRedenVerkregenNlNationaliteit().getOmschrijving().getWaarde() : "";
    ...
    private String geslachtsnaamToString(PersoonGeslachtsnaamcomponent geslachtsnaam, Geslachtsaanduiding geslacht) {
        if (geslachtsnaam == null || geslachtsnaam.getGegevens() == null) {
