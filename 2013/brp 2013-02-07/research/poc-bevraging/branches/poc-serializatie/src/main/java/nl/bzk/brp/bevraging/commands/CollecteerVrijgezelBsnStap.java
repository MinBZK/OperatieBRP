...
public class CollecteerVrijgezelBsnStap implements Command {
    ...
    private static final int ACHTTIEN_JAAR_TERUG = -18;
    ...
    public boolean execute(final Context context) throws Exception {
        ...
        String datumMinimaal18 =
                DateFormatUtils.format(DateUtils.addYears(new Date(), ACHTTIEN_JAAR_TERUG), "yyyyMMdd");
        int tryCount = 0;
        ...
        while (result.size() < count && tryCount < MAX_TRIES) {
            ...
            MapSqlParameterSource parameters = new MapSqlParameterSource()
                    .addValue("ids", param)
                    .addValue("datum", Integer.valueOf(datumMinimaal18));
