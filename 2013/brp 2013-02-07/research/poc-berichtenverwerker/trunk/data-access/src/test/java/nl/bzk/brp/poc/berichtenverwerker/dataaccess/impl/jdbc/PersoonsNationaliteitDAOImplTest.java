...
/**
 * JUnit test voor de direct SQL (JDBC) specifieke {@link PersoonsNationaliteitDAOImpl} class.
 */
@ContextConfiguration({ "JDBCGenericDAOImplTest-context.xml", "PersoonsNationaliteitDAOImplTest-context.xml" })
