...
/**
 * JUnit test voor de direct SQL (JDBC) specifieke {@link ActieDAOImpl} class.
 */
@ContextConfiguration({ "JDBCGenericDAOImplTest-context.xml", "ActieDAOImplTest-context.xml" })
