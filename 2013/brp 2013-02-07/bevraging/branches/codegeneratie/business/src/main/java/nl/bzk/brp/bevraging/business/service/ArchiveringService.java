...
public interface ArchiveringService {
     ...
     *
     * @param ingaandBerichtId Id van het uitgaande bericht wat bijgewerkt moet worden.
     * @param uitgaandBerichtId Id van het ingaande bericht wat nodig is voor het veld antwoordOp van het
     *            uitgaand bericht.
     * @param nieuweData De data die bij het uitgaande bericht hoort.
     */
    void werkDataBij(final Long ingaandBerichtId, final Long uitgaandBerichtId, final String nieuweData);
