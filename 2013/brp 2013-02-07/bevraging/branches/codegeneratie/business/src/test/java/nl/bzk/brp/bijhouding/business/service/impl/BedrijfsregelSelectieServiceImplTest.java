...
public class BedrijfsregelSelectieServiceImplTest {
    ...
    private final Regel                  REGEL_1           = BedrijfsregelTestUtils.creeerRegel("BRPE0001");
    private final Regelimplementatie     IMPLEMENTATIE_1   = creeerRegelImplementatie(REGEL_1,
                                                                   SoortBericht.OPVRAGENPERSOONVRAAG);
    private final Regel                  REGEL_2           = BedrijfsregelTestUtils.creeerRegel("BRPE0002");
    private final Regelimplementatie     IMPLEMENTATIE_2   = creeerRegelImplementatie(REGEL_2,
                                                                   SoortBericht.OPVRAGENPERSOONVRAAG);
    private final SoortBericht           SOORT_BERICHT     = SoortBericht.OPVRAGENPERSOONVRAAG;
    private final Verantwoordelijke      VERANTWOORDELIJKE = Verantwoordelijke.COLLEGE_VAN_BURGEMEESTER_EN_WETHOUDERS;
    private final Boolean                IS_OPSCHORTING    = true;
    private final RedenOpschorting       REDEN_OPSCHORTING = RedenOpschorting.FOUT;
    ...
    private Regelimplementatie creeerRegelImplementatie(final Regel regel, final SoortBericht soortBericht) {
