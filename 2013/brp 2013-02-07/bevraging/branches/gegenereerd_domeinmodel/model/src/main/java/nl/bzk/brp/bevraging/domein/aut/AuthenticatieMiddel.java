...
public class AuthenticatieMiddel implements Serializable {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "AUTHMIDDEL_SEQUENCE_GENERATOR";
    private static final Logger LOGGER = LoggerFactory.getLogger(AuthenticatieMiddel.class);

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "AutAut.seq_Authenticatiemiddel")
    @Id
    ...
    public void setIpAdres(final InetAddress inetAdres) {
        ipAdres = inetAdres.getHostAddress();
    }
