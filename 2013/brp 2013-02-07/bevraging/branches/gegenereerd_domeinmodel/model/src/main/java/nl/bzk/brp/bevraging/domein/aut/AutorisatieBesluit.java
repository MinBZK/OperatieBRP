...
public class AutorisatieBesluit implements Serializable {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "AUTORISATIEBESLUIT_SEQUENCE_GENERATOR";

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "AutAut.seq_Autorisatiebesluit")
    @Id
    ...
    private Integer                   datumBesluit;
    @Column(name = "autorisatiebesluitstatushis")
    @Enumerated(EnumType.STRING)
    private StatusHistorie            autorisatieBesluitStatusHistorie;
    @Column(name = "toestand")
    private Toestand                  toestand;
    @Column(name = "bijhautorisatiebesluitstatus")
    private StatusHistorie            bijhoudingsAutorisatieBesluitStatusHistorie;
     ...
     */
    public AutorisatieBesluit(final SoortAutorisatieBesluit soort, final String besluitTekst, final Partij autoriseerder)
    {
        super();
        this.soort = soort;
    ...
    /**
     * Indicatie die aangeeft of een Autorisatiebesluit WEL of NIET is gebaseerd op een Model besluit. Indien het veld
     * <code>modelBesluit</code> gelijk is aan <code>null</code> of aan {@link Boolean.FALSE}, dan zal de indicatie
     * <code>false</code> zijn en dus alleen als het veld ook werkelijk {@link Boolean.TRUE} is, zal het antwoord ook
     * <code>true</code> zijn.
     *
     * @return indicatie die aangeeft of een Autorisatiebesluit is gebaseerd op een Model besluit.
     */
    public boolean isModelBesluit() {
        return Boolean.TRUE.equals(modelBesluit);
    }
    ...
    /**
     * Indicatie die aangeeft of het Autorisatiebesluit is ingetrokken. Indien het veld <code>ingetrokken</code> gelijk
     * is aan <code>null</code> of aan {@link Boolean.FALSE}, dan zal de indicatie <code>false</code> zijn en dus
     * alleen als het veld ook werkelijk {@link Boolean.TRUE} is, zal het antwoord ook <code>true</code> zijn.
     *
     * @return indicatie die aangeeft of het Autorisatiebesluit is ingetrokken.
     */
    public boolean isIngetrokken() {
        return Boolean.TRUE.equals(ingetrokken);
    }

    /**
     * Datum waarop het autorisatie besluit is genomen.
     *
     * @return De datum waarop het besluit is genomen.
     */
    public Integer getDatumBesluit() {
        return datumBesluit;
    }

    public StatusHistorie getAutorisatieBesluitStatusHistorie() {
        return autorisatieBesluitStatusHistorie;
    }

    /**
     * Toestand waarin dit autorisatiebesluit zich bevindt.
     *
     * @return De toestand van dit autorisatie besluit.
     */
    public Toestand getToestand() {
        return toestand;
    }

    public StatusHistorie getBijhoudingsAutorisatieBesluitStatusHistorie() {
        return bijhoudingsAutorisatieBesluitStatusHistorie;
    }
