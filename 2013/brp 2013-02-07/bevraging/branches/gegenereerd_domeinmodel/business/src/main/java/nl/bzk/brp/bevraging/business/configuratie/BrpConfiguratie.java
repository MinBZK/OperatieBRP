...
public class BrpConfiguratie {
    ...
    public int getDatabaseTimeOutProperty() {
        int timeout = DATABASE_TIMEOUT_SECONDEN_PROPERTY_DEFAULT;
        try {
            timeout = configuratie.getInt(DATABASE_TIMEOUT_SECONDEN_PROPERTY,
                    DATABASE_TIMEOUT_SECONDEN_PROPERTY_DEFAULT);
