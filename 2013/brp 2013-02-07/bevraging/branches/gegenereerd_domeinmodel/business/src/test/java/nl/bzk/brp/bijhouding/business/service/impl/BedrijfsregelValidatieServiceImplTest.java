...
public class BedrijfsregelValidatieServiceImplTest {
    ...
    public void init() {
        ...
        Mockito.when(verzoek.getSoortBericht()).thenReturn(SoortBericht.OPVRAGEN_PERSOON_VRAAG);
        ...
        Mockito.when(implementatie.getSoortBericht()).thenReturn(SoortBericht.OPVRAGEN_PERSOON_VRAAG);
    }
