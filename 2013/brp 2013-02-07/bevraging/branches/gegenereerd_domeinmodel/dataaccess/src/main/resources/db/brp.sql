...
-- Gegenereerd op: Tuesday 3 Jan 2012 11:40:04
--
--------------------------------------------------------------------------------
...
CREATE SEQUENCE BRM.seq_Regelgedrag;
CREATE TABLE BRM.Regelgedrag (
   ID                            Integer                       NOT NULL  DEFAULT nextval('BRM.seq_Regelgedrag')  /* RegeleffectID */,
   ...
   RegelgedragStatusHis          Varchar(1)                    NOT NULL    /* StatusHistorie */,
   CONSTRAINT BR5976 PRIMARY KEY (ID)
);
ALTER SEQUENCE BRM.seq_Regelgedrag OWNED BY BRM.Regelgedrag.ID;
...
CREATE TABLE Kern.SrtActie (
   ...
   Naam                          Varchar(40)                   NOT NULL    /* NaamEnumeratiewaarde */,
   CategorieActie                Smallint                      NOT NULL    /* CategorieSrtActieID */,
...
CREATE SEQUENCE BRM.seq_His_Regelgedrag;
CREATE TABLE BRM.His_Regelgedrag (
   ID                            Bigint                        NOT NULL  DEFAULT nextval('BRM.seq_His_Regelgedrag')  /* His_RegelgedragID */,
   Regelgedrag                   Integer                                   /* RegeleffectID */,
   TsReg                         Timestamp                                 /* Ts */,
   TsVerval                      Timestamp                                 /* Ts */,
   ActieInh                      Bigint                                    /* ActieID */,
   ActieVerval                   Bigint                                    /* ActieID */,
   ...
   CONSTRAINT BR5972 UNIQUE (Regelgedrag, TsReg)
);
ALTER SEQUENCE BRM.seq_His_Regelgedrag OWNED BY BRM.His_Regelgedrag.ID;
...
CREATE TABLE Kern.His_PersInschr (
   ...
   CONSTRAINT BR4248 UNIQUE (Pers, TsReg, DatAanvGel)
);
...
CREATE TABLE Kern.His_PersAdresAdresh (
   ...
   CONSTRAINT BR4261 UNIQUE (PersAdres, TsReg, DatAanvGel)
);
...
CREATE TABLE Kern.His_PersAdresBLAdres (
   ...
   CONSTRAINT BR4300 UNIQUE (PersAdres, TsReg, DatAanvGel)
);
...
CREATE TABLE Kern.His_PersAdresNLAdres (
   ...
   CONSTRAINT BR4283 UNIQUE (PersAdres, TsReg, DatAanvGel)
);
...
CREATE TABLE Kern.His_PersReisdoc (
   ...
   CONSTRAINT BR4351 UNIQUE (PersReisdoc, TsReg, DatAanvGel)
);
...
ALTER TABLE BRM.Regelgedrag ADD CONSTRAINT FK5828 FOREIGN KEY (Regelimplementatie) REFERENCES BRM.Regelimplementatie (ID);
ALTER TABLE BRM.Regelgedrag ADD CONSTRAINT FK5999 FOREIGN KEY (Bijhverantwoordelijkheid) REFERENCES Kern.Verantwoordelijke (ID);
ALTER TABLE BRM.Regelgedrag ADD CONSTRAINT FK6000 FOREIGN KEY (RdnOpschorting) REFERENCES Kern.RdnOpschorting (ID);
ALTER TABLE BRM.Regelgedrag ADD CONSTRAINT FK5829 FOREIGN KEY (Effect) REFERENCES BRM.Regeleffect (ID);
...
ALTER TABLE BRM.His_Regelgedrag ADD CONSTRAINT FK5965 FOREIGN KEY (Regelgedrag) REFERENCES BRM.Regelgedrag (ID);
ALTER TABLE BRM.His_Regelgedrag ADD CONSTRAINT FK5968 FOREIGN KEY (ActieInh) REFERENCES Kern.Actie (ID);
ALTER TABLE BRM.His_Regelgedrag ADD CONSTRAINT FK5969 FOREIGN KEY (ActieVerval) REFERENCES Kern.Actie (ID);
ALTER TABLE BRM.His_Regelgedrag ADD CONSTRAINT FK6021 FOREIGN KEY (Bijhverantwoordelijkheid) REFERENCES Kern.Verantwoordelijke (ID);
ALTER TABLE BRM.His_Regelgedrag ADD CONSTRAINT FK6022 FOREIGN KEY (RdnOpschorting) REFERENCES Kern.RdnOpschorting (ID);
ALTER TABLE BRM.His_Regelgedrag ADD CONSTRAINT FK5970 FOREIGN KEY (Effect) REFERENCES BRM.Regeleffect (ID);
