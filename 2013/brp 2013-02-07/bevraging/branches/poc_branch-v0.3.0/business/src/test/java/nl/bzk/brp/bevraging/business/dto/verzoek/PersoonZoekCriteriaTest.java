...
public class PersoonZoekCriteriaTest {
    ...
    public void testGettersEnSetters() {
        ...
        assertEquals(SoortBericht.OPVRAGEN_PERSOON_VRAAG, zoek.getSoortBericht());
        ...
        zoek.setBsn(123456789L);
        assertEquals(new Long(123456789), zoek.getBsn());
        assertEquals(beschouwing, zoek.getBeschouwing());

        assertEquals(1, zoek.getReadBsnLocks().size());
        assertEquals(new Long(123456789), zoek.getReadBsnLocks().iterator().next());
