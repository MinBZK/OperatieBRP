...
public class ProtocolleringStapTest {
    ...
    public void testVoerVerwerkingsStapUitVoorBericht() {
        ...
        boolean resultaat =
            protocolleringStap.voerVerwerkingsStapUitVoorBericht(getVerzoek(now, 3L, 5L),
                    getContext(ingaandBerichtID, uitgaandBerichtID, 2L), getAntwoord(3L, 5L));
        ...
        assertEquals(uitgaandBerichtID, leveringCommunicatie.getValue().getBericht().longValue());
        assertEquals(levering.getValue().getId(), leveringCommunicatie.getValue().getLevering());
    }
    ...
    public void testExceptieInProtocollering() {
        Calendar now = Calendar.getInstance();
        Mockito.when(leveringRepositoryMock.save(Matchers.any(Levering.class)))
        ...
        boolean resultaat =
            protocolleringStap.voerVerwerkingsStapUitVoorBericht(getVerzoek(now, 3L, 5L), getContext(3L, 4L, 2L),
                    antwoord);
     ...
     */
    private BerichtContext getContext(final Long ingaandBerichtId, final Long uitgaandBerichtId, final Long partijId) {
        ...
        BerichtAntwoord antwoord = new AbstractBerichtAntwoord() {
            ...
            public Collection<Persoon> getPersonen() {
                ...
                for (Long id : persoonIds) {
                    nl.bzk.brp.bevraging.domein.Persoon pers =
