...
public class AbonnementGegevensElement {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "ABONNEMENT_GEGEVENS_ELEMENT_SEQUENCE_GENERATOR";

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "Lev.seq_AbonnementGegevensElement")
    @Id
