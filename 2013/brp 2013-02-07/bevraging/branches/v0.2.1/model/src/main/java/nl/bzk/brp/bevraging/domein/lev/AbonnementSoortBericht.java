...
public class AbonnementSoortBericht {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "ABONNEMENT_SOORT_BERICHT_SEQUENCE_GENERATOR";
    private static final int HASH_CODE_INITIAL_NUMBER    = 31;
    private static final int HASH_CODE_MULTIPLIER_NUMBER = 3;

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "Lev.seq_AbonnementSrtBer")
    @Id
    ...
    public boolean equals(final Object obj) {
        ...
        if (this == obj) {
            resultaat = true;
        } else if (obj instanceof AbonnementSoortBericht) {
            AbonnementSoortBericht rhs = (AbonnementSoortBericht) obj;
            resultaat = new EqualsBuilder().append(abonnement, rhs.abonnement).append(soortBericht, rhs.soortBericht)
                    .isEquals();
        }
        return resultaat;
    }
