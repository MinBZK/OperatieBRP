...
public class PersoonAdres implements Serializable, nl.bzk.brp.bevraging.domein.kern.PersoonAdres {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "PERSOON_ADRES_SEQUENCE_GENERATOR";

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "Kern.seq_PersAdres")
    @Id
