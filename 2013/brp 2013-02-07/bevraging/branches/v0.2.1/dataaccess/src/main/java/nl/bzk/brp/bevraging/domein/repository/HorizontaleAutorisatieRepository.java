...
public interface HorizontaleAutorisatieRepository {
     ...
     * @throws ParserException indien de populatiecriteria in het abonnement niet geparsed kunnen worden.
     */
    List<Long> filterPersonenBijFilter(List<Long> persoonIds, String... filters) throws ParserException;
