...
public class ProtocolleringWebServiceTest extends AbstractWebServiceTest {
    ...
    /**
     * Creeer een nieuwe {@link OpvragenPersoonVraag} instantie, geinitialiseerd
     ...
     */
    private OpvragenPersoonVraag createPersoonVraag(final String bsn, final Long id, final Integer abonnement,
            final Long afzender)
    {
