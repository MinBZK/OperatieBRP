...
public class HorizontaleAutorisatieRepositoryJPA implements HorizontaleAutorisatieRepository {
        ...
        throws ParserException
    {
        ...
        if (valideFilters.isEmpty()) {
            ...
            StringBuilder queryString =
                new StringBuilder("SELECT p.id FROM PersistentPersoon p WHERE p.id IN :persoonIds");
    ...
    /**
     * Retourneert een lijst van de valide opgegeven populatieCriteria, waarin alleen de niet <code>null</code> en niet
     * lege
