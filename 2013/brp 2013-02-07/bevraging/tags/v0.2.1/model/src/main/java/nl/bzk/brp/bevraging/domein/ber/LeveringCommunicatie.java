...
public class LeveringCommunicatie implements Serializable {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "LEVCOMMUNICATIE_SEQUENCE_GENERATOR";

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "lev.seq_levcommunicatie")
    @Id
