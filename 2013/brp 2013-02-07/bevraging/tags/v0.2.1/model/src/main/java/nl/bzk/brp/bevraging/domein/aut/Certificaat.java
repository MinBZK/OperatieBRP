...
public class Certificaat implements Serializable {
    ...
    private static final String SEQUENCE_GENERATOR_NAME = "CERTIFICAAT_SEQUENCE_GENERATOR";

    @SequenceGenerator(name = SEQUENCE_GENERATOR_NAME, sequenceName = "autaut.seq_certificaat")
    @Id
     ...
     */
    public static byte[] converteerStringNaarSignature(final String signature) throws DecoderException {
     ...
     * @throws DecoderException indien er een fout optreedt bij het omzetten.
     */
    public static String converteerSignatureNaarString(final byte[] signature) throws DecoderException {
    ...
    public byte[] getSignature() throws DecoderException {
        return converteerStringNaarSignature(signature);
    }
    ...
    public void setSignature(final byte[] signature) throws DecoderException {
        this.signature = converteerSignatureNaarString(signature);
    }
