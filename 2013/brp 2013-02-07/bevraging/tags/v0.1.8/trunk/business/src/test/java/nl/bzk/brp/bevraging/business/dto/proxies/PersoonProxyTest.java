...
public class PersoonProxyTest {
    ...
    public void testPersoonZonderAdressen() {
        ...
        Persoon persoonProxy = new PersoonProxy(persoon, toegestaneVelden);

        Assert.assertSame(persoon, persoonProxy.getPersoon());
    ...
    public void testVoerVerwerkingsStapUitVoorBerichVoorElkEnkelvoudigAbonnement() throws Throwable {
        ...
        methoden.remove(PersoonAdres.class.getMethod("getAdres"));
