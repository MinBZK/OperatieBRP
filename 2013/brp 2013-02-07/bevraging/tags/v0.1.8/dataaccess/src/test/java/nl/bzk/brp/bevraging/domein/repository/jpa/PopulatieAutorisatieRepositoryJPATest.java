...
/**
 * Testcases voor de {@link PopulatieAutorisatieRepository} class.
 */
public class PopulatieAutorisatieRepositoryJPATest extends AbstractRepositoryTestCase {
    ...
    public void testFilterPersonenMetFilterAltijdWaar() {
        Assert.assertEquals(3,
                populatieAutorisatieRepository.filterPersonenBijFilter(Arrays.asList(1L, 2L, 3L), "1 = 1").size());
    }

    @Test
    public void testFilterPersonenMetFilterNooitWaar() {
        Assert.assertEquals(0,
                populatieAutorisatieRepository.filterPersonenBijFilter(Arrays.asList(1L, 2L, 3L), "1 = 2").size());
    }
    ...
    public void testFilterPersonenMetSelectieveFilter() {
        Assert.assertEquals(
                1,
                populatieAutorisatieRepository.filterPersonenBijFilter(Arrays.asList(1L, 2L, 3L),
    ...
    public void testFilterPersonenMetNullVoorHoofdFilter() {
        Assert.assertEquals(
                1,
                populatieAutorisatieRepository.filterPersonenBijFilter(Arrays.asList(1L, 2L, 3L), null,
                        "p.burgerservicenummer = 123456789").size());
    }
    ...
    public void testFilterPersonenZonderFilters() {
        Assert.assertEquals(3,
                populatieAutorisatieRepository.filterPersonenBijFilter(Arrays.asList(1L, 2L, 3L), " ", null).size());
        Assert.assertEquals(3, populatieAutorisatieRepository.filterPersonenBijFilter(Arrays.asList(1L, 2L, 3L)).size());
    }
}
