...
public class Certificaat implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CERTIFICAAT_SEQUENCE_GENERATOR")
    private Long       id;
    @Column(name = "subject")
     ...
     * @throws DecoderException indien er een fout optreedt bij het omzetten.
     */
    public static String signatureFromByteArrayToString(final byte[] signature) throws DecoderException {
    ...
    public void setSignature(final byte[] signature) throws DecoderException {
        this.signature = signatureFromByteArrayToString(signature);
    }
