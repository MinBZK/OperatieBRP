...
-- Gegenereerd op: Friday 4 Nov 2011 10:47:56
-- 
--------------------------------------------------------------------------------
...
CREATE TABLE AutAut.DoelbindingGegevenselement (
   ...
   Gegevenselement               Integer                       NOT NULL    /* ElementID */,
...
CREATE TABLE Kern.MultiRealiteitRegel (
   ...
   Betr                          Bigint                                    /* BetrID */,
   StatusHis                     Varchar(1)                    NOT NULL    /* StatusHistorie */,
...
ALTER TABLE AutAut.DoelbindingGegevenselement ADD CONSTRAINT FK4893 FOREIGN KEY (Gegevenselement) REFERENCES Kern.Element (ID);
ALTER TABLE Ber.Ber ADD CONSTRAINT FK5017 FOREIGN KEY (SrtBer) REFERENCES Ber.SrtBer (ID);
...
ALTER TABLE Lev.AbonnementGegevenselement ADD CONSTRAINT FK4908 FOREIGN KEY (Gegevenselement) REFERENCES Kern.Element (ID);
