...
public class ProtocolleringStapTest {
    ...
    @Mock
    private PartijRepository          partijRepositoryMock;
    ...
    public void testVoerVerwerkingsStapUitVoorBericht() {
        ...
        Mockito.verify(partijRepositoryMock).findOne(2L);
    ...
    public final void initMocksEnStap() {
        ...
        ReflectionTestUtils.setField(protocolleringStap, "partijRepository", partijRepositoryMock);
