...
public interface Persoon {
    ...
    /**
     * Deze methode geeft toegang tot de database representatie van de persoon.
     * @return Als dit object een proxy is de onderliggende persoon, anders dit object zelf
     */
    nl.bzk.brp.bevraging.domein.Persoon getPersoon();
