...
public class PopulatieAutorisatieAchterafStapTest {
    ...
    private PopulatieAutorisatieAchterafStap stap = null;

    @Test
    public void testPopulatieAutorisatieMetAllemaalToegang() throws ParserException {
    ...
    @Test
    public void testPopulatieAutorisatieMetNiemandToegang() throws ParserException {
        Map<Long, Boolean> result = new HashMap<Long, Boolean>();
    ...
    @Test
    public void testPopulatieAutorisatieMetEenIemandToegang() throws ParserException {
        Map<Long, Boolean> result = new HashMap<Long, Boolean>();
        result.put(1L, Boolean.FALSE);
        result.put(2L, Boolean.TRUE);
        result.put(3L, Boolean.FALSE);
    ...
    @Test
    public void testPopulatieAutorisatieMetParseerFoutInCriteria() throws ParserException {
        Mockito.when(
                toegangsBewakingService.controleerLijstVanPersonenVoorAbonnement(Matchers.any(Abonnement.class),
    ...
    public void init() {
        ...
        stap = new PopulatieAutorisatieAchterafStap();
