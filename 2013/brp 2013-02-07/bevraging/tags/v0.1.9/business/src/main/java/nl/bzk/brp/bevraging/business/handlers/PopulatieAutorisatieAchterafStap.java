...
public class PopulatieAutorisatieAchterafStap extends AbstractBerichtVerwerkingsStap {
    ...
    private static final Logger     LOGGER = LoggerFactory.getLogger(PopulatieAutorisatieAchterafStap.class);
        ...
        try {
            ...
            while (persoonIterator.hasNext()) {
                ...
                if (personenToegangMap.get(persoonId) == Boolean.FALSE) {
                    ...
                    LOGGER.info(String.format("Persoon %s is vanwege populatieautorisatie uit het antwoord gefiltert.",
                            persoonId));
                }
            }
