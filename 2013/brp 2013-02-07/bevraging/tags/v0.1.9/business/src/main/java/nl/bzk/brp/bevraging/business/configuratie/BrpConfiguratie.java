 ...
 */
public final class BrpConfiguratie {

    private static final Logger            LOG                                        = LoggerFactory
                                                                                      .getLogger(BrpConfiguratie.class);
    ...
    private static PropertiesConfiguration configuratie;
     ...
     */
    private BrpConfiguratie(final String propertiesBestand, final int verversingsInterval) throws ConfigurationException
    {
     ...
     */
    public static int getDatabaseTimeOutProperty() {
        try {
            return configuratie.getInt(DATABASE_TIMEOUT_SECONDEN_PROPERTY, DATABASE_TIMEOUT_SECONDEN_PROPERTY_DEFAULT);
        } catch (ConversionException ce) {
            LOG.warn("Configuratie parameter \"" + DATABASE_TIMEOUT_SECONDEN_PROPERTY
                     + "\" is niet correct ingesteld.");
            LOG.warn("De standaard waarde wordt gebruikt.");
        }
