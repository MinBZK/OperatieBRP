...
public class LeveringPersoon implements Serializable {
    ...
    @SequenceGenerator(name = "LEVPERS_SEQUENCE_GENERATOR", sequenceName = "lev.seq_levpers")
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "LEVPERS_SEQUENCE_GENERATOR")
    private Long id;
