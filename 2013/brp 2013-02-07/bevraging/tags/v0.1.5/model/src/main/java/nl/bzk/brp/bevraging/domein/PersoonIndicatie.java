...
public class PersoonIndicatie implements Serializable {
    ...
    @SequenceGenerator(name = "PERSOON_INDICATIE_SEQUENCE_GENERATOR", sequenceName = "Kern.seq_PersIndicatie")
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PERSOON_INDICATIE_SEQUENCE_GENERATOR")
    private Long           id;
    @ManyToOne
