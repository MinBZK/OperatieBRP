 ...
 * voldoen.
 */
public class PersoonZoekCriteriaAntwoord extends AbstractBerichtAntwoord implements BerichtAntwoord {
     ...
     */
    public PersoonZoekCriteriaAntwoord(final Collection<? extends Persoon> personen) {
