 ...
 * de centrale {@link #voerVerwerkingsStapUitVoorBericht(BrpBerichtCommand)} methode aan te roepen.
 */
public interface BerichtVerwerkingsStap {

    /**
     * Resultaat voor de berichtverwerking die aangeeft dat het proces verder
     * doorlopen kan worden; proces is dus nog niet afgerond (geen fatale
     * exceptie noch een eind situatie bereikt in deze stap).
     */
    boolean DOORGAAN_MET_VERWERKING = Boolean.TRUE;

    /**
     * Resultaat voor de berichtverwerking die aangeeft dat het proces afgerond
     * is na het doorlopen van deze stap; er dient dus geen volgende stap in de
     * keten doorlopen te worden daar er een fatale exceptie/fout is opgetreden
     * in de verwerking van deze stap, of er is een eind situatie opgetreden
     * waardoor verdere stappen niet meer van toepassing zijn.
     */
     ...
     *
     * @param bericht het bericht waarvoor de verwerkingsstap dient te worden uitgevoerd.
     * @return een boolean die aangeeft of de stap succesvol is uitgevoerd (true) of niet (false).
     */
    boolean voerVerwerkingsStapUitVoorBericht(BrpBerichtCommand<? extends BRPVerzoek, ? extends BRPAntwoord> bericht);
     ...
     */
    void naVerwerkingsStapVoorBericht(BrpBerichtCommand<? extends BRPVerzoek, ? extends BRPAntwoord> bericht);
