        ...
        try {
            dataset =
                new CompositeDataSet(new IDataSet[] {
                    new FlatXmlDataSetBuilder().build(getClass().getResourceAsStream("/data/stamgegevens.xml")),
                    new FlatXmlDataSetBuilder().build(getClass().getResourceAsStream("/data/testdata.xml")),
                    new FlatXmlDataSetBuilder().build(getClass().getResourceAsStream("/data/abonnement.xml")) });
