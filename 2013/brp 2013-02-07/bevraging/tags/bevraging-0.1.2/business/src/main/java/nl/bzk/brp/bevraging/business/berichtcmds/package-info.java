 ...
 *
 * De package bevat tevens de interface {@link nl.bzk.brp.bevraging.business.berichtcmds.BrpBerichtCommand} voor de
 * command objecten en een abstracte implementatie
 * ({@link nl.bzk.brp.bevraging.business.berichtcmds.AbstractBrpBerichtCommand}) welke gebruikt kunnen worden als
