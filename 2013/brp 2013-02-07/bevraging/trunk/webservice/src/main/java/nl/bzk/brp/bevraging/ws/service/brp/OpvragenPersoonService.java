...
public class OpvragenPersoonService implements OpvragenPersoonPortType {
    ...
    public final OpvragenPersoonAntwoord opvragenPersoon(final OpvragenPersoonVraag vraag) {
        ...
        try {
            ...
            if (BerichtIdsThreadLocal.getIngaandBerichtId() != null) {
                berichtId = BerichtIdsThreadLocal.getIngaandBerichtId().toString();
            }
    ...
    private BerichtContext getContext(final OpvragenPersoonVraag vraag) {
        ...
        context.setIngaandBerichtId(BerichtIdsThreadLocal.getIngaandBerichtId());
        context.setUitgaandBerichtId(BerichtIdsThreadLocal.getUitgaandBerichtId());
