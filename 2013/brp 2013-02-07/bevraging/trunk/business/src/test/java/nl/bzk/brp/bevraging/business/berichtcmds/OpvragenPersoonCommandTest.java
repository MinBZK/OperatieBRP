...
public class OpvragenPersoonCommandTest {
    ...
    public final void testConstructorVeldInitialisatie() {
        ...
        assertEquals("5", command.getVerzoek().getBsn());
    ...
    public final void initMocksEnService() {
        ...
        final String bsnPers1 = "123456789";
        final String bsnPers2 = "234567890";
        final String bsnPers3a = "434567890";

        Persoon pers1 = factory.createPersoon();
        pers1.setSoort(SoortPersoon.INGESCHREVENE);

        pers1.setBurgerservicenummer(bsnPers1);
        pers1.setGeslachtsnaam("Test1");

        Persoon pers2 = factory.createPersoon();
        pers2.setSoort(SoortPersoon.INGESCHREVENE);
        pers2.setBurgerservicenummer(bsnPers2);
        pers2.setGeslachtsnaam("Test2");

        Persoon pers3a = factory.createPersoon();
        pers3a.setSoort(SoortPersoon.INGESCHREVENE);
        pers3a.setBurgerservicenummer(bsnPers3a);
        pers3a.setGeslachtsnaam("Test3a");

        Persoon pers3b = factory.createPersoon();
        pers3b.setSoort(SoortPersoon.INGESCHREVENE);
     ...
     */
    public void voerCommandUitMetBSN(final String bsn) {
