...
public class BsnLockerTest {
    ...
    private static final List<String> GEEN_LOCKS = Collections.<String>emptyList();
    ...
    public void simpleBsnLockerTestA() {
        assertTrue(bsnLocker.getLocks(1L, GEEN_LOCKS, GEEN_LOCKS));
        bsnLocker.unLock();
    }
    ...
    public void simpleBsnLockerTestB() {
        ...
        assertTrue(bsnLocker.getLocks(1L, GEEN_LOCKS, Arrays.asList("1")));
        bsnLocker.unLock();
    }

    @Test
    public void simpleBsnLockerTestC() {
        assertTrue(bsnLocker.getLocks(1L, GEEN_LOCKS, Arrays.asList("1", "2", "3")));
        bsnLocker.unLock();
    }

    @Test
    public void simpleBsnLockerTestD() {
        assertTrue(bsnLocker.getLocks(1L, Arrays.asList("1", "2", "3"), GEEN_LOCKS));
        bsnLocker.unLock();
    }
    ...
    public void tweeKeerLockTest() {
        assertTrue(bsnLocker.getLocks(1L, GEEN_LOCKS, GEEN_LOCKS));
        try {
            bsnLocker.getLocks(1L, GEEN_LOCKS, GEEN_LOCKS);
    ...
    public void timoutThreadLockTestA() {
        ...
        // read - read
        testReadWriteMetAfwijking(Arrays.asList("1"), GEEN_LOCKS, Arrays.asList("1"),
                GEEN_LOCKS, null);
    }
    ...
    public void timoutThreadLockTestB() throws InterruptedException {
        ...
        // read - write
        testReadWriteMetAfwijking(Arrays.asList("1"), GEEN_LOCKS,
                GEEN_LOCKS, Arrays.asList("1"),
    ...
    public void timoutThreadLockTestC() throws InterruptedException {
        ...
        // write - read
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("1"), Arrays.asList("1"),
                GEEN_LOCKS, (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestD() throws InterruptedException {
        ...
        // write - write
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("1"),
                GEEN_LOCKS, Arrays.asList("1"),
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestE() throws InterruptedException {
        ...
        // read - write
        testReadWriteMetAfwijking(Arrays.asList("1", "2"), GEEN_LOCKS,
                GEEN_LOCKS, Arrays.asList("2", "3"),
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestF() throws InterruptedException {
        // write - read
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("1", "2"), Arrays.asList("2", "3"),
                GEEN_LOCKS, (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestG() throws InterruptedException {
        // write - write
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("2", "3"),
                GEEN_LOCKS, Arrays.asList("2", "3"),
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
