...
public class StandaardToegangsBewakingService implements ToegangsBewakingService {
            ...
            final BerichtVerzoek<? extends BerichtAntwoord> verzoek)
    {
        ...
        return bevatSoortBerichtenSetSpecifiekSoortBericht(abonnement.getAbonnementSoortBerichten(), soortBericht);
    }
     ...
     */
    private boolean bevatSoortBerichtenSetSpecifiekSoortBericht(final Iterable<AbonnementSoortBericht> soortBerichten,
