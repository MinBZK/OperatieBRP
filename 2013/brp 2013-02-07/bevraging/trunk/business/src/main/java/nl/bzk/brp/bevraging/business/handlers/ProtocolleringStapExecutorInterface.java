...
public interface ProtocolleringStapExecutorInterface {
     ...
     *
     * @param persoonIds de ID's van de personen waarover geprotocolleerd dient te worden.
    ...
    <T extends BerichtAntwoord> Long protocolleer(final Collection<Long> persoonIds,
