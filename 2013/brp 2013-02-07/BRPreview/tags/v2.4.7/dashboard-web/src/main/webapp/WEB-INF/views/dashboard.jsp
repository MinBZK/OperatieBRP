	...
	<script>
            ...
            if(!updateRunning) {
                var newMessages = $.ajax ({
                     ...
                     success: function(data) {
                        ...
                        maxAantalBerichtenTonen = Math.floor($(document).height()/ 100);
						console.log('Aantal berichten tonen op pagina maximaal:' + maximumAantalBerichtenPerPagina);
        ...
        function showNewMessage(messages, index) {
            ...
            if(index < messages.length)
            {
				...
				maxAantalBerichtenTonen = Math.floor(($(document).height()-50)/ 100);
        ...
        function createMessage(message) {
            ...
            var messageClasses = 'inhoud berichttekst';
            ...
            if(message.prevalidatie == true) {
                content += '<figure class="melding"><img src="${contextRoot}/resources/images/prevalidatie.png" class="meldingstatus" title="prevalidatie"></figure>';
            }
