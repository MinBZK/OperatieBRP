...
public class BerichtenServiceTest {
    ...
    public void testOpslaanVerhuizingBinnenGemeente() {
        ...
        request.setBijhoudingsverzoek(new Bijhoudingsverzoek(new Gemeente("Rotterdam"), "CentricBZM"));
        ...
        oudAdres.setGemeente(new Gemeente("Hellevoetsluis"));
        ...
        Assert.assertEquals("Rotterdam: verhuizing binnen gemeente van Bas de Cuykelaer.", argument.getValue().getBericht());
        Assert.assertEquals("Adres per 20-06-2012: Grote Markt 34 (Nieuwenhoorn).", argument.getValue().getBerichtDetails());
