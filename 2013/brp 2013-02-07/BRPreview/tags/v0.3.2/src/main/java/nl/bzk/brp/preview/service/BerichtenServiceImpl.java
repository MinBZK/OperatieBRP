...
public class BerichtenServiceImpl implements BerichtenService {
    ...
    public void opslaan(final VerhuisBerichtRequest inkomendBericht) {
        ...
        if (inkomendBericht.getPersoon().getAdres().getPlaats() == null) {
            throw new IllegalArgumentException("plaats van nieuw adres ontbreekt");
        }
        ...
        String nieuweWoonplaats = inkomendBericht.getPersoon().getAdres().getPlaats().getNaam();
        String nieuweStraat = inkomendBericht.getPersoon().getAdres().getStraat();
        String nieuwHuisnummer = inkomendBericht.getPersoon().getAdres().getHuisnummerVolledig();
