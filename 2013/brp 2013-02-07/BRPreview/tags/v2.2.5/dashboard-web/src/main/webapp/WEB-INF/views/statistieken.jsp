...
<body>
	<header><hgroup><h1><img src="${contextRoot}/resources/images/rijksoverheid-logo.jpg" height="25px" class="logo"/><fmt:message key="application.title"/></h1></hgroup></header>
    ...
    <table id="statistieken">
        ...
        <tr>
            <td><img src="${contextRoot}/resources/images/prevalidatie.png" class="berichtsoort"/></td>
            <td class="aantal">0</td>
            <td class="aantal">0</td>
            <td class="aantal">0</td>
            <td class="aantal">0</td>
        </tr>
