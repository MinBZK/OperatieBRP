...
<body>
	<script>
			...
			function createMessage(message) { 	
                ...
                content +='Op:&nbsp;<span class="timestamp" title="' + timestamp.toJSON() + '" >' + timestamp.getDate() + '-' + timestamp.getMonth() +1 + '-' + timestamp.getFullYear() + '&nbsp;' + timestamp.toTimeString().substring(0,8) + '</span><br />';
