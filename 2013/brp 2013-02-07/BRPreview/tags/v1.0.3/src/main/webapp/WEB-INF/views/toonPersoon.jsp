        ...
        <section id="person">
            ...
            <section class="collapsable">
                ...
                <div><c:if test="${not empty partner.betrokkene.bsn}">
                    <table>
                        <tr>
                            <td class="label">Datum aanvang</td><td class="data"><c:out value="${brp:datum(partner.relatie.dataanv)}"/></td>
                            <td class="label">Naam</td><td class="data"><c:out value="${partner.betrokkene.voornamen}"/>&nbsp;<c:out value="${partner.betrokkene.geslnaam}"/></td>
                        </tr>
                        <tr>
                            <td class="label">BSN</td><td class="data"><a href="<c:url value='/dashboard/bevraging?bsn=${partner.betrokkene.bsn}' />"><c:out value="${partner.betrokkene.bsn}" /></a></td>
                ...
                <div>
                 <section id="collapsable">
                    ...
                    <tr>
                        <td class="label">Datum aanvang</td>
                        <td class="data">
	                         <c:out value="${brp:datum(ouder.relatie.dataanv)}" />
                        </td>
                     ...
                     <tr>
                        ...
                        <td class="data">
	                         <c:out value="${brp:datum(ouder.betrokkene.datgeboorte)}" />
                        </td>
                    </tr>          
                    <tr>
            ...
            <section class="collapsable">
               ...
               <h3 class="active">Kind</h3>
                  <div>
                    <table>
	                    <tr>
		                    <td class="label">Datum aanvang</td><td class="data"><c:out value="${brp:datum(kind.betrokkene.datgeboorte)}"/></td>
		                    <td class="label">Naam</td><td class="data"><c:out value="${kind.betrokkene.voornamen}"/>&nbsp;<c:out value="${kind.betrokkene.geslnaam}"/></td>
		                </tr>
		                <tr>
                            <td class="label">BSN</td><td class="data"><a href="<c:url value='/dashboard/bevraging?bsn=${kind.betrokkene.bsn}' />"><c:out value="${kind.betrokkene.bsn}" /></a></td>
                            <td class="label">Datum geboorte</td><td class="data"><c:out value="${brp:datum(kind.betrokkene.datgeboorte)}"/></td>
                        </tr>
                         <tr>
