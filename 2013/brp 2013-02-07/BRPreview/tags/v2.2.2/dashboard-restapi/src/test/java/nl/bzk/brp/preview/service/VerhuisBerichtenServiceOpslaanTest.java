...
public class VerhuisBerichtenServiceOpslaanTest {
    ...
    public void testOpslaanVerhuizingBinnenGemeente() {
        ...
        Assert.assertEquals("Verhuizing van Bas de Cuykelaer per 20-06-2012 naar Grote Markt 34 (Nieuwenhoorn).",
                argument.getValue().getBericht());
        Assert.assertEquals("", argument.getValue().getBerichtDetails());
    ...
    public void testOpslaanVerhuizingNaarAndereGemeente() {
        ...
        nieuwAdres.setDatumAanvang(20120600);
        request.setNieuwAdres(nieuwAdres);
        ...
        Mockito.verify(berichtenDao).opslaan(argument.capture());
        Assert.assertEquals(0, argument.getValue().getAantalMeldingen());
        Assert.assertEquals("Verhuizing van Maria Ophuijsen per 00-06-2012 naar Herestraat 1 A (Assen).", argument
                .getValue().getBericht());
        Assert.assertEquals("", argument.getValue().getBerichtDetails());
        Assert.assertEquals("CentricBZM", argument.getValue().getBurgerZakenModule());
    ...
    public void testOpslaanVerhuizingMet1Melding() {
        ...
        Assert.assertEquals("Verhuizing van Hendrika de Roos per 20-06-2012 naar Akerkhof 2 (Groningen).", argument
                .getValue().getBericht());
        Assert.assertEquals("Waarschuwing: Er zijn al mensen ingeschreven op het nieuwe adres.", argument.getValue()
                .getBerichtDetails());
        Assert.assertEquals("CentricBZM", argument.getValue().getBurgerZakenModule());
        Assert.assertEquals("Groningen", argument.getValue().getPartij());
        Assert.assertEquals(OndersteundeBijhoudingsTypes.VERHUIZING, argument.getValue().getSoortBijhouding());
    ...
    public void testOpslaanVerhuizingMet2Meldingen() {
        ...
        Assert.assertEquals("Verhuizing van Hendrika de Roos per 20-06-2012 naar Akerkhof 2 (Groningen).", argument
                .getValue().getBericht());
        Assert.assertEquals("Fout: De bijhouding van deze persoon is opgeschort."
    ...
    public void testOpslaanVerhuizingNietSuccesvolMet1Melding() {
        ...
        Mockito.verify(berichtenDao).opslaan(argument.capture());
        Assert.assertEquals(1, argument.getValue().getAantalMeldingen());
        Assert.assertEquals("Verhuizing van Jan Moes per 20-06-2012 naar Akerkhof 2 (Groningen).", argument.getValue()
                .getBericht());
    ...
    public void testOpslaanVerhuizingRudimentairBericht() {
        ...
        Mockito.verify(berichtenDao).opslaan(argument.capture());
        Assert.assertEquals(0, argument.getValue().getAantalMeldingen());
        Assert.assertEquals("Verhuizing van Ophuijsen per 00-06-2012 naar Herestraat nr. onbekend.", argument
                .getValue().getBericht());
        Assert.assertEquals("", argument.getValue().getBerichtDetails());
        Assert.assertEquals("CentricBZM", argument.getValue().getBurgerZakenModule());
        Assert.assertEquals("Groningen", argument.getValue().getPartij());
