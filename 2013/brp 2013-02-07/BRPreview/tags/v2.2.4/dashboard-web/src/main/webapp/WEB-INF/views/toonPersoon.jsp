...
<body>
	<script>
					 ...
					 success: function(data) {
						...
						if(data.aantalBerichten > 0) {
                            ...
                            for( var i in data.berichten.reverse()) {
								...
								showNewMessage($res);
								if(i > 10) {
								    break; //niet meer dan 10 berichten laten zien
								}
							}
						}
					}
			...
			function createMessage(message) { 	
                ...
                content +='<p class="message" title="' + message.bericht + "\n" + message.berichtDetails + '">';
                ...
                content += "<span id='bericht-details-" + message.berichtId + "' class='berichtdetails'><br>" + message.berichtDetails +"</span>";
                content += '</p>';
                ...
                <c:set var="adreskopregel" value="vanaf ${vanaf}"/>
                 ...
                 <table>                   
                    <tr>
	                    ...
	                    <td class="data"><c:out value="${adres.nor}"/></td>
                    </tr> 
                    <tr>
