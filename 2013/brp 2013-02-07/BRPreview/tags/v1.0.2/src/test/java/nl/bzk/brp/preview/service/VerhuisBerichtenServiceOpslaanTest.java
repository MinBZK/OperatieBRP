...
public class VerhuisBerichtenServiceOpslaanTest {
    ...
    public void testOpslaanVerhuizingRudimentairBericht() {
        ...
        Persadres brpAdres = new Persadres();
        Partij brpGemeente = new Partij();
        brpGemeente.setNaam("Amersfoort");
        brpAdres.setGem(brpGemeente);
        Adres oudAdres = new Adres(brpAdres);
