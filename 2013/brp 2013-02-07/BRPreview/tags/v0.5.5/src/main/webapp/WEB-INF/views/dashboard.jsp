	...
	<script>
		    ...
		    function createMessage(message) { 	
                ...
                if(message.prevalidatie == true) {
                    content += '<figure class="prevalidatie"><img src="${baseUrl}${pageContext.request.contextPath}/resources/images/prevalidatie.jpg" class="prevalidatie" title="prevalidatie"></figure>';
                }
                
                //Icoontjes die de status van de meldingen aangeven
                 if(message.aantalMeldingen > 0) {
                	 if(message.berichtDetails.indexOf('Waarschuwing') >= 0) {
                         content += '<figure class="melding"><img src="${baseUrl}${pageContext.request.contextPath}/resources/images/meldingen-waarschuwing.png" class="meldingstatus" title="melding status"></figure>';                		 
                	 }
                	 if(message.berichtDetails.indexOf('fout') >= 0) {
                         content += '<figure class="melding"><img src="${baseUrl}${pageContext.request.contextPath}/resources/images/meldingen-fout.png" class="meldingstatus" title="melding status"></figure>';
                     }
                 }
...
<body>
	...
	<footer>
	<div><p><img src="${baseUrl}${pageContext.request.contextPath}/resources/images/rijksoverheid-logo.jpg" height="50px"/>&copy;2012&nbsp;Versie&nbsp;<fmt:message key="application.version"/></p></div>
	</footer>
</body>
</html>	