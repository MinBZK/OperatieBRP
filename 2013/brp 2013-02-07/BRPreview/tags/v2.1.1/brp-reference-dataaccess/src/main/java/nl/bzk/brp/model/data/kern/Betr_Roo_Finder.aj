...
privileged aspect Betr_Roo_Finder {
    ...
    public static TypedQuery<Betr> Betr.findBetrsByBetrokkene(Long betrokkene) {
        if (betrokkene == null) throw new IllegalArgumentException("The betrokkene argument is required");
        EntityManager em = Betr.entityManager();
        TypedQuery<Betr> q = em.createQuery("SELECT o FROM Betr AS o WHERE o.betrokkene = :betrokkene", Betr.class);
        q.setParameter("betrokkene", betrokkene);
        return q;
    }
