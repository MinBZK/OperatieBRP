...
privileged aspect HisBetrouderschap_Roo_DbManaged {
    ...
    private Integer HisBetrouderschap.dataanv;
    
    @Column(name = "indouder", columnDefinition = "bool")
    @NotNull
    private boolean HisBetrouderschap.indouder;
    
    @Column(name = "indadresgevend", columnDefinition = "bool")
    private Boolean HisBetrouderschap.indadresgevend;
    ...
    public Integer HisBetrouderschap.getDataanv() {
        return dataanv;
    }
    
    public void HisBetrouderschap.setDataanv(Integer dataanv) {
    ...
    public Boolean HisBetrouderschap.getIndadresgevend() {
        return indadresgevend;
    }
    
    public void HisBetrouderschap.setIndadresgevend(Boolean indadresgevend) {
