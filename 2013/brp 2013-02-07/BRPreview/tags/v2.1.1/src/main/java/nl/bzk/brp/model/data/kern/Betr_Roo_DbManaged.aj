...
privileged aspect Betr_Roo_DbManaged {
    ...
    @Column(name = "betrokkene", columnDefinition = "bigserial")
    @NotNull
    private Long Betr.betrokkene;
    ...
    public Long Betr.getBetrokkene() {
        return betrokkene;
    }
    
    public void Betr.setBetrokkene(Long betrokkene) {
