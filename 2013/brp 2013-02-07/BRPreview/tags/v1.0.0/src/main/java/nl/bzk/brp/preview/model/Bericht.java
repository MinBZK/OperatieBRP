...
public class Bericht implements Serializable {
    ...
    public String toString() {
        return "Bericht [" + (berichtId != null ? "berichtId=" + berichtId + ", " : "")
            + (partij != null ? "partij=" + partij + ", " : "") + (bericht != null ? "bericht=" + bericht + ", " : "")
            + (berichtDetails != null ? "berichtDetails=" + berichtDetails + ", " : "") + "aantalMeldingen="
            + aantalMeldingen + ", " + (verzondenOp != null ? "verzondenOp=" + verzondenOp + ", " : "")
            + (burgerZakenModule != null ? "burgerZakenModule=" + burgerZakenModule + ", " : "")
            + (soortBijhouding != null ? "soortBijhouding=" + soortBijhouding + ", " : "") + "prevalidatie="
            + prevalidatie + ", "
            + (burgerservicenummers != null ? "burgerservicenummers=" + burgerservicenummers : "") + "]";
    }
