            ...
            <section class="collapsable">
                ...
                <c:choose>
                 ...
                 <c:choose>
                     ...
                     <c:otherwise>
                         <c:set var="adreshistorieknop"><a href="${contextAdreshistorie}/overzicht.html?bsn=${bsn}"><img src="${contextRoot}/resources/images/adreshistorie.png" class="historietonen"  title="Toon een grafische presentatie van de adres historie"></a></c:set>
                     </c:otherwise>
                  </c:choose>
                 <section>
