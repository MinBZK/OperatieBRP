...
public class BerichtenDaoTest extends AbstractIntegratieTest {
    ...
    public void testOpslaan() {
        ...
        String sql = "select count(0) from dashboard.berichten where 1 = 1" +
        		" and partij = 'Leiden'" +
        		" and bericht = 'qwe'" +
        		" and berichtdetails = 'asd'" +
        		" and aantalmeldingen = 2" +
        		" and tsverzonden = TIMESTAMP '2004-10-19 10:23:54'" +
        		" and bzm = 'zxc'" +
        		" and soortactie = 'GEBOORTE'" +
        		" and indprevalidatie = true";
