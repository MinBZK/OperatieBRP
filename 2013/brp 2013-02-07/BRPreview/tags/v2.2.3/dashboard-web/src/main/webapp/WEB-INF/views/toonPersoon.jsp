...
<c:choose>
    <c:when test="${bsn!=null && !empty bsn}">
        <c:set var="berichtenUrl" value="${baseUrl}${properties.berichten_context}${properties.berichten_service_uri}${properties.berichten_bsn_service_uri}/${bsn}" />
    </c:when>
    <c:otherwise>
...
<body>
	<script>
					 ...
					 success: function(data) {
						...
						if(data.aantalBerichten > 0) {
                            ...
                            for( var i in data.berichten.reverse()) {
								...
								console.log("Bericht " + i + " tonen" + $res);
								showNewMessage($res)	
							}
						}
					}
			...
			function createMessage(message) { 	
                ...
                content +='<p class="message" title="' + message.bericht + message.berichtDetails + '">';
                content +='Op:&nbsp;<span class="timestamp" title="' + timestamp.toJSON() + '" >' + timestamp.getDate() + '-' + timestamp.getMonth() + '-' + timestamp.getFullYear() + '&nbsp;' + timestamp.toTimeString() + '</span><br />';
    ...
    <div role="main">
        ...
        <section id="person">
            ...
            <section class="collapsable">
                <h3 class="inactive">Adres<img src="${contextRoot}/resources/images/history.png" class="historietonen" onclick="$('#adreshistorie').toggle()"></h3>
                <div>
                ...
                <c:set var="adreskopregel" value="vanaf ${vanaf}"/>
                 ...
                 <section id="adreshistorie">
	                ...
	                <h3 class="inactive"><img src="${contextRoot}/resources/images/history.png" class="historiesadres" title="Histories adres"/>Adres ${adreskopregel}</h3>
	                <div>
                    <table>                   
                    <tr>
                        <td class="label">Soort</td>
    ...
    <footer>
        <div clearfix><p><img src="${contextRoot}/resources/images/rijksoverheid-logo.jpg" height="50px"/>&copy;2012&nbsp;Versie <fmt:message key="application.version"/></p></div>
    </footer>
