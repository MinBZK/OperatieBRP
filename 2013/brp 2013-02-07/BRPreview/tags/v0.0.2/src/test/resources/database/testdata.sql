...
insert into dashboard.berichten (id, partij, bericht, berichtdetails, aantalmeldingen, tsverzonden, bzm, soortactie, indprevalidatie) values (1002, 'Rotterdam', 'Rotterdam heeft een geboorte geprevalideerd.', 'Zie politierapport inschrijving door woongemeente Rotterdam waarbij verwezen zal worden naar wereldvreemde moeder.', 1, timestamp '2012-01-15 10:09:08', 'ProcuraBZM', 'GEBOORTE', true);
