...
public class GeboorteBerichtenServiceTest {
    ...
    public void testOpslaanGeboorte() {
        ...
        Assert.assertEquals(
                "Johan Vlag geboren op 20-06-2012 te Utrecht. BSN: 198352888. Ouders: Cees Vlag en Paula Prins.",
    ...
    public void testOpslaanGeboortePrevalidatie() {
        ...
        Assert.assertEquals(
                "Marije Jansen geboren op 20-06-2012 te Amsterdam. BSN: 198352888. Ouders: Cees Vlag en Paula Prins.",
                argument.getValue().getBericht());
        Assert.assertEquals("Overrulebaar: Geslachtsnaam kind moet overeenkomen met die van één van de ouders. "
    ...
    public void testOpslaanGeboorteDoorAndereGemeente() {
        ...
        Assert.assertEquals(0, argument.getValue().getAantalMeldingen());
        Assert.assertEquals(
                "Mieke Vermeer geboren op 19-06-2012 te Amsterdam. BSN: 194622987. Ouders: Christoffel Vermeer en Eleonora de Crooy.",
                argument.getValue().getBericht());
        Assert.assertEquals("", argument.getValue().getBerichtDetails());
        Assert.assertEquals("CentricBZM", argument.getValue().getBurgerZakenModule());
        Assert.assertEquals("Amsterdam", argument.getValue().getPartij());
    ...
    public void testOpslaanGeboorteMetMinimaleInvoer() {
        ...
        Mockito.verify(berichtenDao).opslaan(argument.capture());
        Assert.assertEquals(0, argument.getValue().getAantalMeldingen());
        Assert.assertEquals("naam onbekend geboren op 20-06-2012 te ?. BSN: 198352888. Ouders: ? en ?.", argument
                .getValue().getBericht());
        Assert.assertEquals("", argument.getValue().getBerichtDetails());
        Assert.assertEquals("CentricBZM", argument.getValue().getBurgerZakenModule());
        Assert.assertEquals("Amsterdam", argument.getValue().getPartij());
