...
public class BerichtenOpslaanController {
     ...
     */
    @RequestMapping(value = "/berichten/opslaan/verhuizing", method = RequestMethod.PUT,
            headers = "Accept=application/json")
    public void opslaan(@RequestBody final VerhuisBerichtRequest requestBericht,
     ...
     * @return het bericht opslaan response object dat we teruggeven (is dit nodig?)
     */
    @RequestMapping(value = "/berichten/opslaan/geboorte", method = RequestMethod.PUT,
            headers = "Accept=application/json")
    public void opslaan(@RequestBody final GeboorteBerichtRequest requestBericht,
            final HttpServletResponse response)
    {
        berichtenService.opslaan(requestBericht);
     ...
     * @return het bericht opslaan response object dat we teruggeven (is dit nodig?)
     */
    @RequestMapping(value = "/berichten/opslaan/huwelijk", method = RequestMethod.PUT,
            headers = "Accept=application/json")
    public void opslaan(@RequestBody final HuwelijkBerichtRequest requestBericht,
            final HttpServletResponse response)
    {
        berichtenService.opslaan(requestBericht);
    }
     ...
     * @return het bericht opslaan response object dat we teruggeven (is dit nodig?)
     */
    @RequestMapping(value = "/berichten/opslaan/adrescorrectie", method = RequestMethod.PUT,
            headers = "Accept=application/json")
    public void opslaan(@RequestBody final AdrescorrectieBerichtRequest requestBericht,
            final HttpServletResponse response)
    {
        berichtenService.opslaan(requestBericht);
    }
