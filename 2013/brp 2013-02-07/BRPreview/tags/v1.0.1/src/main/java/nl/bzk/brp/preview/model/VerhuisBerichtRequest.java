...
public class VerhuisBerichtRequest extends AbstractBerichtRequest {
    ...
    public String creeerBerichtTekst() {
        ...
        String voornaam = getVoornaamTekst(persoon.getVoornamen());
    ...
    private String getVoornaamTekst(final List<String> voornamen) {
        String resultaat;
        if (voornamen == null || voornamen.isEmpty() || voornamen.get(0) == null || voornamen.get(0).length() == 0) {
            resultaat = "persoon ";
        } else {
            resultaat = voornamen.get(0) + " ";
        }
        return resultaat;
    }
