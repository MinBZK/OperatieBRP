...
public class DashboardSettings {
    ...
    public static final int MAX_AANTAL_BERICHTEN_PER_RESPONSE  = 250;

    /** De constante MAX_AANTAL_BERICHTEN. */
    public static final int MAX_AANTAL_BERICHTEN_TONEN         = 6;
    ...
    private int             maximaalAantalBerichtenTonen       = MAX_AANTAL_BERICHTEN_TONEN;
