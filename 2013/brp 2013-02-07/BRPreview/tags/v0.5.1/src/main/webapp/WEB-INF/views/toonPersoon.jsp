...
<head>
    ...
    <link type="text/css" href="http://${pageContext.request.serverName}:${pageContext.request.localPort}${pageContext.request.contextPath}/resources/css/html5reset.css" rel="stylesheet" />
...
<body>
    ...
    <footer>
        <div clearfix><p><img src="resources/images/rijksoverheid-logo.jpg" height="50px"/>&copy;2012&nbsp;Versie <fmt:message key="application.version"/></p></div>
    </footer>
