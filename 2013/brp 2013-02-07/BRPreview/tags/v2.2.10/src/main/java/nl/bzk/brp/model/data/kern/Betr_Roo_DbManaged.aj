...
privileged aspect Betr_Roo_DbManaged {
    ...
    private Set<HisOuderouderlijkgezag> Betr.hisOuderouderlijkgezags;
    
    @OneToMany(mappedBy = "betr")
    private Set<HisOuderouderschap> Betr.hisOuderouderschaps;
    ...
    private Boolean Betr.ouderuitwiekindisvoortgekome;
    ...
    public Set<HisOuderouderlijkgezag> Betr.getHisOuderouderlijkgezags() {
        return hisOuderouderlijkgezags;
    }
    
    public void Betr.setHisOuderouderlijkgezags(Set<HisOuderouderlijkgezag> hisOuderouderlijkgezags) {
        this.hisOuderouderlijkgezags = hisOuderouderlijkgezags;
    }
    
    public Set<HisOuderouderschap> Betr.getHisOuderouderschaps() {
        return hisOuderouderschaps;
    }
    
    public void Betr.setHisOuderouderschaps(Set<HisOuderouderschap> hisOuderouderschaps) {
    ...
    public Boolean Betr.getOuderuitwiekindisvoortgekome() {
        return ouderuitwiekindisvoortgekome;
    }
    
    public void Betr.setOuderuitwiekindisvoortgekome(Boolean ouderuitwiekindisvoortgekome) {
