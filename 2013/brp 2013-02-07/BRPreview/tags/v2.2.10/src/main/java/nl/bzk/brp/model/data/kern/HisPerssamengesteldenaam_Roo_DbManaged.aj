...
privileged aspect HisPerssamengesteldenaam_Roo_DbManaged {
    ...
    @NotNull
    private boolean HisPerssamengesteldenaam.indnreeks;
    ...
    public boolean HisPerssamengesteldenaam.isIndnreeks() {
        return indnreeks;
    }
    
    public void HisPerssamengesteldenaam.setIndnreeks(boolean indnreeks) {
