...
<head>
    ...
    <script src="${contextRoot}/resources/js/libs/jquery.autoellipsis-1.0.3.min.js" type="text/javascript"></script>
	...
	<script>
		    ...
		    function getNewMessages() {		    	
		    	...
		    	urlMessagesSince = "${baseUrl}${properties.berichten_request_uri}/" + lastCall.getTime();
		    ...
		    function getAllMessages() {
                //console.log("URL " + "${baseUrl}${properties.berichten_request_uri}");

		    	$.ajax ({
					 url: "${baseUrl}${properties.berichten_request_uri}",
					 dataType: 'json',
					 timeout: 10000,
					 success: function(data) {
						if (!data.berichten){
