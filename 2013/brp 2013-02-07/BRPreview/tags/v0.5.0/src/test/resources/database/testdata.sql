...
insert into dashboard.statistieken(id, soort, onderwerp, aantal) values (1, 'GENERIEK', 'Prevalidaties',12);
insert into dashboard.statistieken(id, soort, onderwerp, aantal) values (2, 'GEBOORTE', 'Alkmaar',1);
insert into dashboard.statistieken(id, soort, onderwerp, aantal) values (3, 'VERHUIZING', 'Rotterdam',1);
