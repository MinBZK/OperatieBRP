...
public class BerichtDaoImpl implements BerichtenDao {
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.dataaccess.BerichtenDao#getBerichtenVoorPartij(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.dataaccess.BerichtenDao#getBerichtenVoorPartijVanaf(java.lang.String, java.util.Calendar)
     */
    @Override
    ...
    /**
     * Haalt berichten op, op basis van een sql statement en parameters.
     *
     * @param sql de sql
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.dataaccess.BerichtenDao#getBsns(int)
     */
    @Override
