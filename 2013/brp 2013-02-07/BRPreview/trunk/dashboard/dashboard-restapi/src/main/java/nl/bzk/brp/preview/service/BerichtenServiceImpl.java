...
public class BerichtenServiceImpl implements BerichtenService {
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.service.BerichtenService#setMaximumAantalBerichtenTonen(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.service.BerichtenService#getBerichtenVoorPartij(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.service.BerichtenService#getBerichtenVoorPartijVanaf(java.lang.String,
     *  java.util.Calendar)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.service.BerichtenService#getBerichtenVoorBsn(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.bzk.brp.preview.service.BerichtenService#getBsns()
     */
    @Override
    public Set<Integer> getBsns() {
        return berichtenDao.getBsns(settings.getAantalRecenteBsnsVoorAutocompletion());
    }
