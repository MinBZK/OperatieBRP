...
public class DefaultGrammar extends AbstractGrammar {
    ...
    protected void initIdentifiers() {
        ...
        voegToeIdentifier("Persoon.Geslacht.Naam");
        voegToeIdentifier("Persoon.Geslachtsaand.Code");
        voegToeIdentifier("Persoon.datgeboorte");
        voegToeIdentifier("Persoon.Adres.Woonplaats.Naam");
        voegToeIdentifier("Persoon.Adres.Gemeente.ID");
        voegToeIdentifier("Persoon.bsn");
    ...
    protected void initVervangingen() {
        ...
        voegToeIdentifierVervanging("Geslacht", "Persoon.Geslachtsaand.Code");
        voegToeIdentifierVervanging("InOnderzoek", "Persoon.indgegevensinonderzoek = 'J'");
        voegToeIdentifierVervanging("Woonplaats", "Persoon.Adres.Woonplaats.Naam");
        voegToeIdentifierVervanging("Leeftijd", "Jaar(Min(Vandaag, Persoon.datgeboorte))");
        voegToeIdentifierVervanging("Provincie", "Provincie(Persoon.Adres.Gemeente.ID)");
    }
