...
public class Main {
    ...
    private Map<String, Generator> generatoren;
        ...
        final String... generatorNames)
    {
        ...
        /*
         * Selecteren en runnen generatoren.
         */
        ...
        for (String name : generatorNames) {
            ...
            Generator generator = generatoren.get(name);
            if (generator == null) {
                LOGGER.error("Generator '{}' onbekend.", name);
                continue;
            }
            LOGGER.info("Generator '{}' voor model '{}' naar directory '{}'.", new String[] { name, modelNaam,
