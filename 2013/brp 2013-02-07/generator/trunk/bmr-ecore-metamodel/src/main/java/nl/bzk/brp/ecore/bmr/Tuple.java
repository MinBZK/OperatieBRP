 ...
 *   <li>{@link nl.bzk.brp.ecore.bmr.Tuple#getCategorieSoortActie <em>Categorie Soort Actie</em>}</li>
 *   <li>{@link nl.bzk.brp.ecore.bmr.Tuple#getCategorieSoortDocument <em>Categorie Soort Document</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Tuple
{
    ...
    /**
     * Returns the value of the '<em><b>Categorie Soort Actie</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Categorie Soort Actie</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @return the value of the '<em>Categorie Soort Actie</em>' attribute.
     * @see #setCategorieSoortActie(String)
     * @see nl.bzk.brp.ecore.bmr.BmrPackage#getTuple_CategorieSoortActie()
     * @model
     * @generated
     */
    String getCategorieSoortActie();

    /**
     * Sets the value of the '{@link nl.bzk.brp.ecore.bmr.Tuple#getCategorieSoortActie <em>Categorie Soort Actie</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Categorie Soort Actie</em>' attribute.
     * @see #getCategorieSoortActie()
     * @generated
     */
    void setCategorieSoortActie(String value);

    /**
     * Returns the value of the '<em><b>Categorie Soort Document</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Categorie Soort Document</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @return the value of the '<em>Categorie Soort Document</em>' attribute.
     * @see #setCategorieSoortDocument(String)
     * @see nl.bzk.brp.ecore.bmr.BmrPackage#getTuple_CategorieSoortDocument()
     * @model
     * @generated
     */
    String getCategorieSoortDocument();

    /**
     * Sets the value of the '{@link nl.bzk.brp.ecore.bmr.Tuple#getCategorieSoortDocument <em>Categorie Soort Document</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Categorie Soort Document</em>' attribute.
     * @see #getCategorieSoortDocument()
     * @generated
     */
    void setCategorieSoortDocument(String value);
