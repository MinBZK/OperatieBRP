...
public class TekstImpl extends EObjectImpl implements Tekst
{
    ...
    {
        if (eContainerFeatureID() != BmrPackage.TEKST__ELEMENT) return null;
    ...
    {
        msgs = eBasicSetContainer((InternalEObject)newElement, BmrPackage.TEKST__ELEMENT, msgs);
        return msgs;
    }
    ...
    {
        if (newElement != eInternalContainer() || (eContainerFeatureID() != BmrPackage.TEKST__ELEMENT && newElement != null))
        {
            if (EcoreUtil.isAncestor(this, (EObject)newElement))
                throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
            NotificationChain msgs = null;
            if (eInternalContainer() != null)
                msgs = eBasicRemoveFromContainer(msgs);
            if (newElement != null)
                msgs = ((InternalEObject)newElement).eInverseAdd(this, BmrPackage.ELEMENT__TEKSTEN, Element.class, msgs);
            msgs = basicSetElement(newElement, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BmrPackage.TEKST__ELEMENT, newElement, newElement));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
    {
        ...
        {
            case BmrPackage.TEKST__ELEMENT:
                return eInternalContainer().eInverseRemove(this, BmrPackage.ELEMENT__TEKSTEN, Element.class, msgs);
        }
