...
public abstract class ModelElementImpl extends EObjectImpl implements ModelElement {
    ...
    public String getOuderNaam() {
        if ((eContainer() != null) && (eContainer() instanceof ModelElementImpl)) {
            ModelElement container = (ModelElement) eContainer;
            return container.getGekwalificeerdeNaam();
        }
        return null;
    }
    ...
    public String getGekwalificeerdeNaam() {
        ...
        if (getOuderNaam() != null) {
            resultaat.append(getOuderNaam()).append(":");
        }
