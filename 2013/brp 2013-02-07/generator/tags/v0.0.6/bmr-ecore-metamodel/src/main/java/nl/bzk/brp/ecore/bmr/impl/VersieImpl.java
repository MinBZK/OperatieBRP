...
public class VersieImpl extends ElementImpl implements Versie {
    ...
    public Schema getSchema() {
        if (eContainerFeatureID() != BmrPackage.VERSIE__SCHEMA)
            return null;
     ...
     * @generated
     */
    public NotificationChain basicSetSchema(final Schema newSchema, NotificationChain msgs) {
    ...
    public void setSchema(final Schema newSchema) {
        if (newSchema != eInternalContainer()
            || (eContainerFeatureID() != BmrPackage.VERSIE__SCHEMA && newSchema != null))
        {
     ...
     */
    @Override
    public void setVersieTag(final VersieTag newVersieTag) {
        VersieTag oldVersieTag = versieTag;
        versieTag = newVersieTag == null ? VERSIE_TAG_EDEFAULT : newVersieTag;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BmrPackage.VERSIE__VERSIE_TAG, oldVersieTag,
                    versieTag));
    }
     ...
     */
    @Override
    public EList<ObjectType> getObjectTypes() {
        if (objectTypes == null) {
            objectTypes =
                new EObjectContainmentWithInverseEList<ObjectType>(ObjectType.class, this,
                        BmrPackage.VERSIE__OBJECT_TYPES, BmrPackage.OBJECT_TYPE__VERSIE);
        }
        return objectTypes;
    }
     ...
     */
    @Override
    public EList<AttribuutType> getAttribuutTypes() {
        if (attribuutTypes == null) {
            attribuutTypes =
                new EObjectContainmentWithInverseEList<AttribuutType>(AttribuutType.class, this,
                        BmrPackage.VERSIE__ATTRIBUUT_TYPES, BmrPackage.ATTRIBUUT_TYPE__VERSIE);
        }
     ...
     */
    @Override
    public EList<BerichtSjabloon> getBerichtSjablonen() {
        if (berichtSjablonen == null) {
            berichtSjablonen =
                new EObjectContainmentWithInverseEList<BerichtSjabloon>(BerichtSjabloon.class, this,
                        BmrPackage.VERSIE__BERICHT_SJABLONEN, BmrPackage.BERICHT_SJABLOON__VERSIE);
        }
    ...
    public NotificationChain eInverseAdd(final InternalEObject otherEnd, final int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case BmrPackage.VERSIE__ATTRIBUUT_TYPES:
                return ((InternalEList<InternalEObject>) (InternalEList<?>) getAttribuutTypes()).basicAdd(otherEnd,
                        msgs);
            case BmrPackage.VERSIE__BERICHT_SJABLONEN:
                return ((InternalEList<InternalEObject>) (InternalEList<?>) getBerichtSjablonen()).basicAdd(otherEnd,
                        msgs);
        }
