...
public class ExportRegelJpaRepository implements ExportRegelRepository {
    ...
    public void setExportIdentifier(final String interneIdentifier, final String naam, final String exportIdentifier) {
        ...
        /*
         * Elementen die we niet zelf geëxporteerd hebben negeren we met een warning.
         */
        if (regel == null) {
            LOGGER.warn("Export identifier niet gevonden: {}:{}", interneIdentifier, naam);
        } else {
            /*
            ...
            if ((regel.getExportIdentifier() != null) && !regel.getExportIdentifier().equals(exportIdentifier)) {
                ...
                message.append(" is door EA gewijzigd. Was: ");
                message.append(regel.getExportIdentifier());
                message.append("; nieuwe ID: ");
                message.append(exportIdentifier);
            ...
            if (regel.getExportIdentifier() == null) {
                 ...
                 */
                LOGGER.debug("Nieuwe export identifier voor {} {}: {})", new Object[] { interneIdentifier, naam,
                    exportIdentifier });
