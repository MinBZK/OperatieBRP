...
public class BmrPackageImpl extends EPackageImpl implements BmrPackage
{
     ...
     * @generated
     */
    public EAttribute getAttribuut_InSetOfModel()
    {
        return (EAttribute)attribuutEClass.getEStructuralFeatures().get(1);
    }
    ...
    {
        return (EReference)attribuutEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EAttribute getGroep_InSetOfModel()
    {
        return (EAttribute)groepEClass.getEStructuralFeatures().get(1);
    }
    ...
    {
        return (EReference)groepEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EAttribute getObjectType_InSetOfModel()
    {
    ...
    {
        return (EAttribute)objectTypeEClass.getEStructuralFeatures().get(12);
    }
    ...
    public void createPackageContents()
    {
        ...
        createEAttribute(attribuutEClass, ATTRIBUUT__IN_SET_OF_MODEL);
        ...
        createEAttribute(groepEClass, GROEP__IN_SET_OF_MODEL);
        ...
        createEAttribute(objectTypeEClass, OBJECT_TYPE__IN_SET_OF_MODEL);
    ...
    public void initializePackageContents()
    {
        ...
        initEAttribute(getAttribuut_InSetOfModel(), this.getInSetOfModel(), "inSetOfModel", null, 0, 1, Attribuut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getAttribuut_HistorieVastleggen(), ecorePackage.getEBooleanObject(), "historieVastleggen", "false", 0, 1, Attribuut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAttribuut_Verplicht(), ecorePackage.getEBooleanObject(), "verplicht", "false", 0, 1, Attribuut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getElement_Teksten(), this.getSoortTekstToTekstMapEntry(), null, "teksten", null, 0, -1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getGroep_InSetOfModel(), this.getInSetOfModel(), "inSetOfModel", null, 0, 1, Groep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        addEOperation(groepEClass, ecorePackage.getEBooleanObject(), "isHistorieVastleggen", 0, 1, IS_UNIQUE, IS_ORDERED);

        addEOperation(groepEClass, ecorePackage.getEBooleanObject(), "isVerplicht", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        initEAttribute(getObjectType_InSetOfModel(), this.getInSetOfModel(), "inSetOfModel", null, 0, 1, ObjectType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getObjectType_HistorieVastleggen(), ecorePackage.getEString(), "historieVastleggen", "false", 0, 1, ObjectType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getTekst_Element(), this.getElement(), null, "element", null, 0, 1, Tekst.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
