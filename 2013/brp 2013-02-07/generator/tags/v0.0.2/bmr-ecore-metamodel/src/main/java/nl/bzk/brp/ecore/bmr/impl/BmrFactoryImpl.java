...
public class BmrFactoryImpl extends EFactoryImpl implements BmrFactory
{
    ...
    public EObject create(EClass eClass)
    {
        ...
        {
            case BmrPackage.ATTRIBUUT: return createAttribuut();
            case BmrPackage.ATTRIBUUT_TYPE: return createAttribuutType();
            case BmrPackage.BASIS_TYPE: return createBasisType();
            case BmrPackage.BEDRIJFS_REGEL: return createBedrijfsRegel();
            case BmrPackage.BERICHT_SJABLOON: return createBerichtSjabloon();
            case BmrPackage.DOMEIN: return createDomein();
            case BmrPackage.GROEP: return createGroep();
            case BmrPackage.LAAG: return createLaag();
            case BmrPackage.META_REGISTER: return createMetaRegister();
            case BmrPackage.OBJECT_TYPE: return createObjectType();
            case BmrPackage.SCHEMA: return createSchema();
            case BmrPackage.TEKST: return createTekst();
            case BmrPackage.TUPLE: return createTuple();
            case BmrPackage.VERSIE: return createVersie();
            case BmrPackage.WAARDEREGEL_WAARDE: return createWaarderegelWaarde();
            case BmrPackage.SOORT_TEKST_TO_TEKST_MAP_ENTRY: return (EObject)createSoortTekstToTekstMapEntry();
            case BmrPackage.APPLICATIE: return createApplicatie();
            case BmrPackage.FORMULIER: return createFormulier();
            case BmrPackage.FRAME: return createFrame();
            case BmrPackage.FRAME_VELD: return createFrameVeld();
            case BmrPackage.BRON: return createBron();
            case BmrPackage.BRON_ATTRIBUUT: return createBronAttribuut();
            default:
