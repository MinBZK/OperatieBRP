...
public class MetaRegisterImpl extends EObjectImpl implements MetaRegister {
    ...
    public EList<BasisType> getBasisTypen() {
        if (basisTypen == null) {
            basisTypen =
                new EObjectContainmentEList<BasisType>(BasisType.class, this, BmrPackage.META_REGISTER__BASIS_TYPEN);
        }
        return basisTypen;
    }
    ...
    public EList<Applicatie> getApplicaties() {
        if (applicaties == null) {
            applicaties =
                new EObjectContainmentEList<Applicatie>(Applicatie.class, this, BmrPackage.META_REGISTER__APPLICATIES);
        }
        return applicaties;
    }
