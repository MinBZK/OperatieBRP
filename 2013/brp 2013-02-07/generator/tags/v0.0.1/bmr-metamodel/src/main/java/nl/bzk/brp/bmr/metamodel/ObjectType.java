...
public class ObjectType extends Type {
    ...
    private String           historieVastleggen;

    @Column(name = "INSOM")
    private InSetOfModel     inSetOfModel;
    ...
    public List<Groep> getGroepen() {
        return new ArrayList<Groep>(groepen);
    }
    ...
    public Attribuut getIdAttribuut() {
        return Iterables.find(attributen, new Predicate<Attribuut>() {
            ...
            @Override
            public boolean apply(final Attribuut input) {
                return input.isIdentifier();
            }
        });
    }
