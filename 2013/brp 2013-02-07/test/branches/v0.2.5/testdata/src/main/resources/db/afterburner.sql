...
SELECT SETVAL('kern.seq_bron', (select 1+ coalesce(max(id),0)  FROM "kern"."bron"), true);
...
SELECT SETVAL('kern.seq_his_betrouderschap', (select 1+ coalesce(max(id),0)  FROM "kern"."his_betrouderschap"), true);
SELECT SETVAL('kern.seq_his_betrouderlijkgezag', (select 1+ coalesce(max(id),0)  FROM "kern"."his_betrouderlijkgezag"), true);
...
SELECT SETVAL('kern.seq_his_persbijhverantwoordelijk', (select 1+ coalesce(max(id),0)  FROM "kern"."his_persbijhverantwoordelijk"), true);
...
SELECT SETVAL('kern.seq_his_persverblijfsr', (select 1+ coalesce(max(id),0)  FROM "kern"."his_persverblijfsr"), true);
