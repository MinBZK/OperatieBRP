...
WHERE 
  ...
  (pers.bsn = ${DataSource Values#burgerservicenummer_ipp_1} or pers.bsn= ${DataSource Values#burgerservicenummer_ipp_2} or pers.bsn= ${DataSource Values#burgerservicenummer_ipw_2}) 
  AND  
  huwelijk.srt = 1
