...
-- Deze lijst van indexen werden met de hand aangemaakt, omdat gebleken is dat op foreign NIET automatisch indexen werden gemaakt.
...
CREATE INDEX AdmHndBijgehoudenPers_AdmHnd ON Ber.AdmHndBijgehoudenPers (AdmHnd);
CREATE INDEX AdmHndBijgehoudenPers_Pers ON Ber.AdmHndBijgehoudenPers (Pers);
...
CREATE INDEX AdmHndGedeblokkeerdeMelding_AdmHnd ON Ber.AdmHndGedeblokkeerdeMelding (AdmHnd);
CREATE INDEX AdmHndGedeblokkeerdeMelding_Overrule ON Ber.AdmHndGedeblokkeerdeMelding (GedeblokkeerdeMelding);
