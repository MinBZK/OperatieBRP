...
public final class BedrijfsregelExportUtils {
     ...
     */
    public static void append(final List<BedrijfsregelReference> ruleRefs) {
        PrintWriter out = getPrintWriter();
        export(out, ruleRefs);
        out.flush();
        out.close();
     ...
     */
    private static void export(final PrintWriter out, final List<BedrijfsregelReference> ruleRefs) {
     ...
     */
    private static String convertToCsvRecord(final BedrijfsregelReference ruleRef) {
        StringBuilder result = new StringBuilder();
