...
public class GroepDaoTest extends AbstractRepositoryTestCase {
    ...
    public void testGetAll() {
        ...
        String sql = "select count(0) from element where soort = 'G' and versie_tag = 'W' and laag = 1749 and (insom is null or insom in ('M', 'B'))";
    ...
    public void testGetGroepen() {
        List<ObjectType> objectTypes = opjectTypeDao.getAll();
