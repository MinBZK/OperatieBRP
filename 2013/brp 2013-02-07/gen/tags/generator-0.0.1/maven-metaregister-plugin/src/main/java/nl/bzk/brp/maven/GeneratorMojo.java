    ...
    extends AbstractMojo
{
    ...
    /**
     * Locatie van gegenereerde usr bestanden.
     * @parameter expression="${project.build.directory}/generated-sources"
     *
     */
    private File userCodeDirectory;
    
    /**
     * package naam waarin de code gegenereerd moet worden
     * @parameter expression="${generator.basePackage}" default-value="nl.bzk.brp.model"
     * @required
     */
        ...
        throws MojoExecutionException
    {
        ...
        ModelGenerator generator = ctx.getBean("java-generator", ModelGenerator.class);
        ...
        try
        {
            ...
            options.put("basePackage", javaBasePackage);
            reports = generator.genereer(generationTargetDirectory.getAbsolutePath(), userCodeDirectory.getAbsolutePath(), options);
