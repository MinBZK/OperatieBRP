...
public class JavaGroepActueelBasisGeneratorTest extends AbstractBmrTest {

    @Autowired(required = true)
    private JavaGroepActueelBasisGenerator generator;
    ...
    public void genereerGroepNormaal() {
        ...
        Assert.assertEquals(getVerwachtResultaat("AbstractBetrokkenheidOuderlijkGezagActGroepModel.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepStandaard() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("AbstractPersoonAdresStandaardActGroepModel.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepMetDynamischeAttributen() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("AbstractPersoonInschrijvingActGroepModel.jav"), toUnixString(writer));
    }
