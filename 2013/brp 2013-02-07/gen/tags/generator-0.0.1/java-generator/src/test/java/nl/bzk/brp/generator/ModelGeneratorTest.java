...
public class ModelGeneratorTest extends AbstractBmrTest {
    ...
    /**
     * Test method for
     * {@link nl.bzk.brp.generator.ModelGenerator#genereer(java.lang.String, java.lang.String, java.util.Properties)}.
     * @throws IOException 
     */
    @Test
    public final void testGenereer() throws IOException {
        ...
        try {
            ...
            properties.put("basePackage", "nl.bzk.brp.test");
            reports = generator.genereer(testDir, testDir, properties);
