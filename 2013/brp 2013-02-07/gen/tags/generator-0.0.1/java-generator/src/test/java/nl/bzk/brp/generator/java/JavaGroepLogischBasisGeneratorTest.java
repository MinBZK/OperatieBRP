...
public class JavaGroepLogischBasisGeneratorTest extends AbstractBmrTest {
    ...
    public void genereerGroepNormaal() {
        ...
        Assert.assertEquals(getVerwachtResultaat("BetrokkenheidOuderlijkGezagGroepBasis.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepStandaard() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("PersoonAdresStandaardGroepBasis.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepMetDynamischeAttributen() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("PersoonInschrijvingGroepBasis.jav"), toUnixString(writer));
    }
