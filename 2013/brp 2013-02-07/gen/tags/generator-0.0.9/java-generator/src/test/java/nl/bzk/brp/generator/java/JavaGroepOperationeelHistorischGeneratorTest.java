...
public class JavaGroepOperationeelHistorischGeneratorTest extends AbstractBmrTest {
    ...
    public void genereerGroepNormaal() {
        ...
        Assert.assertEquals(getVerwachtResultaat("BetrokkenheidOuderlijkGezagHisModel.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepStandaard() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("PersoonAdresStandaardHisModel.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepMetDynamischeAttributen() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("PersoonInschrijvingHisModel.jav"), toUnixString(writer));
    }
