...
public class JavaAttribuutTypeBasisGeneratorTest extends AbstractBmrTest {

    @Autowired(required = true)
    private JavaAttribuutTypeBasisGenerator generator;
    ...
    public void genereerAttribuutTypeDatum() {
        ...
        Assert.assertEquals(getVerwachtResultaat("DatumBasis.jav"), toUnixString(writer));
    }
    ...
    public void genereerAttribuutTypeIpAdres() {
        ...
        generator.genereerElement(writer, report, attribuutType);
        Assert.assertEquals(getVerwachtResultaat("IPAdresBasis.jav"), toUnixString(writer));
    }
