...
public class Partij extends AbstractStatischObjectType {
     ...
     * @param datumAanvang de datumAanvang.
     * @param sector de sector.
     * @param voortzettendeGemeente de voortzettendeGemeente.
     * @param onderdeelVan de onderdeelVan.
     *
     */
     Partij(final Naam naam, final Soort soort, final Code code, final DatumEinde datumEinde, final DatumAanvang datumAanvang, 
        final Sector sector, final VoortzettendeGemeente voortzettendeGemeente, final OnderdeelVan onderdeelVan) {
        this.naam =  naam;
        this.soort =  soort;
        this.code =  code;
