...
public class JavaGroepLogischGeneratorTest extends AbstractBmrTest {
    ...
    public void genereerGroepNormaal() {
        ...
        Assert.assertEquals(getVerwachtResultaat("BetrokkenheidOuderlijkGezagGroep.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepStandaard() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("PersoonAdresStandaardGroep.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepMetDynamischeAttributen() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("PersoonInschrijvingGroep.jav"), toUnixString(writer));
    }
