...
public class JavaGroepOperationeelHistorischBasisGeneratorTest extends AbstractBmrTest {
    ...
    public void genereerGroepNormaal() {
        ...
        Assert.assertEquals(getVerwachtResultaat("AbstractBetrokkenheidOuderlijkGezagHisModel.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepStandaard() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("AbstractPersoonAdresStandaardHisModel.jav"), toUnixString(writer));
    }
    ...
    public void genereerGroepMetDynamischeAttributen() {
        ...
        generator.genereerElement(writer, report, groep);
        Assert.assertEquals(getVerwachtResultaat("AbstractPersoonInschrijvingHisModel.jav"), toUnixString(writer));
    }
