...
public class ObjectInterface {
    ...
    private final List<Method>      accessors  = new ArrayList<Method>();
    private final List<Method>      modifiers  = new ArrayList<Method>();
    private final List<Method>      methods    = new ArrayList<Method>();
    private final List<Identifier>  interfaces = new ArrayList<Identifier>();
