...
public class XsdObjectTypeContext {
    ...
    public XsdObjectTypeContext(final ObjectType objectType) {
        ...
        this.gevondenGroepen = new ArrayList<Groep>();
        this.gevondenInverseAssociaties = new ArrayList<InverseAssociatie>();
        this.gevondenElementen = new ArrayList<Pair<String, Element>>();
    }
    ...
    public void voegGroepElementenToe(final Groep groep, final List<Element> elementen) {
        for (Element element : elementen) {
            this.voegGroepElementToe(groep, element);
        }
    }
    ...
    public void voegGroepElementToe(final Groep groep, final Element element) {
        if (StringUtils.isBlank(groep.getXsdType())
                && !AbstractGenerator.NIET_ZELFSTANDIGE_GROEPEN.contains(groep.getNaam()))
        {
    ...
    public List<Element> getToeTeVoegenElementen() {
        this.sorteer();
        List<Element> toeTeVoegenElementen = new ArrayList<Element>();
