...
public abstract class AbstractModelSpecifiekeNaamgevingStrategie extends AbstractNaamgevingStrategie {
    ...
    private final AlgemeneNaamgevingStrategie algemeneNaamgevingStrategie = new AlgemeneNaamgevingStrategie();
    ...
    protected final String bepaalPackageNaamVoorElement(final GeneriekElement element) {
        ...
        if (algemeneNaamgevingStrategie.heeftElementEenAlgemeneNaam(element)) {
            packageNaam = algemeneNaamgevingStrategie.bepaalPackageNaamVoorElement(element);
        } else {
            switch (soort) {
                case OBJECTTYPE:
                    packageNaam =
    ...
    protected final String bepaalJavaTypeNaamVoorElement(final GeneriekElement element) {
        ...
        if (algemeneNaamgevingStrategie.heeftElementEenAlgemeneNaam(element)) {
            javaTypeNaam = algemeneNaamgevingStrategie.bepaalJavaTypeNaamVoorElement(element);
        } else {
