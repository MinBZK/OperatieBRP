...
public class BronCodeFormatterImpl implements BronCodeFormatter {
    ...
    private static final Logger LOGGER = Logger.getLogger(BronCodeFormatter.class);
    ...
    private Map<String, String> leesFormatterOptiesIn() {
        Map<String, String> opties = new HashMap<String, String>();
        opties.put(JavaCore.COMPILER_SOURCE, "1.5");
        opties.put(JavaCore.COMPILER_COMPLIANCE, "1.5");
        opties.put(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, "1.5");
