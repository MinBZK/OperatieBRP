...
public class GeneratorenMojo extends AbstractMojo {
    ...
    {
        final Map<String, GeneratorConfiguratie> includeConfiguraties = new HashMap<String, GeneratorConfiguratie>();
    ...
    private Map<String, GeneratorConfiguratie> filterConfiguratiesVoorExcludes(
        final Map<String, GeneratorConfiguratie> configuraties)
    {
        final Map<String, GeneratorConfiguratie> excludeConfiguraties = new HashMap<String, GeneratorConfiguratie>();
        ...
        throws MojoExecutionException
    {
        if (generatorenConfiguraties == null) {
            ...
            final Map<String, GeneratorConfiguratie> configuraties = new HashMap<String, GeneratorConfiguratie>();
