...
public class ObjectTypeTest extends AbstractRepositoryTestCase {
    ...
    public void testGetAttributen() {
        ...
        // test
        Iterator<Attribuut> attributen = enumeratieType.getAttributen().iterator();
    ...
    public void testGetGroepen() {
        ...
        // test
        Iterator<Groep> groepen = objectType.getGroepen().iterator();
    ...
    private ObjectType getObjectTypeOpNaam(final List<ObjectType> objectTypes, final String name) {
