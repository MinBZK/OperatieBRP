...
public class GeneratorenUitvoerder {
    ...
    private static Map<String, GeneratorConfiguratie> bouwConfiguratieMap(final List<String> configuratiePatronen) {
        final Map<String, GeneratorConfiguratie> configuratieMap = new HashMap<String, GeneratorConfiguratie>();
     ...
     */
    public void genereer(final Map<String, GeneratorConfiguratie> generatorConfiguratieMap)
    {
    ...
    private void genereerVoorGenerator(final String naam, final GeneratorConfiguratie configuratie) {
        try {
            Generator generator = applicatieContext.getBean(naam, Generator.class);
