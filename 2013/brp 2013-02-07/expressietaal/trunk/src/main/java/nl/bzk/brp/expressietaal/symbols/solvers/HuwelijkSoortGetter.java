 ...
 */
public class HuwelijkSoortGetter implements AttributeGetter {
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Relatie) {
            Relatie v = (Relatie) rootObject;
            if (v.getSoort() != null) {
                return new StringLiteralExpressie(v.getSoort().getCode());
            }
        }
