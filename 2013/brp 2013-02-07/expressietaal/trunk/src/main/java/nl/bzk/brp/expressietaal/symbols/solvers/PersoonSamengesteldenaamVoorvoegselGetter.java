...
/**
 * Getter voor 'samengesteldenaam.voorvoegsel' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamVoorvoegselGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.voorvoegsel' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getVoorvoegsel() != null) {
                return new StringLiteralExpressie(v.getSamengesteldeNaam().getVoorvoegsel().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.voorvoegsel' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.voorvoegsel' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
