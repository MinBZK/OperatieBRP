...
/**
 * Getter voor 'samengesteldenaam.adellijke_titel' in objecttype 'Persoon'.
 * <p/>
...
public class PersoonSamengesteldenaamAdellijkeTitelGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.adellijke_titel' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getAdellijkeTitel() != null
                    && v.getSamengesteldeNaam().getAdellijkeTitel().getCode() != null)
            {
                return new StringLiteralExpressie(v.getSamengesteldeNaam().getAdellijkeTitel().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.adellijke_titel' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.adellijke_titel' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
