...
/**
 * Getter voor 'gemeente_aanvang' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkGemeenteAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'gemeente_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getGemeenteAanvang() != null
                    && v.getStandaard().getGemeenteAanvang().getCode() != null)
            {
                return new StringLiteralExpressie(v.getStandaard().getGemeenteAanvang().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'gemeente_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'gemeente_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
