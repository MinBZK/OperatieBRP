...
/**
 * Getter voor 'gemeente_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkGemeenteEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'gemeente_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getGemeenteEinde() != null
                    && v.getStandaard().getGemeenteEinde().getCode() != null)
            {
                return new StringLiteralExpressie(v.getStandaard().getGemeenteEinde().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'gemeente_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'gemeente_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
