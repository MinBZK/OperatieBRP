...
/**
 * Getter voor 'samengesteldenaam.namenreeks' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamNamenreeksGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.namenreeks' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getIndicatieNamenreeks() != null) {
                return new BooleanLiteralExpressie(v.getSamengesteldeNaam().getIndicatieNamenreeks().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.namenreeks' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.namenreeks' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
