...
public class PersoonOverlijdenBuitenlandsePlaatsGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.buitenlandse_plaats' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null && v.getOverlijden().getBuitenlandsePlaatsOverlijden() != null) {
                return new StringLiteralExpressie(v.getOverlijden().getBuitenlandsePlaatsOverlijden().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.buitenlandse_plaats' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'overlijden.buitenlandse_plaats' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
