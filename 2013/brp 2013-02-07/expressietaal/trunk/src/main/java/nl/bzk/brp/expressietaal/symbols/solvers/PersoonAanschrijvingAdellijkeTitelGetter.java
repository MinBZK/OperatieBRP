...
/**
 * Getter voor 'aanschrijving.adellijke_titel' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingAdellijkeTitelGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.adellijke_titel' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getAdellijkeTitelAanschrijving() != null
                    && v.getAanschrijving().getAdellijkeTitelAanschrijving().getCode() != null)
            {
                return new StringLiteralExpressie(v.getAanschrijving().getAdellijkeTitelAanschrijving().getCode()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.adellijke_titel' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.adellijke_titel' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
