 ...
 */
public class MinusOperatorExpressie extends AbstractNumericOperatorExpressie {
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new MinusOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
    ...
    public final Expressie optimaliseer() {
        ...
        {
            exp = new NumericNegateExpressie(gereduceerdeTermRechts);
