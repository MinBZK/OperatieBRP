...
/**
 * Getter voor 'indicaties' in objecttype 'PersoonIndicatie'.
 * <p/>
...
public class PersoonIndicatiesGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'indicaties' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'indicaties' uit een bepaald
    ...
    /**
     * Geeft het aantal waarden van 'indicaties' van een (root)object.
