...
/**
 * Getter voor 'bijhoudingsaard' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonBijhoudingsaardGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'bijhoudingsaard' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getBijhoudingsaard() != null && v.getBijhoudingsaard().getBijhoudingsaard() != null) {
                return new StringLiteralExpressie(v.getBijhoudingsaard().getBijhoudingsaard().getCode());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'bijhoudingsaard' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'bijhoudingsaard' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
