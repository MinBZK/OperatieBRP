...
/**
 * Getter voor 'aanschrijving.voorvoegsel' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingVoorvoegselGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.voorvoegsel' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getVoorvoegselAanschrijving() != null) {
                return new StringLiteralExpressie(v.getAanschrijving().getVoorvoegselAanschrijving().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.voorvoegsel' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.voorvoegsel' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
