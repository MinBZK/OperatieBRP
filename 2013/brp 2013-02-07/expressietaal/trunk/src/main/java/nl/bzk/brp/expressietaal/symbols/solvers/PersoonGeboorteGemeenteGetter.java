...
/**
 * Getter voor 'geboorte.gemeente' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeboorteGemeenteGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geboorte.gemeente' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getGemeenteGeboorte() != null
                    && v.getGeboorte().getGemeenteGeboorte().getCode() != null)
            {
                return new StringLiteralExpressie(v.getGeboorte().getGemeenteGeboorte().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.gemeente' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.gemeente' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
