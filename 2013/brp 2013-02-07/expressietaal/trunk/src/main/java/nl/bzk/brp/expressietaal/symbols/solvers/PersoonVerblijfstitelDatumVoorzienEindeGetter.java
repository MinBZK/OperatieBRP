...
/**
 * Getter voor 'verblijfstitel.datum_voorzien_einde' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonVerblijfstitelDatumVoorzienEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'verblijfstitel.datum_voorzien_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getVerblijfstitel() != null && v.getVerblijfstitel().getDatumVoorzienEindeVerblijfstitel() != null) {
                return new DateLiteralExpressie(v.getVerblijfstitel().getDatumVoorzienEindeVerblijfstitel().getWaarde
                        ());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'verblijfstitel.datum_voorzien_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'verblijfstitel.datum_voorzien_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
