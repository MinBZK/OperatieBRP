...
/**
 * Getter voor 'bijhoudingsgemeente' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonBijhoudingsgemeenteGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'bijhoudingsgemeente' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getBijhoudingsgemeente() != null && v.getBijhoudingsgemeente().getBijhoudingsgemeente() != null
                    && v.getBijhoudingsgemeente().getBijhoudingsgemeente().getCode() != null)
            {
                return new StringLiteralExpressie(v.getBijhoudingsgemeente().getBijhoudingsgemeente().getCode()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'bijhoudingsgemeente' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'bijhoudingsgemeente' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
