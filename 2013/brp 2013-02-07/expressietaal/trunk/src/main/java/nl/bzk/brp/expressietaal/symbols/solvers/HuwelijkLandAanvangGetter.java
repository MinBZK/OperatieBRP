...
/**
 * Getter voor 'land_aanvang' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkLandAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'land_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getLandAanvang() != null
                    && v.getStandaard().getLandAanvang().getCode() != null)
            {
                return new StringLiteralExpressie(v.getStandaard().getLandAanvang().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'land_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'land_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
