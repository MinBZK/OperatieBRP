 ...
 */
public class BooleanANDOperatorExpressie extends AbstractBooleanOperatorExpressie {
     ...
     */
    public BooleanANDOperatorExpressie(final Expressie termLinks, final Expressie termRechts) {
    ...
    protected final String operatorAsString() {
        return DefaultKeywordMapping.getSyntax(Keywords.BOOLEAN_AND);
    }
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new BooleanANDOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
     ...
     */
    @Override
    public final boolean calculate(final boolean waardeLinks, final boolean waardeRechts) {
