...
/**
 * Getter voor 'buitenlandse_plaats_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkBuitenlandsePlaatsEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'buitenlandse_plaats_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getBuitenlandsePlaatsEinde() != null) {
                return new StringLiteralExpressie(v.getStandaard().getBuitenlandsePlaatsEinde().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'buitenlandse_plaats_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'buitenlandse_plaats_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
