...
/**
 * Getter voor 'predikaat' in objecttype 'PersoonGeslachtsnaamcomponent'.
 * <p/>
 ...
 */
public class PersoongeslachtsnaamcomponentPredikaatGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'predikaat' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'predikaat' uit een bepaald
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject, final Integer index) {
                ...
                && ((Persoon) rootObject).getGeslachtsnaamcomponenten() != null)
        {
            ...
            if (index >= 1 && index <= collectie.size()) {
                return new StringLiteralExpressie(collectie.get(index - 1).getStandaard().getPredikaat().getCode()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'predikaat' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
