...
/**
 * Getter voor 'uitsluitingnlkiesrecht.datum_einde_uitsluiting_nl_kiesrecht' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonUitsluitingnlkiesrechtDatumEindeUitsluitingNlKiesrechtGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'uitsluitingnlkiesrecht.datum_einde_uitsluiting_nl_kiesrecht' uit het gegeven
     * (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getUitsluitingNLKiesrecht() != null
                    && v.getUitsluitingNLKiesrecht().getDatumEindeUitsluitingNLKiesrecht() != null)
            {
                return new DateLiteralExpressie(v.getUitsluitingNLKiesrecht().getDatumEindeUitsluitingNLKiesrecht()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'uitsluitingnlkiesrecht.datum_einde_uitsluiting_nl_kiesrecht' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'uitsluitingnlkiesrecht.datum_einde_uitsluiting_nl_kiesrecht' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
