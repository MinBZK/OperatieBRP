...
public class PersoonOverlijdenOmschrijvingLocatieGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.omschrijving_locatie' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null && v.getOverlijden().getOmschrijvingLocatieOverlijden() != null) {
                return new StringLiteralExpressie(v.getOverlijden().getOmschrijvingLocatieOverlijden().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.omschrijving_locatie' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'overlijden.omschrijving_locatie' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
