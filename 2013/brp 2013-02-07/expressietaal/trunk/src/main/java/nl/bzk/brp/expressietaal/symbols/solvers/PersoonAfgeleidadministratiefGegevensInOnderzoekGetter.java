...
/**
 * Getter voor 'afgeleidadministratief.gegevens_in_onderzoek' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAfgeleidadministratiefGegevensInOnderzoekGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'afgeleidadministratief.gegevens_in_onderzoek' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAfgeleidAdministratief() != null
                    && v.getAfgeleidAdministratief().getIndicatieGegevensInOnderzoek() != null)
            {
                return new BooleanLiteralExpressie(v.getAfgeleidAdministratief().getIndicatieGegevensInOnderzoek()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'afgeleidadministratief.gegevens_in_onderzoek' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'afgeleidadministratief.gegevens_in_onderzoek' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
