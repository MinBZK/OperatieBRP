...
/**
 * Getter voor 'opschorting.redenbijhouding' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonOpschortingRedenbijhoudingGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'opschorting.redenbijhouding' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOpschorting() != null && v.getOpschorting().getRedenOpschortingBijhouding() != null) {
                return new StringLiteralExpressie(v.getOpschorting().getRedenOpschortingBijhouding().getCode());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'opschorting.redenbijhouding' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'opschorting.redenbijhouding' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
