...
public class PersoonOverlijdenDatumGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.datum' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null && v.getOverlijden().getDatumOverlijden() != null) {
                return new DateLiteralExpressie(v.getOverlijden().getDatumOverlijden().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.datum' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'overlijden.datum' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
