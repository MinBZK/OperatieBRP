...
/**
 * Getter voor 'immigratie.datum_vestiging_in_nederland' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonImmigratieDatumVestigingInNederlandGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'immigratie.datum_vestiging_in_nederland' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getImmigratie() != null && v.getImmigratie().getDatumVestigingInNederland() != null) {
                return new DateLiteralExpressie(v.getImmigratie().getDatumVestigingInNederland().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'immigratie.datum_vestiging_in_nederland' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'immigratie.datum_vestiging_in_nederland' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
