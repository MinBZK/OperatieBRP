...
/**
 * Getter voor 'euverkiezingen.datum_einde_uitsluiting_eu_kiesrecht' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonEuverkiezingenDatumEindeUitsluitingEuKiesrechtGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'euverkiezingen.datum_einde_uitsluiting_eu_kiesrecht' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getEUVerkiezingen() != null && v.getEUVerkiezingen().getDatumEindeUitsluitingEUKiesrecht() != null) {
                return new DateLiteralExpressie(v.getEUVerkiezingen().getDatumEindeUitsluitingEUKiesrecht().getWaarde
                        ());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'euverkiezingen.datum_einde_uitsluiting_eu_kiesrecht' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'euverkiezingen.datum_einde_uitsluiting_eu_kiesrecht' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
