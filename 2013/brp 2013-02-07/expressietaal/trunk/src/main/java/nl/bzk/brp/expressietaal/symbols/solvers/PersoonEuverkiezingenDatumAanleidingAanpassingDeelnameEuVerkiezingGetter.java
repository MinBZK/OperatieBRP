...
/**
 * Getter voor 'euverkiezingen.datum_aanleiding_aanpassing_deelname_eu_verkiezing' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonEuverkiezingenDatumAanleidingAanpassingDeelnameEuVerkiezingGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'euverkiezingen.datum_aanleiding_aanpassing_deelname_eu_verkiezing' uit het gegeven
     * (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getEUVerkiezingen() != null
                    && v.getEUVerkiezingen().getDatumAanleidingAanpassingDeelnameEUVerkiezing() != null)
            {
                return new DateLiteralExpressie(v.getEUVerkiezingen()
                        .getDatumAanleidingAanpassingDeelnameEUVerkiezing().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'euverkiezingen.datum_aanleiding_aanpassing_deelname_eu_verkiezing' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'euverkiezingen.datum_aanleiding_aanpassing_deelname_eu_verkiezing' uit een
     * bepaald
     * geïndiceerd attribuut van een (root)object.
