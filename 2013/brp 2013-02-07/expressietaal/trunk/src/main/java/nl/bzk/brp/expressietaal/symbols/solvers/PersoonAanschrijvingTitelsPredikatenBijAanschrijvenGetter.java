...
/**
 * Getter voor 'aanschrijving.titels_predikaten_bij_aanschrijven' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingTitelsPredikatenBijAanschrijvenGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.titels_predikaten_bij_aanschrijven' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null
                    && v.getAanschrijving().getIndicatieTitelsPredikatenBijAanschrijven() != null)
            {
                return new BooleanLiteralExpressie(v.getAanschrijving().getIndicatieTitelsPredikatenBijAanschrijven()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.titels_predikaten_bij_aanschrijven' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.titels_predikaten_bij_aanschrijven' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
