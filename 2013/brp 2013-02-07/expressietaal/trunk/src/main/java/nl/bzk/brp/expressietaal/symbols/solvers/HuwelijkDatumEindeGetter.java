...
/**
 * Getter voor 'datum_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkDatumEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'datum_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getDatumEinde() != null) {
                return new DateLiteralExpressie(v.getStandaard().getDatumEinde().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'datum_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'datum_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
