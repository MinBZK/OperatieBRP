...
/**
 * Getter voor 'geboorte.datum' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeboorteDatumGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geboorte.datum' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getDatumGeboorte() != null) {
                return new DateLiteralExpressie(v.getGeboorte().getDatumGeboorte().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.datum' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.datum' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
