...
/**
 * Getter voor 'afgeleidadministratief.tijdstip_laatste_wijziging' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAfgeleidadministratiefTijdstipLaatsteWijzigingGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'afgeleidadministratief.tijdstip_laatste_wijziging' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAfgeleidAdministratief() != null
                    && v.getAfgeleidAdministratief().getTijdstipLaatsteWijziging() != null)
            {
                return new StringLiteralExpressie(v.getAfgeleidAdministratief().getTijdstipLaatsteWijziging()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'afgeleidadministratief.tijdstip_laatste_wijziging' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'afgeleidadministratief.tijdstip_laatste_wijziging' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
