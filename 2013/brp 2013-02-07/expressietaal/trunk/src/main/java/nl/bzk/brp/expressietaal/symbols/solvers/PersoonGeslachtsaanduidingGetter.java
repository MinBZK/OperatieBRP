...
/**
 * Getter voor 'geslachtsaanduiding' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeslachtsaanduidingGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geslachtsaanduiding' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeslachtsaanduiding() != null && v.getGeslachtsaanduiding().getGeslachtsaanduiding() != null) {
                return new StringLiteralExpressie(v.getGeslachtsaanduiding().getGeslachtsaanduiding().getCode());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geslachtsaanduiding' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geslachtsaanduiding' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
