...
public class PersoonIdentificatienummersBurgerservicenummerGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'identificatienummers.burgerservicenummer' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getIdentificatienummers() != null && v.getIdentificatienummers().getBurgerservicenummer() != null) {
                return new NumberLiteralExpressie(v.getIdentificatienummers().getBurgerservicenummer().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'identificatienummers.burgerservicenummer' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'identificatienummers.burgerservicenummer' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
