...
/**
 * Getter voor 'geboorte.buitenlandse_regio' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeboorteBuitenlandseRegioGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geboorte.buitenlandse_regio' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getBuitenlandseRegioGeboorte() != null) {
                return new StringLiteralExpressie(v.getGeboorte().getBuitenlandseRegioGeboorte().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.buitenlandse_regio' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.buitenlandse_regio' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
