...
/**
 * Getter voor 'samengesteldenaam.predikaat' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamPredikaatGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.predikaat' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getPredikaat() != null
                    && v.getSamengesteldeNaam().getPredikaat().getCode() != null)
            {
                return new StringLiteralExpressie(v.getSamengesteldeNaam().getPredikaat().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.predikaat' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.predikaat' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
