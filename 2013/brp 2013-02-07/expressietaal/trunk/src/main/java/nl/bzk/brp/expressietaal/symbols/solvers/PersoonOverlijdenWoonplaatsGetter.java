...
/**
 * Getter voor 'overlijden.woonplaats' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonOverlijdenWoonplaatsGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'overlijden.woonplaats' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null && v.getOverlijden().getWoonplaatsOverlijden() != null
                    && v.getOverlijden().getWoonplaatsOverlijden().getCode() != null)
            {
                return new StringLiteralExpressie(v.getOverlijden().getWoonplaatsOverlijden().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.woonplaats' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'overlijden.woonplaats' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
