...
/**
 * Getter voor 'geboorte.woonplaats' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeboorteWoonplaatsGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geboorte.woonplaats' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getWoonplaatsGeboorte() != null
                    && v.getGeboorte().getWoonplaatsGeboorte().getCode() != null)
            {
                return new StringLiteralExpressie(v.getGeboorte().getWoonplaatsGeboorte().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.woonplaats' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.woonplaats' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
