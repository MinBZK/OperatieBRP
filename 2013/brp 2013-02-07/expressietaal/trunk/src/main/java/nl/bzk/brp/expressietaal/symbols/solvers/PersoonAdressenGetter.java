...
/**
 * Getter voor 'adressen' in objecttype 'PersoonAdres'.
 * <p/>
...
public class PersoonAdressenGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'adressen' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'adressen' uit een bepaald
    ...
    /**
     * Geeft het aantal waarden van 'adressen' van een (root)object.
