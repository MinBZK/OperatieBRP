...
/**
 * Getter voor 'aanschrijving.scheidingsteken' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingScheidingstekenGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.scheidingsteken' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getScheidingstekenAanschrijving() != null) {
                return new StringLiteralExpressie(v.getAanschrijving().getScheidingstekenAanschrijving().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.scheidingsteken' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.scheidingsteken' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
