...
public class PersoonOverlijdenGemeenteGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.gemeente' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null && v.getOverlijden().getGemeenteOverlijden() != null
                    && v.getOverlijden().getGemeenteOverlijden().getCode() != null)
            {
                return new StringLiteralExpressie(v.getOverlijden().getGemeenteOverlijden().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.gemeente' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'overlijden.gemeente' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
