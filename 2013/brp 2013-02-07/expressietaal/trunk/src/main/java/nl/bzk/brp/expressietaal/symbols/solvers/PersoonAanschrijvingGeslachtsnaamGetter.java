...
/**
 * Getter voor 'aanschrijving.geslachtsnaam' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingGeslachtsnaamGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.geslachtsnaam' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getGeslachtsnaamAanschrijving() != null) {
                return new StringLiteralExpressie(v.getAanschrijving().getGeslachtsnaamAanschrijving().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.geslachtsnaam' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.geslachtsnaam' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
