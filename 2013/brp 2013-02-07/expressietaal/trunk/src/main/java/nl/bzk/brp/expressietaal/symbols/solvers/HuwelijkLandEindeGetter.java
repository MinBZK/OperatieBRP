...
/**
 * Getter voor 'land_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkLandEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'land_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getLandEinde() != null
                    && v.getStandaard().getLandEinde().getCode() != null)
            {
                return new StringLiteralExpressie(v.getStandaard().getLandEinde().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'land_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'land_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
