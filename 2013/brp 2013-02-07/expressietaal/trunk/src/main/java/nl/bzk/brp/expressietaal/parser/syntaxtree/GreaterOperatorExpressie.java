 ...
 */
public class GreaterOperatorExpressie extends AbstractComparisonOperatorExpressie {
     ...
     */
    public GreaterOperatorExpressie(final Expressie termLinks, final Expressie termRechts) {
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new GreaterOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
}
