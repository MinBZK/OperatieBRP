...
public class PersoonIdentificatienummersAdministratienummerGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'identificatienummers.administratienummer' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getIdentificatienummers() != null && v.getIdentificatienummers().getAdministratienummer() != null) {
                return new NumberLiteralExpressie(v.getIdentificatienummers().getAdministratienummer().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'identificatienummers.administratienummer' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'identificatienummers.administratienummer' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
