...
/**
 * Getter voor 'geboorte.buitenlandse_plaats' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeboorteBuitenlandsePlaatsGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geboorte.buitenlandse_plaats' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getBuitenlandsePlaatsGeboorte() != null) {
                return new StringLiteralExpressie(v.getGeboorte().getBuitenlandsePlaatsGeboorte().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.buitenlandse_plaats' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.buitenlandse_plaats' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
