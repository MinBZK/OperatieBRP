...
/**
 * Getter voor 'bijzondereverblijfsrechtelijkepositie.bijzondere_verblijfsrechtelijke_positie' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonBijzondereverblijfsrechtelijkepositieBijzondereVerblijfsrechtelijkePositieGetter implements
        AttributeGetter
{

    /**
     * Geeft de waarde van attribuut 'bijzondereverblijfsrechtelijkepositie.bijzondere_verblijfsrechtelijke_positie' uit
     * het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getBijzondereVerblijfsrechtelijkePositie() != null
                    && v.getBijzondereVerblijfsrechtelijkePositie().getBijzondereVerblijfsrechtelijkePositie() != null
                    && v.getBijzondereVerblijfsrechtelijkePositie().getBijzondereVerblijfsrechtelijkePositie()
                    .getNaam() != null)
            {
                return new StringLiteralExpressie(v.getBijzondereVerblijfsrechtelijkePositie()
                        .getBijzondereVerblijfsrechtelijkePositie().getNaam().getWaarde());
            }
        }
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'bijzondereverblijfsrechtelijkepositie.bijzondere_verblijfsrechtelijke_positie'
     * uit een bepaald
     * geïndiceerd attribuut van een (root)object.
