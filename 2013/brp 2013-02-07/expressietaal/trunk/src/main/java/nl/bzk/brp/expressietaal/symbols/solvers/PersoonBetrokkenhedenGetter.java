...
/**
 * Getter voor 'betrokkenheden' in objecttype 'Betrokkenheid'.
 * <p/>
...
public class PersoonBetrokkenhedenGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'betrokkenheden' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'betrokkenheden' uit een bepaald
    ...
    /**
     * Geeft het aantal waarden van 'betrokkenheden' van een (root)object.
