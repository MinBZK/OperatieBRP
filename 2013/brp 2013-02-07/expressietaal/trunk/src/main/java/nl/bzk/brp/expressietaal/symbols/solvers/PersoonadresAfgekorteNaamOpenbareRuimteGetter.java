...
/**
 * Getter voor 'afgekorte_naam_openbare_ruimte' in objecttype 'PersoonAdres'.
 * <p/>
 ...
 */
public class PersoonadresAfgekorteNaamOpenbareRuimteGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'afgekorte_naam_openbare_ruimte' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'afgekorte_naam_openbare_ruimte' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'afgekorte_naam_openbare_ruimte' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
