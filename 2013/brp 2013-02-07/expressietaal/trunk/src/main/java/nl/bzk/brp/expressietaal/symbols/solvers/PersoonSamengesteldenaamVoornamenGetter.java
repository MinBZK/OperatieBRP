...
/**
 * Getter voor 'samengesteldenaam.voornamen' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamVoornamenGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.voornamen' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getVoornamen() != null) {
                return new StringLiteralExpressie(v.getSamengesteldeNaam().getVoornamen().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.voornamen' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.voornamen' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
