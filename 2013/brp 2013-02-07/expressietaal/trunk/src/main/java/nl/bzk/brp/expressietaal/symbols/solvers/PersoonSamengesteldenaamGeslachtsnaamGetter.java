...
/**
 * Getter voor 'samengesteldenaam.geslachtsnaam' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamGeslachtsnaamGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.geslachtsnaam' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getGeslachtsnaam() != null) {
                return new StringLiteralExpressie(v.getSamengesteldeNaam().getGeslachtsnaam().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.geslachtsnaam' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.geslachtsnaam' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
