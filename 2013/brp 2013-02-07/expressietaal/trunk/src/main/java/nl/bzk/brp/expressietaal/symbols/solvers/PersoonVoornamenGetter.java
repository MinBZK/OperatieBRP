...
/**
 * Getter voor 'voornamen' in objecttype 'PersoonVoornaam'.
 * <p/>
...
public class PersoonVoornamenGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'voornamen' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'voornamen' uit een bepaald
    ...
    /**
     * Geeft het aantal waarden van 'voornamen' van een (root)object.
