...
/**
 * Getter voor 'verblijfstitel' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonVerblijfstitelGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'verblijfstitel' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getVerblijfstitel() != null && v.getVerblijfstitel().getVerblijfstitel() != null
                    && v.getVerblijfstitel().getVerblijfstitel().getCode() != null)
            {
                return new StringLiteralExpressie(v.getVerblijfstitel().getVerblijfstitel().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'verblijfstitel' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'verblijfstitel' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
