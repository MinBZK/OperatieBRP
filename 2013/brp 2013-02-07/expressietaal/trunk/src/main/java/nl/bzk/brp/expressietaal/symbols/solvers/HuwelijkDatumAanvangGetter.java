...
/**
 * Getter voor 'datum_aanvang' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkDatumAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'datum_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getDatumAanvang() != null) {
                return new DateLiteralExpressie(v.getStandaard().getDatumAanvang().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'datum_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'datum_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
