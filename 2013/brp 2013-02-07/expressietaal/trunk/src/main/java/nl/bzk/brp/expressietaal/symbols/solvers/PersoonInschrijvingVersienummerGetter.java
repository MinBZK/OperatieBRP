...
public class PersoonInschrijvingVersienummerGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'inschrijving.versienummer' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getInschrijving() != null && v.getInschrijving().getVersienummer() != null) {
                return new NumberLiteralExpressie(v.getInschrijving().getVersienummer().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'inschrijving.versienummer' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'inschrijving.versienummer' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
