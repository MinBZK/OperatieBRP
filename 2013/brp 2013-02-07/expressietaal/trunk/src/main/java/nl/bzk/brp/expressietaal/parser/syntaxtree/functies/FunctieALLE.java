 ...
 */
public class FunctieALLE extends AbstractFunctieExpressie {

    /**
     * Het aantal argumenten van de functie ALLE().
     */
    public static final int AANTAL_ARGUMENTEN = 3;

    /**
     * Constructor. Creeer functie-expressie voor functie ALLE().
     *
     * @param argumenten Argumenten van de aanroep.
     */
    public FunctieALLE(final List<Expressie> argumenten) {
        super(Keywords.ALLE, argumenten, ExpressieType.BOOLEAN);
    }

    @Override
    protected Expressie create(final List<Expressie> argumentenAanroep) {
        return new FunctieALLE(argumentenAanroep);
    }
