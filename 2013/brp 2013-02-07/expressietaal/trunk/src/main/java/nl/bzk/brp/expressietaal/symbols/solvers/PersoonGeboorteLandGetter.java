...
/**
 * Getter voor 'geboorte.land' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonGeboorteLandGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'geboorte.land' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getLandGeboorte() != null
                    && v.getGeboorte().getLandGeboorte().getCode() != null)
            {
                return new StringLiteralExpressie(v.getGeboorte().getLandGeboorte().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.land' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.land' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
