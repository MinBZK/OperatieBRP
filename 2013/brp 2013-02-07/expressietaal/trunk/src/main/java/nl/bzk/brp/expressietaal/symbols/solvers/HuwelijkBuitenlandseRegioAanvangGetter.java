...
/**
 * Getter voor 'buitenlandse_regio_aanvang' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkBuitenlandseRegioAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'buitenlandse_regio_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getBuitenlandseRegioAanvang() != null) {
                return new StringLiteralExpressie(v.getStandaard().getBuitenlandseRegioAanvang().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'buitenlandse_regio_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'buitenlandse_regio_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
