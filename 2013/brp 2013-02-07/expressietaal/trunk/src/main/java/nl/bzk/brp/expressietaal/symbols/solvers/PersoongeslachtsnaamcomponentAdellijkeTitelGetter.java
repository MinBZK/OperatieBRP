...
/**
 * Getter voor 'adellijke_titel' in objecttype 'PersoonGeslachtsnaamcomponent'.
 * <p/>
 ...
 */
public class PersoongeslachtsnaamcomponentAdellijkeTitelGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'adellijke_titel' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'adellijke_titel' uit een bepaald
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject, final Integer index) {
                ...
                && ((Persoon) rootObject).getGeslachtsnaamcomponenten() != null)
        {
            ...
            if (index >= 1 && index <= collectie.size()) {
                return new StringLiteralExpressie(collectie.get(index - 1).getStandaard().getAdellijkeTitel().getCode()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'adellijke_titel' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
