 ...
 */
public class GreaterOrEqualOperatorExpressie extends AbstractComparisonOperatorExpressie {
     ...
     */
    public GreaterOrEqualOperatorExpressie(final Expressie termLinks, final Expressie termRechts) {
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new GreaterOrEqualOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
}
