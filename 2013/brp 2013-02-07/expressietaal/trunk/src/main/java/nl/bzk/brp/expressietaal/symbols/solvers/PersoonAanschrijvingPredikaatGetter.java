...
/**
 * Getter voor 'aanschrijving.predikaat' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingPredikaatGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.predikaat' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getPredikaatAanschrijving() != null
                    && v.getAanschrijving().getPredikaatAanschrijving().getCode() != null)
            {
                return new StringLiteralExpressie(v.getAanschrijving().getPredikaatAanschrijving().getCode()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.predikaat' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.predikaat' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
