 ...
 */
public class LessOrEqualOperatorExpressie extends AbstractComparisonOperatorExpressie {
     ...
     */
    public LessOrEqualOperatorExpressie(final Expressie termLinks, final Expressie termRechts) {
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new LessOrEqualOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
}
