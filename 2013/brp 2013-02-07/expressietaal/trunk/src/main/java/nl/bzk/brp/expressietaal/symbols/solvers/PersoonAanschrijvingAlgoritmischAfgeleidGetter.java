...
/**
 * Getter voor 'aanschrijving.algoritmisch_afgeleid' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingAlgoritmischAfgeleidGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.algoritmisch_afgeleid' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null
                    && v.getAanschrijving().getIndicatieAanschrijvingAlgoritmischAfgeleid() != null)
            {
                return new BooleanLiteralExpressie(v.getAanschrijving().getIndicatieAanschrijvingAlgoritmischAfgeleid()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.algoritmisch_afgeleid' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.algoritmisch_afgeleid' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
