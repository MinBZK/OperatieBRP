 ...
 */
public class EqualityOperatorExpressie extends AbstractComparisonOperatorExpressie {
     ...
     */
    public EqualityOperatorExpressie(final Expressie termLinks, final Expressie termRechts) {
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new EqualityOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
}
