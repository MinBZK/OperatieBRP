...
/**
 * Getter voor 'immigratie.land_vanwaar_gevestigd' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonImmigratieLandVanwaarGevestigdGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'immigratie.land_vanwaar_gevestigd' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getImmigratie() != null && v.getImmigratie().getLandVanwaarGevestigd() != null
                    && v.getImmigratie().getLandVanwaarGevestigd().getCode() != null)
            {
                return new StringLiteralExpressie(v.getImmigratie().getLandVanwaarGevestigd().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'immigratie.land_vanwaar_gevestigd' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'immigratie.land_vanwaar_gevestigd' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
