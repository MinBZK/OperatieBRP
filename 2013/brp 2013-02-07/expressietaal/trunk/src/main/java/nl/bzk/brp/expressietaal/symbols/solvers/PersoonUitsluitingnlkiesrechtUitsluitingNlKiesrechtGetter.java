...
/**
 * Getter voor 'uitsluitingnlkiesrecht.uitsluiting_nl_kiesrecht' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonUitsluitingnlkiesrechtUitsluitingNlKiesrechtGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'uitsluitingnlkiesrecht.uitsluiting_nl_kiesrecht' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getUitsluitingNLKiesrecht() != null
                    && v.getUitsluitingNLKiesrecht().getIndicatieUitsluitingNLKiesrecht() != null)
            {
                return new BooleanLiteralExpressie(v.getUitsluitingNLKiesrecht().getIndicatieUitsluitingNLKiesrecht()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'uitsluitingnlkiesrecht.uitsluiting_nl_kiesrecht' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'uitsluitingnlkiesrecht.uitsluiting_nl_kiesrecht' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
