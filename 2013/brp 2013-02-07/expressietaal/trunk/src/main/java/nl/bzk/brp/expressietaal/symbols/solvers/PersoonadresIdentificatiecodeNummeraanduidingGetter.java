...
/**
 * Getter voor 'identificatiecode_nummeraanduiding' in objecttype 'PersoonAdres'.
 * <p/>
 ...
 */
public class PersoonadresIdentificatiecodeNummeraanduidingGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'identificatiecode_nummeraanduiding' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'identificatiecode_nummeraanduiding' uit een bepaald
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject, final Integer index) {
        if (rootObject != null && rootObject instanceof Persoon && ((Persoon) rootObject).getAdressen() != null) {
            ...
            if (index >= 1 && index <= collectie.size()) {
                return new StringLiteralExpressie(collectie.get(index - 1).getStandaard()
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'identificatiecode_nummeraanduiding' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
