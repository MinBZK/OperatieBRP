...
public class PersoonInschrijvingDatumGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'inschrijving.datum' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getInschrijving() != null && v.getInschrijving().getDatumInschrijving() != null) {
                return new DateLiteralExpressie(v.getInschrijving().getDatumInschrijving().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'inschrijving.datum' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'inschrijving.datum' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
