...
/**
 * Getter voor 'bijhoudingsgemeente.datum_inschrijving_in_gemeente' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonBijhoudingsgemeenteDatumInschrijvingInGemeenteGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'bijhoudingsgemeente.datum_inschrijving_in_gemeente' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getBijhoudingsgemeente() != null
                    && v.getBijhoudingsgemeente().getDatumInschrijvingInGemeente() != null)
            {
                return new DateLiteralExpressie(v.getBijhoudingsgemeente().getDatumInschrijvingInGemeente().getWaarde
                        ());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'bijhoudingsgemeente.datum_inschrijving_in_gemeente' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'bijhoudingsgemeente.datum_inschrijving_in_gemeente' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
