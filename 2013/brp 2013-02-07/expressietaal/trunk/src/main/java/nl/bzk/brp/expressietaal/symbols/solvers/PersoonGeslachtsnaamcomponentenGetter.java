...
/**
 * Getter voor 'geslachtsnaamcomponenten' in objecttype 'PersoonGeslachtsnaamcomponent'.
 * <p/>
...
public class PersoonGeslachtsnaamcomponentenGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'geslachtsnaamcomponenten' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'geslachtsnaamcomponenten' uit een bepaald
    ...
    /**
     * Geeft het aantal waarden van 'geslachtsnaamcomponenten' van een (root)object.
