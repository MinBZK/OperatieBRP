...
/**
 * Getter voor 'woonplaats_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkWoonplaatsEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'woonplaats_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getWoonplaatsEinde() != null
                    && v.getStandaard().getWoonplaatsEinde().getCode() != null)
            {
                return new StringLiteralExpressie(v.getStandaard().getWoonplaatsEinde().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'woonplaats_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'woonplaats_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
