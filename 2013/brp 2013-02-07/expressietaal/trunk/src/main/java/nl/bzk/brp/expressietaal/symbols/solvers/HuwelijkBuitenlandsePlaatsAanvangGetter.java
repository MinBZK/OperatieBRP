...
/**
 * Getter voor 'buitenlandse_plaats_aanvang' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkBuitenlandsePlaatsAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'buitenlandse_plaats_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getBuitenlandsePlaatsAanvang() != null) {
                return new StringLiteralExpressie(v.getStandaard().getBuitenlandsePlaatsAanvang().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'buitenlandse_plaats_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'buitenlandse_plaats_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
