...
/**
 * Getter voor 'samengesteldenaam.algoritmisch_afgeleid' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamAlgoritmischAfgeleidGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.algoritmisch_afgeleid' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getIndicatieAlgoritmischAfgeleid() !=
                    null) {
                return new BooleanLiteralExpressie(v.getSamengesteldeNaam().getIndicatieAlgoritmischAfgeleid()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.algoritmisch_afgeleid' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.algoritmisch_afgeleid' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
