...
/**
 * Getter voor 'omschrijving_locatie_aanvang' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkOmschrijvingLocatieAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'omschrijving_locatie_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getOmschrijvingLocatieAanvang() != null) {
                return new StringLiteralExpressie(v.getStandaard().getOmschrijvingLocatieAanvang().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'omschrijving_locatie_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'omschrijving_locatie_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
