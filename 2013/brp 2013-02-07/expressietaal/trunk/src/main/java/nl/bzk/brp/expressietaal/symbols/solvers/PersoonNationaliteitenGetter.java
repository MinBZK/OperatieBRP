...
/**
 * Getter voor 'nationaliteiten' in objecttype 'PersoonNationaliteit'.
 * <p/>
...
public class PersoonNationaliteitenGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'nationaliteiten' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'nationaliteiten' uit een bepaald
    ...
    /**
     * Geeft het aantal waarden van 'nationaliteiten' van een (root)object.
