...
/**
 * Getter voor 'omschrijving_locatie_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkOmschrijvingLocatieEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'omschrijving_locatie_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getOmschrijvingLocatieEinde() != null) {
                return new StringLiteralExpressie(v.getStandaard().getOmschrijvingLocatieEinde().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'omschrijving_locatie_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'omschrijving_locatie_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
