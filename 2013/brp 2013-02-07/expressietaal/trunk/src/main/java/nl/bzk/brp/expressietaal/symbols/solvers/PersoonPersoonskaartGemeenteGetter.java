...
/**
 * Getter voor 'persoonskaart.gemeente' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonPersoonskaartGemeenteGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'persoonskaart.gemeente' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getPersoonskaart() != null && v.getPersoonskaart().getGemeentePersoonskaart() != null
                    && v.getPersoonskaart().getGemeentePersoonskaart().getCode() != null)
            {
                return new StringLiteralExpressie(v.getPersoonskaart().getGemeentePersoonskaart().getCode().getWaarde
                        ());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'persoonskaart.gemeente' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'persoonskaart.gemeente' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
