...
/**
 * Getter voor 'samengesteldenaam.scheidingsteken' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonSamengesteldenaamScheidingstekenGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.scheidingsteken' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getScheidingsteken() != null) {
                return new StringLiteralExpressie(v.getSamengesteldeNaam().getScheidingsteken().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'samengesteldenaam.scheidingsteken' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'samengesteldenaam.scheidingsteken' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
