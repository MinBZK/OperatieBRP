...
/**
 * Getter voor 'reden_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkRedenEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'reden_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getRedenEinde() != null
                    && v.getStandaard().getRedenEinde().getCode() != null)
            {
                return new StringLiteralExpressie(v.getStandaard().getRedenEinde().getCode().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'reden_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'reden_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
