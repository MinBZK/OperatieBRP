...
/**
 * Getter voor 'persoon_niet_aangetroffen_op_adres' in objecttype 'PersoonAdres'.
 * <p/>
 ...
 */
public class PersoonadresPersoonNietAangetroffenOpAdresGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'persoon_niet_aangetroffen_op_adres' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'persoon_niet_aangetroffen_op_adres' uit een bepaald
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject, final Integer index) {
        if (rootObject != null && rootObject instanceof Persoon && ((Persoon) rootObject).getAdressen() != null) {
            ...
            if (index >= 1 && index <= collectie.size()) {
                return new BooleanLiteralExpressie(collectie.get(index - 1).getStandaard()
                        .getIndicatiePersoonNietAangetroffenOpAdres().getWaarde());
            }
        }
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'persoon_niet_aangetroffen_op_adres' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
