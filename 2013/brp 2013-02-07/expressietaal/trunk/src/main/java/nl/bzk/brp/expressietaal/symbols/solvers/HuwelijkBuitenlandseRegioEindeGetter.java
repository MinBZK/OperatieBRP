...
/**
 * Getter voor 'buitenlandse_regio_einde' in objecttype 'HuwelijkGeregistreerdPartnerschap'.
 * <p/>
 ...
 */
public class HuwelijkBuitenlandseRegioEindeGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'buitenlandse_regio_einde' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof HuwelijkGeregistreerdPartnerschap) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getBuitenlandseRegioEinde() != null) {
                return new StringLiteralExpressie(v.getStandaard().getBuitenlandseRegioEinde().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'buitenlandse_regio_einde' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'buitenlandse_regio_einde' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
