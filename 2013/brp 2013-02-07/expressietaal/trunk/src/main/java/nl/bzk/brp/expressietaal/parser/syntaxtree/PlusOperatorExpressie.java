 ...
 */
public class PlusOperatorExpressie extends AbstractNumericOperatorExpressie {
    ...
    protected final Expressie create(final Expressie operatorTermLinks, final Expressie operatorTermRechts) {
        return new PlusOperatorExpressie(operatorTermLinks, operatorTermRechts);
    }
