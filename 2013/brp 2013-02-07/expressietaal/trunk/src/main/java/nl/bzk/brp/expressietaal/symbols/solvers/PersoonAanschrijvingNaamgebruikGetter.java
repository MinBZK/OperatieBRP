...
/**
 * Getter voor 'aanschrijving.naamgebruik' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingNaamgebruikGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.naamgebruik' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getNaamgebruik() != null) {
                return new StringLiteralExpressie(v.getAanschrijving().getNaamgebruik().getCode());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.naamgebruik' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.naamgebruik' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
