...
/**
 * Getter voor 'aanschrijving.voornamen' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonAanschrijvingVoornamenGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'aanschrijving.voornamen' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getAanschrijving() != null && v.getAanschrijving().getVoornamenAanschrijving() != null) {
                return new StringLiteralExpressie(v.getAanschrijving().getVoornamenAanschrijving().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'aanschrijving.voornamen' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'aanschrijving.voornamen' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
