...
public class PersoonOverlijdenBuitenlandseRegioGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.buitenlandse_regio' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null && v.getOverlijden().getBuitenlandseRegioOverlijden() != null) {
                return new StringLiteralExpressie(v.getOverlijden().getBuitenlandseRegioOverlijden().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'overlijden.buitenlandse_regio' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'overlijden.buitenlandse_regio' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
