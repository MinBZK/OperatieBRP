...
/**
 * Getter voor 'bijhoudingsgemeente.onverwerkt_document_aanwezig' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonBijhoudingsgemeenteOnverwerktDocumentAanwezigGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'bijhoudingsgemeente.onverwerkt_document_aanwezig' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getBijhoudingsgemeente() != null
                    && v.getBijhoudingsgemeente().getIndicatieOnverwerktDocumentAanwezig() != null)
            {
                return new BooleanLiteralExpressie(v.getBijhoudingsgemeente().getIndicatieOnverwerktDocumentAanwezig()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'bijhoudingsgemeente.onverwerkt_document_aanwezig' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'bijhoudingsgemeente.onverwerkt_document_aanwezig' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
