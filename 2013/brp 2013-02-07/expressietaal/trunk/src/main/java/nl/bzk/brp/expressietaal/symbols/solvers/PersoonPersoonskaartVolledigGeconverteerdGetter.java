...
/**
 * Getter voor 'persoonskaart.volledig_geconverteerd' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonPersoonskaartVolledigGeconverteerdGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'persoonskaart.volledig_geconverteerd' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getPersoonskaart() != null
                    && v.getPersoonskaart().getIndicatiePersoonskaartVolledigGeconverteerd() != null)
            {
                return new BooleanLiteralExpressie(v.getPersoonskaart()
                        .getIndicatiePersoonskaartVolledigGeconverteerd().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'persoonskaart.volledig_geconverteerd' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'persoonskaart.volledig_geconverteerd' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
