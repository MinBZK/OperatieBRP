...
/**
 * Getter voor 'buitenlands_adres_regel_5' in objecttype 'PersoonAdres'.
 * <p/>
 ...
 */
public class PersoonadresBuitenlandsAdresRegel5Getter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'buitenlands_adres_regel_5' uit het gegeven (root)object.
     *
    ...
    /**
     * Geeft de waarde van attribuut 'buitenlands_adres_regel_5' uit een bepaald
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject, final Integer index) {
        if (rootObject != null && rootObject instanceof Persoon && ((Persoon) rootObject).getAdressen() != null) {
            ...
            if (index >= 1 && index <= collectie.size()) {
                return new StringLiteralExpressie(collectie.get(index - 1).getStandaard().getBuitenlandsAdresRegel5()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'buitenlands_adres_regel_5' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
