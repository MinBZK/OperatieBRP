...
/**
 * Getter voor 'euverkiezingen.deelname_eu_verkiezingen' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonEuverkiezingenDeelnameEuVerkiezingenGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'euverkiezingen.deelname_eu_verkiezingen' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getEUVerkiezingen() != null && v.getEUVerkiezingen().getIndicatieDeelnameEUVerkiezingen() != null) {
                return new BooleanLiteralExpressie(v.getEUVerkiezingen().getIndicatieDeelnameEUVerkiezingen()
                        .getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'euverkiezingen.deelname_eu_verkiezingen' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'euverkiezingen.deelname_eu_verkiezingen' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
