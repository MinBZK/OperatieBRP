...
public class PersoonGeboorteOmschrijvingLocatieGetter implements AttributeGetter {
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.omschrijving_locatie' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getOmschrijvingLocatieGeboorte() != null) {
                return new StringLiteralExpressie(v.getGeboorte().getOmschrijvingLocatieGeboorte().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'geboorte.omschrijving_locatie' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'geboorte.omschrijving_locatie' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
