...
/**
 * Getter voor 'verblijfstitel.datum_aanvang' in objecttype 'Persoon'.
 * <p/>
 ...
 */
public class PersoonVerblijfstitelDatumAanvangGetter implements AttributeGetter {

    /**
     * Geeft de waarde van attribuut 'verblijfstitel.datum_aanvang' uit het gegeven (root)object.
     *
    ...
    public Expressie getAttribuutWaarde(final RootObject rootObject) {
        if (rootObject != null && rootObject instanceof Persoon) {
            ...
            if (v.getVerblijfstitel() != null && v.getVerblijfstitel().getDatumAanvangVerblijfstitel() != null) {
                return new DateLiteralExpressie(v.getVerblijfstitel().getDatumAanvangVerblijfstitel().getWaarde());
            }
        }
    ...
    /**
     * Geeft de waarde van attribuut 'verblijfstitel.datum_aanvang' uit een bepaald
    ...
    /**
     * Geeft de hoogste indexwaarde voor 'verblijfstitel.datum_aanvang' uit een bepaald
     * geïndiceerd attribuut van een (root)object.
