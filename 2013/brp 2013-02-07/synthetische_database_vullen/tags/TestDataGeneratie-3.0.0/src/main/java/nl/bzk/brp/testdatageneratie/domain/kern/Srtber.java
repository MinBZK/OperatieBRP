...
public class Srtber  implements java.io.Serializable {
     ...
     private short id;
     private String naam;
     private Burgerzakenmodule burgerzakenmodule;
    ...
    public Srtber(short id, String naam) {
        this.id = id;
        this.naam = naam;
    }
    public Srtber(short id, String naam, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
    ...
    public Burgerzakenmodule getBurgerzakenmodule() {
        return burgerzakenmodule;
    }


    public void setBurgerzakenmodule(Burgerzakenmodule burgerzakenmodule) {
