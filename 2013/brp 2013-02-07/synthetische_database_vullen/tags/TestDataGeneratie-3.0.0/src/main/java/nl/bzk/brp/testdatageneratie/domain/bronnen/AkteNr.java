...
/**
 * AkteNr generated by hbm2java
 */
public class AkteNr  implements java.io.Serializable {
    ...
    public AkteNr(AkteNrId id, int aantal) {
        this.id = id;
        this.aantal = aantal;
    }
    public AkteNr(AkteNrId id, int aantal, Long van, Long totEnMet) {
       this.id = id;
       this.aantal = aantal;
       this.van = van;
    ...
    public AkteNrId getId() {
        return this.id;
    }
    
    public void setId(AkteNrId id) {
        this.id = id;
    }
