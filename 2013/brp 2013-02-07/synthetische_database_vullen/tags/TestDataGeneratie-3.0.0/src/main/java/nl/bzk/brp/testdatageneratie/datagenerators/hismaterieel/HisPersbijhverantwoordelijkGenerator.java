...
public class HisPersbijhverantwoordelijkGenerator extends HisMaterieelGenerator<Pers, HisPersbijhverantwoordelijk> {
    ...
    @Override
    public HisPersbijhverantwoordelijk generateHisMaterieel(final Pers actueel) {
        HisPersbijhverantwoordelijk his = new HisPersbijhverantwoordelijk();
        his.setPers(actueel);
        his.setVerantwoordelijke(actueel.getVerantwoordelijke());
        return his;
    }
