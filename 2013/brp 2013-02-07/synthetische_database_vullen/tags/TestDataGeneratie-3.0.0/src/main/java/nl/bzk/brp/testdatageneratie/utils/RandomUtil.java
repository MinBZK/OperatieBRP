...
public final class RandomUtil {
    ...
    public static Verantwoordelijke getVerantwoordelijke() {
        return isFractie(10) ? Verantwoordelijke.MINISTER : Verantwoordelijke.COLLEGE;
    }
    ...
    public static Rdnopschorting getRdnOpschorting() {
        ...
        switch (bijhoudingOpschortReden.getReden()) {
            case 'O':
                return Rdnopschorting.OVERLEDEN;
            case 'E':
                return Rdnopschorting.ONBEKEND;
            case 'F':
                return Rdnopschorting.FOUT;
            default:
                return Rdnopschorting.MINISTERIEEL_BESLUIT;
        }
    }
