...
/**
 * Toestand generated by hbm2java
 */
public class Toestand  implements java.io.Serializable {
    ...
    public Toestand(short id, String naam, String oms) {
        this.id = id;
        this.naam = naam;
        this.oms = oms;
    }
    public Toestand(short id, String naam, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
       this.oms = oms;
