 ...
 */
public class Verblijfstitel  implements Cacheable<Short> {
    ...
    public Verblijfstitel(short id, short code, String oms) {
        this.id = id;
        this.code = code;
        this.oms = oms;
    }
    public Verblijfstitel(short id, short code, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.code = code;
       this.oms = oms;
