...
-- Gegenereerd op: Thursday 20 Dec 2012 14:41:52
-- 
--------------------------------------------------------------------------------
...
-- Actual tabellen--------------------------------------------------------------
CREATE SEQUENCE Ber.seq_AdmHndBijgehoudenPers;
CREATE TABLE Ber.AdmHndBijgehoudenPers (
   ID                            BigInt                        NOT NULL  DEFAULT nextval('Ber.seq_AdmHndBijgehoudenPers')  /* BerBijgehoudenPersID */,
   AdmHnd                        BigInt                        NOT NULL    /* AdmHndID */,
   Pers                          Integer                       NOT NULL    /* PersID */,
   CONSTRAINT R6326 PRIMARY KEY (ID)
);
ALTER SEQUENCE Ber.seq_AdmHndBijgehoudenPers OWNED BY Ber.AdmHndBijgehoudenPers.ID;
CREATE SEQUENCE Ber.seq_AdmHndDoc;
CREATE TABLE Ber.AdmHndDoc (
   ID                            Integer                       NOT NULL  DEFAULT nextval('Ber.seq_AdmHndDoc')  /* AdmHndDocID */,
   AdmHnd                        BigInt                        NOT NULL    /* AdmHndID */,
   Doc                           BigInt                        NOT NULL    /* DocID */,
   CONSTRAINT R9531 PRIMARY KEY (ID),
   CONSTRAINT R9527 UNIQUE (AdmHnd, Doc)
);
ALTER SEQUENCE Ber.seq_AdmHndDoc OWNED BY Ber.AdmHndDoc.ID;
...
CREATE TABLE Kern.Betr (
   ...
   OuderUitWieKindIsVoortgekome  Boolean CHECK (OuderUitWieKindIsVoortgekome IS NULL OR OuderUitWieKindIsVoortgekome IN ('T'))              /* Ja */,
...
CREATE TABLE Kern.Pers (
   ...
   BijhverantwoordelijkheidStat  Varchar(1) CHECK (BijhverantwoordelijkheidStat IS NULL OR BijhverantwoordelijkheidStat IN ('A','T','M','F','X'))  NOT NULL    /* StatusHistorie */,
...
CREATE TABLE Kern.Relatie (
   ...
   DatOntkenningOuderschapOngeb  Integer                                   /* Dat */,
   OntkenningOuderschapOngebore  Varchar(1) CHECK (OntkenningOuderschapOngebore IS NULL OR OntkenningOuderschapOngebore IN ('A','T','M','F','X'))  NOT NULL    /* StatusHistorie */,
...
CREATE SEQUENCE Kern.seq_His_OntkenningOuderschapOnge;
CREATE TABLE Kern.His_OntkenningOuderschapOnge (
   ID                            Integer                       NOT NULL  DEFAULT nextval('Kern.seq_His_OntkenningOuderschapOnge')  /* His_OntkenningOuderschapOnge */,
   Relatie                       Integer                                   /* RelatieID */,
   TsReg                         Timestamp                                 /* DatTijd */,
   TsVerval                      Timestamp                                 /* DatTijd */,
   ActieInh                      BigInt                                    /* ActieID */,
   ActieVerval                   BigInt                                    /* ActieID */,
   DatOntkenningOuderschapOngeb  Integer                       NOT NULL    /* Dat */,
   CONSTRAINT R9431 PRIMARY KEY (ID),
   CONSTRAINT R9417 UNIQUE (Relatie, TsReg)
);
ALTER SEQUENCE Kern.seq_His_OntkenningOuderschapOnge OWNED BY Kern.His_OntkenningOuderschapOnge.ID;
...
CREATE TABLE Kern.His_PersBijhverantwoordelijk (
   ID                            Integer                       NOT NULL  DEFAULT nextval('Kern.seq_His_PersBijhverantwoordelijk')  /* His_PersBijhverantwoordelijk */,
   Pers                          Integer                                   /* PersID */,
   DatAanvGel                    Integer                                   /* Dat */,
   DatEindeGel                   Integer                                   /* Dat */,
   TsReg                         Timestamp                                 /* DatTijd */,
...
ALTER TABLE Kern.His_OntkenningOuderschapOnge ADD CONSTRAINT FK9411 FOREIGN KEY (Relatie) REFERENCES Kern.Relatie (ID);
CREATE INDEX ON Kern.His_OntkenningOuderschapOnge (Relatie);
ALTER TABLE Kern.His_OntkenningOuderschapOnge ADD CONSTRAINT FK9414 FOREIGN KEY (ActieInh) REFERENCES Kern.Actie (ID);
CREATE INDEX ON Kern.His_OntkenningOuderschapOnge (ActieInh);
ALTER TABLE Kern.His_OntkenningOuderschapOnge ADD CONSTRAINT FK9415 FOREIGN KEY (ActieVerval) REFERENCES Kern.Actie (ID);
CREATE INDEX ON Kern.His_OntkenningOuderschapOnge (ActieVerval);
