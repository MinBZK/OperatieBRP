...
public class HisPersbijhgemGenerator extends HistorieGenerator<Persadres, HisPersbijhgem> {
    ...
    @Override
    protected HisPersbijhgem generateHisMaterieel(final Persadres persadres) {
        return new HisPersbijhgem(persadres);
    }
