...
public class PersoonGenerator implements Callable<Boolean> {
    ...
    private void voegPersoonToe(final Session kernSession) {
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersids hisPersidsCorrectie = (HisPersids) HisCorrectieUtil.creeerHisCorrectie(HisPersidsGenerator.getInstance().generateHisMaterieel(pers), hisPersidsList.get(randomHisPersids));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersgeslachtsaand hisPersgeslachtsaandCorrectie = (HisPersgeslachtsaand) HisCorrectieUtil.creeerHisCorrectie(HisPersgeslachtsaandGenerator.getInstance().generateHisMaterieel(pers), hisPersgeslachtsaandList.get(randomHisPersgeslachtsaand));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPerssamengesteldenaam hisPerssamengesteldenaamCorrectie = (HisPerssamengesteldenaam) HisCorrectieUtil.creeerHisCorrectie(HisPerssamengesteldenaamGenerator.getInstance().generateHisMaterieel(pers), hisPerssamengesteldenaamList.get(randomHisPerssamengesteldenaam));
            kernSession.save(hisPerssamengesteldenaamCorrectie);
        }

        List<HisPersaanschr> hisPersaanschrList =
                HisPersaanschrGenerator.getInstance().generateHisMaterieels(pers, pers.getDatgeboorte());
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersaanschr hisPersaanschrCorrectie = (HisPersaanschr) HisCorrectieUtil.creeerHisCorrectie(HisPersaanschrGenerator.getInstance().generateHisMaterieel(pers), hisPersaanschrList.get(randomHisPersaanschr));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            HisPersgeboorte hisPersgeboorteCorrectie = (HisPersgeboorte) HisCorrectieUtil.creeerHisCorrectie(new HisPersgeboorte(pers), hisPersgeboorte);
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            HisPersinschr hisPersinschrCorrectie = (HisPersinschr) HisCorrectieUtil.creeerHisCorrectie(new HisPersinschr(pers), hisPersinschr);
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersbijhverantwoordelijk hisPersbijhverantwoordelijkCorrectie = (HisPersbijhverantwoordelijk) HisCorrectieUtil.creeerHisCorrectie(HisPersbijhverantwoordelijkGenerator.getInstance().generateHisMaterieel(pers), hisPersbijhverantwoordelijkList.get(randomHisPersbijhverantwoordelijk));
        ...
        if (pers.getDatoverlijden() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                HisPersoverlijden hisPersoverlijdenCorrectie = (HisPersoverlijden) HisCorrectieUtil.creeerHisCorrectie(new HisPersoverlijden(pers), hisPersoverlijden);
        ...
        if (pers.getInduitslnlkiesr() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                HisPersuitslnlkiesr hisPersuitslnlkiesrCorrectie = (HisPersuitslnlkiesr) HisCorrectieUtil.creeerHisCorrectie(new HisPersuitslnlkiesr(pers), hisPersuitslnlkiesr);
        ...
        if (pers.getInddeelneuverkiezingen() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                HisPerseuverkiezingen hisPerseuverkiezingenCorrectie = (HisPerseuverkiezingen) HisCorrectieUtil.creeerHisCorrectie(new HisPerseuverkiezingen(pers), hisPerseuverkiezingen);
        ...
        if (pers.getRdnopschorting() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersopschorting hisPersopschortingCorrectie = (HisPersopschorting) HisCorrectieUtil.creeerHisCorrectie(HisPersopschortingGenerator.getInstance().generateHisMaterieel(pers), hisPersopschortingList.get(randomHisPersopschorting));
        ...
        if (pers.getPartijByGempk() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                HisPerspk hisPerspkCorrectie = (HisPerspk) HisCorrectieUtil.creeerHisCorrectie(new HisPerspk(pers), hisPerspk);
        ...
        if (pers.getDatvestiginginnederland() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersimmigratie hisPersimmigratieCorrectie = (HisPersimmigratie) HisCorrectieUtil.creeerHisCorrectie(HisPersimmigratieGenerator.getInstance().generateHisMaterieel(pers), hisPersimmigratieList.get(randomHisPersimmigratie));
        ...
        if (pers.getVerblijfsr() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersverblijfsr hisPersverblijfsrCorrectie = (HisPersverblijfsr) HisCorrectieUtil.creeerHisCorrectie(HisPersverblijfsrGenerator.getInstance().generateHisMaterieel(pers), hisPersverblijfsrList.get(randomHisPersverblijfsr));
    ...
    private void voegGeslachtsnamenToe(final Session kernSession, final Pers pers) {
        ...
        for (Persgeslnaamcomp persgeslnaamcomp : geslachtsnaamComponenten) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersgeslnaamcomp hisPersgeslnaamcomp = (HisPersgeslnaamcomp) HisCorrectieUtil.creeerHisCorrectie(HisPersgeslnaamcompGenerator.getInstance().generateHisMaterieel(persgeslnaamcomp), hisPersgeslnaamcompList.get(randomHisPersgeslnaamcomp));
                kernSession.save(hisPersgeslnaamcomp);
            }
        }
    }
    ...
    private void voegVoornamenToe(final Session kernSession, final String[] voornamen, final Pers pers) {
        for (int i = 0; i < voornamen.length; i++) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersvoornaam hisPersvoornaam = (HisPersvoornaam) HisCorrectieUtil.creeerHisCorrectie(HisPersvoornaamGenerator.getInstance().generateHisMaterieel(persVoornaam), hisPersvoornaamList.get(randomHisPersvoornaam));
                kernSession.save(hisPersvoornaam);
            }
        }
    }
    ...
    private void voegReisdocumentToe(final Session kernSession, final Pers pers) {
        ...
        persreisdoc.setAutvanafgiftereisdoc(RandomUtil.getAutvanafgiftereisdoc());
