...
/**
 * Categoriesrtdoc generated by hbm2java
 */
public class Categoriesrtdoc  implements java.io.Serializable {
    ...
    public Categoriesrtdoc() {
    }

	
    public Categoriesrtdoc(short id, String naam, String oms) {
        this.id = id;
        this.naam = naam;
        this.oms = oms;
    }
    public Categoriesrtdoc(short id, String naam, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
       this.oms = oms;
