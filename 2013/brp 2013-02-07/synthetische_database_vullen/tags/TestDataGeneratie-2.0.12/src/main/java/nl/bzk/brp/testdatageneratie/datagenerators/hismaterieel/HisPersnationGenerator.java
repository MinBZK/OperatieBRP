...
public class HisPersnationGenerator extends HistorieGenerator<Persnation, HisPersnation> {
    ...
    protected int getNextAantalExclusiefHuidig(final Persnation actueel) {
        return actueel.getRdnverliesnlnation() == null? 0: 1;
    }
    ...
    @Override
    public HisPersnation generateHisMaterieel(final Persnation actueel) {
        HisPersnation his = new HisPersnation();
        his.setPersnation(actueel);
        his.setRdnverliesnlnation(actueel.getRdnverliesnlnation());
        his.setRdnverknlnation(actueel.getRdnverknlnation());
        return his;
    }
