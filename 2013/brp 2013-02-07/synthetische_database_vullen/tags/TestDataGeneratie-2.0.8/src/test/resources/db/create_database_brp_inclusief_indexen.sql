...
CREATE TABLE AutAut.Bijhsituatie (
   ...
   CONSTRAINT R5749 UNIQUE (Bijhautorisatie, CategorieSrtActie, SrtActie, CategorieSrtDoc, SrtDoc)
);
...
CREATE TABLE BRM.Regelsituatie (
   ...
   RegelsituatieStatusHis        Varchar(1)                    NOT NULL    /* StatusHistorie */,
...
CREATE TABLE Kern.CategorieSrtActie (
   ...
   DatAanvGel                    Integer                                   /* Dat */,
   DatEindeGel                   Integer                                   /* Dat */,
   CONSTRAINT R5981 PRIMARY KEY (ID),
   CONSTRAINT R5982 UNIQUE (Naam),
   CONSTRAINT R5983 UNIQUE (Oms)
);
CREATE TABLE Kern.CategorieSrtDoc (
   ...
   DatAanvGel                    Integer                                   /* Dat */,
   DatEindeGel                   Integer                                   /* Dat */,
   CONSTRAINT R5984 PRIMARY KEY (ID),
   CONSTRAINT R5985 UNIQUE (Naam),
   CONSTRAINT R5986 UNIQUE (Oms)
);
...
CREATE TABLE Kern.Verantwoordelijke (
   ...
   CONSTRAINT R4445 UNIQUE (Code)
);
CREATE TABLE Kern.Verblijfsr (
   ID                            Smallint                      NOT NULL    /* VerblijfsrID */,
   Oms                           Varchar(250)                  NOT NULL    /* OmsEnumeratiewaarde */,
   CodeVerblijfsr                Smallint                      NOT NULL    /* CodeVerblijfsr */,
   DatAanvGel                    Integer                                   /* Dat */,
   DatEindeGel                   Integer                                   /* Dat */,
...
CREATE TABLE Ber.BerActie (
   ...
   CONSTRAINT R6315 PRIMARY KEY (ID)
);
...
CREATE TABLE Ber.BerBijgehoudenPers (
   ...
   Ber                           Bigint                        NOT NULL    /* BerID */,
   Pers                          Integer                       NOT NULL    /* PersID */,
   CONSTRAINT R6326 PRIMARY KEY (ID)
);
...
CREATE TABLE Kern.Actie (
   ...
   AdministratieveHnd            Bigint                        NOT NULL    /* AdministratieveHndID */,
   Partij                        Smallint                      NOT NULL    /* PartijID */,
   DatAanvGel                    Integer                                   /* Dat */,
   DatEindeGel                   Integer                                   /* Dat */,
...
CREATE SEQUENCE Kern.seq_AdministratieveHnd;
CREATE TABLE Kern.AdministratieveHnd (
   ID                            Bigint                        NOT NULL  DEFAULT nextval('Kern.seq_AdministratieveHnd')  /* AdministratieveHndID */,
   Partij                        Smallint                      NOT NULL    /* PartijID */,
   CONSTRAINT R9179 PRIMARY KEY (ID)
);
ALTER SEQUENCE Kern.seq_AdministratieveHnd OWNED BY Kern.AdministratieveHnd.ID;
...
CREATE TABLE Kern.Bron (
   ...
   CONSTRAINT R4504 PRIMARY KEY (ID),
   CONSTRAINT R4481 UNIQUE (Actie, Doc)
);
...
CREATE TABLE Kern.Pers (
   ...
   IndNreeksGeslnaam             boolean                                   /* JaNee */,
...
CREATE TABLE Kern.PersReisdoc (
   ...
   TyperingAutAfgifte            Varchar(16)                               /* AandAdresseerbaarObject */,
   GemAutAfgifte                 Smallint                                  /* PartijID */,
   ProvincieAutAfgifte           Varchar(16)                               /* AandAdresseerbaarObject */,
   LandAutAangifte               Integer                                   /* LandID */,
...
CREATE SEQUENCE Kern.seq_Verantwoording;
CREATE TABLE Kern.Verantwoording (
   ID                            Bigint                        NOT NULL  DEFAULT nextval('Kern.seq_Verantwoording')  /* VerantwoordingsID */,
   Actie                         Bigint                        NOT NULL    /* ActieID */,
   Doc                           Bigint                                    /* DocID */,
...
ALTER SEQUENCE Kern.seq_Verantwoording OWNED BY Kern.Verantwoording.ID;
...
CREATE TABLE Kern.His_PersAanschr (
   ...
   CONSTRAINT R4131 UNIQUE (Pers, TsReg, DatAanvGel)
);
...
CREATE TABLE Kern.His_PersSamengesteldeNaam (
   ...
   IndNreeksGeslnaam             boolean                       NOT NULL    /* JaNee */,
...
CREATE TABLE Kern.His_PersReisdoc (
   ...
   TyperingAutAfgifte            Varchar(16)                   NOT NULL    /* AandAdresseerbaarObject */,
   GemAutAfgifte                 Smallint                                  /* PartijID */,
   ProvincieAutAfgifte           Varchar(16)                               /* AandAdresseerbaarObject */,
   LandAutAangifte               Integer                                   /* LandID */,
...
ALTER TABLE Kern.Actie ADD CONSTRAINT FK9023 FOREIGN KEY (AdministratieveHnd) REFERENCES Kern.AdministratieveHnd (ID);
CREATE INDEX ON Kern.Actie (AdministratieveHnd);
ALTER TABLE Kern.Actie ADD CONSTRAINT FK3209 FOREIGN KEY (Partij) REFERENCES Kern.Partij (ID);
ALTER TABLE Kern.AdministratieveHnd ADD CONSTRAINT FK9172 FOREIGN KEY (Partij) REFERENCES Kern.Partij (ID);
...
CREATE INDEX ON Kern.His_PersAanschr (ActieAanpGel);
