...
public class HisPersimmigratieGenerator extends HistorieGenerator<Pers, HisPersimmigratie> {
    ...
    @Override
    protected HisPersimmigratie generateHisMaterieel(final Pers actueel) {
        return new HisPersimmigratie(actueel);
    }
