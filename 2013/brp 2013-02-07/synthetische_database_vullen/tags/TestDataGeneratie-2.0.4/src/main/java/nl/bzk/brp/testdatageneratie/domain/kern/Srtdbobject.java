...
/**
 * Srtdbobject generated by hbm2java
 */
public class Srtdbobject  implements java.io.Serializable {
    ...
    public Srtdbobject(short id, String naam) {
        this.id = id;
        this.naam = naam;
    }
    public Srtdbobject(short id, String naam, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
