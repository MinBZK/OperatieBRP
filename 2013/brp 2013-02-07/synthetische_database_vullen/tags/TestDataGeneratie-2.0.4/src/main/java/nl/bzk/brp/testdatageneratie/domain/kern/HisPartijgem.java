...
public class HisPartijgem extends His {
    ...
    public void setPartijByPartij(final Partij partijByPartij) {
    ...
    public void setPartijByVoortzettendegem(final Partij partijByVoortzettendegem) {
    ...
    public void setPartijByOnderdeelvan(final Partij partijByOnderdeelvan) {
