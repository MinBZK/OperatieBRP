...
public class DocGenerator implements Callable<Boolean> {
    ...
    public DocGenerator(final int numberOfRecordsToProcess, final int batchBlockSize, final ActieIds actieIds) {
    ...
    public Boolean call() {
        ...
        try {
            ...
            for (long i = 1; i <= numberOfRecordsToProcess; i++) {
                ...
                if (isFractie(2))
                    doc.setIdent(RandomStringUtils.randomAlphanumeric(10));
                if (isFractie(2))
                    doc.setAktenr(RandomStringUtils.randomNumeric(4));
                ...
                if (Settings.SAVE) {
                    ...
                    kernSession.save(new HisDoc(doc));
                }
