...
public enum Srtindicatie {
    ...
    //TODO: wat te doen met verwijderde waarde? Enum zal niet goed meer werken als waarden niet netjes opvolgen.
    /**
     * Deze is verwijderd in laatste versie van statischegegevens
     */
    DUMMY_NIET_GEBRUIKEN("dummy-waarde"),
    /**
    ...
    /**
     * Indicator die aangeeft dat e persoon statenloos is.
     */
