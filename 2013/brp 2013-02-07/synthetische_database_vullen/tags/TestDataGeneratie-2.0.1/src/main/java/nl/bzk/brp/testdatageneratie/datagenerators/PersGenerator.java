...
public class PersGenerator {
    ...
    public Pers generatePers(final Voornaam[] voornamen) {
        ...
        for (int i = 0; i < voornamen.length; i++) {
            String voornaam = voornamen[i].getId().getNaam();
