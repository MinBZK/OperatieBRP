...
public class PersAdresGenerator {
    ...
    private static final int MAX_WOONDUUR_IN_MS = 2 * 10 * 365 * 24 * 60 * 60 * 1000;
    ...
    private static Persadres creeerNederlandsAdres(final Functieadres functieadres) {
        ...
        if (RandomService.isPercent(5)) adres.setLoctovadres(RandomStringUtils.randomAlphabetic(2));
