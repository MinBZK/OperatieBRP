...
public final class RandomService {
    ...
    public static boolean isPercent(final int percent) {
        return getRandomPercent() < percent;
    }
    ...
    public static String getAdresHuisletter() {
        AdresHuisletter adresHuisletter = BronnenRepo.getBron(AdresHuisletter.class);
        return adresHuisletter.getWaarde();
    }

    public static Integer getAdresHuisnummer() {
        AdresHuisnummer adresHuisnummer = BronnenRepo.getBron(AdresHuisnummer.class);
        return adresHuisnummer.getWaarde();
    }

    public static String getAdresHuisnummertoevoeging() {
        AdresHuisnummertoevoeging adresHuisnummertoevoeging = BronnenRepo.getBron(AdresHuisnummertoevoeging.class);
        return adresHuisnummertoevoeging.getWaarde();
    }

    public static String getAdresNor() {
        AdresNor adresNor = BronnenRepo.getBron(AdresNor.class);
        return adresNor.getWaarde();
    }

    public static String getAdresPostcode() {
        AdresPostcode adresPostcode = BronnenRepo.getBron(AdresPostcode.class);
        return adresPostcode.getWaarde();
    }

    public static Locatie getGeboorteplaats() {
        return BronnenRepo.getBron(Geboorteplaats.class).getLocatie();
    }
    ...
    public static Voornaam[] getVoornamen() {

        int aantal = (random.nextInt(4) + 1);
        Voornaam[] voornamen = new Voornaam[aantal];

        for (int i = 0; i < aantal; i++) {
            voornamen[i] = BronnenRepo.getBron(Voornaam.class);
        }
    ...
    public static Partij getPartijByBijhgem() {
        Partij partij;
        do {
            short gemeenteCode = BronnenRepo.getBron(AkteRegisterGemeenteCode.class).getGemeenteCode();
    ...
    public static String getGemDeel() {
        final GemeenteDeel gemeentedeel = BronnenRepo.getBron(GemeenteDeel.class);
