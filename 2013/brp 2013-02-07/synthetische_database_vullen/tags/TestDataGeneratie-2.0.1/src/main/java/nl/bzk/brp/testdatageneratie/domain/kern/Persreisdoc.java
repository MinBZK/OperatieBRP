...
public class Persreisdoc  implements java.io.Serializable {
     ...
     private StatusHis persreisdocstatushis = StatusHis.X;
    ...
    public StatusHis getPersreisdocstatushis() {
        return this.persreisdocstatushis;
    }

    public void setPersreisdocstatushis(final StatusHis persreisdocstatushis) {
