...
/**
 * Srtregel generated by hbm2java
 */
public class Srtregel  implements java.io.Serializable {
    ...
    public Srtregel(short id, String naam, String oms) {
        this.id = id;
        this.naam = naam;
        this.oms = oms;
    }
    public Srtregel(short id, String naam, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
       this.oms = oms;
