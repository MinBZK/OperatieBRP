...
/**
 * Categoriesrtactie generated by hbm2java
 */
public class Categoriesrtactie  implements java.io.Serializable {
    ...
    public Categoriesrtactie() {
    }

	
    public Categoriesrtactie(short id, String naam, String oms) {
        this.id = id;
        this.naam = naam;
        this.oms = oms;
    }
    public Categoriesrtactie(short id, String naam, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
       this.oms = oms;
