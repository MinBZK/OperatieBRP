 ...
 */
public class Verblijfsr  implements Cacheable<String> {
    ...
    public Verblijfsr(short id, String oms) {
        this.id = id;
        this.oms = oms;
    }
    public Verblijfsr(short id, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.oms = oms;
