...
public class PersoonGenerator implements Callable<Boolean> {
    ...
    private void voegPersoonToe(final Session kernSession) {
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersids hisPersidsCorrectie = (HisPersids) HisCorrectieUtil.creeerHisCorrectie(new HisPersids(pers), hisPersidsList.get(randomHisPersids));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersgeslachtsaand hisPersgeslachtsaandCorrectie = (HisPersgeslachtsaand) HisCorrectieUtil.creeerHisCorrectie(new HisPersgeslachtsaand(pers), hisPersgeslachtsaandList.get(randomHisPersgeslachtsaand));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPerssamengesteldenaam hisPerssamengesteldenaamCorrectie = (HisPerssamengesteldenaam) HisCorrectieUtil.creeerHisCorrectie(new HisPerssamengesteldenaam(pers), hisPerssamengesteldenaamList.get(randomHisPerssamengesteldenaam));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersaanschr hisPersaanschrCorrectie = (HisPersaanschr) HisCorrectieUtil.creeerHisCorrectie(new HisPersaanschr(pers), hisPersaanschrList.get(randomHisPersaanschr));
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersbijhverantwoordelijk hisPersbijhverantwoordelijkCorrectie = (HisPersbijhverantwoordelijk) HisCorrectieUtil.creeerHisCorrectie(new HisPersbijhverantwoordelijk(pers), hisPersbijhverantwoordelijkList.get(randomHisPersbijhverantwoordelijk));
        ...
        if (pers.getRdnopschorting() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersopschorting hisPersopschortingCorrectie = (HisPersopschorting) HisCorrectieUtil.creeerHisCorrectie(new HisPersopschorting(pers), hisPersopschortingList.get(randomHisPersopschorting));
        ...
        if (pers.getDatvestiginginnederland() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersimmigratie hisPersimmigratieCorrectie = (HisPersimmigratie) HisCorrectieUtil.creeerHisCorrectie(new HisPersimmigratie(pers), hisPersimmigratieList.get(randomHisPersimmigratie));
        ...
        if (pers.getVerblijfsr() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersverblijfsr hisPersverblijfsrCorrectie = (HisPersverblijfsr) HisCorrectieUtil.creeerHisCorrectie(new HisPersverblijfsr(pers), hisPersverblijfsrList.get(randomHisPersverblijfsr));
    ...
    private void voegGeslachtsnamenToe(final Session kernSession, final Pers pers) {
        ...
        for (Persgeslnaamcomp persgeslnaamcomp : geslachtsnaamComponenten) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersgeslnaamcomp hisPersgeslnaamcomp = (HisPersgeslnaamcomp) HisCorrectieUtil.creeerHisCorrectie(new HisPersgeslnaamcomp(persgeslnaamcomp), hisPersgeslnaamcompList.get(randomHisPersgeslnaamcomp));
                kernSession.save(hisPersgeslnaamcomp);
            }
        }
    }
    ...
    private void voegVoornamenToe(final Session kernSession, final String[] voornamen, final Pers pers) {
        for (int i = 0; i < voornamen.length; i++) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersvoornaam hisPersvoornaam = (HisPersvoornaam) HisCorrectieUtil.creeerHisCorrectie(new HisPersvoornaam(persVoornaam), hisPersvoornaamList.get(randomHisPersvoornaam));
                kernSession.save(hisPersvoornaam);
            }
        }
    }
