...
public class Partij  implements Cacheable<Short> {
    ...
    public Partij(Sector sector, Partij partijByVoortzettendegem, Partij partijByOnderdeelvan, String naam, Short srt, Short code, Integer dateinde, Integer dataanv, String partijstatushis, String gemstatushis) {
       this.sector = sector;
