 ...
 */
public class HisMultirealiteitregel extends His {
    ...
    public HisMultirealiteitregel(Multirealiteitregel multirealiteitregel, Date tsreg, Date tsverval, Long actieinh, Long actieverval) {
