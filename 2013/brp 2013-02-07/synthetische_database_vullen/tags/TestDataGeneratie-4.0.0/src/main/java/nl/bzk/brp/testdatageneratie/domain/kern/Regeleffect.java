...
/**
 * Regeleffect generated by hbm2java
 */
public class Regeleffect  implements java.io.Serializable {
    ...
    public Regeleffect(short id, String naam, String oms) {
        this.id = id;
        this.naam = naam;
        this.oms = oms;
    }
    public Regeleffect(short id, String naam, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.naam = naam;
       this.oms = oms;
