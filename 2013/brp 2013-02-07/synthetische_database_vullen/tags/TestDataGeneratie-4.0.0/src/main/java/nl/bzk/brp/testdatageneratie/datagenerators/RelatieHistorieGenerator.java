...
//                HisRelatie hisRelatieVervallen = HisUtil.creeerHis(relatie);
...
//
//                HisRelatie hisRelatieBeeindigd = HisUtil.creeerHis(relatie);
//                hisRelatieBeeindigd.setDateinde(brpDatumEinde);



                long persoon1 = persoonIds.selecteerId();
                Betr b1 = new Betr(SoortBetrokkenheid.PARTNER, relatie, persoon1);
                Betr b2 = new Betr(SoortBetrokkenheid.PARTNER, relatie, persoonIds.selecteerIdBehalve(persoon1));
