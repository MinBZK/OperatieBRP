...
public class HisPersidsGenerator extends HistorieGenerator<Pers, HisPersids> {
    ...
    @Override
    protected HisPersids generateHisMaterieel(final Pers actueel) {
        return new HisPersids(actueel);
    }
