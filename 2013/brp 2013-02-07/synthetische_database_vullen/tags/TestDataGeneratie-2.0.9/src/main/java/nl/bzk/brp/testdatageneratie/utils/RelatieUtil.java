    ...
    public static void opslaanBetrokkenheidMetHistorie(final Session kernSession, final Betr betr) {
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisBetrouderlijkgezag hisBetrouderlijkgezagCorrectie =
                (HisBetrouderlijkgezag) HisCorrectieUtil.creeerHisCorrectie(new HisBetrouderlijkgezag(betr),
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisBetrouderschap hisBetrouderschapCorrectie = (HisBetrouderschap) HisCorrectieUtil.creeerHisCorrectie(new HisBetrouderschap(betr), hisBetrouderschapList.get(randomHisBetrouderschap));
