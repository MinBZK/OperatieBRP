...
public class RandomBsnHelper {
    ...
    private final static Logger LOG = Logger.getLogger(RandomBsnHelper.class);
    ...
    public RandomBsnHelper(final int threadIndex, final int rangeSize, final int threadBlockSize) {
