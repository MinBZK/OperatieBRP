...
public class PersoonGenerator implements Callable<Boolean> {
    ...
    private void voegPersoonToe(final Session kernSession) {
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisPersaanschr hisPersaanschrCorrectie = (HisPersaanschr) HisUtil.creeerHisCorrectie(HisPersaanschrGenerator.getInstance().generateHisMaterieel(pers), hisPersaanschrList.get(randomHisPersaanschr));
        ...
        if (pers.getVerblijfsr() != null) {
            ...
            if (isFractie(His.CORRECTIE_FRACTIE)) {
                ...
                HisPersverblijfsr hisPersverblijfsrCorrectie = (HisPersverblijfsr) HisUtil.creeerHisCorrectie(HisPersverblijfsrGenerator.getInstance().generateHisMaterieel(pers), hisPersverblijfsrList.get(randomHisPersverblijfsr));
