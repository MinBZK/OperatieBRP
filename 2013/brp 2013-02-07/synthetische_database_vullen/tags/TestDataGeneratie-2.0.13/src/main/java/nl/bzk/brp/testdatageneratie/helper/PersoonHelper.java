...
public class PersoonHelper {
    ...
    public Pers generatePers(final String[] voornamen) {
        ...
        if (isFractie(2347)) {
            pers.setAdellijketitel(RandomUtil.getAdellijketitel());
        ...
        pers.setVerantwoordelijke(RandomUtil.getVerantwoordelijke());
        ...
        pers.setTijdstiplaatstewijz(RandomUtil.getPastTimestamp());
        ...
        if (geboorteplaats.isNederland()) {
            ...
            pers.setDataanvaaneenslverblijfsr(RandomUtil.randomDate());
            pers.setDataanvverblijfsr(RandomUtil.randomDate());
            if (!isFractie(3)) pers.setDatvoorzeindeverblijfsr(RandomUtil.randomDate());

            pers.setVerblijfsr(RandomUtil.getVerblijfsrecht());
        }
