    ...
    public static void opslaanBetrokkenheidMetHistorie(final Session kernSession, final Betr betr) {
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisBetrouderlijkgezag hisBetrouderlijkgezagCorrectie =
                (HisBetrouderlijkgezag) HisUtil.creeerHisCorrectie(HisBetrouderlijkgezagGenerator.getInstance().generateHisMaterieel(betr),
        ...
        if (isFractie(His.CORRECTIE_FRACTIE)) {
            ...
            HisBetrouderschap hisBetrouderschapCorrectie = (HisBetrouderschap) HisUtil.creeerHisCorrectie(HisBetrouderschapGenerator.getInstance().generateHisMaterieel(betr), hisBetrouderschapList.get(randomHisBetrouderschap));
