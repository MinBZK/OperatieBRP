...
ALTER TABLE "kern"."his_persbijhaard" ADD CONSTRAINT "r4197" UNIQUE (pers, tsreg, dataanvgel);
...
ALTER TABLE "kern"."bijhaard" ADD CONSTRAINT "r4444" UNIQUE (naam);
...
ALTER TABLE "kern"."persvol" ADD CONSTRAINT "pk0001" PRIMARY KEY (id);
...
ALTER TABLE "kern"."his_persbijhaard" ADD CONSTRAINT "r4552" PRIMARY KEY (id);
...
ALTER TABLE "kern"."bijhaard" ADD CONSTRAINT "r4443" PRIMARY KEY (id);
...
ALTER TABLE "lev"."abonnementsrtber" ADD CONSTRAINT "abonnementsrtber_abonnementsrtberstatushis_check" CHECK (((abonnementsrtberstatushis IS NULL) OR ((abonnementsrtberstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "lev"."abonnement" ADD CONSTRAINT "abonnement_abonnementstatushis_check" CHECK (((abonnementstatushis IS NULL) OR ((abonnementstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."verstrderde" ADD CONSTRAINT "verstrderde_verstrderdestatushis_check" CHECK (((verstrderdestatushis IS NULL) OR ((verstrderdestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."relatie" ADD CONSTRAINT "relatie_naamskeuzeongeborenvruchtsta_check" CHECK (((naamskeuzeongeborenvruchtsta IS NULL) OR ((naamskeuzeongeborenvruchtsta)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."relatie" ADD CONSTRAINT "relatie_huwelijkgeregistreerdpartner_check" CHECK (((huwelijkgeregistreerdpartner IS NULL) OR ((huwelijkgeregistreerdpartner)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."relatie" ADD CONSTRAINT "relatie_erkenningongeborenvruchtstat_check" CHECK (((erkenningongeborenvruchtstat IS NULL) OR ((erkenningongeborenvruchtstat)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persvoornaam" ADD CONSTRAINT "persvoornaam_persvoornaamstatushis_check" CHECK (((persvoornaamstatushis IS NULL) OR ((persvoornaamstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persverificatie" ADD CONSTRAINT "persverificatie_persverificatiestatushis_check" CHECK (((persverificatiestatushis IS NULL) OR ((persverificatiestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persreisdoc" ADD CONSTRAINT "persreisdoc_persreisdocstatushis_check" CHECK (((persreisdocstatushis IS NULL) OR ((persreisdocstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persnation" ADD CONSTRAINT "persnation_persnationstatushis_check" CHECK (((persnationstatushis IS NULL) OR ((persnationstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persindicatie" ADD CONSTRAINT "persindicatie_waarde_check" CHECK (((waarde IS NULL) OR (waarde = true)));
ALTER TABLE "kern"."persindicatie" ADD CONSTRAINT "persindicatie_persindicatiestatushis_check" CHECK (((persindicatiestatushis IS NULL) OR ((persindicatiestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persgeslnaamcomp" ADD CONSTRAINT "persgeslnaamcomp_persgeslnaamcompstatushis_check" CHECK (((persgeslnaamcompstatushis IS NULL) OR ((persgeslnaamcompstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persadres" ADD CONSTRAINT "persadres_persadresstatushis_check" CHECK (((persadresstatushis IS NULL) OR ((persadresstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."persadres" ADD CONSTRAINT "persadres_loctovadres_check" CHECK (((loctovadres IS NULL) OR ((loctovadres)::text = ANY ((ARRAY['by'::character varying, 'to'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_verblijfstitelstatushis_check" CHECK (((verblijfstitelstatushis IS NULL) OR ((verblijfstitelstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_uitslnlkiesrstatushis_check" CHECK (((uitslnlkiesrstatushis IS NULL) OR ((uitslnlkiesrstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_samengesteldenaamstatushis_check" CHECK (((samengesteldenaamstatushis IS NULL) OR ((samengesteldenaamstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_pkstatushis_check" CHECK (((pkstatushis IS NULL) OR ((pkstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_overlijdenstatushis_check" CHECK (((overlijdenstatushis IS NULL) OR ((overlijdenstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_opschortingstatushis_check" CHECK (((opschortingstatushis IS NULL) OR ((opschortingstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_inschrstatushis_check" CHECK (((inschrstatushis IS NULL) OR ((inschrstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_induitslnlkiesr_check" CHECK (((induitslnlkiesr IS NULL) OR (induitslnlkiesr = true)));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_immigratiestatushis_check" CHECK (((immigratiestatushis IS NULL) OR ((immigratiestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_idsstatushis_check" CHECK (((idsstatushis IS NULL) OR ((idsstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_geslachtsaandstatushis_check" CHECK (((geslachtsaandstatushis IS NULL) OR ((geslachtsaandstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_geboortestatushis_check" CHECK (((geboortestatushis IS NULL) OR ((geboortestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_euverkiezingenstatushis_check" CHECK (((euverkiezingenstatushis IS NULL) OR ((euverkiezingenstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_bvpstatushis_check" CHECK (((bvpstatushis IS NULL) OR ((bvpstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_bijhgemstatushis_check" CHECK (((bijhgemstatushis IS NULL) OR ((bijhgemstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_bijhaardstatushis_check" CHECK (((bijhaardstatushis IS NULL) OR ((bijhaardstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."pers" ADD CONSTRAINT "pers_aanschrstatushis_check" CHECK (((aanschrstatushis IS NULL) OR ((aanschrstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."partijrol" ADD CONSTRAINT "partijrol_partijrolstatushis_check" CHECK (((partijrolstatushis IS NULL) OR ((partijrolstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."partij" ADD CONSTRAINT "partij_partijstatushis_check" CHECK (((partijstatushis IS NULL) OR ((partijstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."partij" ADD CONSTRAINT "partij_gemstatushis_check" CHECK (((gemstatushis IS NULL) OR ((gemstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."onderzoek" ADD CONSTRAINT "onderzoek_onderzoekstatushis_check" CHECK (((onderzoekstatushis IS NULL) OR ((onderzoekstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."multirealiteitregel" ADD CONSTRAINT "multirealiteitregel_multirealiteitregelstatushis_check" CHECK (((multirealiteitregelstatushis IS NULL) OR ((multirealiteitregelstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
...
ALTER TABLE "kern"."his_persadres" ADD CONSTRAINT "his_persadres_loctovadres_check" CHECK (((loctovadres IS NULL) OR ((loctovadres)::text = ANY ((ARRAY['by'::character varying, 'to'::character varying])::text[]))));
...
ALTER TABLE "kern"."doc" ADD CONSTRAINT "doc_docstatushis_check" CHECK (((docstatushis IS NULL) OR ((docstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."betr" ADD CONSTRAINT "betr_ouderschapstatushis_check" CHECK (((ouderschapstatushis IS NULL) OR ((ouderschapstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."betr" ADD CONSTRAINT "betr_ouderlijkgezagstatushis_check" CHECK (((ouderlijkgezagstatushis IS NULL) OR ((ouderlijkgezagstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "kern"."betr" ADD CONSTRAINT "betr_indouder_check" CHECK (((indouder IS NULL) OR (indouder = true)));
ALTER TABLE "brm"."regelsituatie" ADD CONSTRAINT "regelsituatie_regelsituatiestatushis_check" CHECK (((regelsituatiestatushis IS NULL) OR ((regelsituatiestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "ber"."ber" ADD CONSTRAINT "ber_verwerkingswijze_check" CHECK (((verwerkingswijze IS NULL) OR ((verwerkingswijze)::text = ANY ((ARRAY['B'::character varying, 'P'::character varying])::text[]))));
ALTER TABLE "autaut"."uitgeslotene" ADD CONSTRAINT "uitgeslotene_uitgeslotenestatushis_check" CHECK (((uitgeslotenestatushis IS NULL) OR ((uitgeslotenestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "autaut"."doelbinding" ADD CONSTRAINT "doelbinding_doelbindingstatushis_check" CHECK (((doelbindingstatushis IS NULL) OR ((doelbindingstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "autaut"."bijhsituatie" ADD CONSTRAINT "bijhsituatie_bijhsituatiestatushis_check" CHECK (((bijhsituatiestatushis IS NULL) OR ((bijhsituatiestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
ALTER TABLE "autaut"."bijhautorisatie" ADD CONSTRAINT "bijhautorisatie_bijhautorisatiestatushis_check" CHECK (((bijhautorisatiestatushis IS NULL) OR ((bijhautorisatiestatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
...
ALTER TABLE "autaut"."autorisatiebesluit" ADD CONSTRAINT "autorisatiebesluit_autorisatiebesluitstatushis_check" CHECK (((autorisatiebesluitstatushis IS NULL) OR ((autorisatiebesluitstatushis)::text = ANY ((ARRAY['A'::character varying, 'T'::character varying, 'M'::character varying, 'F'::character varying, 'X'::character varying])::text[]))));
...
ALTER TABLE "kern"."persvol" ADD CONSTRAINT "fk0001" FOREIGN KEY (id) REFERENCES kern.pers(id);
