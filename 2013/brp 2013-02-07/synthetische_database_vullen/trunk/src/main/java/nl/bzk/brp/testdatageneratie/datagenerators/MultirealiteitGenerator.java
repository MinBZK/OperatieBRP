...
public class MultirealiteitGenerator implements Callable<Boolean> {
    ...
    public Boolean call() {
        ...
        try {
            ...
            for (long i = 1; i <= numberOfRecordsToProcess; i++) {
                ...
                hisRegel.setMultirealiteitregel(regel);
    ...
    protected Multirealiteitregel getMultirealiteit() {
        ...
        if (!RandomUtil.isFractie(10)) {
            regel.setSrtmultirealiteitregel(SoortMultiRealiteitRegel.PERSOON);
            ...
            regel.setSrtmultirealiteitregel(SoortMultiRealiteitRegel.RELATIE);
            regel.setRelatie(relatieIds.selecteerId());
        } else {
            regel.setSrtmultirealiteitregel(SoortMultiRealiteitRegel.BETROKKENHEID);
