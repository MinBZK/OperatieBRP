...
public class HisPersgeslachtsaand  extends HisMaterieel {
    ...
    public HisPersgeslachtsaand(Geslachtsaanduiding geslachtsaand) {
        this.geslachtsaand = geslachtsaand;
    }
    public HisPersgeslachtsaand(Pers pers, Integer dataanvgel, Integer dateindegel, Date tsreg, Date tsverval, Long actieinh, Long actieverval, Long actieaanpgel, Geslachtsaanduiding geslachtsaand) {
       this.pers = pers;
