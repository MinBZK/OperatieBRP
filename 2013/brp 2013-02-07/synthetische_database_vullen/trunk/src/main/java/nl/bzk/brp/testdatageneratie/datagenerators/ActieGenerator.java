...
public class ActieGenerator implements Callable<Boolean> {
    ...
    public Boolean call() {
        ...
        try {
            ...
            log.info("@@@@@@@@@ Acties / Administratieve Handelingen @@@@@@@@@@@@@@@@");
            ...
            for (long i = 1; i <= numberOfRecordsToProcess; i++) {
                ...
                admhnd.setSrtadmhnd(RandomUtil.getRandom(SoortAdministratieveHandeling.values()));
                ...
                actie.setSrtactie(RandomUtil.getRandom(SoortActie.values()));
