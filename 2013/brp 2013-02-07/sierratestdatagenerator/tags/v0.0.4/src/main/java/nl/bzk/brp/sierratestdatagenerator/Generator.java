...
public class Generator {
	...
	try {
	    ...
	    printWriter.println("--- Start " + " " + SierraTestdataGenerator.getVersion() + " @ " + new DateFormatter(SierraTestdataGenerator.datFormat).valueToString(new Date()));
	    ...
	    printWriter.println();
	    printWriter.println("--------------------------------------------------");
	    printWriter.println("--- Version:    " + SierraTestdataGenerator.getVersion());
	    ...
	    printWriter.println();
	    printWriter.println("--- END " + " " + SierraTestdataGenerator.getVersion() + " @ " + new DateFormatter(SierraTestdataGenerator.datFormat).valueToString(new Date()));
