...
public class BerichtStuurgegevensGroepBerichtBindingTest
    extends AbstractBindingUitTest<BerichtStuurgegevensGroepBericht>
{
    ...
    public void testBinding() throws JiBXException {
        ...
        Assert.assertEquals(maakExpectedStuurgegevensBevragingResultaat(), marshalObject(stuurgegevens));
    }

    private String maakExpectedStuurgegevensBevragingResultaat() {
        String xml =
            "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                + "<brp:StuurgegevensDu02_VraagTEST xmlns:brp=\"http://www.bprbzk.nl/BRP/0001\" xmlns:stuf=\"http://www"
                + ".kinggemeenten.nl/StUF/StUF0302\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
