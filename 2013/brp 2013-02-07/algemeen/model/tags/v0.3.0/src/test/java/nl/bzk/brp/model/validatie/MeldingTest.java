...
public class MeldingTest {
    ...
    public void testConstructorZonderOmschrijving() {
        Melding melding = new Melding(SoortMelding.DEBLOKKEERBAAR, MeldingCode.ALG0001);
    ...
    public void testConstructorMetOmschrijving() {
        Melding melding = new Melding(SoortMelding.DEBLOKKEERBAAR, MeldingCode.ALG0001, "Test");
        Assert.assertEquals(SoortMelding.DEBLOKKEERBAAR, melding.getSoort());
        Assert.assertEquals(MeldingCode.ALG0001, melding.getCode());
    ...
    public void testCompareTo() {
        Melding melding1 = new Melding(SoortMelding.DEBLOKKEERBAAR, MeldingCode.ALG0001, "Test1");
        Melding melding2 = new Melding(SoortMelding.FOUT, MeldingCode.ALG0001, "Test2");
        Melding melding3 = new Melding(SoortMelding.DEBLOKKEERBAAR, MeldingCode.ALG0001, "Test3");
        Melding melding4 = new Melding(SoortMelding.DEBLOKKEERBAAR, MeldingCode.BRAL0001, "Test4");
