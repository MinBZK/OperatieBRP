 ...
 */
@MappedSuperclass
public abstract class AbstractNationaliteitcode extends AbstractGegevensAttribuutType<Short> {
     ...
     *
     */
    protected AbstractNationaliteitcode() {
        super(null);
    }
     ...
     */
    public AbstractNationaliteitcode(final Short waarde) {
        super(waarde);
    }
