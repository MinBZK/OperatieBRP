        ...
        PersoonNationaliteitBasis
{
    ...
    protected AbstractPersoonNationaliteitModel() {
        this.persoonNationaliteitStatusHis = StatusHistorie.X;
    ...
    /**
     * Zet Standaard van Persoon \ Nationaliteit. Zet tevens het bijbehorende status his veld op 'A' als het argument
     * niet
     * null is.
     *
    ...
    public void setStandaard(final PersoonNationaliteitStandaardGroepModel standaard) {
        ...
        if (standaard != null) {
            persoonNationaliteitStatusHis = StatusHistorie.A;
        }
