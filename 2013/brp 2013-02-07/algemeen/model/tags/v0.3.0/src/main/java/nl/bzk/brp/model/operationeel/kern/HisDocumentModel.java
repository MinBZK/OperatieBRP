...
import nl.bzk.brp.model.operationeel.kern.basis.AbstractHisDocumentModel;
...
public class HisDocumentModel extends AbstractHisDocumentModel implements DocumentStandaardGroep {
     ...
     */
    public HisDocumentModel(final DocumentModel documentModel, final DocumentStandaardGroepModel groep) {
        super(documentModel, groep);
    }
