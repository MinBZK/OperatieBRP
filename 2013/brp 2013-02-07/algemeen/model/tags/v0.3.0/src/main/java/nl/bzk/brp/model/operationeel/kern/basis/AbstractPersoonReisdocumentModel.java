        ...
        PersoonReisdocumentBasis
{
    ...
    protected AbstractPersoonReisdocumentModel() {
        this.persoonReisdocumentStatusHis = StatusHistorie.X;
    ...
    /**
     * Zet Standaard van Persoon \ Reisdocument. Zet tevens het bijbehorende status his veld op 'A' als het argument
     * niet
     * null is.
     *
    ...
    public void setStandaard(final PersoonReisdocumentStandaardGroepModel standaard) {
        ...
        if (standaard != null) {
            persoonReisdocumentStatusHis = StatusHistorie.A;
        }
