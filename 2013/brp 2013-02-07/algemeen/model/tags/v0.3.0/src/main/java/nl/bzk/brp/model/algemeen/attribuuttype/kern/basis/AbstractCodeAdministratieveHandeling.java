 ...
 */
@MappedSuperclass
public abstract class AbstractCodeAdministratieveHandeling extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractCodeAdministratieveHandeling() {
        super(null);
    }
     ...
     */
    public AbstractCodeAdministratieveHandeling(final String waarde) {
        super(waarde);
    }
