...
public class SoortNederlandsReisdocument extends AbstractSoortNederlandsReisdocument
    implements Comparable<SoortNederlandsReisdocument>
{
    ...
    public int compareTo(final SoortNederlandsReisdocument o) {
        return new CompareToBuilder().append(getCode(), o.getCode()).append(getOmschrijving(),
            o.getOmschrijving()).toComparison();
    }
}
