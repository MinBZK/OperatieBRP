 ...
 */
@MappedSuperclass
public abstract class AbstractNaamOpenbareRuimte extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractNaamOpenbareRuimte() {
        super(null);
    }
     ...
     */
    public AbstractNaamOpenbareRuimte(final String waarde) {
        super(waarde);
    }
