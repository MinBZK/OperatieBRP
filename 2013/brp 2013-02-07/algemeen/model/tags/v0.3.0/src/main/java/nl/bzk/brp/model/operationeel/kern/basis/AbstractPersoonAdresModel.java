...
import nl.bzk.brp.model.logisch.kern.basis.PersoonAdresBasis;
...
public abstract class AbstractPersoonAdresModel extends AbstractDynamischObjectType implements PersoonAdresBasis {
    ...
    @JsonProperty
    private StatusHistorie                  persoonAdresStatusHis;
    ...
    protected AbstractPersoonAdresModel() {
        this.persoonAdresStatusHis = StatusHistorie.X;
     ...
     */
    public AbstractPersoonAdresModel(final PersoonModel persoon) {
        this();
     ...
     */
    public AbstractPersoonAdresModel(final PersoonAdres persoonAdres, final PersoonModel persoon) {
        this();
        this.persoon = persoon;
        if (persoonAdres.getStandaard() != null) {
            this.standaard = new PersoonAdresStandaardGroepModel(persoonAdres.getStandaard());
        }
     ...
     */
    @Override
    public PersoonAdresStandaardGroepModel getStandaard() {
        return standaard;
    }

    /**
     * Retourneert Persoon \ Adres StatusHis van Persoon \ Adres.
     *
     * @return Persoon \ Adres StatusHis.
     */
    ...
    /**
     * Zet Standaard van Persoon \ Adres. Zet tevens het bijbehorende status his veld op 'A' als het argument niet null
     * is.
     *
     * @param standaard Standaard.
     */
    public void setStandaard(final PersoonAdresStandaardGroepModel standaard) {
        this.standaard = standaard;
        if (standaard != null) {
            persoonAdresStatusHis = StatusHistorie.A;
        }

    }

    /**
     * Zet Persoon \ Adres StatusHis van Persoon \ Adres.
     *
     * @param persoonAdresStatusHis Persoon \ Adres StatusHis.
     */
