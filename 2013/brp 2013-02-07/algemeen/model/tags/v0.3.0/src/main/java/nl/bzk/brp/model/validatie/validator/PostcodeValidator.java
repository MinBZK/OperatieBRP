...
public class PostcodeValidator
    implements ConstraintValidator<Postcode, nl.bzk.brp.model.algemeen.attribuuttype.kern.Postcode>
{
    ...
    @Override
    public boolean isValid(final nl.bzk.brp.model.algemeen.attribuuttype.kern.Postcode postcode,
     ...
     */
    private boolean isGeldigePostcode(final nl.bzk.brp.model.algemeen.attribuuttype.kern.Postcode postcode) {
