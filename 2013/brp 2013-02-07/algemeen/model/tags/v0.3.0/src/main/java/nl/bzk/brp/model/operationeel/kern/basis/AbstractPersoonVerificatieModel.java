        ...
        PersoonVerificatieBasis
{
    ...
    protected AbstractPersoonVerificatieModel() {
        this.persoonVerificatieStatusHis = StatusHistorie.X;
    ...
    /**
     * Zet Standaard van Persoon \ Verificatie. Zet tevens het bijbehorende status his veld op 'A' als het argument niet
     * null is.
     *
    ...
    public void setStandaard(final PersoonVerificatieStandaardGroepModel standaard) {
        ...
        if (standaard != null) {
            persoonVerificatieStatusHis = StatusHistorie.A;
        }
