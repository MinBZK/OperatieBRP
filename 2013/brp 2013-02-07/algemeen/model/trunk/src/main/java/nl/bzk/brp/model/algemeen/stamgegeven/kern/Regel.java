...
public enum Regel {
    ...
    BRAL1118(null, "BRAL1118", "De aangever adreshouding ontbreekt, deze is verplicht als de reden adreswijziging P "
    + "(Aangifte door persoon) is.", null),
     ...
     * adreshouding.
     */
    BRAL2033(null, "BRAL2033",
        "Verplichte velden voor Nederlandse adressen: gemeente, reden wijziging, datum aanvang adreshouding.", null),
    ...
    /**
     * BRAL9010: De waarde van datum/tijdontlening van de Actie mag niet na de waarde van datum/tijdregistratie van
     * de Actie liggen.
     **/
    BRAL9010(null, "BRAL9010", "De waarde van datum/tijdontlening van de Actie mag niet na de waarde van "
        + "datum/tijdregistratie van de Actie liggen.", null),
     ...
     * gekregen kinderen.
     */
    BRBY0106(null, "BRBY0106", "De opgegeven geslachtsnaam is niet toegestaan. De geslachtsnaam moet gelijk zijn aan "
        + "die van een van de ouders en aan die van eerder geboren kinderen van deze ouders.", null),
    ...
    BRBY0152(null, "BRBY0152", "Een nationaliteit kan alleen toegekend worden aan een persoon die als nieuwgeborene "
        + "ingeschreven wordt.", null),
    /**
     ...
     */
    BRBY0165(null, "BRBY0165", "Het is verplicht om een reden verkrijging op te geven bij het verkrijgen van de "
        + "Nederlandse nationaliteit", null),

    /** Er moet precies 1 ouder uit wie het kind geboren is aanwezig zijn in het bericht. */
    BRBY0168(null, "BRBY0168", "Er moet precies 1 ouder uit wie het kind geboren is aanwezig zijn in het bericht.",
        null),
     ...
     */
    BRBY0403(null, "BRBY0403",
        "De partner is onder curatele, trouwen of geregistreerd partnerschap aangaan is niet toegestaan.", null),
    /**
     ...
     * hebben.
     */
    BRBY0409(null, "BRBY0409", "Er is verwantschap tussen de partners, trouwen of geregistreerd partnerschap aangaan "
        + "is niet toegestaan.", null),
     ...
     */
    BRBY0417(null, "BRBY0417", "De partner heeft al een niet- beeindigd huwelijk of geregistreerd partnerschap, "
     ...
     */
    BRBY0525(null, "BRBY0525", "De opgegeven adrescorrectie of een als gevolg daarvan gecreëerd adresrecord heeft een "
    ...
    BRBY0901(null, "BRBY0901",
        "Overlijden kan niet worden geregistreerd omdat de bijhouding al is opgeschort wegens overlijden", null),
    /** Datum overlijden moet op of na datum eerste inschrijving liggen en mag niet in de toekomst liggen.*/
    BRBY0902(null, "BRBY0902",
    ...
    BRBY0903(null, "BRBY0903",
        "De gemeente van overlijden moet verwijzen naar een geldige gemeente op datum overlijden.", null),
    /**
     * BRBY0904: Het land overlijden moet verwijzen naar een geldig voorkomen in stamgegeven "Land" op peildatum datum
     * overlijden.
     **/
    BRBY0904(null, "BRBY0904",
        "Het land van overlijden moet verwijzen naar een geldig land op datum overlijden.", null),
    /**
     * De woonplaats overlijden moet verwijzen naar een geldig voorkomen in stamgegeven "Plaats" op peildatum datum
     * overlijden.
     **/
    BRBY0905(null, "BRBY0905",
        "De plaats van overlijden moet verwijzen naar een geldige plaats op datum overlijden", null),
    /** Er zijn al rechtsfeiten geregistreerd die hebben plaatsgevonden na de datum van overlijden.*/
    BRBY0907(null, "BRBY0907",
        "Er zijn al rechtsfeiten geregistreerd die hebben plaatsgevonden na de datum van overlijden.", null),
    /** De datum aanvang geldigheid van de actie Overlijden moet gelijk zijn aan de datum overlijden. **/
    BRBY0908(null, "BRBY0908",
        "De datum aanvang geldigheid van de actie Overlijden moet gelijk zijn aan de datum overlijden.", null),
    ...
    BRBY0033(null, "BRBY0033",
        "De opgegeven vader voldoet niet aan de regels gesteld in Nederlandse of vreemde wetgeving.", null),
    /** BRBY0033: Vader / kandidaat vader. */
    BRBY0033_1(null, "BRBY0033_1",
        "Er is geen vader opgegeven, terwijl er wel een kandidaat in de BRP staat geregistreerd", null),
    /** CommunicatieID in bericht moet uniek zijn. */
    BRBY9901(null, "BRBY9901", "Elk communicatieID in het bericht moet uniek zijn", null),
    /** ReferentieID in request moet verwijzen naar communicatieID in request. */
    BRBY9902(null, "BRBY9902",
        "Elk referentieID in het request moet verwijzen naar een communicatieID in het request", null),
    /** Gedeblokkeerde meldingen moeten in verwerking daadwerkelijk optreden. */
    BRBY9904(null, "BRBY9904", "De gedeblokkeerde melding is niet opgetreden", null),
    /** In request mag niet naar een verwijzend element worden verwezen. */
    BRBY9905(null, "BRBY9905", "Een request mag geen keten- of zelfverwijzing bevatten.", null),
    /** In request moeten bij verwijzing betrokken elementen van zelfde type zijn. */
    BRBY9906(null, "BRBY9906",
        "Een referentieID moet naar een element in het request verwijzen met hetzelfde entiteittype", null),
    /** ReferentieID in response moet verwijzen naar communicatieID in request. */
    BRBY9903(null, "BRBY9903",
        "Elk referentieID in antwoord moet verwijzen naar een communicatieID in de bijhouding", null);
