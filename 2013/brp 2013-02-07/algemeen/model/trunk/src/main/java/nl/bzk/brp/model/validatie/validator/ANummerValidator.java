 ...
 */
public class ANummerValidator implements ConstraintValidator<ANummer, nl.bzk.brp.model.algemeen.attribuuttype.kern.ANummer> {
    ...
    @Override
    public boolean isValid(final nl.bzk.brp.model.algemeen.attribuuttype.kern.ANummer aNummer, final ConstraintValidatorContext context) {
        boolean resultaat;
     ...
     */
    private boolean isGeldigeAnummer(final nl.bzk.brp.model.algemeen.attribuuttype.kern.ANummer aNummer) {
        boolean resultaat;
