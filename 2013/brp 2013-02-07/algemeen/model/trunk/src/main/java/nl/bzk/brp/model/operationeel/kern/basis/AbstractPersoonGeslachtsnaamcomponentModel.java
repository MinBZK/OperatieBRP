        ...
        PersoonGeslachtsnaamcomponentBasis
{
    ...
    protected AbstractPersoonGeslachtsnaamcomponentModel() {
        this.persoonGeslachtsnaamcomponentStatusHis = StatusHistorie.X;
    ...
    /**
     * Zet Standaard van Persoon \ Geslachtsnaamcomponent. Zet tevens het bijbehorende status his veld op 'A' als het
     * argument
     * niet null is.
     *
    ...
    public void setStandaard(final PersoonGeslachtsnaamcomponentStandaardGroepModel standaard) {
        ...
        if (standaard != null) {
            persoonGeslachtsnaamcomponentStatusHis = StatusHistorie.A;
        }
