 ...
 */
@MappedSuperclass
public abstract class AbstractIdentificatiecodeNummeraanduiding extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractIdentificatiecodeNummeraanduiding() {
        super(null);
    }
     ...
     */
    public AbstractIdentificatiecodeNummeraanduiding(final String waarde) {
        super(waarde);
    }
