...
public final class DatumUtil {
     ...
     */
    public static boolean isGeldigOp(final BestaansPeriodeStamgegeven bestaansPeriodeStamgegeven, final Datum peilDatum)
    {
        if (peilDatum == null) {
     ...
     *
     * @param bestaansPeriodeStamgegeven het stamgegeven.
     * @param beginDatum periode begin datum.
     * @param eindDatum periode einde datum.
    ...
    public static boolean isGeldigInPeriode(final BestaansPeriodeStamgegeven bestaansPeriodeStamgegeven,
                                            final Datum beginDatum,
                                            final Datum eindDatum)
    {
