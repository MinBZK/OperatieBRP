...
import nl.bzk.brp.model.operationeel.kern.basis.AbstractHisOuderOuderschapModel;
...
public class HisOuderOuderschapModel extends AbstractHisOuderOuderschapModel implements OuderOuderschapGroep {
     ...
     */
    public HisOuderOuderschapModel(final OuderModel ouderModel, final OuderOuderschapGroepModel groep) {
        super(ouderModel, groep);
    }
