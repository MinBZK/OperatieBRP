...
import nl.bzk.brp.model.operationeel.kern.basis.AbstractRegelverantwoordingModel;
...
public class RegelverantwoordingModel extends AbstractRegelverantwoordingModel implements Regelverantwoording {
     ...
     */
    public RegelverantwoordingModel(final ActieModel actie, final Regel regel) {
        super(actie, regel);
    }
