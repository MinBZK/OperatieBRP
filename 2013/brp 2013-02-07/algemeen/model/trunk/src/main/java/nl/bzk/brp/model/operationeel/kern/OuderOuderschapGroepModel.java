...
public class OuderOuderschapGroepModel extends AbstractOuderOuderschapGroepModel implements OuderOuderschapGroep {
     ...
     */
    public OuderOuderschapGroepModel(final Ja indicatieOuder, final Ja indicatieOuderUitWieKindIsVoortgekomen) {
        super(indicatieOuder, indicatieOuderUitWieKindIsVoortgekomen);
    }
