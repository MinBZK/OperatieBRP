...
public abstract class AbstractAttribuutType<T> implements AttribuutType<T>, Comparable<AbstractAttribuutType<T>> {
    ...
    /** {@inheritDoc} */
    @Override
    public int compareTo(final AbstractAttribuutType<T> o) {
        final int vergelijk;
