 ...
 */
@MappedSuperclass
public abstract class AbstractScheidingsteken extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractScheidingsteken() {
        super(null);
    }
     ...
     */
    public AbstractScheidingsteken(final String waarde) {
        super(waarde);
    }
