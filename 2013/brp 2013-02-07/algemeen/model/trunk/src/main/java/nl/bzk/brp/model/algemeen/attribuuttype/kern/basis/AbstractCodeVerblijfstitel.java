 ...
 */
@MappedSuperclass
public abstract class AbstractCodeVerblijfstitel extends AbstractGegevensAttribuutType<Short> {
     ...
     *
     */
    protected AbstractCodeVerblijfstitel() {
        super(null);
    }
     ...
     */
    public AbstractCodeVerblijfstitel(final Short waarde) {
        super(waarde);
    }
