...
import nl.bzk.brp.model.bericht.kern.basis.AbstractErkennerBericht;
 ...
 *
 */
public class ErkennerBericht extends AbstractErkennerBericht implements Erkenner {

    /** Constructor die het discriminator attribuut zet of doorgeeft. */
    public ErkennerBericht() {
        super();
    }
