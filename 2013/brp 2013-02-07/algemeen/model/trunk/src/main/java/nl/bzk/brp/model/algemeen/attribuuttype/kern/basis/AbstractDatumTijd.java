 ...
 */
@MappedSuperclass
public abstract class AbstractDatumTijd extends AbstractGegevensAttribuutType<Date> {
     ...
     */
    public AbstractDatumTijd(final Date waarde) {
        super(waarde);
    }
