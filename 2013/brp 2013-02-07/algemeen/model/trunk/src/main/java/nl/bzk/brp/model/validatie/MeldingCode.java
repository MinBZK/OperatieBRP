...
public enum MeldingCode {
    ...
    BRBY0908("De datum aanvang geldigheid van de actie Overlijden moet gelijk zijn aan de datum overlijden."),
    ...
    BRBY9904("De gedeblokkeerde melding is niet opgetreden"),
    ...
    BRBY9903("Elk referentieID in antwoord moet verwijzen naar een communicatieID in de bijhouding");
