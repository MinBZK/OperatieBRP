...
public class BindingUtilTest {
    ...
    public void testVoegToeIdentificeerbaarObjectAanJixbUserContextNiksInContext() {
        IUnmarshallingContext ctx = Mockito.mock(IUnmarshallingContext.class);

        BindingUtil.voegToeIdentificeerbaarObjectAanJixbUserContext(ctx, new PersoonBericht());
    ...
    public void testEnumeratieWaardeConversie() {
        Assert.assertNull(BindingUtil.stringNaarEnumeratiewaarde(null, AanduidingBijHuisnummer.class));
        Assert.assertNull(BindingUtil.enumeratiewaardeNaarString(null));

        Assert.assertEquals(AanduidingBijHuisnummer.BY,
            BindingUtil.stringNaarEnumeratiewaarde("by", AanduidingBijHuisnummer.class));
        Assert.assertEquals(AanduidingBijHuisnummer.TO,
            BindingUtil.stringNaarEnumeratiewaarde("to", AanduidingBijHuisnummer.class));
        Assert.assertEquals("by", BindingUtil.enumeratiewaardeNaarString(AanduidingBijHuisnummer.BY));
        Assert.assertEquals("to", BindingUtil.enumeratiewaardeNaarString(AanduidingBijHuisnummer.TO));

        Assert.assertNull(BindingUtil.stringNaarEnumeratiewaarde("FALSE", AanduidingBijHuisnummer.class));
    }
    ...
    public void testDatumGetalConversie() {
        ...
        Assert.assertEquals(Integer.valueOf(20130000), BindingUtil.datumAlsStringNaarDatumAlsGetal("2013"));
        Assert.assertEquals("2013-02-01", BindingUtil.datumAlsGetalNaarDatumAlsString(Integer.valueOf(20130201)));
        Assert.assertEquals("2013", BindingUtil.datumAlsGetalNaarDatumAlsString(Integer.valueOf(20130000)));
    }
    ...
    public void testW3CDatumTijdConversie() {
        ...
        Assert.assertEquals("2013-02-01T11:11:11.011", BindingUtil.javaDateNaarW3cDatumString(bouwDatum(2013, 2, 1)));
