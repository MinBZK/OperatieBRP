...
public class DatumUtilTest {
    ...
    public void testIsDatumsGeldigOpPeriode() {
        ...
        Assert.assertTrue(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19000101), new Datum(25000101),
            new Datum(20120303), new Datum(20120404)));
        Assert.assertTrue(
            DatumUtil.isDatumsGeldigOpPeriode(new Datum(19000101), null, new Datum(20120303), new Datum(20120404)));
        ...
        Assert.assertFalse(
            DatumUtil.isDatumsGeldigOpPeriode(new Datum(20000101), null, new Datum(19911231), new Datum(19911231)));
        Assert.assertFalse(
            DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101), new Datum(19911231), null));
        Assert.assertFalse(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101),
            new Datum(19910231), new Datum(19911231)));
        Assert.assertFalse(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101),
            new Datum(19910231), new Datum(19970231)));
        Assert.assertFalse(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101),
            new Datum(19910231), new Datum(20070231)));
        Assert.assertTrue(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101),
            new Datum(19920101), new Datum(200020101)));
        Assert.assertFalse(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101),
            new Datum(200020102), new Datum(200020103)));
        Assert.assertFalse(DatumUtil.isDatumsGeldigOpPeriode(new Datum(19920101), new Datum(200020101),
            new Datum(19911230), new Datum(19911231)));
    }
