...
public class RelatieBerichtBindingTest extends AbstractBindingInTest<RelatieBericht> {
    ...
    public void testHuwelijk() throws JiBXException {
        ...
        Assert.assertEquals("1000", standaardGroep.getGemeenteAanvangCode());
        Assert.assertEquals("1000", standaardGroep.getGemeenteEindeCode());
        Assert.assertEquals(new Woonplaatscode(Short.parseShort("1000")), standaardGroep.getWoonplaatsAanvang().getCode());
        Assert.assertEquals(new Woonplaatscode(Short.parseShort("1000")), standaardGroep.getWoonplaatsEinde().getCode());
        ...
        Assert.assertEquals("1000", standaardGroep.getLandAanvangCode());
        Assert.assertEquals("1000", standaardGroep.getLandEindeCode());
        ...
        Assert.assertEquals(new LocatieOmschrijving("omslocaanv"), standaardGroep.getOmschrijvingLocatieAanvang());
        Assert.assertEquals(new LocatieOmschrijving("omsloceinde"), standaardGroep.getOmschrijvingLocatieEinde());
