...
public class BurgerservicenummerTest {
    ...
    public void testMetNullWaardeVoorBurgerservicenummer() {
        Burgerservicenummer bsn = new Burgerservicenummer((Integer) null);
    ...
    public void testEqualsVanBurgerservicenummer() {
        ...
        Assert.assertTrue(bsn.equals(new Burgerservicenummer(Integer.parseInt("012345678"))));
    ...
    public void testHashcodeVanBurgerservicenummer() {
        ...
        Assert.assertTrue(bsn.hashCode() == (new Burgerservicenummer(Integer.parseInt("012345678"))).hashCode());
