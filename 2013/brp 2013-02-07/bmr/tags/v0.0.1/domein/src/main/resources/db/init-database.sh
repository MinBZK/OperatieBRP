...
psql "$@" -f - <<delim
\i ${_CURRENT_DIRECTORY}/brp.sql
\i ${_CURRENT_DIRECTORY}/brp-stamgegevensStatisch.sql
\i ${_CURRENT_DIRECTORY}/brp-logischeElementGegevens.sql
\i ${_CURRENT_DIRECTORY}/stamgegevensLand.sql
\i ${_CURRENT_DIRECTORY}/stamgegevensPartijGemeente.sql
\i ${_CURRENT_DIRECTORY}/stamgegevensPlaats.sql
