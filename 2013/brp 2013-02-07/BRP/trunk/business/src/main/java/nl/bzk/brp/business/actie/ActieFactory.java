...
/**
 * Factory class voor het instantieren van {@link AbstractActieUitvoerder},
 * instanties zijn op basis van de uit te voeren {@link Actie}.
 */
public interface ActieFactory {
     ...
     */
    AbstractActieUitvoerder getActieUitvoerder(Actie actie);
}
