 ...
 */
public class BRBY0024 implements BijhoudingsBerichtBedrijfsRegel<AbstractBijhoudingsBericht> {
    ...
    public List<Melding> executeer(final AbstractBijhoudingsBericht bericht) {
        ...
        if (bericht != null && bevatLijstOverlappendeActies(bericht.getAdministratieveHandeling().getActies())) {
            meldingen =
                Arrays.asList(new Melding(SoortMelding.FOUT, MeldingCode.BRBY0024, null, null));
        } else {
