...
/**
 * Interface waaraan elke bedrijfsregel implementatie moet voldoen. Een bedrijfsregel executeert op het gehele bericht
 * en staat eigenlijk los van de inhoud van de acties.
 *
 * @param <T> Type voor de huidige situatie zoals bekend in de BRP database.
 */
public interface BijhoudingsBerichtBedrijfsRegel<T extends AbstractBijhoudingsBericht> {
     ...
     */
    List<Melding> executeer(final T bericht);
}
