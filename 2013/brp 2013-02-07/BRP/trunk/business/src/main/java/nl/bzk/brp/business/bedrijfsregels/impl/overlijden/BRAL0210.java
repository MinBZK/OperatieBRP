...
public class BRAL0210 implements ActieBedrijfsRegel<Persoon> {
     ...
     * @param plaats plaats in locatie.
    ...
    private boolean geldigLocatieCombinatie(final Partij gemeente, final Land land, final Plaats plaats,
        ...
        final LocatieOmschrijving locatieOmschrijving)
    {
        ...
        if (null == land) {
            ...
            if (null != buitenlandseplaats || null != buitenlandseRegio || null != locatieOmschrijving) {
                combinationOk = false;
            ...
            if (null != gemeente || null != plaats
                || (null == buitenlandseplaats && null == buitenlandseRegio && null == locatieOmschrijving))
            {
                combinationOk = false;
            } else if (null != buitenlandseplaats) {
                if (null != locatieOmschrijving) {
                    combinationOk = false;
                }
            } else {
