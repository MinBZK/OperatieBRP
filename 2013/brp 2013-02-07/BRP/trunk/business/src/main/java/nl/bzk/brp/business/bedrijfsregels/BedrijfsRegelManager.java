...
public interface BedrijfsRegelManager {
    ...
    /**
     * Haalt bedrijfsregels op die dient uitgevoerd te worden voor alle berichten.
     *
     ...
     * @return Lijst van uit te voeren (bericht) bedrijfsregels.
     */
    List<? extends BijhoudingsBerichtBedrijfsRegel> getUitTeVoerenBijhoudingsBerichtBedrijfsRegels(
