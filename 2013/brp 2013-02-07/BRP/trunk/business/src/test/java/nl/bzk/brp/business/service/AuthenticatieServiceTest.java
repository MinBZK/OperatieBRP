...
public class AuthenticatieServiceTest {
    ...
    public void init() throws IOException, CertificateException, URISyntaxException {
        ...
        testPartij1 = StatischeObjecttypeBuilder.bouwGemeente((short) 1200, "testPartij1");
        ReflectionTestUtils.setField(testPartij1, "iD", (short) 1200);
        testPartij2 = StatischeObjecttypeBuilder.bouwGemeente((short) 1300, "testPartij2");
