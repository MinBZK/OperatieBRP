...
public class BRBY0904Test {
    ...
    public void testCorrectePeriodeGemeenteGeenPeriode() {
        ...
        List<Melding> meldingen =
            brby0904.executeer(null, maakPersoonOverlijden(maakLand("24", "land", null, null), 20120303),
    ...
    public void testCorrectePeriode() {
        List<Melding> meldingen =
            brby0904.executeer(null, maakPersoonOverlijden(maakLand("24", "land", 19000101, null), 19000101),
    ...
    public void testNietCorrectePeriode() {
        List<Melding> meldingen =
            brby0904
                .executeer(null, maakPersoonOverlijden(maakLand("24", "gemeente", 19000101, 19000110), 19000110),
    ...
    private Land maakLand(final String code, final String naam, final Integer begin, final Integer eind) {
        ...
        Land land = new Land(new Landcode(Short.parseShort(code)), new NaamEnumeratiewaarde(naam), null, datumAanvang,
                             datumEinde);
        return land;
    }
}
