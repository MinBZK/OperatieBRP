...
public class BsnLockerTest {
    ...
    public void simpleBsnLockerTestC() {
        bsnLocker.getLocks(GEEN_LOCKS, Arrays.asList("1", "2", "3"), null);
        bsnLocker.unLock();
    }

    @Test
    public void simpleBsnLockerTestD() {
        bsnLocker.getLocks(Arrays.asList("1", "2", "3"), GEEN_LOCKS, null);
        bsnLocker.unLock();
    }
    ...
    public void simpleBsnLockerTestF() {
        bsnLocker.getLocks(Arrays.asList("1", "2", "3"), Arrays.asList("1", "2", "3"), null);
        bsnLocker.unLock();
    }
    ...
    public void timoutThreadLockTestC() throws InterruptedException {
        // write - read
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("1"), Arrays.asList("1"), GEEN_LOCKS,
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestD() throws InterruptedException {
        // write - write
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("1"), GEEN_LOCKS, Arrays.asList("1"),
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestE() throws InterruptedException {
        // read - write
        testReadWriteMetAfwijking(Arrays.asList("1", "2"), GEEN_LOCKS, GEEN_LOCKS, Arrays.asList("2", "3"),
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestF() throws InterruptedException {
        // write - read
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("1", "2"), Arrays.asList("2", "3"), GEEN_LOCKS,
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
    ...
    public void timoutThreadLockTestG() throws InterruptedException {
        // write - write
        testReadWriteMetAfwijking(GEEN_LOCKS, Arrays.asList("2", "3"), GEEN_LOCKS, Arrays.asList("2", "3"),
                (brpBusinessConfiguratie.getDatabaseTimeOutProperty() * 1000L));
    }
