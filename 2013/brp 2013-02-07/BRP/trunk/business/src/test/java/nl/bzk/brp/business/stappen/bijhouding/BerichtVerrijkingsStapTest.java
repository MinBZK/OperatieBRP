...
public class BerichtVerrijkingsStapTest extends AbstractStapTest {
    ...
    public void testCorrectieAdresNL() {
        ...
        standaard.setRedenWijzigingCode(WIJZADRES_P.getWaarde());
        standaard.setWoonplaatsCode(PLAATS_234);
        standaard.setSoort(FunctieAdres.WOONADRES);
    ...
    public void testCorrectieAdresNLGeenVerrijkingNodig() {
        ...
        correctieAdresBericht.getAdministratieveHandeling().setActies(new ArrayList<ActieBericht>());
        correctieAdresBericht.getAdministratieveHandeling().getActies().add(correactieAdresActie);
//        correctieAdresBericht.getAdministratieveHandeling().setPartijCode(GEM_34);
...
//        verhuisBericht.getAdministratieveHandeling().setPartijCode(GEM_34);
    ...
    public void testRegistratieNationaliteitGeenVerrijkingNodig() {
        ...
        Assert.assertTrue(berichtVerrijkingsStap.voerVerwerkingsStapUitVoorBericht(bericht,
                bouwBerichtContext(""), res));

        Mockito.verify(referentieDataRepository, Mockito.times(0)).vindNationaliteitOpCode(
                Matchers.any(Nationaliteitcode.class));
        Mockito.verify(referentieDataRepository, Mockito.times(0)).vindRedenVerkregenNlNationaliteitOpCode(
                Matchers.any(RedenVerkrijgingCode.class));
        Mockito.verify(referentieDataRepository, Mockito.times(0)).vindRedenVerliesNLNationaliteitOpCode(
