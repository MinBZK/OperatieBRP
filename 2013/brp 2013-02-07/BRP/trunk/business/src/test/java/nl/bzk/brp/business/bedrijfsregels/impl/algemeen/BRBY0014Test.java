...
public class BRBY0014Test {
    ...
    public void init() {
        ...
        Mockito.when(persoonRepository.isBSNAlIngebruik(new Burgerservicenummer(BESTAAND_BSN_1))).thenReturn(true);
        Mockito.when(persoonRepository.isBSNAlIngebruik(new Burgerservicenummer(BESTAAND_BSN_2))).thenReturn(true);
    ...
    public void testPersoonMetNietBestaandBsn() {
        ...
        Assert.assertEquals("Onverwachte melding tekst",
                "De gevraagde persoon met BSN 111111111 komt niet voor in het systeem.", meldingen.get(0)
                        .getOmschrijving());
    }
    ...
    public void testPersoonMetOntbrekendeIdentificerendeGegevens() {
        ...
        Assert.assertEquals("Onverwachte meldingcode", MeldingCode.BRBY0014, meldingen.get(0).getCode());
        Assert.assertEquals("Onverwachte melding tekst",
                "Er is geen identificatie opgegeven van de betreffende persoon.", meldingen.get(0).getOmschrijving());
    }
    ...
    // TODO na refactoring is het niet meer mogelijk om een lege string als bsn mee te geven, dit kan in de toekomst
    // weer anders zijn. Test is voorlopig uitgezet.
    @Ignore
    @Test
    public void testPersoonMetLegeBsn() {
        ...
        Assert.assertEquals("Onverwachte meldingcode", MeldingCode.BRBY0014, meldingen.get(0).getCode());
        Assert.assertEquals("Onverwachte melding tekst",
                "De gevraagde persoon met BSN  komt niet voor in het systeem.", meldingen.get(0).getOmschrijving());
    }

    @Test
    public void testRelatieMetBestaandeBsns() {
        List<Melding> meldingen =
            bedrijfsregel.executeer(null, maakRelatieBerichtMetPersonen(BESTAAND_PERSOON_1, BESTAAND_PERSOON_2), null);
        Assert.assertNotNull(meldingen);
        Assert.assertEquals("Onverwacht aantal meldingen", 0, meldingen.size());
    }
    ...
    public void testRelatieMetEnkeleBestaandeBsn() {
        List<Melding> meldingen =
            bedrijfsregel.executeer(null,
                    maakRelatieBerichtMetPersonen(BESTAAND_PERSOON_1, maakPersoonBerichtMetBsn("111111111")), null);
        Assert.assertNotNull(meldingen);
        Assert.assertEquals("Onverwacht aantal meldingen", 1, meldingen.size());
        Assert.assertEquals("Onverwachte meldingcode", MeldingCode.BRBY0014, meldingen.get(0).getCode());
        Assert.assertEquals("Onverwachte melding tekst",
    ...
    public void testRelatieMetTweeNietBestaandeBsns() {
        List<Melding> meldingen =
            bedrijfsregel.executeer(
                    null,
                    maakRelatieBerichtMetPersonen(maakPersoonBerichtMetBsn("111111111"),
        ...
        Assert.assertEquals("Onverwachte melding tekst",
                "De gevraagde persoon met BSN 111111111 komt niet voor in het systeem.", meldingen.get(0)
                        .getOmschrijving());
        Assert.assertEquals("Onverwachte melding tekst",
                "De gevraagde persoon met BSN 222222222 komt niet voor in het systeem.", meldingen.get(1)
                        .getOmschrijving());
    }
    ...
    public void testRelatieMetBestaandBsnEnMissendeIdentificerendeGegevens() {
        List<Melding> meldingen =
            bedrijfsregel
                    .executeer(null, maakRelatieBerichtMetPersonen(new PersoonBericht(), BESTAAND_PERSOON_1), null);
        Assert.assertNotNull(meldingen);
        Assert.assertEquals("Onverwacht aantal meldingen", 1, meldingen.size());
        Assert.assertEquals("Onverwachte meldingcode", MeldingCode.BRBY0014, meldingen.get(0).getCode());
        Assert.assertEquals("Onverwachte melding tekst",
    ...
    private static RelatieBericht maakRelatieBerichtMetPersonen(final PersoonBericht... personen) {
        ...
        for (PersoonBericht betrokkene : personen) {
            BetrokkenheidBericht betrokkenheid = new PartnerBericht();
