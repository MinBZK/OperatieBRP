...
-- Verwijder de verplichting op status his velden van hierarchische types (Zie ROMEO-71, ROMEO-120)
ALTER TABLE Kern.Relatie ALTER COLUMN huwelijkgeregistreerdpartner DROP NOT NULL;
ALTER TABLE Kern.Relatie ALTER COLUMN naamskeuzeongeborenvruchtsta DROP NOT NULL;
ALTER TABLE Kern.Relatie ALTER COLUMN erkenningongeborenvruchtstat DROP NOT NULL;
ALTER TABLE Kern.Betr ALTER COLUMN ouderschapstatushis DROP NOT NULL;
ALTER TABLE Kern.Betr ALTER COLUMN ouderlijkgezagstatushis DROP NOT NULL;
