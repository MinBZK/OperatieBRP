...
public class RelatieRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanRelatie() {
        ...
        // NVT voor een familierechtelijke betrekking. Zie ROMEO-71.
        Assert.assertEquals(null, relaties.get(0).get("HuwelijkGeregistreerdPartner"));
        ...
        // NVT voor een familierechtelijke betrekking. Zie ROMEO-71.
        Assert.assertEquals(null, relaties.get(0).get("ouderschapstatushis"));
        Assert.assertEquals(null, relaties.get(0).get("ouderlijkgezagstatushis"));
     ...
     */
    private PersoonModel bouwPersoon(final Integer id, final Integer bsn) {
