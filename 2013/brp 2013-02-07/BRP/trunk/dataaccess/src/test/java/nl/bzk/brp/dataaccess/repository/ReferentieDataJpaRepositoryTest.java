...
public class ReferentieDataJpaRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testVindWoonplaatsOpCode() {
        Plaats woonplaats = referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode(Short.parseShort("0034")));
    ...
    public void testVindRedenVerkregenNlNationaliteitOpCode() {
        RedenVerkrijgingNLNationaliteit redenVerkrijging =
            referentieDataRepository.vindRedenVerkregenNlNationaliteitOpCode(new RedenVerkrijgingCode(
                    Short.parseShort("001")));
...
//    }
    ...
    public void testVindNietBestaandeRedenVerliesNlNationaliteitOpNaam() {
        referentieDataRepository.vindRedenVerliesNLNationaliteitOpCode(new RedenVerliesCode((short) 7));
    }
