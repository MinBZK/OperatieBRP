...
public abstract class AbstractVraagBerichtBindingUitIntegratieTest<T> extends AbstractBindingUitIntegratieTest<T> {
            ...
            final String bsn) throws ParseException
    {
        ...
        identificatieNummersGroep.setAdministratienummer(new ANummer(9876543210L));
        ...
        adr.setIndicatiePersoonNietAangetroffenOpAdres(JaNee.NEE);
        ...
        gegevens.setRedenVerkrijging(new RedenVerkrijgingNLNationaliteit(new RedenVerkrijgingCode((short) 1), null,
                                                                         null, null));
            ...
            final String regelCode, final String meldingOmschrijving, final String verwachtAntwoordBerichtBestandsNaam)
    {
        StringBuilder verwachteWaarde =
            new StringBuilder()
                    ...
                    .append(String
                            .format("<brp:%s xmlns:brp=\"http://www.bprbzk.nl/BRP/0100\" xmlns:stuf=\"http://www.kinggemeenten.nl/StUF/StUF0302\" xmlns:xsi=\"http://www.w3"
    ...
    private void bouwStuurgegevensElement(final StringBuilder stringBuilder) {
        stringBuilder.append("<brp:stuurgegevens>").append(bouwElement("stuf", "berichtcode", "Du02"))
                ...
                .append(bouwElement("stuf", "crossRefnummer", "OnbekendeID"))
                .append(bouwElement("stuf", "functie", "mijnFunctie"))
    ...
    protected PersoonModel bouwMinimaalPersoon() {
        Land nederland = new Land(new Landcode((short) 31), null, null, null, null);
        ...
        persoonIdentificatieNummersGroepBericht.setAdministratienummer(new ANummer(123456789L));
