...
public interface BijhoudingService {
     ...
     * @return Het resultaat van de bijhouding
     */
    HuwelijkAntwoordBericht registreerHuwelijkEnPartnerschap(
            HuwelijkBericht bericht);
     ...
     * @return Het resultaat van de bijhouding
     */
    RegistratieOverlijdenAntwoordBericht registreerOverlijden(RegistratieOverlijdenBericht bericht);
