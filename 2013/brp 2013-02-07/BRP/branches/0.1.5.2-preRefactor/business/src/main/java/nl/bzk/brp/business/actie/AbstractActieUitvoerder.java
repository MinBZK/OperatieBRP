...
public abstract class AbstractActieUitvoerder {
     ...
     */
    protected PersistentActie persisteerActie(final BRPActie brpActie, final BerichtContext berichtContext) {
        final PersistentActie actie = new PersistentActie();
        actie.setPartij(berichtContext.getPartij());
        actie.setSoort(brpActie.getSoort());
        //actie.setTijdstipOntlening();todo
        actie.setTijdstipRegistratie(berichtContext.getTijdstipVerwerking());
     ...
     */
    abstract List<Melding> bereidActieVerwerkingVoor(final BRPActie actie, final BerichtContext berichtContext);
}
