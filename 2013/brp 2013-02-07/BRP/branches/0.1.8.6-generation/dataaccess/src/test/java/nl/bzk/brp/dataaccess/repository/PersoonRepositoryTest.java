...
public class PersoonRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testHaalPersoonOpMetBurgerservicenummer() {
        ...
        Assert.assertEquals("0001", persoon.getNationaliteiten().iterator().next().getNationaliteit()
                .getNationaliteitcode().toString());
    ...
    public void testHaalPersonenMetAdresOpViaBurgerservicenummer() {
        List<PersoonModel> personen =
            persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(new Burgerservicenummer(""));
        Assert.assertTrue("personen zou leeg moeten zijn", personen.size() == 0);

        personen =
            persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(new Burgerservicenummer("123456789"));
        Assert.assertEquals(1, personen.size());

        // BSN met alleen post adres
        personen =
            persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(new Burgerservicenummer("100001002"));
    ...
    public void testHaalPersonenMetWoonAdresOpViaVolledigAdres() {
        ...
        List<PersoonModel> personen =
            persoonRepository.haalPersonenMetWoonAdresOpViaVolledigAdres(new NaamOpenbareRuimte("Damstraat"),
                    new Huisnummer(1), new Huisletter("a"), new Huisnummertoevoeging("II"), null, null, plaats);
        Assert.assertEquals(1, personen.size());
    ...
    public void testHaalPersonenMetWoonAdresOpViaVolledigAdresMetLegeStringsIpvNulls() {
        ...
        List<PersoonModel> personen =
            persoonRepository.haalPersonenMetWoonAdresOpViaVolledigAdres(new NaamOpenbareRuimte("Damstraat"),
                    ...
                    new LocatieOmschrijving(""), new AanduidingBijHuisnummer(""), plaats);
        Assert.assertEquals(1, personen.size());
        Assert.assertEquals(Integer.valueOf(1001), personen.get(0).getId());
    }
    ...
    public void testHaalPersonenOpMetAdresViaPostcodeHuisnummer() {
        List<PersoonModel> personen =
            persoonRepository.haalPersonenOpMetAdresViaPostcodeHuisnummer(new Postcode("1334NA"), new Huisnummer(73),
                    new Huisletter("A"), new Huisnummertoevoeging("sous"));
        Assert.assertEquals(1, personen.size());

        Assert.assertEquals(new Burgerservicenummer("123456789"), personen.get(0).getIdentificatienummers()
                .getBurgerservicenummer());

        personen =
            persoonRepository.haalPersonenOpMetAdresViaPostcodeHuisnummer(new Postcode("1000AA"), new Huisnummer(1),
                    null, null);
        Assert.assertEquals(1, personen.size());
        Assert.assertEquals(new Burgerservicenummer("234567891"), personen.get(0).getIdentificatienummers()
                .getBurgerservicenummer());
    ...
    public void testHaalPersonenOpMetAdresViaPostcodeHuisnummerMetLegeStringsIpvNulls() {
        ...
        personen =
            persoonRepository.haalPersonenOpMetAdresViaPostcodeHuisnummer(new Postcode("1000AA"), new Huisnummer(1),
                    new Huisletter(""), new Huisnummertoevoeging(""));
        Assert.assertEquals(1, personen.size());
        Assert.assertEquals(new Burgerservicenummer("234567891"), personen.get(0).getIdentificatienummers()
                .getBurgerservicenummer());
    }
    ...
    public void testOpslaanNieuwPersoon() {
        ActieModel actie = maakActie(SoortActie.INSCHRIJVING_GEBOORTE);
        Datum datumAanvangGeldigheid = new Datum(20101212);

        PersoonModel persoonOperationeel = maakNieuwPersoon();
        PersoonModel persoonNieuw =
            persoonRepository.opslaanNieuwPersoon(persoonOperationeel, actie, datumAanvangGeldigheid);
        ...
        PersoonModel persoon =
            (PersoonModel) em.createQuery(persoonsql).setParameter("burgerservicenummer", bsn).getSingleResult();
        ...
        Assert.assertEquals(new ANummer(Long.valueOf(1114567890L)), persoon.getIdentificatienummers().getANummer());
        ...
        Assert.assertEquals(Short.valueOf((short) 34), persoon.getGeboorte().getGemeenteGeboorte().getGemeentecode()
                .getWaarde());
        ...
        // Bijhoudinggemeente
        Assert.assertEquals(new Integer(20120101), persoon.getBijhoudingsgemeente().getDatumInschrijvingInGemeente()
                .getWaarde());
        Assert.assertEquals(Short.valueOf((short) 34), persoon.getBijhoudingsgemeente().getBijhoudingsgemeente()
        ...
        List<PersoonVoornaamHisModel> hisVoornamen =
            em.createQuery(hisPersoonvoornaam)
                    .setParameter("burgerservicenummer", new Burgerservicenummer("111456789")).getResultList();
        ...
        Assert.assertEquals(new Integer(20120101), hisPersoonBijhoudingsgemeente.getDatumInschrijvingInGemeente()
                .getWaarde());
        Assert.assertEquals(Short.valueOf((short) 34), hisPersoonBijhoudingsgemeente.getBijhoudingsgemeente()
                .getGemeentecode().getWaarde());
        Assert.assertEquals(JaNee.Nee, hisPersoonBijhoudingsgemeente.getIndOnverwerktDocumentAanwezig());
        Assert.assertEquals(new Integer(20101212), hisPersoonBijhoudingsgemeente.getDatumAanvangGeldigheid()
                .getWaarde());
        ...
        List<PersoonGeslachtsaanduidingHisModel> hisGeslachtsaanduidingen =
            em.createQuery(hisGeslachtsaand).setParameter("burgerservicenummer", new Burgerservicenummer("111456789"))
                    .getResultList();
        ...
        List<PersoonInschrijvingHisModel> hisPersoonInschrijvingen =
            em.createQuery(hisPersInschr).setParameter("burgerservicenummer", new Burgerservicenummer("111456789"))
                    .getResultList();
        ...
        Assert.assertEquals(new Integer(20101212), hisPersoonOpschortingen.get(0).getDatumAanvangGeldigheid()
                .getWaarde());
        ...
        List<PersoonAdresHisModel> hisPersoonAdressen =
            em.createQuery(hisPersoonAdres).setParameter("burgerservicenummer", new Burgerservicenummer("111456789"))
                    .getResultList();
        ...
        Assert.assertEquals(Verantwoordelijke.COLLEGE_VAN_BURGEMEESTER_EN_WETHOUDERS,
                hisPersoonBijhoudingsverantwoordelijkheden.get(0).getVerantwoordelijke());
        ...
        Assert.assertEquals(new Integer(20101212), hisPersoonIdentificatienummersResultaat.get(0)
                .getDatumAanvangGeldigheid().getWaarde());
        Assert.assertEquals(Long.valueOf(1114567890), hisPersoonIdentificatienummersResultaat.get(0).getANummer()
                .getWaarde());
        Assert.assertEquals("111456789", hisPersoonIdentificatienummersResultaat.get(0).getBurgerservicenummer()
                .getWaarde());
    ...
    public void testOpslaanNieuwPersoonSamenGesteldeNaamGroep() {
        ...
        PersoonSamengesteldeNaamGroepModel groep =
            new PersoonSamengesteldeNaamGroepModel(new PersoonSamengesteldeNaamGroepBasis() {
        ...
        PersoonModel persoon1 = persoonRepository.opslaanNieuwPersoon(persoon, actie, new Datum(20101212));
        ...
        PersoonModel ppersoon =
            (PersoonModel) em.createQuery(persoonsql)
                    .setParameter("burgerservicenummer", new Burgerservicenummer("111456789")).getSingleResult();

        Assert.assertEquals("B", ppersoon.getSamengesteldeNaam().getAdellijkeTitel().getAdellijkeTitelCode()
                .getWaarde());
        ...
        final String historieQuery =
            "SELECT sgn FROM PersoonSamengesteldeNaamHisModel sgn WHERE " + " sgn.persoon = :persoon";
    ...
    public void testPersoonOpslaanGeenPlaats() {
        ...
        PersoonModel persoon = maakNieuwPersoon();
        ReflectionTestUtils.setField(persoon.getIdentificatienummers(), "burgerservicenummer", new Burgerservicenummer(
                "222456789"));
        ReflectionTestUtils.setField(persoon.getGeboorte(), "woonplaatsGeboorte", null);

        Integer id = persoonRepository.opslaanNieuwPersoon(persoon, actie, new Datum(20101212)).getId();
        ...
        PersoonModel persoonCheck =
            (PersoonModel) em.createQuery(persoonsql)
                    .setParameter("burgerservicenummer", new Burgerservicenummer("222456789")).getSingleResult();
    ...
    public void testOpslaanNieuwPersoonAlBestaand() {
        final ActieModel actie = maakActie(SoortActie.INSCHRIJVING_GEBOORTE);
        PersoonModel persoon = maakNieuwPersoon();
        ReflectionTestUtils.setField(persoon.getIdentificatienummers(), "burgerservicenummer", new Burgerservicenummer(
                "123456789"));
        persoonRepository.opslaanNieuwPersoon(persoon, actie, new Datum(20101212));
    }
    ...
    public void testWerkbijBijhoudingsgemeente() {
        ...
        // Gemeente
        PersoonBijhoudingsgemeenteGroepModel bijhoudingsgemeente =
            new PersoonBijhoudingsgemeenteGroepModel(new PersoonBijhoudingsgemeenteGroepBasis() {
        ...
        persoonRepository.werkbijBijhoudingsgemeente(bsn, bijhoudingsgemeente, actie, new Datum(20120708));

        persoon = em.find(PersoonModel.class, 1);
        Assert.assertEquals("Amsterdan", persoon.getBijhoudingsgemeente().getBijhoudingsgemeente().getNaam()
                .getWaarde());
        Assert.assertEquals(new Integer(20120708), persoon.getBijhoudingsgemeente().getDatumInschrijvingInGemeente()
                .getWaarde());
        ...
        bijhoudingsgemeente = new PersoonBijhoudingsgemeenteGroepModel(new PersoonBijhoudingsgemeenteGroepBasis() {
        ...
        persoonRepository.werkbijBijhoudingsgemeente(bsn, bijhoudingsgemeente, actie2, new Datum(20120908));
    ...
    // , ((null != his.getIndAanschrijvingAlgorthmischAfgeleid()) ? his.getIndAanschrijvingAlgorthmischAfgeleid() :
    // null)
    ...
    public void testWerkbijAanschrijving() {
        ...
        TypedQuery<PersoonAanschrijvingHisModel> queryCLaag =
            em.createQuery(
                    "SELECT his from PersoonAanschrijvingHisModel his " + " WHERE his.persoon.id = :id "
                        + " AND his.historie.datumTijdVerval is NULL "
                        + " ORDER BY his.historie.datumAanvangGeldigheid ", PersoonAanschrijvingHisModel.class)
                    .setParameter("id", persoonMdl.getId());

        TypedQuery<PersoonAanschrijvingHisModel> queryDLaag =
            em.createQuery(
                    "SELECT his from PersoonAanschrijvingHisModel his " + " WHERE his.persoon.id = :id "
                        + " AND his.historie.datumTijdVerval is NOT NULL "
                        + " ORDER BY his.historie.datumTijdRegistratie ", PersoonAanschrijvingHisModel.class)
                    .setParameter("id", persoonMdl.getId());
        ...
        persoonRepository.werkbijNaamGebruik(
                persoonMdl,
                maakAanschrijvingGroep("B", WijzeGebruikGeslachtsnaam.PARTNER, JaNee.Nee, JaNee.Nee, "Jan Jans",
                        "in het", null, "Peterson"), actie, aanvangGeldigheid);
        ...
        Assert.assertEquals(aanvangGeldigheid, aanHisListCLaagNew.get(aanHisListCLaag.size() - 1)
                .getDatumEindeGeldigheid());
        Assert.assertEquals(aanvangGeldigheid, aanHisListCLaagNew.get(aanHisListCLaagNew.size() - 1)
     ...
     * @return .
     */
    private PersoonAanschrijvingGroepModel maakAanschrijvingGroep(final String adellijkeTitelCode,
            final WijzeGebruikGeslachtsnaam gebruik, final JaNee indMetAdellijkeTitel, final JaNee indAlgorithm,
            final String voornamen, final String voorVoegsel, final String scheidingsTeken, final String naam)
    {
        ...
        if (adellijkeTitelCode != null) {
            aanB.setAdellijkeTitel(referentieDataRepository.vindAdellijkeTitelOpCode(new AdellijkeTitelCode(
                    adellijkeTitelCode)));
        }
        if (gebruik != null) {
    ...
    private PersoonModel maakNieuwPersoon() {
        ...
        PersoonModel persoon = new PersoonModel(new PersoonBasis() {
            ...
            public PersoonIdentificatienummersGroep getIdentificatienummers() {
                @SuppressWarnings("serial")
                PersoonIdentificatienummersGroep idnrs =
                    new PersoonIdentificatienummersGroepModel(new PersoonIdentificatienummersGroepBasis() {
            ...
            public PersoonGeslachtsaanduidingGroep getGeslachtsaanduiding() {
                return new PersoonGeslachtsaanduidingGroepModel(new PersoonGeslachtsaanduidingGroepBasis() {
        ...
        persoon.getGeslachtsnaamcomponenten().add(
                maakNieuwGeslachtsnaamcomponent(persoon, 1, "geslachtsnaamcomp1", "voorvoeg1", "B", "H", ","));
        persoon.getGeslachtsnaamcomponenten().add(
                maakNieuwGeslachtsnaamcomponent(persoon, 2, "geslachtsnaamcomp2", "voorvoeg2", "G", "J", ";"));
    ...
    private PersoonGeslachtsnaamcomponentModel maakNieuwGeslachtsnaamcomponent(final PersoonModel persoon,
            final Integer volgnummer, final String naam, final String voorvoegsel, final String adellijkeTitelCode,
            final String predikaatCode, final String scheidingsteken)
    {
        return new PersoonGeslachtsnaamcomponentModel(new PersoonGeslachtsnaamcomponentBasis() {
            ...
            public PersoonGeslachtsnaamcomponentStandaardGroep getGegevens() {
                return new PersoonGeslachtsnaamcomponentStandaardGroep() {
                    ...
                    @Override
                    public AdellijkeTitel getAdellijkeTitel() {
                        return referentieDataRepository.vindAdellijkeTitelOpCode(new AdellijkeTitelCode(
                                adellijkeTitelCode));
                    }
                };
            }
    ...
    private PersoonAdresModel maakNieuwAdres(final PersoonModel persoon, final FunctieAdres functieAdres,
            final String postcode, final Integer huisnummer)
    {
    ...
    private PersoonVoornaam haalopVoornaam(final String voornaam, final Set<PersoonVoornaamModel> voornamen) {
    ...
    private ActieModel maakActie(final SoortActie soortActie) {
        ...
        ActieModel actie = new ActieModel(new ActieBasis() {
            ...
            public DatumTijd getTijdstipRegistratie() {
                return new DatumTijd(new Timestamp(new Date(System.currentTimeMillis() - 1).getTime()));
            }
