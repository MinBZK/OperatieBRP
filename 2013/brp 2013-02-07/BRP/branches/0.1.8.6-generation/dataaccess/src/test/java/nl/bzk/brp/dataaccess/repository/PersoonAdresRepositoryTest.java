...
public class PersoonAdresRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanNieuwPersoonAdres() {
        ...
        Assert.assertEquals("1753", nieuwHisAdres.getAanduidingAdresseerbaarObject().getWaarde());
    ...
    public void testTerugwerkendeKrachtCorrectie() {
        ...
        Assert.assertEquals("1492", huidigAdres.getGegevens().getAanduidingAdresseerbaarObject().getWaarde());
    ...
    private PersoonAdresModel creerTestAdres() {
        ...
        paGegevens.setAanduidingAdresseerbaarObject(new AanduidingAdresseerbaarObject("1492"));
    ...
    private PersoonAdresModel maakNieuwAdres2(final PersoonModel persoon) {
        ...
        paGegevens.setAanduidingAdresseerbaarObject(new AanduidingAdresseerbaarObject("1753"));
    ...
    private void controleerHuidigAdresInALaag(final PersoonAdresModel huidigAdres) {
        ...
        Assert.assertEquals("1753", huidigAdres.getGegevens().getAanduidingAdresseerbaarObject().getWaarde());
    ...
    private PersoonAdresModel maakNieuwAdres() {
        ...
        gegevens.setAanduidingAdresseerbaarObject(new AanduidingAdresseerbaarObject("1753"));
    ...
    public void haalPersoonAdresOp() {
        ...
        Assert.assertEquals("1492", pa.getGegevens().getAanduidingAdresseerbaarObject().getWaarde());
    ...
    public void slaPersoonAdresOp() {
        ...
        paGegevens.setAanduidingAdresseerbaarObject(new AanduidingAdresseerbaarObject("AdreerbaarObject x"));
        ...
        Assert.assertEquals("Hoofd instelling", pa.getGegevens().getAangeverAdresHouding().getNaam());
        Assert.assertEquals("AdreerbaarObject x", pa.getGegevens().getAanduidingAdresseerbaarObject().getWaarde());
