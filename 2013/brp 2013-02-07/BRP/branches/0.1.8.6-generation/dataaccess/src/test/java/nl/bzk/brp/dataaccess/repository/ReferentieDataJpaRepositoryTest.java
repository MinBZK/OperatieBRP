...
public class ReferentieDataJpaRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testVindWoonplaatsOpCode() {
        Plaats woonplaats = referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode((short) 34));
    ...
    public void testVindNietBestaandeWoonplaatsOpCode() {
        referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode((short) 0));
    }
    ...
    public void testVindRedenVerkregenNlNationaliteitOpCode() {
        RedenVerkrijgingNLNationaliteit redenVerkrijging =
            referentieDataRepository.vindRedenVerkregenNlNationaliteitOpCode(new RedenVerkrijgingCode((short) 1));
        Assert.assertNotNull(redenVerkrijging);
        Assert.assertEquals("Bij geboorte", redenVerkrijging.getOmschrijving().getWaarde());
    }
...
//    }
    ...
    //@GEN was X, even dummy 99 neergezet
    @Test(expected = OnbekendeReferentieExceptie.class)
    public void testVindNietBestaandeRedenVerliesNlNationaliteitOpCode() {
        referentieDataRepository.vindRedenVerliesNLNationaliteitOpCode(new RedenVerliesCode((short)99));
    }
