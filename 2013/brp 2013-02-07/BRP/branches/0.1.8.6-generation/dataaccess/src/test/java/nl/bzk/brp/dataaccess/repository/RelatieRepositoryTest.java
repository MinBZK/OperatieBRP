...
public class RelatieRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanNieuweRelatie() {
        ...
        ActieModel actie = bouwActie(SoortActie.REGISTRATIE_HUWELIJK, aanvangGeldigheid, tijdstipRegistratie);
    ...
    public void testOpslaanRelatie() {
        ...
        ActieModel actie = bouwActie(SoortActie.INSCHRIJVING_GEBOORTE, aanvangGeldigheid, tijdstipRegistratie);
