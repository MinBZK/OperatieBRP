...
public abstract class AbstractVraagBerichtBindingUitIntegratieTest<T> extends AbstractBindingUitIntegratieTest<T> {
        ...
        final String bsn) throws ParseException
    {
        ...
        identificatieNummersGroep.setAdministratienummer(new ANummer(Long.valueOf(987654321L)));
        ...
        persoonGeboorteGroep.setOmschrijvingGeboorteLocatie(new OmschrijvingEnumeratiewaarde("omschrijving"));
        ...
        opschorting.setRedenOpschorting(RedenOpschorting.MINISTERIEEL_BESLUIT);
        ...
        adr.setAanduidingAdresseerbaarObject(new AanduidingAdresseerbaarObject("acd"));
        ...
        adr.setLocatietovAdres(new AanduidingBijHuisnummer("TO"));
        ...
        nation.setNaam(new NaamEnumeratiewaarde("abcd"));
        ...
        ParseException
    {
        ...
        gegevens.setOmschrijvingLocatieAanvang(new OmschrijvingEnumeratiewaarde("Timboektoe"));
        gegevens.setOmschrijvingLocatieEinde(new OmschrijvingEnumeratiewaarde("blakalafm"));
    ...
    protected PersoonModel bouwMinimaalPersoon() {
        ...
        PersoonBijhoudingsverantwoordelijkheidGroepBericht bijhoudingsVerantwoordelijke =
            new PersoonBijhoudingsverantwoordelijkheidGroepBericht();
        bijhoudingsVerantwoordelijke.setVerantwoordelijke(Verantwoordelijke.COLLEGE_VAN_BURGEMEESTER_EN_WETHOUDERS);
