    ...
    extends AbstractBindingInIntegratieTest<InschrijvingGeboorteBericht>
{
    ...
    public void testBindingMaxBericht() throws JiBXException, IOException {
        ...
        checkActies(bericht, 20120101, SoortActie.INSCHRIJVING_GEBOORTE, SoortActie.REGISTRATIE_NATIONALITEIT);
    ...
    public void testBindingMinBericht() throws IOException, JiBXException {
        ...
        checkActies(bericht, 1012012, SoortActie.INSCHRIJVING_GEBOORTE, SoortActie.REGISTRATIE_NATIONALITEIT);
    ...
    public void testBindingBerichtMinNilInWaarde() throws IOException, JiBXException {
        ...
        PersoonBericht kind = getKindUitGeboorteActie(bericht);
        Assert.assertNull(kind.getIdentificatienummers().getANummer());
            ...
            final SoortActie... actieSoorten)
    {
        ...
        for (int i = 0; i < actieSoorten.length; i++) {
            ...
            if (SoortActie.INSCHRIJVING_GEBOORTE == actieSoorten[i]) {
    ...
    private RelatieBericht getRelatieUitGeboorteActie(final AbstractBijhoudingsBericht bericht) {
        ...
        Assert.assertEquals(SoortActie.INSCHRIJVING_GEBOORTE, geboortActie.getSoort());
    ...
    private PersoonBericht getKindUitGeboorteActie(final AbstractBijhoudingsBericht bericht) {
        ...
        Assert.assertEquals(SoortActie.INSCHRIJVING_GEBOORTE, actie.getSoort());
        ...
        final Geslachtsaanduiding geslachtsaanduiding)
    {
        ...
        Assert.assertEquals(aNummer, kind.getIdentificatienummers().getANummer().getWaarde());
    ...
    private void checkAlleVerzendedIds(final AbstractBijhoudingsBericht bericht) {
        ...
        for (Actie actie : bericht.getBrpActies()) {
            ...
            if (actie.getSoort() == SoortActie.INSCHRIJVING_GEBOORTE) {
