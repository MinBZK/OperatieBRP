 ...
 *
 */
public class VraagPersonenOpAdresInclusiefBetrokkenhedenAntwoord extends BevragingAntwoordBericht {
     ...
     *            gebouwd.
     */
    public VraagPersonenOpAdresInclusiefBetrokkenhedenAntwoord(final OpvragenPersoonResultaat berichtResultaat) {
