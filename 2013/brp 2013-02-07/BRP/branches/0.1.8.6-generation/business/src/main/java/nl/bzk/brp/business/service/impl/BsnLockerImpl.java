...
public class BsnLockerImpl implements BsnLocker {
     ...
     */
    @Override
    public void getLocks(final Collection<Integer> readBsnLocks, final Collection<Integer> writeBsnLocks,
     ...
     *             van de lock(s).
     */
    private void creeerConnectieVoorTransactieEnPlaatsLock(final Collection<Integer> readBsnLocks,
        final Collection<Integer> writeBsnLocks, final Long berichtId) throws SQLException
    {
        /*
