...
public abstract class AbstractVraag extends AbstractIdentificerendeGroep {
    ...
    private VraagOpties  vraagOpties;

    public VraagOpties getVraagOpties() {
        return vraagOpties;
    }

    public void setVraagOpties(final VraagOpties vraagOpties) {
     ...
     */
    public abstract Integer getBurgerservicenummerForLocks();
