...
public class BijhoudingsgemeenteAfleidingTest {
    ...
    public void testGeenAdresGevendeOuder() {
        ...
        Assert.assertTrue(bijhoudingsgemeenteAfleiding.executeer(null, familie, null, null).size() == 0);
    }
    ...
    public void testAdresGevendeMoederZonderIdentificatieNummers() {
        ...
        List<Melding> meldingen = bijhoudingsgemeenteAfleiding.executeer(null, familie, null, null);
