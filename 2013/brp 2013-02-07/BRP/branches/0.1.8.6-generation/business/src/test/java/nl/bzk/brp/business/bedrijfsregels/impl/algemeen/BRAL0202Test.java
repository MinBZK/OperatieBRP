...
public class BRAL0202Test {
    ...
    public void test2VerschillendePersonenInHuwelijk() {
        ...
        List<Melding> meldingen = bral0202.executeer(null, huwelijk, null, null);
    ...
    public void test1Persoon2MaalInHuwelijk() {
        RelatieBericht huwelijk = new RelatieBuilder().bouwHuwlijkRelatie().
                voegPartnerToe(PersoonBuilder.bouwPersoon("man", null, 19840404, null, null, null, null)).
                voegPartnerToe(PersoonBuilder.bouwPersoon("man", null, 19850404, null, null, null, null)).
                setDatumAanvang(20010404).
                getRelatie();
    ...
    public void testFamilieRechtelijkeBetrekking() {
        RelatieBericht familie = new RelatieBuilder().bouwFamilieRechtelijkeBetrekkingRelatie().
                voegOuderToe(PersoonBuilder.bouwPersoon("papa", null, 19840404, null, null, null, null)).
                voegOuderToe(PersoonBuilder.bouwPersoon("mama", null, 19850404, null, null, null, null)).
                voegKindToe(PersoonBuilder.bouwPersoon("kind", null, 19850404, null, null, null, null)).
                getRelatie();

        List<Melding> meldingen = bral0202.executeer(null, familie, null, null);
        Assert.assertTrue(meldingen.isEmpty());
    }
    ...
    public void test1Persoon2MaalInFamilieRechtelijkeBetrekking() {
        RelatieBericht familie = new RelatieBuilder().bouwFamilieRechtelijkeBetrekkingRelatie().
                voegOuderToe(PersoonBuilder.bouwPersoon("papa", null, 19840404, null, null, null, null)).
                voegOuderToe(PersoonBuilder.bouwPersoon("mama", null, 19850404, null, null, null, null)).
                voegKindToe(PersoonBuilder.bouwPersoon("papa", null, 19850404, null, null, null, null)).
                getRelatie();
