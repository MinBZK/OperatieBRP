...
public class BRAL9003Test {
    ...
    public void testHuidigeSituatieGeenOpschorting() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20150101), null);
    ...
    public void testHuidigeSituatieLeeg() {
        List<Melding> meldingen = bral9003.executeer(null, null, new Datum(20150101), null);
    ...
    public void testHuidigeSituatieWelOpschortingMaarGeenOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon0, nieuweSituatie, new Datum(20150101), null);
    ...
    public void testWijzigingDatumVoorOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120504), null);
    ...
    public void testWijzigingDatumOpOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120505), null);
    ...
    public void testWijzigingDatumNaOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120506), null);
