...
public class RelatieBerichtBindingTest extends AbstractBindingInTest<RelatieBericht> {
    ...
    public void testFamilieRechtelijkeBetrekking() throws JiBXException {
        final String xml =
            "<ns:Objecttype_Relatie xmlns:ns=\"" + NAMESPACE_BRP + "\">" + "\t\t\t\t<ns:betrokkenheden>\n"
    ...
    public void testHuwelijk() throws JiBXException {
        final String xml =
            "<ns:Objecttype_Relatie xmlns:ns=\"" + NAMESPACE_BRP + "\">"
        ...
        Assert.assertEquals(new Woonplaatscode((short) 1000), standaardGroep.getWoonPlaatsAanvangCode());
        Assert.assertEquals(new Woonplaatscode((short) 1000), standaardGroep.getWoonPlaatsEindeCode());
