...
public class PersoonAdresBindingTest extends AbstractBindingUitTest<PersoonAdresModel> {
    ...
    public void testBindingOut() throws JiBXException {
        ...
        gegevens.setAanduidingAdresseerbaarObject(new AanduidingAdresseerbaarObject("Blokhut"));
        ...
        woonplaats.setCode(new Woonplaatscode((short) 555));
        gegevens.setWoonplaats(woonplaats);
        gegevens.setLocatietovAdres(new AanduidingBijHuisnummer("In het midden"));
