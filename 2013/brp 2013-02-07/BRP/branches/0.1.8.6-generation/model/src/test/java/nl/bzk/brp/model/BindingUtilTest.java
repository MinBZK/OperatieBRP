...
public class BindingUtilTest {
    ...
    public void testDatumTijdNaarDate() throws ParseException {
        ...
        Assert.assertEquals(0, maakDatum("2012/01/02 03:04:05:000").compareTo(
                BindingUtil.datumTijdNaarDate("2012010203040500")));
        Assert.assertEquals(0, new SimpleDateFormat("yyyy/MM/dd HH:mm:ss:S").parse("2012/11/22 13:24:35:100")
                .compareTo(BindingUtil.datumTijdNaarDate("2012112213243510")));
    }
