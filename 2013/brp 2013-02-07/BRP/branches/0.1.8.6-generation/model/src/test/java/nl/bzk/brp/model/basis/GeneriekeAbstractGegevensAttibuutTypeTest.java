...
public class GeneriekeAbstractGegevensAttibuutTypeTest {
    ...
    public void testEqualsWaardeNotNull() {
        ...
        Assert.assertFalse("Ander gegevens attribuuttype: Zou ongelijk moeten zijn", gemeentedeel.equals(new Postcode(
                "12")));
    ...
    public void testEqualsMetSoortNull() {
        ...
        Assert.assertFalse("exacte waarde: Zou ongelijk moeten zijn vanwege ontbrekende soortnull", gemeentedeel
                .equals(new Gemeentedeel("12")));
        Assert.assertFalse("exacte waarde: Zou ongelijk moeten zijn vanwege andere soortnull", gemeentedeel
                .equals(new Gemeentedeel("12", false, SoortNull.NIET_ONDERSTEUND)));
        Assert.assertTrue("exacte waarde: Zou gelijk moeten zijn vanwege gelijke soortnull", gemeentedeel
                .equals(new Gemeentedeel("12", false, SoortNull.NIET_GEAUTORISEERD)));
    }
    ...
    public void testEqualsMetInOnderzoek() {
        ...
        Assert.assertFalse("exacte waarde: Zou ongelijk moeten zijn vanwege andere inonderzoek", gemeentedeel
                .equals(new Gemeentedeel("12")));
        Assert.assertFalse("exacte waarde: Zou ongelijk moeten zijn vanwege andere inonderzoek", gemeentedeel
                .equals(new Gemeentedeel("12", false, SoortNull.NIET_GEAUTORISEERD)));
        Assert.assertTrue("exacte waarde: Zou gelijk moeten zijn vanwege gelijke inonderzoek", gemeentedeel
                .equals(new Gemeentedeel("12", true, SoortNull.NIET_GEAUTORISEERD)));
    }
}
