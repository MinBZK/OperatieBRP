...
/**
 * BuitenlandseRegioBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class BuitenlandseRegioBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private BuitenlandseRegioBasis() {
        super(null);
    }
     ...
     */
    public BuitenlandseRegioBasis(final String waarde) {
        super(waarde);
    }
}
