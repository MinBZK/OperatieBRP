...
/**
 * OntleningstoelichtingBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class OntleningstoelichtingBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private OntleningstoelichtingBasis() {
        super(null);
    }
     ...
     */
    public OntleningstoelichtingBasis(final String waarde) {
        super(waarde);
    }
}
