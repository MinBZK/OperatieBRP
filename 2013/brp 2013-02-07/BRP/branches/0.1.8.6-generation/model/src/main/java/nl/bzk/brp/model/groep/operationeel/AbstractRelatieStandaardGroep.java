...
public abstract class AbstractRelatieStandaardGroep extends AbstractGroep implements RelatieStandaardGroepBasis {
    ...
    protected void setOmschrijvingLocatieAanvang(final OmschrijvingEnumeratiewaarde omschrijvingLocatieAanvang) {
        this.omschrijvingLocatieAanvang = omschrijvingLocatieAanvang;
    }

    protected void setOmschrijvingLocatieEinde(final OmschrijvingEnumeratiewaarde omschrijvingLocatieEinde) {
