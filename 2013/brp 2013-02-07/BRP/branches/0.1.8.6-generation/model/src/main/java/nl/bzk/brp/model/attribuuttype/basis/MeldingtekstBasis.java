 ...
 */
@Embeddable
public abstract class MeldingtekstBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private MeldingtekstBasis() {
        super(null);
    }
     ...
     */
    public MeldingtekstBasis(final String waarde) {
        super(waarde);
    }
}
