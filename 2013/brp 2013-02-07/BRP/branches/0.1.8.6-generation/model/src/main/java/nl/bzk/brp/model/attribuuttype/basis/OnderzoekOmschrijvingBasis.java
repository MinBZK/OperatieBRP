...
/**
 * OnderzoekOmschrijvingBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class OnderzoekOmschrijvingBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private OnderzoekOmschrijvingBasis() {
        super(null);
    }
     ...
     */
    public OnderzoekOmschrijvingBasis(final String waarde) {
        super(waarde);
    }
}
