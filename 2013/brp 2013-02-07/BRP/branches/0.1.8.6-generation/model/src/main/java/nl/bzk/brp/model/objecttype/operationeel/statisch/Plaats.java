...
public class Plaats extends AbstractStatischObjectType {
    ...
    @Embedded
    @AttributeOverride(name = "waarde", column = @Column(name = "NaamEnumeratiewaarde"))
    ...
    public void setNaam(NaamEnumeratiewaarde naamEnumeratiewaarde) {
        this.naam = naamEnumeratiewaarde;
    }
}
