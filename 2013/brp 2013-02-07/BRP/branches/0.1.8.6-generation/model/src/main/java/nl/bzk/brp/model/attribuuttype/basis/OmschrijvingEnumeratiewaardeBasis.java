...
/**
 * OmschrijvingEnumeratiewaardeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class OmschrijvingEnumeratiewaardeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private OmschrijvingEnumeratiewaardeBasis() {
        super(null);
    }
     ...
     */
    public OmschrijvingEnumeratiewaardeBasis(final String waarde) {
        super(waarde);
    }
}
