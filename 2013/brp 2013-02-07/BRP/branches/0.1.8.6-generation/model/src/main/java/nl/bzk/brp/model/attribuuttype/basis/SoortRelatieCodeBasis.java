...
/**
 * SoortRelatieCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class SoortRelatieCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SoortRelatieCodeBasis() {
        super(null);
    }
     ...
     */
    public SoortRelatieCodeBasis(final String waarde) {
        super(waarde);
    }
}
