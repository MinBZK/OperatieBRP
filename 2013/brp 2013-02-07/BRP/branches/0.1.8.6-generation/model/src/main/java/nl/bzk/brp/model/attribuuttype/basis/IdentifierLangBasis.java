 ...
 */
@Embeddable
public abstract class IdentifierLangBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private IdentifierLangBasis() {
        super(null);
    }
     ...
     */
    public IdentifierLangBasis(final String waarde) {
        super(waarde);
    }
}
