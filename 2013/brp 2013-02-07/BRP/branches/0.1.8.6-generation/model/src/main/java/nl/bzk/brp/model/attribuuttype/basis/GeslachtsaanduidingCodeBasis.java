...
/**
 * GeslachtsaanduidingCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class GeslachtsaanduidingCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private GeslachtsaanduidingCodeBasis() {
        super(null);
    }
     ...
     */
    public GeslachtsaanduidingCodeBasis(final String waarde) {
        super(waarde);
    }
}
