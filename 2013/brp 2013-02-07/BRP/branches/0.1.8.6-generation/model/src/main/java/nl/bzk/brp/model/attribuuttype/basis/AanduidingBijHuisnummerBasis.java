...
/**
 * AanduidingBijHuisnummerBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class AanduidingBijHuisnummerBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private AanduidingBijHuisnummerBasis() {
        super(null);
    }
     ...
     */
    public AanduidingBijHuisnummerBasis(final String waarde) {
        super(waarde);
    }
}
