...
/**
 * RedenVerliesCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class RedenVerliesCodeBasis extends AbstractStatischAttribuutType<Short> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RedenVerliesCodeBasis() {
        super(null);
    }
     ...
     */
    public RedenVerliesCodeBasis(final Short waarde) {
        super(waarde);
    }
}
