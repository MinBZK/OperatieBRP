...
/**
 * BurgerservicenummerBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class BurgerservicenummerBasis extends AbstractStatischAttribuutType<Integer> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private BurgerservicenummerBasis() {
        super(null);
    }
     ...
     */
    public BurgerservicenummerBasis(final Integer waarde) {
        super(waarde);
    }
}
