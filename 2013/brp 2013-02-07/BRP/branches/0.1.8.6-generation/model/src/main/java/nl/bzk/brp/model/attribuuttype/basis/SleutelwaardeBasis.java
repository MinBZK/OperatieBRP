 ...
 */
@Embeddable
public abstract class SleutelwaardeBasis extends AbstractStatischAttribuutType<Long> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SleutelwaardeBasis() {
        super(null);
    }
     ...
     */
    public SleutelwaardeBasis(final Long waarde) {
        super(waarde);
    }
}
