...
/**
 * AdellijkeTitelCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class AdellijkeTitelCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private AdellijkeTitelCodeBasis() {
        super(null);
    }
     ...
     */
    public AdellijkeTitelCodeBasis(final String waarde) {
        super(waarde);
    }
}
