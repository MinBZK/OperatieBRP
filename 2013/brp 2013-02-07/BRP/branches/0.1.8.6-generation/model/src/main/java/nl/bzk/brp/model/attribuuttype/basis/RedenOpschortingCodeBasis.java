...
/**
 * RedenOpschortingCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class RedenOpschortingCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RedenOpschortingCodeBasis() {
        super(null);
    }
     ...
     */
    public RedenOpschortingCodeBasis(final String waarde) {
        super(waarde);
    }
}
