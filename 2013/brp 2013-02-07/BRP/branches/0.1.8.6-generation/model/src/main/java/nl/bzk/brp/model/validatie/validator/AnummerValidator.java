 ...
 */
public class AnummerValidator implements ConstraintValidator<Anummer, nl.bzk.brp.model.attribuuttype.ANummer> {
    ...
    @Override
    public boolean isValid(final ANummer aNummer, final ConstraintValidatorContext context) {
        boolean resultaat;
     ...
     */
    private boolean isGeldigeAnummer(final ANummer aNummer) {
        boolean resultaat;
