...
/**
 * OrganisatienaamBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class OrganisatienaamBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private OrganisatienaamBasis() {
        super(null);
    }
     ...
     */
    public OrganisatienaamBasis(final String waarde) {
        super(waarde);
    }
}
