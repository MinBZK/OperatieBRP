...
/**
 * RedenBeeindigingRelatieCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class RedenBeeindigingRelatieCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RedenBeeindigingRelatieCodeBasis() {
        super(null);
    }
     ...
     */
    public RedenBeeindigingRelatieCodeBasis(final String waarde) {
        super(waarde);
    }
}
