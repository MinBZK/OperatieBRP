...
/**
 * ProtocolleringsniveauCodeBasis.
 * @version 1.0.18.
 */
@Embeddable
public abstract class ProtocolleringsniveauCodeBasis extends AbstractStatischAttribuutType<Short> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private ProtocolleringsniveauCodeBasis() {
        super(null);
    }
     ...
     */
    public ProtocolleringsniveauCodeBasis(final Short waarde) {
        super(waarde);
    }
}
