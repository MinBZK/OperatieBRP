...
/**
 * <p>
 * Specifieke marshaller/unmarshaller voor de {@link PersoonIndicatie} instanties in de
 * {@link PersoonModel} class. Deze mapper class verzorgd zowel de JiBX marshalling als
 * unmarshalling van de {@link PersoonIndicatie} van en naar XML. Hierbij wordt bij de
...
public class PersoonIndicatieMapper implements IMarshaller, IUnmarshaller, IAliasable {
    ...
    private static final Logger                      LOGGER                         =
                                                                                        LoggerFactory
                                                                                                .getLogger(PersoonIndicatieMapper.class);
    ...
    public void marshal(final Object obj, final IMarshallingContext marshallingContext) throws JiBXException {
        ...
        if (!(obj instanceof PersoonIndicatieModel)) {
            LOGGER.error(String
                    .format("Onverwacht (en niet ondersteund) type voor JiBX Marshaller: %s", obj.getClass()));
            ...
            context.startTagAttributes(namespaceIndex, bepaalIndicatieElementNaam(indicatie.getGegevens().getSoort()));
            ...
            context.closeStartContent();
            context.content(indicatie.getGegevens().getWaarde().getXmlCode());
            context.endTag(namespaceIndex, STANDAARD_WAARDE_ELEMENT_NAAM);

            // sluit het element
            context.endTag(namespaceIndex, bepaalIndicatieElementNaam(indicatie.getGegevens().getSoort()));
        }
    }
    ...
    public Object unmarshal(final Object obj, final IUnmarshallingContext unmarshallingContext) throws JiBXException {
        ...
        PersoonIndicatieModel persoonIndicatie = (PersoonIndicatieModel) obj;
        ...
        persoonIndicatie.setGegevens(new PersoonIndicatieStandaardGroepModel(gegevens));
    ...
    /**
     * Retourneert de {@link nl.bzk.brp.model.objecttype.operationeel.statisch.SoortIndicatie} op basis van de opgegeven indicatie naam. Indien de naam onbekend is, zal
