...
import nl.bzk.brp.model.objecttype.bericht.basis.AbstractPersoonVoornaamBericht;
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof PersoonVoornaamBericht)) {
            ...
            if (this == obj) {
                ...
                resultaat =
                    new EqualsBuilder().append(getPersoon(), pv.getPersoon()).append(getVolgnummer(),
                            pv.getVolgnummer()).isEquals();
            }
        }
        return resultaat;
    }
