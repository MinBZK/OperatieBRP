...
public final class BindingUtil {
    ...
    public static ActieBericht newInschrijvingGeboorteActie() {
        return newActieVanSoort(SoortActie.INSCHRIJVING_GEBOORTE);
    }
    ...
    public static ActieBericht newRegistratieNationaliteitActie() {
        //TODO TEMPORARY REMOVED SINCE IT IS MISSING IN GENERATED CODE!
        //return newActieVanSoort(SoortActie.REGISTRATIE_NATIONALITEIT);
        return newActieVanSoort(SoortActie.DUMMY);
    }
    ...
    public static ActieBericht newCorrectieAdresNLActie() {
        return newActieVanSoort(SoortActie.CORRECTIE_ADRES_BINNEN_NL);
    }
    ...
    public static ActieBericht newHuwelijkActie() {
        return newActieVanSoort(SoortActie.REGISTRATIE_HUWELIJK);
    }
