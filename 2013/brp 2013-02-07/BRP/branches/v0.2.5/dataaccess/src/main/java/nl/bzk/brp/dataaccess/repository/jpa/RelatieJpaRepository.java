...
public class RelatieJpaRepository implements RelatieRepository {
    ...
    public void opslaanVeranderdeRelatieStandaardGegevens(final RelatieModel relatieModel,
            final RelatieStandaardGroepModel relatieStandaardGroepModel, final ActieModel actie)
    {
        relatieModel.vervangGroepen(relatieStandaardGroepModel);
    ...
    @Override
    public List<BetrokkenheidModel> haalOpBetrokkenhedenVanPersoon(final PersoonModel persoon, RelatieSelectieFilter filter) {
        List<NameValue> parameters = new ArrayList<NameValue>();
            ...
            final RelatieSelectieFilter filter, final List<RelatieModel> relaties)
    {
        ...
        List<BetrokkenheidModel> gefilterdeBetrokkenheden = filterRelatiesEnExtraheerBetrokkenheden(persoonId, filter, relaties);
