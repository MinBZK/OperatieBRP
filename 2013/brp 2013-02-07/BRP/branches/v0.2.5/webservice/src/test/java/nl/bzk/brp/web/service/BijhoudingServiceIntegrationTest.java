...
//        Assert.assertEquals("A", persoonenNaamWijzigingVrouw.get(0).get("aanschrstatushis"));
    ...
    public void testRegistreerOverlijden() throws Exception {
        ...
        printAlsResponseHeeftFoutCode(document);
        Assert.assertTrue("Overlijden root node bestaat niet",
            XmlUtils.isNodeAanwezig("//overlijden_RegistratieOverlijden_BijhoudingResponse", document));
        Assert.assertTrue("resultaat bestaat niet", XmlUtils.isNodeAanwezig("//resultaat", document));
        Assert.assertEquals(Verwerkingsresultaat.GOED.getCode(),
            XmlUtils.getNodeWaarde("//resultaat/verwerkingCode", document));
        ...
        Document orgAanvraag =
            XmlUtils
                .bouwDocumentVanBestand(getInputStream("registratieOverlijden.xml"));
        String bsnMan =
            XmlUtils.getNodeWaarde("//persoon/identificatienummers/burgerservicenummer", orgAanvraag);
        ...
        Assert.assertEquals(20120101, res.get("datoverlijden"));
        ...
        Assert.assertEquals(20120101, res.get("dataanvgel"));
