        ...
        extends AbstractBindingInIntegratieTest<HuwelijkEnGeregistreerdPartnerschapBericht>
{
    ...
    public void testBindingMaxBericht() throws IOException, JiBXException {
        ...
        BerichtStuurgegevensGroepBericht berichtStuurgegevens =
                (BerichtStuurgegevensGroepBericht) bericht.getBerichtStuurgegevensGroep();
        ...
        Assert.assertEquals(Ja.Ja, berichtStuurgegevens.getIndPrevalidatie());
        ...
        Assert.assertEquals(SoortActie.HUWELIJK, huwelijksActie.getSoort());
        ...
        Assert.assertEquals(new PlaatsCode((short) 243), standaardGroep.getWoonPlaatsAanvangCode());
        ...
        Assert.assertEquals(new Burgerservicenummer("123456789"), partner1.getIdentificatienummers().getBurgerservicenummer());
        ...
        Assert.assertEquals(new PlaatsCode((short) 243), partner1.getGeboorte().getWoonplaatsGeboorteCode());
        ...
        Assert.assertEquals(new Omschrijving("string"), partner1.getGeboorte().getOmschrijvingGeboorteLocatie());
        ...
        Assert.assertEquals(new PlaatsCode((short) 243), partner2.getGeboorte().getWoonplaatsGeboorteCode());
        ...
        Assert.assertEquals(new Omschrijving("string"), partner2.getGeboorte().getOmschrijvingGeboorteLocatie());
