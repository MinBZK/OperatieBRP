...
public class BindingUtilTest {
    ...
    public void testDatumTijdNaarDate() throws ParseException {
        ...
        Assert.assertEquals(0, new SimpleDateFormat("yyyy/MM/dd HH:mm:ss:S").parse("2012/11/22 13:24:35:10").compareTo(BindingUtil.datumTijdNaarDate("2012112213243510")));
        Assert.assertEquals(0, maakDatum("2012/01/02 00:00:00:000").compareTo(BindingUtil.datumTijdNaarDate("20120102")));
    }
