...
// voorlopig NIET Onderzoekbaar
public abstract class AbstractDocumentStandaardGroepModel extends AbstractDocumentStandaardGroep
{
    /**
     * .
     */
     ...
     * @param that .
     */
    protected AbstractDocumentStandaardGroepModel(final DocumentStandaardGroepBasis that) {
        super(that);
    }
