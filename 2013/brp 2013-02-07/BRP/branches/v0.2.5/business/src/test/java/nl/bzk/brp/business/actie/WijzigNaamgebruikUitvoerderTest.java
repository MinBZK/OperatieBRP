...
public class WijzigNaamgebruikUitvoerderTest extends AbstractStapTest {
    ...
    private WijzigingNaamgebruikActieValidator echteValidator = new WijzigingNaamgebruikActieValidator();
    ...
    @InjectMocks
    private WijzigNaamgebruikUitvoerder wijzigNaamgebruikUitvoerder = new WijzigNaamgebruikUitvoerder();
