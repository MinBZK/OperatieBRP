...
public class BRPUC00120Test extends AbstractBedrijfsregelsTest {
    ...
    public void testKanAdresGevendeOuderNietBepalen() {
        ...
        Assert.assertEquals("De adresgevende ouder van de nieuwgeborene is niet te bepalen.", getLogAppender().get(0));
    }
    ...
    public void testIdentificatienummersMoederNietOpgegeven() {
        ...
        Assert.assertFalse(getLogAppender().isEmpty());
        Assert.assertEquals(1, getLogAppender().size());
        Assert.assertEquals("Groep persoonidentificatienummers van adresgevende ouder niet opgegeven in het bericht.", getLogAppender().get(0));
    }
