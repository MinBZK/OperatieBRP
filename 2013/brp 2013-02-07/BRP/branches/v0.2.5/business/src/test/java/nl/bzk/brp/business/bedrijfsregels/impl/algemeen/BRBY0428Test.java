...
public class BRBY0428Test {
    ...
    private static final PlaatsCode GELDIGE_PLAATS_CODE              = new PlaatsCode((short) 34);
    private static final PlaatsCode GELDIGE_PLAATS_CODE_ZONDER_DATUM = new PlaatsCode((short) 17);
     ...
     */
    private Plaats bouwPlaats(final PlaatsCode code, final Datum datumAanvang, final Datum datumEinde) {
