...
public class BRBY0187Test {
    ...
    public void init() {
        ...
        berichtMoeder = PersoonBuilder.bouwPersoon(MOEDER_BSN,
        ...
        PersoonBericht v = PersoonBuilder.bouwPersoon("222222222",
                Geslachtsaanduiding.MAN, 19261225,
                StatischeObjecttypeBuilder.GEMEENTE_AMSTERDAM,
                "vader", "van", "Houten");
        PersoonBericht b = PersoonBuilder.bouwPersoon("333333333",
                Geslachtsaanduiding.MAN, 20060409,
                StatischeObjecttypeBuilder.GEMEENTE_AMSTERDAM,
                "broer", "van", "Houten");
        PersoonBericht z = PersoonBuilder.bouwPersoon("555555555",
                Geslachtsaanduiding.MAN, 20090730,
                StatischeObjecttypeBuilder.GEMEENTE_AMSTERDAM,
                "zus", "van", "Houten");
    ...
    public void testKindExactJongsteKind() throws Exception {
        ...
        RelatieBericht nieuweSituatie = relBuilder
                    ...
                    .voegOuderToe(berichtMoeder).voegKindToe(k)
                    .getRelatie();
    ...
    public void testKindExact9MaandenJongerDanJongsteKind() throws Exception {
        ...
        PersoonBericht k = PersoonBuilder.bouwPersoon("666666666",
                Geslachtsaanduiding.MAN, 20100601,
                StatischeObjecttypeBuilder.GEMEENTE_AMSTERDAM,
                "kind", "van", "Houten");
        RelatieBuilder relBuilder = new RelatieBuilder();
        RelatieBericht nieuweSituatie = relBuilder
    ...
    public void testKind9MaandenMinEenDagJongerDanJongsteKind() throws Exception {
        ...
        PersoonBericht k = PersoonBuilder.bouwPersoon("666666666",
                Geslachtsaanduiding.MAN, 20100531,
                StatischeObjecttypeBuilder.GEMEENTE_AMSTERDAM,
                "kind", "van", "Houten");
        k.setVerzendendId("id.kind.pers");
        ...
        Assert.assertEquals("id.kind.pers.geboorte", meldingen.get(0).getVerzendendId());
    }
    ...
    private void zetOuderMoederAlsIndicatieAdresHoudend(final RelatieBericht nieuweSituatie) {
        ...
        for (BetrokkenheidBericht betr : nieuweSituatie.getOuderBetrokkenheden()) {
            if (betr.getBetrokkene().getIdentificatienummers().getBurgerservicenummer().getWaarde().equals(MOEDER_BSN)) {
