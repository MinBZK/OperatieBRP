...
public class KandidaatVaderImplTest {
    ...
    public void testVraagOpKandidaatVaderZonderOverledenVaderNietNL() {
        ...
        List<BetrokkenheidModel> echtgenoten = Arrays.asList(maakBetrokkenheden(20101231, null, (short) 2));
    ...
    public void testVraagOpKandidaatVaderMetOverledenVaderNietNL() {
        // Buitenlands nationaliteit
        List<BetrokkenheidModel> echtgenoten = Arrays.asList(maakBetrokkenheden(20101231, 20110101, (short) 2));
    ...
    public void testVraagOpKandidaatVaderMetOverledenVaderNietNLBuitenPeriode() {
        // Buitenlands nationaliteit
        List<BetrokkenheidModel> echtgenoten = Arrays.asList(maakBetrokkenheden(20101231, 20101231, (short) 2));
    ...
    public void testVraagOpKandidaatVaderMetOverledenVaderNL() {
        List<BetrokkenheidModel> echtgenoten = Arrays.asList(maakBetrokkenheden(20101231, 20110301, (short) 1));
    ...
    public void testVraagOpKandidaatVaderMetOverledenVaderNLBuitenPeriode() {
        List<BetrokkenheidModel> echtgenoten = Arrays.asList(maakBetrokkenheden(20101231, 20110228, (short) 1));
    ...
    /**
     * In periode van geboorte kind zijn er twee vaders overleden.
     *
     * Kind geboren op 2012-05-06
     * Twee vader:
     * vader1: 2011-07-01 tot 2012-01-01
     * vader2: 2012-02-01 tot 2012-05-04
     */
    @Test
    public void testTweeVaderOverLedenInNLPeriodeGeboorte() {
        List<BetrokkenheidModel> echtgenoten =
            Arrays.asList(maakBetrokkenheden(20110701, 20120101, (short) 1),
                    maakBetrokkenheden(20120201, 20120504, (short) 1));
        ...
        Mockito.when(persoonRepository.haalPersoonOpMetAdresViaBetrokkenheid(echtgenoten.get(1))).thenReturn(
                echtgenoten.get(1).getBetrokkene());

        List<PersoonModel> kandidaten =
            kandidaatVader.bepaalKandidatenVader(new PersoonModel(new PersoonBericht()), new Datum(20120506));

        Mockito.verify(persoonRepository, Mockito.times(2)).haalPersoonOpMetAdresViaBetrokkenheid(
                (BetrokkenheidModel) Matchers.any());
    ...
    /**
     * Twee vader, in periode van geboorte kind is er 1 vader overleden
     *
     * Kind geboren op 2012-04-01
     * Twee vader:
     * vader1: 2011-07-01 tot 2012-01-01
     * vader2: 2012-02-01 tot 2012-05-04
     */
    @Test
    public void testTweeVaderKindGeborenVoorOverlijdenTweedeVader() {
        List<BetrokkenheidModel> echtgenoten =
            Arrays.asList(maakBetrokkenheden(20110701, 20120101, (short) 1),
                    maakBetrokkenheden(20120201, 20120504, (short) 1));
        ...
        List<PersoonModel> kandidaten =
            kandidaatVader.bepaalKandidatenVader(new PersoonModel(new PersoonBericht()), new Datum(20120401));
     ...
     * Twee vader, in periode van geboorte kind is er 1 vader overleden
     *
     * Kind geboren op 2012-11-03
     * Twee vader:
     * vader1: 2011-07-01 tot 2012-01-01
     * vader2: 2012-02-01 tot 2012-05-04
     */
    @Test
    public void testTweeVaderKindGeborenPeriodeBijTweedeVader() {
        List<BetrokkenheidModel> echtgenoten =
            Arrays.asList(maakBetrokkenheden(20110701, 20120101, (short) 1),
                    maakBetrokkenheden(20120201, 20120504, (short) 1));
        ...
        List<PersoonModel> kandidaten =
            kandidaatVader.bepaalKandidatenVader(new PersoonModel(new PersoonBericht()), new Datum(20121103));
    ...
    /**
     * Twee vader, kind geboren voor overleiden eerste vader
     *
     * Kind geboren op 2011-11-01
     * Twee vader:
     * vader1: 2011-07-01 tot 2012-01-01
     * vader2: 2012-02-01 tot 2012-05-04
     */
    @Test
    public void testKindGeborenVoorOverlijdenEersteVader() {
        List<BetrokkenheidModel> echtgenoten =
            Arrays.asList(maakBetrokkenheden(20110701, 20120101, (short) 1),
                    maakBetrokkenheden(20120201, 20120504, (short) 1));
        ...
        List<PersoonModel> kandidaten =
            kandidaatVader.bepaalKandidatenVader(new PersoonModel(new PersoonBericht()), new Datum(20111101));
    ...
    private BetrokkenheidModel maakBetrokkenheden(final Integer datumAanvang, final Integer overlijdingsDatum,
            final short nationaliteitCode)
    {
        RelatieBericht relatie = new RelatieBericht();
        relatie.setGegevens(new RelatieStandaardGroepBericht());
        relatie.getGegevens().setDatumAanvang(new Datum(datumAanvang));
