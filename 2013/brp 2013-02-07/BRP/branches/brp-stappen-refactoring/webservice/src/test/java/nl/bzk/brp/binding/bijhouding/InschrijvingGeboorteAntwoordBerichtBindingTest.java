...
@Ignore("Fix testen met correcte bevraging xml: SIERRA-459")
    ...
    AbstractBindingUitIntegratieTest<InschrijvingGeboorteAntwoordBericht>
{
    ...
    public void testLeegAntwoordBericht() throws JiBXException {
        ...
        final InschrijvingGeboorteAntwoordBericht bericht =
            (InschrijvingGeboorteAntwoordBericht) antwoordBerichtFactory.bouwAntwoordBericht(
                bouwIngaandBericht(SoortBericht.A_F_S_REGISTREER_GEBOORTE_B), resultaat);
    ...
    public void testAntwoordMetBijgehoudenPersonen() throws JiBXException {
        ...
        PersoonBericht pers1 =
            PersoonBuilder.bouwPersoon("123456782", Geslachtsaanduiding.MAN, 19930205, null, null, null, null);
        PersoonBericht pers2 =
            PersoonBuilder.bouwPersoon("123456781", Geslachtsaanduiding.MAN, 19930205, null, null, null, null);
        PersoonBericht pers3 =
            PersoonBuilder.bouwPersoon("123456780", Geslachtsaanduiding.MAN, 19930205, null, null, null, null);
