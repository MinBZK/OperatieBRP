        ...
        AbstractVraagBerichtBindingUitIntegratieTest<VraagDetailsPersoonAntwoordBericht>
{
    ...
    public void testOutBindingMetPersoonInResultaat() throws Exception {
        Partij gemeente =
            new TestPartij(null, SoortPartij.GEMEENTE, new GemeenteCode("0010"), null, null, null, null, null,
                    StatusHistorie.X, StatusHistorie.X);

        Land nederland = new TestLand(new Landcode("0031"), null, null, null, null);

        Plaats amsterdam = new TestPlaats(new Woonplaatscode("0020"), null, null, null);
    ...
    public void testOutBindingMinimaalPersoonMetHuwelijk() throws JiBXException, ParseException {
        ...
        gegevens.setLandAanvang(new TestLand(new Landcode("0031"), null, null, null, null));
    ...
    public void testIndicatieBinding() throws Exception {
        Partij gemeente = new TestPartij(null, null, new GemeenteCode("0010"), null, null, null, null, null, null, null);
        Land nederland = new TestLand(new Landcode("0031"), null, null, null, null);
        Plaats amsterdam = new TestPlaats(new Woonplaatscode("0020"), null, null, null);
