    ...
    extends AbstractBindingInIntegratieTest<HuwelijkBericht>
{
    ...
    public void testBindingMaxBericht() throws IOException, JiBXException {
        ...
        Assert.assertEquals(new GemeenteCode("34"), standaardGroep.getGemeenteAanvangCode());
        Assert.assertEquals(new Woonplaatscode("243"), standaardGroep.getWoonplaatsAanvangCode());
        ...
        Assert.assertEquals(new GemeenteCode("34"), partner1.getGeboorte().getGemeenteGeboorteCode());
        Assert.assertEquals(new Woonplaatscode("243"), partner1.getGeboorte().getWoonplaatsGeboorteCode());
        ...
        Assert.assertEquals(new Landcode("2"), partner1.getGeboorte().getLandGeboorteCode());
        ...
        Assert.assertEquals(new GemeenteCode("34"), partner2.getGeboorte().getGemeenteGeboorteCode());
        Assert.assertEquals(new Woonplaatscode("243"), partner2.getGeboorte().getWoonplaatsGeboorteCode());
        ...
        Assert.assertEquals(new Landcode("2"), partner2.getGeboorte().getLandGeboorteCode());
