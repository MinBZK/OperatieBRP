...
public class BRBY0428Test {
    ...
    private static final Woonplaatscode GELDIGE_WOONPLAATSCODE              = new Woonplaatscode("34");
    private static final Woonplaatscode GELDIGE_WOONPLAATSCODE_ZONDER_DATUM = new Woonplaatscode("17");
