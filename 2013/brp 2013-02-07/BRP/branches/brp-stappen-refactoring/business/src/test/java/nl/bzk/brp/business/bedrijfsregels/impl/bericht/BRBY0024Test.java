...
public class BRBY0024Test {
     ...
     */
    private List<ActieBericht> bouwLijstVanActies(final Integer... datums) {
     ...
     */
    private AbstractBijhoudingsBericht bouwBerichtMetActies(final List<ActieBericht> acties) {
