...
public class BRBY0429Test {
    ...
    private static final GemeenteCode GELDIGE_GEMEENTE_CODE              = new GemeenteCode("34");
    private static final GemeenteCode GELDIGE_GEMEENTE_CODE_ZONDER_DATUM = new GemeenteCode("17");
