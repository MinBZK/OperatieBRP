...
import nl.bzk.brp.model.algemeen.attribuuttype.brm.RegelCode;
...
public class BerichtResultaatTest {
    ...
    public void testVoegtoeOverruleMeldingen() {
        BerichtVerwerkingsResultaat resultaat = new BerichtVerwerkingsResultaat(null);
        List<GedeblokkeerdeMeldingBericht> overrMeldingen = new ArrayList<GedeblokkeerdeMeldingBericht>();
        ...
        Assert.assertEquals(MeldingCode.ACT0001.name(),
                resultaat.getOverruleMeldingen().get(0).getGedeblokkeerdeMelding().getRegel().getCode());
        Assert.assertEquals(MeldingCode.ACT0002.name(),
