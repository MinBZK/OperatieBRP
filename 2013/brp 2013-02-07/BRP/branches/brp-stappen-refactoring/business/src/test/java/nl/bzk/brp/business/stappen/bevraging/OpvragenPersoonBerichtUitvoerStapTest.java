...
public class OpvragenPersoonBerichtUitvoerStapTest {
    ...
    public void testVraagOpDetailPersoonPersoonGevonden() {
        ...
        Assert.assertEquals(Integer.valueOf(1234), gevondenPersoon.getIdentificatienummers().getBurgerservicenummer().getWaarde());
        Assert.assertEquals("0000001235", gevondenPersoon.getIdentificatienummers().getAdministratienummer().toString());
    ...
    public void testVraagOpDetailPersoonMetHistorie() {
        ...
        vraag.getVraag().getVraagOpties().setHistorieMaterieel(Ja.J);
        opvragenPersoonBerichtUitvoerStap.voerVerwerkingsStapUitVoorBericht(vraag, null, resultaat);
        ...
        vraag.getVraag().getVraagOpties().setHistorieFormeel(Ja.J);
        opvragenPersoonBerichtUitvoerStap.voerVerwerkingsStapUitVoorBericht(vraag, null, resultaat);
        Mockito.verify(persoonRepository, Mockito.times(1)).vulaanAdresMetHistorie(Matchers.any(PersoonModel.class),
            Matchers.eq(true));
    }
    ...
    public void testHaalPersonenMetAdresOpViaBurgerservicenummerIdMetIdCodeAanduidingStap3bGeenResultaat() {
        ...
        Mockito.when(
            persoonRepository.haalPersonenMetWoonAdresOpViaVolledigAdres(new NaamOpenbareRuimte(
                "naamOpenbareRuimte"), new Huisnummer("" + 12), new Huisletter("A"), null,
                StatischeObjecttypeBuilder.WOONPLAATS_AMSTERDAM, gemeente))
               .thenReturn(personen);
    ...
    private PersoonModel maakGevondenPersoon() {
        ...
        BetrokkenheidModel partner2 = new PartnerModel(new PartnerBericht(), huwelijk, new PersoonModel(new PersoonBericht()));
    ...
    private PersoonModel maakPersoon() {
        ...
        idnrs.setAdministratienummer(new ANummer("9234567821"));
        persoon.setIdentificatienummers(idnrs);
...
//            relatie.getStandaard().setRedenBeeindigingRelatie(redenBeeindigingRelatie);
