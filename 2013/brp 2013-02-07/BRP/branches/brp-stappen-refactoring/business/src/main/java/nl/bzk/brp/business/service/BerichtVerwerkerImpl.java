...
@Service
public class BerichtVerwerkerImpl<T extends BerichtVerwerkingsResultaat> implements BerichtVerwerker<T, BerichtBericht, BerichtContext> {
    ...
    /** {@inheritDoc} */
    @Override
    public <T extends BerichtVerwerkingsResultaat> T verwerkBericht(final BerichtBericht bericht,
        ...
        final BerichtVerwerkingsResultaat berichtResultaat)
    {
        ...
        if (bericht.getBrpActies() == null || bericht.getBrpActies().isEmpty()) {
            berichtResultaat.voegMeldingToe(new Melding(SoortMelding.FOUT, MeldingCode.ACT0001));
    ...
    @Override
    public <R extends StappenResultaat> R verwerk(final BerichtBericht onderwerp, final BerichtContext context) {
        return (R)verwerkBericht(onderwerp, context);
    }
}
