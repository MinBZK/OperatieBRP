 ...
 */
public class BRBY0152 implements BerichtBedrijfsRegel<InschrijvingGeboorteBericht> {
    ...
    public List<Melding> executeer(final InschrijvingGeboorteBericht bericht) {
        ...
        if (bericht != null && bericht.getAdministratieveHandeling().getActies() != null && bericht.getAdministratieveHandeling().getActies().size() > 1) {
            List<Persoon> hoofdPersonen = BerichtUtils.bepaalPersonenUitActie(bepaalHoofdActie(bericht.getAdministratieveHandeling().getActies()));
            ...
            if (CollectionUtils.isNotEmpty(hoofdPersonen)) {
                ...
                for (int i = 1; i < bericht.getAdministratieveHandeling().getActies().size(); i++) {
                    List<Persoon> bijPersonen = BerichtUtils.bepaalPersonenUitActie(bericht.getAdministratieveHandeling().getActies().get(i));
