...
/**
 * Interface voor de factory klasse die {@link nl.bzk.brp.business.dto.BerichtVerwerkingsResultaat} instanties creeert
 * op basis van een opgegeven bericht.
 */
public interface BerichtResultaatFactory {

    /**
     * Creeert een bericht specifieke {@link nl.bzk.brp.business.dto.BerichtVerwerkingsResultaat}.
     * Dus op basis van het bericht, wordt er een nieuwe
     * instantie aangemaakt van een van subclass van {@link nl.bzk.brp.business.dto.BerichtVerwerkingsResultaat}.
     *
