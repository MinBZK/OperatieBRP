...
//                }
                ...
                administratieveHandelingRepository.opslaanNieuwAdministratieveHandeling(administratieveHandelingBericht);
                administratieveHandelingBericht.setTechnischeSleutel(administratieveHandelingModel.getTechnischeSleutel());
                ...
                if (bericht.getAdministratieveHandeling().getActies() != null) {
                    for (Actie actie : bericht.getAdministratieveHandeling().getActies()) {
                        ...
                        if (uitvoerder != null) {
                            ...
                            List<Melding> actieMeldingen = uitvoerder.voerUit(actie, context, administratieveHandelingModel);
