 ...
 */
public interface BerichtVerwerker<T extends BerichtVerwerkingsResultaat, O extends BerichtBericht, C extends StappenContext> extends StappenVerwerker<T, O, C> {
     ...
     */
     <T extends BerichtVerwerkingsResultaat> T verwerkBericht(final O bericht,
                                                              final C context);
