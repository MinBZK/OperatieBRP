 ...
 */
public interface StappenVerwerker<R extends StappenResultaat, O extends ObjectType, C extends StappenContext> {
    /**
     ...
     */
    <R extends StappenResultaat> R verwerk(final O onderwerp,
                                                             final C context);
}
