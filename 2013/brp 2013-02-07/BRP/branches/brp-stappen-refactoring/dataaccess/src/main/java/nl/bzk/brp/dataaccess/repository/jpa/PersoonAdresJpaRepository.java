...
public class PersoonAdresJpaRepository implements PersoonAdresRepository {
    ...
    public boolean isIemandIngeschrevenOpAdres(final PersoonAdres persoonAdres) {
        ...
        final Path<PersoonAdresStandaardGroepModel> gegevensPath = root.get("standaard");
        final PersoonAdresStandaardGroep gegevens = persoonAdres.getStandaard();

        SingularAttribute attrGegevens =
            em.getMetamodel().entity(PersoonAdresModel.class).getSingularAttribute("standaard");
        ...
        if (gegevens.getGemeente() != null && gegevens.getGemeente().getCode() != null) {
            p = cb.and(p, cb.equal(gegevensPath.get("gemeente").get("code"),
                gegevens.getGemeente().getCode()));
        } else {
    ...
    public PersoonAdresModel vindHuidigWoonAdresVoorPersoon(final Burgerservicenummer bsn) {
        ...
        predicate = cb.and(predicate, cb.equal(root.get("standaard").get("soort"), FunctieAdres.WOONADRES));
        cq.where(predicate);
    ...
    private PersoonAdresModel pasAdresEnHistorieAan(final PersoonAdresModel persoonAdres, final ActieModel actie,
        final Datum datumAanvangGeldigheid, final Datum datumEindeGeldigheid)
    {
        PersoonAdresStandaardGroepModel gegevens = persoonAdres.getStandaard();
        ...
        if (datumEindeGeldigheid == null) {
            ...
            gegevens = huidigAdres.getStandaard();
        }
        ...
        // Werk historie bij
        historiePersoonAdresRepository.persisteerHistorie(huidigAdres, gegevens, actie,
    ...
    public PersoonAdresModel vulaanAdresMetHistorie(final PersoonAdresModel adres, final boolean inclFormeleHistorie) {
        if (adres != null) {
            ...
            // de query uitvoeren?
            List<HisPersoonAdresModel> historie = historiePersoonAdresRepository.haalopHistorie(adres, inclFormeleHistorie);
