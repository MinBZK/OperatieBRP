...
public class PersoonAdresRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testIsIemandIngeschrevenOpAdresMetAlleenHuisnummer() {
        ...
        Assert.assertTrue(persoonAdresRepository.isIemandIngeschrevenOpAdres(
            creerTestAdresVoorTestReedsBewoners(new Huisnummer("1"), null, null, "0034")));
        Assert.assertTrue(persoonAdresRepository.isIemandIngeschrevenOpAdres(
            creerTestAdresVoorTestReedsBewoners(new Huisnummer("6"), null, null, "0034")));
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(
            creerTestAdresVoorTestReedsBewoners(new Huisnummer("6"), null, null, "1352")));
    }
    ...
    public void testIsIemandIngeschrevenOpAdresMetHuisnummerEnHuisletter() {
        ...
        Assert.assertTrue(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer("7"), new Huisletter("b"), null, "0034")));
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer("7"), new Huisletter("b"), null, "1352")));
    }
    ...
    public void testIsIemandIngeschrevenOpAdresMetHuisnummerEnHuisnummerToevoeging() {
        ...
        Assert.assertTrue(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer("8"), null, new Huisnummertoevoeging("II"), "0034")));
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer("8"), null, new Huisnummertoevoeging("II"), "1352")));
    }
    ...
    public void testIsIemandIngeschrevenOpAdresMetHuisnummerHuisLetterEnHuisnummerToevoeging() {
        ...
        Assert.assertTrue(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer("9"), new Huisletter("c"), new Huisnummertoevoeging("III"), "0034")));
    }
    ...
    private PersoonAdresModel creerTestAdres() {
        ...
        paGegevens.setWoonplaats(referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode("0034")));
        ...
        paGegevens.setGemeente(referentieDataRepository.vindGemeenteOpCode(new GemeenteCode("0034")));
    ...
    private PersoonAdresModel maakNieuwAdres2(final PersoonModel persoon) {
        ...
        paGegevens.setWoonplaats(referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode("1352")));
        ...
        paGegevens.setLand(referentieDataRepository.vindLandOpCode(BrpConstanten.NL_LAND_CODE));
        paGegevens.setGemeente(referentieDataRepository.vindGemeenteOpCode(new GemeenteCode("0034")));
        paGegevens.setRedenWijziging(
            referentieDataRepository.vindRedenWijzingAdresOpCode(new RedenWijzigingAdresCode("A")));
        //paGegevens.setAangeverAdreshouding(new AangeverAdreshouding("GEZAGHOUDER"));
