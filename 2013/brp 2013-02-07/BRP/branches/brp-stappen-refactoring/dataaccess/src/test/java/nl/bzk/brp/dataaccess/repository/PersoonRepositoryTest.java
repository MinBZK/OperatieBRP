...
//                }
    ...
    public void testHaalPersonenMetWoonAdresOpViaVolledigAdres() {
        Plaats plaats = referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode("0034"));
    ...
    public void testOpslaanNieuwPersoon() {
        ...
        Assert.assertEquals(new ANummer("1114567890"),
        ...
        PersoonBijhoudingsgemeenteGroepModel bijhoudingsgemeente = new PersoonBijhoudingsgemeenteGroepModel(
            new PersoonBijhoudingsgemeenteGroep() {
                ...
                public Partij getBijhoudingsgemeente() {
                    return referentieDataRepository.vindGemeenteOpCode(new GemeenteCode("0363"));
                }
            });
    ...
    public void testWerkbijBijhoudingsgemeente() {
        ...
        bijhoudingsgemeente = new PersoonBijhoudingsgemeenteGroepModel(
            new PersoonBijhoudingsgemeenteGroep() {
                ...
                @Override
                public Partij getBijhoudingsgemeente() {
                    return referentieDataRepository.vindGemeenteOpCode(new GemeenteCode("0034"));
                }
            });
...
//
        ...
        final String voornamen, final String voorVoegsel, final String scheidingsTeken, final String naam)
    {
        ...
        if (adellijkeTitelCode != null) {
            aanB.setAdellijkeTitelAanschrijving(
                referentieDataRepository.vindAdellijkeTitelOpCode(new AdellijkeTitelCode(adellijkeTitelCode)));
        }
        if (gebruik != null) {
            aanB.setNaamgebruik(gebruik);
        }
        if (indMetAdellijkeTitel != null) {
            aanB.setIndicatieTitelsPredikatenBijAanschrijven(indMetAdellijkeTitel);
        }
        if (indAlgorithm != null) {
            aanB.setIndicatieAanschrijvingAlgoritmischAfgeleid(indAlgorithm);
        }
        if (voornamen != null) {
            aanB.setVoornamenAanschrijving(new Voornamen(voornamen));
        }
        if (voorVoegsel != null) {
            aanB.setVoorvoegselAanschrijving(new Voorvoegsel(voorVoegsel));
        }
        if (scheidingsTeken != null) {
            aanB.setScheidingstekenAanschrijving(new Scheidingsteken(scheidingsTeken));
        }
        if (naam != null) {
            aanB.setGeslachtsnaamAanschrijving(new Geslachtsnaam(naam));
        }
    ...
    private PersoonModel maakNieuwPersoon() {
            ...
            public PersoonGeboorteGroep getGeboorte() {
                return new PersoonGeboorteGroep() {
                    ...
                    public Plaats getWoonplaatsGeboorte() {
                        return referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode("0034"));
                    }

                    @Override
                    public Land getLandGeboorte() {
                        return referentieDataRepository.vindLandOpCode(new Landcode("6023"));
                    }
        ...
        persoon.getNationaliteiten().add(maakNieuwNationaliteit(persoon, "001", null));
        return persoon;
    }
    ...
    private ActieModel maakActie(final SoortActie soortActie) {
        final AdministratieveHandelingModel admhnd = new AdministratieveHandelingModel(
            ...
            referentieDataRepository.vindGemeenteOpCode(new GemeenteCode("0363")),
