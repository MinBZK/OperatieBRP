 ...
 */
public abstract class AbstractActieRegistratieAanschrijvingBericht extends ActieBericht {

    /**
     * Default constructor instantieert met de juiste SoortActie.
     *
     */
    public AbstractActieRegistratieAanschrijvingBericht() {
        super(SoortActie.REGISTRATIE_AANSCHRIJVING);
    }
