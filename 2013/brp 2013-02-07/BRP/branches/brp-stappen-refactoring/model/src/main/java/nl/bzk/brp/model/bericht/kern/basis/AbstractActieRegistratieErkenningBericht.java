 ...
 */
public abstract class AbstractActieRegistratieErkenningBericht extends ActieBericht {

    /**
     * Default constructor instantieert met de juiste SoortActie.
     *
     */
    public AbstractActieRegistratieErkenningBericht() {
        super(SoortActie.REGISTRATIE_ERKENNING);
    }
