...
import nl.bzk.brp.model.operationeel.kern.basis.AbstractPersoonVerificatieModel;
...
public class PersoonVerificatieModel extends AbstractPersoonVerificatieModel implements PersoonVerificatie {
     ...
     */
    public PersoonVerificatieModel(final PersoonModel geverifieerde, final SoortVerificatie soort) {
        super(geverifieerde, soort);
    }
