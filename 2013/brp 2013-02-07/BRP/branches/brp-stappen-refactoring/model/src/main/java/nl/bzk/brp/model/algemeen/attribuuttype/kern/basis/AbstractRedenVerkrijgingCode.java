 ...
 */
@MappedSuperclass
public abstract class AbstractRedenVerkrijgingCode extends AbstractGegevensAttribuutType<Short> {
     ...
     *
     */
    protected AbstractRedenVerkrijgingCode() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public AbstractRedenVerkrijgingCode(final Short waarde) {
        super(waarde);
    }
