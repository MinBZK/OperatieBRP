 ...
 * Gegenereerd op: Tue Dec 04 09:37:17 CET 2012.
 */
    ...
    implements Betrokkenheid, Comparable<BetrokkenheidModel>
{
    ...
    public BetrokkenheidModel(final RelatieModel relatie, final SoortBetrokkenheid rol, final PersoonModel persoon) {
        ...
        setOuderlijkGezagStatusHis(StatusHistorie.X);
        setOuderschapStatusHis(StatusHistorie.X);
    }
     ...
     */
    public BetrokkenheidModel(final Betrokkenheid betrokkenheid, final RelatieModel relatie,
        final PersoonModel persoon)
    {
        super(betrokkenheid, relatie, persoon);

        //TODO Tijdelijk?!? Zie ROMEO-71
        if (getOuderlijkGezagStatusHis() == null) {
            setOuderlijkGezagStatusHis(StatusHistorie.X);
        }
        if (getOuderschapStatusHis() == null) {
            setOuderschapStatusHis(StatusHistorie.X);
        }
    }
