...
import nl.bzk.brp.model.algemeen.attribuuttype.autaut.basis.AbstractTekstUitBesluit;
 ...
 */
@Embeddable
public class TekstUitBesluit extends AbstractTekstUitBesluit {
     ...
     */
    public TekstUitBesluit(final String waarde) {
        super(waarde);
    }
