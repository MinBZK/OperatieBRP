 ...
 */
@MappedSuperclass
public abstract class AbstractRegelCode extends AbstractGegevensAttribuutType<String> {
     ...
     */
    @JsonCreator
    public AbstractRegelCode(final String waarde) {
        super(waarde);
    }
