 ...
 */
@MappedSuperclass
public abstract class AbstractOntleningstoelichting extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractOntleningstoelichting() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public AbstractOntleningstoelichting(final String waarde) {
        super(waarde);
    }
