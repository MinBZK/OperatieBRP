...
import nl.bzk.brp.model.algemeen.stamgegeven.kern.basis.AbstractRedenWijzigingAdres;
...
public class RedenWijzigingAdres extends AbstractRedenWijzigingAdres {

    /**
     * Constructor is protected, want de BRP zal geen stamgegevens beheren.
     *
     */
    protected RedenWijzigingAdres() {
        super();
    }
     ...
     */
    public RedenWijzigingAdres(final RedenWijzigingAdresCode code, final NaamEnumeratiewaarde naam) {
        super(code, naam);
    }
