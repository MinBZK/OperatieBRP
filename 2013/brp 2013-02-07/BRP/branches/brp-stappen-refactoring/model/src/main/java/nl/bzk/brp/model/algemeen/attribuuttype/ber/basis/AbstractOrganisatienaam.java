 ...
 */
@MappedSuperclass
public abstract class AbstractOrganisatienaam extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractOrganisatienaam() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public AbstractOrganisatienaam(final String waarde) {
        super(waarde);
    }
