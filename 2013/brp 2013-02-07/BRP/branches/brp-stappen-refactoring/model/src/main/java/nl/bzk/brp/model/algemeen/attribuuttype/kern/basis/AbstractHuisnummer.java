 ...
 */
@MappedSuperclass
public abstract class AbstractHuisnummer extends AbstractGegevensAttribuutType<Integer> {
     ...
     */
    @JsonCreator
    public AbstractHuisnummer(final Integer waarde) {
        super(waarde);
    }
