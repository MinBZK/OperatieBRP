 ...
 */
public abstract class AbstractActieRegistratieHuwelijkBericht extends ActieBericht {

    /**
     * Default constructor instantieert met de juiste SoortActie.
     *
     */
    public AbstractActieRegistratieHuwelijkBericht() {
        super(SoortActie.REGISTRATIE_HUWELIJK);
    }
