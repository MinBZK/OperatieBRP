 ...
 */
@MappedSuperclass
public abstract class AbstractLandcode extends AbstractGegevensAttribuutType<Short> {
     ...
     */
    @JsonCreator
    public AbstractLandcode(final Short waarde) {
        super(waarde);
    }
