 ...
 */
@MappedSuperclass
public abstract class AbstractBijhoudingsresultaatCode extends AbstractGegevensAttribuutType<String> {
     ...
     *
     */
    protected AbstractBijhoudingsresultaatCode() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public AbstractBijhoudingsresultaatCode(final String waarde) {
        super(waarde);
    }
