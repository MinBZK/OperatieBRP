 ...
 */
public class DatumValidator implements ConstraintValidator<Datum, nl.bzk.brp.model.algemeen.attribuuttype.kern.Datum> {
    ...
    @Override
    public boolean isValid(final nl.bzk.brp.model.algemeen.attribuuttype.kern.Datum datum,
     ...
     */
    private boolean isGeldigeDatum(final nl.bzk.brp.model.algemeen.attribuuttype.kern.Datum datum) {
