        ...
        implements HuwelijkGeregistreerdPartnerschap
{
    ...
    protected HuwelijkGeregistreerdPartnerschapModel(final SoortRelatie s) {
        super(s);
    }
            ...
            final HuwelijkGeregistreerdPartnerschap hgp)
    {
        if (hgp.getSoort() == SoortRelatie.HUWELIJK) {
            return new HuwelijkModel((Huwelijk) hgp);
        } else if (hgp.getSoort() == SoortRelatie.GEREGISTREERD_PARTNERSCHAP) {
            return new GeregistreerdPartnerschapModel((GeregistreerdPartnerschap) hgp);
        } else {
