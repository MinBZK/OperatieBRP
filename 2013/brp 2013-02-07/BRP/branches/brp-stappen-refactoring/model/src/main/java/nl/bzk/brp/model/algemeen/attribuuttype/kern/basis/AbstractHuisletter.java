 ...
 */
@MappedSuperclass
public abstract class AbstractHuisletter extends AbstractGegevensAttribuutType<String> {
     ...
     */
    @JsonCreator
    public AbstractHuisletter(final String waarde) {
        super(waarde);
    }
