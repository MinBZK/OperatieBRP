 ...
 */
public abstract class AbstractHandelingCorrectieGeregistreerdPartnerschapBericht extends
        AdministratieveHandelingBericht
{
    ...
    public AbstractHandelingCorrectieGeregistreerdPartnerschapBericht() {
        super(SoortAdministratieveHandeling.CORRECTIE_GEREGISTREERD_PARTNERSCHAP);
    }
