    ...
    implements PersoonAdres, Comparable<PersoonAdresModel>
{
    ...
    @Transient
    private List<HisPersoonAdresModel> historie;
    ...
    public List<HisPersoonAdresModel> getHistorie() {
        return historie;
    }

    public void setHistorie(final List<HisPersoonAdresModel> historie) {
