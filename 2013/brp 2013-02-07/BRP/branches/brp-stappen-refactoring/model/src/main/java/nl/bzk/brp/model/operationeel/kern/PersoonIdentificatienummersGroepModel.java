...
import nl.bzk.brp.model.operationeel.kern.basis.AbstractPersoonIdentificatienummersGroepModel;
 ...
 * <p/>
 * De groep ""identificatienummers"" bevat het burgerservicenummer, en het Administratienummer, waarmee de persoon
 * uniek
 * wordt aangeduid.
 * <p/>
    ...
    PersoonIdentificatienummersGroep, Comparable<PersoonIdentificatienummersGroepModel>
{
     ...
     */
    public PersoonIdentificatienummersGroepModel(final Burgerservicenummer burgerservicenummer,
     ...
     * voor {@link PersoonIdentificatienummersGroepModel} speficiek gekeken naar de waardes voor burgerservicenummer en
     * administratienummer, waarbij eerst gesorteerd wordt op burgerservicenummer en dan op administratienummer.
     * <p>
     * Merk op dat in deze vergelijking op een niet standaard wijze wordt omgegaan met <code>null</code> waardes.
     * Waar <code>null</code> meestal wordt gezien als 'kleiner' dan een werkelijke waarde, worden in deze
     * vergelijker <code>null</code>-waardes juist als 'groter' gezien, zodat deze ook achteraan de lijst komen
     * in geval van een sortering.
     * </p>
     *
    ...
    /**
     * Vergelijkt het opgegeven burgerservicenummer met het burgerservicenummer van dit object en retourneert een
     * negatief getal, nul, of een positief getal indien het bsn van dit object 'kleiner', gelijk of 'groter' dan het
     * opgegeven bsn is.
     *
     * @param bsn het bsn dat vergeleken moet worden.
     * @return een negatief getal, nul of een positief getal indien het bsn van dit object 'kleiner', gelijk aan of
     *         'groter' is dan het opgegeven bsn.
     */
    private int vergelijkBurgerservicenummer(final Burgerservicenummer bsn) {
        final int vergelijk;
    ...
    /**
     * Vergelijkt het opgegeven administratienummer met het administratienummer van dit object en retourneert een
     * negatief getal, nul, of een positief getal indien het administratienummer van dit object 'kleiner', gelijk of
     * 'groter' dan het opgegeven administratienummer is.
     *
     * @param aNummer het administratienummer dat vergeleken moet worden.
     * @return een negatief getal, nul of een positief getal indien het administratienummer van dit object 'kleiner',
     *         gelijk aan of 'groter' is dan het opgegeven administratienummer.
     */
    private int vergelijkAdministratienummer(final ANummer aNummer) {
        final int vergelijk;
    ...
    public int hashCode() {
        return new HashCodeBuilder(HASHCODE_GETAL1, HASHCODE_GETAL2)
            .append(this.getBurgerservicenummer())
