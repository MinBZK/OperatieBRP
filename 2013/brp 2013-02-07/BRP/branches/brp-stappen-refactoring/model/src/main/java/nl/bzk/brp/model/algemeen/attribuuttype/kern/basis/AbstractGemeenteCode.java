 ...
 */
@MappedSuperclass
public abstract class AbstractGemeenteCode extends AbstractGegevensAttribuutType<Short> {
     ...
     *
     */
    protected AbstractGemeenteCode() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public AbstractGemeenteCode(final Short waarde) {
        super(waarde);
    }
