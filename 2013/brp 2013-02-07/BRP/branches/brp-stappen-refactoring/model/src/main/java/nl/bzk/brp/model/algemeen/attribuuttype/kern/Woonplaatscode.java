...
import nl.bzk.brp.model.algemeen.attribuuttype.kern.basis.AbstractWoonplaatscode;
 ...
 */
@Embeddable
public class Woonplaatscode extends AbstractWoonplaatscode {

    private static final int LENGTE_CODE = 4;

    /**
     * Lege (value-object) constructor voor Woonplaatscode, niet gedeclareerd als public om te voorkomen dat objecten
     * zonder waarde worden geïnstantieerd.
     *
     */
    private Woonplaatscode() {
        super();
    }

    /**
     * Constructor voor Woonplaatscode die de waarde toekent aan het (value-)object.
     *
     * @param waarde De waarde voor dit value-object.
     */
    public Woonplaatscode(final String waarde) {
