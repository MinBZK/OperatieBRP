 ...
 */
@MappedSuperclass
public abstract class AbstractRedenVerliesCode extends AbstractGegevensAttribuutType<Short> {
     ...
     *
     */
    protected AbstractRedenVerliesCode() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public AbstractRedenVerliesCode(final Short waarde) {
        super(waarde);
    }
