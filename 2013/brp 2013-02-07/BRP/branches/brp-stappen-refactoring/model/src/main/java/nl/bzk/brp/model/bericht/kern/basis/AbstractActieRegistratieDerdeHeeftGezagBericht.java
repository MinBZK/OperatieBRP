 ...
 */
public abstract class AbstractActieRegistratieDerdeHeeftGezagBericht extends ActieBericht {

    /**
     * Default constructor instantieert met de juiste SoortActie.
     *
     */
    public AbstractActieRegistratieDerdeHeeftGezagBericht() {
        super(SoortActie.REGISTRATIE_DERDE_HEEFT_GEZAG);
    }
