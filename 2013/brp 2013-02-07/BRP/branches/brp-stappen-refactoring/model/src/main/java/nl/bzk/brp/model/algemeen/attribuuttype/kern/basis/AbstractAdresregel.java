 ...
 */
@MappedSuperclass
public abstract class AbstractAdresregel extends AbstractGegevensAttribuutType<String> {
     ...
     */
    @JsonCreator
    public AbstractAdresregel(final String waarde) {
        super(waarde);
    }
