...
public class PersoonOverlijdenGroepBindingTest extends AbstractBindingInTest<PersoonOverlijdenGroepBericht> {
    ...
    public void testPersoonOverlijdenGroep() throws JiBXException {
        ...
        Assert.assertEquals(new GemeenteCode("12"), overlijdenGroep.getGemeenteOverlijdenCode());
        Assert.assertEquals(new Woonplaatscode("1"), overlijdenGroep.getWoonplaatsOverlijdenCode());
        ...
        Assert.assertEquals(new Landcode("10"), overlijdenGroep.getLandOverlijdenCode());
        Assert
