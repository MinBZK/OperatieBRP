...
/** Predikaat ten behoeve van unittest. */
public class TestPredikaat extends Predikaat {
     ...
     */
    public TestPredikaat(final PredikaatCode code, final NaamEnumeratiewaarde naamMannelijk,
