...
public class BindingUtilTest {
    ...
    public void testDateNaarDatumTijd() throws ParseException {
        ...
        Assert.assertEquals("2012-01-02T03:04:05.006", BindingUtil.dateNaarDatumTijd(maakDatum("2012/01/02 03:04:05:006")));
        Assert.assertEquals("2012-11-22T13:24:35.106", BindingUtil.dateNaarDatumTijd(maakDatum("2012/11/22 13:24:35:106")));
    }
    ...
    public void testDatumTijdNaarDate() throws ParseException {
        ...
        Assert.assertEquals(0,
            maakDatum("2012/01/02 03:04:05:000").compareTo(BindingUtil.datumTijdNaarDate("2012-01-02T03:04:05.000")));
        Assert.assertEquals(0, new SimpleDateFormat("yyyy/MM/dd HH:mm:ss:SSS").parse("2012/11/22 13:24:35:100").compareTo(
            BindingUtil.datumTijdNaarDate("2012-11-22T13:24:35.100")));
        Assert
            .assertEquals(0, maakDatum("2012/01/02 00:00:00:000").compareTo(BindingUtil.datumTijdNaarDate("2012-01-02")));
    }

    @Test
    public void testIntegerNaarDatum() {
        Assert.assertNull(BindingUtil.integerNaarDatum(null));
        Assert.assertEquals("2011-02-03", BindingUtil.integerNaarDatum(20110203));
        Assert.assertEquals("2011-00-00", BindingUtil.integerNaarDatum(20110000));
    }

    @Test
    public void testDatumNaarInteger() {
        Assert.assertNull(BindingUtil.datumNaarInteger(null));
        Assert.assertEquals(Integer.valueOf(20110203), BindingUtil.datumNaarInteger("2011-02-03"));
        Assert.assertEquals(Integer.valueOf(20110000), BindingUtil.datumNaarInteger("2011-00-00"));
    }
