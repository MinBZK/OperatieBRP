...
public class PersoonAdresHistorieJpaRepository extends
        AbstractGroepHistorieRepository<PersoonAdresModel, AbstractPersoonAdresStandaardGroep, PersoonAdresStandaardHisModel>
        implements PersoonAdresHistorieRepository
{

    @Override
    public List<PersoonAdresStandaardHisModel> haalHistorieGewijzigdeRecordsOp(final PersoonModel persoon,
            final DatumTijd tijdstipRegistratie)
    {
        ...
        return getEntityManager().createQuery(query, PersoonAdresStandaardHisModel.class)
     ...
     */
    @Override
    protected PersoonAdresStandaardHisModel maakNieuwHistorieRecord(final PersoonAdresModel objectType,
            final AbstractPersoonAdresStandaardGroep groep)
    {
        // dual gebruik, als groep is null, haal de groep uit de huidige ALaag
        if (groep == null) {
            return new PersoonAdresStandaardHisModel(objectType.getGegevens(), objectType);
        } else {
            return new PersoonAdresStandaardHisModel(groep, objectType);
        }
    }
    ...
    @Override
    protected Class<PersoonAdresStandaardHisModel> getCLaagDomainClass() {
        return PersoonAdresStandaardHisModel.class;
    }
