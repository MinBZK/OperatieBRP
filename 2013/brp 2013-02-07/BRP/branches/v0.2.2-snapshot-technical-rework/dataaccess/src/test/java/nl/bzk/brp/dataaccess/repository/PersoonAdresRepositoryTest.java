...
public class PersoonAdresRepositoryTest extends AbstractRepositoryTestCase {
    ...
    private final String adresHistorieSql =
        "SELECT adres FROM PersoonAdresStandaardHisModel adres WHERE adres.persoonAdres.persoon.id = :persoonId "
    ...
    public void testOpslaanNieuwPersoonAdres() {
        ...
        List<PersoonAdresStandaardHisModel> adresHistorie =
        ...
        // C-laag - Nieuwe adres
        PersoonAdresStandaardHisModel nieuwHisAdres = adresHistorie.get(0);
        ...
        PersoonAdresStandaardHisModel oudHisAdres = adresHistorie.get(1);
        // Niet ingevulde tijd verval geeft aan dat de history item in laag C zit
        ...
        PersoonAdresStandaardHisModel oudHisAdresDLaag = adresHistorie.get(2);
    ...
    public void testTerugwerkendeKrachtCorrectie() {
        ...
        // Haal de adres history op
        List<PersoonAdresStandaardHisModel> adresHistorie =
            em.createQuery(adresHistorieSql, PersoonAdresStandaardHisModel.class).setParameter("persoonId", 1001)
              .getResultList();
    ...
    public void testIsIemandIngeschrevenOpAdresMetAlleenHuisnummer() {
        ...
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(
            creerTestAdresVoorTestReedsBewoners(new Huisnummer(6), null, null, new Short((short) 1352))));
    }
    ...
    public void testIsIemandIngeschrevenOpAdresMetHuisnummerEnHuisletter() {
        ...
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer(7), new Huisletter("b"), null, new Short((short) 1352))));
    }
    ...
    public void testIsIemandIngeschrevenOpAdresMetHuisnummerEnHuisnummerToevoeging() {
        ...
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(creerTestAdresVoorTestReedsBewoners(
            new Huisnummer(8), null, new Huisnummertoevoeging("II"), new Short((short) 1352))));
    }
    ...
    private PersoonAdresModel creerTestAdres() {
        ...
        paGegevens.setWoonplaats(referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode((short) 34)));
        ...
        final Huisletter huisletter, final Huisnummertoevoeging huisnummertoevoeging, final Short wplId)
    {
        ...
        if (wplId != null) {
            paGegevens.setWoonplaats(referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode(wplId)));
        }
        paGegevens.setLand(referentieDataRepository.vindLandOpCode(BrpConstanten.NL_LAND_CODE));
        paGegevens.setGemeente(referentieDataRepository.vindGemeenteOpCode(new Gemeentecode((short) 34)));
        PersoonAdresModel persoonAdres = new PersoonAdresModel(adres, null);
    ...
    private PersoonAdresModel maakNieuwAdres2(final PersoonModel persoon) {
        ...
        paGegevens.setWoonplaats(referentieDataRepository.vindWoonplaatsOpCode(new Woonplaatscode((short) 1352)));
        paGegevens.setAdresseerbaarObject(new AanduidingAdresseerbaarObject("1753"));
    ...
    public void testIsIemandIngeschrevenOpAdresWoonplaatsVerschillend() {
        ...
        ReflectionTestUtils.setField(adres.getGegevens(), "woonplaats", StatischeObjecttypeBuilder.bouwWoonplaats((short) 17, "TEST"));
        Assert.assertFalse(persoonAdresRepository.isIemandIngeschrevenOpAdres(adres));
...
//        PersoonAdresModel adres = maakNieuwAdres2(em.find(PersoonModel.class, 1001));
    ...
    public void slaPersoonAdresOp() {
        ...
        paGegevens.setLocatietovAdres(new AanduidingBijHuisnummer("ta"));
    ...
    public void testAlleHistorie() {
        ...
        List<PersoonAdresStandaardHisModel> historie = persoonAdresHistorieRepository.haalopHistorie(adres, true);
    ...
    public void haalHistorieGewijzigdeRecordsOp() throws ParseException {
        ...
        List<PersoonAdresStandaardHisModel> his = persoonAdresHistorieRepository.haalHistorieGewijzigdeRecordsOp(adres.getPersoon(), actie.getTijdstipRegistratie());
    ...
    public void tesCLaagHistorie() {
        ...
        List<PersoonAdresStandaardHisModel> historie = persoonAdresHistorieRepository.haalopHistorie(adres, false);
    ...
    public void haalHuidigRecordUitHistorie() {
        PersoonAdresModel adres = em.find(PersoonAdresModel.class, 1101);
        Assert.assertNotNull(adres);
        PersoonAdresStandaardHisModel pah = persoonAdresHistorieRepository.haalGeldigRecord(adres, new Datum(20160509));
