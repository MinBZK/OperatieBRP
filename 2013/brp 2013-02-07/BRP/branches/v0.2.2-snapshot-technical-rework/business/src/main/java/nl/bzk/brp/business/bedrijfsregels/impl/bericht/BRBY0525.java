...
public class BRBY0525 implements BerichtContextBedrijfsRegel {
    ...
    public List<Melding> executeer(final BerichtContext context) {
        ...
        List<PersoonAdresStandaardHisModel> historie = persoonAdresHistorieRepository.haalHistorieGewijzigdeRecordsOp(
     ...
     */
    private boolean isDatumIncosistent(final List<PersoonAdresStandaardHisModel> historie) {
        boolean incosistent = false;
        for (PersoonAdresStandaardHisModel his : historie) {
