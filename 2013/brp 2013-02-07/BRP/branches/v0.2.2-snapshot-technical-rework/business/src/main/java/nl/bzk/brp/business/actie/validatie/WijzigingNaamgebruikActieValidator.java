    ...
    private Collection<? extends Melding> valideerPersoon(final PersoonBericht persoon) {
        ...
        if (persoonAanschrijving != null) {
            ValidatieUtil.controleerVerplichteVeldInGroep(meldingen, persoonAanschrijving,
                persoonAanschrijving.getGebruikGeslachtsnaam(),
                "wijzeVanGebruikGeslachtsnaamEchtgenootGeregistreerdPartnerCode");
            ValidatieUtil.controleerVerplichteVeldInGroep(meldingen, persoonAanschrijving,
                    persoonAanschrijving.getIndAanschrijvingAlgorthmischAfgeleid(), "indicatieAlgoritmischAfgeleid");
            ValidatieUtil.controleerVerplichteVeldInGroep(meldingen, persoonAanschrijving,
                    persoonAanschrijving.getGeslachtsnaam(), "geslachtsnaam");
            if ((persoonAanschrijving.getGeslachtsnaam() != null)
                && StringUtils.isEmpty(persoonAanschrijving.getGeslachtsnaam().getWaarde()))
            {
