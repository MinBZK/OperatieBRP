...
public class BerichtVerrijkingsStapTest extends AbstractStapTest {
    ...
    public void testVerhuizing() {
        ...
        standaard.setWoonplaatsCode(new Woonplaatscode((short) 324));
        ...
        Mockito.verify(referentieDataRepository, Mockito.times(1)).vindWoonplaatsOpCode(Matchers.any(Woonplaatscode.class));
    ...
    public void testVerhuizingGeenVerrijkingNodig() {
        ...
        Mockito.verify(referentieDataRepository, Mockito.times(0)).vindWoonplaatsOpCode(Matchers.any(Woonplaatscode.class));
    ...
    public void testEersteInschrijving() {
        ...
        geboorte.setWoonplaatsGeboorteCode(new Woonplaatscode((short) 243));
        ...
        relatieStandaardGroep.setWoonPlaatsAanvangCode(new Woonplaatscode((short) 243));
        relatieStandaardGroep.setWoonPlaatsEindeCode(new Woonplaatscode((short) 243));
        ...
        Mockito.verify(referentieDataRepository, Mockito.times(3)).vindWoonplaatsOpCode(Matchers.any(Woonplaatscode.class));
    ...
    public void testOnbekendeReferentieExceptionAlsResultaat() {
        ...
        standaard.setWoonplaatsCode(new Woonplaatscode((short) 243));
