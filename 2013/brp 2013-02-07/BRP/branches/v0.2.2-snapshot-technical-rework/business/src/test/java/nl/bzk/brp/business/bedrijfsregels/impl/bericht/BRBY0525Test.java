...
public class BRBY0525Test {
    ...
    private List<PersoonAdresStandaardHisModel> maakHistorie(final boolean inconsistent) {
        int datum = 20120101;
        ...
        List<PersoonAdresStandaardHisModel> historie = new ArrayList<PersoonAdresStandaardHisModel>();

        PersoonAdresStandaardHisModel his1 = new PersoonAdresStandaardHisModel(persoonAdresModel.getGegevens(), persoonAdresModel);
        his1.setDatumAanvangGeldigheid(new Datum(datum));

        PersoonAdresStandaardHisModel his2 = new PersoonAdresStandaardHisModel(persoonAdresModel.getGegevens(), persoonAdresModel);
        if (inconsistent) {
        ...
        PersoonAdresStandaardHisModel his3 = new PersoonAdresStandaardHisModel(persoonAdresModel.getGegevens(), persoonAdresModel);
