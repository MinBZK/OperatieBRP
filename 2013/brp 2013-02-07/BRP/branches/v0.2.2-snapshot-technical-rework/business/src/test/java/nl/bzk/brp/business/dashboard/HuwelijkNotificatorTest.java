...
public class HuwelijkNotificatorTest {
    ...
    public void testHuwelijkBericht() throws Exception {
        ...
        gegevens.setWoonPlaatsAanvangCode(new Woonplaatscode((short) 123));
        ...
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("321432543"))).thenReturn(Arrays.asList(bouwPersoonModel(partner1)));
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("987654321"))).thenReturn(Arrays.asList(bouwPersoonModel(partner2)));
