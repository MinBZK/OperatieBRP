...
public abstract class AbstractPersoonAdresModel extends AbstractDynamischObjectType implements PersoonAdresBasis {
    ...
    @Transient
    private List<PersoonAdresStandaardHisModel> historie;
    ...
    public List<PersoonAdresStandaardHisModel> getHistorie() {
        return historie;
    }

    public void setHistorie(final List<PersoonAdresStandaardHisModel> historie) {
