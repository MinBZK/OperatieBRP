...
public abstract class AbstractPersoonGeslachtsnaamcomponentStandaardHisModel extends
    AbstractPersoonGeslachtsnaamcomponentStandaardGroep implements MaterieleHistorie
{
     ...
     */
    protected AbstractPersoonGeslachtsnaamcomponentStandaardHisModel() {
        super();
    }
        ...
        final PersoonGeslachtsnaamcomponentModel geslachtsnaamcomponentModel)
    {
        ...
        this.persoonGeslachtsnaamcomponent = geslachtsnaamcomponentModel;
        if (persoonGeslachtsnaamcomponentGroep instanceof AbstractPersoonGeslachtsnaamcomponentStandaardHisModel) {
            historie = new MaterieleHistorieImpl(
                    ((AbstractPersoonGeslachtsnaamcomponentStandaardHisModel) persoonGeslachtsnaamcomponentGroep).getHistorie()
            );
        } else {
            historie = new MaterieleHistorieImpl();
        }
