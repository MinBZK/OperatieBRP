...
public abstract class AbstractPersoonAdresStandaardHisModel extends AbstractPersoonAdresStandaardGroep implements
    MaterieleHistorie
{
        ...
        final PersoonAdresModel persoonAdresModel)
    {
        ...
        if (persoonAdresStandaardGroep instanceof AbstractPersoonAdresStandaardHisModel) {
            historie =
                new MaterieleHistorieImpl(
                    ((AbstractPersoonAdresStandaardHisModel) persoonAdresStandaardGroep).getHistorie());
