...
public abstract class AbstractPersoonPersoonskaartGroep extends AbstractGroep implements
        PersoonPersoonskaartGroepBasis
{
     ...
     */
    protected AbstractPersoonPersoonskaartGroep(final PersoonPersoonskaartGroepBasis groep) {
        super(groep);
     ...
     */
    protected AbstractPersoonPersoonskaartGroep() {
        super();
    }
