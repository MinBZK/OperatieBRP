...
public abstract class AbstractPersoonVoornaamStandaardHisModel extends AbstractPersoonVoornaamStandaardGroep implements
        MaterieleHistorie
{
     ...
     */
    protected AbstractPersoonVoornaamStandaardHisModel() {
        super();
    }
            ...
            final PersoonVoornaamModel persoonVoornaamModel)
    {
        ...
        if (persoonVoornaamStandaardGroep instanceof AbstractPersoonVoornaamStandaardHisModel) {
            historie = new MaterieleHistorieImpl(
                    ((AbstractPersoonVoornaamStandaardHisModel) persoonVoornaamStandaardGroep).getHistorie()
            );
        } else {
            historie = new MaterieleHistorieImpl();
        }
