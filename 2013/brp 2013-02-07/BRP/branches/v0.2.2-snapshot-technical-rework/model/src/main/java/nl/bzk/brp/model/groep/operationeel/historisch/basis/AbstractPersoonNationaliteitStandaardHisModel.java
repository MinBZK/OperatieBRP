...
public abstract class AbstractPersoonNationaliteitStandaardHisModel extends AbstractPersoonNationaliteitStandaardGroep
                                                           implements MaterieleHistorie
{
     ...
     */
    protected AbstractPersoonNationaliteitStandaardHisModel() {
        super();
            ...
            final PersoonNationaliteitModel persoonNationaliteit)
    {
        ...
        if ((persoonNationaliteitStandaardGroep != null)
                && persoonNationaliteitStandaardGroep instanceof AbstractPersoonNationaliteitStandaardHisModel)
        {
            historie =
                new MaterieleHistorieImpl(
                        ((AbstractPersoonNationaliteitStandaardHisModel) persoonNationaliteitStandaardGroep)
                                .getHistorie());
        } else {
            historie = new MaterieleHistorieImpl();
        }
