...
public final class StatischeObjecttypeBuilder {
    ...
    public static Land bouwLand(final Short code, final String naam) {
        ...
        if (naam != null) {
            land.setNaam(new NaamEnumeratiewaarde(naam));
        }
        return land;
    }
    ...
    public static Nationaliteit bouwNationaliteit(final Short code, final String naam) {
        ...
        if (naam != null) {
            nationaliteit.setNaam(new NaamEnumeratiewaarde(naam));
        }
    ...
    public static Plaats bouwWoonplaats(final short code, final String naam) {
        ...
        if (naam != null) {
            woonplaats.setNaam(new NaamEnumeratiewaarde(naam));
        }
        return woonplaats;
    }
    ...
    public static AdellijkeTitel bouwAdellijkeTitel(final String code, final String naam) {
        ...
        adellijkeTitel.setNaamMannelijk(new NaamEnumeratiewaarde(naam));
        adellijkeTitel.setNaamVrouwelijk(new NaamEnumeratiewaarde(naam));
    ...
    public static Predikaat bouwPredikaat(final String code, final String naam) {
        ...
        predikaat.setNaamMannelijk(new NaamEnumeratiewaarde(naam));
        predikaat.setNaamVrouwelijk(new NaamEnumeratiewaarde(naam));
        return predikaat;
    }
}
