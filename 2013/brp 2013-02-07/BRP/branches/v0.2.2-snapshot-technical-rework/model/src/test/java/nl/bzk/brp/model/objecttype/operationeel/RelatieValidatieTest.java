...
public class RelatieValidatieTest {
    ...
    private void vulMaxAan(final RelatieBericht bericht) {
        ...
        bericht.getGegevens().setOmschrijvingLocatieAanvang(new OmschrijvingEnumeratiewaarde("----"));
        bericht.getGegevens().setOmschrijvingLocatieEinde(new OmschrijvingEnumeratiewaarde("----"));
