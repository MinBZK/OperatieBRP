...
public class RelatieJpaRepository implements RelatieRepository {
                                                                     ...
                                                                     final SoortRelatie... soorten)
    {
        ...
        Integer vandaag = Integer.parseInt(format.format(new Date()));
        ...
        queryStr.append("((SELECT be FROM PersistentBetrokkenheid be WHERE be.betrokkene = :ouder1 AND be.relatie = ")
                ...
                .append("AND (relaties.datumAanvang IS NULL OR relaties.datumAanvang <= :vandaag) ")
                .append("AND (relaties.datumEinde IS NULL OR relaties.datumEinde > :vandaag) ")
        ...
        query.setParameter("vandaag", vandaag);
