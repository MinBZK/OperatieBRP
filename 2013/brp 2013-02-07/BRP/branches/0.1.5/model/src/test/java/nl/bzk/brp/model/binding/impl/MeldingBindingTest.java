...
public class MeldingBindingTest extends AbstractBindingUitTest<Melding> {
    ...
    private String getMeldingResultaat2() {
        ...
        sb.append("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>");
        sb.append("<melding xmlns=\"http://www.bprbzk.nl/BRP/0001\" xmlns:xsi=\"http://www.w3"
            + ".org/2001/XMLSchema-instance\" cIDVerzendend=\"Any string will do\">");
        sb.append("<regelCode>BRBER00121</regelCode>");
        sb.append("<soortCode>I</soortCode>");
        sb.append("<melding>")
            .append(MeldingCode.BRBER00121.getOmschrijving()).append("</melding>")
            .append("<attribuutNaam>MijnAttribuut</attribuutNaam>")
            .append("</melding>");
        return sb.toString();
    }
