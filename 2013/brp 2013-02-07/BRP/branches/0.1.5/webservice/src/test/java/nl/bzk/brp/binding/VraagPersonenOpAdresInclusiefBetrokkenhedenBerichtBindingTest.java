        ...
        AbstractBindingInTest<VraagPersonenOpAdresInclusiefBetrokkenhedenBericht>
{
    ...
    public void testBindingMaxBericht() throws JiBXException, IOException {
        ...
        Assert.assertEquals("0034", vraag.getGemeenteCode());
        Assert.assertEquals("nor", vraag.getNaamOpenbareRuimte());
        Assert.assertEquals("12", vraag.getHuisnummer());
        Assert.assertEquals("A", vraag.getHuisletter());
        Assert.assertEquals("I", vraag.getHuisnummertoevoeging());
        Assert.assertEquals("1066DG", vraag.getPostcode());
    }
