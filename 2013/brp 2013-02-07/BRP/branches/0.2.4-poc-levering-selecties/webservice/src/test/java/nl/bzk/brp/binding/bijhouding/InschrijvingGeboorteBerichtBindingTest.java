    ...
    extends AbstractBindingInIntegratieTest<InschrijvingGeboorteBericht>
{
    ...
    private void checkAlleVerzendedIds(final AbstractBijhoudingsBericht bericht) {
        ...
        if (bericht.getBerichtStuurgegevensGroep() != null) {
            BerichtStuurgegevensGroepBericht stuurgegevensGroepBericht =
                    (BerichtStuurgegevensGroepBericht) bericht.getBerichtStuurgegevensGroep();
            Assert.assertTrue(StringUtils.isNotBlank(stuurgegevensGroepBericht.getVerzendendId()));
        }
