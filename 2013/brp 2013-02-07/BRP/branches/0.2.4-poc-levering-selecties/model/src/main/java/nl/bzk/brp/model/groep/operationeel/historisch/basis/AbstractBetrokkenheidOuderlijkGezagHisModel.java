...
public abstract class AbstractBetrokkenheidOuderlijkGezagHisModel extends AbstractBetrokkenheidOuderlijkGezagGroep
    implements MaterieleHistorie
{

    @Id
    @SequenceGenerator(name = "hisBetrouderlijkgezag", sequenceName = "Kern.seq_his_betrouderlijkgezag")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "hisBetrouderlijkgezag")
    @JsonProperty
    private Long id;
     ...
     *
     * @param betrokkenheidOuderlijkGezagGroep de ouderlijk gezag groep waarvan de waardes moeten worden overgenomen.
     * @param betrokkenheidModel de betrokkenheid waarvoor deze groep geldt.
     */
    protected AbstractBetrokkenheidOuderlijkGezagHisModel(
    ...
    {
        super(betrokkenheidOuderlijkGezagGroep);
        betrokkenheid = betrokkenheidModel;
        if (betrokkenheidOuderlijkGezagGroep instanceof AbstractBetrokkenheidOuderlijkGezagHisModel) {
            historie =
                new MaterieleHistorieImpl(
                    ((AbstractBetrokkenheidOuderlijkGezagHisModel) betrokkenheidOuderlijkGezagGroep)
                        .getHistorie());
    ...
    /**
     * Retourneert de materiele historie.
     *
     * @return de materiele historie.
     */
