        ...
        FormeleHistorie
{
    ...
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "HisPersOverlijden")
    private Long                id;
     ...
     *
     * @param persoonOverlijdenGroep de (blauwdruk) groep van overlijden waaruit de initiele waardes worden gekopieerd.
     * @param persoonModel de persoon waarvoor de overlijden groep geldt.
     */
