    ...
    AbstractPersoonBijhoudingsverantwoordelijkheidGroep implements MaterieleHistorie
{
    ...
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "hisPersBijhverantwoordelijk")
    private Long                  id;
     ...
     *
     * @param persoonBijhoudingsverantwoordelijkheidGroep groep waaruit de waardes worden gekopieerd.
