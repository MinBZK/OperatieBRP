 ...
 */
@Embeddable
public final class RedenVerkrijgingNaam extends AbstractGegevensAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RedenVerkrijgingNaam() {
        super(null);
    }
     ...
     */
    @JsonCreator
    public RedenVerkrijgingNaam(final String waarde) {
        super(waarde);
    }
}
