...
import nl.bzk.brp.model.groep.operationeel.historisch.basis.AbstractPersoonOverlijdenHisModel;
...
public class PersoonOverlijdenHisModel extends AbstractPersoonOverlijdenHisModel {
    ...
    public PersoonOverlijdenHisModel kopieer() {
        return new PersoonOverlijdenHisModel(this, getPersoon());
    }
}
