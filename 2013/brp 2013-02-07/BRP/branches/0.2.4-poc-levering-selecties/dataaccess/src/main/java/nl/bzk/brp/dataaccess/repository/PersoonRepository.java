...
public interface PersoonRepository {
    ...
    /**
     * Haal de technische sleutel van een Persoon op a.d.h.v. BSN.
     *
     * @param bsn Burgerservicenummer van de te zoeken persoon
     * @return technische sleutel van de persoon
     */
    Integer haalPersoonIdOp(Burgerservicenummer bsn);
    ...
    void werkbijOverlijden(final PersoonModel persoon, final PersoonOverlijdenGroep overlijden,
            ...
            final ActieModel actie, final Datum datumAanvangGeldigheid);
    /**
     * Vul aan adres met adres historie.
     * @param persoon .
    ...
    /**
     * Werk bij de persoon tijdstip laatste wijziging in de groep afgeleid administratief.
     * @param persoon de persoon.
     * @param tijdstip de tijdstip.
     */
    void werkbijTijsptipLaastWijziging(final PersoonModel persoon, final DatumTijd tijdstip);
