    ...
    Y extends FormeleHistorie> implements GroepFormeleHistorieRepository<T>
{
    ...
    /**
     * TODO: kopie van andere repository implementatie
     * @see AbstractGroepHistorieRepository#haalopHistorie(nl.bzk.brp.model.basis.AbstractDynamischObjectType, boolean)
     */
    public List<Y> haalopHistorie(final T objectType, final boolean inclFormeleHistorie) {
        ...
        return entityManager.createQuery(
                "SELECT hpa FROM "
                        ...
                        + filter
                        + " ORDER BY hpa.historie.datumTijdVerval DESC, hpa.id DESC "
                , getCLaagDomainClass())
