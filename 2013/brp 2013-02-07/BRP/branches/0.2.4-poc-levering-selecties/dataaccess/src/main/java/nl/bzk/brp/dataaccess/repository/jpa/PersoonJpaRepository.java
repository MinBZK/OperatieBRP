...
public class PersoonJpaRepository implements PersoonRepository {
    ...
    @Override
    public Integer haalPersoonIdOp(final Burgerservicenummer bsn) {
        TypedQuery<Integer> tQuery =
                em.createQuery("SELECT persoon.id FROM PersoonModel persoon"
                                       + " WHERE identificatienummers.burgerservicenummer = :burgerservicenummer", Integer.class);
