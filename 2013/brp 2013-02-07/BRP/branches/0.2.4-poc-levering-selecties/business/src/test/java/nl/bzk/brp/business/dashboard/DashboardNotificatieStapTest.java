...
public class DashboardNotificatieStapTest {
    ...
    public void testVoorverwerking() {
        ...
        ArgumentCaptor<AbstractBijhoudingsBericht> berichtArgument = ArgumentCaptor.forClass(AbstractBijhoudingsBericht.class);
    ...
    public void testGeboorteBericht() {
        ...
        ArgumentCaptor<BerichtVerwerkingsResultaat> resultaatArgument = ArgumentCaptor.forClass(BerichtVerwerkingsResultaat.class);
