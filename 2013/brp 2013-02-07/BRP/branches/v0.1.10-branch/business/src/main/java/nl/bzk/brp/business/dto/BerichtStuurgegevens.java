...
public class BerichtStuurgegevens implements Identificeerbaar {
    ...
    private JaNee   prevalidatieBericht;
    ...
    public BerichtStuurgegevens(final String organisatie, final String applicatie, final String referentienummer,
            final String crossReferentienummer, final JaNee prevalidatieBericht)
    {
        ...
        if (prevalidatieBericht == null) {
            this.prevalidatieBericht = JaNee.Nee;
        } else {
    ...
    public JaNee getPrevalidatieBericht() {
        return prevalidatieBericht;
    }

    public void setPrevalidatieBericht(final JaNee prevalidatieBericht) {
        this.prevalidatieBericht = prevalidatieBericht;
    }
    ...
    public boolean isPrevalidatieBericht() {
        ...
        if (prevalidatieBericht == null
            || prevalidatieBericht == JaNee.Nee)
        {
            isPrevalidatieBericht = false;
        } else {
            isPrevalidatieBericht = true;
        }
