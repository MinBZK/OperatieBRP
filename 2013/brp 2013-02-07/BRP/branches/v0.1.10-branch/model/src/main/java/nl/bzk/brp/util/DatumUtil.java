...
public final class DatumUtil {
    ...
    private static final FastDateFormat DATUM_FORMAAT = FastDateFormat.getInstance("yyyyMMdd");
...
//        if (null == datumAanvangPeriode && null == datumEindePeriode) {
//            geldig = true;
//        } else if (null == datumAanvangPeriode && null != datumEindePeriode) {
//            // peil datum op einde periode is ook fout; het is TOT en NIET t/m
//            geldig = (peil < eindePeriode);
//        } else if (null != datumAanvangPeriode && null == datumEindePeriode) {
//            // peil datum op begin periode is ook goed; het is vanaf (inclusief)
//            geldig = (peil >= aanvangPeriode);
//        } else {
//            geldig = (datumAanvangPeriode.getWaarde() <= peilDatum.getWaarde())
//                    && (peilDatum.getWaarde() < datumEindePeriode.getWaarde());
//        }
        return geldig;
    }
