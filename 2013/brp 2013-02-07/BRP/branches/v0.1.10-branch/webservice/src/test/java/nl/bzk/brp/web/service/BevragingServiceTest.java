...
import nl.bzk.brp.business.dto.bevraging.BevragingsBericht;
...
public class BevragingServiceTest extends AbstractWebServiceTest<BevragingsBericht, OpvragenPersoonResultaat> {
    ...
    public void testOpvragenDetailPersoon() {
        initMocks(VraagDetailsPersoonBericht.class);
        initBerichtVerwerker(new ArrayList<Melding>(), OpvragenPersoonResultaat.class, true);

        VraagDetailsPersoonAntwoord resultaat =
    ...
    public void testOpvragenPersonenOpAdresInclusiefBetrokkenheden() {
        initMocks(VraagPersonenOpAdresInclusiefBetrokkenhedenBericht.class);
        initBerichtVerwerker(new ArrayList<Melding>(), OpvragenPersoonResultaat.class, true);

        VraagPersonenOpAdresInclusiefBetrokkenhedenAntwoord resultaat =
    ...
    @Override
    protected AbstractWebService<BevragingsBericht, OpvragenPersoonResultaat> getNieuweWebServiceVoorTest() {
