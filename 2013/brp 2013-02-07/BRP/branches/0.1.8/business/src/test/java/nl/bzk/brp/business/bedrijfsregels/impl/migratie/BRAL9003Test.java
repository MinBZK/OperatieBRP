...
public class BRAL9003Test {
    ...
    public void testHuidigeSituatieGeenOpschorting() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20150101));
    ...
    public void testHuidigeSituatieLeeg() {
        List<Melding> meldingen = bral9003.executeer(null, null, new Datum(20150101));
    ...
    public void testHuidigeSituatieWelOpschortingMaarGeenOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon0, nieuweSituatie, new Datum(20150101));
    ...
    public void testWijzigingDatumVoorOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120504));
    ...
    public void testWijzigingDatumOpOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120505));
    ...
    public void testWijzigingDatumNaOpschortingDatum() {
        ...
        List<Melding> meldingen = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120506));
