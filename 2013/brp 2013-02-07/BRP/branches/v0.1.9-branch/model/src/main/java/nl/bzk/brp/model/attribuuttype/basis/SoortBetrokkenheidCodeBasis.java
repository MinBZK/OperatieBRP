...
/**
 * SoortBetrokkenheidCodeBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class SoortBetrokkenheidCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SoortBetrokkenheidCodeBasis() {
        super(null);
    }
     ...
     */
    public SoortBetrokkenheidCodeBasis(final String waarde) {
        super(waarde);
    }
}
