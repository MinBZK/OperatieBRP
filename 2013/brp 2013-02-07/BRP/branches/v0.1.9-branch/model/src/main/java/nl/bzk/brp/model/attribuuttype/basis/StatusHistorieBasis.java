...
public abstract class StatusHistorieBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private StatusHistorieBasis() {
        super(null);
    }
     ...
     */
    public StatusHistorieBasis(final String waarde) {
        super(waarde);
    }
}
