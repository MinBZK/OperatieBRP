...
/**
 * GeslachtsnaamcomponentBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class GeslachtsnaamcomponentBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private GeslachtsnaamcomponentBasis() {
        super(null);
    }
     ...
     */
    public GeslachtsnaamcomponentBasis(final String waarde) {
        super(waarde);
    }
}
