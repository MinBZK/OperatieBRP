...
public class BRBY0118Test {
    ...
    public void testGeenAdresgevendAdres() {
        ...
        List<Melding> meldingen = brby0118.executeer(null, nieuweSituatie, new Datum(20120101), null);
    ...
    public void testAdresgevendPersoonMetAdres() {
        ...
        Assert.assertEquals("P", persoonAdres.getGegevens().getRedenWijziging().getRedenWijzigingAdresCode().getWaarde());
