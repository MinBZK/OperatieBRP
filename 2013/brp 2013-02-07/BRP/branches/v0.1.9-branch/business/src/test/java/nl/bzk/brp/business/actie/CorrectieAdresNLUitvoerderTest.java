...
public class CorrectieAdresNLUitvoerderTest {
    ...
    private AbstractActieUitvoerder        correctieAdresNLUitvoerder;
    ...
    public void init() {
        ...
        correctieAdresNLUitvoerder = new CorrectieAdresNLUitvoerder();
        ReflectionTestUtils.setField(correctieAdresNLUitvoerder, "persoonAdresRepository", persoonAdresRepository);
        ReflectionTestUtils.setField(correctieAdresNLUitvoerder, "correctieAdresNLActieValidator",
                correctieAdresNLActieValidator);
        ReflectionTestUtils.setField(correctieAdresNLUitvoerder, "persoonRepository", persoonRepository);
        ReflectionTestUtils.setField(correctieAdresNLUitvoerder, "actieRepository", actieRepository);
    ...
    public void testVoerUitZonderFouten() {
        ...
        Mockito.verify(persoonAdresRepository, Mockito.times(1)).voerCorrectieAdresUit(
