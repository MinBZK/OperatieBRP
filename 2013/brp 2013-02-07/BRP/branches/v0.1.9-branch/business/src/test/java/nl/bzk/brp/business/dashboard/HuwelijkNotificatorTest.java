...
public class HuwelijkNotificatorTest {
    ...
    public void init() throws URISyntaxException {
        ...
        notificator
            .setDashboardUri(new URI("http://localhost:8080/brp-dashboard/service/berichten/opslaan/huwelijk"));
    ...
    public void testHuwelijkBericht() throws Exception {
        ...
        PersoonBericht partner1 = PersoonBuilder.bouwPersoon("321432543", Geslachtsaanduiding.MAN, 19660417,
            StatischeObjecttypeBuilder.bouwGemeente((short) 0344, null), "Ab", "de", "Vis");
        PersoonAdresBericht adresPartner1 = PersoonAdresBuilder.bouwWoonadres("Brink", 11, "1234AA",
        ...
        adresPartner1.getGegevens().setHuisnummertoevoeging(new Huisnummertoevoeging("B"));
        List<PersoonAdresBericht> adressenPartner1 = new ArrayList<PersoonAdresBericht>();
        adressenPartner1.add(adresPartner1);
        partner1.setAdressen(adressenPartner1);
        ...
        PersoonBericht partner2 = PersoonBuilder.bouwPersoon("987654321", Geslachtsaanduiding.MAN, 19660417,
            StatischeObjecttypeBuilder.bouwGemeente((short) 344, null), "Ab", "de", "Vis");
        PersoonAdresBericht adrespartner2 = PersoonAdresBuilder.bouwWoonadres("Brink", 11, "1234AA",
            StatischeObjecttypeBuilder.bouwWoonplaats((short) 747, "Vollenhoven"),
            StatischeObjecttypeBuilder.bouwGemeente((short) 355, "Zeist"), 20120515);
        adrespartner2.getGegevens().setHuisnummertoevoeging(new Huisnummertoevoeging("B"));
        List<PersoonAdresBericht> adressenpartner2 = new ArrayList<PersoonAdresBericht>();
        adressenpartner2.add(adrespartner2);
        partner2.setAdressen(adressenpartner2);
