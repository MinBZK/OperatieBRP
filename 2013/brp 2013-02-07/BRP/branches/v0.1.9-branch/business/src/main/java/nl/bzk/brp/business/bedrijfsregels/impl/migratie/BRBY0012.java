 ...
 *
 */
public class BRBY0012 implements BedrijfsRegel<Persoon> {
            ...
            final Datum datumAanvangGeldigheid, final Datum datumEindeGeldigheid)
    {
        ...
        if (datumEindeGeldigheid != null && DatumUtil.vandaag().voor(datumEindeGeldigheid)) {
            meldingen.add(new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRBY0012,
                    (PersoonBericht) nieuweSituatie, "datumEindeGeldigheid"));
        }
