...
SELECT SETVAL('kern.seq_his_betrouderschap', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_betrouderschap"), true);
SELECT SETVAL('kern.seq_his_betrouderlijkgezag', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_betrouderlijkgezag"), true);
...
SELECT SETVAL('kern.seq_his_persbijhverantwoordelijk', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_persbijhverantwoordelijk"), true);
