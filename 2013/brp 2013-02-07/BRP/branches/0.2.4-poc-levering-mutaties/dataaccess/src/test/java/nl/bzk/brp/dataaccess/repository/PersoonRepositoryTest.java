...
//                }
    ...
    public void testHaalPersonenMetWoonAdresOpViaVolledigAdres() {
        Plaats plaats = referentieDataRepository.vindWoonplaatsOpCode(new PlaatsCode((short) 34));
    ...
    public void testOpslaanNieuwPersoon() {
        ...
        Assert.assertEquals(new Administratienummer(Long.valueOf(1114567890L)),
...
//        Assert.assertEquals(StatusHistorie.A, persoon.getInschrijving().getStatusHistorie());
    ...
    public void testWerkbijOverlijden() {
        ActieModel actie = maakActie(SoortActie.AANGIFTE_OVERLIJDEN);
        PersoonModel persoon = em.find(PersoonModel.class, 1);
        Assert.assertNotNull(persoon);
        ...
        Assert.assertEquals(1301, persoon.getOverlijden().getWoonplaatsOverlijden().getId().intValue());
        Assert.assertEquals(4, persoon.getOverlijden().getOverlijdenGemeente().getId().intValue());
        Assert.assertEquals(2, persoon.getOverlijden().getLandOverlijden().getId().intValue());

        // test de C-Laag
        List<PersoonOverlijdenHisModel>  hisOverlijden = em.createQuery(
            "SELECT his FROM PersoonOverlijdenHisModel his where his.persoon = :pers",
                PersoonOverlijdenHisModel.class)
        ...
        Assert.assertEquals(1301, hisOverlijden.get(0).getWoonplaatsOverlijden().getId().intValue());
        Assert.assertEquals(4, hisOverlijden.get(0).getOverlijdenGemeente().getId().intValue());
        Assert.assertEquals(2, hisOverlijden.get(0).getLandOverlijden().getId().intValue());
        Assert.assertEquals(null, hisOverlijden.get(0).getDatumTijdVerval());
        Assert.assertEquals(actie.getTijdstipRegistratie(), hisOverlijden.get(0).getDatumTijdRegistratie());
    }
    ...
    public void testWerkbijOverlijdenBuitenland1() {
        ...
        Assert.assertEquals(null, persoon.getOverlijden().getOverlijdenGemeente());
        Assert.assertEquals(5, persoon.getOverlijden().getLandOverlijden().getId().intValue());
        Assert.assertEquals("BuitenlandsePlaats", persoon.getOverlijden().getBuitenlandsePlaatsOverlijden().getWaarde());
        ...
        Assert.assertEquals(null, hisOverlijden.get(0).getOverlijdenGemeente());
        Assert.assertEquals(5, hisOverlijden.get(0).getLandOverlijden().getId().intValue());
...
//      printHistorie(aanHisListDLaag, "D-Laag");
                ...
                PersoonIdentificatienummersGroep idnrs = new PersoonIdentificatienummersGroepModel(
                        new PersoonIdentificatienummersGroepBasis()
                    {
                        ...
                        public Administratienummer getAdministratienummer() {
                            return new Administratienummer(Long.valueOf(1114567890L));
                        }
                    });
                return idnrs;
            }
            ...
            public PersoonGeboorteGroep getGeboorte() {
                return new PersoonGeboorteGroep() {
                    ...
                    public Plaats getWoonplaatsGeboorte() {
                        return referentieDataRepository.vindWoonplaatsOpCode(new PlaatsCode((short) 34));
                    }
    ...
    private ActieModel maakActie(final SoortActie soortActie) {
        ...
        ActieModel actie = new ActieModel(new ActieBasis() {
            ...
            @Override
            public List<? extends Bron> getBronnen() {
                return null;
            }
