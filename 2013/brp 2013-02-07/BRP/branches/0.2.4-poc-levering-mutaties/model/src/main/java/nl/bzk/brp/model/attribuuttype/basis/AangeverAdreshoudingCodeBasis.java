...
/**
 * AangeverAdreshoudingCodeBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class AangeverAdreshoudingCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private AangeverAdreshoudingCodeBasis() {
        super(null);
    }
     ...
     */
    public AangeverAdreshoudingCodeBasis(final String waarde) {
        super(waarde);
    }
}
