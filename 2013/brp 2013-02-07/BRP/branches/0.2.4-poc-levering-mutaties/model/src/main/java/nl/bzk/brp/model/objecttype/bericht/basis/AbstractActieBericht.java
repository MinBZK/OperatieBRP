...
public abstract class AbstractActieBericht extends AbstractObjectTypeBericht
		implements ActieBasis {
	...
	public Verdrag getVerdrag() {
		throw new UnsupportedOperationException(
				"VerdragWeb moet gebouwd worden.");
	}
	...
	public void setOntleningstoelichting(
			final Ontleningstoelichting ontleningstoelichting) {
		this.ontleningstoelichting = ontleningstoelichting;
	}

	public void setTijdstipVerwerkingMutatie(
			final DatumTijd tijdstipVerwerkingMutatie) {
