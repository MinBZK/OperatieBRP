...
/**
 * DocumentOmschrijvingBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class DocumentOmschrijvingBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private DocumentOmschrijvingBasis() {
        super(null);
    }
     ...
     */
    public DocumentOmschrijvingBasis(final String waarde) {
        super(waarde);
    }
}
