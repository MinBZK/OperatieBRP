...
public abstract class VoorvoegselBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private VoorvoegselBasis() {
        super(null);
    }
     ...
     */
    public VoorvoegselBasis(final String waarde) {
        super(waarde);
    }
}
