...
import nl.bzk.brp.model.objecttype.operationeel.statisch.CategorieSoortDocument;
...
public final class StatischeObjecttypeBuilder {
    ...
    public static final Land LAND_BELGIE = bouwLand((short) 5010, "Belgie");
    ...
    public static final SoortDocument OVERLIJDEN_AKTE = bouwSoortDocument("Overlijdenakte",
            CategorieSoortDocument.NEDERLANDSE_AKTE);
    public static final SoortDocument BUITENLANDS_AKTE = bouwSoortDocument("Buitelandsakte",
            CategorieSoortDocument.BUITENLANDSE_AKTE);
    ...
    public static SoortDocument bouwSoortDocument(final String naam, final CategorieSoortDocument categorie) {
        final SoortDocument soort = new SoortDocument();
        ReflectionTestUtils.setField(soort, "naam", new Naam(naam));
        ReflectionTestUtils.setField(soort, "categorieSoortDocument", categorie);
        return soort;
    }
}
