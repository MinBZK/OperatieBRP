 ...
 */
public abstract class AbstractBerichtVerwerkingsStap {

    public static enum StapResultaat {STOP_VERWERKING, DOORGAAN_MET_VERWERKING}
     ...
     */
    public abstract StapResultaat voerVerwerkingsStapUitVoorBericht(final LevMutAdmHandBerichtContext context);
