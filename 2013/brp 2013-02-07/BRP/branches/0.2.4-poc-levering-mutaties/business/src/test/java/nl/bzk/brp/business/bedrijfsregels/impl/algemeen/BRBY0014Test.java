...
public class BRBY0014Test {
    ...
    public void init() {
        ...
        Mockito.when(persoonRepository.isBSNAlIngebruik(new Burgerservicenummer(BESTAAND_BSN_1)))
               .thenReturn(true);
        Mockito.when(persoonRepository.isBSNAlIngebruik(new Burgerservicenummer(BESTAAND_BSN_2)))
               .thenReturn(true);
    ...
    public void testPersoonMetNietBestaandBsn() {
        ...
        Assert.assertEquals("Onverwachte melding tekst",
            "De gevraagde persoon met BSN 111111111 komt niet voor in het systeem.",
    ...
    public void testPersoonMetLegeBsn() {
        ...
        Assert.assertEquals("Onverwachte meldingcode", MeldingCode.BRBY0014, meldingen.get(0).getCode());
        Assert.assertEquals("Onverwachte melding tekst",
            "De gevraagde persoon met BSN  komt niet voor in het systeem.",
            meldingen.get(0).getOmschrijving());
    }
    ...
    public void testRelatieMetTweeNietBestaandeBsns() {
        ...
        Assert.assertEquals("Onverwachte melding tekst",
            ...
            meldingen.get(0).getOmschrijving());
        Assert.assertEquals("Onverwachte melding tekst",
            "De gevraagde persoon met BSN 222222222 komt niet voor in het systeem.",
