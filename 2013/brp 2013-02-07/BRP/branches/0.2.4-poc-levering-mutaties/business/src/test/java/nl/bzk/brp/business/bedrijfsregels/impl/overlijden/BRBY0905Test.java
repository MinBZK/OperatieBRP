...
public class BRBY0905Test {
    ...
    public void testCorrectePeriodeGemeenteGeenPeriode() {
        ...
        List<Melding> meldingen =
            brby0905.executeer(null, maakPersoonOverlijden(maakPlaats((short) 24, "plaats", null, null), 20120303),
    ...
    public void testCorrectePeriodeActieZonderDatums() {
        List<Melding> meldingen =
            brby0905.executeer(null, maakPersoonOverlijden(maakPlaats((short) 24, "plaats", 19000101, null), 19000101),
    ...
    public void testNietCorrectePeriode() {
        List<Melding> meldingen =
                brby0905.executeer(null, maakPersoonOverlijden(maakPlaats((short) 24, "gemeente", 19000101, 19000110), 19000110),
    ...
    private Plaats maakPlaats(final short code, final String naam, final Integer begin, final Integer eind) {
        Plaats plaats = new Plaats();
        plaats.setNaam(new Naam(naam));
        plaats.setCode(new PlaatsCode(code));
        if (begin != null) {
            plaats.setDatumAanvang(new Datum(begin));
        }
        if (eind != null) {
            plaats.setDatumEinde(new Datum(eind));
        }
