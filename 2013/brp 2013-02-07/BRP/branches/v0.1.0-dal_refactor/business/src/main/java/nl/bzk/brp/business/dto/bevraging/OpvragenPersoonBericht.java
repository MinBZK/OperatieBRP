...
public class OpvragenPersoonBericht implements BRPBericht {
    ...
    /**
     * Retourneert het tijdstip verzonden als {@link Date} instantie.
     * @return het tijdstip verzonden als {@link Date} instantie.
     */
    public Date getTijdstipVerzondenDate() {
        Date resultaat;
        if (tijdstipVerzonden == null) {
            resultaat = null;
        } else {
            resultaat = tijdstipVerzonden.getTime();
        }
        return resultaat;
    }
