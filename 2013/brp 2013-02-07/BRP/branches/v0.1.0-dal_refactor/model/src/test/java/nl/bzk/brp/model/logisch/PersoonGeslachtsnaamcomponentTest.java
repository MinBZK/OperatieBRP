...
public class PersoonGeslachtsnaamcomponentTest {
    ...
    public void testHashCode() {
        ...
        Assert.assertFalse(
            bouwNaamComponent("Test", 1, "vv", persoon).hashCode() == bouwNaamComponent("Test", 1, "aa", persoon)
                .hashCode());
        Assert.assertFalse(
                bouwNaamComponent("Test", 1, "vv", persoon, "/", Predikaat.HOOGHEID, null).hashCode()
                    == bouwNaamComponent("Test", 2, "vv", persoon, "-", Predikaat.HOOGHEID, null)
                    .hashCode());
        Assert.assertFalse(
                bouwNaamComponent("Test", 1, "vv", persoon, "-", Predikaat.JONKHEER, null).hashCode()
                    == bouwNaamComponent("Test", 2, "vv", persoon, "-", Predikaat.JONKHEER, null)
                    .hashCode());
        Assert.assertFalse(
                bouwNaamComponent("Test", 1, "vv", persoon, "-", Predikaat.JONKHEER, AdellijkeTitel.GRAAF).hashCode()
                    == bouwNaamComponent("Test", 2, "vv", persoon, "-", Predikaat.JONKHEER, null)
                    .hashCode());
        Assert.assertFalse(
    ...
    private PersoonGeslachtsnaamcomponent bouwNaamComponent(final String naam, final int volgNummer,
            final String voorvoegsel, final Persoon persoon, final String scheidingsTeken, final Predikaat predikaat, final AdellijkeTitel adellijkeTitel)
        {
