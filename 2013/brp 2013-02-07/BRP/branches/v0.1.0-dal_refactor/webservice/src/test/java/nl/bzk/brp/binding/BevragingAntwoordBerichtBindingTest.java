...
//TODO wordt weggegooid! Bevraging nieuwe XSD's in de pijplijn.
@Ignore
public class BevragingAntwoordBerichtBindingTest extends AbstractBerichtBindingUitTest<BevragingAntwoordBericht> {

    @Override
    public Class<BevragingAntwoordBericht> getBindingClass() {
    ...
    public void testOutBindingMetLeegResultaat() throws JiBXException {
        ...
        Assert.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
            + "<OpvragenPersoonResultaat xmlns=\"http://www.bprbzk.nl/BRP/0001\" "
            //+ "xmlns:bas=\"http://www.bprbzk.nl/BRP/basis\" "
    ...
    public void testOutBindingMetPersoonInResultaat() throws JiBXException {
        ...
        Assert.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
            + "<OpvragenPersoonResultaat xmlns=\"" + NAMESPACE_BRP + "\" "
            + "xmlns:bas=\"http://www.bprbzk.nl/BRP/basis\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
            + "<aantal>1</aantal>"
            + "<antwoord>"
            + "<persoon>"
