...
public class InschrijvingGeboorteBerichtBindingTest extends AbstractBindingInTest<InschrijvingGeboorteBericht> {
    ...
    public void testBindingMinBericht() throws IOException, JiBXException {
        ...
        Assert.assertEquals("6039", kind.getGeboorte().getLandGeboorteCode().getWaarde());
    ...
    private void checkIdentificatieNummersEnGeslacht(final PersoonBericht kind, final String bsn, final String aNummer,
    ...
    private void checkGeboorte(final PersoonBericht kind, final int datumGeboorte) {
        ...
        Assert.assertEquals("1111", geboorte.getGemeenteGeboorteCode().getWaarde());
        Assert.assertNull(geboorte.getWoonplaatsGeboorte());
        Assert.assertEquals("1111", geboorte.getWoonplaatsGeboorteCode().getWaarde());
        ...
        Assert.assertEquals("1111", geboorte.getLandGeboorteCode().getWaarde());
            ...
            final String rdnVerkrijging, final String rdnVerlies)
    {
        ...
        Assert.assertEquals(rdnVerkrijging, persoonNationaliteit.getGegevens().getRedenVerkregenNlNationaliteitNaam()
                .getWaarde());
    ...
    private void checkAlleVerzendedIds(final PersoonBericht persoon) {
        ...
        if (persoon.getBijhoudenGemeente() != null) {
            Assert.assertTrue(StringUtils.isNotBlank(persoon.getBijhoudenGemeente().getVerzendendId()));
        }
