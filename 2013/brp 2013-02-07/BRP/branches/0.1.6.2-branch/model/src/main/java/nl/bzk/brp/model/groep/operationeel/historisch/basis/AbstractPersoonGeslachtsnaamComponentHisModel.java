...
public abstract class AbstractPersoonGeslachtsnaamComponentHisModel extends
        AbstractPersoonGeslachtsnaamCompStandaardGroep implements MaterieleHistorie
{
    ...
    {
        super(persoonGeslachtsnaamCompStandaardGroep);
        persoonGeslachtsnaamcomponent = geslachtsnaamComponentModel;
        if (persoonGeslachtsnaamCompStandaardGroep instanceof AbstractPersoonGeslachtsnaamComponentHisModel) {
            historie = new MaterieleHistorieImpl(
                    ((AbstractPersoonGeslachtsnaamComponentHisModel) persoonGeslachtsnaamCompStandaardGroep).getHistorie()
            );
        } else {
            historie = new MaterieleHistorieImpl();
        }
