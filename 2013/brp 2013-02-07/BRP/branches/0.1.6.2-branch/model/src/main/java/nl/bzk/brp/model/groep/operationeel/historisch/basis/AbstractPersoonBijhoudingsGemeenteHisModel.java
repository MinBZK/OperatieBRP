...
public abstract class AbstractPersoonBijhoudingsGemeenteHisModel extends AbstractPersoonBijhoudingsGemeenteGroep
        implements MaterieleHistorie
{

    @Id
    @SequenceGenerator(name = "hisPersBijhgem", sequenceName = "Kern.seq_His_PersBijhgem")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "hisPersBijhgem")
    private Long                  id;
    ...
    /**
     * copy constructor .
     * @param persoonBijhoudingsGemeenteGroep het ander object.
     * @param persoonModel de persoon.
     */
    protected AbstractPersoonBijhoudingsGemeenteHisModel(
            ...
            final PersoonModel persoonModel)
    {
        ...
        if (persoonBijhoudingsGemeenteGroep instanceof AbstractPersoonBijhoudingsGemeenteHisModel) {
            historie = new MaterieleHistorieImpl(
                    ((AbstractPersoonBijhoudingsGemeenteHisModel) persoonBijhoudingsGemeenteGroep).getHistorie()
            );
        } else {
            historie = new MaterieleHistorieImpl();
        }
     ...
     *default constructor.
     */
    public AbstractPersoonBijhoudingsGemeenteHisModel() {
        super();
    }
