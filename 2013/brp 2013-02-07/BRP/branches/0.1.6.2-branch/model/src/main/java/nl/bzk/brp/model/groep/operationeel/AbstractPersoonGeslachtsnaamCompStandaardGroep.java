...
public abstract class AbstractPersoonGeslachtsnaamCompStandaardGroep extends AbstractGroep implements
        PersoonGeslachtsnaamCompStandaardGroepBasis
{
     ...
     */
    protected AbstractPersoonGeslachtsnaamCompStandaardGroep() {
    ...
    {
        predikaat = persoonGeslachtsnaamCompStandaardGroepBasis.getPredikaat();
        adellijkeTitel = persoonGeslachtsnaamCompStandaardGroepBasis.getAdellijkeTitel();
        voorvoegsel = persoonGeslachtsnaamCompStandaardGroepBasis.getVoorvoegsel();
        scheidingsteken = persoonGeslachtsnaamCompStandaardGroepBasis.getScheidingsteken();
        geslachtsnaamComponent = persoonGeslachtsnaamCompStandaardGroepBasis.getNaam();
    }
