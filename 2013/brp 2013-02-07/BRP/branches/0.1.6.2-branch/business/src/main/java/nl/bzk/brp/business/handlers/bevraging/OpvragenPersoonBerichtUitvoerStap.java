        ...
        AbstractBerichtVerwerkingsStap<BRPBericht, OpvragenPersoonResultaat>
{
            ...
            final OpvragenPersoonResultaat resultaat)
    {
        final PersoonModel gevondenPersoon =
            persoonMdlRepository.haalPersoonOpMetBurgerservicenummer(bericht.getVraag()
            ...
            final VraagPersonenOpAdresInclusiefBetrokkenhedenBericht bericht, final OpvragenPersoonResultaat resultaat)
    {
        ...
        if (isBsnCriteria(bericht)) {
            gevondenPersonen =
                persoonMdlRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(bericht
            ...
            final OpvragenPersoonResultaat resultaat)
    {
        ...
        PersoonModel moeder =
            persoonMdlRepository.findByBurgerservicenummer(bericht.getVraag().getZoekCriteria()
        ...
        if (moeder == null) {
            ...
            List<Long> persoonIds = relatieMdlRepository.haalopPersoonIdsVanRelatiesVanPersoon(moeder.getId(), filter);
