...
public class AuthenticatieMiddelRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testZoekAuthMiddelenVoorPartijMetCertificaat() {
        final Partij partij = em.find(Partij.class, 4);
        List<AuthenticatieMiddelModel> authenticatieMiddelen =
            authenticatieMiddelRepository.zoekAuthMiddelenVoorPartijMetCertificaat(partij, new Subject("CN=Test"),
                    new Serial(new BigInteger("1323167436")), new Signature(
