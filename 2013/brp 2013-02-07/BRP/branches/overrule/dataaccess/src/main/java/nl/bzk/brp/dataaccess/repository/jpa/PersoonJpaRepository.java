...
public class PersoonJpaRepository implements PersoonRepository {
            ...
            final String locatieOmschrijving, final String locatietovAdres, final Plaats woonplaats)
    {
        ...
        List<PersistentPersoon> persistentPersonen =
            haalPersonenOpViaQuery(query.toString(),
                    new NameValue("naamOpenbareRuimte", StringUtils.upperCase(naamOpenbareRuimte)), new NameValue(
                            "huisnummer", huisnummer), new NameValue("huisletter", StringUtils.upperCase(huisletter)),
                    new NameValue("huisnummertoevoeging", StringUtils.upperCase(huisnummertoevoeging)), new NameValue(
                            "locatieOmschrijving", StringUtils.upperCase(locatieOmschrijving)),
    ...
    private void vulAanGeboorte(final Persoon persoon, final PersistentPersoon persistentPersoon) {
        ...
        if (persoon.getGeboorte().getWoonplaatsGeboorte().getWoonplaatscode() != null) {
            persistentPersoon.setWoonplaatsGeboorte(referentieDataRepository.findWoonplaatsOpCode(persoon.getGeboorte()
            ...
            final Date datumTijdRegistratie, final Integer datumAanvangGeldigheid)
    {
        ...
        for (PersistentPersoonAdres persoonAdres : ppersoon.getAdressen()) {
            persoonAdresHistorieRepository.opslaanHistorie(persoonAdres, datumAanvangGeldigheid,
                    null, datumTijdRegistratie);
        }
        ...
        hisPersoonInschrijving.setDatInschr(datumAanvangGeldigheid);
