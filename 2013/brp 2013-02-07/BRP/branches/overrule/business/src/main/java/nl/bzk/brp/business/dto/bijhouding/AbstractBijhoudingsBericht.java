...
public abstract class AbstractBijhoudingsBericht extends AbstractBRPBericht implements BRPBericht {
    ...
    /**
     * .
     * @param overruledMelding .
     */
    public void voegOverruledMeldingToe(final OverruleMelding overruledMelding) {
        if ((null != overruledMelding) && (!overruledMeldingen.contains(overruledMelding))) {
            overruledMeldingen.add(overruledMelding);
        }
    }
