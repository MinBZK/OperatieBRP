...
public class AlgemeneAbstractGroepHistorieRepositoryTest extends AbstractRepositoryTestCase {
    ...
    @Inject
    private GroepHistorieRepository<PersoonModel, AbstractPersoonAanschrijvingGroep, PersoonAanschrijvingHisModel>
    persoonAanschrijvingHistorieRepository;
...
//        List<PersoonAanschrijvingHisModel> hisPersoonAanschrijvingen =
//                em.createQuery("select hpa FROM PersoonAanschrijvingHisModel hpa "
//                    + " order by hpa.historie.datumTijdVerval desc, "
//                    + " hpa.historie.datumAanvangGeldigheid desc, "
//                    + "hpa.historie.datumTijdRegistratie" ,
//                PersoonAanschrijvingHisModel.class).getResultList();
//        for (PersoonAanschrijvingHisModel his : hisPersoonAanschrijvingen) {
//            System.out.printf("%d= %d-%d, %d-%d %s\n",
//                    his.getId(), his.getHistorie().getDatumAanvangGeldigheid().getWaarde()
//                    , (null == his.getHistorie().getDatumEindeGeldigheid()) ?
//                            0 : his.getHistorie().getDatumEindeGeldigheid().getWaarde()
//                    , his.getHistorie().getDatumTijdRegistratie().getWaarde().getTime()
//                    , (null == his.getHistorie().getDatumTijdVerval()) ?
//                            0 : his.getHistorie().getDatumTijdVerval().getWaarde().getTime()
//                    , his.getGeslachtsnaam().getWaarde()
//            );
//        }
//    }
    ...
    public void testTweePeriodesNietOverlappend() {
        ...
        PersoonModel persoon = bouwPersoon("Tester");
        AbstractPersoonAanschrijvingGroep aanschrijvingGroep = persoon.getAanschrijving();

        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20110909), new Datum(20120101));

        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20120515), new Datum(20120717));
        em.flush();
//        printHistorischeRecords();

        // Verwacht nu 10 records (6 actueel, 4 vervallen)
        Assert.assertEquals(10, countRowsInTable("kern.his_persaanschr"));
        testVerwachteActueleRecords(
            new AanschrijvingInfoTuple("20100101", "20110101", "2011-01-02 12:12:12", null, "Test1"),
            new AanschrijvingInfoTuple("20110101", "20110909", "2012-12-12 12:12:12", null, "Test2"),
            new AanschrijvingInfoTuple("20110909", "20120101", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120101", "20120515", "2012-12-12 12:12:12", null, "Test3"),
            new AanschrijvingInfoTuple("20120515", "20120717", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120717", null,       "2012-12-12 12:12:12", null, "Test3"));
        testVerwachteVervallenRecords(
            new AanschrijvingInfoTuple("20100101", null,       "2010-01-01 10:00:00", "2011-01-02 12:12:12", "Test1"),
            new AanschrijvingInfoTuple("20110101", null,       "2011-01-02 12:12:12", "2011-11-12 13:13:13", "Test2"),
            new AanschrijvingInfoTuple("20110101", "20111111", "2011-11-12 13:13:13", "2012-12-12 12:12:12", "Test2"),
...
//        printHistorischeRecords();
    ...
    public void testVierPeriodesNietOverlappend() {
        ...
        PersoonModel persoon = bouwPersoon("Tester");
        AbstractPersoonAanschrijvingGroep aanschrijvingGroep = persoon.getAanschrijving();
        AbstractPersoonAanschrijvingGroep anderGroep = new PersoonAanschrijvingGroepModel(aanschrijvingGroep);
        ReflectionTestUtils.setField(anderGroep, "geslachtsnaam", new Geslachtsnaamcomponent("Tester4"));

        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20110909), new Datum(20120101));
        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20120313), new Datum(20120515));
        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20120717), new Datum(20120919));
        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                anderGroep, actie, new Datum(20120406), new Datum(20120816));
        em.flush();

//        printHistorischeRecords();

        // Verwacht nu 12 records (6 actueel, 4 vervallen)
        Assert.assertEquals(12, countRowsInTable("kern.his_persaanschr"));
        testVerwachteActueleRecords(
            new AanschrijvingInfoTuple("20100101", "20110101", "2011-01-02 12:12:12", null, "Test1"),
            new AanschrijvingInfoTuple("20110101", "20110909", "2012-12-12 12:12:12", null, "Test2"),
            new AanschrijvingInfoTuple("20110909", "20120101", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120101", "20120313", "2012-12-12 12:12:12", null, "Test3"),
            new AanschrijvingInfoTuple("20120313", "20120406", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120406", "20120816", "2012-12-12 12:12:12", null, "Tester4"),
            new AanschrijvingInfoTuple("20120816", "20120919", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120919", null, "2012-12-12 12:12:12", null, "Test3"));
        testVerwachteVervallenRecords(
            new AanschrijvingInfoTuple("20100101", null, "2010-01-01 10:00:00", "2011-01-02 12:12:12", "Test1"),
            new AanschrijvingInfoTuple("20110101", null, "2011-01-02 12:12:12", "2011-11-12 13:13:13", "Test2"),
            new AanschrijvingInfoTuple("20110101", "20111111", "2011-11-12 13:13:13", "2012-12-12 12:12:12", "Test2"),
    ...
    public void testTweePeriodesAaneensluitend() {
        ...
        AbstractPersoonAanschrijvingGroep aanschrijvingGroep = persoon.getAanschrijving();
        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20110909), new Datum(20120515));
        persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, new Datum(20120515), new Datum(20120717));
        em.flush();
//      printHistorischeRecords();
        ...
        Assert.assertEquals(9, countRowsInTable("kern.his_persaanschr"));
        testVerwachteActueleRecords(
            new AanschrijvingInfoTuple("20100101", "20110101", "2011-01-02 12:12:12", null, "Test1"),
            new AanschrijvingInfoTuple("20110101", "20110909", "2012-12-12 12:12:12", null, "Test2"),
            new AanschrijvingInfoTuple("20110909", "20120515", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120515", "20120717", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120717", null,       "2012-12-12 12:12:12", null, "Test3"));
        testVerwachteVervallenRecords(
            new AanschrijvingInfoTuple("20100101", null, "2010-01-01 10:00:00", "2011-01-02 12:12:12", "Test1"),
...
//        printHistorischeRecords();
        ...
        testVerwachteActueleRecords(
            ...
            new AanschrijvingInfoTuple("20110909", "20120515", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120515", "20120717", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120717", "20120919", "2012-12-12 12:12:12", null, "Tester"),
            new AanschrijvingInfoTuple("20120919", null,       "2012-12-12 12:12:12", null, "Test3"));
        testVerwachteVervallenRecords(
            new AanschrijvingInfoTuple("20100101", null, "2010-01-01 10:00:00", "2011-01-02 12:12:12", "Test1"),
            new AanschrijvingInfoTuple("20110101", null, "2011-01-02 12:12:12", "2011-11-12 13:13:13", "Test2"),
    ...
    public void testMessedupDatums() throws Throwable {
        ...
        try {
            persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                    aanschrijvingGroep, actie, new Datum(20120515), new Datum(20110909));
    ...
    public void testMessedupDatums2() throws Throwable {
        ...
        try {
            persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                    aanschrijvingGroep, actie, new Datum(20120515), new Datum(20120515));
        } catch (InvalidDataAccessApiUsageException ei) {
            throw ei.getCause();
        }
    }
    ...
    public void testMessedupDatums3() throws Throwable {
        ...
        try {
            ...
            persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, null, new Datum(20120515));
        } catch (InvalidDataAccessApiUsageException ei) {
            throw ei.getCause();
        }
    }
    ...
    public void testMessedupDatums4() throws Throwable {
        ...
        try {
            persoonAanschrijvingHistorieRepository.persisteerHistorie(persoon,
                aanschrijvingGroep, actie, null, null);
        } catch (InvalidDataAccessApiUsageException ei) {
            throw ei.getCause();
        }
    }
