...
public abstract class AbstractRepositoryTestCase extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    //DUALJDBC: direct naar de schrijf connectie
    @Inject
    @Named("dataSourceSystem")
    ...
    private List<String> getDataBestanden() {
        ...
        dataBestanden.addAll(Arrays.asList("/data/stamgegevensStatisch.xml", "/data/stamgegevensLand.xml",
            "/data/stamgegevensNationaliteit.xml", "/data/partij.xml", "/data/testdata.xml"));
     ...
     * @see nl.bzk.brp.dataaccess.AbstractRepositoryTestCase#getDataBestanden()
     */
