...
import nl.bzk.brp.dataaccess.repository.PersoonAdresRepositoryCustom;
import nl.bzk.brp.dataaccess.repository.PersoonRepositoryCustom;
...
import nl.bzk.brp.model.groep.operationeel.*;
import nl.bzk.brp.model.groep.operationeel.historisch.*;
 ...
 * van de {@link nl.bzk.brp.dataaccess.repository.PersoonRepositoryCustom} class.
 */
public class PersoonRepositoryImpl implements PersoonRepositoryCustom {

    private static final Logger LOGGER = LoggerFactory.getLogger(PersoonRepositoryImpl.class);
    ...
    @Inject
    private PersoonAdresRepositoryCustom persoonAdresRepository;
    ...
    public PersoonModel findByBurgerservicenummer(final Burgerservicenummer bsn) {
        LOGGER.info("findByBurgerservicenummer datasource: " + em.getProperties().get("dataSource") );
    ...
    public PersoonModel haalPersoonOpMetBurgerservicenummer(final Burgerservicenummer bsn) {
        LOGGER.info("persoonophalen datasource: " + em.getProperties().get("dataSource") );
        StringBuilder query = new StringBuilder(SELECT_PERSOON).append(JOIN_ALLES);
        query.append("WHERE persoon.identificatienummers.burgerservicenummer = :burgerservicenummer");
