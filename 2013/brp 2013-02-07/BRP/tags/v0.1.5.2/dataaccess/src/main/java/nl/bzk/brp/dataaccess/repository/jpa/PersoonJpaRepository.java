...
public class PersoonJpaRepository implements PersoonRepository {
    ...
    @Inject
    private GroepHistorieRepository                         persoonGeslachtsaanduidingHistorieRepository;

    @Inject
    private GroepHistorieRepository                         persoonBijhoudingsVerantwoordelijkheidHistorieRepository;

    @Inject
    private PersoonGeslachtsnaamcomponentHistorieRepository persoonGeslachtsnaamcomponentHistorieRepository;

    @Inject
    private GroepHistorieRepository                         persoonIdentificatienummersHistorieRepository;
     ...
     */
    private PersistentPersoon haalPersoonOpViaQuery(final String query, final QueryParameter... parameters) {
     ...
     */
    private List<PersistentPersoon> haalPersonenOpViaQuery(final String query, final QueryParameter... parameters) {
    ...
    public Persoon haalPersoonMetAdres(final Long persId) {
        ...
        PersistentPersoon persistentPersoon = haalPersoonOpViaQuery(query.toString(),
    ...
    public List<Persoon> haalPersonenMetWoonAdresOpViaBurgerservicenummer(final String bsn) {
        ...
        List<PersistentPersoon> persistentPersonen =
            haalPersonenOpViaQuery(query.toString(),
                    new QueryParameter("persoon.burgerservicenummer", "burgerservicenummer", bsn));
            ...
            final String locatieOmschrijving, final String locatietovAdres, final Plaats woonplaats)
    {
        ...
        List<PersistentPersoon> persistentPersonen = haalPersonenOpViaQuery(query.toString(),
            new QueryParameter("adres.naamOpenbareRuimte", "naamOpenbareRuimte",
                    StringUtils.defaultIfBlank(StringUtils.upperCase(naamOpenbareRuimte), null)),
            new QueryParameter("adres.huisnummer", "huisnummer",
                    StringUtils.defaultIfBlank(huisnummer, null)),
            new QueryParameter("adres.huisletter", "huisletter",
                    StringUtils.defaultIfBlank(StringUtils.upperCase(huisletter), null)),
            new QueryParameter("adres.huisnummertoevoeging", "huisnummertoevoeging",
                    StringUtils.defaultIfBlank(StringUtils.upperCase(huisnummertoevoeging), null)),
            new QueryParameter("adres.locatieOmschrijving", "locatieOmschrijving",
                    StringUtils.defaultIfBlank(StringUtils.upperCase(locatieOmschrijving), null)),
            new QueryParameter("adres.locatietovAdres", "locatietovAdres",
                    StringUtils.defaultIfBlank(StringUtils.upperCase(locatietovAdres), null)),
            new QueryParameter("adres.woonplaats", "woonplaats",
                    woonplaats));
            ...
            final String identificatiecodeNummeraanduiding)
    {
        ...
        List<PersistentPersoon> persistentPersonen =
            haalPersonenOpViaQuery(query.toString(),
                    new QueryParameter("adres.identificatiecodeNummeraanduiding", "idCodeNumaanduiding",
            ...
            final String huisletter, final String huisnummertoevoeging)
    {
        ...
        List<PersistentPersoon> persistentPersonen =
            haalPersonenOpViaQuery(query.toString(),
                    new QueryParameter("adres.postcode", "postcode",
                            StringUtils.defaultIfBlank(StringUtils.upperCase(postcode), null)),
                    new QueryParameter("adres.huisnummer", "huisnummer", StringUtils.defaultIfBlank(huisnummer, null)),
                    new QueryParameter("adres.huisletter", "huisletter",
                            StringUtils.defaultIfBlank(StringUtils.upperCase(huisletter), null)),
                    new QueryParameter("adres.huisnummertoevoeging", "huisnummertoevoeging",
                            StringUtils.defaultIfBlank(StringUtils.upperCase(huisnummertoevoeging), null)));
    ...
    @Override
    public PersistentPersoon opslaanNieuwPersoon(final Persoon persoon, final Integer datumAanvangGeldigheid,
    ...
    @Override
    public void werkHistorieBij(final PersistentPersoon ppersoon, final Persoon persoon, final PersistentActie actie,
            final Integer datumAanvangGeldigheid)
    {
        ...
        for (PersistentPersoonVoornaam voornaam : ppersoon.getPersoonVoornamen()) {
            persoonVoornaamHistorieRepository.opslaanHistorie(voornaam, actie, datumAanvangGeldigheid, null);
        }
        ...
        {
            persoonGeslachtsnaamcomponentHistorieRepository.opslaanHistorie(geslachtsnaamcomponent, actie,
                    datumAanvangGeldigheid, null);
        }

        // Historie Samengestelde naam
        if (persoon.getSamengesteldenaam() != null) {
            persoonSamengesteldeNaamHistorieRepository.persisteerHistorie(ppersoon,
        ...
        for (PersistentPersoonAdres persoonAdres : ppersoon.getAdressen()) {
            persoonAdresHistorieRepository.opslaanHistorie(persoonAdres, actie, datumAanvangGeldigheid, null);
        }
        ...
        hisPersoonGeboorte.setDatumTijdRegistratie(actie.getTijdstipRegistratie());
        ...
        hisPersoonGeboorte.setActieInhoud(actie);
        ...
        if (persoon.getPersoonGeslachtsAanduiding() != null) {
            persoonGeslachtsaanduidingHistorieRepository.persisteerHistorie(ppersoon,
                    actie, datumAanvangGeldigheid, null);
        }
        ...
        hisPersoonInschrijving.setDatumTijdRegistratie(actie.getTijdstipRegistratie());
        hisPersoonInschrijving.setVersienr(1);
        hisPersoonInschrijving.setActieInhoud(actie);
        em.persist(hisPersoonInschrijving);

        // Sla Bijhoudingsgemeente in historie op in de C-laag
        if (ppersoon.getBijhoudingsGemeente() != null
            && ppersoon.getBijhoudingsGemeenteDatumInschrijving() != null
            && ppersoon.getBijhoudingsGemeenteIndicatieOnverwerktDocumentAanwezig() != null)
        {
            bijhoudingsGemeenteHistorieRepository.persisteerHistorie(ppersoon, actie, datumAanvangGeldigheid, null);
        }

        // Sla BijhoudingsVerwantwoordelijkheid op in de C-laag
        persoonBijhoudingsVerantwoordelijkheidHistorieRepository.persisteerHistorie(ppersoon, actie,
                datumAanvangGeldigheid, null);

        // Sla PersoonIdentificatienummers op in de C-laag
        persoonIdentificatienummersHistorieRepository.persisteerHistorie(ppersoon, actie, datumAanvangGeldigheid, null);
    }
