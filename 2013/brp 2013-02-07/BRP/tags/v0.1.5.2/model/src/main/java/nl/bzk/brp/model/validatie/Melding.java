...
public class Melding extends AbstractIdentificerendeGroep {
     ...
     */
    public Melding(final SoortMelding soort, final MeldingCode code, final IdentificerendeGroep groep, final String atttribuutNaam) {
     ...
     */
    public Melding(final SoortMelding soort, final MeldingCode code, final String omschrijving,
            final IdentificerendeGroep groep, final String atttribuutNaam)
    {
        this.soort = soort;
        this.code = code;
        this.omschrijving = omschrijving;
