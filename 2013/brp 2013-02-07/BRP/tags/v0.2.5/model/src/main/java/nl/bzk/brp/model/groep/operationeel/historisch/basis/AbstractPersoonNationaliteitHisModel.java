...
public abstract class AbstractPersoonNationaliteitHisModel extends AbstractPersoonNationaliteitStandaardGroep
                                                           implements MaterieleHistorie
{

    @Id
    @SequenceGenerator(name = "hisPersNation", sequenceName = "Kern.seq_His_PersNation")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "hisPersNation")
    private Long                    id;
     ...
     */
    protected AbstractPersoonNationaliteitHisModel() {
        super();
     ...
     * .
     *
     * @param persoonNationaliteitStandaardGroep ,.
     * @param persoonNationaliteit De bijbehorende persoon nationaliteit.
     */
    protected AbstractPersoonNationaliteitHisModel(
            ...
            final PersoonNationaliteitModel persoonNationaliteit)
    {
        ...
        if ((persoonNationaliteitStandaardGroep != null)
                && persoonNationaliteitStandaardGroep instanceof AbstractPersoonNationaliteitHisModel)
        {
            historie =
                new MaterieleHistorieImpl(
                        ((AbstractPersoonNationaliteitHisModel) persoonNationaliteitStandaardGroep)
                                .getHistorie());
        } else {
            historie = new MaterieleHistorieImpl();
        }
