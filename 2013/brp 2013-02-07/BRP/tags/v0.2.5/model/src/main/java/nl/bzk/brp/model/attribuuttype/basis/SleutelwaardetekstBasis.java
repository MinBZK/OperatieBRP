...
/**
 * SleutelwaardetekstBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class SleutelwaardetekstBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private SleutelwaardetekstBasis() {
        super(null);
    }
     ...
     */
    public SleutelwaardetekstBasis(final String waarde) {
        super(waarde);
    }
}
