...
public class ActieBerichtBindingTest extends AbstractBindingInTest<ActieBericht> {
    ...
    public void testActie() throws JiBXException {
        ...
        Assert.assertEquals("id.bron1", actie.getBronnen().get(0).getVerzendendId());

        Assert.assertNotNull(actie.getBronnen().get(0).getDocument());
        Assert.assertEquals("V", actie.getBronnen().get(0).getDocument().getDocumentsoortNaam().getWaarde());
        Assert.assertEquals("id.document1", actie.getBronnen().get(0).getDocument().getVerzendendId());
        ...
        Assert.assertEquals(new Short("1000"), gegevens.getPartijCode().getWaarde());
    }
    ...
    public void testActieBronNil() throws JiBXException {
        ...
        Assert.assertEquals(1, actie.getBronnen().size());
        BronBericht bron = actie.getBronnen().get(0);
