...
delete from kern.bron;
delete from kern.doc;

delete from kern.his_onderzoek;
delete from kern.onderzoek;

delete from kern.his_betrouderschap;
delete from kern.his_betrouderlijkgezag;
delete from kern.betr;

delete from kern.his_relatie;
...
delete from kern.his_persbijhverantwoordelijk;
...
delete from kern.his_persverblijfsr;
