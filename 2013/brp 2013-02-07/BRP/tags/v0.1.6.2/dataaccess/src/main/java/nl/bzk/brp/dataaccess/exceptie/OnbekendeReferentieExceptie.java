...
public class OnbekendeReferentieExceptie extends RuntimeException {
     ...
     */
    public OnbekendeReferentieExceptie(final ReferentieVeld veld, final String waarde, final Throwable throwable) {
    ...
    /**
     * Enumeratie van referentievelden waarvoor de {@link OnbekendeReferentieExceptie} gebruikt kan worden.
     */
    public enum ReferentieVeld {
        ...
        REDENVERKRIJGENNLNATION("RedenVerkijgenNLNationaliteit"),
