 ...
 */
@Repository
public class PersoonNationaliteitMdlJpaRepository implements PersoonNatRepository {
            ...
            final Datum datumAanvangGeldigheid, final DatumTijd tijdstipRegistratie)
    {
        ...
        persoonNationaliteitStandaardMdlHistorieRepository.persisteerHistorie(nieuwNationaliteit,
