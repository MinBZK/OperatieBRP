...
//
    @Inject
    private PersoonNatRepository        persoonNationaliteitMdlRepository;
    ...
    private PersoonNationaliteitModel maakNationalRecord(final String nationaliteitCode) {
        ...
        persoonNationaliteitBericht.setNationaliteit(referentieDataMdlRepository.vindNationaliteitOpCode(
        ...
        PersoonNationaliteitModel nationaliteit = new PersoonNationaliteitModel(persoonNationaliteitBericht, null);
    ...
    public void testVoegNationaliteit() {
        ...
        final PersoonModel bestaandePersoon = em.find(PersoonModel.class, 2L);
        ...
        PersoonModel nieuwPersoon =  persoonNationaliteitMdlRepository.voegNationaliteit(bestaandePersoon,
                maakNationalRecord("0339"), actie,
                new Datum(20120216), new DatumTijd(new Timestamp(new Date().getTime())));
        ...
        nieuwPersoon =  persoonNationaliteitMdlRepository.voegNationaliteit(bestaandePersoon,
                maakNationalRecord("0027"), actie,
                new Datum(20120416), new DatumTijd(new Timestamp(new Date().getTime())));
