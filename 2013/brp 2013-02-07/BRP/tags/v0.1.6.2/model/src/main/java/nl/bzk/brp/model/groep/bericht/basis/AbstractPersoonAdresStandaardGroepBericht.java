...
@ConditioneelVerplichteVelden({
    ...
    @ConditioneelVerplichtVeld(naamVerplichtVeld = "soort", naamAfhankelijkVeld = "land.landCode", waardeAfhankelijkVeld = "6030", code = MeldingCode.BRAL2032, message = "BRAL2032"),
    ...
    @ConditioneelVerplichtVeld(naamVerplichtVeld = "gemeente.gemeenteCode", naamAfhankelijkVeld = "land.landCode", waardeAfhankelijkVeld = "6030", code = MeldingCode.BRAL2033, message = "BRAL2033"),
    @ConditioneelVerplichtVeld(naamVerplichtVeld = "redenwijziging.redenWijzigingAdresCode", naamAfhankelijkVeld = "land.landCode", waardeAfhankelijkVeld = "6030", code = MeldingCode.BRAL2033, message = "BRAL2033")
})
