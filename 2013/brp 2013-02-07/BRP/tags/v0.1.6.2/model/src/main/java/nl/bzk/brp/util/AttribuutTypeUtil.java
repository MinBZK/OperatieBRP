...
/**
 * Utility class voor het {@link AbstractAttribuutType}.
 *
 */
public final class AttribuutTypeUtil {
    ...
    public static boolean isBlank(final AbstractAttribuutType<? extends Object> attribuut) {
        return !isNotBlank(attribuut);
    }

    public static String defaultWaardeIfBlank(final AbstractAttribuutType<String> attribuut,
                                              final String defaultWaarde)
    {
