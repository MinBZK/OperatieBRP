            ...
            try {
                SOAPACTION_TO_SCHEMAMAPPING.put(
                        ...
                        fact.newSchema(new StreamSource(new File(SchemaValidationHelper.class.getResource(
                                "/xsd/BRP_Afstamming_InschrijvingAangifteGeboorte_Bijhouding_v0001.xsd").toURI()))));
                SOAPACTION_TO_SCHEMAMAPPING.put(
                        "verhuizing",
                        fact.newSchema(new StreamSource(new File(SchemaValidationHelper.class.getResource(
                                "/xsd/BRP_Migratie_Verhuizing_Bijhouding_v0001.xsd").toURI()))));
                SOAPACTION_TO_SCHEMAMAPPING.put(
                        "bevraging",
                        fact.newSchema(new StreamSource(new File(SchemaValidationHelper.class.getResource(
                                "/xsd/bevraging.xsd").toURI()))));
