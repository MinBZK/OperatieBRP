...
public class InschrijvingGeboorteUitvoerderTest {
    ...
    public void testUitvoerMetBestaandBsn() {
        ...
        Mockito.doThrow(new ObjectReedsBestaandExceptie(ObjectReedsBestaandExceptie.ReferentieVeld.BSN, null, null))
               .when(persoonRepository).opslaanNieuwPersoon(Matchers.any(Persoon.class), Matchers.anyInt());
    ...
    public void testUitvoerMetOnbekendeReferentie() {
        BRPActie actie = getInschrijvingGeboorteActie();
        Mockito.doThrow(new OnbekendeReferentieExceptie(OnbekendeReferentieExceptie.ReferentieVeld.LANDCODE, "abc", null))
               .when(persoonRepository).opslaanNieuwPersoon(Matchers.any(Persoon.class), Matchers.anyInt());
