...
public class PersoonOpschortingHistorieJpaRepository extends
    AbstractGroepHistorieRepository<PersoonModel, PersoonOpschortingHisModel>
    implements PersoonOpschortingHistorieRepository
{
    ...
    @Override
    protected PersoonOpschortingHisModel maakNieuwHistorieRecord(final PersoonModel objectType) {
