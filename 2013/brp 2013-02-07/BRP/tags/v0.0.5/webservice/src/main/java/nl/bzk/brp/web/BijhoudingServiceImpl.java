...
public class BijhoudingServiceImpl extends AbstractWebService<BijhoudingsBericht> implements BijhoudingService {
    ...
    /** {@inheritDoc} */
    @Override
    public BerichtResultaat bijhouden(
        @WebParam(name = "Bijhouding", partName = "bericht") final BijhoudingsBericht bericht)
    {
        BerichtResultaat berichtResultaat = new BerichtResultaat(null);
        return voerBerichtUit(bijhoudingsBerichtVerwerker, bericht, berichtResultaat);
    }
