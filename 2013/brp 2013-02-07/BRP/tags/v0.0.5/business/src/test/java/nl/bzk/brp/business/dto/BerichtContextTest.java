...
public class BerichtContextTest {
    ...
    public void testConstructorEnGetters() {
        BerichtContext context = new BerichtContext(new BerichtenIds(Long.valueOf(2L), Long.valueOf(3L)), Integer.valueOf(1), new Partij());
    ...
    public void testConstructorMetNullVoorBerichtenIds() {
        new BerichtContext(null, Integer.valueOf(1), new Partij());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructorMetNullVoorAuthenticatieMiddelId() {
        new BerichtContext(new BerichtenIds(Long.valueOf(2L), Long.valueOf(3L)), null, new Partij());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructorMetNullVoorPartij() {
        new BerichtContext(new BerichtenIds(Long.valueOf(2L), Long.valueOf(3L)), Integer.valueOf(1), null);
    }
}
