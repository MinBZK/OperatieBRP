    ...
    BetrokkenheidOuderschapGroep
{
    ...
    @Formula("(select hbo.dataanvgel from kern.his_betrouderschap hbo where hbo.betr = id and hbo.tsverval is null)")
    private Integer datumAanvangOuderschap;
    @Formula("(select hbo.dateindegel from kern.his_betrouderschap hbo where hbo.betr = id and hbo.tsverval is null)")
    ...
    protected void setDatumEindeGeldigheid(final Integer datumEindeOuderschap) {
        this.datumEindeGeldigheid = datumEindeOuderschap;
    }
}
