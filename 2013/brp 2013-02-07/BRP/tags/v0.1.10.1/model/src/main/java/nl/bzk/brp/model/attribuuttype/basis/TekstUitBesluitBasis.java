...
/**
 * TekstUitBesluitBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class TekstUitBesluitBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private TekstUitBesluitBasis() {
        super(null);
    }
     ...
     */
    public TekstUitBesluitBasis(final String waarde) {
        super(waarde);
    }
}
