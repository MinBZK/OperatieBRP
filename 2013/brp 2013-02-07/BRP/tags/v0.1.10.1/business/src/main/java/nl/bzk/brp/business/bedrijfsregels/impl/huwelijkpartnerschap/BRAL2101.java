 ...
 */
public class BRAL2101 implements ActieBedrijfsRegel<Relatie> {
            ...
            final Actie actie)
    {
        ...
        if (nieuweSituatie == null || nieuweSituatie.getGegevens() == null) {
            ...
            {
                meldingen =
                    Collections.singletonList(new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL2101,
                            (Identificeerbaar) nieuweSituatie.getGegevens(), "gemeenteAanvang"));
            } else {
                meldingen = Collections.emptyList();
            }
        }
