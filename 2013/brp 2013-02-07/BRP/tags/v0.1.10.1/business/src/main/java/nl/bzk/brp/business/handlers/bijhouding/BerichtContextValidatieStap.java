 ...
 *
 */
public class BerichtContextValidatieStap extends AbstractBerichtVerwerkingsStap<BijhoudingsBericht, BerichtResultaat> {
     ...
     */
    private void controleerBedrijfsregelsOpBerichtContext(final BijhoudingsBericht bericht,
            final BerichtContext context, final BerichtResultaat resultaat)
    {
        if (bedrijfsRegelManager == null) {
            ...
            for (BerichtContextBedrijfsRegel regel : bedrijfsRegelManager
