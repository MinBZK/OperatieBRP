...
public class BerichtVerrijkingsStapTest extends AbstractStapTest {
    ...
    public void testEersteInschrijvingOnbekendeReferentie() {
        ...
        Assert.assertEquals(MeldingCode.BRAL1002, res.getMeldingen().get(2).getCode());
        ...
        Assert.assertEquals(MeldingCode.BRAL1020, res.getMeldingen().get(5).getCode());
        Assert.assertEquals(MeldingCode.BRAL1002, res.getMeldingen().get(6).getCode());
        Assert.assertEquals("Gemeente 34 betaat niet.", res.getMeldingen().get(6).getOmschrijving());
        Assert.assertEquals(MeldingCode.BRAL1001, res.getMeldingen().get(7).getCode());
        Assert.assertEquals("Land 2 bestaat niet.", res.getMeldingen().get(7).getOmschrijving());
        Assert.assertEquals(MeldingCode.BRAL1020, res.getMeldingen().get(8).getCode());
        Assert.assertEquals("Woonplaats 243 bestaat niet.", res.getMeldingen().get(8).getOmschrijving());
        Assert.assertEquals(MeldingCode.BRAL1018, res.getMeldingen().get(9).getCode());
        Assert.assertEquals("Predikaat pred bestaat niet.", res.getMeldingen().get(9).getOmschrijving());
        Assert.assertEquals(MeldingCode.BRAL1015, res.getMeldingen().get(10).getCode());
        Assert.assertEquals("Adellijke titel adel bestaat niet.", res.getMeldingen().get(10).getOmschrijving());
    }
    ...
    public void testOnbekendeReferentieExceptionAlsResultaat() {
        ...
        Assert.assertEquals(MeldingCode.BRAL1007, res.getMeldingen().get(0).getCode());
        Assert.assertEquals("Reden wijziging adres abc bestaat niet.", res.getMeldingen().get(0).getOmschrijving());
        Assert.assertEquals(MeldingCode.BRAL1020, res.getMeldingen().get(1).getCode());
        Assert.assertEquals(MeldingCode.BRAL1002, res.getMeldingen().get(2).getCode());
        Assert.assertEquals(MeldingCode.BRAL1001, res.getMeldingen().get(3).getCode());
    }
