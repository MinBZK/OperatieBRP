 ...
 */
public class BRBY0417 implements BedrijfsRegel<Relatie> {
     ...
     *
     * @param huidigeSituatie .
     * @param nieuweSituatie .
     * @param datumAanvangGeldigheid .
     * @return melding
     */
    @Override
    public List<Melding> executeer(final Relatie huidigeSituatie,
            final Relatie nieuweSituatie, final Datum datumAanvangGeldigheid)
    {
    ...
    private Melding controlleer(final Betrokkenheid betrokkenheid, final Datum datumAanvang) {
        ...
        if (persoonBericht.getIdentificatienummers() != null) {
            ...
            if (persoon == null) {
                LOGGER.info("Kan de persoon met bsn %s niet vinden",
