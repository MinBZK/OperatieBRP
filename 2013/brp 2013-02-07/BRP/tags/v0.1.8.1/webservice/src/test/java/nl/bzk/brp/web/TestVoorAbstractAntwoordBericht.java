...
public class TestVoorAbstractAntwoordBericht {
    ...
    public void testStandaardConstructor() {
        ...
        Assert.assertNotNull(berichtStuurgegevens.getReferentienummer());
        Assert.assertEquals("Ministerie BZK", berichtStuurgegevens.getOrganisatie());
        Assert.assertNotNull(berichtStuurgegevens.getCrossReferentienummer());
