        ...
        implements BijhoudingService
{
            ...
            @WebParam(name = "Bijhouding", partName = "bericht") final VerhuizingBericht bericht)
    {
        ...
        return (VerhuizingAntwoordBericht)
            ...
            @WebParam(name = "Bijhouding", partName = "bericht") final CorrectieAdresBericht bericht)
    {
        ...
        return (CorrectieAdresNLAntwoordBericht)
                stelAntwoordBerichtSamenOpBasisVanVerwerkingsResultaat(bericht, berichtResultaat);
    }
            ...
            @WebParam(name = "Bijhouding", partName = "bericht") final InschrijvingGeboorteBericht bericht)
    {
        ...
        return (InschrijvingGeboorteAntwoordBericht)
                stelAntwoordBerichtSamenOpBasisVanVerwerkingsResultaat(bericht, berichtResultaat);
    }
            ...
            final HuwelijkEnGeregistreerdPartnerschapBericht bericht)
    {
        ...
        return (HuwelijkEnGeregistreerdPartnerschapAntwoordBericht)
                stelAntwoordBerichtSamenOpBasisVanVerwerkingsResultaat(bericht, berichtResultaat);
    }

    @Override
    protected BijhoudingResultaat verwerkBericht(final AbstractBijhoudingsBericht bericht,
