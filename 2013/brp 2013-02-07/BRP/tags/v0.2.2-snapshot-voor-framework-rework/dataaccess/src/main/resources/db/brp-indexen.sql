...
DROP INDEX IF EXISTS indkern905;
CREATE INDEX indkern905 ON kern.adellijketitel (code ASC NULLS LAST);

DROP INDEX IF EXISTS indkern906;
CREATE INDEX indkern906 ON kern.functieadres (code ASC NULLS LAST);

DROP INDEX IF EXISTS indkern907;
CREATE INDEX indkern907 ON kern.geslachtsaand (code ASC NULLS LAST);

DROP INDEX IF EXISTS indkern908;
CREATE INDEX indkern908 ON kern.predikaat (code ASC NULLS LAST);

DROP INDEX IF EXISTS indkern909;
CREATE INDEX indkern909 ON kern.rdnwijzadres (code ASC NULLS LAST);

DROP INDEX IF EXISTS indkern910;
CREATE INDEX indkern910 ON kern.wijzegebruikgeslnaam (code ASC NULLS LAST);
