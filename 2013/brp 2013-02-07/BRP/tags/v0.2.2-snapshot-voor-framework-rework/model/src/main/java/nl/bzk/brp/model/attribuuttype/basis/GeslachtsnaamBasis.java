...
public abstract class GeslachtsnaamBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private GeslachtsnaamBasis() {
        super(null);
    }
     ...
     */
    public GeslachtsnaamBasis(final String waarde) {
        super(waarde);
    }
}
