...
/**
 * PopulatiecriteriumBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class PopulatiecriteriumBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private PopulatiecriteriumBasis() {
        super(null);
    }
     ...
     */
    public PopulatiecriteriumBasis(final String waarde) {
        super(waarde);
    }
}
