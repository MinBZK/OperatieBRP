...
public class BRBY0532Test {
     ...
     */
    private List<Actie> bouwLijstVanActies(final Persoon... personen) {
        List<Actie> acties = new ArrayList<Actie>();

        for (Persoon persoon : personen) {
            acties.add(ActieBerichtBuilder.bouwNieuweActie(SoortActie.CORRECTIE_ADRES_NL).voegRootObjectToe(persoon)
                                          .getActie());
        }
     ...
     */
    private CorrectieAdresBericht bouwBerichtMetActies(final List<Actie> acties) {
