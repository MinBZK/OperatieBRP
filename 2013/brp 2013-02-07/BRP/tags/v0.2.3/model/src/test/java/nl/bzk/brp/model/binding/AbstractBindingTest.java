...
abstract class AbstractBindingTest<T> {
    ...
    /**
     * Naam van de te gebruiken factory. Oftewel binding bestand dat gebruikt moet worden.
     *
     * @return Naam van de te gebruiken factory.
     */
    protected abstract String getBindingFactoryName();
}
