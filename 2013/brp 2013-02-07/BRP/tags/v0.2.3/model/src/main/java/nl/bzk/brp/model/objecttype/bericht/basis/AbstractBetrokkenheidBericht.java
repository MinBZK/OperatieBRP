...
@ConditioneelVerplichteVelden({
    @ConditioneelVerplichtVeld(naamVerplichtVeld = "betrokkenheidOuderschap.datumAanvang", naamAfhankelijkVeld = "rol.code", waardeAfhankelijkVeld = "K", verplichtNull = true, code = MeldingCode.BRAL0203, message = "BRAL0203")
})
