...
public abstract class AbstractPersoonAanschrijvingHisModel extends AbstractPersoonAanschrijvingGroep implements
    MaterieleHistorie
{

    @Id
    @SequenceGenerator(name = "hisPersAanschr", sequenceName = "Kern.seq_his_persaanschr")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "hisPersAanschr")
    private Long id;
    ...
    protected AbstractPersoonAanschrijvingHisModel() {
        super();
    }
     ...
     * .
     *
     * @param persoonAanschrijvingGroep .
     * @param persoonModel .
     */
    protected AbstractPersoonAanschrijvingHisModel(final AbstractPersoonAanschrijvingGroep persoonAanschrijvingGroep,
        final PersoonModel persoonModel)
    {
        super(persoonAanschrijvingGroep);
        persoon = persoonModel;
        if (persoonAanschrijvingGroep instanceof AbstractPersoonAanschrijvingHisModel) {
            historie = new MaterieleHistorieImpl(
                ((AbstractPersoonAanschrijvingHisModel) persoonAanschrijvingGroep).getHistorie());
        } else {
            historie = new MaterieleHistorieImpl();
        }
    }
