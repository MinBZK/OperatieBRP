...
public enum Soortbericht {
    ...
    AFSTAMMING_INSCHRIJVINGAANGIFTEGEBOORTE_BIJHOUDING_ANTWOORD("Afstamming InschrijvingAangifteGeboorte BijhoudingAntwoord"),
    ...
    HUWELIJKPARTNERSCHAP_REGISTRATIEHUWELIJK_BIJHOUDING_ANTWOORD("HuwelijkPartnerschap RegistratieHuwelijk BijhoudingAntwoord"),
    ...
    HUWELIJKPARTNERSCHAP_REGISTRATIEPARTNERSCHAP_BIJHOUDING_ANTWOORD("HuwelijkPartnerschap RegistratiePartnerschap BijhoudingAntwoord"),
    ...
    VRAAG_PERSONENOPADRESINCLUSIEFBETROKKENHEDEN_BEVRAGEN_ANTWOORD("Vraag PersonenOpAdresInclusiefBetrokkenheden BevragenAntwoord"),
    ...
    /** Overlijden RegistratieOverlijden Bijhouding.**/
    OVERLIJDEN_REGISTRATIEOVERLIJDEN_BIJHOUDING("Overlijden RegistratieOverlijden Bijhouding"),
    /** Overlijden RegistratieOverlijden BijhoudingAntwoord.**/
    OVERLIJDEN_REGISTRATIEOVERLIJDEN_BIJHOUDING_ANTWOORD("Overlijden RegistratieOverlijden BijhoudingAntwoord");
