...
public class RelatieJpaRepository implements RelatieRepository {
    ...
    private static final String SELECT_RELATIES_QUERY =
        "SELECT relatie FROM RelatieModel relatie, "
            ...
            + "WHERE relatie = betrokkenheid.relatie AND betrokkenheid.betrokkene = persoon ";
    ...
    @Inject
    private GroepHistorieRepository<BetrokkenheidModel,
            BetrokkenheidOuderschapHisModel> betrokkenheidOuderschapHistorieRepository;
    @Inject
    private GroepHistorieRepository<BetrokkenheidModel,
            BetrokkenheidOuderlijkGezagHisModel> betrokkenheidOuderlijkgezagHistorieRepository;
    @Inject
