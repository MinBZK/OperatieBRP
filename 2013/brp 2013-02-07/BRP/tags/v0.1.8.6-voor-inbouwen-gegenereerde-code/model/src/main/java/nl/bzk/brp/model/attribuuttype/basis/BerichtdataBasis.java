...
public abstract class BerichtdataBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private BerichtdataBasis() {
        super(null);
    }
     ...
     */
    public BerichtdataBasis(final String waarde) {
        super(waarde);
    }
}
