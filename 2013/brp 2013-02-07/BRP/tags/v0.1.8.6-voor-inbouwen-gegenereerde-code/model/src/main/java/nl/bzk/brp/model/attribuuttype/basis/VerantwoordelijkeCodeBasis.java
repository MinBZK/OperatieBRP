...
/**
 * VerantwoordelijkeCodeBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class VerantwoordelijkeCodeBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private VerantwoordelijkeCodeBasis() {
        super(null);
    }
     ...
     */
    public VerantwoordelijkeCodeBasis(final String waarde) {
        super(waarde);
    }
}
