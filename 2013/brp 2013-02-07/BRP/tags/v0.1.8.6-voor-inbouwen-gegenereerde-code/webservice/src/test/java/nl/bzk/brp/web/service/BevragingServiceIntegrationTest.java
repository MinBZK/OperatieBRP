...
//        System.out.println(xml);
        ...
        Assert.assertEquals("brp:bevragen_VraagDetailsPersoon_Antwoord", antwoord.getFirstChild().getNodeName());
...
//    @Test
//    public void testVraagDetailsPersoonMetHistorie() throws Exception {
//        Node antwoord = verzendBerichtNaarService("bevragen_VraagDetailsPersoon.xml");
////        String xml = XmlUtils.toXmlString(antwoord);
////        Document document = XmlUtils.bouwDocument(xml);
//
