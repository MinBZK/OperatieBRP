...
public final class PersoonAdresBuilder {
    ...
    /**
     * Bouwt en retourneert een nieuwe adrescorrectie Actie instantie met de opgegeven eigenschappen en enkele standaard
     ...
     */
    public static Actie bouwAdrescorrectieActie(final Datum datumAanvangGeldigheid, final Datum datumEindeGeldigheid,
