...
/**
 * HuisnummertoevoegingBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class HuisnummertoevoegingBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private HuisnummertoevoegingBasis() {
        super(null);
    }
     ...
     */
    public HuisnummertoevoegingBasis(final String waarde) {
        super(waarde);
    }
}
