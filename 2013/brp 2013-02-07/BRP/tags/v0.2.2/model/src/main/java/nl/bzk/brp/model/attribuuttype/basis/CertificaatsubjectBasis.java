...
/**
 * CertificaatsubjectBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class CertificaatsubjectBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private CertificaatsubjectBasis() {
        super(null);
    }
     ...
     */
    public CertificaatsubjectBasis(final String waarde) {
        super(waarde);
    }
}
