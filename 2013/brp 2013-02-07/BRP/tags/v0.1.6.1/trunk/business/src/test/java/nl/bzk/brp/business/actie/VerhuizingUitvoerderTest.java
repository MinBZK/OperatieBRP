...
public class VerhuizingUitvoerderTest extends AbstractStapTest {
    ...
    public void init() {
        ...
        ReflectionTestUtils.setField(verhuizingUitvoerder, "bijhoudingsGemeenteHistorieRepository",
                bijhoudingsGemeenteHistorieRepository);
        ...
        Mockito.when(actieRepository.save(Mockito.any(PersistentActie.class))).thenReturn(actie);

        PersistentPersoonAdres persoonAdres = new PersistentPersoonAdres();
        persoonAdres.setPersoon(new PersistentPersoon());
        Mockito.when(persoonAdresRepository.opslaanNieuwPersoonAdres(
                Mockito.any(PersoonAdres.class), Mockito.anyInt(), Mockito.anyInt(), Mockito.any(Date.class)
        )).thenReturn(persoonAdres);
    }
