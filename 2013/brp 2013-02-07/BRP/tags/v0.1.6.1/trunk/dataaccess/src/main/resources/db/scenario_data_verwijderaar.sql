...
TRUNCATE Kern.His_BetrOuder CASCADE;
...
DELETE FROM Kern.His_Partij WHERE ID = 2000;
DELETE FROM Kern.Partij WHERE ID = 2000;

DELETE FROM Kern.SrtActie;

DELETE FROM Kern.SrtPartij WHERE ID = 7;
