 ...
 */
public class RelatieSelectieFilterOud implements Serializable {
    /**
     *
     */
    ...
    public Integer getPeilDatum() {
        return peilDatum;
    }

    public void setPeilDatum(final Integer peilDatum) {
