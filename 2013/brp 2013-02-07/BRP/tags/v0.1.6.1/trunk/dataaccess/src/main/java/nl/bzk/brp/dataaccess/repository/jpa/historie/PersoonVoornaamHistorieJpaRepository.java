...
public class PersoonVoornaamHistorieJpaRepository implements PersoonVoornaamHistorieRepository {
    ...
    @Override
    public void opslaanHistorie(final PersistentPersoonVoornaam voornaam, final PersistentActie actie,
                                final Integer datumAanvangGeldigheid, final Integer datumEindeGeldigheid)
    {
        ...
        hisPersoonVoornaam.setDatumTijdRegistratie(actie.getTijdstipRegistratie());
        hisPersoonVoornaam.setNaam(voornaam.getNaam());
        hisPersoonVoornaam.setActieInhoud(actie);
