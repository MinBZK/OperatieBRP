...
public interface PersoonRepository {
    ...
    * @deprecated wordt nog vaak gebruikt in de business laag
    */
    @Deprecated
     ...
     * @deprecated Kan nog niet verwijderd worden, omdat deze nog door de PersoonAdresJpaRepository gebruikt bij
     * bewaren van een adres.
     */
    @Deprecated
...
//
     ...
     * @deprecated Wordt nog gebruikt door de business laag op de oa. ouder op te halen.
     */
    @Deprecated
