...
public class PersoonAdresHistorieJpaRepository implements PersoonAdresHistorieRepository {
    ...
    @Override
    public void opslaanHistorie(final PersistentPersoonAdres persoonAdres, final PersistentActie actie,
     ...
     */
    private void kopieerGrensRecordsEnPasDezeAan(final PersistentActie actie,
                                                 final List<HisPersoonAdres> overlapteRecords,
     ...
     * @param overlapteRecords alle overlapte records uit de C-laag.
     */
    private void verplaatsOverlapteRecordsNaarDLaag(final PersistentActie actie,
                                                    final List<HisPersoonAdres> overlapteRecords)
    {
        for (HisPersoonAdres adres : overlapteRecords) {
     ...
     * @param datumEindeGeldigheid Datum waarop het adres niet meer geldig is.
     */
    private void slaOpNieuwHistoriePersoonAdres(final PersistentActie actie, final PersistentPersoonAdres persoonAdres,
                                                ...
                                                final Integer datumEindeGeldigheid)
    {
        ...
        hisPersoonAdres.setRedenWijzigingAdres(persoonAdres.getRedenWijziging());
        hisPersoonAdres.setAangeverAdreshouding(persoonAdres.getAangeverAdreshouding());
