...
public abstract class AbstractPersoonGeslachtsnaamComponentMdl extends AbstractDynamischObjectType implements
        PersoonGeslachtsnaamComponentBasis
{
    ...
    @Embedded
    @NotNull
    private PersoonGeslachtsnaamCompStandaardGroepMdl persoonGeslachtsnaamCompStandaardGroep;
    ...
    @Override
    public PersoonGeslachtsnaamCompStandaardGroepMdl getGegevens() {
