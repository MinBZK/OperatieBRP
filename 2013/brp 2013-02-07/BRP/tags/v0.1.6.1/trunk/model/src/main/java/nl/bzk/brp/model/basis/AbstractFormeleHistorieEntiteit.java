...
public abstract class AbstractFormeleHistorieEntiteit implements Cloneable {
    ...
    private PersistentActie actieInhoud;

    @OneToOne
    @JoinColumn(name = "ActieVerval")
    private PersistentActie actieVerval;
    ...
    public PersistentActie getActieInhoud() {
        return actieInhoud;
    }

    public void setActieInhoud(final PersistentActie actieInhoud) {
        this.actieInhoud = actieInhoud;
    }

    public PersistentActie getActieVerval() {
        return actieVerval;
    }

    public void setActieVerval(final PersistentActie actieVerval) {
