...
import nl.bzk.brp.model.attribuuttype.RedenVerkregenNLNationaliteitCode;
...
public class RedenVerkrijgingNLNationaliteit extends AbstractStatischObjectType {
    ...
    private RedenVerkregenNLNationaliteitCode code;

    public Integer getId() {
        return id;
    }

    public RedenVerkregenNLNationaliteitCode getCode() {
        return code;
    }
}
