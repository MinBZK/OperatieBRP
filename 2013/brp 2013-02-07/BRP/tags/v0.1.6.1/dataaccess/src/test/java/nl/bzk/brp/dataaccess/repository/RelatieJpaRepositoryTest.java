...
public class RelatieJpaRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanRelatie() {
        ...
        PersistentRelatie pRelatie = relatieRepository.opslaanNieuweRelatie(relatie, 20120605, new Date());

        relatieRepository.werkHistorieBij(pRelatie, actie, 20120605);
        em.flush();
        ...
        Assert.assertNotNull(pRelatie);

        Long relatieId = pRelatie.getId();
    ...
    public void testOpslaanRelatieMetKindZonderId() {
        ...
        Long relatieId = relatieRepository.opslaanNieuweRelatie(relatie, 20120605, new Date()).getId();
        em.flush();
    }
    ...
    public void testOpslaanHuwelijkRelatie() {
        ...
        PersistentRelatie relatie1 = relatieRepository.opslaanNieuweRelatie(relatie, 20120605, new Date());
        relatieRepository.werkHistorieBij(relatie1, null, 20120605);
    }
