        ...
        if (adresGevendeOuder == null) {
            ...
            if (adresGevendeOuder.getIdentificatienummers() != null) {
                ...
                try {
                    ...
                    if (adres.getDatumAanvangAdreshouding() != null) {
                        if (kind.getGeboorte().getDatumGeboorte() <= adres.getDatumAanvangAdreshouding()) {
                    ...
                    // TODO: bolie: maak hier een echte waarschuring / foutmelding.
                    // zie ook BRBY0118
