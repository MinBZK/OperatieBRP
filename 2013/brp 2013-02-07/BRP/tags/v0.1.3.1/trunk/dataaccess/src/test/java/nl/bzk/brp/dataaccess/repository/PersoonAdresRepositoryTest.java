...
public class PersoonAdresRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanNieuwPersoonAdres() {
        ...
        persoonAdresRepository.opslaanNieuwPersoonAdres(maakNieuwAdres(), datumAanvangGeldigheid, null, new Date());
        ...
        Assert.assertEquals(RedenWijzigingAdres.AMBTSHALVE, nieuwHisAdres.getRedenWijzigingAdres());
    ...
    public void testIsIemandIngeschrevenOpAdres() {
        ...
        adres.setNaamOpenbareRuimte("Damstraat");
        adres.setAfgekorteNaamOpenbareRuimte("Damstr");
        adres.setHuisnummer("1");
        adres.setHuisletter("a");
        adres.setHuisnummertoevoeging("II");
        adres.setPostcode("3984NX");
        Plaats woonplaats = new Plaats();
        woonplaats.setWoonplaatscode("0034");
        adres.setWoonplaats(woonplaats);
        adres.setAdresseerbaarObject("1492");
        adres.setIdentificatiecodeNummeraanduiding("1581");
        Land land = new Land();
        land.setId(2);
    ...
    private PersoonAdres maakNieuwAdres() {
        ...
        gemeente.setGemeentecode("0034");
        adres.setGemeente(gemeente);
        adres.setRedenWijziging(RedenWijzigingAdres.AMBTSHALVE);
        adres.setAangeverAdreshouding(AangeverAdreshoudingIdentiteit.GEZAGHOUDER);
        return adres;
    }
