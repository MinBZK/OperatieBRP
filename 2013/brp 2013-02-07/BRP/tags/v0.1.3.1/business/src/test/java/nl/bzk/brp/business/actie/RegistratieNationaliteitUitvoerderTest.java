...
public class RegistratieNationaliteitUitvoerderTest extends AbstractStapTest {
    ...
    @Mock
    private ObjectTypeHistorieRepository<HisPersoonNationaliteit, PersistentPersoonNationaliteit>
    ...
    public void testRegistratieNationaliteitNormaleFlow() {
        ...
        Mockito.when(persoonNationaliteitRepository.save(Mockito.any(PersistentPersoonNationaliteit.class)))
    ...
    public void testRegistratieNationaliteitNormaleFlowMetOpslagHistorie() {
        ...
        registratieNationaliteitUitvoerder.verwerkActie(actie, bouwBerichtContext());
        Mockito.verify(persoonNationaliteitHistorieRepository, Mockito.times(1)).persisteerHistorie(
            Mockito.any(PersistentPersoonNationaliteit.class), Mockito.any(PersistentPersoon.class),
            Mockito.eq(actie.getDatumAanvangGeldigheid()), Mockito.isNull(Integer.class), Mockito.any(Date.class));
    }
