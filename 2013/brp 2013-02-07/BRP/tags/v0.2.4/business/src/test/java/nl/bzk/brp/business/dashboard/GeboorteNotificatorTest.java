...
public class GeboorteNotificatorTest {
    ...
    public void init() throws URISyntaxException {
        ...
        notificator.setDashboardUri(new URI("http://localhost:8080/brp-dashboard/service/berichten/opslaan/geboorte"));
    ...
    private List<BetrokkenheidBericht> creeerBetrokkenhedenVoorBericht(final AbstractBijhoudingsBericht bericht) {
        ...
        ((AbstractBijhoudingsBericht) bericht).setBrpActies(brpActies);
    ...
    public void testGeboorteBericht() throws Exception {
        ...
        berichtStuurgegevens.setApplicatie(new Applicatienaam("Digimeente"));
        berichtStuurgegevens.setIndPrevalidatie(Ja.Ja);
        ...
        PersoonAdresBericht adres =
            PersoonAdresBuilder.bouwWoonadres("Brink", 11, "1234AA",
        ...
        PersoonAdresBericht adresOuder1 =
            PersoonAdresBuilder.bouwWoonadres("Brink", 11, "1234AA",
                StatischeObjecttypeBuilder.bouwWoonplaats((short) 747, "Vollenhoven"),
                StatischeObjecttypeBuilder.bouwGemeente((short) 355, "Zeist"), 20120515);
        ...
        Mockito.when(referentieDataRepository.vindGemeenteOpCode(new Gemeentecode((short) 344))).thenReturn(
            brpGemeenteGeboorte);
        Mockito.when(
            persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(new Burgerservicenummer("123234345")))
               .thenReturn(Arrays.asList(bouwPersoonModel(nieuwgeborene)));
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("321432543")))
               .thenReturn(Arrays.asList(bouwPersoonModel(ouder1)));
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("987654321")))
               .thenReturn(Arrays.asList(bouwPersoonModel(ouder2)));
        ...
        Assert.assertEquals(20120515, berichtArgument.getValue().getAdresNieuwgeborene().getDatumAanvang());
    ...
    public void testGeboorteBerichtZonderOudersOfAdressen() throws Exception {
        ...
        Mockito.when(referentieDataRepository.vindGemeenteOpCode(new Gemeentecode((short) 030))).thenReturn(
            brpGemeenteGeboorte);
    ...
    public void testGeboorteBerichtZonderKindAdres() throws Exception {
        ...
        Mockito.when(referentieDataRepository.vindGemeenteOpCode(new Gemeentecode((short) 30))).thenReturn(
            brpGemeenteGeboorte);
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("123234345"))).thenReturn(Arrays.asList(bouwPersoonModel(nieuwgeborene)));
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("321432543"))).thenReturn(Arrays.asList(bouwPersoonModel(ouder1)));
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("987654321"))).thenReturn(Arrays.asList(bouwPersoonModel(ouder2)));
    ...
    public void testGeboorteBerichtNietSuccesvol() throws Exception {
        ...
        meldingen.add(new Melding(Soortmelding.FOUT, MeldingCode.BRBER00121, "BSN bestaat al"));
        meldingen.add(new Melding(Soortmelding.OVERRULEBAAR, MeldingCode.ALG0001, "zxc"));
        ...
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("321432543"))).thenReturn(Arrays.asList(bouwPersoonModel(ouder1)));
        Mockito.when(persoonRepository.haalPersonenMetWoonAdresOpViaBurgerservicenummer(
            new Burgerservicenummer("123234345"))).thenReturn(Arrays.asList(bouwPersoonModel(ouder2)));
        ...
        Assert.assertEquals("Vis", berichtArgument.getValue().getNieuwgeborene().getGeslachtsnaamcomponenten().get(0)
                                                  .getNaam());
        Assert.assertEquals("0070", berichtArgument.getValue().getNieuwgeborene().getGemeenteGeboorte().getCode()
                                                   .toString());
    ...
    public void testGeboorteBerichtMetOverrule() throws Exception {
        ...
        meldingen.add(new Melding(Soortmelding.OVERRULEBAAR, MeldingCode.ALG0001, "zxc"));
        meldingen.add(new Melding(Soortmelding.OVERRULEBAAR, MeldingCode.ALG0002, "asd"));
        meldingen.add(new Melding(Soortmelding.OVERRULEBAAR, MeldingCode.ALG0001, "qwe"));
        meldingen.add(new Melding(Soortmelding.OVERRULEBAAR, MeldingCode.AUTH0001, "qaz"));
        ...
        resultaat.voegtoeOverruleMeldingen(overruleMeldingen);
        ...
        Assert.assertNotNull(berichtArgument.getValue().getMeldingen().get(0));
        Assert.assertEquals(MeldingSoort.GENEGEERDE_FOUT, berichtArgument.getValue().getMeldingen().get(0).getSoort());
        Assert.assertEquals("zxc", berichtArgument.getValue().getMeldingen().get(0).getTekst());
        Assert.assertNotNull(berichtArgument.getValue().getMeldingen().get(1));
        Assert.assertEquals(MeldingSoort.GENEGEERDE_FOUT, berichtArgument.getValue().getMeldingen().get(1).getSoort());
        Assert.assertEquals("qwe", berichtArgument.getValue().getMeldingen().get(1).getTekst());
        ...
        Assert.assertEquals("qaz", berichtArgument.getValue().getMeldingen().get(3).getTekst());
        Assert.assertNotNull(berichtArgument.getValue().getMeldingen().get(4));
        Assert.assertEquals(MeldingSoort.WAARSCHUWING, berichtArgument.getValue().getMeldingen().get(4).getSoort());
        Assert.assertEquals("BSN bestaat al", berichtArgument.getValue().getMeldingen().get(4).getTekst());
