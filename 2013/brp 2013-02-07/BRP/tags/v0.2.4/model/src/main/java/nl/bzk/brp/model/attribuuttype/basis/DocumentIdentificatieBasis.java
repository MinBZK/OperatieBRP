...
/**
 * DocumentIdentificatieBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class DocumentIdentificatieBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private DocumentIdentificatieBasis() {
        super(null);
    }
     ...
     */
    public DocumentIdentificatieBasis(final String waarde) {
        super(waarde);
    }
}
