...
public class PersoonJpaRepository implements PersoonRepository {
    ...
    @Inject
    private GroepHistorieRepository<PersoonGeslachtsnaamcomponentModel> persoonGeslachtsnaamcomponentHistorieRepository;

    @Inject
    private PersoonAdresHistorieRepository persoonAdresHistorieRepository;

    @Inject
    private GroepHistorieRepository<PersoonNationaliteitModel> persoonNationaliteitStandaardHistorieRepository;
