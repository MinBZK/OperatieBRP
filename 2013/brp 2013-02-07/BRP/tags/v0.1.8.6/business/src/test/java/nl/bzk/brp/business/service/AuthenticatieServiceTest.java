...
public class AuthenticatieServiceTest {
    ...
    private final Short                      partijId1 = (short) 1200;
    private final Short                      partijId2 = (short) 1300;
    ...
    public void init() throws IOException, CertificateException, URISyntaxException {
        ...
        ReflectionTestUtils.setField(testPartij1, "id", Short.valueOf((short) 1));
        testPartij2 = new Partij();
        ReflectionTestUtils.setField(testPartij2, "id", Short.valueOf((short) 2));
