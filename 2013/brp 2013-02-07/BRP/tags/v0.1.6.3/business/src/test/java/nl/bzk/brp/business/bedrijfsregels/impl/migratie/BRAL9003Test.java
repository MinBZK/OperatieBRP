...
public class BRAL9003Test {
    ...
    public void testHuidigeSituatieGeenOpschorting() {
        ...
        Melding melding = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20150101));
    ...
    public void testHuidigeSituatieLeeg() {
        Melding melding = bral9003.executeer(null, null, new Datum(20150101));
    ...
    public void testHuidigeSituatieWelOpschortingMaarGeenOpschortingDatum() {
        ...
        Melding melding = bral9003.executeer(persoon0, nieuweSituatie, new Datum(20150101));
    ...
    public void testWijzigingDatumVoorOpschortingDatum() {
        ...
        Melding melding = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120504));
    ...
    public void testWijzigingDatumOpOpschortingDatum() {
        ...
        Melding melding = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120505));
    ...
    public void testWijzigingDatumNaOpschortingDatum() {
        ...
        Melding melding = bral9003.executeer(persoon1, nieuweSituatie, new Datum(20120506));
