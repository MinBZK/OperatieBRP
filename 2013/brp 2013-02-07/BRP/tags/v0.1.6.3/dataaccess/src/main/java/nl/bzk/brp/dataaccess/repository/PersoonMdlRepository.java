...
public interface PersoonMdlRepository {
     ...
     */
    PersoonModel haalPersoonMetAdres(final Long persId);
    ...
    // TODO: verwerkHistorie moet in de DAL gebeuren!!
    /**
    ...
    void werkbijBijhoudingsGemeente(final Burgerservicenummer bsn,
            ...
            final ActieModel actie, final Datum datumAanvangGeldigheid, final DatumTijd tijdstipRegistratie);
