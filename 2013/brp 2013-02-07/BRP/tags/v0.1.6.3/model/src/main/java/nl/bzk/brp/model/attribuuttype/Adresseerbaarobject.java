 ...
 */
@Embeddable
public final class Adresseerbaarobject extends AbstractGegevensAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private Adresseerbaarobject() {
        super(null);
    }
     ...
     */
    public Adresseerbaarobject(final String waarde) {
        super(waarde);
    }
}
