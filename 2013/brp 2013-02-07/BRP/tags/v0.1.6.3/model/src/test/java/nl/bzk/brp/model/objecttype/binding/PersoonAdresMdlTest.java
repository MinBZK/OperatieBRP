 ...
 *
 */
public class PersoonAdresMdlTest extends AbstractBindingUitTest<PersoonAdresModel> {
    ...
    public void testBindingOut() throws JiBXException {
        ...
        String xml = marshalObjectTest(new PersoonAdresModel(persoonAdres, new PersoonModel(new PersoonBericht())));
