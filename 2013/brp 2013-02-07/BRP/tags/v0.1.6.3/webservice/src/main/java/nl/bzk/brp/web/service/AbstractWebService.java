 ...
 */
public abstract class AbstractWebService<T extends AbstractBRPBericht, Y extends BerichtResultaat> {
    ...
    protected Y voerBerichtUit(final T bericht) {
        ...
        try {
            ...
            resultaat.setBerichtCrossReferentieNummer(berichtReferentieNummer);
            resultaat.setPrevalidatie(prevalidatie);
        } catch (Throwable t) {
            ...
            resultaat = bouwBerichtResultaatMetMelding(MeldingCode.ALG0001,
                "Er is een onbekende fout opgetreden in de verwerking. Probeer later nogmaals", bericht.getBerichtStuurgegevens());
        }
     ...
     */
    protected Y bouwBerichtResultaatMetMelding(final MeldingCode meldingCode,
        final String omschrijving, final Identificeerbaar groep)
    {
