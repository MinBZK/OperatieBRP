 ...
 */
public class InschrijvingGeboorteAntwoordBericht extends BijhoudingAntwoordBericht {
     ...
     */
    public InschrijvingGeboorteAntwoordBericht(final BijhoudingResultaat berichtResultaat) {
