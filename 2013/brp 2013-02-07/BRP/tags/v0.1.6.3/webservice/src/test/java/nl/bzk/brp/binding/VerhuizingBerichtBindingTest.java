...
public class VerhuizingBerichtBindingTest extends AbstractBindingInTest<VerhuizingBericht> {
    ...
    public void testBindingMaxBericht() throws JiBXException, IOException {
        ...
        Assert.assertEquals("Blokhut", persoonAdres.getGegevens().getAdresseerbaarObject().getWaarde());
        Assert.assertEquals("nummerAand", persoonAdres.getGegevens().getIdentificatiecodeNummeraanduiding().getWaarde());
        Assert.assertEquals("0001", persoonAdres.getGegevens().getGemeenteCode().getWaarde());
        ...
        Assert.assertEquals("15", persoonAdres.getGegevens().getHuisnummer().getWaarde());
        ...
        Assert.assertEquals("1001", persoonAdres.getGegevens().getCode().getWaarde());
        ...
        Assert.assertEquals("9076", persoonAdres.getGegevens().getLandCode().getWaarde());
    }
