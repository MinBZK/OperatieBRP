...
public class PersoonSamengesteldeNaamHistorieRepository
        extends AbstractGroepHistorieRepository<PersoonModel, PersoonSamengesteldeNaamHisModel>
{

    @Override
    protected PersoonSamengesteldeNaamHisModel maakNieuwHistorieRecord(final PersoonModel objectType) {
