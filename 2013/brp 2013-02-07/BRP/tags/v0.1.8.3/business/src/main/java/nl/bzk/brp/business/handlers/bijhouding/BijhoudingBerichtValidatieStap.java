        ...
        BerichtResultaat>
{
    ...
    // TODO: bolie voorlopig is dit hier gedefinieerd, uiteindelijk moet dit naar de xml configuratie.
...
//      , MeldingCode.BRBY04011.getNaam()
    );

    private List<String> whitelistOverrulbareMeldingen = WHITELIST;
