...
public interface PersoonRepository {
    ...
    /**
     * Deze methode zoekt met volldige adres behalve postcode. Null waardes worden ook
     * meegenomen in de zoek opdracht. null resulteert in de query "is null".
     *
     ...
     */
    Long opslaanNieuwPersoon(final Persoon persoon, final Integer datumAanvangGeldigheid);
