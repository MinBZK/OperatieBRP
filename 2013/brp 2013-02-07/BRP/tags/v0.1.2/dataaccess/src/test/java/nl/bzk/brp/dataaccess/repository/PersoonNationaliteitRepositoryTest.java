...
public class PersoonNationaliteitRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanNieuwPersoonNationaliteitRecordInclusiefHistorie() {
        PersistentPersoonNationaliteit persoonNationaliteit =
                persoonNationaliteitRepository.save(maakPersoonNationaliteit());
        persoonNationaliteitHistorieRepository.persisteerHistorie(
                persoonNationaliteit,
                persoonNationaliteit.getPers(),
                20120101,
                null,
                new Date());
        //Check C laag:
    ...
    public void testWijzigingNationaliteit() {
        ...
        persoonNationaliteitHistorieRepository.persisteerHistorie(nieuwPersoonNation, nieuwPersoonNation.getPers(), 20120101, null, new Date());
        //Check C/D laag
    ...
    public void testTerugWerkendeKrachtMutatie() {
        ...
        persoonNationaliteitHistorieRepository.persisteerHistorie(persoonNationaliteit, persoonNationaliteit.getPers(), 20110201, 20110301, new Date());
        //Check C/D laag
        List<HisPersoonNationaliteit> nieuweHistorie = em.createQuery(
                "Select x from HisPersoonNationaliteit x", HisPersoonNationaliteit.class
        ).getResultList();
    ...
    private PersistentPersoonNationaliteit maakHuidigRecordMetHistorie(final PersistentPersoonNationaliteit persoonNationaliteit, final Integer datumAanvangGeldigheid) {
        ...
        persoonNationaliteitHistorieRepository.persisteerHistorie(persoonNation, persoonNation.getPers(), datumAanvangGeldigheid, null, new Date(System.currentTimeMillis() - 1));
