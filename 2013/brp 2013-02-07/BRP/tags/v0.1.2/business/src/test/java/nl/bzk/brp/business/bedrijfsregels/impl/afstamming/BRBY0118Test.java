...
public class BRBY0118Test {
    ...
    public void testAdresgevendPersoonMetAdres() {
        ...
        Assert.assertEquals(RedenWijzigingAdres.PERSOON, persoonAdres.getRedenWijziging());
        //TODO check of dit klopt
        Assert.assertEquals(AangeverAdreshoudingIdentiteit.GEZAGHOUDER, persoonAdres.getAangeverAdreshouding());
        //TODO check of dit klopt
