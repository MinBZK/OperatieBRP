...
public class InschrijvingGeboorteBerichtBindingTest extends AbstractBindingInTest<InschrijvingGeboorteBericht> {
    ...
    private void checkStuurgegevens(final BijhoudingsBericht bericht, final String organisatie, final String applicatie,
    ...
    private Relatie getRelatieUitGeboorteActie(final BijhoudingsBericht bericht) {
     ...
     */
    private Persoon getKindUitGeboorteActie(final BijhoudingsBericht bericht) {
     ...
     * zijn.
     */
    private Persoon getKindUitRegistratieNationaliteitActie(final BijhoudingsBericht bericht) {
