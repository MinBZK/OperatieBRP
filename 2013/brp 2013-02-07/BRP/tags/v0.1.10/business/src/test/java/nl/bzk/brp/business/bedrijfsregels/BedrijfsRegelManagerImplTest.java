...
public class BedrijfsRegelManagerImplTest {
    ...
    public void testConstructorMetNulls() {
        ...
        Assert.assertNull(bedrijfsRegelManager.getUitTeVoerenActieBedrijfsRegels(SoortActie.AANGIFTE_GEBOORTE));
        Assert.assertNull(bedrijfsRegelManager.getUitTeVoerenBerichtBedrijfsRegels(BijhoudingsBericht.class));
        Assert.assertNull(bedrijfsRegelManager.getUitTeVoerenBerichtContextBedrijfsRegels(BijhoudingsBericht.class));
    }
    ...
    public void testConstructorMetVulling() {
        ...
        Assert.assertNotNull(bedrijfsRegelManager.getUitTeVoerenActieBedrijfsRegels(SoortActie.AANGIFTE_GEBOORTE));
        Assert.assertSame(ACTIEREGELS1,
                bedrijfsRegelManager.getUitTeVoerenActieBedrijfsRegels(SoortActie.AANGIFTE_GEBOORTE));
    ...
    private Map<SoortActie, List<? extends ActieBedrijfsRegel>> bouwActieRegelsMap() {
        ...
        actieRegelMap.put(SoortActie.AANGIFTE_GEBOORTE, ACTIEREGELS1);
        actieRegelMap.put(SoortActie.CORRECTIE_ADRES_NL, ACTIEREGELS2);
     ...
     */
    private Map<Class<? extends BRPBericht>, List<? extends BerichtBedrijfsRegel>> bouwBerichtRegelsMap() {
        Map<Class<? extends BRPBericht>, List<? extends BerichtBedrijfsRegel>> berichtRegelMap =
            new HashMap<Class<? extends BRPBericht>, List<? extends BerichtBedrijfsRegel>>();
     ...
     * @return een map voor bericht classes op bedrijfsregels.
     */
    private Map<Class<? extends BRPBericht>, List<? extends BerichtContextBedrijfsRegel>> bouwContextRegelsMap() {
        Map<Class<? extends BRPBericht>, List<? extends BerichtContextBedrijfsRegel>> berichtRegelMap =
            new HashMap<Class<? extends BRPBericht>, List<? extends BerichtContextBedrijfsRegel>>();
