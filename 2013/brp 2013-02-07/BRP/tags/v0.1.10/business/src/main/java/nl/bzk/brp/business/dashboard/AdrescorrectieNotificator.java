        ...
        AbstractDashboardNotificator<CorrectieAdresBericht, AdresCorrectieBerichtRequest>
{
    ...
    @Override
    protected void verzendNotificatie(final AdresCorrectieBerichtRequest request) {
        getRestTemplate().postForEntity(getDashboardUri(), request, AdresCorrectieBerichtRequest.class);
    }
