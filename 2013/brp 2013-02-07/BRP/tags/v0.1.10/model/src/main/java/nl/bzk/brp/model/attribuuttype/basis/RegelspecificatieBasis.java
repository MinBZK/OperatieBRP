...
/**
 * RegelspecificatieBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class RegelspecificatieBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private RegelspecificatieBasis() {
        super(null);
    }
     ...
     */
    public RegelspecificatieBasis(final String waarde) {
        super(waarde);
    }
}
