...
import nl.bzk.brp.business.dto.bevraging.OpvragenPersoonCriteria;
import nl.bzk.brp.model.binding.AbstractBindingInTest;
import org.jibx.runtime.JiBXException;
import org.junit.Assert;
import org.junit.Test;

public class OpvragenPersoonBindingTest extends AbstractBindingInTest<OpvragenPersoonBericht> {

    @Override
    public Class<OpvragenPersoonBericht> getBindingClass() {
    ...
    public void testOpvragenPersoonBericht() throws JiBXException {
        String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?> "
                + "<bev:OpvragenPersoon xmlns:bev=\"" + NAMESPACE_BRP + "\">"
