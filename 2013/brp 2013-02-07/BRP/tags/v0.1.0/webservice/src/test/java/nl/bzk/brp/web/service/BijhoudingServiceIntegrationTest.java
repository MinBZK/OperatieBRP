...
//            System.out.println("------"+xml);
    ...
    private class PersoonTest {
        private final Long id;
        private final String bsn;
        private final String anr;
        public PersoonTest(final Long id, final String bsn, final String anr) {
    ...
    private class PersoonAdres {
        ...
        public PersoonAdres(final Long id, final Long historischId, final String adreseerbaarObject, final String huisnr, final String postcode) {
    ...
    private List<PersoonTest> persoonMetBsnNumerBestaatLevelA(final String bsn)  {
        List<PersoonTest> personen = new ArrayList<PersoonTest>();

        List<Map<String, Object>> rows = simpleJdbcTemplate.queryForList("select id, bsn, anr from kern.pers where bsn = ?", bsn);
    ...
    private List<PersoonAdres> persoonAdresLevelA(final String bsn)  {
...
//            System.out.println("Adres: " +row.get("id")+","+row.get("adresseerbaarobject")+","+row.get("huisnr")+","+row.get("postcode"));
    ...
    private List<PersoonAdres> persoonAdresLevelC(final String bsn)  {
