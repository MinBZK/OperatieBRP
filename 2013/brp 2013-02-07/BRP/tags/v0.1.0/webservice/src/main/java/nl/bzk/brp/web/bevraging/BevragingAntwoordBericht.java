...
public class BevragingAntwoordBericht extends AbstractAntwoordBericht {
    ...
    /**
     * Check of er gevonden personen zijn in het antwoord.
     * Wordt gebruikt door JIBX.
     * @return true indien er personen zijn gevonden, anders false.
     */
    public boolean personenGevonden() {
        return gevondenPersonen != null
