...
public abstract class AbstractPersoonGeboorteActGroepModel extends AbstractPersoonGeboorteGroep
    implements Onderzoekbaar
{
     ...
     */
    protected AbstractPersoonGeboorteActGroepModel() {
        super();
    }
     ...
     */
    protected AbstractPersoonGeboorteActGroepModel(final PersoonGeboorteGroepBasis persoonGeboorteGroepBasis) {
