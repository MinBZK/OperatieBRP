...
public class BijhoudingServiceTest extends AbstractWebServiceTest<BijhoudingsBericht, BijhoudingResultaat> {
    ...
    public void testCorrectieAdresNL() {
        initMocks(CorrectieAdresBericht.class);
        initBerichtVerwerker(new ArrayList<Melding>(), BijhoudingResultaat.class, true);
    ...
    @Override
    protected AbstractWebService<BijhoudingsBericht, BijhoudingResultaat> getNieuweWebServiceVoorTest() {
