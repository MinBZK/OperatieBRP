...
public abstract class AbstractBindingIntegratieTest<T> {
    ...
    /**
     * Valideert de opgegeven output XML tegen het schema. Middels assertions ({@link org.junit.Assert#fail(String)}) worden
    ...
    protected void valideerTegenSchema(final String xml) {
        try {
            ...
            Schema schema =
                factory.newSchema(new StreamSource(new File(AbstractBindingUitIntegratieTest.class
