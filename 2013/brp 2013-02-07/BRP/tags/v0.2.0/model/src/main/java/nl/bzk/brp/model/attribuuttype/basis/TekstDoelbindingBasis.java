...
/**
 * TekstDoelbindingBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class TekstDoelbindingBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private TekstDoelbindingBasis() {
        super(null);
    }
     ...
     */
    public TekstDoelbindingBasis(final String waarde) {
        super(waarde);
    }
}
