...
public class HisPersoonNationaliteit extends AbstractMaterieleEnFormeleHistorieEntiteit {
    ...
    public HisPersoonNationaliteit clone() throws CloneNotSupportedException {
        HisPersoonNationaliteit clone = new HisPersoonNationaliteit();
        clone.setPersoonNationaliteit(persoonNationaliteit);
        clone.setDatumAanvangGeldigheid(getDatumAanvangGeldigheid());
        clone.setDatumEindeGeldigheid(getDatumEindeGeldigheid());
        clone.setDatumTijdRegistratie(getDatumTijdRegistratie());
        clone.setDatumTijdVerval(getDatumTijdVerval());
        return clone;
    }
}
