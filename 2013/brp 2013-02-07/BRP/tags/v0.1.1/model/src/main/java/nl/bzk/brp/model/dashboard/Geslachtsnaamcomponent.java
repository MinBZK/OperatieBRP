...
public class Geslachtsnaamcomponent {
     ...
     * @param samengesteldenaam naam uit logisch model
     */
    public Geslachtsnaamcomponent(final PersoonSamengesteldeNaam samengesteldenaam) {
        voorvoegsel = samengesteldenaam.getVoorvoegsel();
        naam = samengesteldenaam.getGeslachtsnaam();
    }
