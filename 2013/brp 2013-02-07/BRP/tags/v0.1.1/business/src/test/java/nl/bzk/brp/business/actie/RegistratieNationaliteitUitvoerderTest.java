...
public class RegistratieNationaliteitUitvoerderTest {
    ...
    public void testRegistratieNationaliteitNormaleFlowMetOpslagHistorie() {
        ...
        registratieNationaliteitUitvoerder.verwerkActie(actie);
        Mockito.verify(persoonNationaliteitRepository, Mockito.times(1)).persisteerHistorie(
                Mockito.any(PersistentPersoonNationaliteit.class), Mockito.eq(actie.getDatumAanvangGeldigheid()), Mockito.isNull(Integer.class), Mockito.any(Date.class));
    }
