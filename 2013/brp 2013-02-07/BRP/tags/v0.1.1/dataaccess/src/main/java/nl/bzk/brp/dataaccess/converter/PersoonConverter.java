...
public final class PersoonConverter {
    ...
    {
        // Letop: we testen alleen of de geslachtsnaam ingevuld is voor de groep, omdat volgens de xsd
        // dit element gevuld MOET zijn als de groep bestaat.
    ...
    private static void copyAanschrijving(final Persoon persoon, final PersistentPersoon persistentPersoon,
            final PersoonConverterConfiguratie configuratie)
    {
        // Letop: groep aanschrijving moet er altijd zijn volgens de xsd
