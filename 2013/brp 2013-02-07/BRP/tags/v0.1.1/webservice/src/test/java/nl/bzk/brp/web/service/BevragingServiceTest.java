...
public class BevragingServiceTest extends AbstractWebServiceTest<BRPBericht, OpvragenPersoonResultaat> {
    ...
    @Override
    protected AbstractWebService<BRPBericht, OpvragenPersoonResultaat> getNieuweWebServiceVoorTest() {
