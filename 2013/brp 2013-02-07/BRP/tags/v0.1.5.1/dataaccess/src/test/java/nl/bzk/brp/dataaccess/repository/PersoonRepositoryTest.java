...
public class PersoonRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testHaalPersoonOpMetBurgerservicenummer() {
        ...
        Assert.assertEquals("0001", persoon.getNationaliteiten().get(0).getNationaliteit().getCode());
    ...
    public void testHaalPersonenMetWoonAdresOpViaVolledigAdresMetLegeStringsIpvNulls() {
        ...
        List<Persoon> personen =
            persoonRepository.haalPersonenMetWoonAdresOpViaVolledigAdres("Damstraat", "1", "a", "II", "", "",
                    plaats);
        Assert.assertEquals(1, personen.size());
        Assert.assertEquals(Long.valueOf(1001), personen.get(0).getId());
    }
    ...
    public void testHaalPersonenOpMetAdresViaPostcodeHuisnummerMetLegeStringsIpvNulls() {
        ...
        personen = persoonRepository.haalPersonenOpMetAdresViaPostcodeHuisnummer("1000AA", "1", "", "");
        Assert.assertEquals(1, personen.size());
        Assert.assertEquals("234567891", personen.get(0).getIdentificatienummers().getBurgerservicenummer());
    }
    ...
    public void testOpslaanNieuwPersoon() {
        ...
        Assert.assertTrue(persoon.getBijhoudingsGemeenteIndicatieOnverwerktDocumentAanwezig());
        ...
        Assert.assertTrue(hisPersoonBijhoudingsGemeente.isIndOnverwDocAanw());
