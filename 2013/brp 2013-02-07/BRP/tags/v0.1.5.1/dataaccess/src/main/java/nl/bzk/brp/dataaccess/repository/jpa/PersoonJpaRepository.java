...
public class PersoonJpaRepository implements PersoonRepository {
    ...
    private List<PersistentPersoon> haalPersonenOpViaQuery(final String query, final QueryParameter... parameters) {
        ...
        for (QueryParameter parameter : parameters) {
            if (parameter.waarde == null) {
                ...
                uitTeVoerenQuery = uitTeVoerenQuery.replace("= :" + paramNaam, "is null or " + parameter.dbVeldNaam + " = '' ");
            } else {
    ...
    public Persoon haalPersoonMetAdres(final Long persId) {
        ...
        PersistentPersoon persistentPersoon = haalPersoonOpViaQuery(query.toString(), new QueryParameter("persoon.id", "persId", persId));
