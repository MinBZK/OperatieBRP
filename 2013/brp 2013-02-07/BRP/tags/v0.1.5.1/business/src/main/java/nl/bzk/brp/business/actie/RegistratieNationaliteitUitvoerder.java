            ...
            if (persoon.getNationaliteiten() != null) {
                for (PersoonNationaliteit persoonNationaliteit : persoon.getNationaliteiten()) {
                    try {
                        ...
                        //BRPUC00115:
                        //Datum aanvang geldigheid van de nation. groep dient gelijk te zijn aan de datum aanvang
                        //geldigheid van de actie:
                        persoonNationaliteitHistorieRepository.persisteerHistorie(persNation,
                            persNation.getPers(),
