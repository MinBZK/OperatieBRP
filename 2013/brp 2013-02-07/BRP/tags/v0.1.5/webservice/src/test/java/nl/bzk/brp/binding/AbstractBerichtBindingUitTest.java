...
public abstract class AbstractBerichtBindingUitTest<T> extends AbstractBindingUitTest<T> {
        ...
        final String tijdstipRegistratie, final boolean heeftBijhoudingsCode)
    {
        ...
        resultaat.append("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>").append("<")
                 ...
                 .append("<organisatie>Ministerie BZK</organisatie>").append("<applicatie>BRP</applicatie>")
                 .append("<referentienummer>OnbekendeID</referentienummer>")
                 .append("<crossReferentienummer>onbekend</crossReferentienummer>")
                 .append("</stuurgegevens>").append("<resultaat>").append("<verwerkingCode>%s</verwerkingCode>");
        if (heeftBijhoudingsCode) {
            resultaat.append("<bijhoudingCode>V</bijhoudingCode>");
        }
        ...
        if (tijdstipRegistratie != null) {
            ...
            resultaat.append("<tijdstipRegistratie xsi:nil=\"true\"/>");
        }
