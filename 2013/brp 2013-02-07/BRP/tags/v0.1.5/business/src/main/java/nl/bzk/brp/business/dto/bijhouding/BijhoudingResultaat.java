...
public class BijhoudingResultaat extends BerichtResultaat {
    ...
    public BijhoudingResultaat(final List<Melding> meldingen) {
        ...
        // Merk ook op dat in BijhoudingAntwoordBericht nog verder wordt bepaald of het getoond moet worden of niet.
        // ToDo: Niet direct zetten, maar in de business laag afleiden/bepalen
