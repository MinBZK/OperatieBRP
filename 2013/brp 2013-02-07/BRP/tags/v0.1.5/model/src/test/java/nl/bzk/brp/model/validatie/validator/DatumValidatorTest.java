...
public class DatumValidatorTest {
    ...
    public void testDatumDeelsOnbekendRestrictie() {
        ...
        Assert.assertFalse("2012 13 00 zou NIET geldig moeten zijn.", validator.isValid(20121300, null));
        Assert.assertFalse("2012 00 00 zou NIET geldig moeten zijn.", validator.isValid(20120000, null));
        Assert.assertFalse("0000 00 00 zou NIET geldig moeten zijn.", validator.isValid(0, null));
        Assert.assertFalse("2012 00 12 zou NIET geldig moeten zijn.", validator.isValid(20120012, null));

        Assert.assertTrue("2012 01 01 zou NIET geldig moeten zijn.", validator.isValid(20120101, null));
        Assert.assertTrue("2012 12 12 zou NIET geldig moeten zijn.", validator.isValid(20121212, null));
        Assert.assertTrue("2012 12 05 zou NIET geldig moeten zijn.", validator.isValid(20121205, null));
    }
}
