 ...
 */
public class AnummerValidator implements ConstraintValidator<Anummer, String> {
    ...
    public boolean isValid(final String waarde, final ConstraintValidatorContext context) {
        ...
        if (waarde == null || waarde.length() == 0) {
            ...
            resultaat = isGeldigeAnummer(waarde);
        }
     ...
     */
    private boolean isGeldigeAnummer(final String waarde) {
        boolean resultaat;
