...
public enum MeldingCode {
    ...
    BRAL9003("Het is niet toegestaan na de opschorting van de persoongegevens bij te houden."),
    ...
    BRPUC00120("De adresgevende ouder (moeder) is verhuisd na de geboorte. "
