...
public class BRPBerichtBindingTest extends AbstractBindingTest<BRPBericht> {

    @Test
    public void testBRPBerichtBinding() throws JiBXException {
        final String xml = leesBestand("verhuizing.xml");

        BRPBericht bericht = unmarshalObject(xml);
    ...
    @Override
    protected Class<BRPBericht> getBindingClass() {
