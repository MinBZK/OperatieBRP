        ...
        AbstractBerichtVerwerkingsStap<BRPBericht, OpvragenPersoonResultaat>
{
    ...
    {
        List<Persoon> gevondenPersonen = new ArrayList<Persoon>();
        ...
        if (isBsnCriteria(bericht)) {
            ...
            gevondenPersonen =
                persoonRepository.haalPersonenOpMetAdresViaPostcodeHuisnummer(zoekCriteria.getPostcode(),
                        zoekCriteria.getHuisnummer(), zoekCriteria.getHuisletter(),
            ...
            final OpvragenPersoonResultaat resultaat)
    {
        ...
        if (moeder == null) {
            ...
            filter.setPeilDatum(bericht.getVraag().getZoekCriteria().getGeboortedatumKind());
    ...
    private boolean isPostcodeCriteria(final VraagPersonenOpAdresInclusiefBetrokkenhedenBericht bericht) {
        ...
        return StringUtils.isNotBlank(zoekCriteria.getPostcode())
            ...
            && ObjectUtil.isAllEmpty(zoekCriteria.getBurgerservicenummer(),
                    zoekCriteria.getNaamOpenbareRuimte(), zoekCriteria.getGemeenteCode());
    }
