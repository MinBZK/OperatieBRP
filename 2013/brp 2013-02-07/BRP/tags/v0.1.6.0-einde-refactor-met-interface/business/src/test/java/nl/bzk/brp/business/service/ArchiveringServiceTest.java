...
public class ArchiveringServiceTest {
    ...
    public void testArchiveerInkomend() {
        ArgumentCaptor<PersistentBericht> argument = ArgumentCaptor.forClass(PersistentBericht.class);
    ...
    public void testArchiveerUitgaand() {
        PersistentBericht ingaand = new PersistentBericht();
        ingaand.setRichting(Richting.INGAAND);
        PersistentBericht uitgaand = new PersistentBericht();
