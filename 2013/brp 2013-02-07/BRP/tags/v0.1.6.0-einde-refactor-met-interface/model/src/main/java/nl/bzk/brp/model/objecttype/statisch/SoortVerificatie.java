...
/**
 * Enum voor stamgegeven soort verificatie.
 */
public enum SoortVerificatie {
     ...
     */
    private SoortVerificatie(final String code, final String naam, final String omschrijving) {
        this.code = code;
        this.naam = naam;
