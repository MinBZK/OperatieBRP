...
public class PersistentPersoonAdres {
    ...
    @Column(name = "adresseerbaarObject")
    ...
    /**
     * @param redenWijziging the redenWijziging to set
     */
    ...
    /**
     * @return the aangeverAdreshouding
     */
    ...
    /**
     * @param aangeverAdreshouding the aangeverAdreshouding to set
     */
    ...
    /**
     * @param persoonAdresStatusHis the persoonAdresStatusHis to set
     */
