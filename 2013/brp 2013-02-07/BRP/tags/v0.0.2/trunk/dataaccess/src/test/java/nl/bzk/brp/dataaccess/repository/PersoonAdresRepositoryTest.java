...
public class PersoonAdresRepositoryTest extends AbstractRepositoryTestCase {
    ...
    public void testOpslaanNieuwPersoonAdres() {
        ...
        Assert.assertEquals(20120102, oudHisAdres.getDatumAanvangGeldigheid().intValue());
        ...
        Assert.assertEquals(20120102, oudHisAdresDLaag.getDatumAanvangGeldigheid().intValue());
