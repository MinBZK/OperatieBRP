...
public class AuthenticatieServiceTest {
    ...
    public void init() throws IOException, CertificateException, URISyntaxException {
        //Mock repo's
        partijRepository = Mockito.mock(PartijRepository.class);
    ...
    public void testGeenAuthenticatieMiddelenAanwezig() {
        Assert.assertFalse(authenticatieService.isPartijGeauthenticeerdInBRP(
                partijId1, testCertificaat
        ));

        Assert.assertFalse(authenticatieService.isPartijGeauthenticeerdInBRP(
                partijId2, testCertificaat
        ));
    }
    ...
    public void testAuthenticatieMiddelAanwezig() {
        ...
        Assert.assertTrue(authenticatieService.isPartijGeauthenticeerdInBRP(
                partijId1, testCertificaat
        ));
    }
