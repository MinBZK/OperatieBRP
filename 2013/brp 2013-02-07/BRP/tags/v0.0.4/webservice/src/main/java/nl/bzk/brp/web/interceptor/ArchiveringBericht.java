 ...
 */
class ArchiveringBericht {

    public static final String BERICHT_ARCHIVERING_IN_ID  =
        ArchiveringBericht.class.getPackage().toString() + ".berichtarchivering.IN";
    public static final String BERICHT_ARCHIVERING_UIT_ID =
        ArchiveringBericht.class.getPackage().toString() + ".berichtarchivering.UIT";
     ...
     * content wordt, indien het XML is, nog netjes geindenteerd.
     *
     ...
     * @throws TransformerException indien er problemen zijn bij het indenteren van de XML payload.
     */
    public void vulPayload(final CachedOutputStream outputStream) throws IOException, TransformerException {
