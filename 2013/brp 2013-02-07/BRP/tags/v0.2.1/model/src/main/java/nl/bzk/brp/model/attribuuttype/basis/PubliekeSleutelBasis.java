...
/**
 * PubliekeSleutelBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class PubliekeSleutelBasis extends AbstractStatischAttribuutType<String> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private PubliekeSleutelBasis() {
        super(null);
    }
     ...
     */
    public PubliekeSleutelBasis(final String waarde) {
        super(waarde);
    }
}
