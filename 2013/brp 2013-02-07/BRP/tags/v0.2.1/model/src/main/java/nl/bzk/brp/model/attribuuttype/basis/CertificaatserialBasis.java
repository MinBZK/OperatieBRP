...
/**
 * CertificaatserialBasis.
 * @version 1.0.18.
 */
@MappedSuperclass
@Access(AccessType.FIELD)
public abstract class CertificaatserialBasis extends AbstractStatischAttribuutType<Long> {

    /**
     * Private constructor t.b.v. Hibernate.
     */
    private CertificaatserialBasis() {
        super(null);
    }
     ...
     */
    public CertificaatserialBasis(final Long waarde) {
        super(waarde);
    }
}
