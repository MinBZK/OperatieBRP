...
public class BijhoudingServiceImpl extends AbstractWebService<BijhoudingsBericht, BijhoudingResultaat>
        implements BijhoudingService
{
            ...
            @WebParam(name = "Bijhouding", partName = "bericht") final CorrectieAdresBericht bericht)
    {
        ...
        return new CorrectieAdresNLAntwoordBericht(berichtResultaat);
    }
