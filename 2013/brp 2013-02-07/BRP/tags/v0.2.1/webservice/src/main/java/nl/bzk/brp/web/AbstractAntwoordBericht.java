...
public abstract class AbstractAntwoordBericht<T extends BerichtResultaat> {
    ...
    public AbstractAntwoordBericht(final T berichtResultaat) {
        if (berichtResultaat != null && berichtResultaat.getBerichtStuurgegevens() != null) {
            berichtStuurgegevens = berichtResultaat.getBerichtStuurgegevens();
        } else {
            berichtStuurgegevens = new BerichtStuurgegevens();
        }
