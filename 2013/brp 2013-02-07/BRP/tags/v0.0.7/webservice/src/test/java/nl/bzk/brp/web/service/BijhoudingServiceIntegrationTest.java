...
public class BijhoudingServiceIntegrationTest extends AbstractIntegrationTest {
        ...
        MarshalException, XMLSignatureException
    {
        ...
        Assert.assertEquals(VerwerkingsResultaat.GOED.getCode(), resultaat.getTextContent());
        ...
        MarshalException, XMLSignatureException
    {
        ...
        Node antwoord = verzendBerichtNaarService("inschrijving_geboorte.xml");

        Assert.assertEquals("afstamming_InschrijvingAangifteGeboorte_BijhoudingResponse_v0100",
        ...
        Assert.assertEquals("bijhoudingResultaat", resultaat.getNodeName());
