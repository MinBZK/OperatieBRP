...
@Component
public class InschrijvingGeboorteUitvoerder implements ActieUitvoerder {
    ...
    public List<Melding> voerUit(final BRPActie actie) {
        ...
        if (nieuwIngeschrevene == null) {
            ...
            meldingen = overInschrijvingGeboorteDoor(nieuwIngeschrevene, actie);
        }
     ...
     *         zijn.
     */
    private List<Melding> overInschrijvingGeboorteDoor(final Persoon nieuwIngeschrevene, final BRPActie actie) {
        List<Melding> meldingen;
        try {
