...
public class BRPActie {
     ...
     * @return null
     */
    public Persoon getPersoonRootObject() {
        return null;
    }

    /**
     * Initialiseert de soort van de actie standaard naar 'AANGIFTE_GEBOORTE'. Dit moet straks nog flexibel worden
     * gemaakt zodat bij de JiBX binding de soort van de actie altijd goed wordt gezet.
     */
    public void initSoort() {
        soort = SoortActie.AANGIFTE_GEBOORTE;
    }
}
