 ...
 */
public class BerichtVerrijkingsStap extends AbstractBerichtVerwerkingsStap<BijhoudingsBericht, BerichtResultaat> {
            ...
            if (CollectionUtils.isNotEmpty(persoon.getNationaliteiten())) {
                for (PersoonNationaliteitBericht persoonNationaliteitBericht : persoon.getNationaliteiten()) {
                    if (AttribuutTypeUtil.isNotBlank(persoonNationaliteitBericht.getNationaliteitcode())) {
                        persoonNationaliteitBericht
                            .setNationaliteit(vindNationaliteitOpCode(
    ...
    private RedenVerliesNLNationaliteit vindRedenVerliesNLNationaliteitOpNaam(final RedenVerliesNaam redenVerliesNaam,
        final Identificeerbaar groep, final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1022, String.format(
                    MeldingCode.BRAL1022.getOmschrijving(), redenVerliesNaam.getWaarde()), groep, "redenVerliesNaam");
        ...
        final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1021, String.format(
        ...
        final Identificeerbaar groep, final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1017, String.format(
        ...
        final Identificeerbaar groep, final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1007, String.format(
        ...
        final Identificeerbaar groep, final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1015, String.format(
        ...
        final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1018, String.format(
        ...
        final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1020, String.format(
     ...
     */
    private Land
    vindLandOpCode(final Landcode landcode, final Identificeerbaar groep, final BerichtResultaat resultaat) {
        try {
            return referentieRepository.vindLandOpCode(landcode);
        } catch (OnbekendeReferentieExceptie ore) {
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1001, String.format(
        ...
        final BerichtResultaat resultaat)
    {
        try {
            ...
            final Melding melding =
                new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.BRAL1002, String.format(
