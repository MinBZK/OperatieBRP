...
public class MeldingTest {
    ...
    public void testCompareTo() {
        Melding melding1 = new Melding(SoortMelding.FOUT_OVERRULEBAAR, MeldingCode.ALG0001, "Test1");
        Melding melding2 = new Melding(SoortMelding.FOUT_ONOVERRULEBAAR, MeldingCode.ALG0001, "Test2");
        Melding melding3 = new Melding(SoortMelding.FOUT_OVERRULEBAAR, MeldingCode.ALG0001, "Test3");
        Melding melding4 = new Melding(SoortMelding.FOUT_OVERRULEBAAR, MeldingCode.BRAL0001, "Test4");
