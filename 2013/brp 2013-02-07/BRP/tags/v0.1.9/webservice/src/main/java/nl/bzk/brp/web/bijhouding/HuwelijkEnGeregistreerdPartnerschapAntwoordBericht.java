 ...
 */
public class HuwelijkEnGeregistreerdPartnerschapAntwoordBericht extends BijhoudingAntwoordBericht {
     ...
     */
    public HuwelijkEnGeregistreerdPartnerschapAntwoordBericht(final BijhoudingResultaat berichtResultaat) {
