 ...
 */
public interface BedrijfsRegel<Y extends RootObject> {
     ...
     * @param datumAanvangGeldigheid aanvang datum van de nieuwe situatie.
     * @param datumEindeGeldigheid eindedatum van de nieuwe situatie.
     * @return Melding die de bedrijfsregel kan retourneren indien niet aan de bedrijfsregel wordt voldaan.
     */
    List<Melding> executeer(final Y huidigeSituatie, final Y nieuweSituatie, final Datum datumAanvangGeldigheid,
