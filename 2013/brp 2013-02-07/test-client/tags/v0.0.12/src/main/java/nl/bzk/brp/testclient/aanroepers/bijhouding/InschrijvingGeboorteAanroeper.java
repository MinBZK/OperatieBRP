...
public class InschrijvingGeboorteAanroeper extends BijhoudingAanroeper {
    ...
    /** De Constante DATUM_GEBOORTE. */
    private static final BigInteger DATUM_GEBOORTE             = BigInteger.valueOf(20120920);

    /** De Constante LANDCODE. */
    ...
    /** De Constante VOORNAAM. */
    private static final String     VOORNAAM                   = "Testertje";

    /** De Constante NATIONALITEIT_NAAM. */
    ...
    public void fire() {
        ...
        InschrijvingGeboorteCommand command = new InschrijvingGeboorteCommand(bijhouding);
        Long duur = roepAan(command);
        TestClient.statistieken.bijwerkenNaBericht(Bericht.BERICHT.BIJHOUDING_INSCHRIJVING_GEBOORTE,
                getStatus(), duur);
    }
    ...
    private AfstammingInschrijvingAangifteGeboorteBijhouding creeerAfstammingInschrijvingAangifteGeboorteBijhouding() {
        ...
        JAXBElement<ContainerBerichtOverruleMeldingen> jaxbOverruleMeldingen = objectFactory.createObjecttypeBerichtOverruleMeldingen(overruleBerichten);
        ...
        aanvang.setValue(AANVANG_GELDIGHEID);
        ...
        aanvang2.setValue(AANVANG_GELDIGHEID);
        ...
        aanvangGeldigheidNationaliteit.setValue(AANVANG_GELDIGHEID);
        ...
        JAXBElement<NaamEnumeratiewaarde> jaxbRedenVerkrijgingNaam = objectFactory.createObjecttypePersoonNationaliteitRedenVerkrijgingNaam(redenVerkrijgingNaam);
    ...
    private JAXBElement<Datum> creeerJaxbAanvangGeldigheid() {
        ...
        aanvangGeldigheid.setValue(AANVANG_GELDIGHEID);
    ...
    protected List<String> getParameterList() {
        return Arrays
                .asList(new String[] { PARAMETER_REFERENTIENUMMER, PARAMETER_PREVALIDATIE, PARAMETER_BSN, PARAMETER_ANUMMER, PARAMETER_NAAM, PARAMETER_BSN_OUDER1, PARAMETER_BSN_OUDER2, PARAMETER_VOORVOEGSEL });
    }
}
