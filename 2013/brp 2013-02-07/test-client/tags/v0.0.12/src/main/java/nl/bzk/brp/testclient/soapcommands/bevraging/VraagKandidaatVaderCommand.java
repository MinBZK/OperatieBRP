 ...
 */
public class VraagKandidaatVaderCommand extends
        AbstractSoapCommand<BevragingPortType, BevragingKandidaatVader, BevragingAntwoordPersoonMetAdresIndividueel>
{

    /** De Constante LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(VraagKandidaatVaderCommand.class);
     ...
     */
    public VraagKandidaatVaderCommand(final BevragingKandidaatVader vraag) {
        super(vraag);
    }
