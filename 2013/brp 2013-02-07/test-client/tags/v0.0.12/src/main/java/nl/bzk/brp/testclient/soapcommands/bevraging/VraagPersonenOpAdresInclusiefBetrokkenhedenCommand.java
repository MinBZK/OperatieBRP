 ...
 */
public class VraagPersonenOpAdresInclusiefBetrokkenhedenCommand extends
        AbstractSoapCommand<BevragingPortType, BevragingPersonenOpAdresInclusiefBetrokkenheden, BevragingAntwoordPersoonMetAdresEnBetrokkenhedenSelectie>
{
    ...
    /** De Constante LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(VraagPersonenOpAdresInclusiefBetrokkenhedenCommand.class);
     ...
     */
    public VraagPersonenOpAdresInclusiefBetrokkenhedenCommand(final BevragingPersonenOpAdresInclusiefBetrokkenheden vraag) {
        super(vraag);
    }
