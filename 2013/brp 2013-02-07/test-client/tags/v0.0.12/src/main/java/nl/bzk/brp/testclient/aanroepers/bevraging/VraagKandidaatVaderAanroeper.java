...
import nl.bzk.brp.testclient.soapcommands.bevraging.VraagKandidaatVaderCommand;
...
public class VraagKandidaatVaderAanroeper extends BevragingAanroeper {
    ...
    /** De Constante GEBOORTEDATUMKIND. */
    private static final BigInteger GEBOORTEDATUMKIND = BigInteger.valueOf(20120219);
    ...
    public void fire() {
        ...
        VraagKandidaatVaderCommand command = new VraagKandidaatVaderCommand(vraag);
    ...
    private BevragingKandidaatVader creeerBevragingKandidaatVader() {
        ...
        geboortedatumKind.setValue(GEBOORTEDATUMKIND);
