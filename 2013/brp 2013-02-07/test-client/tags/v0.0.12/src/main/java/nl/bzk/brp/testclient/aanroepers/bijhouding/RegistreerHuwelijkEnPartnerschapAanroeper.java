...
import nl.bzk.brp.testclient.soapcommands.bijhouding.RegistreerHuwelijkEnPartnerschapCommand;
...
public class RegistreerHuwelijkEnPartnerschapAanroeper extends BijhoudingAanroeper {
    ...
    private static final BigInteger TIJDSTIP_LAATSTE_WIJZIGING          = BigInteger.valueOf(2012092014145900L);

    /** De Constante DATUM_AANVANG_HUWELIJK. */
    ...
    /** De Constante ONTLENINGSTOELICHTING. */
    private static final String     ONTLENINGSTOELICHTING               = "Test test test";

    /** De Constante DATUM_AANVANG_WIJZIGING_NAAMGEBRUIK. */
    private static final BigInteger DATUM_AANVANG_WIJZIGING_NAAMGEBRUIK = BigInteger.valueOf(20120921);

    /** De Constante BSN_NAAMGEBRUIK. */
    private static final String     BSN_NAAMGEBRUIK                     = "100027933";

    /** De Constante TIJD_LAATSTE_WIJZIGING_NAAMGEBRUIK. */
    private static final BigInteger TIJD_LAATSTE_WIJZIGING_NAAMGEBRUIK  = BigInteger.valueOf(2012092014145900L);
    ...
    public void fire() {
        ...
        RegistreerHuwelijkEnPartnerschapCommand command = new RegistreerHuwelijkEnPartnerschapCommand(bijhouding);
        Long duur = roepAan(command);
        TestClient.statistieken.bijwerkenNaBericht(Bericht.BERICHT.BIJHOUDING_REGISTREER_HUWELIJK,
                getStatus(), duur);
    }
    ...
    private HuwelijkPartnerschapRegistratieHuwelijkBijhouding creeerHuwelijkPartnerschapRegistratieHuwelijkBijhouding()
    {
        ...
        tijdstipLaatsteWijziging2.setValue(TIJDSTIP_LAATSTE_WIJZIGING);
        ...
        tijdstipLaatsteWijzigingNaamgebruik.setValue(TIJD_LAATSTE_WIJZIGING_NAAMGEBRUIK);
