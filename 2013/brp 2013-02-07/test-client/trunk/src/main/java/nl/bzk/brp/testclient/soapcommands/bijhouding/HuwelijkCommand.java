...
AbstractSoapCommand<BijhoudingPortType, HuwelijkPartnerschapRegistratieHuwelijkBijhouding, HuwelijkPartnerschapRegistratieHuwelijkResponse>{
    ...
    /** De Constante LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(HuwelijkCommand.class);
     ...
     */
    public HuwelijkCommand(final HuwelijkPartnerschapRegistratieHuwelijkBijhouding vraag) {
        super(vraag);
    }
