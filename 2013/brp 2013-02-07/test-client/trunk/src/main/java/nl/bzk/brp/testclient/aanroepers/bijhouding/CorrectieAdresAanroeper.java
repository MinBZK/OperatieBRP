...
public class CorrectieAdresAanroeper extends BijhoudingAanroeper {
    ...
    private JAXBElement<Huisnummertoevoeging> creeerJaxbHuisnummertoevoeging() {
        ...
        JAXBElement<Huisnummertoevoeging> jaxbHuisnummertoevoeging =
            objectFactory.createObjecttypePersoonAdresHuisnummertoevoeging(huisnummertoevoeging);
    ...
    protected List<String> getParameterList() {
        return Arrays.asList(new String[] { BijhoudingAanroeper.PARAMETER_PREVALIDATIE, PARAMETER_REFERENTIENUMMER,
            PARAMETER_BSN, PARAMETER_NAAM_OPENBARE_RUIMTE, PARAMETER_DATUM_AANVANG_GELDIGHEID,
            PARAMETER_DATUM_EINDE_GELDIGHEID, PARAMETER_HUISNUMMER, PARAMETER_HUISLETTER,
            PARAMETER_HUISNUMMERTOEVOEGING, PARAMETER_POSTCODE, PARAMETER_WOONPLAATS, PARAMETER_GEMEENTECODE });
    }
