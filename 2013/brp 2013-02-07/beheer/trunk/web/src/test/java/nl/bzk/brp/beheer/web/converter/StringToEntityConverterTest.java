...
public class StringToEntityConverterTest {
    ...
    public void setUp() {
        ...
        Mockito.when(stamgegevensService.find(Sector.class, 1)).thenReturn(sector1);
        Mockito.when(stamgegevensService.find(Sector.class, 2)).thenThrow(
    ...
    public void testConvertSourceTypeString() {
        ...
        Mockito.verify(stamgegevensService, Mockito.times(1)).find(Sector.class, 1);
    ...
    public void testConvertTargetTypeString() {
        ...
        Integer id =
            (Integer) stringToEntityConverter.convert(sector1, TypeDescriptor.valueOf(Sector.class),
                    TypeDescriptor.valueOf(String.class));

        Mockito.verify(stamgegevensService, Mockito.times(0)).find((Class<Sector>) Matchers.any(), Matchers.anyInt());
