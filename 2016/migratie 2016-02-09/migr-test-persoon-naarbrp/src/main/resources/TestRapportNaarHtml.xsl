...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="resultaat">
		...
		<table id="thema_{@thema}">
			<tr>
				...
				<th colspan="2" STYLE="text-align: center;">Rondverteer</th>
				<th rowspan="2">Opslaan BRP</th>
				<th rowspan="2">Lezen BRP</th>
				<th colspan="2" STYLE="text-align: center;">BRP naar LO3</th>
			</tr>
            <tr>
                <th STYLE="text-align: center;">Basis vergelijker</th>
                <th STYLE="text-align: center;">Verschil analyse</th>
                <th STYLE="text-align: center;">Basis vergelijker</th>
                <th STYLE="text-align: center;">Verschil analyse</th>
            </tr>
				...
				<tr>
					...
					<xsl:choose>
						...
						<xsl:otherwise>
                            ...
                            <td>
                                <xsl:apply-templates select="rondverteer-va" />
                            </td>
                            <td>
	...
	<xsl:template match="syntaxPrecondities|lo3NaarBrp|conversieLog|rondverteer|rondverteer-va|opslaanBrp|lezenBrp|brpNaarLo3|brpNaarLo3-va">
