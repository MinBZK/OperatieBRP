...
public class TimerTransactionIntegrationTest extends AbstractIntegrationTest {
            ...
            public Long doInTransaction(final TransactionStatus status) {
                ...
                return jbpmInvoker.executeInContext(new JbpmExecution<Long>() {
                    ...
                    public Long doInContext(final JbpmContext jbpmContext) {
                        final ProcessInstance processInstance = jbpmContext.newProcessInstanceForUpdate("timertransaction");
