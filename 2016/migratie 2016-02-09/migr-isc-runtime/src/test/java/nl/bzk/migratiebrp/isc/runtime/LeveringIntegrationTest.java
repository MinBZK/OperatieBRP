...
public class LeveringIntegrationTest extends AbstractIntegrationTest {
    ...
    public void testLevering() throws BerichtSyntaxException, BerichtInhoudException {
        ...
        Assert.assertNotNull("Verzendende partij verwacht", result.getBronGemeente());
