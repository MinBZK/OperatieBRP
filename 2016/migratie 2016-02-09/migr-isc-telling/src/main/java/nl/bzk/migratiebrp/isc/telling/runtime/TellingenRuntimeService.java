...
public interface TellingenRuntimeService {
     ...
     * 
     * @param datumTot
     *            De datum tot wanneer de tellingen bijgewerkt dienen te worden.
     */
     ...
     * 
     * @param datumTot
     *            De datum tot wanneer de berichten worden meegenomen in de telling.
     * 
     ...
     * 
     * @param datumTot
     *            De datum tot wanneer de processen worden meegenomen in de telling. *
     * 
     * @return True indien het bijwerken is gelukt, false in andere gevallen.
     */
