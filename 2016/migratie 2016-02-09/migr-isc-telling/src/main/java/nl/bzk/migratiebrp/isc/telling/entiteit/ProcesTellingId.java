...
public final class ProcesTellingId implements Serializable {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(datum).append(procesnaam).append(berichtType).append(kanaal).toHashCode();
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof ProcesTellingId)) {
            return false;
        }
