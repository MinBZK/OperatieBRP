 ...
 *
 * @param <T>
 *            Een implementatie van BrpGroepInhoud
 */
public abstract class AbstractGgoBrpMapper<T extends FormeleHistorie> {
     ...
     *            De GGO BRP persoonslijst waarin de stapel terecht komt.
     * @param persoon
     *            De entitymodel persoon
     * @param brpStapel
     *            De BRP stapel die wordt ingevuld.
     * @param aNummer
     *            Het aNummer van de persoonslijst.
     * @param labelEnum
     *            Het label van de stapel.
     * @param ahs
        ...
        if (brpStapel != null) {
            ...
            for (final T groep : brpStapel) {
                if (!groep.isVoorkomenTbvLeveringMutaties()) {
                    ...
                    ggoBrpGegevensgroepenBuilder.addHistorie(voorkomen, groep, brpGroepEnum);
                    ggoBrpActieBuilder.createActies(voorkomen, groep, brpGroepEnum, aNummer, ahs);
                    ggoBrpOnderzoekBuilder.createOnderzoeken(voorkomen, persoon, groep, aNummer);
     ...
     *
     * @param voorkomen
     *            Het GGO BRP voorkomen dat wordt bijgewekt
     * @param brpInhoud
