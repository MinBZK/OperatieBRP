...
public class GgoBrpGeslachtsaanduidingMapper extends AbstractGgoBrpMapper<PersoonGeslachtsaanduidingHistorie> {
    ...
    public final void verwerkInhoud(
        ...
        final PersoonGeslachtsaanduidingHistorie brpInhoud,
        final GgoBrpGroepEnum brpGroepEnum)
    {
        getGgoBrpValueConvert().verwerkElement(ggoInhoud, brpGroepEnum, GgoBrpElementEnum.GESLACHTSAANDUIDING, brpInhoud.getGeslachtsaanduiding());
    }
}
