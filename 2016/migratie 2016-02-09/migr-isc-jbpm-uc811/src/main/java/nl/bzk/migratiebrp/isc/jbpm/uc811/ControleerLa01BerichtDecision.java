...
public final class ControleerLa01BerichtDecision implements SpringDecision {
    ...
    private static final String ONGELDIG = "4f. Fout";
    ...
    public String execute(final Map<String, Object> parameters) {
        ...
        if (controleerLa01Bericht(la01Bericht, Long.valueOf(lq01Bericht.getANummer()))) {
            return GELDIG;
        } else {
            return ONGELDIG;
        }
    ...
    private boolean controleerLa01Bericht(final La01Bericht la01Bericht, final Long aNummerLq01Bericht) {

        if (la01Bericht == null || la01Bericht.getLo3Persoonslijst() == null) {
            return false;
        }

        final String originator = la01Bericht.getBronGemeente();
        ...
        if (!aNummerLq01Bericht.equals(la01Bericht.getLo3Persoonslijst().getActueelAdministratienummer())) {
