...
public final class MaakLq01Action implements SpringAction {
    ...
    public Map<String, Object> execute(final Map<String, Object> parameters) {
        ...
        lq01Bericht.setDoelGemeente(inputBericht.getGemeenteCode());
        lq01Bericht.setBronGemeente((String) parameters.get("bronGemeente"));
    ...
    private String getHerhaling(final Object herhaling) {
        ...
        if (herhalingInteger > MAX_GBA_HERHALING) {
            ...
            LOG.warn("synchronisatieVraagHerhaling '{}' is groter dat toegestaan in GBA Herhaalteller."
                     + " Maximaal 1 positie. Herhaalteller op het Lq01 bericht zal op {} blijven staan.", herhaling, MAX_GBA_HERHALING);
        }
