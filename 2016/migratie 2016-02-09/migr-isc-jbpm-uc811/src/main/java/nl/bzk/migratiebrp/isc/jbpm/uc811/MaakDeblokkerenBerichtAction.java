 ...
 */
@Component("uc811MaakDeblokkerenBerichtAction")
public final class MaakDeblokkerenBerichtAction implements SpringAction {
    ...
    public Map<String, Object> execute(final Map<String, Object> parameters) {
        ...
        final String gemeenteCode = getGemeenteVanInschrijving(la01Bericht);
    ...
    private String getGemeenteVanInschrijving(final La01Bericht la01Bericht) {
        final List<Lo3CategorieWaarde> categorieen = la01Bericht.getCategorieen();
        return Lo3CategorieWaardeUtil.getElementWaarde(categorieen, Lo3CategorieEnum.VERBLIJFPLAATS, 0, 0, Lo3ElementEnum.ELEMENT_0910);
    }
}
