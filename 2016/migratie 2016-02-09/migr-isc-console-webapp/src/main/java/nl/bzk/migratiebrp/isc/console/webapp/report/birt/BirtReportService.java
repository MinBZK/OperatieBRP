...
import nl.bzk.migratiebrp.isc.console.webapp.report.ReportRuntimeException;
...
public final class BirtReportService implements ReportService {
    ...
    public BirtReportService(final ReportConfig config) {
        ...
        try {
            ...
            throw new ReportRuntimeException("Could not start BIRT.", e);
        }
    }
    ...
    public String genereerReport(final String reportName, final Map<String, Object> parameters) throws ReportException {
        ...
        try {
            ...
            throw new ReportException("Could not create temporary report file.", e1);
        }
        ...
        throws ReportException
    {
        ...
        if (parameters != null) {
            final IGetParameterDefinitionTask parameterDefinitions = engine.createGetParameterDefinitionTask(reportDesign);

            @SuppressWarnings("unchecked")
            final Iterator<IScalarParameterDefn> parameterDefinitionIterator = parameterDefinitions.getParameterDefns(true).iterator();
            ...
            while (parameterDefinitionIterator.hasNext()) {
                ...
                if (parameters.containsKey(parameterName)) {
                    parameterValues.put(parameterName, BirtReportParameters.convertTo(parameterDefition, parameters.get(parameterName)));
                }
            }
     ...
     */
    private static final class ResourceLocator implements IResourceLocator {
        ...
        @Override
        public URL findResource(final ModuleHandle moduleHandle, final String fileName, final int type, final Map appContext) {
