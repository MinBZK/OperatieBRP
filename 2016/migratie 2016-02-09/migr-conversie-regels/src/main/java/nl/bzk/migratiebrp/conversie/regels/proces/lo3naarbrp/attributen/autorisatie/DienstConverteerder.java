 ...
 */
@Component
public class DienstConverteerder extends AbstractConverteerder {
     ...
     */
    public final TussenStapel<BrpDienstInhoud> converteerDienst(final Lo3Categorie<Lo3AutorisatieInhoud> categorie) {
     ...
     * @return {@link nl.bzk.migratiebrp.conversie.model.tussen.TussenStapel} van {@link BrpDienstInhoud}
     */
    public final TussenStapel<BrpDienstAttenderingInhoud> converteerAttenderingDienst(final Lo3Categorie<Lo3AutorisatieInhoud> categorie) {
     ...
     * @return {@link nl.bzk.migratiebrp.conversie.model.tussen.TussenStapel} van {@link BrpDienstInhoud}
     */
    public final TussenStapel<BrpDienstSelectieInhoud> converteerSelectieDienst(final Lo3Categorie<Lo3AutorisatieInhoud> categorie) {
        final BrpDatum eersteSelectieDatum = lo3AttribuutConverteerder.converteerDatum(categorie.getInhoud().getEersteSelectiedatum());
        ...
        final BrpDienstSelectieInhoud inhoud = new BrpDienstSelectieInhoud(eersteSelectieDatum, selectiePeriodeInMaanden);
