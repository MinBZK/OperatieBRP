...
/**
 * Vertaald GBA voorwaarde regels van type naamgebruik; hiervoor wordt een conversie tabel gebruikt.
 */
@Component
public class SoortRelatieVoorwaardeRegel extends AbstractStandaardVoorwaardeRegel {

    /**
     * Regex expressie voor selectie van voorwaarderegels die door deze class worden behandeld.
     */
    public static final String REGEX_PATROON = "^(05|55)\\.15\\.10.*";
     ...
     */
    public SoortRelatieVoorwaardeRegel() {
    ...
    public final String vertaalWaardeVanRubriek(final String ruweWaarde) {
        ...
        final String vertaaldeWaarde =
                conversieTabelFactory.createSoortRelatieConversietabel().converteerNaarBrp(new Lo3SoortVerbintenis(zonderAanhalingstekens)).getWaarde();
