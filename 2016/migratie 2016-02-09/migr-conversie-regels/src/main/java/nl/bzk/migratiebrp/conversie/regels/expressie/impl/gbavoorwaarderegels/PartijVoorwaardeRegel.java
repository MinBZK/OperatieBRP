 ...
 */
@Component
public class PartijVoorwaardeRegel extends AbstractStandaardVoorwaardeRegel {
     ...
     */
    public PartijVoorwaardeRegel() {
        super(VOLGORDE, REGEX_PATROON);
    }

    @Override
    public final String vertaalWaardeVanRubriek(final String ruweWaarde) {
        return Integer.toString(conversieTabelFactory.createPartijConversietabel().converteerNaarBrp(new Lo3GemeenteCode(ruweWaarde)).getWaarde());
    }
}
