 ...
 */
@Component
public final class IndicatieDocumentVoorwaardeRegel extends AbstractIndicatieVoorwaardeRegel {

    /**
     * Rubriek voor deze indicatie.
     */
    public static final String RUBRIEK = "(08|58).75.10";
    ...
    protected Boolean vertaalIndicatieVanWaarde(final String ruweWaarde) {
        ...
        return conversieTabelFactory.createIndicatieDocumentConversietabel()
                                    .converteerNaarBrp(new Lo3IndicatieDocument(zonderAanhalingstekens, null))
                                    .getWaarde();
    }
}
