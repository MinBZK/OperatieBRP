...
public class Casus22IndicatieTest extends AbstractCasusTest {
...
true), null, null);
...

    {
        ...
        // @formatter:off
        // V 31-12-1989 3-1-1990 <A2>
        // B O 1-1-1990 2-1-1990 <A1>

        // LO3 input
        lo2.vul(lo3VastgesteldNietNl, null, 19891231, 19900103, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        lo1.vul(lo3BijzonderNl, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));

        // verwachte BRP output
        // bijz:
        // Ja 1-1-1990 xxxxxxxx 2-1-1990 2-1-1990 A1 A2 A1
        brpBijzNl1.vul(brpBehandeldAlsNl, 19900101, null, 19900102010000L, 19900102010000L, 'O', actie1, null, actie1);
        // vastgesteld niet NL
        // Ja 31-12-1989 xxxxxxxx 3-1-1990 xxxxxxxx A2 x x
        brpVastgesteldNietNl1.vul(brpVastgesteldNietNl, 19891231, null, 19900103010000L, null, null, actie2, null, null);
        // @formatter:on
