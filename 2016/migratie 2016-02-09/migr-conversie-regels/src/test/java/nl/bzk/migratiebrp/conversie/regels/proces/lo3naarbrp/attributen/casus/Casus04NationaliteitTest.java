...
public class Casus04NationaliteitTest extends AbstractCasusTest {
...

    {
        ...
        lo1.vul(lo3Duits, null, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));

        // verwachte BRP output
        brp1.vul(brpDuits, 19900101, 19950101, 19900102010000L, null, null, actie1, actie2, null);
        // @formatter:on
