...
public class Casus17NationaliteitTest extends AbstractCasusTest {
    ...
    private final BrpNationaliteitInhoud brpDuits =
            new BrpNationaliteitInhoud(new BrpNationaliteitCode(Short.parseShort("1234")), null, null, null, null, null, null);
...

    {
        ...
        // @formatter:off
        // LO3 input
        lo4.vul(lo3Leeg, null, 19941231, 19950113, 4, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        lo3.vul(lo3Leeg, ONJUIST, 19950110, 19950111, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));
        lo2.vul(lo3Leeg, ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 2));
        lo1.vul(lo3Duits, null, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 3));

        // verwachte BRP output
        brp1.vul(brpDuits, 19900101, 19941231, 19900102010000L, null, null, actie1, actie4, null);
        brp2.vul(brpDuits, 19900101, 19950101, 19900102010100L, 19900102010100L, 'O', actie1, actie2, actie1);
        brp3.vul(brpDuits, 19900101, 19950110, 19900102010200L, 19900102010200L, 'O', actie1, actie3, actie1);
        // @formatter:on
