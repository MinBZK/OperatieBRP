...
public class Casus03NaamTest extends AbstractCasusTest {
...

    {
        ...
        // @formatter:off
        // LO3 input
        lo3.vul(lo3Klaas, null, 19941231, 19950110, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 0));
        ...
        brp1.vul(brpJan, 19900101, 19941231, 19900102010000L, null, null, actie1, actie3, null);
        brp2.vul(brpPiet, 19950101, null, 19950102010000L, 19950102010000L, 'O', actie2, null, actie2);
        brp3.vul(brpKlaas, 19941231, null, 19950110010000L, null, null, actie3, null, null);
        // @formatter:on
