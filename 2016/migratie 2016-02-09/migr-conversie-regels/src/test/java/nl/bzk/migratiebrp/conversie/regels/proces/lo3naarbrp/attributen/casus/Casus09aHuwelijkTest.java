...
public class Casus09aHuwelijkTest extends AbstractCasusTest {
...

    {
        ...
        // LO3 input
        lo3.vul(buildHuwelijk(null, null), null, 19900101, 19950103, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_05, 0, 0));
        lo2.vul(buildHuwelijk(null, 19950101), ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_55, 0, 1));
        lo1.vul(buildHuwelijk(19900101, null), ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_55, 0, 2));

        // Conversie volgorde: A1, A2, A3
    ...
    public void testRondverteer() {
        ...
        Lo3StapelHelper.vergelijk(origineleStapels.get(0), rondverteerdeStapels.get(0));
