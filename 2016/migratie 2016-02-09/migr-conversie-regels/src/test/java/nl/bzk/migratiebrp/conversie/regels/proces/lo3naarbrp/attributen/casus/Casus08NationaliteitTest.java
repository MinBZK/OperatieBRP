...
public class Casus08NationaliteitTest extends AbstractCasusTest {
...

    {
        ...
        lo1.vul(lo3Duits, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));

        // verwachte BRP output
        brp1.vul(brpDuits, 19900101, 19900101, 19900102010000L, 19900102010000L, 'O', actie1, actie2, actie1);
        // @formatter:on
