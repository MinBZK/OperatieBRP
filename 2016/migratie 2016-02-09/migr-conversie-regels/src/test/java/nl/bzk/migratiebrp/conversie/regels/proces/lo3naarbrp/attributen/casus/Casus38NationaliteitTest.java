...
public class Casus38NationaliteitTest extends AbstractCasusTest {
...

    {
        ...
        lo1.vul(lo3Duits, null, 20000101, 20000102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 2));
        ...
        brp1.vul(brpDuits, 20000101, 20040101, 20000102010000L, null, null, actie1, actie3, null);
        brp2.vul(brpDuits, 20000101, 20040101, 20000102010100L, 20000102010100L, 'O', actie1, actie2, actie1);
        brp3.vul(brpDuits, 20040101, null, 20040103010000L, null, null, actie3, null, null);
        // @formatter:on
