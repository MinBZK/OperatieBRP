...
public class BrpGroepConverteerderTest<L extends Lo3CategorieInhoud> {
    ...
    @InjectMocks
    private Converteerder converteerder = new Converteerder();
    ...
    public void bepaalgecreerdeRijenTest() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method pm = BrpGroepConverteerder.class.getDeclaredMethod("bepaalGecreeerdeRijen", BrpActie.class, List.class);
    ...
    public void bepaalVervallenRijen() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method pm = BrpGroepConverteerder.class.getDeclaredMethod("bepaalVervallenRijen", BrpActie.class, Collection.class);
        pm.setAccessible(true);
        List<BrpGroep> result = (ArrayList<BrpGroep>) pm.invoke(converteerder, actie1, groepen);
    ...
    public void bepaalGeldigheidsdatums() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method pmBGR = BrpGroepConverteerder.class.getDeclaredMethod("bepaalGecreeerdeRijen", BrpActie.class, List.class);
        ...
        Method pmVR = BrpGroepConverteerder.class.getDeclaredMethod("bepaalVervallenRijen", BrpActie.class, Collection.class);
        ...
        Method pm = BrpGroepConverteerder.class.getDeclaredMethod("bepaalGeldigheidsdatums", Collection.class, Collection.class);
        pm.setAccessible(true);
    ...
    public void bepaalGeldigeRij_legeLijst() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method bgr = BrpGroepConverteerder.class.getDeclaredMethod("bepaalGeldigeRij", Collection.class, BrpDatum.class);
        ...
        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException
    {
        ...
        Method bgr = BrpGroepConverteerder.class.getDeclaredMethod("checkUitzonderingAlleRijenNadereAanduidingVervalGevuld", List.class);
        bgr.setAccessible(true);
    ...
    public void checkUitzonderingAlleRijenAanvangGelijkAanEindeGeldigheid()
        ...
        Method bgr = BrpGroepConverteerder.class.getDeclaredMethod("checkUitzonderingAlleRijenAanvangGelijkAanEindeGeldigheid", List.class);
        bgr.setAccessible(true);
    ...
    public void isPrevalerend() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method bgr = BrpGroepConverteerder.class.getDeclaredMethod("isPrevalerend", BrpGroep.class);
        bgr.setAccessible(true);
    ...
    public void maximaliseerOnbekendeDatum() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method pm = BrpGroepConverteerder.class.getDeclaredMethod("maximaliseerOnbekendeDatum", BrpDatum.class);
        pm.setAccessible(true);
        BrpDatum arg = null;
        assertNull(pm.invoke(converteerder, arg));
        try {
            pm.invoke(converteerder, new BrpDatum(null, new Lo3Onderzoek(new Lo3Integer(new Integer(3610)), new Lo3Datum(20010101), null)));
            Assert.fail();
    ...
    public void checkUitzonderingConversieActieAanpassingGeldigheid() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method pm = BrpGroepConverteerder.class.getDeclaredMethod("checkUitzonderingConversieActieAanpassingGeldigheid", BrpActie.class, List.class);
        pm.setAccessible(true);
        List<BrpGroep> groepen = Collections.EMPTY_LIST;
    ...
    public void checkActieInhoudKomtVoorInAndereRij() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method pm = BrpGroepConverteerder.class.getDeclaredMethod("checkActieInhoudKomtVoorInAndereRij", List.class, BrpStapel.class);
        pm.setAccessible(true);
        List<BrpGroep<BrpGeboorteInhoud>> groepen = new ArrayList<>();
        groepen.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105),BrpHistorieTest.createInhoud(20010506, 20020506, 20010106, 20020106),actie1,actie1,null));
        groepen.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105),BrpHistorieTest.createInhoud(20010505, 20020505, 20010105, 20020105),actie2,null,null));
        groepen.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105),BrpHistorieTest.createInhoud(20010505, 20020505, 20010105, 20020105),actie1,null,null));
    ...
    public void checkActieInhoudKomtNietVoorInAndereRij() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        groepen2.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105),BrpHistorieTest.createInhoud(20010506, 20020506, 20010106, 20020106),actie3,actie2,null));
        groepen2.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105),BrpHistorieTest.createInhoud(20010505, 20020505, 20010105, 20020105),actie4,null,null));
        groepen2.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105),BrpHistorieTest.createInhoud(20010505, 20020505, 20010105, 20020105),actie4,null,null));
    ...
    public void converteer(){
        try {
            ...
            BrpActie actie1 = new BrpActie(1001L, BrpSoortActieCode.CONVERSIE_GBA, BrpPartijCode.MINISTER, BrpDatumTijd.fromDatum(20010102, null), null, Collections.<BrpActieBron>emptyList(), 1, null);
    ...
    public void converteerUitzondering(){
        try {
            List<BrpGroep<BrpGeboorteInhoud>> groepen2 = new ArrayList<>();
            groepen2.add(new BrpGroep<>(BrpGeboorteInhoudTest.getBrpGeboorteInhoud(20010105), BrpHistorieTest.createInhoud(20010506, 20020506, 20010106, 20020106),null, null, actie1));
    ...
    private class Converteerder extends BrpGroepConverteerder {
