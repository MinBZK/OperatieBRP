...
public class Casus02NaamTest extends AbstractCasusTest {
...

    {
        ...
        // @formatter:off
        // LO3 input
        lo3.vul(lo3Klaas, null, 20000101, 20000102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 0));
        ...
        brp1.vul(brpJan, 19900101, 20000101, 19900102010000L, null, null, actie1, actie3, null);
