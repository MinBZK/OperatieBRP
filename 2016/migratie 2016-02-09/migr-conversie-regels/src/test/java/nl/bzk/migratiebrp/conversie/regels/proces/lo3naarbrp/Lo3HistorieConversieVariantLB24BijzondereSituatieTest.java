...
public class Lo3HistorieConversieVariantLB24BijzondereSituatieTest extends AbstractLoggingTest {
    ...
    public <T extends BrpGroepInhoud> void testGeenBijzondereSituatieLB020() {
        final TussenGroep<BrpOverlijdenInhoud> tussenGroep1 =
                new TussenGroep<>(new BrpOverlijdenInhoud(new BrpDatum(19830205, null), new BrpGemeenteCode((short) 1904), new BrpString(
                    "woonplaats",
                    null), null, null, new BrpLandOfGebiedCode((short) 6030), new BrpString("omschrijving", null)), Lo3StapelHelper.lo3His(
                    "O",
                    19830205,
