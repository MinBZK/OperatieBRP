...
public class Casus45IndicatieTest extends AbstractCasusTest {
    ...
    private final Lo3NationaliteitInhoud lo3VastgesteldNietNl = new Lo3NationaliteitInhoud(
        ...
        null,
        null,
        Lo3AanduidingBijzonderNederlandschapEnum.VASTGESTELD_NIET_NEDERLANDER.asElement());
...
true), null, null);
...

    {
        ...
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(20010102, null), "3A");
        final BrpActie actie2 = buildBrpActie(BrpDatumTijd.fromDatum(20000102, null), "2A");
        final BrpActie actie1 = buildBrpActie(BrpDatumTijd.fromDatum(19900102, null), "1A");

        // @formatter:off
        // V 8-1-1990 2-1-2001 <A3>
        // - 1-1-2000 2-1-2000 <A2>
        // B O 1-1-1990 2-1-1990 <A1>

        // LO3 input
        lo3.vul(lo3Leeg, null, 20000101, 20000102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        lo2.vul(lo3VastgesteldNietNl, null, 19900108, 20010102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));
        lo1.vul(lo3BijzonderNl, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 2));
        ...
        brpVastgesteldNietNl1.vul(brpVastgesteldNietNl, 19900108, 20000101, 20010102010000L, null, null, actie3, actie2, null);
        // @formatter:on
