...
public class BrpBepalenAdellijkeTitelTest {
    ...
    public void testConverteer() {
        ...
        builder.persoonStapel(lo3Stapel(lo3Cat(
            lo3Persoon(1234567L, null, MARIE, "JH", null, BEL, 19750101, GEM_CODE, LAND_CODE, "V", null, null, "E"),
    ...
    public void testConverteerTitelMetOnderzoek() {
        ...
        final Lo3PersoonInhoud persoonInhoud = lo3Persoon(1234567L, null, MARIE, "JH", null, BEL, 19750101, GEM_CODE, LAND_CODE, "V", null, null, "E");
        final Lo3PersoonInhoud.Builder persoonInhoudBuilder = new Lo3PersoonInhoud.Builder(persoonInhoud);
        final Lo3Onderzoek onderzoek = new Lo3Onderzoek(new Lo3Integer(0), Lo3Datum.NULL_DATUM, null);
        ...
        builder.persoonStapel(lo3Stapel(lo3Cat(persoonInhoudOnderzoek, lo3Doc(3L, DOC03, 19750102, DOC03_OMS), lo3His(19750102), new Lo3Herkomst(
    ...
    public void testConverteerLegeTitelMetOnderzoek() {
        ...
        final Lo3PersoonInhoud persoonInhoud = lo3Persoon(1234567L, null, MARIE, null, null, BEL, 19750101, GEM_CODE, LAND_CODE, "V", null, null, "E");
        final Lo3PersoonInhoud.Builder persoonInhoudBuilder = new Lo3PersoonInhoud.Builder(persoonInhoud);
        final Lo3Onderzoek onderzoek = new Lo3Onderzoek(new Lo3Integer(0), Lo3Datum.NULL_DATUM, null);
    ...
    public void testConverteerLegeGeslachtsaanduidingMetOnderzoek() {
        ...
        final Lo3PersoonInhoud persoonInhoud = lo3Persoon(1234567L, null, MARIE, "JH", null, BEL, 19750101, GEM_CODE, LAND_CODE, null, null, null, "E");
        final Lo3PersoonInhoud.Builder persoonInhoudBuilder = new Lo3PersoonInhoud.Builder(persoonInhoud);
        final Lo3Onderzoek onderzoek = new Lo3Onderzoek(new Lo3Integer(0), Lo3Datum.NULL_DATUM, null);
    ...
    public void testConverteerLegeTitelEnGeslachtsaanduidingMetOnderzoek() {
        ...
        final Lo3PersoonInhoud persoonInhoud = lo3Persoon(1234567L, null, MARIE, null, null, BEL, 19750101, GEM_CODE, LAND_CODE, null, null, null, "E");
        final Lo3PersoonInhoud.Builder persoonInhoudBuilder = new Lo3PersoonInhoud.Builder(persoonInhoud);
        final Lo3Onderzoek onderzoek1 = new Lo3Onderzoek(new Lo3Integer(0), Lo3Datum.NULL_DATUM, Lo3Datum.NULL_DATUM);
        final Lo3Onderzoek onderzoek2 = new Lo3Onderzoek(new Lo3Integer(0), Lo3Datum.NULL_DATUM, null);
