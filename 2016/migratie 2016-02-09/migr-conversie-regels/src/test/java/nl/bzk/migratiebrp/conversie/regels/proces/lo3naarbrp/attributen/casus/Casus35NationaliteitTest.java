...
public class Casus35NationaliteitTest extends AbstractCasusTest {
...

    {
        ...
        lo2.vul(lo3Duits, null, 19890101, 20000102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));
        lo1.vul(lo3Duits, ONJUIST, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 2));

        // verwachte BRP output
        // Duits 1-1-1989 1-1-1995 2-1-2000 <A3> <A2>
        ...
        brp2.vul(brpDuits, 19890101, 19950101, 20000102010000L, null, null, actie3, actie2, null);
        // @formatter:on
