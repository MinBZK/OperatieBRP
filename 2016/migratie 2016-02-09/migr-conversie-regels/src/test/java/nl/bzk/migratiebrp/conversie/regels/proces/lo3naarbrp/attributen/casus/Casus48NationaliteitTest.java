...
public class Casus48NationaliteitTest extends AbstractCasusTest {
...

    {
        ...
        // @formatter:off
        // Duits 1-1-1995 2-1-2000 <A3>
        // - O 1-1-1995 2-1-1995 <A2>
        // Duits 1-1-1990 2-1-1990 <A1>

        // LO3 input
        lo3.vul(lo3Duits, null, 19950101, 20000102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        lo2.vul(lo3Leeg, ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 1));
        lo1.vul(lo3Duits, null, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_54, 0, 2));

        // verwachte BRP output

        brp1.vul(brpDuits, 19900101, 19950101, 19900102010000L, null, null, actie1, actie3, null);
        brp2.vul(brpDuits, 19900101, 19950101, 19900102010100L, 19900102010100L, 'O', actie1, actie2, actie1);
        brp3.vul(brpDuits, 19950101, null, 20000102010000L, null, null, actie3, null, null);
        // @formatter:on
