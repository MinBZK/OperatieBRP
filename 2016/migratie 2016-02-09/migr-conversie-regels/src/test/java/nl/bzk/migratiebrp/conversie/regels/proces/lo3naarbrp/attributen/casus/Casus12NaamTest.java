...
public class Casus12NaamTest extends AbstractCasusTest {
    ...
    private final BrpVoornaamInhoud brpHenk = new BrpVoornaamInhoud(new BrpString("Henk"), new BrpInteger(1));
    ...
    private final BrpTestObject<BrpVoornaamInhoud> brp4 = new BrpTestObject<>();

    {
        ...
        final BrpActie actie4 = buildBrpActie(BrpDatumTijd.fromDatum(20010102, null), "4A");

        // @formatter:off

        // LO3 input
        lo4.vul(lo3Klaas, null, 20000101, 20000102, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 0));
        lo3.vul(lo3Piet, ONJUIST, 19950101, 19950102, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_51, 0, 1));
        lo2.vul(lo3Henk, null, 19940101, 20010102, 4, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_51, 0, 2));
        lo1.vul(lo3Jan, null, 19900101, 19900102, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_51, 0, 3));

        // verwachte BRP output
        brp1.vul(brpJan, 19900101, 19940101, 19900102010000L, null, null, actie1, actie4, null);
        brp2.vul(brpPiet, 19950101, null, 19950102010000L, 19950102010000L, 'O', actie2, null, actie2);
        brp3.vul(brpKlaas, 20000101, null, 20000102010000L, null, null, actie3, null, null);
        brp4.vul(brpHenk, 19940101, 20000101, 20010102010000L, null, null, actie4, actie3, null);
        // @formatter:on
    ...
    public void testLo3NaarBrp() {
        ...
        assertVoornaam(voornaamStapel.get(3), brp4);
    }
