 ...
 * BRP JMX Kanaal.
 */
public final class BrpVerzendingJmxKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public BrpVerzendingJmxKanaal() {
        super(new Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-jmx-brp-verzending.xml"));
    }
