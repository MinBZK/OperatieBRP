 ...
 * Sync queue kanaal.
 */
public final class AutorisatieQueueKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "autorisatie";

    /**
     * Constructor.
     */
    public AutorisatieQueueKanaal() {
        super(new Worker(),
              new Configuration(
