 ...
 * BRP JMX Kanaal.
 */
public final class IscJmxKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public IscJmxKanaal() {
        super(new Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-jmx-isc.xml"));
    }
