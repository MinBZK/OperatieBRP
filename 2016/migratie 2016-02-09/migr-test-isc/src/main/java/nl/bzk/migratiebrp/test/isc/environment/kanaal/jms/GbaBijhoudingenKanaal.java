 ...
 */
public class GbaBijhoudingenKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "gbaBijhouding";

    /**
     * Constructor.
     */
    public GbaBijhoudingenKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        protected String getCorrelatieIdentifier() {
            return GbaBijhoudingenKanaal.KANAAL;
        }
