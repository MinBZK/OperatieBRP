 ...
 */
public class GbaArchiefDlqKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "gbaArchiefDlq";

    /**
     * Constructor.
     */
    public GbaArchiefDlqKanaal() {
