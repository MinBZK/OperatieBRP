 ...
 */
public class GbaArchiefKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "gbaArchief";

    /**
     * Constructor.
     */
    public GbaArchiefKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        protected String getCorrelatieIdentifier() {
            return GbaArchiefKanaal.KANAAL;
        }
