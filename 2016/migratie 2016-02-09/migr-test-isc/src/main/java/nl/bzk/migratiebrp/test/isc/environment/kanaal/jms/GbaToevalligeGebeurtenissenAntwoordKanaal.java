 ...
 */
public class GbaToevalligeGebeurtenissenAntwoordKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "gbaToevalligeGebeurtenissenAntwoord";

    /**
     * Constructor.
     */
    public GbaToevalligeGebeurtenissenAntwoordKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaToevalligeGebeurtenissenAntwoordQueue")
