 ...
 */
public class GbaAfnemerindicatiesKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "gbaAfnemerindicaties";

    /**
     * Constructor.
     */
    public GbaAfnemerindicatiesKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        @Inject
        @Named("gbaAfnemerindicatiesQueue")
