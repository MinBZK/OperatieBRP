...
/**
 * Kanaal om berichten te lezen: Gba Afnemersindicaties antwoord DLQ.
 */
public class GbaAfnemerindicatiesAntwoordDlqKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "gbaAfnemerindicatiesAntwoordDlq";

    /**
     * Constructor.
     */
    public GbaAfnemerindicatiesAntwoordDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        @Inject
        @Named("gbaAfnemerindicatiesAntwoordDlqQueue")
