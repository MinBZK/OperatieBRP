 ...
 */
public class HornetQDlqKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "hornetq_dlq";

    private static final Logger LOG = LoggerFactory.getLogger();
    
    public HornetQDlqKanaal() {
        super(new HornetQDlqKanaal.Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-queues-hornetq.xml", "classpath:infra-jms-hornetq.xml"));
    }
