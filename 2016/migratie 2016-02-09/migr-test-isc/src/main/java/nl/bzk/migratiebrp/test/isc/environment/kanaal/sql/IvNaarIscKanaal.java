...
/**
 * Kanaal om migr-init-naarisc mee uit te voeren.
 */
public class IvNaarIscKanaal extends LazyLoadingKanaal {

    /** Kanaal naam. */
    public static final String KANAAL = "iv_naarisc";

    /**
     * Constructor.
     */
    public IvNaarIscKanaal() {
        super(new Worker(),
              new Configuration(
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        private String verwerk() throws KanaalException {
            try {
                return new IvUc105Helper("/sql/extract-isc-verzender.sql", gbavDataSource, iscDataSource).execute();
