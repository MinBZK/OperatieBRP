...
import nl.bzk.migratiebrp.test.isc.environment.kanaal.jms.GbaAfnemerindicatiesKanaal;
 ...
 */
public final class HornetQKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "hornetq";
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        @Inject
        @Named("hornetQVerzoek")
        private Destination inkomendDestination;

        @Inject
        @Named("hornetQAntwoord")
        ...
        public Bericht verwerkInkomend(final TestCasusContext testCasus, final Bericht verwachtBericht) throws KanaalException {
            ...
            if (verwachtBericht.getCorrelatieReferentie() != null) {
                correlator.controleerUitgaand(verwachtBericht.getCorrelatieReferentie(), GbaAfnemerindicatiesKanaal.KANAAL);
            ...
            if (message == null) {
                ...
                correlator.registreerInkomend(
                        verwachtBericht.getBerichtReferentie(),
                        GbaAfnemerindicatiesKanaal.KANAAL,
                        ontvangenBericht.getBerichtReferentie());
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            ...
            correlator.registreerUitgaand(bericht.getBerichtReferentie(), GbaAfnemerindicatiesKanaal.KANAAL, berichtReferentie);
        ...
        protected boolean vergelijkInhoud(final String verwachteInhoud, final String ontvangenInhoud) {
            try {
                ...
                final JsonNode jsonNode = objectMapper.readTree(ontvangenInhoud);
                final JsonNode expectedJsonNode = objectMapper.readTree(verwachteInhoud);
                return jsonNode.equals(expectedJsonNode);
