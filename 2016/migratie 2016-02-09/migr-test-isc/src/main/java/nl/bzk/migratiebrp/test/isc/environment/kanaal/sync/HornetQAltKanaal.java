 ...
 */
public final class HornetQAltKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "hornetq_alt";
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public Bericht verwerkInkomend(final TestCasusContext testCasus, final Bericht verwachtBericht) throws KanaalException {
            ...
            if (verwachtBericht.getCorrelatieReferentie() != null) {
                correlator.controleerUitgaand(verwachtBericht.getCorrelatieReferentie(), HornetQAltKanaal.KANAAL);
            ...
            try {
                jmsTemplate.setReceiveTimeout(originalTimeout / AANTAL_LOOPS);

                int count = 0;
                while (count++ < AANTAL_LOOPS && message == null) {
            ...
            if (message == null) {
                ...
                correlator.registreerInkomend(verwachtBericht.getBerichtReferentie(), HornetQAltKanaal.KANAAL, ontvangenBericht.getBerichtReferentie());
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            ...
            correlator.registreerUitgaand(bericht.getBerichtReferentie(), HornetQAltKanaal.KANAAL, berichtReferentie);
