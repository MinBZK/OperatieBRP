 ...
 * BRP JMX Kanaal.
 */
public final class BrpGbaCentraleJmxKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public BrpGbaCentraleJmxKanaal() {
        super(new Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-jmx-brp-gbacentrale.xml"));
    }
