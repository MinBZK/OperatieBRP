...
/**
 * Kanaal om berichten te lezen: Gba Toevallige Gebeurtenissen DLQ.
 */
public class GbaToevalligeGebeurtenissenDlqKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public GbaToevalligeGebeurtenissenDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaToevalligeGebeurtenissenDlqQueue")
        private Destination destination;

        @Override
        public String getKanaal() {
            return "gbaToevalligeGebeurtenissenDlq";
        }
