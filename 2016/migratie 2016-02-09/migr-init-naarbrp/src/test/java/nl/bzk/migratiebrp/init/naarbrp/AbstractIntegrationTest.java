...
public class AbstractIntegrationTest {
    ...
    protected Integer insertGbavPersoon(final Date tijdstip, final String inhoud, final Integer plId) {
        ...
        try {
            ...
            LOGGER.info("insertGbavPersoon: anr: {}, originator: {}, opschortdatum: {}, opschortreden: {}", new Object[] {aNummer,
    ...
    protected void insertAfnemersIndicatie(final Long aNummer, final Integer afnemersindicatie, final Integer ingangsdatumGeldigheid) {
        ...
        final Lo3Categorie<Lo3AfnemersindicatieInhoud> categorie = new Lo3Categorie<Lo3AfnemersindicatieInhoud>(inhoud, null, historie, null);
        final List<Lo3Categorie<Lo3AfnemersindicatieInhoud>> categorieen = Arrays.asList(categorie);
        final Lo3Stapel<Lo3AfnemersindicatieInhoud> stapel = new Lo3Stapel<Lo3AfnemersindicatieInhoud>(categorieen);
        final List<Lo3Stapel<Lo3AfnemersindicatieInhoud>> stapels = Arrays.asList(stapel);
            ...
            final Date tijdstipMutatie) throws SQLException
        {
            ...
            try (Connection connection = gbavDataSource.getConnection();
                ...
                final PreparedStatement lo3PlPersoonStatement =
                        connection.prepareStatement("insert into lo3_pl_persoon(pl_id, persoon_type, stapel_nr, volg_nr, a_nr) "
                                                    + "values(?, 'P', 0, 0, ?)")) {
    ...
    public static final class GbavAfnemersindicatieRepository {
        ...
        private Long zoekPersoon(final Connection connection, final Long aNummer) throws SQLException {
