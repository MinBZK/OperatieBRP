...
public abstract class AbstractJdbcRepository {
    ...
    /** Transactionmanager. */
    public static final String INIT_RUNTIME_TRANSACTION_MANAGER = "init-runtime-transactionManager";
    ...
    protected final String getStringResourceData(final String resourcePath) {
        try (final InputStream inputStream = AbstractJdbcRepository.class.getResourceAsStream(resourcePath)) {
