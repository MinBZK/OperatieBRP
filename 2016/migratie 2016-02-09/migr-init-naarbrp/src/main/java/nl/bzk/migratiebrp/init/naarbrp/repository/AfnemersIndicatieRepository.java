...
public interface AfnemersIndicatieRepository {
    ...
    /**
     * Laad de initiele vulling autorisatie tabel met de berichten die naar de BRP database gestuurd moeten worden.
     */
    void laadInitVullingAfnIndTable();

    /**
     * Zoekt in de initiele vulling tabel naar afnemerindicaties met de aangegeven ConversieResultaat status. Deze
     * regels worden doorgegeven aan de verwerker.
     *
     ...
     */
    boolean verwerkAfnemerindicaties(ConversieResultaat zoekConversieResultaat, AfnemersindicatieBerichtVerwerker verwerker, int batchGrootte);
     ...
     */
    void updateAfnemersIndicatiesBerichtStatus(List<Long> aNummers, ConversieResultaat conversieResultaat);
