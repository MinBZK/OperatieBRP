...
public interface ProcesService {
     ...
     * 
     * @param datumTot
     *            De datum tot wanneer op te schonen processen worden meegenomen.
     * 
     ...
     * 
     * @param procesId
     *            Het id van het proces waarvoor we willen bepalen of deze verwijderbaar is.
     * @param verwerkteProcesIds
     *            Lijst met reeds verwerkte processen.
     * @param verwijderdeProcesIds
     *            Lijst met reeds verwijderde processen.
     * @throws NietVerwijderbareProcesInstantieException
     *             Exceptie die wordt gegooid wanneer het proces niet verwijderbaar is.
     */
     ...
     * 
     * @param procesId
     *            Het id van het proces dat we willen verwijderen.
     * @param verwerkteProcesIds
     *            Lijst met reeds verwerkte processen.
     * @param verwijderdeProcesIds
     *            Lijst met reeds verwijderde processen.
     ...
     * 
     * @param procesId
     *            Het proces dat geupdate dient te worden.
     * @param verwachteVerwijderDatum
     *            De te zetten verwachte verwijder datum.
     */
