...
public interface JbpmDao {
     ...
     * 
     * @param procesId
     *            Het proces waarvan we de subprocessen willen.
     ...
     * 
     * @param procesId
     *            Het id van het proces waarvan we de einddatum willen.
     ...
     * 
     * @param procesId
     *            Het id van het proces waarvoor we de task instances verwijderen.
     */
     ...
     * 
     * @param tokens
     *            Lijst van tokens waarvoor we de variable instances bepalen.
     ...
     * 
     * @param tokens
     *            Lijst van tokens waarvoor we de variable instances verwijderen.
     */
     ...
     * 
     * @param procesId
     *            Het Id van het te verwijderen proces.
     */
     ...
     *            Lijst van ids van de variable instances.
     ...
     * 
     * @param byteArrays
     *            Lijst met id's van te verwijderen byte arrays.
     */
     ...
     * 
     * @param tokens
     *            De ids van de tokens waarvoor we de referenties willen verwijderen.
     */
     ...
     * 
     * @param tokens
     *            De tokens waarvoor we de logs verwijderen.
     */
     ...
     * 
     * @param procesId
     *            Het id van het proces waarvoor we de jobs willen opruimen.
     */
     ...
     * 
     * @param procesId
     *            Het id van het proces waarvoor de module instances worden verwijderd.
     */
     ...
     * 
     * @param token
     *            Het token waarvoor we de subprocessen ophalen.
     ...
     * 
     * @param tokens
     *            De te verwijderen refereneties van tokens.
     */
     ...
     * 
     * @param tokens
     *            De tokens waarvoor de token variable map worden verwijderd.
     */
     ...
     * 
     * @param tokens
     *            De lijst met tokens waarvoor we de comments verwijderen.
     */
     ...
     * 
     * @param taskInstances
     *            De id's van de task instances waarvoor we de swimlane instances verwijderen.
     */
     ...
     * 
     * @param taskInstances
     *            De id's van de task instances waarvoor we de task actor pools verwijderen.
     */
     ...
     * 
     * @param procesId
     *            Het id van het proces waarvoor we de runtime actions verwijderen.
     */
