...
public final class Wa01Bericht extends AbstractParsedLo3Bericht implements Lo3Bericht, Serializable {
    ...
    protected List<String> getGerelateerdeAnummers() {
        return Arrays.asList(aNummer == null ? null : aNummer.toString(), getHeader(Lo3HeaderVeld.A_NUMMER));
    }
    ...
    public Long getNieuwANummer() {
        return SimpleParser.parseLong(getHeader(Lo3HeaderVeld.A_NUMMER));
    }
     ...
     *            a-nummer
     */
    public void setNieuwANummer(final Long nieuwANummer) {
        setHeader(Lo3HeaderVeld.A_NUMMER, Lo3Format.format(nieuwANummer));
    }
    ...
    public Lo3Datum getDatumGeldigheid() {
        return SimpleParser.parseLo3Datum(getHeader(Lo3HeaderVeld.DATUM));
    }
     ...
     *            a-nummer
     */
    public void setOudANummer(final Long oudANummer) {
        aNummer = oudANummer;
    }
