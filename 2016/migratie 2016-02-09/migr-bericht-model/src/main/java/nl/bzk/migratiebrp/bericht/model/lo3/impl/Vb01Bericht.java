 ...
 * Vb01.
 */
public final class Vb01Bericht extends AbstractCategorieGebaseerdParsedLo3Bericht implements Lo3Bericht, Serializable {
    private static final long serialVersionUID = 1L;

    private static final Lo3Header HEADER = new Lo3Header(
        Lo3HeaderVeld.RANDOM_KEY,
        Lo3HeaderVeld.BERICHTNUMMER,
        Lo3HeaderVeld.LENGTE_BERICHT,
        Lo3HeaderVeld.BERICHT);

    /**
     * Default constructor.
     */
    public Vb01Bericht() {
        super(HEADER, "Vb01", null);
    }
    ...
    public void setBericht(final String bericht) {
        setHeader(Lo3HeaderVeld.BERICHT, bericht);
