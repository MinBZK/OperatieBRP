...
public class AkteEnumTest {
    ...
    public void testValues() {
        Assert.assertEquals("Aantal akten moet 18 zijn", 18, AkteEnum.values().length);
    }
    ...
    public void testValueOf_String() {
        AkteEnum.AKTE_3B.equals(AkteEnum.valueOf("AKTE_3B"));
    }
    ...
    public void testZijnJuisteCategorieenAanwezigMetAlleenVerplichtElementenAanwezig() throws Exception {
        final List<Lo3CategorieWaarde> waarden = Arrays.asList(
        ...
        AkteEnum.AKTE_3A.zijnJuisteCategorieenAanwezig("36A123456789", waarden);
    ...
    public void testZijnJuisteCategorieenAanwezigMetOntbrekendeVerplichtElementen() throws Exception {
        ...
        try {
            AkteEnum.AKTE_3A.zijnJuisteCategorieenAanwezig("36A123456789", waarden);
        } catch (AkteEnum.AkteEnumException ae) {
            for (final String melding :  ae.getFoutMeldingen()) {
                LOG.error(melding);
            }
            Assert.assertEquals(12, ae.getFoutMeldingen().size());
        }
    ...
    public void testZijnJuisteCategorieenAanwezigMetNietToegestaneElementenAanwezig() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(3, ae.getFoutMeldingen().size());
        }
    ...
    public void testZijnJuisteCategorieenAanwezigMetDubbeleCategorieen() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(11, ae.getFoutMeldingen().size());
        }
    ...
    public void testValueOf_char_char_BestaandeAkte() {
        Assert.assertEquals(AkteEnum.AKTE_3A, AkteEnum.valueOf('3', 'A'));
    }
    ...
    public void testValueOf_char_char_NietBestaandeAkte() {
        AkteEnum.valueOf('9', 'Z');
    }
}