...
public class LeesAutorisatieRegisterVerzoekBerichtTest extends AbstractSyncBerichtTest {

    @Test
    public void test() throws BerichtInhoudException, ClassNotFoundException, IOException {
        final LeesAutorisatieRegisterVerzoekBericht bericht = new LeesAutorisatieRegisterVerzoekBericht();
