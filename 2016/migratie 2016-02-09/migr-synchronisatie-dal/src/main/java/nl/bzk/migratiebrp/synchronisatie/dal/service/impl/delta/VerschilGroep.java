 ...
 * {@link nl.bzk.migratiebrp.synchronisatie.dal.domein.brp.kern.entity.ALaagHistorieVerzameling}) als een Historie (
...
public final class VerschilGroep implements Iterable<Verschil> {
     ...
     * 
     * @param verschilGroep
     *            het object waar een kopie van wordt gemaakt.
     ...
     * 
     * @param formeleHistorie
     *            de historie waar dit object voor gemaakt wordt
     ...
     * 
     * @param verschil
     *            het verschil dat mogelijk toegevoegd wordt aan de lijst.
     */
     ...
     *
     * @param nieuweVerschillen
     *            de lijst met nieuwe verschillen die mogelijk worden toegevoegd aan de lijst.
     */
     ...
     * 
     * @param verschil
     *            het verschil wat verwijderd moet worden
    ...
    /**
     * @return geeft de {@link FormeleHistorie} object terug waarvoor deze groep is aangemaakt, null als het voor een
     *         {@link nl.bzk.migratiebrp.synchronisatie.dal.domein.brp.kern.entity.ALaagHistorieVerzameling} is gemaakt.
     */
