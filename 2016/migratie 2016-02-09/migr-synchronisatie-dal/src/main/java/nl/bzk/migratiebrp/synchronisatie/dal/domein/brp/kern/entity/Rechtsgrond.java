...
public class Rechtsgrond extends AbstractDeltaEntiteit implements Serializable, DynamischeStamtabel {
    ...
    @Column(name = "srt", insertable = false, updatable = false, nullable = false)
    private short soortRechtsgrondId;
     ...
     *            omschrijving
     */
    public Rechtsgrond(final short code, final SoortRechtsgrond soort, final String omschrijving) {
        this.code = code;
        setSoortRechtsgrond(soort);
    ...
    /**
     * Geef de waarde van soort rechtsgrond.
     *
     * @return soort rechtsgrond
     */
    public SoortRechtsgrond getSoortRechtsgrond() {
        return SoortRechtsgrond.parseId(soortRechtsgrondId);
    }

    /**
     * Zet de waarde van soort rechtsgrond.
     *
     * @param soort
     *            soort rechtsgrond
     */
    public void setSoortRechtsgrond(final SoortRechtsgrond soort) {
        ValidationUtils.controleerOpNullWaarden("soortRechtsgrond mag niet null zijn", soort);
        soortRechtsgrondId = soort.getId();
    }
