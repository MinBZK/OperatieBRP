...
public interface ConsolidatieData {
     ...
     *
     * @param nieuweActieParam
     *            de nieuwe actie
     * @param oudeActieParam
     *            de oude actie
     */
     ...
     * @param mRijenParam
     *            de m-rijen
     * @param nieuweRijAanpassingen
     *            de verschillen op nieuwe rijen
     * @return een kopie van de actie consolidatie data waaruit acties zijn verwijderd die alleen voorkomen in m-rijen
     *         en niet gebruikt worden in nieuwe rijen
     */
     ...
     *
     * @param nieuweActiesParam
     *            de set van nieuwe acties
     ...
     *
     * @param data
     *            de consilidatie data uit een andere vergelijking.
     */
