        ...
        AbstractNietIngeschrevenPersoonHistorieMapperStrategie<BrpSamengesteldeNaamInhoud, PersoonSamengesteldeNaamHistorie>
{
     ...
     */
    @Override
    protected void kopieerActueleGroepNaarEntiteit(final PersoonSamengesteldeNaamHistorie historie, final Persoon persoon) {
        persoon.setAdellijkeTitel(historie.getAdellijkeTitel());
        persoon.setPredicaat(historie.getPredicaat());
        persoon.setVoornamen(historie.getVoornamen());
        persoon.setGeslachtsnaamstam(historie.getGeslachtsnaamstam());
        persoon.setVoorvoegsel(historie.getVoorvoegsel());
        persoon.setScheidingsteken(historie.getScheidingsteken());
        persoon.setIndicatieAfgeleid(historie.getIndicatieAfgeleid());
        persoon.setIndicatieNamenreeks(historie.getIndicatieNamenreeks());
    }
    ...
    protected PersoonSamengesteldeNaamHistorie mapHistorischeGroep(final BrpSamengesteldeNaamInhoud groepInhoud, final Persoon persoon) {
        ...
        if (Validatie.isAttribuutGevuld(adellijkeTitelCode)) {
        ...
        if (Validatie.isAttribuutGevuld(predicaatCode)) {
