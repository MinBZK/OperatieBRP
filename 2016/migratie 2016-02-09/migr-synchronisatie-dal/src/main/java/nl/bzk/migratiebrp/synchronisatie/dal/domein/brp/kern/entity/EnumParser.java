...
public class EnumParser<E extends Enumeratie> {
    private final Map<Short, E> enumaratiesOpId;
     ...
     * @return map
     */
    private Map<Short, E> maakIndexVanEnumeratieOpId(final Class<E> clazz) {
        final Map<Short, E> result = new HashMap<>();
     ...
     */
    public final E parseId(final Short id) {
        if (id == null) {
            return null;
        }
