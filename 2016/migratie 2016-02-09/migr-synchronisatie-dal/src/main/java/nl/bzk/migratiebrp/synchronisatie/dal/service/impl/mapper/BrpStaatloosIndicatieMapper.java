...
/**
 * Map staatloos indicatie van het BRP database model naar het BRP conversie model.
 */
@Component
public final class BrpStaatloosIndicatieMapper extends AbstractBrpMapper<PersoonIndicatieHistorie, BrpStaatloosIndicatieInhoud> {
