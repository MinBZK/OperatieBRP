        ...
        extends AbstractMapperStrategie<T, E>
{
    ...
    private void mapActieEnHistorie(final BrpGroep<T> teMappenGroep, final H historie) {
        if (historie instanceof MaterieleHistorie) {
            MapperUtil.mapHistorieVanMigratie(teMappenGroep.getHistorie(), (MaterieleHistorie) historie, getOnderzoekMapper());
        } else {
            MapperUtil.mapFormeleHistorieVanMigratie(teMappenGroep.getHistorie(), historie, getOnderzoekMapper());
        }
    }
