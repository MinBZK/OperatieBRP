...
public class RedenVerliesNLNationaliteit extends AbstractDeltaEntiteit implements Serializable, DynamischeStamtabel {
     ...
     *            omschrijving
     */
    public RedenVerliesNLNationaliteit(final short code, final String omschrijving) {
        this.code = code;
