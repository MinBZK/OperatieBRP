...
public final class PersoonGeboorteMapper extends AbstractNietIngeschrevenPersoonHistorieMapperStrategie<BrpGeboorteInhoud, PersoonGeboorteHistorie> {
    ...
    protected void kopieerActueleGroepNaarEntiteit(final PersoonGeboorteHistorie historie, final Persoon persoon) {
        persoon.setGemeenteGeboorte(historie.getGemeente());
        persoon.setLandOfGebiedGeboorte(historie.getLandOfGebied());
        ...
        persoon.setWoonplaatsGeboorte(historie.getWoonplaatsnaamGeboorte());
        persoon.setBuitenlandsePlaatsGeboorte(historie.getBuitenlandsePlaatsGeboorte());
