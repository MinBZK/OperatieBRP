 ...
 * {@link nl.bzk.migratiebrp.synchronisatie.dal.domein.brp.kern.entity.PersoonNummerverwijzingHistorie} en vice versa.
 */
        ...
        AbstractPersoonHistorieMapperStrategie<BrpNummerverwijzingInhoud, PersoonNummerverwijzingHistorie>
{
    ...
    @Override
    protected void kopieerActueleGroepNaarEntiteit(final PersoonNummerverwijzingHistorie historie, final Persoon persoon) {
        persoon.setVorigeAdministratienummer(historie.getVorigeAdministratienummer());
        persoon.setVorigeBurgerservicenummer(historie.getVorigeBurgerservicenummer());
        persoon.setVolgendeAdministratienummer(historie.getVolgendeAdministratienummer());
        persoon.setVolgendeBurgerservicenummer(historie.getVolgendeBurgerservicenummer());
    }
    ...
    protected PersoonNummerverwijzingHistorie mapHistorischeGroep(final BrpNummerverwijzingInhoud groepInhoud, final Persoon persoon) {
        ...
        historie.setVolgendeAdministratienummer(BrpLong.unwrap(groepInhoud.getVolgendeAdministratienummer()));
        historie.setVorigeAdministratienummer(BrpLong.unwrap(groepInhoud.getVorigeAdministratienummer()));
        historie.setVolgendeBurgerservicenummer(BrpInteger.unwrap(groepInhoud.getVolgendeBurgerservicenummer()));
        historie.setVorigeBurgerservicenummer(BrpInteger.unwrap(groepInhoud.getVorigeBurgerservicenummer()));
