...
public class DocumentTest {
    ...
    private static final String IDENTIFICATIE2 = "identificatie2";
    ...
    private void assertEnkeleKoppeling(final Document document, final BRPActie brpActie) {
        ...
        final ActieBron actieBron1 = (ActieBron) ((Set<?>) ReflectionUtil.getField(document, "actieBronSet")).toArray()[0];
        final ActieBron actieBron2 = (ActieBron) ((Set<?>) ReflectionUtil.getField(brpActie, "actieBronSet")).toArray()[0];
    ...
    public void isInhoudelijkGelijkIdentificatie() {
        ...
        document.setIdentificatie(IDENTIFICATIE);
        document2.setIdentificatie(IDENTIFICATIE2);
        Assert.assertFalse(document.isInhoudelijkGelijkAan(document2));
    }
