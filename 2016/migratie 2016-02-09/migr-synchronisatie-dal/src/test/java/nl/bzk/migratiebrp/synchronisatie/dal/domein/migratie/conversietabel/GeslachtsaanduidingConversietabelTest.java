...
public class GeslachtsaanduidingConversietabelTest {
    ...
    public void testConverteerNaarBrp() {
        final BrpGeslachtsaanduidingCode brpResultaatMan = conversietabel.converteerNaarBrp(Lo3GeslachtsaanduidingEnum.MAN.asElement());
        final BrpGeslachtsaanduidingCode brpResultaatVrouw = conversietabel.converteerNaarBrp(Lo3GeslachtsaanduidingEnum.VROUW.asElement());
    ...
    public void testConverteerNaarLo3() {
        final Lo3Geslachtsaanduiding lo3ResultaatMan = conversietabel.converteerNaarLo3(BrpGeslachtsaanduidingCode.MAN);
        final Lo3Geslachtsaanduiding lo3ResultaatVrouw = conversietabel.converteerNaarLo3(BrpGeslachtsaanduidingCode.VROUW);
        final Lo3Geslachtsaanduiding lo3ResultaatOnbekend = conversietabel.converteerNaarLo3(BrpGeslachtsaanduidingCode.ONBEKEND);
