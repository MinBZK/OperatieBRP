...
public class BrpBehandeldAlsNederlanderIndicatieMapperTest extends BrpAbstractTest {

    private final BrpOnderzoekMapper brpOnderzoekMapper = new BrpOnderzoekMapperImpl(new ArrayList<Onderzoek>());

    @Inject
    private BrpBehandeldAlsNederlanderIndicatieMapper mapper;
    ...
    public void testMapInhoud() {
        ...
        final BrpBehandeldAlsNederlanderIndicatieInhoud result = mapper.mapInhoud(historie, brpOnderzoekMapper);
