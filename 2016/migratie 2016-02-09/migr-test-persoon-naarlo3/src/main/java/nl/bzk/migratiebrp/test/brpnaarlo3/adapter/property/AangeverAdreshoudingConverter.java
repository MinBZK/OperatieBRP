 ...
 */
@Component
public final class AangeverAdreshoudingConverter implements PropertyConverter<Aangever> {
    @PersistenceContext
    private EntityManager em;

    @Override
    public Aangever convert(final String value) {
        return value == null ? null : em.find(Aangever.class, Short.valueOf(value));
    }
}
