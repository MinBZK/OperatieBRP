...
/**
 * AanduidingInhoudingOfVermissingReisdocument converter.
 */
@Component
        ...
        PropertyConverter<AanduidingInhoudingOfVermissingReisdocument>
{
    ...
    @Override
    public AanduidingInhoudingOfVermissingReisdocument convert(final String value) {
        return value == null ? null : em.find(AanduidingInhoudingOfVermissingReisdocument.class, Short.valueOf(value));
    }
