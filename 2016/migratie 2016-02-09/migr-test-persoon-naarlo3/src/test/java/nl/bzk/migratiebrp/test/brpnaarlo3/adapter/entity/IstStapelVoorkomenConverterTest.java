...
public class IstStapelVoorkomenConverterTest {
    ...
    private AdministratieveHandeling administratieveHandeling = new AdministratieveHandeling(new Partij("naam",1),SoortAdministratieveHandeling.CORRECTIE_CURATELE);
    private String soortDocument = "soort Document";
    private Partij partij = new Partij("naam",1);
    ...
    private Long anummer = 8191430945L;
    private Integer bsn = 492475945;
    ...
    private Gemeente gemeenteGeboorte = new Gemeente(null,"gemeente",new Short("1"),new Partij("gemeenteGeboorte",1));
    private String buitenlandsePlaatsGeboorte = "Marakech";
    private String omschrijvingLocatieGeboorte = "omschrijvingLocatieGeboorte";
    private LandOfGebied landOfGebiedGeboorte = new LandOfGebied(new Short("123"),"landOfGebiedGeboorte");
    private Geslachtsaanduiding geslachtsaanduiding = Geslachtsaanduiding.ONBEKEND;
    private Integer datumAanvang =20000102;
    private Gemeente gemeenteAanvang = new Gemeente(null,"gemeente",new Short("1"),new Partij("gemeenteAanvang",1));
    ...
    private LandOfGebied landOfGebiedAanvang = new LandOfGebied(new Short("123"),"landOfGebiedAanvang");
    ...
    private Gemeente gemeenteEinde  = new Gemeente(null,"gemeente",new Short("1"),new Partij("gemeenteEinde",1));
    ...
    private LandOfGebied landOfGebiedEinde = new LandOfGebied(new Short("123"),"landOfGebiedEinde");
    ...
    public void testMaakentityConvertorHaaderTypeMagGeenInvloedHebben() throws Exception {
        ...
        assertTrue(zijnTweeStapelVoorkomensGelijk(ctx1.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next(),ctx2.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next()));
    }
    ...
    public void testMaakentityConvertorPredicaat() throws Exception {
        ConverterContext ctx = createContext(MINIMAAL);
        converter.convertInhoudelijk(ctx,IstStapelVoorkomenConverter.HEADER_PREDICAAT,Short.toString(predicaat.getId()));
        converter.maakEntity(ctx);
        StapelVoorkomen stapelVoorkomen = ctx.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next();
    ...
    public void testMaakentityConvertorAdelijkeTitel() throws Exception {
        ConverterContext ctx = createContext(MINIMAAL);
        converter.convertInhoudelijk(ctx,IstStapelVoorkomenConverter.HEADER_ADELLIJKE_TITEL,Short.toString(adellijkeTitel.getId()));
        converter.maakEntity(ctx);
        StapelVoorkomen stapelVoorkomen = ctx.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next();
    ...
    public void testMaakentityConvertorGesclachtBijAdelijkeTitelPredicaat() throws Exception {
        ConverterContext ctx = createContext(MINIMAAL);
        converter.convertInhoudelijk(ctx,IstStapelVoorkomenConverter.HEADER_GESLACHT_BIJ_ADELLIJKE_TITEL_PREDICAAT,Short.toString(geslachtsaanduidingBijAdellijkeTitelOfPredicaat.getId()));
        converter.maakEntity(ctx);
        StapelVoorkomen stapelVoorkomen = ctx.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next();
    ...
    public void testMaakentityConvertorGeslachtsAanduiding() throws Exception {
        ConverterContext ctx = createContext(MINIMAAL);
        converter.convertInhoudelijk(ctx,IstStapelVoorkomenConverter.HEADER_GESLACHTS_AANDUIDING,Short.toString(geslachtsaanduiding.getId()));
        converter.maakEntity(ctx);
        StapelVoorkomen stapelVoorkomen = ctx.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next();
    ...
    public void testMaakentityConvertorSoortRelatie() throws Exception {
        ConverterContext ctx = createContext(MINIMAAL);
        converter.convertInhoudelijk(ctx,IstStapelVoorkomenConverter.HEADER_SOORT_RELATIE,Short.toString(soortRelatie.getId()));
        converter.maakEntity(ctx);
        StapelVoorkomen stapelVoorkomen = ctx.getStapel(Integer.parseInt(volgnummer)).getStapelvoorkomens().iterator().next();
...
*/
    ...
    private boolean zijnTweeStapelVoorkomensGelijk(StapelVoorkomen vk1, StapelVoorkomen vk2){
        boolean gelijk = true;
        gelijk = vk1.getAdellijkeTitel() != null ? gelijk && vk1.getAdellijkeTitel().equals(vk2.getAdellijkeTitel()) : gelijk && vk2.getAdellijkeTitel() == null;
        gelijk = vk1.getAdministratieveHandeling() != null ? gelijk && vk1.getAdministratieveHandeling().equals(vk2.getAdministratieveHandeling()) : gelijk && vk2.getAdministratieveHandeling() == null;
        ...
        gelijk = vk1.getBuitenlandsePlaatsAanvang() != null ? gelijk && vk1.getBuitenlandsePlaatsAanvang().equals(vk2.getBuitenlandsePlaatsAanvang()) : gelijk && vk2.getBuitenlandsePlaatsAanvang() == null;
        gelijk = vk1.getBuitenlandsePlaatsEinde() != null ? gelijk && vk1.getBuitenlandsePlaatsEinde().equals(vk2.getBuitenlandsePlaatsEinde()) : gelijk && vk2.getBuitenlandsePlaatsEinde() == null;
        gelijk = vk1.getBuitenlandsePlaatsGeboorte() != null ? gelijk && vk1.getBuitenlandsePlaatsGeboorte().equals(vk2.getBuitenlandsePlaatsGeboorte()) : gelijk && vk2.getBuitenlandsePlaatsGeboorte() == null;
        ...
        gelijk = vk1.getDocumentOmschrijving() != null ? gelijk && vk1.getDocumentOmschrijving().equals(vk2.getDocumentOmschrijving()) : gelijk && vk2.getDocumentOmschrijving() == null;
        gelijk = vk1.getGemeenteAanvang() != null ? gelijk && vk1.getGemeenteAanvang().equals(vk2.getGemeenteAanvang()) : gelijk && vk2.getGemeenteAanvang() == null;
        ...
        gelijk = vk1.getGemeenteGeboorte() != null ? gelijk && vk1.getGemeenteGeboorte().equals(vk2.getGemeenteGeboorte()) : gelijk && vk2.getGemeenteGeboorte() == null;
        gelijk = vk1.getGeslachtsaanduiding() != null ? gelijk && vk1.getGeslachtsaanduiding().equals(vk2.getGeslachtsaanduiding()) : gelijk && vk2.getGeslachtsaanduiding() == null;
        gelijk = vk1.getGeslachtsaanduidingBijAdellijkeTitelOfPredikaat() != null ? gelijk && vk1.getGeslachtsaanduidingBijAdellijkeTitelOfPredikaat().equals(vk2.getGeslachtsaanduidingBijAdellijkeTitelOfPredikaat()) : gelijk && vk2.getGeslachtsaanduidingBijAdellijkeTitelOfPredikaat() == null;
        gelijk = vk1.getGeslachtsnaamstam() != null ? gelijk && vk1.getGeslachtsnaamstam().equals(vk2.getGeslachtsnaamstam()) : gelijk && vk2.getGeslachtsnaamstam() == null;
        gelijk = vk1.getId() != null ? gelijk && vk1.getId().equals(vk2.getId()) : gelijk && vk2.getId() == null;
        gelijk = vk1.getIndicatieDerdeHeeftGezag() != null ? gelijk && vk1.getIndicatieDerdeHeeftGezag().equals(vk2.getIndicatieDerdeHeeftGezag()) : gelijk && vk2.getIndicatieDerdeHeeftGezag() == null;
        gelijk = vk1.getIndicatieOnderCuratele() != null ? gelijk && vk1.getIndicatieOnderCuratele().equals(vk2.getIndicatieOnderCuratele()) : gelijk && vk2.getIndicatieOnderCuratele() == null;
        gelijk = vk1.getIndicatieOuder1HeeftGezag() != null ? gelijk && vk1.getIndicatieOuder1HeeftGezag().equals(vk2.getIndicatieOuder1HeeftGezag()) : gelijk && vk2.getIndicatieOuder1HeeftGezag() == null;
        gelijk = vk1.getIndicatieOuder2HeeftGezag() != null ? gelijk && vk1.getIndicatieOuder2HeeftGezag().equals(vk2.getIndicatieOuder2HeeftGezag()) : gelijk && vk2.getIndicatieOuder2HeeftGezag() == null;
        gelijk = vk1.getLandOfGebiedAanvang() != null ? gelijk && vk1.getLandOfGebiedAanvang().equals(vk2.getLandOfGebiedAanvang()) : gelijk && vk2.getLandOfGebiedAanvang() == null;
        gelijk = vk1.getLandOfGebiedEinde() != null ? gelijk && vk1.getLandOfGebiedEinde().equals(vk2.getLandOfGebiedEinde()) : gelijk && vk2.getLandOfGebiedEinde() == null;
        gelijk = vk1.getLandOfGebiedGeboorte() != null ? gelijk && vk1.getLandOfGebiedGeboorte().equals(vk2.getLandOfGebiedGeboorte()) : gelijk && vk2.getLandOfGebiedGeboorte() == null;
        gelijk = vk1.getOmschrijvingLocatieAanvang() != null ? gelijk && vk1.getOmschrijvingLocatieAanvang().equals(vk2.getOmschrijvingLocatieAanvang()) : gelijk && vk2.getOmschrijvingLocatieAanvang() == null;
        gelijk = vk1.getOmschrijvingLocatieEinde() != null ? gelijk && vk1.getOmschrijvingLocatieEinde().equals(vk2.getOmschrijvingLocatieEinde()) : gelijk && vk2.getOmschrijvingLocatieEinde() == null;
        gelijk = vk1.getOmschrijvingLocatieGeboorte() != null ? gelijk && vk1.getOmschrijvingLocatieGeboorte().equals(vk2.getOmschrijvingLocatieGeboorte()) : gelijk && vk2.getOmschrijvingLocatieGeboorte() == null;
        ...
        gelijk = vk1.getRedenBeeindigingRelatie() != null ? gelijk && vk1.getRedenBeeindigingRelatie().equals(vk2.getRedenBeeindigingRelatie()) : gelijk && vk2.getRedenBeeindigingRelatie() == null;
        gelijk = vk1.getRubriek6210DatumIngangFamilierechtelijkeBetrekking() != null ? gelijk && vk1.getRubriek6210DatumIngangFamilierechtelijkeBetrekking().equals(vk2.getRubriek6210DatumIngangFamilierechtelijkeBetrekking()) : gelijk && vk2.getRubriek6210DatumIngangFamilierechtelijkeBetrekking() == null;
        gelijk = vk1.getRubriek8220DatumDocument() != null ? gelijk && vk1.getRubriek8220DatumDocument().equals(vk2.getRubriek8220DatumDocument()) : gelijk && vk2.getRubriek8220DatumDocument() == null;
        gelijk = vk1.getRubriek8310AanduidingGegevensInOnderzoek() != null ? gelijk && vk1.getRubriek8310AanduidingGegevensInOnderzoek().equals(vk2.getRubriek8310AanduidingGegevensInOnderzoek()) : gelijk && vk2.getRubriek8310AanduidingGegevensInOnderzoek() == null;
        gelijk = vk1.getRubriek8320DatumIngangOnderzoek() != null ? gelijk && vk1.getRubriek8320DatumIngangOnderzoek().equals(vk2.getRubriek8320DatumIngangOnderzoek()) : gelijk && vk2.getRubriek8320DatumIngangOnderzoek() == null;
        gelijk = vk1.getRubriek8330DatumEindeOnderzoek() != null ? gelijk && vk1.getRubriek8330DatumEindeOnderzoek().equals(vk2.getRubriek8330DatumEindeOnderzoek()) : gelijk && vk2.getRubriek8330DatumEindeOnderzoek() == null;
        gelijk = vk1.getRubriek8410OnjuistOfStrijdigOpenbareOrde() != null ? gelijk && vk1.getRubriek8410OnjuistOfStrijdigOpenbareOrde().equals(vk2.getRubriek8410OnjuistOfStrijdigOpenbareOrde()) : gelijk && vk2.getRubriek8410OnjuistOfStrijdigOpenbareOrde() == null;
        gelijk = vk1.getRubriek8510IngangsdatumGeldigheid() != null ? gelijk && vk1.getRubriek8510IngangsdatumGeldigheid().equals(vk2.getRubriek8510IngangsdatumGeldigheid()) : gelijk && vk2.getRubriek8510IngangsdatumGeldigheid() == null;
        gelijk = vk1.getRubriek8610DatumVanOpneming() != null ? gelijk && vk1.getRubriek8610DatumVanOpneming().equals(vk2.getRubriek8610DatumVanOpneming()) : gelijk && vk2.getRubriek8610DatumVanOpneming() == null;
        gelijk = vk1.getScheidingsteken() != null ? gelijk && vk1.getScheidingsteken().equals(vk2.getScheidingsteken()) : gelijk && vk2.getScheidingsteken() == null;
