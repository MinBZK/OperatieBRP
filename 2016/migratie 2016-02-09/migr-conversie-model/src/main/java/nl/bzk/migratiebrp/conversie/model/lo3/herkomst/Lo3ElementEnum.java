...
public enum Lo3ElementEnum {
     ...
     */
    ELEMENT_0630(Lo3GroepEnum.GROEP06, Lo3RubriekVolgnummerEnum.VOLGNR_30, Type.NUMERIEK, 4, "Land huwelijkssluiting / aangaan geregistreerd partnerschap"),
    /**
     ...
     */
    ELEMENT_0740(Lo3GroepEnum.GROEP07, Lo3RubriekVolgnummerEnum.VOLGNR_40, Type.ALPHANUMERIEK, 1, "Reden ontbinding huwelijk / geregistreerd partnerschap"),
    /**
     * Datum overlijden.
     */
     ...
     * Afnemersindicatie.
     */
    ELEMENT_4010(Lo3GroepEnum.GROEP40, Lo3RubriekVolgnummerEnum.VOLGNR_10, Type.NUMERIEK, 6, "Afnemersindicatie"),
    /**
     * Aantekening.
     */
     ...
     * 
     * @param leesbaar
     *            Indien true dan leesbaar (xx.xx) anders (xxxx).
