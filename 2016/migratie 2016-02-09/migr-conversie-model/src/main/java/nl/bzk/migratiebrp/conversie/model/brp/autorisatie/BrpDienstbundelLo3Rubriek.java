...
public final class BrpDienstbundelLo3Rubriek extends AbstractBrpGroepInhoud {
    ...
    private final BrpStapel<BrpDienstbundelLo3RubriekInhoud> dienstbundelLo3RubriekStapel;
     ...
     */
    public BrpDienstbundelLo3Rubriek(
        ...
        @Element(name = "dienstbundelLo3RubriekStapel", required = false) final BrpStapel<BrpDienstbundelLo3RubriekInhoud> dienstbundelLo3RubriekStapel)
    {
        super();
     ...
     */
    public BrpStapel<BrpDienstbundelLo3RubriekInhoud> getDienstbundelLo3RubriekStapel() {
