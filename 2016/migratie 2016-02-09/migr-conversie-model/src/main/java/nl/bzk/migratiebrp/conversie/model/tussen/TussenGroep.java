...
public final class TussenGroep<T extends BrpGroepInhoud> {
     ...
     * @param lo3Herkomst
     *            de herkomst, mag null zijn
     * @param afsluitendGroep
     *            als deze groep alleen gebruikt wordt om een eerdere groep af te sluiten (bv bij het splitsen van
     *            relaties)
     * @param oorsprongVoorkomenLeeg
     *            true als het voorkomen waaruit deze groep ontstaat, inhoudelijk leeg is.
     * @throws NullPointerException
     *             als inhoud of historie null is
     */
    public TussenGroep(
    ...
    /**
     * Geef de inhoudelijk leeg.
     *
     * @return true als deze TussenGroep semantisch leeg is.
     */
    ...
    /**
     * Geef de afsluitende groep.
     *
     * @return true als deze groep alleen bestaat om een eerdere groep af te sluiten (bv. bij relaties)
     */
    ...
    /**
     * Checks if is oorsprongVoorkomenLeeg is true als het voorkomen waaruit deze groep is ontstaan, leeg is.
     *
     * @return true als het voorkomen waaruit deze groep is ontstaat, leeg is
     */
