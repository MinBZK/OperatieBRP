...
public enum Lo3IndicatieOnjuistEnum {
    ...
    private static final Map<String, Lo3IndicatieOnjuistEnum> CODE_MAP = new HashMap<String, Lo3IndicatieOnjuistEnum>() {
    ...
    private Lo3IndicatieOnjuistEnum(final String code, final String label) {
        this.code = code;
        this.label = label;
    }
