...
public enum Lo3AanduidingBijzonderNederlandschapEnum {
    ...
    private static final Map<String, Lo3AanduidingBijzonderNederlandschapEnum> CODE_MAP = new HashMap<String, Lo3AanduidingBijzonderNederlandschapEnum>() {
    ...
    private Lo3AanduidingBijzonderNederlandschapEnum(final String code, final String label) {
        this.code = code;
        this.label = label;
    }
