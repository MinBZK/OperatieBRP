...
public enum Lo3AanduidingNaamgebruikCodeEnum {
    ...
    private static final Map<String, Lo3AanduidingNaamgebruikCodeEnum> CODE_MAP = new HashMap<String, Lo3AanduidingNaamgebruikCodeEnum>() {
    ...
    private Lo3AanduidingNaamgebruikCodeEnum(final String code, final String label) {
        this.code = code;
        this.label = label;
    }
