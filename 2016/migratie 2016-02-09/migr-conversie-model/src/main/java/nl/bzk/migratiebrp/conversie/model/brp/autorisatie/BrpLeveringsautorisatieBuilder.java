...
public final class BrpLeveringsautorisatieBuilder {
    ...
    public BrpAutorisatie build() {
        return new BrpAutorisatie(partij, leveringsautorisatieLijst);
    }
     ...
     *
     * @param param
     *            de partij, mag null zijn
     * @return het BrpPersoonslijstBuilder object
     */
    public BrpLeveringsautorisatieBuilder partij(final BrpPartij param) {
        partij = param;
        return this;
    }
     ...
     *
     * @param param
     *            de leveringautorisatieLijst, mag null zijn
