...
public final class Lo3Afnemersindicatie {
     ...
     * 
     * @param aNummer
     *            a-nummer van de persoon waarvoor de afnemersindicaties zijn
     * @param afnemersindicatieStapels
     *            de lijst met afnemersIndicatieStapels, mag null of leeg zijn
     * 
    ...
    public Lo3Afnemersindicatie(
        ...
        @ElementList(name = "afnemersIndicatieStapels", entry = "afnemersIndicatieStapel", type = Lo3Stapel.class, required = false) final List<Lo3Stapel<Lo3AfnemersindicatieInhoud>> afnemersindicatieStapels)
    {
     ...
     */
    @ElementList(name = "afnemersIndicatieStapels", entry = "afnemersIndicatieStapel", type = Lo3Stapel.class, required = false)
    ...
    public boolean equals(final Object other) {
        ...
        return new EqualsBuilder().append(aNummer, castOther.aNummer)
                                  .append(afnemersindicatieStapels, castOther.afnemersindicatieStapels)
                                  .isEquals();
    }
