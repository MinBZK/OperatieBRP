...
public enum Lo3IndicatieCurateleregisterEnum {
    ...
    private static final Map<Integer, Lo3IndicatieCurateleregisterEnum> CODE_MAP = new HashMap<Integer, Lo3IndicatieCurateleregisterEnum>() {
    ...
    private Lo3IndicatieCurateleregisterEnum(final Integer code, final String label) {
        this.code = code;
        this.label = label;
    }
