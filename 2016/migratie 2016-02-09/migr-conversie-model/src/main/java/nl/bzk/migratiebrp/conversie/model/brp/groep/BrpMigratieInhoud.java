...
public final class BrpMigratieInhoud extends AbstractBrpGroepInhoud {
     ...
     *
     * @param soortMigratieCode
     *            soort migratie code
     * @param redenWijzigingMigratieCode
     *            reden wijziging code
     * @param aangeverMigratieCode
    ...
    public boolean isLeeg() {
        return !Validatie.isEenParameterGevuld(soortMigratieCode, landOfGebiedCode);
    }
    ...
    /**
     * Geef de waarde van soort migratie code.
     *
     * @return soort migratie code
     */
    ...
    /**
     * Geef de waarde van reden wijziging migratie code.
     *
     * @return reden wijziging migratie code
     */
    ...
    /**
     * Geef de waarde van aangever migratie code.
     *
     * @return aangever migratie code
     */
