 ...
 */
public final class FunctieAdresConversietabel implements Conversietabel<Lo3FunctieAdres, BrpSoortAdresCode> {
    ...
    public boolean valideerLo3(final Lo3FunctieAdres input) {
        return !Validatie.isElementGevuld(input) || Lo3FunctieAdresEnum.getByCode(input.getWaarde()) != null;
    }
