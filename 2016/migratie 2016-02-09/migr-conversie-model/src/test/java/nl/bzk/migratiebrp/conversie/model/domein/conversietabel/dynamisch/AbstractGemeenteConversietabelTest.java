...
public class AbstractGemeenteConversietabelTest {
    ...
    private static final Lo3GemeenteCode LO3 = new Lo3GemeenteCode("12", ONDERZOEK);
    private static final Lo3GemeenteCode LO3_ALLEEN_ONDERZOEK = new Lo3GemeenteCode(null, ONDERZOEK);
    private static final BrpGemeenteCode BRP = new BrpGemeenteCode((short) 24, ONDERZOEK);
