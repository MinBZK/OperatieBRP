...
public class AbstractRedenVerkrijgingNederlanderschapConversietabelTest {
    private final AbstractRedenVerkrijgingNederlanderschapConversietabel subject = new AbstractRedenVerkrijgingNederlanderschapConversietabel(
        Collections.<Entry<Lo3RedenNederlandschapCode, BrpRedenVerkrijgingNederlandschapCode>>emptyList())
    {
    };

    private static final Lo3RedenNederlandschapCode LO3 = new Lo3RedenNederlandschapCode("12");
    private static final BrpRedenVerkrijgingNederlandschapCode BRP = new BrpRedenVerkrijgingNederlandschapCode((short) 12);
