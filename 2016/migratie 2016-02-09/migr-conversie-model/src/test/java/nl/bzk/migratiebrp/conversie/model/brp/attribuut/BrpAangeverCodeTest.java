...
public class BrpAangeverCodeTest {
    ...
    public void testZonderOnderzoek() {
        final Lo3Onderzoek onderzoek = new Lo3Onderzoek(Lo3Integer.wrap(10000), Lo3Datum.NULL_DATUM, null);
    ...
    public void testWrapMetWaardeEnOnderzoek() {
        final String waarde = "Test";
        final Lo3Onderzoek onderzoek = new Lo3Onderzoek(new Lo3Integer("010000", null), Lo3Datum.NULL_DATUM, null);
    ...
    public void verwijderOnderzoekZonder() {
        final Lo3Onderzoek onderzoek = new Lo3Onderzoek(Lo3Integer.wrap(10000), Lo3Datum.NULL_DATUM, null);
        BrpAangeverCode brp = new BrpAangeverCode(null,onderzoek);
        Assert.assertNotNull(brp.getOnderzoek());
