...
public class AbstractRNIDeelnemerConversietabelTest {
    private final AbstractRNIDeelnemerConversietabel subject = new AbstractRNIDeelnemerConversietabel(
        Collections.<Entry<Lo3RNIDeelnemerCode, BrpPartijCode>>emptyList())
    {
    };

    private static final Lo3RNIDeelnemerCode LO3 = new Lo3RNIDeelnemerCode("12");
