...
public class TussenAfnemersindicatiesTest {
    ...
    @Test
    public void test() {
        final TussenAfnemersindicaties subject = maakAfnemersindicatie(123456789L, 123456, 19920101);
        final TussenAfnemersindicaties equals = maakAfnemersindicatie(123456789L, 123456, 19920101);
        final TussenAfnemersindicaties different = maakAfnemersindicatie(987654321L, 654321, 19920101);

        Assert.assertEquals(Long.valueOf(123456789L), subject.getAdministratienummer());
        Assert.assertEquals(1, subject.getAfnemersindicaties().size());
    ...
    private TussenAfnemersindicaties maakAfnemersindicatie(final long administratienummer, final int partijCode, final int datumingang) {
        ...
        return new TussenAfnemersindicaties(administratienummer, Collections.singletonList(new TussenAfnemersindicatie(
            new BrpPartijCode(partijCode),
            stapel)));
    }
}
