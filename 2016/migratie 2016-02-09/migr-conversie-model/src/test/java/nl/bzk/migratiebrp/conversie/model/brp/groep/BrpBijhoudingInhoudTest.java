...
public class BrpBijhoudingInhoudTest {
    public static BrpBijhoudingInhoud createInhoud() {
        return new BrpBijhoudingInhoud(BrpPartijCode.MINISTER, BrpBijhoudingsaardCode.INGEZETENE, BrpNadereBijhoudingsaardCode.ACTUEEL, new BrpBoolean(
            Boolean.FALSE));
    }
    ...
    public static BrpStapel<BrpBijhoudingInhoud> createStapel() {
        ...
        groepen.add(groep);
        BrpStapel<BrpBijhoudingInhoud> result = new BrpStapel<>(groepen);
        return result;
    }
