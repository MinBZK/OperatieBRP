...
public class BrpVastgesteldNietNederlanderIndicatieInhoudTest {
    ...
    public static BrpVastgesteldNietNederlanderIndicatieInhoud createInhoud(boolean value) {
        return new BrpVastgesteldNietNederlanderIndicatieInhoud(new BrpBoolean(value), null, null);
    }

    public static BrpStapel<BrpVastgesteldNietNederlanderIndicatieInhoud> createStapel() {
        List<BrpGroep<BrpVastgesteldNietNederlanderIndicatieInhoud>> groepen = new ArrayList<>();
        BrpGroep<BrpVastgesteldNietNederlanderIndicatieInhoud> groep =
                new BrpGroep<>(createInhoud(false), BrpHistorieTest.createdefaultInhoud(), null, null, null);
        groepen.add(groep);
    ...
    @Before
    public void setup() {
        inhoud1 = createInhoud(true);
        inhoud2 = createInhoud(true);
    }
    ...
    public void testHeeftIndicatie() {
        assertTrue(inhoud1.heeftIndicatie());
    }
