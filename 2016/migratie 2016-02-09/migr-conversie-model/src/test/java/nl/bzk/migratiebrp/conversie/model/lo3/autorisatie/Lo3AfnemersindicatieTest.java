...
public class Lo3AfnemersindicatieTest {
    ...
    @Test
    public void test() {
        final Lo3Afnemersindicatie subject = maakAfnemersindicatie(12345678L, 123456, 19920101);
        final Lo3Afnemersindicatie equals = maakAfnemersindicatie(12345678L, 123456, 19920101);
        final Lo3Afnemersindicatie different = maakAfnemersindicatie(98765432L, 654321, 19920101);

        Assert.assertEquals(Long.valueOf(12345678L), subject.getANummer());
    ...
    private Lo3Afnemersindicatie maakAfnemersindicatie(final long aNummer, final int afnemersindicatie, final int datumingang) {
