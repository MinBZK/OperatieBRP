...
public class AbstractLandConversietabelTest {
    ...
    private static final Lo3LandCode LO3 = new Lo3LandCode("12", ONDERZOEK);
    private static final Lo3LandCode LO3_ALLEEN_ONDERZOEK = new Lo3LandCode(null, ONDERZOEK);
    private static final BrpLandOfGebiedCode BRP = new BrpLandOfGebiedCode((short) 24, ONDERZOEK);
