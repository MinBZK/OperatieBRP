...
public class PlVerwerkerBeheerdersKeuzeVervangTest {

    @Mock
    private PlService plService;

    @InjectMocks
    private PlVerwerkerBeheerdersKeuzeVervang subject;
    ...
    @Test
    public void testOk() throws SynchronisatieVerwerkerException {
        // Parameters
        final SynchroniseerNaarBrpVerzoekBericht verzoek = new SynchroniseerNaarBrpVerzoekBericht();
        verzoek.setANummerTeVervangenPl(123456789L);
        ...
        // Setup
        Mockito.when(plService.zoekNietFoutievePersoonslijstOpActueelAnummer(123456789L)).thenReturn(dbPersoonslijst);
        ...
        Mockito.verify(plService).persisteerPersoonslijst(brpPersoonslijst, 123456789L, false, loggingBericht);
    ...
    private BrpPersoonslijst maakPl() {
        ...
        builder.identificatienummersStapel(BrpStapelHelper.stapel(BrpStapelHelper.groep(
            BrpStapelHelper.identificatie(1231231232L, null),
