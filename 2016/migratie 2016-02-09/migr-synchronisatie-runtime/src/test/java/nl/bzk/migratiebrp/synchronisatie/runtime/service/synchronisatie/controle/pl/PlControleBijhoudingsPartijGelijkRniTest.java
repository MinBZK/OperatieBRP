...
public class PlControleBijhoudingsPartijGelijkRniTest {

    private final PlControleBijhoudingsPartijGelijkRni subject = new PlControleBijhoudingsPartijGelijkRni();
    ...
    @Test
    public void test() {
        Assert.assertTrue(subject.controleer(new VerwerkingsContext(null, null, null, maakPl(199901, false)), maakPl(516010, false)));
