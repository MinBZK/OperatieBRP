...
public class AbstractTest {
    ...
    protected void controleerFormatParse(final SyncBericht bericht) throws Exception {
    ...
    protected void controleerSerialization(final SyncBericht bericht) throws Exception {
