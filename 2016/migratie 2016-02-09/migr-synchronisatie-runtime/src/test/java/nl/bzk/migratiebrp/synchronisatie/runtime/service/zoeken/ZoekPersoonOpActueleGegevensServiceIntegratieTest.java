...
public class ZoekPersoonOpActueleGegevensServiceIntegratieTest extends AbstractSynchronisatieIntegratieTest {
    ...
    public void testNietsGevonden() throws Exception {
        ...
        Assert.assertFalse(
            "Testdatabase bevat onverwacht het a-nummer wat wij hier gebruiken!?",
            komtAnummerActueelVoor(Long.parseLong(verzoek.getANummer())));
