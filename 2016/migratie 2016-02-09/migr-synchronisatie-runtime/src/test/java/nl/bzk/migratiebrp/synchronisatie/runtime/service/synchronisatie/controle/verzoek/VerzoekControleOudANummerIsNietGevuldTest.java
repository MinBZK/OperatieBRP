...
public class VerzoekControleOudANummerIsNietGevuldTest {

    @InjectMocks
    private VerzoekControleOudANummerIsNietGevuld subject;
    ...
    @Test
    public void test() {
        Assert.assertTrue(subject.controleer(maakVerzoek(null)));
        Assert.assertFalse(subject.controleer(maakVerzoek(true)));
        Assert.assertTrue(subject.controleer(maakVerzoek(false)));
    }
