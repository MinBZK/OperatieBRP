...
@Transactional
@Rollback(false)
public class InitieleVullingSynchronisatieVerwerkerIntegratieTest extends AbstractSynchronisatieServiceIntegratieTest {
    ...
    public void testNieuwePl() throws Exception {
        ...
        builder.persoonStapel(Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(
            Lo3StapelHelper.lo3Persoon(4241824289L, "Piet", "Klaassen", 19770101, "0516", "6030", "M"),
            Lo3CategorieEnum.PERSOON)));

        builder.ouder1Stapel(Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(
            Lo3StapelHelper.lo3Ouder(9806953249L, "Betsy", "Pietersen", 19130101, "0516", "6030", "V", 19770101),
            Lo3CategorieEnum.OUDER_1)));
        builder.ouder2Stapel(Lo3StapelHelper.lo3Stapel(Lo3StapelHelper.lo3Cat(
            Lo3StapelHelper.lo3Ouder(9806953249L, "Johan", "Klaassen", 19130101, "0516", "6030", "M", 19770101),
        ...
        verzoek.setLo3BerichtAsTeletexString(Lo3Inhoud.formatInhoud(categorieen));
