...
public class PlZoekerOpAnummerEnNietFoutiefOpgeschortObvActueelAnummerTest {

    @Mock
    private PlService plService;

    @InjectMocks
    private PlZoekerOpAnummerEnNietFoutiefOpgeschortObvActueelAnummer subject;
    ...
    public void testGevonden() {
        ...
        Mockito.when(plService.zoekNietFoutievePersoonslijstOpActueelAnummer(1111L)).thenReturn(dbPersoonslijst);
        ...
        Mockito.verify(plService).zoekNietFoutievePersoonslijstOpActueelAnummer(1111L);
    ...
    public void testNietGevonden() {
        ...
        Mockito.when(plService.zoekNietFoutievePersoonslijstOpActueelAnummer(1111L)).thenReturn(null);
