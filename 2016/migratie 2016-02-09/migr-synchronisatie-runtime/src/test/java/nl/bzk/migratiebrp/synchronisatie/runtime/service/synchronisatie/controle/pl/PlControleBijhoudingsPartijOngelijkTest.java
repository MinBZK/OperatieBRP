...
public class PlControleBijhoudingsPartijOngelijkTest {

    private final PlControleBijhoudingsPartijOngelijk subject = new PlControleBijhoudingsPartijOngelijk();
    ...
    @Test
    public void test() {
        Assert.assertFalse(subject.controleer(new VerwerkingsContext(null, null, null, maakPl(516010, false)), maakPl(516010, false)));
