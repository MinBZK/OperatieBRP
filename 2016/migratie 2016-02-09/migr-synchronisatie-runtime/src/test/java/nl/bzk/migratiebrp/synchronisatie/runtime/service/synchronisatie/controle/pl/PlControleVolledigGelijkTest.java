...
public class PlControleVolledigGelijkTest {
    ...
    private final PlControleVolledigGelijk subject = new PlControleVolledigGelijk();
    ...
    public void test() {
        ...
        Assert.assertFalse(subject.controleer(maakContext(bsns(3, 2, 1), geboortes(19770101)), maakPl(bsns(1), geboortes(19770101))));
        Assert.assertFalse(subject.controleer(maakContext(bsns(1), geboortes(19780101, 19770101)), maakPl(bsns(1), geboortes(19770101))));
        Assert.assertFalse(subject.controleer(maakContext(bsns(3, 2, 1), geboortes(19780101, 19770101)), maakPl(bsns(1), geboortes(19770101))));
