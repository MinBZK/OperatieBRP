...
/**
 * Controleer dat het versienummer van de gevonden persoonslijst gelijk of groter is dan het versienummer van de
 * aangeboden persoonslijst.
 */
@Component(value = "plControleGevondenVersienummerGelijkOfGroter")
public final class PlControleGevondenVersienummerGelijkOfGroter implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_GEVONDEN_VERSIENUMMER_GELIJK_OF_GROTER);
