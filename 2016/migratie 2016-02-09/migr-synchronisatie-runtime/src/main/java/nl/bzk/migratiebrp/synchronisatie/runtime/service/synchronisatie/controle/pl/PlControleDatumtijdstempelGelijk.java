 ...
 */
@Component(value = "plControleDatumtijdstempelGelijk")
public final class PlControleDatumtijdstempelGelijk implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_DATUMTIJDSTEMPEL_GELIJK);
