...
/**
 * Controle oud-anummer is niet gevuld.
 */
@Component(value = "verzoekControleOudAnummerIsNietGevuld")
public final class VerzoekControleOudANummerIsNietGevuld implements VerzoekControle {

    @Override
    public boolean controleer(final SynchroniseerNaarBrpVerzoekBericht verzoek) {
        final ControleLogging logging = new ControleLogging(ControleMelding.VERZOEK_CONTROLE_OUD_ANUMMER_IS_NIET_GEVULD);
