...
public final class ControlePersoonslijstIsOuder implements Controle {
    ...
    @Inject
    @Named(value = "plControleGevondenVersienummerGroter")
    private PlControle plControleGevondenVersienummerGroter;
    @Inject
    @Named(value = "plControleGevondenDatumtijdstempelNieuwer")
    ...
    public boolean controleer(final VerwerkingsContext context) {
        ...
        if (verzoekControleOudAnummerIsNietGevuld.controleer(context.getVerzoek()) && lijstControleEen.controleer(dbPersoonslijsten)) {
            ...
            if (dbPersoonslijst != null
                ...
                && plControleGevondenVersienummerGroter.controleer(context, dbPersoonslijst)
                && plControleGevondenDatumtijdstempelNieuwer.controleer(context, dbPersoonslijst))
            {
