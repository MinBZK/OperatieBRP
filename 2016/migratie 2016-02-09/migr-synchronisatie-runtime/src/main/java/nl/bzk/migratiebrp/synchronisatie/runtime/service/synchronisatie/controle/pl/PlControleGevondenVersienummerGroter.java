...
/**
 * Controleer dat het versienummer van de gevonden persoonslijst groter is dan het versienummer van de aangeboden
 * persoonslijst.
 */
@Component(value = "plControleGevondenVersienummerGroter")
public final class PlControleGevondenVersienummerGroter implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_GEVONDEN_VERSIENUMMER_GROTER);
