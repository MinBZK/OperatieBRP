 ...
 */
@Component(value = "plControleBijhoudingsPartijGelijkRni")
public final class PlControleBijhoudingsPartijGelijkRni implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_BIJHOUDINGSPARTIJ_GELIJK_RNI);
        ...
        final String logMelding = result ? MELDING_GELIJK_RNI : MELDING_ONGELIJK_RNI;
