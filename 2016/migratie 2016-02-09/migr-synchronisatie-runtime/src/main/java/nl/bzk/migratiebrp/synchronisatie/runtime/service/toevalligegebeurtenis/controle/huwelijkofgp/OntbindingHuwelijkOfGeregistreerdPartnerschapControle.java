 ...
 */
@Component("ontbindingHuwelijkOfGeregistreerdPartnerschapControle")
public final class OntbindingHuwelijkOfGeregistreerdPartnerschapControle implements ToevalligeGebeurtenisControle {
    ...
    public boolean controleer(final Persoon rootPersoon, final VerwerkToevalligeGebeurtenisVerzoekBericht verzoek) {
        return persoonControle.controleer(rootPersoon, verzoek)
               ...
               && soortVerbintenisGelijkControle.controleer(rootPersoon, verzoek);
    }
