...
/**
 * Controleer dat het versienummer van de gevonden persoonslijst gelijk is aan het versienummer van de aangeboden
 * persoonslijst.
 */
@Component(value = "plControleVersienummerGelijk")
public final class PlControleVersienummerGelijk implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_VERSIENUMMER_GELIJK);
