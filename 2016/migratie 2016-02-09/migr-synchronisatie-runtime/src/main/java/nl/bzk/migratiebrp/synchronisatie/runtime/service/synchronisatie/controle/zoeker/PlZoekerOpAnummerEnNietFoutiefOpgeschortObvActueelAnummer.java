 ...
 */
@Component(value = "plZoekerOpAnummerEnNietFoutiefOpgeschortObvActueelAnummer")
public final class PlZoekerOpAnummerEnNietFoutiefOpgeschortObvActueelAnummer implements PlZoeker {
    ...
    private Identifier maakResultaatIdentifier(final long aNummer) {
        return new Identifier("plZoekerOpAnummerEnNietFoutiefOpgeschortObvActueelAnummer", aNummer);
    }
}
