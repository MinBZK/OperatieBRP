 ...
 */
@Component(value = "plControleGevondenDatumtijdstempelOuder")
public final class PlControleGevondenDatumtijdstempelOuder implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_GEVONDEN_DATUMTIJDSTEMPEL_OUDER);
