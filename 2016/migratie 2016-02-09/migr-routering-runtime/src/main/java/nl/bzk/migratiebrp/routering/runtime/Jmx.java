...
public interface Jmx {
     ...
     *
     * @param queueNaam
     *            queue naam (let op: NIET de DLQ naam, maar de 'gewone' queue naam)
     * @return aantal berichten
     * @throws JMSException
     *             bij JMS fouten
     * @throws URISyntaxException
     *             als geen verbinding gemaakt kan worden met de BrokerService
     * @throws IOException
     *             bij verbindingsfouten met de BrokerService
     */
