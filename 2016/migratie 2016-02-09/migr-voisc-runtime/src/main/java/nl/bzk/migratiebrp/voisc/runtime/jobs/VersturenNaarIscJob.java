...
public final class VersturenNaarIscJob implements Job {
    ...
    public void execute(final JobExecutionContext arg0) {
        try (MDCCloser verwerkingCloser = MDC.startVerwerking()) {
            LOGGER.debug("Start job: versturen berichten naar ISC.");
            ...
            LOGGER.debug("Einde job: versturen berichten naar ISC.");
        }
    }
}
