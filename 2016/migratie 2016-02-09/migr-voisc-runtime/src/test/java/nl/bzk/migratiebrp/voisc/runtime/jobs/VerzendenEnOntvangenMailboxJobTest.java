...
public class VerzendenEnOntvangenMailboxJobTest {
    ...
    public void testExecute() {
        ...
        // Execute
        final VerzendenEnOntvangenMailboxJob subject = new VerzendenEnOntvangenMailboxJob();
        subject.execute(jobExecutionContext);

        Mockito.verify(voiscService).berichtenVerzendenNaarEnOntvangenVanMailbox();
