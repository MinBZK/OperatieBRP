...
/**
 * Maakt VerwerkToevalligeGebeurtenisVerzoekBericht voor akte 3B en 5B.
 */
class ToevalligeGebeurtenisOntbinding extends AbstractBerichtVerwerker<VerwerkToevalligeGebeurtenisVerzoekBericht, Tb02Bericht> {
    ...
    public final VerwerkToevalligeGebeurtenisVerzoekBericht verwerkInput(final Tb02Bericht input) {
        ...
        final RelatieType.Ontbinding ontbinding = new RelatieType.Ontbinding();
        ontbinding.setOntbinding(maakGroep07(input, Lo3CategorieEnum.CATEGORIE_05));
        bericht.getRelatie().setOntbinding(ontbinding);
