 ...
 */
@Component("algControleerBronEnDoelGemeenteDecision")
public final class ControleerBronEnDoelGemeenteDecision implements SpringDecision {
    ...
    public String execute(final Map<String, Object> parameters) {
        ...
        final Gemeente bronGemeente = (Gemeente) parameters.get("bron");
        final Gemeente doelGemeente = (Gemeente) parameters.get("doel");

        if (bronGemeente == null
            || bronGemeente.getStelsel() != Stelsel.BRP
            || doelGemeente == null
            || doelGemeente.getStelsel() != Stelsel.GBA)
        {
