---Groep Betrokkenheid---
select c.dataanv as DA, c.dateinde as DE, a.tsreg, a.tsverval, a.nadereaandverval, 
...
where c.srt = 3
and (ai_v.lo3categorie like '%2%' or ai_v.lo3categorie like '%3%')
