...
/**
 * Job voor het combineren van resultaten.
 */
public final class CombinatiesJob {
    ...
    public void execute(final ConfigurableApplicationContext context) {
        ...
        final String sqlCreateEnVul = ResourceUtil.getStringResourceData(this, "/sql/leveringsvergelijking-create-berichtcombinaties.sql");
