...
/**
 * Object waarin de stapel(s) met dezelfde herkomst van zowel de oorspronkelijke LO3 als de teruggeconverteerde BRP
...
public final class StapelMatch<T extends Lo3CategorieInhoud> {
     ...
     * 
     * @param herkomst
     *            herkomst waar deze {@link StapelMatch} voor gaat gelden.
     */
     ...
     * 
     * @param stapel
     *            teruggeconverteerde BRP stapel
     */
     ...
     * <li>{@link VerschilType#MATCHED} - als er precies 1 stapel is gevonden in zowel LO3 als BRP</li>
     * <li>{@link VerschilType#NON_UNIQUE_MATCHED} - als er meer dan 1 stapel is gevonden in of LO3 of BRP</li>
     * <li>{@link VerschilType#REMOVED} - als er een stapel is gevonden in LO3, maar niet in BRP</li>
     * </ul>
     * 
