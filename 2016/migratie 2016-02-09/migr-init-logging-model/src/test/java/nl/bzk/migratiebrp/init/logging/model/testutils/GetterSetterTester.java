...
package nl.bzk.migratiebrp.init.logging.model.testutils;
...
public class GetterSetterTester {
    ...
    private Object generateValue(final Class<?> type) {
        ...
        if (VALUES.containsKey(type)) {
            ...
            LOG.info("Probeer object van type " + type.getName() + " te instantieren");
            ...
            if (type.getDeclaredConstructors().length == 0) {
                ...
                try {
                    ...
                    LOG.warn("Kan object (" + type.getClass().getName() + ") niet instantieren met alleen maar NULL waarden in constructor.", e);
                    result = null;
                }
            }
        }
