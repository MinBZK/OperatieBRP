...
public class BRBY2019Test {

    private final BRBY2019       brby2019              = new BRBY2019();
    ...
    public void testGetRegel() {
        Assert.assertEquals(Regel.BRBY2019, new BRBY2019().getRegel());
    }

    @Test
    public void testPersoonGeenIndicaties() {
        final List<BerichtEntiteit> berichtEntiteiten =
            brby2019.voerRegelUit(maakPersoon(null, 2, HEEFT_OUDERLIJK_GEZAG, HEEFT_OUDERSCHAP), maakPersoonBericht());
    ...
    public void testPersoonMetIndicatieDerdeHeeftGezagBijEenOuder() {
        final List<BerichtEntiteit> berichtEntiteiten =
            brby2019.voerRegelUit(maakPersoon(SoortIndicatie.INDICATIE_DERDE_HEEFT_GEZAG, 1, HEEFT_OUDERLIJK_GEZAG, HEEFT_OUDERSCHAP),
                maakPersoonBericht());
    ...
    public void testPersoonMetIndicatieDerdeHeeftGezagBijEenOuderGeenOuderschapEnZonderOuderlijkGezag() {
        final List<BerichtEntiteit> berichtEntiteiten =
            brby2019.voerRegelUit(maakPersoon(SoortIndicatie.INDICATIE_DERDE_HEEFT_GEZAG, 1, null, GEEN_OUDERSCHAP),
                    maakPersoonBericht());
        Assert.assertEquals(0, berichtEntiteiten.size());
    }
