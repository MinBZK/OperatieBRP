...
public class CorrectieAdresUitvoerderTest {

    private CorrectieAdresUitvoerder correctieAdresUitvoerder;

    @Before
    public void init() {
        correctieAdresUitvoerder = new CorrectieAdresUitvoerder() {
            @Override
    ...
    public void testVerzamelVerwerkingsregels() {
        Assert.assertEquals(0, getVerwerkingsregels(correctieAdresUitvoerder).size());

        correctieAdresUitvoerder.verzamelVerwerkingsregels();

        Assert.assertEquals(1, getVerwerkingsregels(correctieAdresUitvoerder).size());
        Assert.assertTrue(getVerwerkingsregels(correctieAdresUitvoerder).get(0)
    ...
    private List<Verwerkingsregel> getVerwerkingsregels(final CorrectieAdresUitvoerder regUitvoerder) {
