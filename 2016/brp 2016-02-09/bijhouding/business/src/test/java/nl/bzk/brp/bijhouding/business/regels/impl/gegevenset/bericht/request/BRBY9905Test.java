...
public class BRBY9905Test {
    ...
    public void testGetRegel() {
        Assert.assertEquals(Regel.BRBY9905, bedrijfsregel.getRegel());
    }
    ...
    public void testBRY9905FoutSitiuatieNaarZichZelfMetDubbeleID() {
        ...
        BerichtAdministratieUtil.verrijktBerichtMetIdentificeerbaarObjectIndex(simplegGeboorteBericht);
        final List<BerichtIdentificeerbaar> berichtenDieDeRegelOvertreden = bedrijfsregel.voerRegelUit(simplegGeboorteBericht);
        // kan geen conclusie trekken, er zijn 2 waar we naar toe refereren.
        Assert.assertEquals(0, berichtenDieDeRegelOvertreden.size());
    }
    ...
    public void testBRY9905FoutSitiuatieRefereertNaarEenReferentieEnNaarZichzelf() {
        ...
        BerichtAdministratieUtil.verrijktBerichtMetIdentificeerbaarObjectIndex(simplegGeboorteBericht);
        final List<BerichtIdentificeerbaar> berichtenDieDeRegelOvertreden = bedrijfsregel.voerRegelUit(simplegGeboorteBericht);
        Assert.assertEquals(3, berichtenDieDeRegelOvertreden.size());
    }
