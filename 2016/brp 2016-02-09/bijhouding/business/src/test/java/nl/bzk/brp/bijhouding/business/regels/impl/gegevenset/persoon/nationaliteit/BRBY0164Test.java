...
/**
 * Unit test voor de {@link nl.bzk.brp.bijhouding.business.regels.impl.gegevenset.persoon.nationaliteit.BRBY0164} bedrijfsregel.
 */
public class BRBY0164Test {

    private BRBY0164 brby0164 = new BRBY0164();

    @Test
    public void testNieuweSituatieMetNederlandseNationaliteit() throws Exception {
        ...
        List<BerichtEntiteit> berichtEntiteiten = brby0164.voerRegelUit(null, nieuweSituatie, null, null);
    ...
    @Test
    public void testNieuweSituatieMetVreemdeNationaliteit() throws Exception {
        PersoonBericht nieuweSituatie =
    ...
    public void testGetRegel() throws Exception {
        Assert.assertEquals(Regel.BRBY0164, brby0164.getRegel());
    }
