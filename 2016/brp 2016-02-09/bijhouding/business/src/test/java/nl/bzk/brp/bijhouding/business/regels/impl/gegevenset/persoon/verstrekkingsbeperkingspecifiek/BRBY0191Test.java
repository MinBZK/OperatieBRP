...
/**
 * Unit test voor het testen van de bedrijfsregel BRBY0191.
 */
public class BRBY0191Test {
    ...
    private BRBY0191                         bedrijfsregel;

    @Before
    public void init() {
        bedrijfsregel = new BRBY0191();
    }

    @Test
    public void testGetRegel() {
        Assert.assertEquals(Regel.BRBY0191, bedrijfsregel.getRegel());
    }
    ...
    public void testGeenPartij() {
        ...
        ReflectionTestUtils.setField(persoon.getVerstrekkingsbeperkingen().iterator().next(), "partij", null);
    ...
    private PersoonBericht bouwPersoon(final Partij partij) {
        ...
        if (partij != null) {
            ...
            verstrekkingsbeperking.setPartij(new PartijAttribuut(partij));
