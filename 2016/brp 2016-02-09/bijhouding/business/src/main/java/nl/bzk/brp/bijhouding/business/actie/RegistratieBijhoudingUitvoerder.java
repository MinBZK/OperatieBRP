...
/**
 * Actie uitvoerder voor registratie opschorting.
 */
public final class RegistratieBijhoudingUitvoerder extends AbstractActieUitvoerder<
        PersoonBericht, PersoonHisVolledigImpl>
{

    @Override
    protected void verzamelVerwerkingsregels() {
        this.voegVerwerkingsregelToe(new BijhoudingGroepVerwerker(getBerichtRootObject(),
