...
/**
 * GemeenteVerordening heeft een waarde als en alleen als OmschrijvingDerde ook een waarde heeft.
 *
 * @brp.bedrijfsregel BRBY0179
 */
@Named("BRBY0179")
public class BRBY0179 implements VoorActieRegelMetMomentopname<PersoonView, PersoonBericht> {

    @Override
    public final Regel getRegel() {
        return Regel.BRBY0179;
    }
            ...
            final Actie actie, final Map<String, PersoonView> bestaandeBetrokkenen)
    {
        ...
        if (nieuweSituatie.getVerstrekkingsbeperkingen() != null) {
            ...
            {
                if ((persoonVerstrekkingsbeperking.getOmschrijvingDerde() != null && persoonVerstrekkingsbeperking
                        .getGemeenteVerordening() == null)
                    || (persoonVerstrekkingsbeperking.getOmschrijvingDerde() == null && persoonVerstrekkingsbeperking
                            .getGemeenteVerordening() != null))
                {
