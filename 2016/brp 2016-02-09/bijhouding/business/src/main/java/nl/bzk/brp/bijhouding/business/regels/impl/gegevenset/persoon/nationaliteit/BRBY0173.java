...
/**
 * Nationaliteit moet verwijzen naar geldig stamgegeven.
 *
 * @brp.bedrijfsregel BRBY0173
 */
@Named("BRBY0173")
public class BRBY0173 extends AbstractBestaansPeriodeStamgegevenRegel<
        PersoonView, PersoonBericht, PersoonNationaliteitBericht>
{
    ...
    {
        final Map<BestaansPeriodeStamgegeven, PersoonNationaliteitBericht> stamgegevensEnEntiteiten = new HashMap<>();
        ...
        if (nieuweSituatie.getNationaliteiten() != null) {
            for (final PersoonNationaliteitBericht persoonNationaliteit : nieuweSituatie.getNationaliteiten()) {
                if (persoonNationaliteit.getNationaliteit() != null) {
                    stamgegevensEnEntiteiten.put(persoonNationaliteit.getNationaliteit().getWaarde(),
