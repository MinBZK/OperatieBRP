 ...
 */
@Named("BRBY0012")
public class BRBY0012 implements VoorActieRegelMetMomentopname<ModelRootObject, BerichtRootObject> {

    @Override
    public final Regel getRegel() {
        return Regel.BRBY0012;
    }
                                              ...
                                              final Map<String, PersoonView> bestaandeBetrokkenen)
    {
        ...
        if (actie.getDatumEindeGeldigheid() != null && DatumAttribuut.vandaag().voor(actie.getDatumEindeGeldigheid())) {
