 ...
 */
@Component
public class RegistratieIdentificatienummersActieRegelManager extends AbstractActieRegelManager {
    ...
    public List<Class<? extends VoorActieRegel>> getVoorActieRegels(final SoortAdministratieveHandeling soortAdministratieveHandeling) {
        ...
        regels.addAll(Arrays.asList(BRAL0004.class, BRAL0013.class));
