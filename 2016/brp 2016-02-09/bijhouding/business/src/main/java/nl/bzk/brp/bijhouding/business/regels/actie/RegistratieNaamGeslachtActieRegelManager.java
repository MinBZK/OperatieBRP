 ...
 */
@Component
public class RegistratieNaamGeslachtActieRegelManager extends AbstractActieRegelManager {
    ...
    public List<Class<? extends VoorActieRegel>> getVoorActieRegels(final SoortAdministratieveHandeling soortAdministratieveHandeling) {
        ...
        switch (soortAdministratieveHandeling) {
            case WIJZIGING_GESLACHTSNAAM:
            case WIJZIGING_GESLACHTSAANDUIDING:
                regels.addAll(Arrays.asList(BRAL9003.class));
                break;
            default:
                break;
        }
