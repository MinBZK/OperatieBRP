 ...
 *
 * @brp.bedrijfsregel BRBY0193
 */
@Named("BRBY0193")
public class BRBY0193 extends AbstractBestaansPeriodeStamgegevenRegel<
        ...
        if (nieuweSituatie.getVerstrekkingsbeperkingen() != null) {
                    ...
                    : nieuweSituatie.getVerstrekkingsbeperkingen())
            {
                if (persoonVerstrekkingsbeperking.getGemeenteVerordening() != null) {
                    stamgegevensEnEntiteiten.put(persoonVerstrekkingsbeperking.getGemeenteVerordening().getWaarde(),
