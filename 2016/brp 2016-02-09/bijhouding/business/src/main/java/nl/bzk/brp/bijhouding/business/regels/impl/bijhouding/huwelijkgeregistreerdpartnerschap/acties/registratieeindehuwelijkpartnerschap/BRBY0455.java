...
/**
 * In het Bericht moet DatumAanvangGeldigheid van de Actie RegistratieEindeHuwelijkPartnerschap dezelfde
 * waarde hebben als DatumEinde (groep Standaard) van het HuwelijkPartnerschap.
 */
@Named("BRBY0455")
public class BRBY0455 implements
        VoorActieRegelMetMomentopname<HuwelijkGeregistreerdPartnerschapView, HuwelijkGeregistreerdPartnerschapBericht>
{
                                              ...
                                              final Map<String, PersoonView> bestaandeBetrokkenen)
    {
        ...
        if (nieuweSituatie.getStandaard() != null
            && nieuweSituatie.getStandaard().getDatumEinde() != null
            && nieuweSituatie.getStandaard().getDatumEinde().heeftWaarde()
            && !nieuweSituatie.getStandaard().getDatumEinde().equals(actie.getDatumAanvangGeldigheid()))
        {
