 ...
 */
@Component
public final class BerichtResultaatFactoryImpl implements BerichtResultaatFactory {

    @Override
    public BijhoudingResultaat creeerBerichtResultaat(final BerichtBericht bericht,
                                                      final BerichtContext berichtContext)
    {
        final BijhoudingResultaat resultaat = new BijhoudingResultaat(null);
