 ...
 */
@Named("BRBY0011")
public class BRBY0011 implements VoorActieRegelMetMomentopname<ModelRootObject, BerichtRootObject> {

    @Override
    public final Regel getRegel() {
        return Regel.BRBY0011;
    }
                                              ...
                                              final Map<String, PersoonView> bestaandeBetrokkenen)
    {
        ...
        if (actie.getDatumAanvangGeldigheid() != null && DatumAttribuut.vandaag().voor(actie.getDatumAanvangGeldigheid())) {
            objectenDieDeRegelOvertreden.add((BerichtEntiteit) actie);
        }
