...
/**
 * Land geboorte moet geldig zijn op geboortedatum.
 *
 * @brp.bedrijfsregel BRBY01037
 */
@Named("BRBY01037")
public class BRBY01037 extends AbstractBestaansPeriodeStamgegevenRegel<
        FamilierechtelijkeBetrekkingView, FamilierechtelijkeBetrekkingBericht, PersoonBericht>
{
            ...
            final FamilierechtelijkeBetrekkingBericht nieuweSituatie)
    {
        ...
        if (kind.getGeboorte() != null && kind.getGeboorte().getLandGebiedGeboorte() != null) {
            stamgegevensEnEntiteiten.put(kind.getGeboorte().getLandGebiedGeboorte().getWaarde(), kind);
        }

        final PersoonBericht vader = (PersoonBericht) RelatieUtils.haalNietMoederUitRelatie(nieuweSituatie);
        if (vader != null && vader.getGeboorte() != null && vader.getGeboorte().getLandGebiedGeboorte() != null) {
            stamgegevensEnEntiteiten.put(vader.getGeboorte().getLandGebiedGeboorte().getWaarde(), vader);
        }
