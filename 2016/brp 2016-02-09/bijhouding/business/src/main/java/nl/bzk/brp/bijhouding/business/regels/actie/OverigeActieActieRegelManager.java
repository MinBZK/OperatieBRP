...
/**
 * Implementatie van ActieRegelManager voor acties waarvoor geen actie-specifieke variant nodig is.
 */
@Component
public class OverigeActieActieRegelManager extends AbstractActieRegelManager {
