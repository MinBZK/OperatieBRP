...
/**
 * Op DatumAanvangGeldigheid van de groep Curatele, moet de Persoon meerderjarig zijn.
 */
@Named("BRBY2014")
public class BRBY2014 implements VoorActieRegelMetMomentopname<PersoonView, PersoonBericht> {
        ...
        final Map<String, PersoonView> bestaandeBetrokkenen)
    {
        ...
        if (!brby0003.isMeerderjarig(huidigeSituatie, new DatumAttribuut(actie.getDatumAanvangGeldigheid()))) {
