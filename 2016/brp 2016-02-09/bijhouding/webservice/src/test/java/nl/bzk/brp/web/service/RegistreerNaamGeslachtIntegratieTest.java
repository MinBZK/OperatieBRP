...
@Ignore
public class RegistreerNaamGeslachtIntegratieTest extends AbstractBijhoudingServiceIntegrationTest {
     ...
     */
    @Test
    public void testRegistratieNaamgeslachtMinBericht() throws Exception {
        String bestandsNaam = "naamGeslacht_Registreer_Naam_Geslacht_MIN.xml";
        zetActieVoorBericht("registreerNaamGeslacht");
        voegObjectSleutelXPathMetBijbehorendePersoonIdToe(
                "/brp:bhg_nmgRegistreerNaamGeslacht/brp:wijzigingGeslachtsnaam/brp:acties/brp:registratieNaamGeslacht/brp:persoon/@brp:objectSleutel",
                4002
        );
