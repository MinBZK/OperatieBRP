...
@Ignore
public class CorrigeerAdresIntegratieTest extends AbstractBijhoudingServiceIntegrationTest {
     ...
     */
    @Test
    public void testCorrectieAdresMinBericht() throws Exception {
        String bestandsNaam = "verblijf_Corrigeer_Adres_MIN.xml";
        zetActieVoorBericht("corrigeerAdres");
        voegObjectSleutelXPathMetBijbehorendePersoonIdToe(
                "/brp:bhg_vbaCorrigeerAdres/brp:correctieAdres/brp:acties/brp:correctieAdres/brp:persoon/@brp:objectSleutel",
                1);
