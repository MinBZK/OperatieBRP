...
@Ignore
public class RegistreerReisdocumentIntegratieTest extends AbstractBijhoudingServiceIntegrationTest {
     ...
     */
    @Test
    public void testRegistratieReisdocumentMinBericht() throws Exception {
        String bestandsNaam = "reisdocument_Registreer_Reisdocument_MIN.xml";
        zetActieVoorBericht("registreerReisdocument");
        voegObjectSleutelXPathMetBijbehorendePersoonIdToe(
                "/brp:bhg_rsdRegistreerReisdocument/brp:verkrijgingReisdocument/brp:acties/brp:registratieReisdocument/brp:persoon/@brp:objectSleutel",
                1
        );
