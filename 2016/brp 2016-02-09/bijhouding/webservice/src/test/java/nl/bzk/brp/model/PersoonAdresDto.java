...
public final class PersoonAdresDto {
    ...
    private static final String SQL_OPHALEN_PERSOONADRES_A_LAAG_MIDDELS_BSN =
        "select pa.id, pa.identcodeadresseerbaarobject, pa.huisnr, pa.postcode "
    ...
    private static final String SQL_OPHALEN_PERSOONADRES_C_LAAG_MIDDELS_BSN =
        "select pa.id, pa.identcodeadresseerbaarobject, pa.huisnr, pa.postcode "
            ...
            + "order by pa.dataanvgel desc";


    private final Integer id;
    private final Integer historischId;
    private final String  adreseerbaarObject;
    private final String  huisnr;
    private final String  postcode;

    private PersoonAdresDto(final Integer id, final Integer historischId, final String adreseerbaarObject,
    ...
    public Integer getHistorischId() {
        return historischId;
    }
    ...
    public static List<PersoonAdresDto> persoonAdresLevelA(final JdbcTemplate simpleJdbcTemplate,
        final String bsn)
    {
        List<PersoonAdresDto> persoonAdressen = new ArrayList<>();
        ...
        for (Map<String, Object> row : rows) {
            persoonAdressen.add(new PersoonAdresDto(
                ...
                (String) row.get("identcodeadresseerbaarobject"),
    ...
    public static List<PersoonAdresDto> persoonAdresLevelC(final JdbcTemplate simpleJdbcTemplate,
        final String bsn)
    {
        List<PersoonAdresDto> persoonAdressen = new ArrayList<>();
