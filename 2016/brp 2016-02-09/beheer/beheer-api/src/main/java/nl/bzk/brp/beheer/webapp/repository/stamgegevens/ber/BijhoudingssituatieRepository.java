 ...
 */
@Repository
public class BijhoudingssituatieRepository extends EnumReadonlyRepository<Bijhoudingssituatie> {

    /**
     * Constructor.
     */
    public BijhoudingssituatieRepository() {
        super(Bijhoudingssituatie.class);
    }
}
