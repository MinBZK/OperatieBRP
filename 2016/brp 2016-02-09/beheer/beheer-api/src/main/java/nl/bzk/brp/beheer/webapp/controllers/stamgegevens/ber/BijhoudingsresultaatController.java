...
public final class BijhoudingsresultaatController extends AbstractReadonlyController<Bijhoudingsresultaat, Integer> {
     ...
     */
    @Autowired
    protected BijhoudingsresultaatController(@Named("bijhoudingsresultaatRepository") final ReadonlyRepository<Bijhoudingsresultaat, Integer> repository) {
        super(repository);
    }
