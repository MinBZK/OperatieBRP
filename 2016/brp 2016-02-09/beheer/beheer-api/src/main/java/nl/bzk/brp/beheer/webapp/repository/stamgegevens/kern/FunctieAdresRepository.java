...
/**
 * FunctieAdres repository.
 */
@Repository
public class FunctieAdresRepository extends EnumReadonlyRepository<FunctieAdres> {

    /**
     * Constructor.
     */
    public FunctieAdresRepository() {
        super(FunctieAdres.class);
    }
}
