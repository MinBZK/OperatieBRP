...
/**
 * StatusTerugmelding repository.
 */
@Repository
public class StatusTerugmeldingRepository extends EnumReadonlyRepository<StatusTerugmelding> {

    /**
     * Constructor.
     */
    public StatusTerugmeldingRepository() {
        super(StatusTerugmelding.class);
    }
}
