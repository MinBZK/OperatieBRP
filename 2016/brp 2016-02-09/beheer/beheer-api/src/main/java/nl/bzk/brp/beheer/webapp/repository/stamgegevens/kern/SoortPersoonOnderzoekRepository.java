...
/**
 * SoortPersoonOnderzoek repository.
 */
@Repository
public class SoortPersoonOnderzoekRepository extends EnumReadonlyRepository<SoortPersoonOnderzoek> {

    /**
     * Constructor.
     */
    public SoortPersoonOnderzoekRepository() {
        super(SoortPersoonOnderzoek.class);
    }
}
