...
public final class ConversieAangifteAdreshoudingController extends AbstractReadWriteController<ConversieAangifteAdreshouding, Integer> {
    ...
    protected ConversieAangifteAdreshoudingController(
        @Named("conversieAangifteAdreshoudingRepository") final ReadWriteRepository<ConversieAangifteAdreshouding, Integer> repository)
    {
        super(repository);
    }
