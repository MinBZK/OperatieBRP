...
/**
 * AanduidingMedium repository.
 */
@Repository
public class AanduidingMediumRepository extends EnumReadonlyRepository<AanduidingMedium> {

    /**
     * Constructor.
     */
    public AanduidingMediumRepository() {
        super(AanduidingMedium.class);
    }
}
