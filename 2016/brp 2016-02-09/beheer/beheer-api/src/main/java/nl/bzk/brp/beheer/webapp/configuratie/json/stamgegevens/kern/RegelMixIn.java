...
/**
 * Mix-in for {@link nl.bzk.brp.model.algemeen.stamgegeven.kern.Regel}.
 */
public interface RegelMixIn extends StringEnumMixIn {
    ...
    /** @return specificatie */
    @JsonProperty
    String getSpecificatie();

    /** @return property melding paden */
    @JsonProperty
    String[] getPropertyMeldingPaden();
}
