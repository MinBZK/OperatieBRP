...
/**
 * RegelSoortBericht repository.
 */
@Repository
public class RegelSoortBerichtRepository extends EnumReadonlyRepository<RegelSoortBericht> {

    /**
     * Constructor.
     */
    public RegelSoortBerichtRepository() {
