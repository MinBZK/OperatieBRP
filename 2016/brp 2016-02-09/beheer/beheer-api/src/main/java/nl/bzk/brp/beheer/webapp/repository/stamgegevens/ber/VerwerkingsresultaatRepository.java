...
/**
 * Verwerkingsresultaat repository.
 */
@Repository
public class VerwerkingsresultaatRepository extends EnumReadonlyRepository<Verwerkingsresultaat> {

    /**
     * Constructor.
     */
    public VerwerkingsresultaatRepository() {
        super(Verwerkingsresultaat.class);
    }
}
