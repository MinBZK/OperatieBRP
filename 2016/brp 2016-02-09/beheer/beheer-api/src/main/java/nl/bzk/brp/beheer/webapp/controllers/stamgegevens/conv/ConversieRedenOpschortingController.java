...
public final class ConversieRedenOpschortingController extends AbstractReadWriteController<ConversieRedenOpschorting, Integer> {
    ...
    protected ConversieRedenOpschortingController(
        @Named("conversieRedenOpschortingRepository") final ReadWriteRepository<ConversieRedenOpschorting, Integer> repository)
    {
        super(repository);
    }
