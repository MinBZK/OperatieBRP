...
public final class BeheerInitializer extends AbstractSecurityWebApplicationInitializer {
    ...
    static {
        org.slf4j.MDC.put(MDCVeld.MDC_APPLICATIE_NAAM.getVeld(), ApplicationConstants.APPLICATIE_NAAM);
    }
    ...
    public BeheerInitializer() {
        ...
        super(RepositoryConfiguratie.class, BlobifierConfiguratie.class, SecurityConfiguratie.class);
    }
