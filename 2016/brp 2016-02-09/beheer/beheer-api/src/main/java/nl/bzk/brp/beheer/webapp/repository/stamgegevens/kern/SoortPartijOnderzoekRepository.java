...
/**
 * SoortPartijOnderzoek repository.
 */
@Repository
public class SoortPartijOnderzoekRepository extends EnumReadonlyRepository<SoortPartijOnderzoek> {

    /**
     * Constructor.
     */
    public SoortPartijOnderzoekRepository() {
        super(SoortPartijOnderzoek.class);
    }
}
