...
/**
 * Historievorm repository.
 */
@Repository
public class HistorievormRepository extends EnumReadonlyRepository<Historievorm> {

    /**
     * Constructor.
     */
    public HistorievormRepository() {
        super(Historievorm.class);
    }
}
