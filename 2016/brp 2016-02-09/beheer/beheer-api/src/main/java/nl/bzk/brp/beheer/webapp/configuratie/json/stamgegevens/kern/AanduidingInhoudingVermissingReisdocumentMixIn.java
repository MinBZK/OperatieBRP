...
/**
 * Mix in voor {@link nl.bzk.brp.model.beheer.kern.AanduidingInhoudingVermissingReisdocument}.
 */
public interface AanduidingInhoudingVermissingReisdocumentMixIn extends StamgegevenMixIn {

    /** @return Code. */
    @JsonProperty
    AanduidingInhoudingVermissingReisdocumentCodeAttribuut getCode();
}
