...
public final class ConversieAdellijkeTitelPredikaatController extends AbstractReadWriteController<ConversieAdellijkeTitelPredikaat, Integer> {
    ...
    protected ConversieAdellijkeTitelPredikaatController(
        @Named("conversieAdellijkeTitelPredikaatRepository") final ReadWriteRepository<ConversieAdellijkeTitelPredikaat, Integer> repository)
    {
        super(repository);
    }
