...
/**
 * Bijhoudingsresultaat repository.
 */
@Repository
public class BijhoudingsresultaatRepository extends EnumReadonlyRepository<Bijhoudingsresultaat> {

    /**
     * Constructor.
     */
    public BijhoudingsresultaatRepository() {
        super(Bijhoudingsresultaat.class);
    }
}
