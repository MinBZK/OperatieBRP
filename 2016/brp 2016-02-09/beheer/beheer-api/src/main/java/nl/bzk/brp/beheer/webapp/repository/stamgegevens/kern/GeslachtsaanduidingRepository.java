...
/**
 * Geslachtsaanduiding repository.
 */
@Repository
public class GeslachtsaanduidingRepository extends EnumReadonlyRepository<Geslachtsaanduiding> {

    /**
     * Constructor.
     */
    public GeslachtsaanduidingRepository() {
