...
/**
 * Soort autorisatiebesluit repository.
 */
@Repository
public class SoortAutorisatiebesluitRepository extends EnumReadonlyRepository<SoortAutorisatiebesluit> {

    /**
     * Constructor.
     */
    public SoortAutorisatiebesluitRepository() {
        super(SoortAutorisatiebesluit.class);
    }
}
