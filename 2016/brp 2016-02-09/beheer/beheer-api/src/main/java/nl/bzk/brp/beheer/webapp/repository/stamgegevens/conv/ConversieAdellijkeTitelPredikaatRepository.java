...
/**
 * Conversie adellijke titel predikaat repository.
 */
@Master
public interface ConversieAdellijkeTitelPredikaatRepository extends ReadWriteRepository<ConversieAdellijkeTitelPredikaat, Integer> {
