...
/**
 * Conversie aangifte adreshouding repository.
 */
@Master
public interface ConversieAangifteAdreshoudingRepository extends ReadWriteRepository<ConversieAangifteAdreshouding, Integer> {
