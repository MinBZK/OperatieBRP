...
/**
 * Soort bevoegdheid repository.
 */
@Repository
public class SoortBevoegdheidRepository extends EnumReadonlyRepository<SoortBevoegdheid> {

    /**
     * Constructor.
     */
    public SoortBevoegdheidRepository() {
        super(SoortBevoegdheid.class);
    }
}
