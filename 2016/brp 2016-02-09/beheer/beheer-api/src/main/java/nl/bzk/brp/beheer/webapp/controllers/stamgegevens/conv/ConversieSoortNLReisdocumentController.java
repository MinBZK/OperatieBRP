...
public final class ConversieSoortNLReisdocumentController extends AbstractReadWriteController<ConversieSoortNLReisdocument, Integer> {
    ...
    protected ConversieSoortNLReisdocumentController(
        @Named("conversieSoortNLReisdocumentRepository") final ReadWriteRepository<ConversieSoortNLReisdocument, Integer> repository)
    {
        super(repository);
    }
