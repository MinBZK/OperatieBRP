...
public final class ProtocolleringsniveauController extends AbstractReadonlyController<Protocolleringsniveau, Integer> {
     ...
     * Constructor.
     *
     * @param repository protocolleringsniveau repository
     */
    @Autowired
    protected ProtocolleringsniveauController(@Named("protocolleringsniveauRepository") final ReadonlyRepository<Protocolleringsniveau, Integer> repository) {
        super(repository);
    }
