...
public class VersieControllerTest extends AbstractDatabaseTest {
    ...
    public final void test() throws Exception {
        final MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/versie")).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();
