...
public class ConversieRedenOpnameNationaliteitControllerTest {
    ...
    public final void testConversieLO3RubriekFilter() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/conversieredenopnamenationaliteit"))
