...
/**
 * Test voor {@link GedeblokkeerdeMeldingController}
 */
...
@Data(resources = "classpath:/data/gedeblokkeerdemelding.xml", dataSourceRef = RepositoryConfiguratie.DATA_SOURCE_MASTER)
public class GedeblokkeerdeMeldingControllerTest extends AbstractDatabaseTest {
    ...
    /**
     * Test administratieve handeling gedeblokkeerde melding.
     *
     * @throws Exception ex
     */
    @Test
    public final void testOphalenLijst() throws Exception {
        final MvcResult result =
            mockMvc.perform(MockMvcRequestBuilders.get("/gedeblokkeerdemelding/"))
     ...
     */
    @Test
    public final void testOphalenMetFilter() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/gedeblokkeerdemelding/").param("administratieveHandeling", "1000"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.first").value(true))
