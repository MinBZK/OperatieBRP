...
public class AdministratieveHandelingRepositoryTest extends AbstractDatabaseTest {

    @Autowired
    private AdministratieveHandelingRepository subject;

    @Test
    public void findAll() throws JsonProcessingException {
        final Pageable pageable = new PageRequest(0, 10);
        final Page<AdministratieveHandelingModel> page = subject.findAll(null, pageable);
