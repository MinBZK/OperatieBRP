...
public class ConversieRedenBeeindigenNationaliteitControllerTest {
    ...
    public final void testConversieLO3RubriekFilter() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/conversieredenbeeindigennationaliteit"))
