        ...
        extends AbstractMaterieelMutatieVerwerker<Lo3HuwelijkOfGpInhoud, BrpSamengesteldeNaamInhoud, HisPersoonSamengesteldeNaamModel>
{
     ...
     */
    @Autowired
    protected GeregistreerdPartnerschapSamengesteldeNaamMutatieVerwerker(
        final GeregistreerdPartnerschapSamengesteldeNaamMapper mapper,
        final SamengesteldeNaamConverteerder converteerder)
    {
        super(mapper, converteerder, ElementEnum.GERELATEERDEGEREGISTREERDEPARTNER_PERSOON_SAMENGESTELDENAAM);
    }
