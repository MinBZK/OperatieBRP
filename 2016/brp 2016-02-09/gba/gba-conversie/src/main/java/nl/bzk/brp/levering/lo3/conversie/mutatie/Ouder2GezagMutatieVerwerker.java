 ...
 */
@Component
public final class Ouder2GezagMutatieVerwerker
        extends AbstractMaterieelMutatieVerwerker<Lo3GezagsverhoudingInhoud, BrpOuder2GezagInhoud, HisOuderOuderlijkGezagModel>
{
    /**
     * Constructor.
     *
     ...
     */
    @Autowired
    protected Ouder2GezagMutatieVerwerker(final Ouder2GezagMapper mapper, final GezagOuder2Converteerder converteerder) {
