 ...
 */
@Component
public final class Ouder1GezagMapper extends AbstractMaterieelMapper<OuderHisVolledig, HisOuderOuderlijkGezagModel, BrpOuder1GezagInhoud> {

    /**
     * Constructor.
     */
    public Ouder1GezagMapper() {
    ...
    @Override
    public BrpOuder1GezagInhoud mapInhoud(final HisOuderOuderlijkGezagModel historie, final OnderzoekMapper onderzoekMapper) {
        return new BrpOuder1GezagInhoud(BrpMapperUtil.mapBrpBoolean(
