        ...
        extends AbstractMaterieelMutatieVerwerker<Lo3HuwelijkOfGpInhoud, BrpGeslachtsaanduidingInhoud, HisPersoonGeslachtsaanduidingModel>
{
     ...
     */
    @Autowired
    protected GeregistreerdPartnerschapGeslachtsaanduidingMutatieVerwerker(
        final GeregistreerdPartnerschapGeslachtsaanduidingMapper mapper,
        final GeslachtsaanduidingConverteerder converteerder)
    {
        super(mapper, converteerder, ElementEnum.GERELATEERDEGEREGISTREERDEPARTNER_PERSOON_GESLACHTSAANDUIDING);
    }
