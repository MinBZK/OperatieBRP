 ...
 */
@Component
public class ReisdocumentIdentiteitOnderzoekVerwerker extends AbstractIdentiteitOnderzoekVerwerker<Lo3ReisdocumentInhoud> {

    /**
     * Default constructor.
     */
    public ReisdocumentIdentiteitOnderzoekVerwerker() {
        super(ElementEnum.PERSOON_REISDOCUMENT_IDENTITEIT);
    }
