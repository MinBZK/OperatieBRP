...
import nl.bzk.brp.levering.lo3.mapper.DerdeHeeftGezagIndicatieMapper;
...
public final class PersoonIndicatieDerdeHeeftGezagMutatieVerwerker
        extends AbstractMaterieelMutatieVerwerker<Lo3GezagsverhoudingInhoud, BrpDerdeHeeftGezagIndicatieInhoud, HisPersoonIndicatieDerdeHeeftGezagModel>
{
    /**
     * Constructor.
     *
     ...
     */
    @Autowired
    protected PersoonIndicatieDerdeHeeftGezagMutatieVerwerker(
        final DerdeHeeftGezagIndicatieMapper mapper,
        final DerdeHeeftGezagIndicatieConverteerder converteerder)
    {
        super(mapper, converteerder, ElementEnum.PERSOON_INDICATIE_DERDEHEEFTGEZAG_GROEP);
    }
