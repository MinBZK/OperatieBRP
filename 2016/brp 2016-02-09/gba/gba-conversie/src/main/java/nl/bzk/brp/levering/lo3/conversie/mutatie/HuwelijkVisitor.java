...
public final class HuwelijkVisitor extends AbstractRelatieVisitor {
    ...
    public void verwerk(
        ...
        final HuwelijkHisVolledig relatie,
        final PersoonHisVolledig partner)
    {
        ...
        if (actueleEntiteit != null && historieEntiteit == null) {
            ...
            LOGGER.debug("Nieuw huwelijk: id={}; actieInhoud={}", relatie.getID(), actueleEntiteit.getID());
            ...
            LOGGER.debug("Vervallen huwelijk: id={}; actieVerval={}", relatie.getID(), historieEntiteit.getID());
            ...
            LOGGER.debug("Verwerk huwelijk: id={}", relatie.getID());
