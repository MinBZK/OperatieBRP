 ...
 */
@Component
public final class ReisdocumentStandaardMutatieVerwerker
        extends AbstractFormeelMutatieVerwerker<Lo3ReisdocumentInhoud, BrpReisdocumentInhoud, HisPersoonReisdocumentModel>
{
    /**
     * Constructor.
     *
    ...
    protected ReisdocumentStandaardMutatieVerwerker(
        ...
        final ReisdocumentConverteerder converteerder,
        final PersoonReisdocumentHistorieNabewerking historieNabewerking)
    {
        super(mapper, converteerder, historieNabewerking, ElementEnum.PERSOON_REISDOCUMENT_STANDAARD);
    }
}
