 ...
 */
@Component
public final class KindGeboorteMutatieVerwerker extends AbstractFormeelMutatieVerwerker<Lo3KindInhoud, BrpGeboorteInhoud, HisPersoonGeboorteModel> {
    /**
     * Constructor.
     *
     * @param mapper
     ...
     */
    @Autowired
    protected KindGeboorteMutatieVerwerker(final KindGeboorteMapper mapper, final GeboorteConverteerder converteerder) {
        super(mapper, converteerder, null, ElementEnum.GERELATEERDEKIND_PERSOON_GEBOORTE);
    }
