...
public class PersoonIdentificatieNummersMapperTest {
    ...
    public void testSucces() {
        ...
        Assert.assertEquals(Long.valueOf(1234567890L), brpInhoud.get(0).getInhoud().getAdministratienummer().getWaarde());
        Assert.assertEquals(Integer.valueOf(123456789), brpInhoud.get(0).getInhoud().getBurgerservicenummer().getWaarde());
    }
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.nieuwIdentificatienummersRecord(MapperTestUtil.maakActieModel(20131212000000L, 20131212, null)).eindeRecord();
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        // @formatter:off
        return builder.nieuwIdentificatienummersRecord(MapperTestUtil.maakActieModel(20131212000000L, 20131212, null))
                .administratienummer(1234567890L)
