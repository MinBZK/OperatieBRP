...
public class OnderCurateleIndicatieMapperTest {

    private final OnderCurateleIndicatieMapper mapper = new OnderCurateleIndicatieMapper();
    ...
    public void testSucces() {
        ...
        final BrpStapel<BrpOnderCurateleIndicatieInhoud> stapel =
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpOnderCurateleIndicatieInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieOnderCurateleToe(new PersoonIndicatieOnderCurateleHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieOnderCurateleToe(new PersoonIndicatieOnderCurateleHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                         MapperTestUtil.maakActieModel(
                                                                                                                             20131212000000L,
                                                                                                                             20131212,
                                                                                                                             null))
