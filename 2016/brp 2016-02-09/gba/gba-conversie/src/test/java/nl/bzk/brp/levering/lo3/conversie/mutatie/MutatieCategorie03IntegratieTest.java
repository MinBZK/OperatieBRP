...
public class MutatieCategorie03IntegratieTest extends AbstractMutatieConverteerderIntegratieTest {
    ...
    public void testGroep01Identificatienummers() {
        ...
        ouder2Builder.nieuwIdentificatienummersRecord(actie).administratienummer(7777777777L).burgerservicenummer(123123123).eindeRecord();
    ...
    public void testGroep02Naam() {
        final ActieModel actie =
                PersoonHisVolledigUtil.maakActie(2L, SoortAdministratieveHandeling.G_B_A_BIJHOUDING_ACTUEEL, SoortActie.CONVERSIE_G_B_A, 19400101, partij);
        ouder2Builder.nieuwSamengesteldeNaamRecord(actie)
                     .voornamen("Voornaam3")
    ...
    public void testGroep03Geboorte() {
        final ActieModel actie =
                PersoonHisVolledigUtil.maakActie(2L, SoortAdministratieveHandeling.G_B_A_BIJHOUDING_ACTUEEL, SoortActie.CONVERSIE_G_B_A, 19400101, partij);
        ouder2Builder.nieuwGeboorteRecord(actie).datumGeboorte(19330202).gemeenteGeboorte((short) 222).landGebiedGeboorte((short) 6030).eindeRecord();

        maakOuders();
        final List<Lo3CategorieWaarde> resultaat = uitvoeren(actie);

        assertElementen(resultaat, Lo3CategorieEnum.CATEGORIE_03, true, Lo3ElementEnum.ELEMENT_0310, "19330202", Lo3ElementEnum.ELEMENT_0320, "0222",
        // Lo3ElementEnum.ELEMENT_8510,
        // "19400101",
            Lo3ElementEnum.ELEMENT_8610,
            "19400102");
        assertElementen(resultaat, Lo3CategorieEnum.CATEGORIE_53, true, Lo3ElementEnum.ELEMENT_0310, "18800606", Lo3ElementEnum.ELEMENT_0320, "0577",
        // Lo3ElementEnum.ELEMENT_8510,
        // "19200101",
            Lo3ElementEnum.ELEMENT_8610,
            "19200102");
    ...
    public void testGroep03GeboorteBuiteland() {
        final ActieModel actie =
                PersoonHisVolledigUtil.maakActie(2L, SoortAdministratieveHandeling.G_B_A_BIJHOUDING_ACTUEEL, SoortActie.CONVERSIE_G_B_A, 19400101, partij);
        ouder2Builder.nieuwGeboorteRecord(actie)
                     .datumGeboorte(18800606)
        ...
        assertElementen(resultaat, Lo3CategorieEnum.CATEGORIE_03, true, Lo3ElementEnum.ELEMENT_0320, "Brussel", Lo3ElementEnum.ELEMENT_0330, "5010",
        // Lo3ElementEnum.ELEMENT_8510,
        // "19400101",
            Lo3ElementEnum.ELEMENT_8610,
            "19400102");
        assertElementen(resultaat, Lo3CategorieEnum.CATEGORIE_53, true, Lo3ElementEnum.ELEMENT_0320, "0577", Lo3ElementEnum.ELEMENT_0330, "6030",
        // Lo3ElementEnum.ELEMENT_8510,
        // "19200101",
            Lo3ElementEnum.ELEMENT_8610,
            "19200102");
    ...
    public void testGroep04Geslacht() {
        final ActieModel actie =
                PersoonHisVolledigUtil.maakActie(2L, SoortAdministratieveHandeling.G_B_A_BIJHOUDING_ACTUEEL, SoortActie.CONVERSIE_G_B_A, 19400101, partij);
        ouder2Builder.nieuwGeslachtsaanduidingRecord(actie).geslachtsaanduiding(Geslachtsaanduiding.VROUW).eindeRecord();
