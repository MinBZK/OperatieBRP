...
public class SignaleringMetBetrekkingTotVerstrekkenReisdocumentMapperTest {

    private final SignaleringMetBetrekkingTotVerstrekkenReisdocumentMapper mapper = new SignaleringMetBetrekkingTotVerstrekkenReisdocumentMapper();
    ...
    public void testSucces() {
        ...
        final BrpStapel<BrpSignaleringMetBetrekkingTotVerstrekkenReisdocumentInhoud> stapel =
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpSignaleringMetBetrekkingTotVerstrekkenReisdocumentInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentToe(new PersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentToe(new PersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                                                                                                   MapperTestUtil.maakActieModel(
                                                                                                                                                                                                       20131212000000L,
                                                                                                                                                                                                       20131212,
                                                                                                                                                                                                       null))
