...
public class BehandeldAlsNederlanderIndicatieMapperTest {

    private final BehandeldAlsNederlanderIndicatieMapper mapper = new BehandeldAlsNederlanderIndicatieMapper();
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpBehandeldAlsNederlanderIndicatieInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieBehandeldAlsNederlanderToe(new PersoonIndicatieBehandeldAlsNederlanderHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieBehandeldAlsNederlanderToe(new PersoonIndicatieBehandeldAlsNederlanderHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                                             MapperTestUtil.maakActieModel(
                                                                                                                                                 20131212000000L,
                                                                                                                                                 20131212,
                                                                                                                                                 null))
