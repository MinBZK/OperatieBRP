...
public class DerdeHeeftGezagIndicatieMapperTest {

    private final DerdeHeeftGezagIndicatieMapper mapper = new DerdeHeeftGezagIndicatieMapper();
    ...
    public void testSucces() {
        ...
        final BrpStapel<BrpDerdeHeeftGezagIndicatieInhoud> stapel =
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpDerdeHeeftGezagIndicatieInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieDerdeHeeftGezagToe(new PersoonIndicatieDerdeHeeftGezagHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieDerdeHeeftGezagToe(new PersoonIndicatieDerdeHeeftGezagHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                             MapperTestUtil.maakActieModel(
                                                                                                                                 20131212000000L,
                                                                                                                                 20131212,
                                                                                                                                 null))
