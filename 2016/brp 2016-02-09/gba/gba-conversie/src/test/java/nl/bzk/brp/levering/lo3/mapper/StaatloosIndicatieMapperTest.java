...
public class StaatloosIndicatieMapperTest {

    private final StaatloosIndicatieMapper mapper = new StaatloosIndicatieMapper();
    ...
    public void testSucces() {
        ...
        final BrpStapel<BrpStaatloosIndicatieInhoud> stapel =
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpStaatloosIndicatieInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieStaatloosToe(new PersoonIndicatieStaatloosHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieStaatloosToe(new PersoonIndicatieStaatloosHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                 MapperTestUtil.maakActieModel(
                                                                                                                     20131212000000L,
                                                                                                                     20131212,
                                                                                                                     null))
