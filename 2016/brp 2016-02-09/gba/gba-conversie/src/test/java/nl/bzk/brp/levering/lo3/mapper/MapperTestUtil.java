...
public final class MapperTestUtil {
    ...
    protected static final SoortActie DEFAULT_SOORT_ACTIE = SoortActie.DUMMY;
        ...
        final SoortActie soortActie)
    {
        ...
        final DatumTijdAttribuut tijdstipRegistratie = datumRegistratie == null ? null : maakDatumTijdAttribuut(datumRegistratie);
        final PartijAttribuut partij =
                partijCode == null ? null : new PartijAttribuut(new Partij(null, null, new PartijCodeAttribuut(partijCode), null, null, null, null,
                    null, null));
    ...
    public static ActieModel maakActieModel(final Long datumRegistratie) {
        return maakActieModel(ID_GENERATOR.getAndIncrement(), datumRegistratie, null, null, DEFAULT_PARTIJ_CODE, DEFAULT_SOORT_ACTIE);
    }

    public static ActieModel maakActieModel(final Long datumRegistratie, final Integer datumAanvangGeldigheid, final Integer datumEindeGeldigheid) {
    ...
    public static ActieModel maakActieModel() {
        return maakActieModel(ID_GENERATOR.getAndIncrement(), DEFAULT_DATUM_REGISTRATIE, null, null, DEFAULT_PARTIJ_CODE, DEFAULT_SOORT_ACTIE);
    }
