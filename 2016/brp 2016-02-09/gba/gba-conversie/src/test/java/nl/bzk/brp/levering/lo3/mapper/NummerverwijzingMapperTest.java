...
public class NummerverwijzingMapperTest {

    private final NummerverwijzingMapper mapper = new NummerverwijzingMapper();
    ...
    public void testSucces() {
        ...
        Assert.assertEquals(Long.valueOf(1234567890L), brpInhoud.get(0).getInhoud().getVolgendeAdministratienummer().getWaarde());
        Assert.assertEquals(Long.valueOf(9876543210L), brpInhoud.get(0).getInhoud().getVorigeAdministratienummer().getWaarde());
    }
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.nieuwNummerverwijzingRecord(MapperTestUtil.maakActieModel(20131212000000L, 20131212, null)).eindeRecord();
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        // @formatter:off
        return builder.nieuwNummerverwijzingRecord(MapperTestUtil.maakActieModel(20131212000000L, 20131212, null))
                .volgendeAdministratienummer(1234567890L)
                .vorigeAdministratienummer(9876543210L)
                .eindeRecord();
        // @formatter:on
    }
