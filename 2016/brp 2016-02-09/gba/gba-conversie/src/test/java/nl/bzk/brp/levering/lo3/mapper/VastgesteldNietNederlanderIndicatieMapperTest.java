...
public class VastgesteldNietNederlanderIndicatieMapperTest {

    private final VastgesteldNietNederlanderIndicatieMapper mapper = new VastgesteldNietNederlanderIndicatieMapper();
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpVastgesteldNietNederlanderIndicatieInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieVastgesteldNietNederlanderToe(new PersoonIndicatieVastgesteldNietNederlanderHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieVastgesteldNietNederlanderToe(new PersoonIndicatieVastgesteldNietNederlanderHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                                                   MapperTestUtil.maakActieModel(
                                                                                                                                                       20131212000000L,
                                                                                                                                                       20131212,
                                                                                                                                                       null))
