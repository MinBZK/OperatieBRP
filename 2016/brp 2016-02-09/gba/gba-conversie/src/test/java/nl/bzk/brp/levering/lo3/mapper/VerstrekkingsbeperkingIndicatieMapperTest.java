...
public class VerstrekkingsbeperkingIndicatieMapperTest {

    private final VerstrekkingsbeperkingIndicatieMapper mapper = new VerstrekkingsbeperkingIndicatieMapper();
    ...
    public void testSucces() {
        ...
        final BrpStapel<BrpVerstrekkingsbeperkingIndicatieInhoud> stapel =
    ...
    public void testLeeg() {
        ...
        final BrpStapel<BrpVerstrekkingsbeperkingIndicatieInhoud> brpBijhoudingsaard =
                mapper.map(persoonHisVolledig, new OnderzoekMapper(persoonHisVolledig), new TestActieHisVolledigLocator());
    ...
    public void testGeenWaarde() {
        final PersoonHisVolledigImplBuilder builder = new PersoonHisVolledigImplBuilder(SoortPersoon.INGESCHREVENE);
        builder.voegPersoonIndicatieVolledigeVerstrekkingsbeperkingToe(new PersoonIndicatieVolledigeVerstrekkingsbeperkingHisVolledigImplBuilder().nieuwStandaardRecord(
    ...
    public static PersoonHisVolledigImplBuilder maak(final PersoonHisVolledigImplBuilder builder) {
        return builder.voegPersoonIndicatieVolledigeVerstrekkingsbeperkingToe(new PersoonIndicatieVolledigeVerstrekkingsbeperkingHisVolledigImplBuilder().nieuwStandaardRecord(
                                                                                                                                                             MapperTestUtil.maakActieModel(
                                                                                                                                                                 20131212000000L,
                                                                                                                                                                 20131212,
                                                                                                                                                                 null))
