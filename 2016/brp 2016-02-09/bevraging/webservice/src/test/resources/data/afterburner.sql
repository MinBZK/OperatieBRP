...
-- SELECT SETVAL('kern.seq_his_erkenningongeborenvrucht', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_erkenningongeborenvrucht"), true);
-- SELECT SETVAL('kern.seq_his_huwelijkgeregistreerdpar', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_huwelijkgeregistreerdpar"), true);
-- SELECT SETVAL('kern.seq_his_multirealiteitregel', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_multirealiteitregel"), true);
-- SELECT SETVAL('kern.seq_his_naamskeuzeongeborenvruch', (select 90000+ coalesce(max(id),0)  FROM "kern"."his_naamskeuzeongeborenvruch"), true);
...
-- -- SELECT SETVAL('autaut.seq_his_abonnementsrtber', (select 90000+ coalesce(max(id),0)  FROM "autaut"."his_abonnementsrtber"), true);
