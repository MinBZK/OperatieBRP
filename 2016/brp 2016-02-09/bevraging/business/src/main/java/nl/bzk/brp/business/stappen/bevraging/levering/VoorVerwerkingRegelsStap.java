...
/**
 * Stap waarin bedrijfsregels worden uitgevoerd die voor de verwerking van het bericht moeten worden gecontrolleerd.
 */
public class VoorVerwerkingRegelsStap extends AbstractVerwerkingRegelsStap {
            ...
            final BevragingResultaat resultaat)
    {
        ...
        LOGGER.debug("VoorVerwerkingRegelsStap.voerStapUit");
     ...
     */
    private void controleerVoorVerwerkingRegels(final BevragingsBericht onderwerp,
            final BevragingBerichtContextBasis context, final BerichtVerwerkingsResultaatImpl resultaat)
    {
        ...
        final List<RegelInterface> regels =
            this.getBedrijfsregelManagerImpl().getUitTeVoerenRegelsVoorVerwerking(soortBericht);
