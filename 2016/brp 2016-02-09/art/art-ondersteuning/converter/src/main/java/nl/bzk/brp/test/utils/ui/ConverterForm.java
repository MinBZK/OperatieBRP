...
import nl.bzk.brp.test.utils.SoortBevraging;
...
public class ConverterForm extends JFrame {
    ...
    private SoortBevraging soortBevraging;
    ...
    public ConverterForm() {
        ...
        // TODO: Maak drop down?
        soortBevraging = SoortBevraging.DETAILS_PERSOON;
        refreshConfig();
    }

    private void refreshConfig() {
        ConverterForm.this.inputFolderTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/" + soortBevraging.getMapnaam() + "/input");
        ConverterForm.this.templateFileTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/" + soortBevraging.getTemplateNaam());
        ConverterForm.this.inputFindReplaceTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/2-find-replace.properties");
        ConverterForm.this.templateDefaultsBestaansrechtTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/3-default-met-bestaansrecht.properties");
        ConverterForm.this.templateDefaultsGeenBestaansrechtTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/4-default-zonder-bestaansrecht.properties");
        ConverterForm.this.templateStructuurTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/5-structuur-mapping.properties");
        ConverterForm.this.templateMappingTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/6-nieuw-oud-mapping.properties");
        ConverterForm.this.templateNieuwTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/7-nieuwe-tags-lijst.txt");
        ConverterForm.this.outputFolderTextField.setText("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/BMR26Conversie/" + soortBevraging.getMapnaam() + "/output/");
        //NASTY HACK :)
    ...
    private void initializeInteractiveComponents() {
