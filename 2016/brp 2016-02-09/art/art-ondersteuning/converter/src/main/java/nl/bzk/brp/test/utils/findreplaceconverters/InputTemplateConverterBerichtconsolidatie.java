...
public class InputTemplateConverterBerichtconsolidatie {

    public static void main(final String[] args) throws Exception {
        new InputTemplateConverterBerichtconsolidatie().startConversie();
    }

    private List<Map.Entry<String, String>> findReplaceValues;

    public InputTemplateConverterBerichtconsolidatie() throws Exception {
        findReplaceValues = ConverterConfiguratie.maakCustomPropertyMap(
                new File("D:/Werk/QSD/mGBA/Eclipse Workspace/art-utils-trunk/utils/converter/src/test/resources/Berichtconsolidatie/find-replace-template.properties"));
    }

    public void startConversie() throws Exception {
        String pad = "D:/Werk/QSD/mGBA/Eclipse Workspace/art-resources-trunk/resources/RequestTemplates";
