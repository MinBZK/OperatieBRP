...
public class ResultaatForm extends JFrame {
    ...
    private JScrollPane geconverteerdeBestandenPane;
    ...
    public void vulTabellen(final ConverterResultaat resultaat) {
        if (resultaat != null) {
            this.vulGeconverteerdeBestanden(resultaat);
    ...
    private void vulGeconverteerdeBestanden(final ConverterResultaat resultaat) {
        Object[] columnNames = new String[] {"Bestandsnaam", "XSD validiteit"};
        Object[][] rowData = new Object[resultaat.getGeconverteerdeBestanden().size()][2];
        int index = 0;
        for (Map.Entry<String, String> geconverteerdBestand : resultaat.getGeconverteerdeBestanden().entrySet()) {
            rowData[index][0] = geconverteerdBestand.getKey();
            rowData[index][1] = geconverteerdBestand.getValue();
            index++;
        }
        JTable tabel = new JTable(rowData, columnNames);
        tabel.getColumnModel().getColumn(1).setPreferredWidth(450);
        geconverteerdeBestandenPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        geconverteerdeBestandenPane.setViewportView(tabel);
    }
    ...
    private void initializeBasicComponents() {
        ...
        label0.setText("Geconverteerde bestanden");
        ...
        geconverteerdeBestandenPane = new JScrollPane();
        geconverteerdeBestandenPane.setMinimumSize(new Dimension(900, 150));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.weightx = 99;
        gbc.fill = GridBagConstraints.BOTH;
        mainPanel.add(geconverteerdeBestandenPane, gbc);
