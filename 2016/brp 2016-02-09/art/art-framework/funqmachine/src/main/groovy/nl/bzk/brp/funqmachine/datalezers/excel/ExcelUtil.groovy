...
class ExcelUtil {
    ...
    /**
     * Check of een waarde een referentie is naar een andere cel.
     *
     * @param waarde de waarde om te verifieren
     * @return {@code true} als het een referentie is, anders {@code false}
     */
    static boolean isCellReferentie(final String waarde) {
        return waarde.matches(~/^\$?[A-Z]+\$?[0-9]+$/)
    }
}
