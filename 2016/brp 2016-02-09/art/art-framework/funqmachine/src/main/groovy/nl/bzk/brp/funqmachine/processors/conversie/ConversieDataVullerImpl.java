...
/**
 * Deze implementatie is afgeleid van code geschreven door migratie
 * (migr-test-levering / LeveringMutatieberichtTestCasus.java).
 */
@Service
public class ConversieDataVullerImpl implements ConversieDataVuller {
     ...
     */
    @Override
    @Transactional(transactionManager = "syncDalTransactionManager", propagation = Propagation.NEVER)
    public PersoonslijstPersisteerResultaat converteerInitieleVullingPL(final File persoonFile)
    ...
    @Override
    @Transactional(transactionManager = "syncDalTransactionManager", propagation = Propagation.NEVER)
    public PersoonslijstPersisteerResultaat converteerSyncPL(final File persoonFile)
        throws IOException, ExcelAdapterException, Lo3SyntaxException, OngeldigePersoonslijstException
    {
    ...
    /**
     * Converteer een PL file met daarin initiele vulling kolom (0)
     * en 0 of * sync kolommen.
     *
     * @param persoonFile persoon file
     * @return the persoonslijst persisteer resultaat
     * @throws IOException iO exception
    ...
    /**
     * Converteer persoonslijst persisteer resultaat.
     *
     * @param excelData excel data
     * @param bron      bron
     * @return persoonslijst persisteer resultaat
     * @throws IOException                     io exception
     * @throws ExcelAdapterException           excel adapter exception
     * @throws Lo3SyntaxException              lo 3 syntax exception
     * @throws OngeldigePersoonslijstException ongeldige persoonslijst exception
     */
    public PersoonslijstPersisteerResultaat converteer(final ExcelData excelData, final Lo3BerichtenBron bron)
        throws IOException, ExcelAdapterException, Lo3SyntaxException, OngeldigePersoonslijstException
    {
