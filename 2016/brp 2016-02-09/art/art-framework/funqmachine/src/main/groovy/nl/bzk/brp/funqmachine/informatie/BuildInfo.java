...
public class BuildInfo {
    ...
    public String getReleaseLabel() {
        return BUILD_PROPERTIES.getProperty("FunqMachine-Version", "unknown");
    }
    ...
    public String getBuildRevision() {
        return BUILD_PROPERTIES.getProperty("FunqMachine-Revision", "unknown");
    }
    ...
    public String getBuildTime() {
        return BUILD_PROPERTIES.getProperty("FunqMachine-Build-Time", "unknown");
    }
