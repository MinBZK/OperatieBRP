...
/**
 * An implementation of the {@link nl.bzk.brp.funqmachine.wachttijd.Wait} interface that may have its timeout and polling interval configured on the fly.
 * <p/>
 * <p/>
 ...
 * Furthermore, the user may configure the wait to ignore specific types of exceptions whilst waiting, such as {@code
 * org.openqa.selenium.NoSuchElementException} when searching for an element on the page.
 * <p/>
 * <p/>
...
public class FluentWait<T> implements Wait<T> {
     ...
     * <p/>
     * <p/>
     * In reality, the interval may be greater as the cost of actually evaluating a condition function is not factored in. The default polling interval is
    ...
    /**
     * Configures this instance to ignore specific types of exceptions while waiting for a condition. Any exceptions not whitelisted will be allowed to
     * propagate, terminating the wait.
     *
    ...
    /**
     * Repeatedly applies this instance's input value to the given function until one of the following occurs: <ol> <li>the function returns neither null
     * nor false,</li> <li>the function throws an unignored exception,</li> <li>the timeout expires, <li> <li>the current thread is interrupted</li> </ol>
     *
     * @param isTrue the parameter to pass to the {@link ExpectedSqlCondition}
     * @param <V>    The function's expected return type.
     * @return The functions' return value if the function returned something different from null or false before the timeout expired.
     * @throws TimeoutException If the timeout expires.
     */
    public <V> V until(Function<? super T, V> isTrue) {
        ...
        while (true) {
            ...
            try {
                ...
                throw new WachttijdException(e);
            }
        }
    }
    ...
    /**
     * Throws a timeout exception. This method may be overridden to throw an exception that is idiomatic for a particular test infrastructure, such as an
