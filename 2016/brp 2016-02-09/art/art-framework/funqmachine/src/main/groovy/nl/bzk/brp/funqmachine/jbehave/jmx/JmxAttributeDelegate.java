 ...
 */
public class JmxAttributeDelegate extends JmxDelegate {
    ...
    protected Object execute(final MBeanServerConnection mBeanServerConnection,
        ...
        throws MalformedObjectNameException, MBeanException, IOException, ReflectionException,
        InstanceNotFoundException, AttributeNotFoundException {

        return mBeanServerConnection.getAttribute(
            new ObjectName(jmxCommand.getJMXObjectName()), jmxCommand.getAttributeName());
    }
}
