 ...
 *
 */
class OnderzoekGewijzigdHandler extends AbstractGebeurtenisHandler {
    ...
    OnderzoekGewijzigdHandler(final GebeurtenisAttributen attr, final PersoonHisVolledigImplBuilder b) {
        super(attr, b)
