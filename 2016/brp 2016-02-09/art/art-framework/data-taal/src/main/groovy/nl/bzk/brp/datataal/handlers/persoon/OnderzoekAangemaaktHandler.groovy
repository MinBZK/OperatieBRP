 ...
 *
 */
class OnderzoekAangemaaktHandler extends AbstractGebeurtenisHandler {
    ...
    OnderzoekAangemaaktHandler(final GebeurtenisAttributen attr, final PersoonHisVolledigImplBuilder b) {
        super(attr, b)
