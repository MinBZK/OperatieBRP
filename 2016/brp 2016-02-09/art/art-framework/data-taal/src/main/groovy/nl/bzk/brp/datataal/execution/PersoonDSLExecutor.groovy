...
/**
 * Specifieke implementatie van {@link DSLExecutor} die de GroovyShell
...
class PersoonDSLExecutor extends DSLExecutor {
    ...
    /**
     * Constructor met applicatieserver tijd.
     */
    PersoonDSLExecutor(final Date applicatieServerTijd) {
        super(compilerConfiguration(), binding())
        ApplicatieServerTijdThreadLocal.set(applicatieServerTijd);
    }
