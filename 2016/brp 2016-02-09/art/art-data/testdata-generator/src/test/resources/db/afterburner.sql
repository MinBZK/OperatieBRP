...
SELECT SETVAL('prot.seq_abonnement', (select 1+ coalesce(max(id),0)  FROM "prot"."abonnement"), true);
SELECT SETVAL('prot.seq_abonnementgegevenselement', (select 1+ coalesce(max(id),0)  FROM "prot"."abonnementgegevenselement"), true);
SELECT SETVAL('prot.seq_abonnementsrtber', (select 1+ coalesce(max(id),0)  FROM "prot"."abonnementsrtber"), true);
...
SELECT SETVAL('prot.seq_his_abonnement', (select 1+ coalesce(max(id),0)  FROM "prot"."his_abonnement"), true);
SELECT SETVAL('prot.seq_his_abonnementsrtber', (select 1+ coalesce(max(id),0)  FROM "prot"."his_abonnementsrtber"), true);
...
SELECT SETVAL('prot.seq_levsaantek', (select 1+ coalesce(max(id),0)  FROM "prot"."lev"), true);
SELECT SETVAL('prot.seq_levsaantekpers', (select 1+ coalesce(max(id),0)  FROM "prot"."levpers"), true);
