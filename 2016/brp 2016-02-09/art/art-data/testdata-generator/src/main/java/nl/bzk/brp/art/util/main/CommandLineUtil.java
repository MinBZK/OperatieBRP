...
public final class CommandLineUtil {
    ...
    /** . */
    public static final char OPTION_INPUT = 'i';
    /** . */
    public static final char OPTION_OUTPUT = 'o';
    ...
    public static Options createOptions() {
        ...
        optionGroep.addOption(OptionBuilder
                ...
                .withDescription("commando voor backup. Maakt een logische backup van een net "
                        ...
                        + "verplichte parameters [-d, -u, -p [,-i, -o]].\n"
                )
                .create('b'));
    ...
    public static void printUsage(final Options options) {
        ...
        formatter.printHelp("DataGenerator parameters: {-c | -b} [options] \n"
            + " -c commando voor conversie; Leest een of meerdere excel bestanden en genereert een sql waarmee de "
            + " database gevuld kan worden.\n"
