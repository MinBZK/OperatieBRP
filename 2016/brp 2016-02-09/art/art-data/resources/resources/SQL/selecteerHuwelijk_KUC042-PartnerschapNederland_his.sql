SELECT p.id as P_ID, p.bsn as P_BSN, b.id as BETR_ID, hb.id as HIS_BETR_ID, sb.code as BETR_CODE, r.id as RELATIE_ID, hr.id as HIS_RELATIE_ID, sr.code as RELATIE_CODE
FROM kern.pers p
...
WHERE b.rol = (SELECT id FROM kern.srtbetr WHERE code = 'P')
