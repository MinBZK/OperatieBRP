...
WHERE (p.bsn = ${DataSource Values#burgerservicenummer_ipp0}
OR p.bsn = ${DataSource Values#burgerservicenummer_ipp1})
AND ad.srt = (SELECT id FROM kern.srtadmhnd WHERE naam = 'Voltrekking huwelijk in Nederland')
