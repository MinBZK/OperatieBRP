...
where
	...
	(pers.bsn = ${DataSource Values#burgerservicenummer_B00} or
	 pers.bsn= ${DataSource Values#|objectid.burgerservicenummer_ipo_B01|} or pers.bsn= ${DataSource Values#|objectid.burgerservicenummer_ipo_B03|})
