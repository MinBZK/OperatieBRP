...
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 1, e.id, 4 from autaut.expressie e ;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 4, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 5, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 6, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 7, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 8, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 9, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 10, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 11, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 12, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 13, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 14, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 15, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 16, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 17, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 18, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 19, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 20, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 21, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 22, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 23, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 24, e.id, 4 from autaut.expressie e;
insert into autaut.abonnementexpressie (abonnement, expressie, toestand) select 25, e.id, 4 from autaut.expressie e;
