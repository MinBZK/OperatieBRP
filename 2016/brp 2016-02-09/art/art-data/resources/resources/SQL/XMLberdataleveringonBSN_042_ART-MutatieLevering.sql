...
where 
    ...
    and (berpers.pers = persoon_id_voor_bsn(${DataSource Values#burgerservicenummer_ipp0}) or berpers.pers = persoon_id_voor_bsn(${DataSource Values#burgerservicenummer_ipp1}))
