...
Scenario: 1. DatumAanvangMaterielePeriode = 2012/05/15, DatumEindeGeldigheid = 20120400: niet alle voorkomens adres groep wordt geleverd
...
Given de personen 363078319 zijn verwijderd
...
testpersoon = uitGebeurtenissen {
    geboorte(partij: 34401, aanvang: 19930916, toelichting: '1e kind', registratieDatum: 19930916) {
        ...
        identificatienummers bsn: 363078319, anummer: 1523109458
    }
...
And testdata uit bestand datum_einde_geldigheid_onbekend_groepen_niet_geleverd_01.yml
When het bericht wordt verstuurd
Then heeft het antwoordbericht verwerking Geslaagd
...
| adres | 1      | datumAanvangGeldigheid | 2012-04         |
...
Scenario: 4. DatumAanvangMaterielePeriode = 2012/05/15, DatumEindeGeldigheid = 20110000: niet alle voorkomens adres groep wordt geleverd
...
testpersoon = uitGebeurtenissen {
    ...
    verhuizing(partij: 'Gemeente Hillegom', aanvang: 20110000, registratieDatum: 20111212) {
            naarGemeente 'Hillegom',
                straat: 'Dorpsstraat', nummer: 25, postcode: '2180AA', woonplaats: "Hillegom"
    }
...
Then hebben attributen in voorkomens de volgende waardes:
| groep | nummer | attribuut              | verwachteWaarde |
| adres | 1      | datumAanvangGeldigheid | 2011            |
| adres | 2      | datumAanvangGeldigheid | 1993-09-16      |
