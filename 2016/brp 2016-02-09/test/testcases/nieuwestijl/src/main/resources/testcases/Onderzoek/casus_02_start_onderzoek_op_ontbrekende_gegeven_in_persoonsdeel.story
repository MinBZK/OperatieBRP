...
@sleutelwoorden         onderzoek,casus2
@status                 Klaar
@regels                 R2063,R2065

Narrative: Casus 2. Een administratieve handeling die een ontbrekend gegeven in onderzoek plaatst.

Scenario: 1. Onderzoek gestart op een ontbrekende gegeven in persoonsdeel (olivia is niet getrouwd), er wordt NIET geleverd
