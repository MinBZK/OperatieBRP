...
Narrative:  Alle Gegeven in onderzoek, waarvoor geldt dat deze GEEN Gegeven in onderzoek.Object sleutel gegeven én GEEN Gegeven in onderzoek.
            Voorkomen sleutel gegeven bevatten (dus alleen een verwijzing naar Gegeven in onderzoek.Element) moeten worden verwijderd als er wordt geleverd aan een afnemer.

Scenario: R2065_01. Onderzoek gestart op een ontbrekende gegeven in persoonsdeel (olivia is niet getrouwd), er wordt NIET geleverd
            Logisch Testgeval: R2065_01
            Verwacht Resultaat: Geen mutatie levering, onderzoek gestart op een gegeven dat niet aanwezig is op de persoonslijst
...
Scenario: R2065_02. Beeindiging onderzoek naar een ontbrekend gegeven, er wordt NIET geleverd
            Logisch Testgeval: R2065_02
            Verwacht Resultaat: Geen mutatie bericht

Given leveringsautorisatie uit /levering_autorisaties/geen_pop_bep_levering_op_basis_van_doelbinding
Given de persoon beschrijvingen:
persoon = Persoon.metBsn(411372233)
nieuweGebeurtenissenVoor(persoon) {
   onderzoekBeeindigd(partij: 34401, registratieDatum: 20151012) {
...
Scenario: R2065_03. start een onderzoek op een bestaand gegeven, dat is beeindigd. De afnemer heeft geen autorisatie op materiele historie op deze groep
            Logisch Testgeval: R2065_03
            Verwacht Resultaat: Leveringsautorisatie zonder materiele historie ontvangt geen mutatie bericht
                                Leveringsautorisatie met materiele historie ontvangt mutatie bericht
...
nieuweGebeurtenissenVoor(persoon) {
    onderzoekAangemaakt(partij: 34401, registratieDatum: 20090101) {
...
And testdata uit bestand R2065_synchronisatie_01.yml
...
Scenario: R2065_04. leveren (zonder onderzoek) er wordt een VolledigBericht opgevraagd, waarin zich een onderzoek bevindt dat betrekking heeft op een vervallen gegeven. De afnemer is niet geautoriseerd voor formele historie op de groep waarvan het vervallen gegeven in onderzoek staat
            Logisch Testgeval: R2065_04
            Verwacht Resultaat: Leveringsautorisatie zonder materiele historie ontvangt geen mutatie bericht
                                Leveringsautorisatie met materiele historie ontvangt mutatie bericht

Given leveringsautorisatie uit /levering_autorisaties/Abo_met_alleen_verantwoordingsinfo_True
Given alle personen zijn verwijderd
Given een sync uit bestand R2065_DELTAONDC40T50.xls
When voor persoon 651919113 wordt de laatste handeling geleverd

Given verzoek voor leveringsautorisatie 'Abo met alleen verantwoordingsinfo True' en partij 'Gemeente Utrecht'
Given verzoek van bericht lvg_synGeefSynchronisatiePersoon
And testdata uit bestand R2065_synchronisatie_02.yml
When het bericht wordt verstuurd
Then heeft het antwoordbericht verwerking Geslaagd
...
Scenario: R2065_05A niet leveren, er is sprake van een bestaand onderzoek op een actueel gegeven.
            ...
            Logisch Testgeval: R2065_05
            Verwacht Resultaat: Beeindigd onderzoek naar vervallen gegeven wordt niet geleverd aan afnemer zonder autorisatie
...
Scenario: R2065_05B. Verhuizing, zodat het onderzoek naar een vervallen adres wijst
            Logisch Testgeval: R2065_05
            Verwacht Resultaat: Beeindigd onderzoek naar vervallen gegeven wordt niet geleverd aan afnemer zonder autorisatie
...
Scenario: R2065_05C Onderzoek naar vervallen gegeven beeindigen
            Logisch Testgeval: R2065_05
            Verwacht Resultaat: Beeindigd onderzoek naar vervallen gegeven wordt niet geleverd aan afnemer zonder autorisatie voor historie

Given leveringsautorisatie uit /levering_autorisaties/geen_pop_bep_levering_op_basis_van_doelbinding, /levering_autorisaties/Abo_met_alleen_verantwoordingsinfo_True
Given de persoon beschrijvingen:
persoon = Persoon.metBsn(891833225)
nieuweGebeurtenissenVoor(persoon) {
    onderzoekBeeindigd(partij: 34401, registratieDatum: 20141212) {
...
Scenario: R2065_06. Volledig bericht opvragen voor een persoon met een beeindigd onderzoek naar een vervallen gegeven
            Logisch Testgeval: R2065_06
            Verwacht Resultaat: Leveringsautorisatie zonder materiele historie ontvangt volledig bericht zonder onderzoek
                                Leveringsautorisatie met materiele historie ontvangt bericht met onderzoek

Given leveringsautorisatie uit /levering_autorisaties/geen_pop_bep_levering_op_basis_van_doelbinding, /levering_autorisaties/Abo_met_alleen_verantwoordingsinfo_True

Given verzoek voor leveringsautorisatie 'Abo met alleen verantwoordingsinfo True' en partij 'Gemeente Utrecht'
Given verzoek van bericht lvg_synGeefSynchronisatiePersoon
And testdata uit bestand R2065_synchronisatie_03.yml
When het bericht wordt verstuurd
Then heeft het antwoordbericht verwerking Geslaagd
