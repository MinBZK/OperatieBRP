...
Scenario: 3.1   Succesvol uitvoeren geefSynchronisatieStamgegevens
                Een element verwijderen uit de totale tobel
...
Given de database is aangepast met: update kern.element set leverenalsstamgegeven = NULL where element.id=3010
