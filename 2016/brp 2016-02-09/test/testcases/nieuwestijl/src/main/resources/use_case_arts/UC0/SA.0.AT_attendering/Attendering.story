...
Narrative:
        ...
        Log melding bij scenario 4: Populatiebeperking evalueert naar waarde NULL (onbekend) voor abonnement: 'Attendering populatiebeperking op basis van geboortedatum' en persoon met id: 2129331
...
Given relevante abonnementen Attendering populatiebeperking op basis van geboortedatum
...
Given de database is aangepast met: update autaut.abonnement set datingang ='${vandaagsql()}' where naam = 'Attendering populatiebeperking op basis van geboortedatum'
Given relevante abonnementen Attendering populatiebeperking op basis van geboortedatum
Given de database is aangepast met: update autaut.abonnement set datingang = 20130101 where naam = 'Attendering populatiebeperking op basis van geboortedatum'
...
When volledigbericht voor abonnement Attendering populatiebeperking op basis van geboortedatum wordt bekeken
Then is er geen synchronisatiebericht gevonden

When mutatiebericht voor abonnement Attendering populatiebeperking op basis van geboortedatum wordt bekeken
Then is er geen synchronisatiebericht gevonden
...
Given de database is aangepast met: update autaut.abonnement set dateinde ='${vandaagsql()}' where naam = 'Attendering populatiebeperking op basis van geboortedatum'
Given relevante abonnementen Attendering populatiebeperking op basis van geboortedatum
Given de database is aangepast met: update autaut.abonnement set dateinde = NULL where naam = 'Attendering populatiebeperking op basis van geboortedatum'
...
Given de database is aangepast met: update autaut.abonnement set datingang = '${vandaagsql(0,0,1)}' where naam = 'Attendering populatiebeperking op basis van geboortedatum'
Given relevante abonnementen Attendering populatiebeperking op basis van geboortedatum
Given de database is aangepast met: update autaut.abonnement set datingang = 20130101 where naam = 'Attendering populatiebeperking op basis van geboortedatum'
...
Given de database is aangepast met: update autaut.abonnement set dateinde = '${vandaagsql(0,0,-1)}' where naam='Attendering populatiebeperking op basis van geboortedatum'
...
Given relevante abonnementen attendering obv wijziging in relatiegegevens - huwelijk
...
| relatie | 1      | datumAanvang | 2015-05-01      |
...
Given relevante abonnementen attendering obv wijziging in relatiegegevens - geslachtsnaam
...
Given de database is aangepast met: update autaut.dienst set attenderingscriterium =NULL where id=138
Given relevante abonnementen Attendering populatiebeperking op basis van geboortedatum
Given de database is aangepast met: update autaut.dienst set attenderingscriterium = 'WAAR' where id=138
