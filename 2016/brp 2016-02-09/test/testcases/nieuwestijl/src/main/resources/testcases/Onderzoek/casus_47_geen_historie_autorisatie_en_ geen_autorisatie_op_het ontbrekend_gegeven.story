...
@sleutelwoorden         onderzoek,casus47
@status                 Klaar
@regels                 R1549,R1561

Narrative: Casus 47: Volledig bericht met een onderzoek op een beëindigd en een vervallen gegeven,
           alsmede een onderzoek op een ontbrekend gegeven.
...
Given leveringsautorisatie uit /levering_autorisaties/Abo_geen_materiele-formele_historie_en_geen_verantwoording
Given verzoek voor leveringsautorisatie 'Abo geen materiele - formele historie en geen verantwoording' en partij 'Gemeente Utrecht'
