...
/**
 */
public final class GroepIndentificatienummerMapper extends AbstractGroepMapper<HisPersoonIdentificatienummersModel, ObjectPersoonMapper> {
    ...
    @Override
    protected HistorieSet<HisPersoonIdentificatienummersModel> geefHistorieSet(final ObjectPersoonMapper objectMapper) {
