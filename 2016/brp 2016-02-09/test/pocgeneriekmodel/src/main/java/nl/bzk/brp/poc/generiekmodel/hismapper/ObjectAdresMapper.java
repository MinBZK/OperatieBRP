 ...
 */
class ObjectAdresMapper extends AbstractObjectMapper<PersoonAdresHisVolledigImpl> {

    /**
     *
     * @param mappedObject
     */
    protected ObjectAdresMapper(final PersoonAdresHisVolledigImpl mappedObject) {
        super(mappedObject);
    }

    @Override
    public ElementObjectType geefObjectType() {
        return ElementObjectType.PersoonAdres;
    }
