...
public class AdresLookup {
	...
	for (int i = 2; i < sheet.getRows(); i++) {
	    ...
	    adresDTO.woonplaatsNaam = row[3].getContents();
	...
	public String gemCode, straatKort, straatLang, huisNr, postcode, woonplaatsNaam;


	@Override
	public String toString() {
	    return "gemCode=" + gemCode + ", straatKort=" + straatKort + ", straatLang=" + straatLang + ", huisNr="
                + huisNr + ", postcode=" + postcode + "";
	}
    }
