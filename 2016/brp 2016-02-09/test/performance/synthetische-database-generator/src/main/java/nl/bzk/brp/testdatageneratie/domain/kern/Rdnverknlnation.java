 ...
 */
public class Rdnverknlnation  implements nl.bzk.brp.testdatageneratie.dataaccess.Cacheable<Short>,java.io.Serializable {
    ...
    public Rdnverknlnation(short id, short code, String oms) {
        this.id = id;
        this.code = code;
        this.oms = oms;
    }
    public Rdnverknlnation(short id, short code, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.code = code;
       this.oms = oms;
