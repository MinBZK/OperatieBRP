 ...
 */
public class HisUitgeslotene  implements java.io.Serializable {


     private int id;
     private int uitgeslotene;
     private Date tsreg;
    ...
    public HisUitgeslotene(int id, int uitgeslotene) {
        this.id = id;
        this.uitgeslotene = uitgeslotene;
    }
    public HisUitgeslotene(int id, int uitgeslotene, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval) {
       this.id = id;
       this.uitgeslotene = uitgeslotene;
       this.tsreg = tsreg;
    ...
    public int getUitgeslotene() {
        return this.uitgeslotene;
    }
    
    public void setUitgeslotene(int uitgeslotene) {
        this.uitgeslotene = uitgeslotene;
    }
