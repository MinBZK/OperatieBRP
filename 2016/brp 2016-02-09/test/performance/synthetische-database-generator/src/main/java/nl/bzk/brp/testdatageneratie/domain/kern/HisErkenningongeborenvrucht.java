 ...
 */
public class HisErkenningongeborenvrucht  implements His,IntegerAsPrimaryKey,java.io.Serializable {
    ...
    public HisErkenningongeborenvrucht(int id, int relatie, int daterkenningongeborenvrucht) {
        this.id = id;
        this.relatie = relatie;
        this.daterkenningongeborenvrucht = daterkenningongeborenvrucht;
    }
    public HisErkenningongeborenvrucht(int id, int relatie, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, int daterkenningongeborenvrucht) {
       this.id = id;
       this.relatie = relatie;
       this.tsreg = tsreg;
