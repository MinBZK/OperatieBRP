 ...
 */
public class HisPersverblijfsr  implements HisMaterieel,IntegerAsPrimaryKey,java.io.Serializable {
     ...
     private int datmededelingverblijfsr;
    ...
    public HisPersverblijfsr(int id, int pers, short aandverblijfsr, int datmededelingverblijfsr) {
        this.id = id;
        this.pers = pers;
        this.aandverblijfsr = aandverblijfsr;
        this.datmededelingverblijfsr = datmededelingverblijfsr;
    }
    public HisPersverblijfsr(int id, int pers, Integer dataanvgel, Integer dateindegel, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, Long actieaanpgel, short aandverblijfsr, int datmededelingverblijfsr, Integer datvoorzeindeverblijfsr) {
       this.id = id;
       this.pers = pers;
    ...
    public int getDatmededelingverblijfsr() {
        return this.datmededelingverblijfsr;
    }
    
    public void setDatmededelingverblijfsr(int datmededelingverblijfsr) {
        this.datmededelingverblijfsr = datmededelingverblijfsr;
    }
