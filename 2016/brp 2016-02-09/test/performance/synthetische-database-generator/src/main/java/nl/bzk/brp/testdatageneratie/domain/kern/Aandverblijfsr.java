...
/**
 * Aandverblijfsr generated by hbm2java
 */
public class Aandverblijfsr  implements nl.bzk.brp.testdatageneratie.dataaccess.Cacheable<Short>,java.io.Serializable {
    ...
    public Aandverblijfsr() {
    }

	
    public Aandverblijfsr(short id, short code, String oms) {
        this.id = id;
        this.code = code;
        this.oms = oms;
    }
    public Aandverblijfsr(short id, short code, String oms, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.code = code;
       this.oms = oms;
