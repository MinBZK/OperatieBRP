...
/**
 * HisToegangabonnement generated by hbm2java
 */
public class HisToegangabonnement  implements java.io.Serializable {
    ...
    public HisToegangabonnement() {
    }

	
    public HisToegangabonnement(int id, int toegangabonnement, int datingang) {
        this.id = id;
        this.toegangabonnement = toegangabonnement;
        this.datingang = datingang;
    }
    public HisToegangabonnement(int id, int toegangabonnement, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, int datingang, Integer dateinde) {
       this.id = id;
       this.toegangabonnement = toegangabonnement;
       this.tsreg = tsreg;
