...
/**
 * Csv proc his persnation.
 */
public class CsvProcHisPersnation extends AbstractCsvProc<HisPersnation> {

    private static final String CSV_FILENAME = "kern.his_persnation.csv";

    // volgorde van velden in de csv bestand moet overeenkomen met de volgorde van de processoren.
    private static final CellProcessor[] PROCESSORS = new CellProcessor[] {
            new ParseInt(),     // id
            new ParseInt(),     // persnation
    ...
    @Override
    public Class<HisPersnation> getLoadingClass() {
        return HisPersnation.class;
    }
}
