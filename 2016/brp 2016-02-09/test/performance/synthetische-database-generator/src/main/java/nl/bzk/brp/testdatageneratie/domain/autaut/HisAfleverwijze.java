...
/**
 * HisAfleverwijze generated by hbm2java
 */
public class HisAfleverwijze  implements java.io.Serializable {


     private int id;
     private int afleverwijze;
     private Date tsreg;
    ...
    public HisAfleverwijze() {
    }

	
    public HisAfleverwijze(int id, int afleverwijze, int datingang) {
        this.id = id;
        this.afleverwijze = afleverwijze;
        this.datingang = datingang;
    }
    public HisAfleverwijze(int id, int afleverwijze, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, int datingang, Integer dateinde) {
       this.id = id;
       this.afleverwijze = afleverwijze;
       this.tsreg = tsreg;
    ...
    public int getAfleverwijze() {
        return this.afleverwijze;
    }
    
    public void setAfleverwijze(int afleverwijze) {
        this.afleverwijze = afleverwijze;
    }
