...
/**
 * Csv proc his persgeslachtsaand.
 */
public class CsvProcHisPersgeslachtsaand extends AbstractCsvProc<HisPersgeslachtsaand> {

    private static final String CSV_FILENAME = "kern.his_persgeslachtsaand.csv";
    ...
    @Override
    public Class<HisPersgeslachtsaand> getLoadingClass() {
        return HisPersgeslachtsaand.class;
    }
}
