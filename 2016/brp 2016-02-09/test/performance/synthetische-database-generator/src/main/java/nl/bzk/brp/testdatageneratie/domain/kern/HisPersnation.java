 ...
 */
public class HisPersnation  implements HisMaterieel,IntegerAsPrimaryKey,java.io.Serializable {


     private int id;
     private int persnation;
    ...
    public HisPersnation(int id, int persnation) {
        this.id = id;
        this.persnation = persnation;
    }
    public HisPersnation(int id, int persnation, Integer dataanvgel, Integer dateindegel, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, Long actieaanpgel, Short rdnverk, Short rdnverlies) {
       this.id = id;
       this.persnation = persnation;
    ...
    public int getPersnation() {
        return this.persnation;
    }
    
    public void setPersnation(int persnation) {
        this.persnation = persnation;
    }
