 ...
 */
public class HisPersgeslachtsaand  implements HisMaterieel,IntegerAsPrimaryKey,java.io.Serializable {
    ...
    public HisPersgeslachtsaand(int id, int pers, short geslachtsaand) {
        this.id = id;
        this.pers = pers;
        this.geslachtsaand = geslachtsaand;
    }
    public HisPersgeslachtsaand(int id, int pers, Integer dataanvgel, Integer dateindegel, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, Long actieaanpgel, short geslachtsaand) {
       this.id = id;
       this.pers = pers;
