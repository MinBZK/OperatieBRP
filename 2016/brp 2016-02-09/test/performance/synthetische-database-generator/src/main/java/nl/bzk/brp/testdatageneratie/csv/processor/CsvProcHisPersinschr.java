...
/**
 * Csv proc his persinschr.
 */
public class CsvProcHisPersinschr extends AbstractCsvProc<HisPersinschr> {

    private static final String CSV_FILENAME = "kern.his_persinschr.csv";
...
//            new Optional(new ParseInt()),     // dateindegel
            ...
            new ParseDate("yyyyMMdd"), // dattijdstempel
    };
    ...
    @Override
    public Class<HisPersinschr> getLoadingClass() {
        return HisPersinschr.class;
    }
}
