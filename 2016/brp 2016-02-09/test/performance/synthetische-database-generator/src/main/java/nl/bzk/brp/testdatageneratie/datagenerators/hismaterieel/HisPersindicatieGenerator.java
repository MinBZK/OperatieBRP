...
public class HisPersindicatieGenerator extends HisMaterieelGenerator<Persindicatie, HisPersindicatie>{
    ...
    @Override
    public HisPersindicatie generateHisMaterieel(final Persindicatie actueel, final boolean newCopy) {
        HisPersindicatie his = new HisPersindicatie();
        his.setPersindicatie(actueel.getId());
