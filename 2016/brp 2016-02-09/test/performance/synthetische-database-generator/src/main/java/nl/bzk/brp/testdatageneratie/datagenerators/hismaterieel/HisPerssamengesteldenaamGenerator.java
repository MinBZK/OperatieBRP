...
public class HisPerssamengesteldenaamGenerator extends HisMaterieelGenerator<Pers, HisPerssamengesteldenaam> {
    ...
    @Override
    public HisPerssamengesteldenaam generateHisMaterieel(final Pers actueel, final boolean newCopy) {
        HisPerssamengesteldenaam his = new HisPerssamengesteldenaam();
        his.setPers(actueel.getId());
        his.setGeslnaamstam(actueel.getGeslnaamstam());
        his.setIndafgeleid(actueel.getIndafgeleid());
