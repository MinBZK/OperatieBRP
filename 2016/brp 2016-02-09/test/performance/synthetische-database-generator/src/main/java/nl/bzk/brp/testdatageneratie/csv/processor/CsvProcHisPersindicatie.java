...
/**
 * Csv proc his persindicatie.
 */
public class CsvProcHisPersindicatie extends AbstractCsvProc<HisPersindicatie> {

    private static final String CSV_FILENAME = "kern.his_persindicatie.csv";

    // volgorde van velden in de csv bestand moet overeenkomen met de volgorde van de processoren.
    private static final CellProcessor[] PROCESSORS = new CellProcessor[] {
            new ParseInt(),     // id
            new ParseInt(),     // persindicatie
    ...
    @Override
    public Class<HisPersindicatie> getLoadingClass() {
        return HisPersindicatie.class;
    }
}
