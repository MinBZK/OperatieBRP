...
/**
 * Auttypevanafgiftereisdoc generated by hbm2java
 */
public class Auttypevanafgiftereisdoc  implements nl.bzk.brp.testdatageneratie.dataaccess.Cacheable<String>,java.io.Serializable {
    ...
    public Auttypevanafgiftereisdoc() {
    }

	
    public Auttypevanafgiftereisdoc(short id, String code, String naam) {
        this.id = id;
        this.code = code;
        this.naam = naam;
    }
    public Auttypevanafgiftereisdoc(short id, String code, String naam, Integer dataanvgel, Integer dateindegel) {
       this.id = id;
       this.code = code;
       this.naam = naam;
