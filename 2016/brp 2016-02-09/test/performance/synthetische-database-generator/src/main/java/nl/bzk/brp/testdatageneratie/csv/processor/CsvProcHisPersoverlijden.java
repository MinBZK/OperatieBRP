...
/**
 * Csv proc his persoverlijden.
 */
public class CsvProcHisPersoverlijden extends AbstractCsvProc<HisPersoverlijden> {

    private static final String CSV_FILENAME = "kern.his_persoverlijden.csv";
    ...
    @Override
    public Class<HisPersoverlijden> getLoadingClass() {
        return HisPersoverlijden.class;
    }
}
