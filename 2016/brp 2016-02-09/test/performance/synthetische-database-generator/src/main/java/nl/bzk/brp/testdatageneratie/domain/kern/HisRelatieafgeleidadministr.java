...
/**
 * HisRelatieafgeleidadministr generated by hbm2java
 */
public class HisRelatieafgeleidadministr  implements His,IntegerAsPrimaryKey,java.io.Serializable {
    ...
    public HisRelatieafgeleidadministr() {
    }

	
    public HisRelatieafgeleidadministr(int id, int relatie, boolean indasymmetrisch) {
        this.id = id;
        this.relatie = relatie;
        this.indasymmetrisch = indasymmetrisch;
    }
    public HisRelatieafgeleidadministr(int id, int relatie, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, boolean indasymmetrisch) {
       this.id = id;
       this.relatie = relatie;
       this.tsreg = tsreg;
    ...
    public boolean isIndasymmetrisch() {
