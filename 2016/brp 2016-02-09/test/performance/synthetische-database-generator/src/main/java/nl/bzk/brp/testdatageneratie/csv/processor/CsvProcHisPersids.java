...
/**
 * Csv proc his persids.
 */
public class CsvProcHisPersids extends AbstractCsvProc<HisPersids> {

    private static final String CSV_FILENAME = "kern.his_persids.csv";
...
//            new Optional(new ParseLong()),  // actieverval    ?? niet in csv
//            new Optional(new ParseLong()),  // actieaanpgel   ?? niet in csv
    ...
    @Override
    public Class<HisPersids> getLoadingClass() {
        return HisPersids.class;
    }
}
