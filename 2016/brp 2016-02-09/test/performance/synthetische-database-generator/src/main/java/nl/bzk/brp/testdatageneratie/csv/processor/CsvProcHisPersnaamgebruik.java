...
/**
 * Csv proc his persnaamgebruik.
 */
public class CsvProcHisPersnaamgebruik extends AbstractCsvProc<HisPersnaamgebruik> {

    private static final String CSV_FILENAME = "kern.his_persnaamgebruik.csv";
    ...
    private static final CellProcessor[] PROCESSORS = new CellProcessor[] {
            ...
            new Optional(new ParseInt()), // predikaatnaamgebruik
            null,   //voornamennaamgebruik
            null,   // voorvoegselnaamgebruik
            null, // scheidingstekennaamgebruik
            new Optional(new ParseInt()), // adellijketitelnaamgebruik
    ...
    @Override
    public Class<HisPersnaamgebruik> getLoadingClass() {
        return HisPersnaamgebruik.class;
    }
}
