 ...
 */
public class Nation  implements nl.bzk.brp.testdatageneratie.dataaccess.Cacheable<Short>,java.io.Serializable {
    ...
    public Nation(int id, short code, String naam) {
        this.id = id;
        this.code = code;
        this.naam = naam;
    }
...
private static final short CODE_NL = 1; public boolean isNederlandse() { return code == CODE_NL; } @Override public Short
        getKey() { return code; }
