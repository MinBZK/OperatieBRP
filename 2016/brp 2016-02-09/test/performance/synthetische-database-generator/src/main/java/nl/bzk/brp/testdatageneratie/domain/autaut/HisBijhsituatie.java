 ...
 */
public class HisBijhsituatie  implements java.io.Serializable {


     private int id;
     private int bijhsituatie;
     private Date tsreg;
    ...
    public HisBijhsituatie(int id, int bijhsituatie) {
        this.id = id;
        this.bijhsituatie = bijhsituatie;
    }
    public HisBijhsituatie(int id, int bijhsituatie, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval) {
       this.id = id;
       this.bijhsituatie = bijhsituatie;
       this.tsreg = tsreg;
    ...
    public int getBijhsituatie() {
        return this.bijhsituatie;
    }
    
    public void setBijhsituatie(int bijhsituatie) {
        this.bijhsituatie = bijhsituatie;
    }
