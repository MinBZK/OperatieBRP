...
/**
 * HisPartijonderzoek generated by hbm2java
 */
public class HisPartijonderzoek  implements His,IntegerAsPrimaryKey,java.io.Serializable {


     private int id;
     private int partijonderzoek;
     private Date tsreg;
    ...
    public HisPartijonderzoek() {
    }

	
    public HisPartijonderzoek(int id, int partijonderzoek, short rol) {
        this.id = id;
        this.partijonderzoek = partijonderzoek;
        this.rol = rol;
    }
    public HisPartijonderzoek(int id, int partijonderzoek, Date tsreg, Date tsverval, Long actieinh, Long actieverval, String nadereaandverval, short rol) {
       this.id = id;
       this.partijonderzoek = partijonderzoek;
       this.tsreg = tsreg;
    ...
    public int getPartijonderzoek() {
        return this.partijonderzoek;
    }
    
    public void setPartijonderzoek(int partijonderzoek) {
        this.partijonderzoek = partijonderzoek;
    }
