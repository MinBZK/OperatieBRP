...
/**
 * Csv proc his persvoornaam.
 */
public class CsvProcHisPersvoornaam extends AbstractCsvProc<HisPersvoornaam> {

    private static final String CSV_FILENAME = "kern.his_persvoornaam.csv";

    // volgorde van velden in de csv bestand moet overeenkomen met de volgorde van de processoren.
    private static final CellProcessor[] PROCESSORS = new CellProcessor[] {
            new ParseInt(),     // id
            new ParseInt(),     // persvoornaam
    ...
    @Override
    public Class<HisPersvoornaam> getLoadingClass() {
        return HisPersvoornaam.class;
    }
}
