 ...
 */
@Repository
public final class DocumentModelJparepository implements DocumentModelRepository {

    @PersistenceContext(unitName = "nl.bzk.brp.lezenschrijven")
    private EntityManager em;

    @Override
    public DocumentModel slaNieuwDocumentModel(DocumentModel documentModel) {
