...
public class LogischeEnExpressieTest {
    ...
    public LogischeEnExpressieTest(final String op1, final String op2, final String resultaat, final String inverseResultaat) {
        operandLinks = op1;
        operandRechts = op2;
