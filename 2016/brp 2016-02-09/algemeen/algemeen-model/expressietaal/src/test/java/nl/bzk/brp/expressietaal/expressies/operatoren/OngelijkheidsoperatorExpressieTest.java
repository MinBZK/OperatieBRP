...
public class OngelijkheidsoperatorExpressieTest {
    ...
    public OngelijkheidsoperatorExpressieTest(final String op1, final String op2, final String resultaat) {
        operandLinks = op1;
        operandRechts = op2;
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
            // bekende datum
            { "2014/FEB/01", "2014/FEB/01", ONWAAR },
            { "2014/FEB/01", "2014/JAN/31", WAAR },
            { "2014/FEB/01", "2014/FEB/10", WAAR },

            // bekende datum met datumtijd
            { "2014/FEB/01", "2014/FEB/01/12/00/00", ONWAAR },
            { "2014/FEB/01", "2014/JAN/31/12/00/00", WAAR },
            { "2014/FEB/01", "2014/FEB/10/12/00/00", WAAR },

            // onbekende dag vs. bekend
            { "2014/FEB/?", "2014/FEB/01", ONBEKEND },
            { "2014/SEP/?", "2014/SEP/19", ONBEKEND },
            { "2014/FEB/?", "2014/JAN/31", WAAR },
            { "2014/FEB/?", "2014/MRT/01", WAAR },

            // onbekende dag vs. onbekende dag
            { "2014/FEB/?", "2014/FEB/?", ONBEKEND },
            { "2014/FEB/?", "2014/JAN/?", WAAR },
            { "2014/FEB/?", "2014/MRT/?", WAAR },

            // onbekende maand/dag vs. bekend
            { "2014/?/?", "2014/JAN/01", ONBEKEND },
            { "2014/?/?", "2014/SEP/19", ONBEKEND },
            { "2014/?/?", "2015/JAN/01", WAAR },
            { "2014/?/?", "2013/DEC/31", WAAR },
    ...
    @Test
    public void testBooleanCombinatieVan_Ongelijk_en_Gelijk() {
