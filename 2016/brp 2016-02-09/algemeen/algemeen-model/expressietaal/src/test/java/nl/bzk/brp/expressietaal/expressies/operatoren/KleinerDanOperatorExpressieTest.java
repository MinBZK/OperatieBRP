...
public class KleinerDanOperatorExpressieTest {
    ...
    public KleinerDanOperatorExpressieTest(final String op1, final String op2, final String resultaat, final String inverseResultaat) {
        operandLinks = op1;
        operandRechts = op2;
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            { "2014/?/?", "2014/DEC/31", ONBEKEND, ONWAAR },

            { "2014/FEB/?", "2014/FEB/28", ONBEKEND, ONWAAR },
            { "2012/FEB/?", "2012/FEB/28", ONBEKEND, ONBEKEND },
            { "2012/FEB/?", "2012/FEB/29", ONBEKEND, ONWAAR },
            ...
            { "1997/11/13", "1997/12/01", WAAR, ONWAAR },
            { "1997/11/12", "1997/11/10", ONWAAR, WAAR },
        });
    }
    ...
    @Test
    public void testBooleanCombinatieVanKleinerDanEnGroterDanOfGelijk() {
    ...
    @Test
    public void testOmgedraaidBooleanCombinatieVanKleinerDanEnGroterDanOfGelijk() {
