...
public class GroterDanOperatorExpressieTest {
    ...
    public GroterDanOperatorExpressieTest(final String op1, final String op2, final String resultaat, final String inverseResultaat) {
        operandLinks = op1;
        operandRechts = op2;
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            { "2014/FEB/?", "2014/FEB/01", ONBEKEND, ONWAAR },
            ...
            { "2014/?/?", "2014/JAN/01", ONBEKEND, ONWAAR },
    ...
    @Test
    public void testBooleanCombinatieVanGroterDanEnKleinerDanOfGelijk() {
    ...
    @Test
    public void testOmgedraaidBooleanCombinatieVanGroterDanEnKleinerDanOfGelijk() {
