...
import nl.bzk.brp.model.hisvolledig.momentview.kern.OnderzoekView;
import nl.bzk.brp.model.logisch.kern.Onderzoek;

/**
 * Getter voor 'status' in objecttype 'Onderzoek'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OnderzoekStatusGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            final Attribuut attribuut = getAttribuut(brpObject);
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((StatusOnderzoekAttribuut) attribuut).getWaarde().getNaam());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((StatusOnderzoekAttribuut) attribuut).getWaarde().getNaam()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            final Onderzoek v = (Onderzoek) brpObject;
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getStatus();
            }
        } else if (brpObject instanceof OnderzoekHisVolledig) {
            final Onderzoek x = new OnderzoekView((OnderzoekHisVolledig) brpObject, new DatumTijdAttribuut(), new DatumAttribuut());
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getStatus());
            }
        }
        return attributen;
    }
