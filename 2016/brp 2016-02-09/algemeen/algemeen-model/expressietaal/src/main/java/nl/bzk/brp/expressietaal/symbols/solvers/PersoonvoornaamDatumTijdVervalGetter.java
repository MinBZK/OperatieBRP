...
/**
 * Getter voor groepattribuut 'datum_tijd_verval' in objecttype 'HisPersoonVoornaam'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonvoornaamDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaamHisVolledig) {
            ...
            if (v.getPersoonVoornaamHistorie() != null && v.getPersoonVoornaamHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVoornaamHistorie().getActueleRecord().getDatumTijdVerval();
            }
