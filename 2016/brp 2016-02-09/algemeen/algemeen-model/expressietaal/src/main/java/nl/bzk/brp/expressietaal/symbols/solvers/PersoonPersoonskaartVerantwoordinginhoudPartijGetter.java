...
/**
 * Getter voor groepattribuut 'persoonskaart.verantwoordingInhoud.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonPersoonskaartVerantwoordinginhoudPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getPersoonskaart() != null && v.getPersoonskaart().getVerantwoordingInhoud() != null) {
                resultaat = v.getPersoonskaart().getVerantwoordingInhoud().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getVerantwoordingInhoud().getPartij();
            }
        }
        return resultaat;
    }
