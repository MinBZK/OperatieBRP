...
/**
 * Getter voor groepattribuut 'migratie.verantwoordingInhoud.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getMigratie() != null && v.getMigratie().getVerantwoordingInhoud() != null) {
                resultaat = v.getMigratie().getVerantwoordingInhoud().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
