...
public class BetrokkenheidVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof BetrokkenheidHisMoment) {
            ...
            if (v.getBetrokkenheidHistorie() != null
                ...
                && v.getBetrokkenheidHistorie().getActueleRecord().getVerantwoordingVerval() != null)
            {
                resultaat = v.getBetrokkenheidHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
