...
/**
 * Getter voor 'object_sleutel_gegeven' in objecttype 'GegevenInOnderzoek'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class GegeveninonderzoekObjectSleutelGegevenGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof GegevenInOnderzoek) {
            ...
            resultaat = v.getObjectSleutelGegeven();
