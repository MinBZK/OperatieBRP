...
public class PersoonnationaliteitRedenVerliesGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            if (attribuut != null) {
                resultaat = new GetalLiteralExpressie(((RedenVerliesNLNationaliteitAttribuut) attribuut).getWaarde().getCode().getWaarde());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new GetalLiteralExpressie(((RedenVerliesNLNationaliteitAttribuut) attribuut).getWaarde().getCode().getWaarde()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getRedenVerlies();
            }
        } else if (brpObject instanceof PersoonNationaliteitHisVolledig) {
            ...
            if (v.getPersoonNationaliteitHistorie() != null && v.getPersoonNationaliteitHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getRedenVerlies();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getRedenVerlies());
            }
        }
        return attributen;
    }
