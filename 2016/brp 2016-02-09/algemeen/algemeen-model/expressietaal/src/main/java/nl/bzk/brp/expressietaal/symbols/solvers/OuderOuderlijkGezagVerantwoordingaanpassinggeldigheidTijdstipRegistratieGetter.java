...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in objecttype
 * 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderlijkGezag() != null && v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
