...
/**
 * Getter voor 'gemeente_verordening' in objecttype 'PersoonVerstrekkingsbeperking'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonverstrekkingsbeperkingGemeenteVerordeningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperking) {
            ...
            resultaat = v.getGemeenteVerordening();
        } else if (brpObject instanceof PersoonVerstrekkingsbeperkingHisVolledig) {
            ...
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getPersoonVerstrekkingsbeperking().getGemeenteVerordening();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperking) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getPersoonVerstrekkingsbeperking().getGemeenteVerordening());
            }
        }
        return attributen;
    }
