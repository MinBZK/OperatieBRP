...
/**
 * Getter voor groepattribuut 'administratief.verantwoordingInhoud.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefVerantwoordinginhoudPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getAfgeleidAdministratief() != null && v.getAfgeleidAdministratief().getVerantwoordingInhoud() != null) {
                resultaat = v.getAfgeleidAdministratief().getVerantwoordingInhoud().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingInhoud().getPartij();
            }
        }
        return resultaat;
    }
