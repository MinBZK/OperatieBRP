...
public class PersoongeslachtsnaamcomponentVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonGeslachtsnaamcomponentHisMoment) {
            ...
            {
                resultaat = v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
