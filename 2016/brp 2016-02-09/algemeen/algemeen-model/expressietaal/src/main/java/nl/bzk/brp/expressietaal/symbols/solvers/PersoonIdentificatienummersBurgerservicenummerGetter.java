...
/**
 * Getter voor 'identificatienummers.burgerservicenummer' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonIdentificatienummersBurgerservicenummerGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getIdentificatienummers() != null) {
                resultaat = v.getIdentificatienummers().getBurgerservicenummer();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonIdentificatienummersHistorie() != null && v.getPersoonIdentificatienummersHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonIdentificatienummersHistorie().getActueleRecord().getBurgerservicenummer();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBurgerservicenummer());
            }
        }
        return attributen;
    }
