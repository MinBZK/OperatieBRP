 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingVerval.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
