...
/**
 * Getter voor 'uitsluiting_kiesrecht.uitsluiting_kiesrecht' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtUitsluitingKiesrechtGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getUitsluitingKiesrecht() != null) {
                resultaat = v.getUitsluitingKiesrecht().getIndicatieUitsluitingKiesrecht();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonUitsluitingKiesrechtHistorie() != null && v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getIndicatieUitsluitingKiesrecht();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieUitsluitingKiesrecht());
            }
        }
        return attributen;
    }
