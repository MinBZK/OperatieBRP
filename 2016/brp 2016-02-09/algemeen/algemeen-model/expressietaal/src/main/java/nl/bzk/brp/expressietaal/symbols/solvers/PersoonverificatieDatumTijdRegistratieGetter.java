...
/**
 * Getter voor groepattribuut 'datum_tijd_registratie' in objecttype 'HisPersoonVerificatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonverificatieDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerificatieHisVolledig) {
            ...
            if (v.getPersoonVerificatieHistorie() != null && v.getPersoonVerificatieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerificatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
