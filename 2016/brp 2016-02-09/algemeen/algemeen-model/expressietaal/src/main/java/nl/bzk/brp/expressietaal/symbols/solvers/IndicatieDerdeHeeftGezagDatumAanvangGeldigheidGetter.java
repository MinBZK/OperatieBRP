...
/**
 * Getter voor datum aanvang geldigheid van indicatie 'indicatie.derde_heeft_gezag.datum_aanvang_geldigheid' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie persoonIndicatie = persoonHisMoment.getIndicatieDerdeHeeftGezag();
            if (persoonIndicatie != null) {
                ...
                resultaat = standaardGroep.getDatumAanvangGeldigheid();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieDerdeHeeftGezag() != null) {
                resultaat = p.getIndicatieDerdeHeeftGezag().getPersoonIndicatieHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
