 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingInhoud.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
