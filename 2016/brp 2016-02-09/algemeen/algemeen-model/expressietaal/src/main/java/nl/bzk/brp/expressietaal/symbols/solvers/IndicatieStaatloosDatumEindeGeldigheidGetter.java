...
/**
 * Getter voor datum einde geldigheid indicatie 'indicatie.staatloos.datum_einde_geldigheid' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosDatumEindeGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieStaatloos() != null) {
                resultaat = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getDatumEindeGeldigheid();
            }
        }
        return resultaat;
    }
