...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingVerval.soort' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordingvervalSoortGetter implements AttributeGetter {
