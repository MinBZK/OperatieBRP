 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingInhoud.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordinginhoudSoortGetter implements AttributeGetter {
