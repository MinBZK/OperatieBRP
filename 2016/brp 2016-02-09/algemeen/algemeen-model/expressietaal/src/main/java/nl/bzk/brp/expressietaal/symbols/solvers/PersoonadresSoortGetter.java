...
/**
 * Getter voor 'soort' in objecttype 'PersoonAdres'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonadresSoortGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((FunctieAdresAttribuut) attribuut).getWaarde().getCode());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((FunctieAdresAttribuut) attribuut).getWaarde().getCode()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getSoort();
            }
        } else if (brpObject instanceof PersoonAdresHisVolledig) {
            final PersoonAdres x = new PersoonAdresView((PersoonAdresHisVolledig) brpObject, new DatumTijdAttribuut(), new DatumAttribuut());
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getSoort());
            }
        }
        return attributen;
    }
