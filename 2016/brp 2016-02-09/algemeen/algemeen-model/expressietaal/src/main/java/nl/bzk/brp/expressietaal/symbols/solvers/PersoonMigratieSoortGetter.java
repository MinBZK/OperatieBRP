...
/**
 * Getter voor 'migratie.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieSoortGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((SoortMigratieAttribuut) attribuut).getWaarde().getCode());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((SoortMigratieAttribuut) attribuut).getWaarde().getCode()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getMigratie() != null) {
                resultaat = v.getMigratie().getSoortMigratie();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getSoortMigratie());
            }
        }
        return attributen;
    }
