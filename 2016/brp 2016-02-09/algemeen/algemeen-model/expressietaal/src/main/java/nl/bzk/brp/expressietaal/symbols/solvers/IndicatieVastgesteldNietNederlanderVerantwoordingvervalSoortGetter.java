 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingVerval.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordingvervalSoortGetter implements AttributeGetter {
