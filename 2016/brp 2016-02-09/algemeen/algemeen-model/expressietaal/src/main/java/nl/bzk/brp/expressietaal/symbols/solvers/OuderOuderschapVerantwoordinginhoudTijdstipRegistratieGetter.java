...
/**
 * Getter voor groepattribuut 'ouderschap.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderschap() != null && v.getOuderschap().getVerantwoordingInhoud() != null) {
                resultaat = v.getOuderschap().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
