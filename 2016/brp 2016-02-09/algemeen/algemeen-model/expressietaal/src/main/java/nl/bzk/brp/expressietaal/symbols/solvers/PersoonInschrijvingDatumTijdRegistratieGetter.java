...
/**
 * Getter voor groepattribuut 'inschrijving.datum_tijd_registratie' in objecttype 'HisPersoonInschrijving'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonInschrijvingDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonInschrijvingHistorie() != null && v.getPersoonInschrijvingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonInschrijvingHistorie().getActueleRecord().getTijdstipRegistratie();
            }
            ...
            if (v.getInschrijving() != null) {
                resultaat = v.getInschrijving().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
