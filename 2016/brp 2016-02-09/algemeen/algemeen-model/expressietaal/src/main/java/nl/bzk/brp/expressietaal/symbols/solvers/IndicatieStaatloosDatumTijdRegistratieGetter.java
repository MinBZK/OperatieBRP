...
/**
 * Getter voor tijdstip registratie van indicatie 'indicatie.staatloos.datum_tijd_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieStaatloos() != null) {
                resultaat = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
