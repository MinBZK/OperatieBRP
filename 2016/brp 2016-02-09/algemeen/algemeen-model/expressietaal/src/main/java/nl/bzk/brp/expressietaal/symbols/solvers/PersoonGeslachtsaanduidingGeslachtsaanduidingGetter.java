...
/**
 * Getter voor 'geslachtsaanduiding.geslachtsaanduiding' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingGeslachtsaanduidingGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((GeslachtsaanduidingAttribuut) attribuut).getWaarde().getCode());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((GeslachtsaanduidingAttribuut) attribuut).getWaarde().getCode()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getGeslachtsaanduiding() != null) {
                resultaat = v.getGeslachtsaanduiding().getGeslachtsaanduiding();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getGeslachtsaanduiding());
            }
        }
        return attributen;
    }
