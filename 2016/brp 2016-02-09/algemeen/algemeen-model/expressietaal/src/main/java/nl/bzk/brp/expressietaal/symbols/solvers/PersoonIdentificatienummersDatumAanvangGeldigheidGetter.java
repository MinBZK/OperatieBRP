...
/**
 * Getter voor groepattribuut 'identificatienummers.datum_aanvang_geldigheid' in objecttype
 * 'HisPersoonIdentificatienummers'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonIdentificatienummersDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonIdentificatienummersHistorie() != null && v.getPersoonIdentificatienummersHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonIdentificatienummersHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
            ...
            if (v.getIdentificatienummers() != null) {
                resultaat = v.getIdentificatienummers().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
