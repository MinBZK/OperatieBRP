 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingInhoud.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordinginhoudSoortGetter implements AttributeGetter {
