...
/**
 * Getter voor 'inschrijving.datum' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonInschrijvingDatumGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getInschrijving() != null) {
                resultaat = v.getInschrijving().getDatumInschrijving();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonInschrijvingHistorie() != null && v.getPersoonInschrijvingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonInschrijvingHistorie().getActueleRecord().getDatumInschrijving();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumInschrijving());
            }
        }
        return attributen;
    }
