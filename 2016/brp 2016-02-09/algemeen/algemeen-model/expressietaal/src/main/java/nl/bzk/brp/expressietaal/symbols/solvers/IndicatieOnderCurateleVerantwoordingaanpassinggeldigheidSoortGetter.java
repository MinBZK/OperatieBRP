 ...
 * 'indicatie.onder_curatele.verantwoordingAanpassingGeldigheid.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
