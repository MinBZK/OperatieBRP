...
/**
 * Getter voor 'bijhouding.onverwerkt_document_aanwezig' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonBijhoudingOnverwerktDocumentAanwezigGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getBijhouding() != null) {
                resultaat = v.getBijhouding().getIndicatieOnverwerktDocumentAanwezig();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonBijhoudingHistorie() != null && v.getPersoonBijhoudingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonBijhoudingHistorie().getActueleRecord().getIndicatieOnverwerktDocumentAanwezig();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieOnverwerktDocumentAanwezig());
            }
        }
        return attributen;
    }
