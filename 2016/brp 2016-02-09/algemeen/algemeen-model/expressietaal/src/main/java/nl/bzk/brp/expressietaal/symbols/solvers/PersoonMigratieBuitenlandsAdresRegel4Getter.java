...
/**
 * Getter voor 'migratie.buitenlands_adres_regel_4' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieBuitenlandsAdresRegel4Getter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getMigratie() != null) {
                resultaat = v.getMigratie().getBuitenlandsAdresRegel4Migratie();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonMigratieHistorie() != null && v.getPersoonMigratieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getBuitenlandsAdresRegel4Migratie();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBuitenlandsAdresRegel4Migratie());
            }
        }
        return attributen;
    }
