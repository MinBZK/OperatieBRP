...
/**
 * Getter voor tijdstip verval van indicatie 'indicatie.onder_curatele.datum_tijd_verval' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieOnderCuratele() != null) {
                resultaat = p.getIndicatieOnderCuratele().getPersoonIndicatieHistorie().getActueleRecord().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
