...
/**
 * Getter voor groepattribuut 'samengestelde_naam.verantwoordingVerval.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamVerantwoordingvervalPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getVerantwoordingVerval() != null) {
                resultaat = v.getSamengesteldeNaam().getVerantwoordingVerval().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getVerantwoordingVerval().getPartij();
            }
        }
        return resultaat;
    }
