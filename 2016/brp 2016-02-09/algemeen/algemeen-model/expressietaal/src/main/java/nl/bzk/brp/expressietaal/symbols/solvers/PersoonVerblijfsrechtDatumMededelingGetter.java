...
/**
 * Getter voor 'verblijfsrecht.datum_mededeling' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonVerblijfsrechtDatumMededelingGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getVerblijfsrecht() != null) {
                resultaat = v.getVerblijfsrecht().getDatumMededelingVerblijfsrecht();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonVerblijfsrechtHistorie() != null && v.getPersoonVerblijfsrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerblijfsrechtHistorie().getActueleRecord().getDatumMededelingVerblijfsrecht();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumMededelingVerblijfsrecht());
            }
        }
        return attributen;
    }
