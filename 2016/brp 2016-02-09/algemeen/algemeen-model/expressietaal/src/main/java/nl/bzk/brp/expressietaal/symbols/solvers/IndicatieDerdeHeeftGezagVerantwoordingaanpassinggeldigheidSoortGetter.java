 ...
 * 'indicatie.derde_heeft_gezag.verantwoordingAanpassingGeldigheid.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
