...
public class PersoonindicatieSoortGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonIndicatie || brpObject instanceof PersoonIndicatieHisVolledig) {
            final Attribuut attribuut = getAttribuut(brpObject);
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((SoortIndicatieAttribuut) attribuut).getWaarde().getNaam());
            }
        }
        return resultaat;
    }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonIndicatie) {
            ...
            final PersoonIndicatie x = new PersoonIndicatieView((PersoonIndicatieHisVolledig) brpObject, new DatumTijdAttribuut(), new DatumAttribuut());
