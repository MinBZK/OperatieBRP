...
/**
 * Getter voor 'samengestelde_naam' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonSamengesteldeNaamGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getSamengesteldeNaam();
        }
        return resultaat;
    }
