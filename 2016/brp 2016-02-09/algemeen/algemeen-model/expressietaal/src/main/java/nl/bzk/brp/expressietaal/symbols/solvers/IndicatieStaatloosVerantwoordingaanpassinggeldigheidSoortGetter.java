...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingAanpassingGeldigheid.soort'
 * in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (indicatie != null) {
                ...
                if (standaard.getVerantwoordingAanpassingGeldigheid() != null) {
                    return standaard.getVerantwoordingAanpassingGeldigheid().getSoort();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
