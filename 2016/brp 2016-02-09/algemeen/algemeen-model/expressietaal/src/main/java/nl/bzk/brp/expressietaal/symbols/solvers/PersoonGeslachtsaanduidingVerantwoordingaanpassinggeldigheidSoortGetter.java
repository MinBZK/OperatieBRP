...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.verantwoordingAanpassingGeldigheid.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeslachtsaanduiding() != null && v.getGeslachtsaanduiding().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getGeslachtsaanduiding().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
        }
        return resultaat;
    }
