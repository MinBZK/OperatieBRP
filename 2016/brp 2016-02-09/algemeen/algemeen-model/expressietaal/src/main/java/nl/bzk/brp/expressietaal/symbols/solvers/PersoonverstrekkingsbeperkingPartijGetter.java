...
/**
 * Getter voor 'partij' in objecttype 'PersoonVerstrekkingsbeperking'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonverstrekkingsbeperkingPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperking) {
            ...
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getPersoonVerstrekkingsbeperking().getPartij();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperking) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getPersoonVerstrekkingsbeperking().getPartij());
            }
        }
        return attributen;
    }
