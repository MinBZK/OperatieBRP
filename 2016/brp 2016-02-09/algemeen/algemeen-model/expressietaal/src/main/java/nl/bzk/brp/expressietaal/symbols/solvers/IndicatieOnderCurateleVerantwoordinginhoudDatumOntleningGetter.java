 ...
 * 'indicatie.onder_curatele.verantwoordingInhoud.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
