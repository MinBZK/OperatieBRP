 ...
 * 'indicatie.onder_curatele.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieOnderCuratele() != null) {
                final ActieModel actieModel =
                        p.getIndicatieOnderCuratele().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid();
                if (actieModel != null) {
