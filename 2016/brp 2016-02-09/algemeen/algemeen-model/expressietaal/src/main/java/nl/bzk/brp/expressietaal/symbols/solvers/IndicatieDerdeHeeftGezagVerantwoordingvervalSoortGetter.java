...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.derde_heeft_gezag.verantwoordingVerval.soort' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordingvervalSoortGetter implements AttributeGetter {
