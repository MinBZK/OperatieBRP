...
/**
 * Getter voor groepattribuut 'ouderschap.verantwoordingVerval.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapVerantwoordingvervalPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderschap() != null && v.getOuderschap().getVerantwoordingVerval() != null) {
                resultaat = v.getOuderschap().getVerantwoordingVerval().getPartij();
            }
            ...
            {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingVerval().getPartij();
            }
        }
        return resultaat;
    }
