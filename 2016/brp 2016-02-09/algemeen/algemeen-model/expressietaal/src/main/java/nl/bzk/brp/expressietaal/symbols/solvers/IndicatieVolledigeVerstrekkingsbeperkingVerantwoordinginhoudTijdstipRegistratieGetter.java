 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie indicatie = persoonHisMoment.getIndicatieVolledigeVerstrekkingsbeperking();
            if (indicatie != null) {
            ...
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null) {
                final ActieModel actieModel =
                        p.getIndicatieVolledigeVerstrekkingsbeperking().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingInhoud();
                if (actieModel != null) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null) {
                final Iterator<HisPersoonIndicatieVolledigeVerstrekkingsbeperkingModel> iterator =
                        p.getIndicatieVolledigeVerstrekkingsbeperking().getPersoonIndicatieHistorie().iterator();
