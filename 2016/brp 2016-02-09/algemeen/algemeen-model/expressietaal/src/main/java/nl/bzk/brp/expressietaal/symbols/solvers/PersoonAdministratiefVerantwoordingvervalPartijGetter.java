...
/**
 * Getter voor groepattribuut 'administratief.verantwoordingVerval.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefVerantwoordingvervalPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getAfgeleidAdministratief() != null && v.getAfgeleidAdministratief().getVerantwoordingVerval() != null) {
                resultaat = v.getAfgeleidAdministratief().getVerantwoordingVerval().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingVerval().getPartij();
            }
        }
        return resultaat;
    }
