 ...
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.verantwoordingVerval.tijdstip_registratie' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (indicatie != null) {
                ...
                if (standaard.getVerantwoordingVerval() != null) {
                    return standaard.getVerantwoordingVerval().getTijdstipRegistratie();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
