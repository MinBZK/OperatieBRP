...
/**
 * Getter voor 'uitsluiting_kiesrecht.datum_voorzien_einde_uitsluiting_kiesrecht' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtDatumVoorzienEindeUitsluitingKiesrechtGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getUitsluitingKiesrecht() != null) {
                resultaat = v.getUitsluitingKiesrecht().getDatumVoorzienEindeUitsluitingKiesrecht();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig v = (PersoonHisVolledig) brpObject;
            if (v.getPersoonUitsluitingKiesrechtHistorie() != null && v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getDatumVoorzienEindeUitsluitingKiesrecht();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumVoorzienEindeUitsluitingKiesrecht());
            }
        }
        return attributen;
    }
