 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingInhoud.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordinginhoudPartijGetter implements AttributeGetter {
