...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.verantwoordingAanpassingGeldigheid.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderlijkGezag() != null && v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
            ...
            {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
        }
        return resultaat;
    }
