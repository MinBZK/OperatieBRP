...
/**
 * Getter voor 'verblijfsrecht.datum_aanvang' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonVerblijfsrechtDatumAanvangGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getVerblijfsrecht() != null) {
                resultaat = v.getVerblijfsrecht().getDatumAanvangVerblijfsrecht();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonVerblijfsrechtHistorie() != null && v.getPersoonVerblijfsrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerblijfsrechtHistorie().getActueleRecord().getDatumAanvangVerblijfsrecht();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumAanvangVerblijfsrecht());
            }
        }
        return attributen;
    }
