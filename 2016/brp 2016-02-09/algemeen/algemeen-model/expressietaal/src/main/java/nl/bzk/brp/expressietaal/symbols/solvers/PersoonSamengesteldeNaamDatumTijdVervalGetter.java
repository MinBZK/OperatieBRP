...
/**
 * Getter voor groepattribuut 'samengestelde_naam.datum_tijd_verval' in objecttype 'HisPersoonSamengesteldeNaam'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonSamengesteldeNaamHistorie() != null && v.getPersoonSamengesteldeNaamHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getSamengesteldeNaam() != null) {
                resultaat = v.getSamengesteldeNaam().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
