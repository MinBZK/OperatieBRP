 ...
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.verantwoordingVerval.datum_ontlening' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (indicatie != null) {
                ...
                if (standaard.getVerantwoordingVerval() != null) {
                    return standaard.getVerantwoordingVerval().getDatumOntlening();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
