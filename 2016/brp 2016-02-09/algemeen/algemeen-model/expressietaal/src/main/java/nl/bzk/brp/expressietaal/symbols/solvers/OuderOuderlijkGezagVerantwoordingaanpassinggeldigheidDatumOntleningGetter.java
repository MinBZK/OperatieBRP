...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype
 * 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderlijkGezag() != null && v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
            ...
            if (v.getOuderOuderlijkGezagHistorie() != null
                ...
                && v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid() != null)
            {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
        }
        return resultaat;
    }
