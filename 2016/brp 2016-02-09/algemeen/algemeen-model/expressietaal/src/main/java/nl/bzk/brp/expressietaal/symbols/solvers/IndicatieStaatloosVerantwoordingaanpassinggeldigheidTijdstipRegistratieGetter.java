 ...
 * 'indicatie.staatloos.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieStaatloos() != null) {
                final ActieModel actieModel =
                        p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid();
                if (actieModel != null) {
