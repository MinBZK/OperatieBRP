...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.datum_tijd_registratie' in objecttype
 * 'HisPersoonGeslachtsaanduiding'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonGeslachtsaanduidingHistorie() != null && v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getTijdstipRegistratie();
            }
            ...
            if (v.getGeslachtsaanduiding() != null) {
                resultaat = v.getGeslachtsaanduiding().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
