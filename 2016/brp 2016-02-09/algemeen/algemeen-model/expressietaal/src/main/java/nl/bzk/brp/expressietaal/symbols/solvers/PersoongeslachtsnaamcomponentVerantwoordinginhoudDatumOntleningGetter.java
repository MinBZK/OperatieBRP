...
public class PersoongeslachtsnaamcomponentVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonGeslachtsnaamcomponentHisMoment) {
            ...
            {
                resultaat = v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord().getVerantwoordingInhoud().getDatumOntlening();
            }
        }
        return resultaat;
    }
