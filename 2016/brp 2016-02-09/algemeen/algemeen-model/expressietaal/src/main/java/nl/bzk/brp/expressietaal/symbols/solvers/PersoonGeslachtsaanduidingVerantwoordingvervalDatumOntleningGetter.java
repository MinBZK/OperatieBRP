...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.verantwoordingVerval.datum_ontlening' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeslachtsaanduiding() != null && v.getGeslachtsaanduiding().getVerantwoordingVerval() != null) {
                resultaat = v.getGeslachtsaanduiding().getVerantwoordingVerval().getDatumOntlening();
            }
            ...
            {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getVerantwoordingVerval().getDatumOntlening();
            }
        }
        return resultaat;
    }
