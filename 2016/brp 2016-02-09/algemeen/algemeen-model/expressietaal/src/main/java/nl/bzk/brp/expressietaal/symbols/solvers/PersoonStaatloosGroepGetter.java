...
/**
 * Getter voor 'staatloos' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonStaatloosGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getIndicatieStaatloos().getStandaard();
        }
        return resultaat;
    }
    ...
    public final List<Groep> getHistorischeGroepen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            final Iterator<nl.bzk.brp.model.operationeel.kern.HisPersoonIndicatieStaatloosModel> iterator =
                    p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getHistorie().iterator();
