    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getPersoonskaart() != null) {
                resultaat = v.getPersoonskaart().getIndicatiePersoonskaartVolledigGeconverteerd();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonPersoonskaartHistorie() != null && v.getPersoonPersoonskaartHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getIndicatiePersoonskaartVolledigGeconverteerd();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatiePersoonskaartVolledigGeconverteerd());
            }
        }
        return attributen;
    }
