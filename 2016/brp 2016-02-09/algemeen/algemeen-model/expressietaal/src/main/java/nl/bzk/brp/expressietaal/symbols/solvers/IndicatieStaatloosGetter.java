...
/**
 * Getter voor indicatie 'indicatie.staatloos' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (p.getIndicatieStaatloos() != null && p.getIndicatieStaatloos().getStandaard() != null) {
                resultaat = p.getIndicatieStaatloos().getStandaard().getWaarde();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieStaatloos() != null) {
                resultaat = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getWaarde();
            }
        }
        return resultaat;
    }
