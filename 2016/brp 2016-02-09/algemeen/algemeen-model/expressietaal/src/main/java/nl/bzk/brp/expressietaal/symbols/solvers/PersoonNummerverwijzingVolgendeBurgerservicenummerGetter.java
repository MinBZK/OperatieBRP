...
/**
 * Getter voor 'nummerverwijzing.volgende_burgerservicenummer' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonNummerverwijzingVolgendeBurgerservicenummerGetter implements AttributeGetter {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new GetalLiteralExpressie(attribuut.getWaarde()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getNummerverwijzing() != null) {
                resultaat = v.getNummerverwijzing().getVolgendeBurgerservicenummer();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonNummerverwijzingHistorie() != null && v.getPersoonNummerverwijzingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNummerverwijzingHistorie().getActueleRecord().getVolgendeBurgerservicenummer();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getVolgendeBurgerservicenummer());
            }
        }
        return attributen;
    }
