...
public class PersoonvoornaamNaamGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaam) {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaam) {
            final PersoonVoornaam v = (PersoonVoornaam) brpObject;
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getNaam();
            }
        } else if (brpObject instanceof PersoonVoornaamHisVolledig) {
            ...
            if (v.getPersoonVoornaamHistorie() != null && v.getPersoonVoornaamHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVoornaamHistorie().getActueleRecord().getNaam();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaam) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getNaam());
            }
        }
        return attributen;
    }
