...
/**
 * Getter voor 'bijhouding.bijhoudingspartij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonBijhoudingBijhoudingspartijGetter implements AttributeGetter {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new GetalLiteralExpressie(((PartijAttribuut) attribuut).getWaarde().getCode().getWaarde()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getBijhouding() != null) {
                resultaat = v.getBijhouding().getBijhoudingspartij();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig v = (PersoonHisVolledig) brpObject;
            if (v.getPersoonBijhoudingHistorie() != null && v.getPersoonBijhoudingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonBijhoudingHistorie().getActueleRecord().getBijhoudingspartij();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBijhoudingspartij());
            }
        }
        return attributen;
    }
