 ...
 * 'indicatie.onder_curatele.verantwoordingAanpassingGeldigheid.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
