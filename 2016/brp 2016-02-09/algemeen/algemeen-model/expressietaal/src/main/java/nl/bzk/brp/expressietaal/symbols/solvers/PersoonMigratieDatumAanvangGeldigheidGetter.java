...
/**
 * Getter voor groepattribuut 'migratie.datum_aanvang_geldigheid' in objecttype 'HisPersoonMigratie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonMigratieHistorie() != null && v.getPersoonMigratieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getMigratie() != null) {
                resultaat = v.getMigratie().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
