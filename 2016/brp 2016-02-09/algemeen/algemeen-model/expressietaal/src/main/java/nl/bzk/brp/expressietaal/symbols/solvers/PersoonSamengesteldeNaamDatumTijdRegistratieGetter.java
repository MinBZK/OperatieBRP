...
/**
 * Getter voor groepattribuut 'samengestelde_naam.datum_tijd_registratie' in objecttype 'HisPersoonSamengesteldeNaam'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonSamengesteldeNaamHistorie() != null && v.getPersoonSamengesteldeNaamHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getTijdstipRegistratie();
            }
            ...
            if (v.getSamengesteldeNaam() != null) {
                resultaat = v.getSamengesteldeNaam().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
