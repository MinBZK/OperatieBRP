...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.verantwoordingVerval.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeslachtsaanduiding() != null && v.getGeslachtsaanduiding().getVerantwoordingVerval() != null) {
                resultaat = v.getGeslachtsaanduiding().getVerantwoordingVerval().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
