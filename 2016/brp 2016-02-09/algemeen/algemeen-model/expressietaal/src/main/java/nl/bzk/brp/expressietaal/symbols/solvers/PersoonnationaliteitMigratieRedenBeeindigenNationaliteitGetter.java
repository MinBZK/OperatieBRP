...
/**
 * Getter voor 'migratie_reden_beeindigen_nationaliteit' in objecttype 'PersoonNationaliteit'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonnationaliteitMigratieRedenBeeindigenNationaliteitGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getMigratieRedenBeeindigenNationaliteit();
            }
        } else if (brpObject instanceof PersoonNationaliteitHisVolledig) {
            ...
            if (v.getPersoonNationaliteitHistorie() != null && v.getPersoonNationaliteitHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getMigratieRedenBeeindigenNationaliteit();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getMigratieRedenBeeindigenNationaliteit());
            }
        }
        return attributen;
    }
