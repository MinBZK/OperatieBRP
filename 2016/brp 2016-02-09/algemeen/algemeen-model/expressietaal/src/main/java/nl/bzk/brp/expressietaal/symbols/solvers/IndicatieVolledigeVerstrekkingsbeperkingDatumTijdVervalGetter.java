...
/**
 * Getter voor tijdstip verval van indicatie 'indicatie.volledige_verstrekkingsbeperking.datum_tijd_verval' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null) {
                resultaat = p.getIndicatieVolledigeVerstrekkingsbeperking().getPersoonIndicatieHistorie().getActueleRecord().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
