 ...
 * 'indicatie.derde_heeft_gezag.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie indicatie = persoonHisMoment.getIndicatieDerdeHeeftGezag();
            if (indicatie != null) {
            ...
            if (p.getIndicatieDerdeHeeftGezag() != null) {
                final ActieModel actieModel = p.getIndicatieDerdeHeeftGezag().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingInhoud();
                if (actieModel != null) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieDerdeHeeftGezag() != null) {
                final Iterator<HisPersoonIndicatieDerdeHeeftGezagModel> iterator =
                        p.getIndicatieDerdeHeeftGezag().getPersoonIndicatieHistorie().iterator();
