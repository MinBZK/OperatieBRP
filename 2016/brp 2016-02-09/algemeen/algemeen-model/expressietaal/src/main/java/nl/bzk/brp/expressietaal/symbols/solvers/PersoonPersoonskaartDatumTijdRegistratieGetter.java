...
/**
 * Getter voor groepattribuut 'persoonskaart.datum_tijd_registratie' in objecttype 'HisPersoonPersoonskaart'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonPersoonskaartDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonPersoonskaartHistorie() != null && v.getPersoonPersoonskaartHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getTijdstipRegistratie();
            }
            ...
            if (v.getPersoonskaart() != null) {
                resultaat = v.getPersoonskaart().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
