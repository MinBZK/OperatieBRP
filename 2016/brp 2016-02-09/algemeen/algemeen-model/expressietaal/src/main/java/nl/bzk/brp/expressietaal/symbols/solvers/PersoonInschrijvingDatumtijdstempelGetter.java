...
/**
 * Getter voor 'inschrijving.datumtijdstempel' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonInschrijvingDatumtijdstempelGetter implements AttributeGetter {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new DateTimeLiteralExpressie(attribuut.getWaarde()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getInschrijving() != null) {
                resultaat = v.getInschrijving().getDatumtijdstempel();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig v = (PersoonHisVolledig) brpObject;
            if (v.getPersoonInschrijvingHistorie() != null && v.getPersoonInschrijvingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonInschrijvingHistorie().getActueleRecord().getDatumtijdstempel();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumtijdstempel());
            }
        }
        return attributen;
    }
