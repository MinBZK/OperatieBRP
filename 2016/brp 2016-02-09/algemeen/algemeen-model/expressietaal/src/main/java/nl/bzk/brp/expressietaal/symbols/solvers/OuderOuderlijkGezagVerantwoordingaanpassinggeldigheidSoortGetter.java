...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.verantwoordingAanpassingGeldigheid.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderlijkGezag() != null && v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderlijkGezag().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
            ...
            {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
        }
        return resultaat;
    }
