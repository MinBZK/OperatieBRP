...
/**
 * Getter voor 'datum_aanvang_materiele_periode' in objecttype 'PersoonAfnemerindicatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonafnemerindicatieDatumAanvangMaterielePeriodeGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAfnemerindicatie) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getDatumAanvangMaterielePeriode();
            }
        } else if (brpObject instanceof PersoonAfnemerindicatieHisVolledig) {
            ...
            if (v.getPersoonAfnemerindicatieHistorie() != null && v.getPersoonAfnemerindicatieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonAfnemerindicatieHistorie().getActueleRecord().getDatumAanvangMaterielePeriode();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAfnemerindicatie) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumAanvangMaterielePeriode());
            }
        }
        return attributen;
    }
