...
/**
 * Getter voor groepattribuut 'administratief.verantwoordingVerval.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getAfgeleidAdministratief() != null && v.getAfgeleidAdministratief().getVerantwoordingVerval() != null) {
                resultaat = v.getAfgeleidAdministratief().getVerantwoordingVerval().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
