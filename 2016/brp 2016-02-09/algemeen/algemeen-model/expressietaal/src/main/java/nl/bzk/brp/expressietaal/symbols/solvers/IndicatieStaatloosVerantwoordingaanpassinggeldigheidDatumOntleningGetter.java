 ...
 * 'indicatie.staatloos.verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
