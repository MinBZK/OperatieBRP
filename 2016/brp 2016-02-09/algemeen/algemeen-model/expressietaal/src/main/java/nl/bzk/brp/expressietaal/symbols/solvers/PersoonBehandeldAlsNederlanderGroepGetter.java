...
/**
 * Getter voor 'behandeld_als_nederlander' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonBehandeldAlsNederlanderGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getIndicatieBehandeldAlsNederlander().getStandaard();
        }
        return resultaat;
    }
    ...
    public final List<Groep> getHistorischeGroepen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            final Iterator<nl.bzk.brp.model.operationeel.kern.HisPersoonIndicatieBehandeldAlsNederlanderModel> iterator =
                    p.getIndicatieBehandeldAlsNederlander().getPersoonIndicatieHistorie().getHistorie().iterator();
