 ...
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.verantwoordingInhoud.datum_ontlening' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (indicatie != null) {
                ...
                if (standaard.getVerantwoordingInhoud() != null) {
                    return standaard.getVerantwoordingInhoud().getDatumOntlening();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
