...
/**
 * Getter voor groepattribuut 'datum_tijd_verval' in objecttype 'HisOnderzoek'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OnderzoekDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OnderzoekHisVolledig) {
            ...
            if (v.getOnderzoekHistorie() != null && v.getOnderzoekHistorie().getActueleRecord() != null) {
                resultaat = v.getOnderzoekHistorie().getActueleRecord().getDatumTijdVerval();
            }
