...
/**
 * Getter voor TSReg van de verantwoording van indicatie
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.verantwoordingInhoud.tijdstip_registratie' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie indicatie = persoonHisMoment.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument();
            if (indicatie != null) {
                final HisPersoonIndicatieStandaardGroep standaard = (HisPersoonIndicatieStandaardGroep) indicatie.getStandaard();
                if (standaard.getVerantwoordingInhoud() != null) {
                    return standaard.getVerantwoordingInhoud().getTijdstipRegistratie();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument() != null) {
                final ActieModel actieModel =
                        p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument()
                         .getPersoonIndicatieHistorie()
                         .getActueleRecord()
                         .getVerantwoordingInhoud();
                if (actieModel != null) {
                    resultaat = actieModel.getTijdstipRegistratie();
                }
            }
        }
        return resultaat;
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument() != null) {
                final Iterator<HisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel> iterator =
                        p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument().getPersoonIndicatieHistorie().iterator();
                while (iterator.hasNext()) {
                    final ActieModel actieModel = iterator.next().getVerantwoordingInhoud();
                    if (actieModel != null) {
                        attributen.add(actieModel.getTijdstipRegistratie());
                    }
                }
            }
        }
