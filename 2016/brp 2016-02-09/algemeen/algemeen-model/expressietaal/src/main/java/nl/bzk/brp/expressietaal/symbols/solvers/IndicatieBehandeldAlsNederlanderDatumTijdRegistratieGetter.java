...
/**
 * Getter voor tijdstip registratie van indicatie 'indicatie.behandeld_als_nederlander.datum_tijd_registratie' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieBehandeldAlsNederlander() != null) {
                resultaat = p.getIndicatieBehandeldAlsNederlander().getPersoonIndicatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
