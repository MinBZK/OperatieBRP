...
/**
 * Getter voor 'migratie_reden_opname_nationaliteit' in objecttype 'PersoonIndicatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonindicatieMigratieRedenOpnameNationaliteitGetter implements AttributeGetter {
