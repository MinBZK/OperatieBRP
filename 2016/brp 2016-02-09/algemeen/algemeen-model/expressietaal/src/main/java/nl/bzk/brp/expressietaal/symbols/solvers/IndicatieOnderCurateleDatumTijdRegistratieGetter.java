...
/**
 * Getter voor tijdstip registratie van indicatie 'indicatie.onder_curatele.datum_tijd_registratie' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieOnderCuratele() != null) {
                resultaat = p.getIndicatieOnderCuratele().getPersoonIndicatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
