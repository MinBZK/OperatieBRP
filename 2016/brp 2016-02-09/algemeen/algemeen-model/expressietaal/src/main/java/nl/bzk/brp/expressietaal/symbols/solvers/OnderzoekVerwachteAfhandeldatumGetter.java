...
/**
 * Getter voor 'verwachte_afhandeldatum' in objecttype 'Onderzoek'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OnderzoekVerwachteAfhandeldatumGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getVerwachteAfhandeldatum();
            }
        } else if (brpObject instanceof OnderzoekHisVolledig) {
            final OnderzoekHisVolledig v = (OnderzoekHisVolledig) brpObject;
            if (v.getOnderzoekHistorie() != null && v.getOnderzoekHistorie().getActueleRecord() != null) {
                resultaat = v.getOnderzoekHistorie().getActueleRecord().getVerwachteAfhandeldatum();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getVerwachteAfhandeldatum());
            }
        }
        return attributen;
    }
