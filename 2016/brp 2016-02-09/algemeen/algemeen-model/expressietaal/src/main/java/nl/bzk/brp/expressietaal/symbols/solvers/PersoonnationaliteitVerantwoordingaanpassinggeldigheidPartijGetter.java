...
public class PersoonnationaliteitVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteitHisMoment) {
            ...
            {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
        }
        return resultaat;
    }
