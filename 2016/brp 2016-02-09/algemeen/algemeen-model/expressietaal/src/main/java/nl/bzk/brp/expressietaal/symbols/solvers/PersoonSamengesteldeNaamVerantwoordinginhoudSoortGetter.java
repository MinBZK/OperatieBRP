...
/**
 * Getter voor groepattribuut 'samengestelde_naam.verantwoordingInhoud.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getVerantwoordingInhoud() != null) {
                resultaat = v.getSamengesteldeNaam().getVerantwoordingInhoud().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
