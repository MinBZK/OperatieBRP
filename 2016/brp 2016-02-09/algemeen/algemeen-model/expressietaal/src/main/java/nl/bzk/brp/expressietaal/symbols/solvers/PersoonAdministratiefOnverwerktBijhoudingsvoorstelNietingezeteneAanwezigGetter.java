...
/**
 * Getter voor 'administratief.onverwerkt_bijhoudingsvoorstel_nietingezetene_aanwezig' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefOnverwerktBijhoudingsvoorstelNietingezeteneAanwezigGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getAfgeleidAdministratief() != null) {
                resultaat = v.getAfgeleidAdministratief().getIndicatieOnverwerktBijhoudingsvoorstelNietIngezeteneAanwezig();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonAfgeleidAdministratiefHistorie() != null && v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord() != null) {
                resultaat =
                        v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getIndicatieOnverwerktBijhoudingsvoorstelNietIngezeteneAanwezig();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieOnverwerktBijhoudingsvoorstelNietIngezeteneAanwezig());
            }
        }
        return attributen;
    }
