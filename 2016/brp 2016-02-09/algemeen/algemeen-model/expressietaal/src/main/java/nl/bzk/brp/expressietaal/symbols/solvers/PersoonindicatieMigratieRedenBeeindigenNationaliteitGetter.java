...
/**
 * Getter voor 'migratie_reden_beeindigen_nationaliteit' in objecttype 'PersoonIndicatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonindicatieMigratieRedenBeeindigenNationaliteitGetter implements AttributeGetter {
