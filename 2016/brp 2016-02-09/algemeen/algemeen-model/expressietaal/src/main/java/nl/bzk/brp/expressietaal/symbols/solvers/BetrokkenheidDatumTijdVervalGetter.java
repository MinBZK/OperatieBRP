...
/**
 * Getter voor groepattribuut 'datum_tijd_verval' in objecttype 'HisBetrokkenheid'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class BetrokkenheidDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof BetrokkenheidHisVolledig) {
            ...
            if (v.getBetrokkenheidHistorie() != null && v.getBetrokkenheidHistorie().getActueleRecord() != null) {
                resultaat = v.getBetrokkenheidHistorie().getActueleRecord().getDatumTijdVerval();
            }
