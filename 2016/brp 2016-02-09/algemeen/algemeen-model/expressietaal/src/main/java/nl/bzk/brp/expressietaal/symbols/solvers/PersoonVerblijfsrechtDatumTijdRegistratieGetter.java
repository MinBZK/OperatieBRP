...
/**
 * Getter voor groepattribuut 'verblijfsrecht.datum_tijd_registratie' in objecttype 'HisPersoonVerblijfsrecht'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonVerblijfsrechtDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonVerblijfsrechtHistorie() != null && v.getPersoonVerblijfsrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerblijfsrechtHistorie().getActueleRecord().getTijdstipRegistratie();
            }
            ...
            if (v.getVerblijfsrecht() != null) {
                resultaat = v.getVerblijfsrecht().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
