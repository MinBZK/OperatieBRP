...
/**
 * Getter voor groepattribuut 'identificatienummers.datum_einde_geldigheid' in objecttype
 * 'HisPersoonIdentificatienummers'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonIdentificatienummersDatumEindeGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonIdentificatienummersHistorie() != null && v.getPersoonIdentificatienummersHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonIdentificatienummersHistorie().getActueleRecord().getDatumEindeGeldigheid();
            }
            ...
            if (v.getIdentificatienummers() != null) {
                resultaat = v.getIdentificatienummers().getDatumEindeGeldigheid();
            }
        }
        return resultaat;
    }
