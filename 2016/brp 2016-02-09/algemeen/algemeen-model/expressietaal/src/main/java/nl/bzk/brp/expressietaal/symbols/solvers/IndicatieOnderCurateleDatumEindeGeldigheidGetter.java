...
/**
 * Getter voor datum einde geldigheid indicatie 'indicatie.onder_curatele.datum_einde_geldigheid' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleDatumEindeGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieOnderCuratele() != null) {
                resultaat = p.getIndicatieOnderCuratele().getPersoonIndicatieHistorie().getActueleRecord().getDatumEindeGeldigheid();
            }
        }
        return resultaat;
    }
