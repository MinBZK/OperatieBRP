 ...
 * 'indicatie.staatloos.verantwoordingInhoud.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
