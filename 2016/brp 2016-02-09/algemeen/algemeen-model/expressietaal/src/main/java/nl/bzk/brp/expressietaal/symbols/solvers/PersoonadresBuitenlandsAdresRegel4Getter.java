    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getBuitenlandsAdresRegel4();
            }
        } else if (brpObject instanceof PersoonAdresHisVolledig) {
            ...
            if (v.getPersoonAdresHistorie() != null && v.getPersoonAdresHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonAdresHistorie().getActueleRecord().getBuitenlandsAdresRegel4();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBuitenlandsAdresRegel4());
            }
        }
        return attributen;
    }
