...
public class PersoonverstrekkingsbeperkingVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisMoment) {
            ...
            if (v.getIdentiteit() != null && v.getIdentiteit().getVerantwoordingVerval() != null) {
                resultaat = v.getIdentiteit().getVerantwoordingVerval().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
