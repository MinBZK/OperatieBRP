...
/**
 * Getter voor 'datum_inhouding_vermissing' in objecttype 'PersoonReisdocument'.
 *
 */
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocument) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getDatumInhoudingVermissing();
            }
        } else if (brpObject instanceof PersoonReisdocumentHisVolledig) {
            ...
            if (v.getPersoonReisdocumentHistorie() != null && v.getPersoonReisdocumentHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonReisdocumentHistorie().getActueleRecord().getDatumInhoudingVermissing();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocument) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumInhoudingVermissing());
            }
        }
        return attributen;
    }
