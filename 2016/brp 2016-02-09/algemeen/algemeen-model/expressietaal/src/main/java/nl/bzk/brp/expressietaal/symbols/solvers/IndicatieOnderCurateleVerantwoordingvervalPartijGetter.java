...
/**
 * Getter voor partij van de verantwoording van indicatie 'indicatie.onder_curatele.verantwoordingVerval.partij' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordingvervalPartijGetter implements AttributeGetter {
