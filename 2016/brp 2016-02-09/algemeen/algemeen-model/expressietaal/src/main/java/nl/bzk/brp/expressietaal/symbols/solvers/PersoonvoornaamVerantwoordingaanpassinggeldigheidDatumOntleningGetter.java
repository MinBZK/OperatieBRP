...
public class PersoonvoornaamVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaamHisMoment) {
            ...
            if (v.getPersoonVoornaamHistorie() != null
                ...
                && v.getPersoonVoornaamHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid() != null)
            {
                resultaat = v.getPersoonVoornaamHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
        }
        return resultaat;
    }
