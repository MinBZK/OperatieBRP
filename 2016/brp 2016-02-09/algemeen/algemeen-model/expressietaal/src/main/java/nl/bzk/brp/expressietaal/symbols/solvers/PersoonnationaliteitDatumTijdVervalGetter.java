...
/**
 * Getter voor groepattribuut 'datum_tijd_verval' in objecttype 'HisPersoonNationaliteit'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonnationaliteitDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteitHisVolledig) {
            ...
            if (v.getPersoonNationaliteitHistorie() != null && v.getPersoonNationaliteitHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getDatumTijdVerval();
            }
