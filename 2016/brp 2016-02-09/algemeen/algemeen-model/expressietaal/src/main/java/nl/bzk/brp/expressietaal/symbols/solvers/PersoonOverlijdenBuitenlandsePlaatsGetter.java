...
/**
 * Getter voor 'overlijden.buitenlandse_plaats' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonOverlijdenBuitenlandsePlaatsGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null) {
                resultaat = v.getOverlijden().getBuitenlandsePlaatsOverlijden();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonOverlijdenHistorie() != null && v.getPersoonOverlijdenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonOverlijdenHistorie().getActueleRecord().getBuitenlandsePlaatsOverlijden();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBuitenlandsePlaatsOverlijden());
            }
        }
        return attributen;
    }
