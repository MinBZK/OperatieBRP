...
/**
 * Getter voor groepattribuut 'samengestelde_naam.verantwoordingInhoud.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamVerantwoordinginhoudPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getVerantwoordingInhoud() != null) {
                resultaat = v.getSamengesteldeNaam().getVerantwoordingInhoud().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getVerantwoordingInhoud().getPartij();
            }
        }
        return resultaat;
    }
