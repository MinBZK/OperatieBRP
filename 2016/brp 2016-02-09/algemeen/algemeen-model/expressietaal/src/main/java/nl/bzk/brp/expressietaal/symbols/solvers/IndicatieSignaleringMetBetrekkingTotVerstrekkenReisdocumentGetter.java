...
/**
 * Getter voor indicatie 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument() != null
                && p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument().getStandaard() != null)
            {
                resultaat = p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument().getStandaard().getWaarde();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument() != null) {
                resultaat =
                        p.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument().getPersoonIndicatieHistorie().getActueleRecord().getWaarde();
            }
        }
        return resultaat;
    }
