...
/**
 * Getter voor groepattribuut 'samengestelde_naam.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in objecttype
 * 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getSamengesteldeNaam() != null && v.getSamengesteldeNaam().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getSamengesteldeNaam().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
