    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getPersoonskaart() != null) {
                resultaat = v.getPersoonskaart().getGemeentePersoonskaart();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig v = (PersoonHisVolledig) brpObject;
            if (v.getPersoonPersoonskaartHistorie() != null && v.getPersoonPersoonskaartHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getGemeentePersoonskaart();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getGemeentePersoonskaart());
            }
        }
        return attributen;
    }
