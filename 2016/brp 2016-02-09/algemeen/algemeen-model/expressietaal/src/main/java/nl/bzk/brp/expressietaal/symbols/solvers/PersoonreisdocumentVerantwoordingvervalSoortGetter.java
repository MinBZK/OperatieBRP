...
public class PersoonreisdocumentVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocumentHisMoment) {
            ...
            {
                resultaat = v.getPersoonReisdocumentHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
