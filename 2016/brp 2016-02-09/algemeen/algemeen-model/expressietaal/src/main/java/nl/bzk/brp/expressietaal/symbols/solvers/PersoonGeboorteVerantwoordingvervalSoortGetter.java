...
/**
 * Getter voor groepattribuut 'geboorte.verantwoordingVerval.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeboorteVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getVerantwoordingVerval() != null) {
                resultaat = v.getGeboorte().getVerantwoordingVerval().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonGeboorteHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
