...
/**
 * Getter voor 'deelname_eu_verkiezingen.datum_voorzien_einde_uitsluiting_eu_verkiezingen' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonDeelnameEuVerkiezingenDatumVoorzienEindeUitsluitingEuVerkiezingenGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getDeelnameEUVerkiezingen() != null) {
                resultaat = v.getDeelnameEUVerkiezingen().getDatumVoorzienEindeUitsluitingEUVerkiezingen();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonDeelnameEUVerkiezingenHistorie() != null && v.getPersoonDeelnameEUVerkiezingenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonDeelnameEUVerkiezingenHistorie().getActueleRecord().getDatumVoorzienEindeUitsluitingEUVerkiezingen();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumVoorzienEindeUitsluitingEUVerkiezingen());
            }
        }
        return attributen;
    }
