...
public class BetrokkenheidRolGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Betrokkenheid) {
            final Attribuut attribuut = getAttribuut(brpObject);
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((SoortBetrokkenheidAttribuut) attribuut).getWaarde().getCode());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((SoortBetrokkenheidAttribuut) attribuut).getWaarde().getCode()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Betrokkenheid) {
            final Betrokkenheid v = (Betrokkenheid) brpObject;
            resultaat = v.getRol();
        } else if (brpObject instanceof BetrokkenheidHisVolledig) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Betrokkenheid) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBetrokkenheid().getRol());
            }
        }
        return attributen;
    }
