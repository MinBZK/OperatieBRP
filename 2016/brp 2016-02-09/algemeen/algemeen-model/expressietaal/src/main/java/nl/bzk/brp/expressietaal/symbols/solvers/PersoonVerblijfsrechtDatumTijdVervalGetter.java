...
/**
 * Getter voor groepattribuut 'verblijfsrecht.datum_tijd_verval' in objecttype 'HisPersoonVerblijfsrecht'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonVerblijfsrechtDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonVerblijfsrechtHistorie() != null && v.getPersoonVerblijfsrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerblijfsrechtHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getVerblijfsrecht() != null) {
                resultaat = v.getVerblijfsrecht().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
