...
/**
 * Getter voor 'buitenlandse_regio_einde' in objecttype 'Relatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class FamilierechtelijkebetrekkingBuitenlandseRegioEindeGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Relatie) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getBuitenlandseRegioEinde();
            }
        } else if (brpObject instanceof RelatieHisVolledig) {
            ...
            if (v.getRelatieHistorie() != null && v.getRelatieHistorie().getActueleRecord() != null) {
                resultaat = v.getRelatieHistorie().getActueleRecord().getBuitenlandseRegioEinde();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Relatie) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBuitenlandseRegioEinde());
            }
        }
        return attributen;
    }
