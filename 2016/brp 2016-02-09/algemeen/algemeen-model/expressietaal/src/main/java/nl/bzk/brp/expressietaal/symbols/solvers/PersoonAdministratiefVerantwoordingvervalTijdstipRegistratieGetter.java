...
/**
 * Getter voor groepattribuut 'administratief.verantwoordingVerval.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getAfgeleidAdministratief() != null && v.getAfgeleidAdministratief().getVerantwoordingVerval() != null) {
                resultaat = v.getAfgeleidAdministratief().getVerantwoordingVerval().getTijdstipRegistratie();
            }
            ...
            if (v.getPersoonAfgeleidAdministratiefHistorie() != null
                ...
                && v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingVerval() != null)
            {
                resultaat = v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
