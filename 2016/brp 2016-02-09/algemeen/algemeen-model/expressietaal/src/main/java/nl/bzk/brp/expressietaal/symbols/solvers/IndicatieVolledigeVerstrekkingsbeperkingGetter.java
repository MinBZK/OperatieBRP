...
/**
 * Getter voor indicatie 'indicatie.volledige_verstrekkingsbeperking' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null && p.getIndicatieVolledigeVerstrekkingsbeperking().getStandaard() != null) {
                resultaat = p.getIndicatieVolledigeVerstrekkingsbeperking().getStandaard().getWaarde();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null) {
                resultaat = p.getIndicatieVolledigeVerstrekkingsbeperking().getPersoonIndicatieHistorie().getActueleRecord().getWaarde();
            }
        }
        return resultaat;
    }
