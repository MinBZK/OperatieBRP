...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.datum_tijd_verval' in objecttype 'HisPersoonGeslachtsaanduiding'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonGeslachtsaanduidingHistorie() != null && v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getGeslachtsaanduiding() != null) {
                resultaat = v.getGeslachtsaanduiding().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
