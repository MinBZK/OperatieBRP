 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingVerval.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordingvervalPartijGetter implements AttributeGetter {
