...
/**
 * Getter voor partij van de verantwoording van indicatie 'indicatie.derde_heeft_gezag.verantwoordingInhoud.partij' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordinginhoudPartijGetter implements AttributeGetter {
