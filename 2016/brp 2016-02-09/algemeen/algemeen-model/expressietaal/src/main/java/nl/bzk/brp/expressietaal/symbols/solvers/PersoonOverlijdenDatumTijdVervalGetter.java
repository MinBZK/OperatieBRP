...
/**
 * Getter voor groepattribuut 'overlijden.datum_tijd_verval' in objecttype 'HisPersoonOverlijden'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonOverlijdenDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonOverlijdenHistorie() != null && v.getPersoonOverlijdenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonOverlijdenHistorie().getActueleRecord().getDatumTijdVerval();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getOverlijden() != null) {
                resultaat = v.getOverlijden().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
