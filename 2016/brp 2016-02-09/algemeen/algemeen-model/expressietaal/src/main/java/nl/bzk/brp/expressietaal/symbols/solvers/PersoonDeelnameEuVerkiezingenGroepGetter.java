...
/**
 * Getter voor 'deelname_eu_verkiezingen' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonDeelnameEuVerkiezingenGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getDeelnameEUVerkiezingen();
        }
        return resultaat;
    }
