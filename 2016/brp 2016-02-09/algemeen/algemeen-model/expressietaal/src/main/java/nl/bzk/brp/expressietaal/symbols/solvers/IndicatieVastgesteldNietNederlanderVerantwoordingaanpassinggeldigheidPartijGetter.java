 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingAanpassingGeldigheid.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
