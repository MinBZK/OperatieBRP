...
/**
 * Getter voor groepattribuut 'uitsluiting_kiesrecht.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getUitsluitingKiesrecht() != null && v.getUitsluitingKiesrecht().getVerantwoordingInhoud() != null) {
                resultaat = v.getUitsluitingKiesrecht().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
