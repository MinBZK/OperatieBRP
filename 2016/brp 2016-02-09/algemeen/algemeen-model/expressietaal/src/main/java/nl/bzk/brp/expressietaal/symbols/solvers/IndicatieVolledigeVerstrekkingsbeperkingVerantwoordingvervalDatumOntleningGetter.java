 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingVerval.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
