...
/**
 * Getter voor groepattribuut 'uitsluiting_kiesrecht.datum_tijd_registratie' in objecttype
 * 'HisPersoonUitsluitingKiesrecht'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonUitsluitingKiesrechtHistorie() != null && v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getTijdstipRegistratie();
            }
            ...
            if (v.getUitsluitingKiesrecht() != null) {
                resultaat = v.getUitsluitingKiesrecht().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
