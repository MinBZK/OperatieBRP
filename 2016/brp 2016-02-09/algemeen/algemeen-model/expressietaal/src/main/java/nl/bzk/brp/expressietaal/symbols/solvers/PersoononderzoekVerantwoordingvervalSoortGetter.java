...
/**
 * Getter voor groepattribuut 'persoononderzoek.verantwoordingVerval.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoononderzoekVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonOnderzoekHisMoment) {
            ...
            {
                resultaat = v.getPersoonOnderzoekHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
