...
/**
 * Getter voor groepattribuut 'migratie.datum_tijd_verval' in objecttype 'HisPersoonMigratie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieDatumTijdVervalGetter implements AttributeGetter {
