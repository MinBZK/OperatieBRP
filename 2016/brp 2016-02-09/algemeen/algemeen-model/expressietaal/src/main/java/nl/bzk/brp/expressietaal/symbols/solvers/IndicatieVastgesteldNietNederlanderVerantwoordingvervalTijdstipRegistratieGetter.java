 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingVerval.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieVastgesteldNietNederlander() != null) {
                final ActieModel actieModel =
                        p.getIndicatieVastgesteldNietNederlander().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingVerval();
                if (actieModel != null) {
