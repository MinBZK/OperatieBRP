...
/**
 * Getter voor 'samengestelde_naam.afgeleid' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonSamengesteldeNaamAfgeleidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getSamengesteldeNaam() != null) {
                resultaat = v.getSamengesteldeNaam().getIndicatieAfgeleid();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonSamengesteldeNaamHistorie() != null && v.getPersoonSamengesteldeNaamHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonSamengesteldeNaamHistorie().getActueleRecord().getIndicatieAfgeleid();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieAfgeleid());
            }
        }
        return attributen;
    }
