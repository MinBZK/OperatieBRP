 ...
 * 'indicatie.behandeld_als_nederlander.verantwoordingInhoud.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderVerantwoordinginhoudPartijGetter implements AttributeGetter {
