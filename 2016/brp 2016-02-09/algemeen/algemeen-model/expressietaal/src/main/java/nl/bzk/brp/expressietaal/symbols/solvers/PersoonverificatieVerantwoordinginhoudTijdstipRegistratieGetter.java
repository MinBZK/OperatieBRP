...
public class PersoonverificatieVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerificatieHisMoment) {
            ...
            {
                resultaat = v.getPersoonVerificatieHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
