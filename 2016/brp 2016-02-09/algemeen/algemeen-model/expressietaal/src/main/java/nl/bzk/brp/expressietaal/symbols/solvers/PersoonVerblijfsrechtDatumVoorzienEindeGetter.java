...
/**
 * Getter voor 'verblijfsrecht.datum_voorzien_einde' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonVerblijfsrechtDatumVoorzienEindeGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getVerblijfsrecht() != null) {
                resultaat = v.getVerblijfsrecht().getDatumVoorzienEindeVerblijfsrecht();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonVerblijfsrechtHistorie() != null && v.getPersoonVerblijfsrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerblijfsrechtHistorie().getActueleRecord().getDatumVoorzienEindeVerblijfsrecht();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumVoorzienEindeVerblijfsrecht());
            }
        }
        return attributen;
    }
