...
/**
 * Getter voor groepattribuut 'uitsluiting_kiesrecht.datum_tijd_verval' in objecttype 'HisPersoonUitsluitingKiesrecht'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonUitsluitingKiesrechtHistorie() != null && v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getUitsluitingKiesrecht() != null) {
                resultaat = v.getUitsluitingKiesrecht().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
