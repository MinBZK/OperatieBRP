...
/**
 * Getter voor groepattribuut 'geboorte.datum_tijd_registratie' in objecttype 'HisPersoonGeboorte'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeboorteDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonGeboorteHistorie() != null && v.getPersoonGeboorteHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeboorteHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getGeboorte() != null) {
                resultaat = v.getGeboorte().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
