...
/**
 * Getter voor 'aanduiding_inhouding_vermissing' in objecttype 'PersoonReisdocument'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonreisdocumentAanduidingInhoudingVermissingGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocument) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((AanduidingInhoudingVermissingReisdocumentAttribuut) attribuut).getWaarde().getCode().getWaarde());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((AanduidingInhoudingVermissingReisdocumentAttribuut) attribuut).getWaarde()
                                                                                                                                 .getCode()
                                                                                                                                 .getWaarde()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocument) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getAanduidingInhoudingVermissing();
            }
        } else if (brpObject instanceof PersoonReisdocumentHisVolledig) {
            ...
            if (v.getPersoonReisdocumentHistorie() != null && v.getPersoonReisdocumentHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonReisdocumentHistorie().getActueleRecord().getAanduidingInhoudingVermissing();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocument) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getAanduidingInhoudingVermissing());
            }
        }
        return attributen;
    }
