...
public class PersoonverstrekkingsbeperkingVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisMoment) {
            ...
            if (v.getIdentiteit() != null && v.getIdentiteit().getVerantwoordingVerval() != null) {
                resultaat = v.getIdentiteit().getVerantwoordingVerval().getDatumOntlening();
            }
            ...
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getVerantwoordingVerval().getDatumOntlening();
            }
        }
        return resultaat;
    }
