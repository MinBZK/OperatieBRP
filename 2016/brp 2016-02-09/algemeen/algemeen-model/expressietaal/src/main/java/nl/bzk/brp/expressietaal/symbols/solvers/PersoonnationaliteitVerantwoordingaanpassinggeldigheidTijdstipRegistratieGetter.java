...
public class PersoonnationaliteitVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteitHisMoment) {
            ...
            {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
