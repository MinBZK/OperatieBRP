...
/**
 * Getter voor groepattribuut 'datum_tijd_registratie' in objecttype 'HisPersoonVerstrekkingsbeperking'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonverstrekkingsbeperkingDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisVolledig) {
            ...
            if (v.getPersoonVerstrekkingsbeperkingHistorie() != null && v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getTijdstipRegistratie();
            }
