...
/**
 * Getter voor groepattribuut 'geboorte.datum_tijd_verval' in objecttype 'HisPersoonGeboorte'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeboorteDatumTijdVervalGetter implements AttributeGetter {
