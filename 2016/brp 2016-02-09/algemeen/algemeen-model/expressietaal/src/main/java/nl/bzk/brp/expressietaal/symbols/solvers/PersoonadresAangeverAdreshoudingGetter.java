...
/**
 * Getter voor 'aangever_adreshouding' in objecttype 'PersoonAdres'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonadresAangeverAdreshoudingGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((AangeverAttribuut) attribuut).getWaarde().getCode().getWaarde());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((AangeverAttribuut) attribuut).getWaarde().getCode().getWaarde()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getAangeverAdreshouding();
            }
        } else if (brpObject instanceof PersoonAdresHisVolledig) {
            ...
            if (v.getPersoonAdresHistorie() != null && v.getPersoonAdresHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonAdresHistorie().getActueleRecord().getAangeverAdreshouding();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdres) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getAangeverAdreshouding());
            }
        }
        return attributen;
    }
