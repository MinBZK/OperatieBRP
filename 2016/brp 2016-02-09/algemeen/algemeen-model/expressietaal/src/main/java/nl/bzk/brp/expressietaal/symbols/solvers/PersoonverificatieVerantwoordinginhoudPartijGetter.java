...
public class PersoonverificatieVerantwoordinginhoudPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerificatieHisMoment) {
            ...
            {
                resultaat = v.getPersoonVerificatieHistorie().getActueleRecord().getVerantwoordingInhoud().getPartij();
            }
        }
        return resultaat;
    }
