...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.verantwoordingInhoud.datum_ontlening' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderlijkGezag() != null && v.getOuderlijkGezag().getVerantwoordingInhoud() != null) {
                resultaat = v.getOuderlijkGezag().getVerantwoordingInhoud().getDatumOntlening();
            }
            ...
            {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingInhoud().getDatumOntlening();
            }
        }
        return resultaat;
    }
