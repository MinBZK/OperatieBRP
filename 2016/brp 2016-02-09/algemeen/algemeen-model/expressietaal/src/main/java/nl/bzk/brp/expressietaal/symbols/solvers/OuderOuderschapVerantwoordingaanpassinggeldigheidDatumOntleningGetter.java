...
/**
 * Getter voor groepattribuut 'ouderschap.verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderschap() != null && v.getOuderschap().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderschap().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
            ...
            if (v.getOuderOuderschapHistorie() != null
                ...
                && v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid() != null)
            {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
        }
        return resultaat;
    }
