...
public class PersoonreisdocumentVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocumentHisMoment) {
            ...
            {
                resultaat = v.getPersoonReisdocumentHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
