...
/**
 * Getter voor groepattribuut 'migratie.verantwoordingVerval.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieVerantwoordingvervalPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getMigratie() != null && v.getMigratie().getVerantwoordingVerval() != null) {
                resultaat = v.getMigratie().getVerantwoordingVerval().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingVerval().getPartij();
            }
        }
        return resultaat;
    }
