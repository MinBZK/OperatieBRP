...
/**
 * Getter voor groepattribuut 'nummerverwijzing.datum_tijd_verval' in objecttype 'HisPersoonNummerverwijzing'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonNummerverwijzingDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonNummerverwijzingHistorie() != null && v.getPersoonNummerverwijzingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNummerverwijzingHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getNummerverwijzing() != null) {
                resultaat = v.getNummerverwijzing().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
