 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingVerval.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordingvervalSoortGetter implements AttributeGetter {
