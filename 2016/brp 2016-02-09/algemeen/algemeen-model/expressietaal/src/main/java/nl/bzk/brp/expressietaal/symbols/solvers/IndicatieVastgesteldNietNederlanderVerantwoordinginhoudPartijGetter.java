 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingInhoud.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordinginhoudPartijGetter implements AttributeGetter {
