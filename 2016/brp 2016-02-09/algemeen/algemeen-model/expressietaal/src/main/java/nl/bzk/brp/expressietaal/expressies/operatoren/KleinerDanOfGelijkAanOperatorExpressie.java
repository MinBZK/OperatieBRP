...
/**
 * Representeert een kleiner-dan-of-gelijk-aan-expressie.
 */
public class KleinerDanOfGelijkAanOperatorExpressie extends AbstractVergelijkingsoperatorExpressie {
     ...
     */
    public KleinerDanOfGelijkAanOperatorExpressie(final Expressie termLinks, final Expressie termRechts)
    {
    ...
    protected final Expressie pasToeOpLijsten(final Expressie waardeLinks, final Expressie waardeRechts) {
        ...
        return BooleanLiteralExpressie.getExpressie(v == LijstExpressie.Vergelijkingsresultaat.KLEINER
            || v == LijstExpressie.Vergelijkingsresultaat.GELIJK);
