...
/**
 * Getter voor groepattribuut 'ouderschap.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in objecttype
 * 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderschap() != null && v.getOuderschap().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderschap().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
