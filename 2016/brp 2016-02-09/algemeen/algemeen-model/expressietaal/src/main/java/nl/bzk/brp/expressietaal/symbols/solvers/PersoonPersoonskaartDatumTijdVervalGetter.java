...
/**
 * Getter voor groepattribuut 'persoonskaart.datum_tijd_verval' in objecttype 'HisPersoonPersoonskaart'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonPersoonskaartDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonPersoonskaartHistorie() != null && v.getPersoonPersoonskaartHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getPersoonskaart() != null) {
                resultaat = v.getPersoonskaart().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
