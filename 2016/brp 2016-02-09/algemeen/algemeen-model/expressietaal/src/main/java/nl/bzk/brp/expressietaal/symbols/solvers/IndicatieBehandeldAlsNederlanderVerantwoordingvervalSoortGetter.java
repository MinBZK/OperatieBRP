 ...
 * 'indicatie.behandeld_als_nederlander.verantwoordingVerval.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderVerantwoordingvervalSoortGetter implements AttributeGetter {
