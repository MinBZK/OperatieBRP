...
/**
 * Getter voor 'datum_einde_volgen' in objecttype 'PersoonAfnemerindicatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonafnemerindicatieDatumEindeVolgenGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAfnemerindicatie) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getDatumEindeVolgen();
            }
        } else if (brpObject instanceof PersoonAfnemerindicatieHisVolledig) {
            ...
            if (v.getPersoonAfnemerindicatieHistorie() != null && v.getPersoonAfnemerindicatieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonAfnemerindicatieHistorie().getActueleRecord().getDatumEindeVolgen();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAfnemerindicatie) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumEindeVolgen());
            }
        }
        return attributen;
    }
