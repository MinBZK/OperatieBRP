 ...
 * 'indicatie.derde_heeft_gezag.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (indicatie != null) {
                ...
                if (standaard.getVerantwoordingAanpassingGeldigheid() != null) {
                    return standaard.getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (p.getIndicatieDerdeHeeftGezag() != null) {
                final ActieModel actieModel =
                        p.getIndicatieDerdeHeeftGezag().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid();
                if (actieModel != null) {
