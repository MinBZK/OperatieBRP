 ...
 * 'indicatie.derde_heeft_gezag.verantwoordingAanpassingGeldigheid.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
