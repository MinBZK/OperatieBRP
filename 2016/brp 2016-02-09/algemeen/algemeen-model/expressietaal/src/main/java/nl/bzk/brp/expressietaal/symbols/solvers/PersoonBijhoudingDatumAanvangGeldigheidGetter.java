...
/**
 * Getter voor groepattribuut 'bijhouding.datum_aanvang_geldigheid' in objecttype 'HisPersoonBijhouding'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonBijhoudingDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonBijhoudingHistorie() != null && v.getPersoonBijhoudingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonBijhoudingHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getBijhouding() != null) {
                resultaat = v.getBijhouding().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
