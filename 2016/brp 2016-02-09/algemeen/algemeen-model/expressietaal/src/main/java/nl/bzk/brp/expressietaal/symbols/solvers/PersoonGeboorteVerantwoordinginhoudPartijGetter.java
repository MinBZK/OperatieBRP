...
/**
 * Getter voor groepattribuut 'geboorte.verantwoordingInhoud.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeboorteVerantwoordinginhoudPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getVerantwoordingInhoud() != null) {
                resultaat = v.getGeboorte().getVerantwoordingInhoud().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonGeboorteHistorie().getActueleRecord().getVerantwoordingInhoud().getPartij();
            }
        }
        return resultaat;
    }
