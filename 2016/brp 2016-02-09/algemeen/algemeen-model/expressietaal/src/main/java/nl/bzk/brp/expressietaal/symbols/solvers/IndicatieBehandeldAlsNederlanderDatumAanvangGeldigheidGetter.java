...
/**
 * Getter voor datum aanvang geldigheid van indicatie 'indicatie.behandeld_als_nederlander.datum_aanvang_geldigheid' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieBehandeldAlsNederlander() != null) {
                resultaat = p.getIndicatieBehandeldAlsNederlander().getPersoonIndicatieHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
