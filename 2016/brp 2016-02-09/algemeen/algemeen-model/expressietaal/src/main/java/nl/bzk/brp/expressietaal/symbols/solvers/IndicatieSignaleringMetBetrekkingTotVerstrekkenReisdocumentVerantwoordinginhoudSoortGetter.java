 ...
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.verantwoordingInhoud.soort' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentVerantwoordinginhoudSoortGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (indicatie != null) {
                ...
                if (standaard.getVerantwoordingInhoud() != null) {
                    return standaard.getVerantwoordingInhoud().getSoort();
                }
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
