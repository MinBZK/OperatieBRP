...
/**
 * Getter voor tijdstip registratie van indicatie 'indicatie.vastgesteld_niet_nederlander.datum_tijd_registratie' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieVastgesteldNietNederlander() != null) {
                resultaat = p.getIndicatieVastgesteldNietNederlander().getPersoonIndicatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
