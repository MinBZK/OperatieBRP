 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingVerval.partij' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordingvervalPartijGetter implements AttributeGetter {
