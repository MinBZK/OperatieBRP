...
/**
 * Getter voor datum aanvang geldigheid van indicatie 'indicatie.vastgesteld_niet_nederlander.datum_aanvang_geldigheid'
 * in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie persoonIndicatie = persoonHisMoment.getIndicatieVastgesteldNietNederlander();
            ...
            if (p.getIndicatieVastgesteldNietNederlander() != null) {
                resultaat = p.getIndicatieVastgesteldNietNederlander().getPersoonIndicatieHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
