...
/**
 * Getter voor groepattribuut 'uitsluiting_kiesrecht.verantwoordingVerval.datum_ontlening' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getUitsluitingKiesrecht() != null && v.getUitsluitingKiesrecht().getVerantwoordingVerval() != null) {
                resultaat = v.getUitsluitingKiesrecht().getVerantwoordingVerval().getDatumOntlening();
            }
            ...
            {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getVerantwoordingVerval().getDatumOntlening();
            }
        }
        return resultaat;
    }
