...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.datum_aanvang_geldigheid' in objecttype
 * 'HisPersoonGeslachtsaanduiding'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonGeslachtsaanduidingHistorie() != null && v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
            ...
            if (v.getGeslachtsaanduiding() != null) {
                resultaat = v.getGeslachtsaanduiding().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
