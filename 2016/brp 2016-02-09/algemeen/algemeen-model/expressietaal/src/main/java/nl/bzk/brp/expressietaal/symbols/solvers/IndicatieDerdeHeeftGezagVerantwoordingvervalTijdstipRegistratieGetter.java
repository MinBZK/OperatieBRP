 ...
 * 'indicatie.derde_heeft_gezag.verantwoordingVerval.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieDerdeHeeftGezag() != null) {
                final ActieModel actieModel = p.getIndicatieDerdeHeeftGezag().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingVerval();
                if (actieModel != null) {
