 ...
 */
public class KleinerDanOperatorExpressie extends AbstractVergelijkingsoperatorExpressie {
     ...
     */
    public KleinerDanOperatorExpressie(final Expressie termLinks, final Expressie termRechts) {
    ...
    protected final Expressie pasToeOpLijsten(final Expressie waardeLinks, final Expressie waardeRechts) {
        return BooleanLiteralExpressie.getExpressie(LijstExpressie.vergelijkLijsten(waardeLinks, waardeRechts, null)
            == LijstExpressie.Vergelijkingsresultaat.KLEINER);
    }
