...
/**
 * Getter voor groepattribuut 'ouderschap.verantwoordingAanpassingGeldigheid.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderschap() != null && v.getOuderschap().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getOuderschap().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
            ...
            {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
        }
        return resultaat;
    }
