...
/**
 * Getter voor 'datum_einde' in objecttype 'Relatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class FamilierechtelijkebetrekkingDatumEindeGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Relatie) {
            ...
            if (v.getRelatieHistorie() != null && v.getRelatieHistorie().getActueleRecord() != null) {
                resultaat = v.getRelatieHistorie().getActueleRecord().getDatumEinde();
            }
        }
        return resultaat;
    }
