...
/**
 * Getter voor 'uitsluiting_kiesrecht' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonUitsluitingKiesrechtGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getUitsluitingKiesrecht();
        }
        return resultaat;
    }
