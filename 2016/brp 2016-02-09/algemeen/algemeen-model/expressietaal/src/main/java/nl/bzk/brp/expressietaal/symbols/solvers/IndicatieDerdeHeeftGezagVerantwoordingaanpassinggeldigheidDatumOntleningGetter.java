 ...
 * 'indicatie.derde_heeft_gezag.verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
