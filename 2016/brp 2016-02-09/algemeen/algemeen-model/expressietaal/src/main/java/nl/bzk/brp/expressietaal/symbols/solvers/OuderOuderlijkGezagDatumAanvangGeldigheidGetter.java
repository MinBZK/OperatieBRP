...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.datum_aanvang_geldigheid' in objecttype 'HisOuderOuderlijkGezag'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisVolledig) {
            ...
            if (v.getOuderOuderlijkGezagHistorie() != null && v.getOuderOuderlijkGezagHistorie().getActueleRecord() != null) {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        } else if (brpObject instanceof OuderHisMoment) {
            final OuderHisMoment v = (OuderHisMoment) brpObject;
            if (v.getOuderlijkGezag() != null) {
                resultaat = v.getOuderlijkGezag().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
