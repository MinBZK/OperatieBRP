...
public class PersoonverstrekkingsbeperkingVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisMoment) {
            ...
            if (v.getIdentiteit() != null && v.getIdentiteit().getVerantwoordingVerval() != null) {
                resultaat = v.getIdentiteit().getVerantwoordingVerval().getTijdstipRegistratie();
            }
            ...
            if (v.getPersoonVerstrekkingsbeperkingHistorie() != null
                ...
                && v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getVerantwoordingVerval() != null)
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
