...
/**
 * Getter voor 'nummerverwijzing.vorige_burgerservicenummer' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonNummerverwijzingVorigeBurgerservicenummerGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getNummerverwijzing() != null) {
                resultaat = v.getNummerverwijzing().getVorigeBurgerservicenummer();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonNummerverwijzingHistorie() != null && v.getPersoonNummerverwijzingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNummerverwijzingHistorie().getActueleRecord().getVorigeBurgerservicenummer();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getVorigeBurgerservicenummer());
            }
        }
        return attributen;
    }
