...
import nl.bzk.brp.model.hisvolledig.momentview.kern.GeregistreerdPartnerschapView;
...
public class GeregistreerdpartnerschapSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Relatie) {
            ...
            final Relatie x =
                    new GeregistreerdPartnerschapView((GeregistreerdPartnerschapHisVolledig) brpObject, new DatumTijdAttribuut(), new DatumAttribuut());
