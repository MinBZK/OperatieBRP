 ...
 * 'indicatie.behandeld_als_nederlander.verantwoordingVerval.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieBehandeldAlsNederlander() != null) {
                final ActieModel actieModel =
                        p.getIndicatieBehandeldAlsNederlander().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingVerval();
                if (actieModel != null) {
