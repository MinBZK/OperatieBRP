...
/**
 * Getter voor groepattribuut 'ouderschap.datum_aanvang_geldigheid' in objecttype 'HisOuderOuderschap'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisVolledig) {
            ...
            if (v.getOuderOuderschapHistorie() != null && v.getOuderOuderschapHistorie().getActueleRecord() != null) {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        } else if (brpObject instanceof OuderHisMoment) {
            final OuderHisMoment v = (OuderHisMoment) brpObject;
            if (v.getOuderschap() != null) {
                resultaat = v.getOuderschap().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
