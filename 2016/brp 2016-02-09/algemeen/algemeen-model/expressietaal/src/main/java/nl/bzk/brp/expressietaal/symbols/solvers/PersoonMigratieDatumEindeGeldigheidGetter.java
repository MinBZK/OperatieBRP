...
/**
 * Getter voor groepattribuut 'migratie.datum_einde_geldigheid' in objecttype 'HisPersoonMigratie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieDatumEindeGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonMigratieHistorie() != null && v.getPersoonMigratieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getDatumEindeGeldigheid();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getMigratie() != null) {
                resultaat = v.getMigratie().getDatumEindeGeldigheid();
            }
        }
        return resultaat;
    }
