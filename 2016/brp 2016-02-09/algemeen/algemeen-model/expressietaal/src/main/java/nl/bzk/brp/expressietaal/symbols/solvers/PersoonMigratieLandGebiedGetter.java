...
/**
 * Getter voor 'migratie.land_gebied' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieLandGebiedGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getMigratie() != null) {
                resultaat = v.getMigratie().getLandGebiedMigratie();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonMigratieHistorie() != null && v.getPersoonMigratieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getLandGebiedMigratie();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getLandGebiedMigratie());
            }
        }
        return attributen;
    }
