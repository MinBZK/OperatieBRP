...
/**
 * Getter voor groepattribuut 'persoononderzoek.datum_tijd_verval' in objecttype 'HisPersoonOnderzoek'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoononderzoekDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonOnderzoekHisVolledig) {
            ...
            if (v.getPersoonOnderzoekHistorie() != null && v.getPersoonOnderzoekHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonOnderzoekHistorie().getActueleRecord().getDatumTijdVerval();
            }
