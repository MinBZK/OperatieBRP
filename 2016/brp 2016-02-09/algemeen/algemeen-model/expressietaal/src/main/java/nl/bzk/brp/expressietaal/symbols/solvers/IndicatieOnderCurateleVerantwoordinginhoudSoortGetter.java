...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.onder_curatele.verantwoordingInhoud.soort' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordinginhoudSoortGetter implements AttributeGetter {
