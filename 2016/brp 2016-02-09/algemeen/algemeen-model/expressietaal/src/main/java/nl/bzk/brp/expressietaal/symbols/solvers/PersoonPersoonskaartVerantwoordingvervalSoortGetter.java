...
/**
 * Getter voor groepattribuut 'persoonskaart.verantwoordingVerval.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonPersoonskaartVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getPersoonskaart() != null && v.getPersoonskaart().getVerantwoordingVerval() != null) {
                resultaat = v.getPersoonskaart().getVerantwoordingVerval().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
