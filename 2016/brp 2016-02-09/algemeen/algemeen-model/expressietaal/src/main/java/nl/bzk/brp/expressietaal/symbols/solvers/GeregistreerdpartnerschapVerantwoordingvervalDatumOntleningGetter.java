...
public class GeregistreerdpartnerschapVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof RelatieHisMoment) {
            ...
            {
                resultaat = v.getRelatieHistorie().getActueleRecord().getVerantwoordingVerval().getDatumOntlening();
            }
        }
        return resultaat;
    }
