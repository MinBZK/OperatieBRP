...
/**
 * Getter voor tijdstip registratie van indicatie 'indicatie.volledige_verstrekkingsbeperking.datum_tijd_registratie' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie persoonIndicatie = persoonHisMoment.getIndicatieVolledigeVerstrekkingsbeperking();
            ...
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null) {
                resultaat = p.getIndicatieVolledigeVerstrekkingsbeperking().getPersoonIndicatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
