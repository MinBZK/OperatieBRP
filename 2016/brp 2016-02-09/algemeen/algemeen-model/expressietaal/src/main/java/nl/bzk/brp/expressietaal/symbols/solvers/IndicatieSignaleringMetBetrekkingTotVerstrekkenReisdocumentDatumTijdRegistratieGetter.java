...
/**
 * Getter voor tijdstip registratie van indicatie
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.datum_tijd_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie persoonIndicatie = persoonHisMoment.getIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocument();
            if (persoonIndicatie != null) {
                ...
                resultaat = standaardGroep.getTijdstipRegistratie();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
