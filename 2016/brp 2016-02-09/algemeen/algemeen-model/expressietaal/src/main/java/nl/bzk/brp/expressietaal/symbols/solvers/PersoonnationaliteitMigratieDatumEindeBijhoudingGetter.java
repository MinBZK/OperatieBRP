...
/**
 * Getter voor 'migratie_datum_einde_bijhouding' in objecttype 'PersoonNationaliteit'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonnationaliteitMigratieDatumEindeBijhoudingGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getMigratieDatumEindeBijhouding();
            }
        } else if (brpObject instanceof PersoonNationaliteitHisVolledig) {
            ...
            if (v.getPersoonNationaliteitHistorie() != null && v.getPersoonNationaliteitHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getMigratieDatumEindeBijhouding();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteit) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getMigratieDatumEindeBijhouding());
            }
        }
        return attributen;
    }
