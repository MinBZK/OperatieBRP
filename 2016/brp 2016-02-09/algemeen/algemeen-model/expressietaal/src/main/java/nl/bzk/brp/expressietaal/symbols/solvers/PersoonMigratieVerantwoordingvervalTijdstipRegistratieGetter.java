...
/**
 * Getter voor groepattribuut 'migratie.verantwoordingVerval.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getMigratie() != null && v.getMigratie().getVerantwoordingVerval() != null) {
                resultaat = v.getMigratie().getVerantwoordingVerval().getTijdstipRegistratie();
            }
            ...
            if (v.getPersoonMigratieHistorie() != null
                ...
                && v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingVerval() != null)
            {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
