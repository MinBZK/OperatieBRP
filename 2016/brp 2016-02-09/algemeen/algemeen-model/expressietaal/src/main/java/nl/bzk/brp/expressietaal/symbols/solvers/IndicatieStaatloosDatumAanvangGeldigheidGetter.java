...
/**
 * Getter voor datum aanvang geldigheid van indicatie 'indicatie.staatloos.datum_aanvang_geldigheid' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie persoonIndicatie = persoonHisMoment.getIndicatieStaatloos();
            ...
            if (p.getIndicatieStaatloos() != null) {
                resultaat = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
