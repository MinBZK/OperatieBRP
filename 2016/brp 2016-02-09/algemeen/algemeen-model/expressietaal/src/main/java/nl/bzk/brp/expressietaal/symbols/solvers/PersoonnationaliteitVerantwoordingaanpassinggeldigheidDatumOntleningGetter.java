...
/**
 * Getter voor groepattribuut 'verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonnationaliteitVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteitHisMoment) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getStandaard().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
            ...
            if (v.getPersoonNationaliteitHistorie() != null
                ...
                && v.getPersoonNationaliteitHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid() != null)
            {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
        }
        return resultaat;
    }
