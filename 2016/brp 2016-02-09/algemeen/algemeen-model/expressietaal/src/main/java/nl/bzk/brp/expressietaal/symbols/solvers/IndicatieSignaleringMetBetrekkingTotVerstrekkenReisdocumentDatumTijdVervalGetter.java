...
/**
 * Getter voor tijdstip verval van indicatie
 * 'indicatie.signalering_met_betrekking_tot_verstrekken_reisdocument.datum_tijd_verval' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (persoonIndicatie != null) {
                ...
                resultaat = standaardGroep.getDatumTijdVerval();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
