...
public class PersoonvoornaamVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaamHisMoment) {
            ...
            {
                resultaat = v.getPersoonVoornaamHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
        }
        return resultaat;
    }
