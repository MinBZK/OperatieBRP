...
/**
 * Getter voor partij van de verantwoording van indicatie 'indicatie.onder_curatele.verantwoordingInhoud.partij' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordinginhoudPartijGetter implements AttributeGetter {
