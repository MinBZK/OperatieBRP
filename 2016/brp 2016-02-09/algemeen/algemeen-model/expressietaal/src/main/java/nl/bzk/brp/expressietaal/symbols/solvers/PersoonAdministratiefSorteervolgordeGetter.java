...
/**
 * Getter voor 'administratief.sorteervolgorde' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefSorteervolgordeGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getAfgeleidAdministratief() != null) {
                resultaat = v.getAfgeleidAdministratief().getSorteervolgorde();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonAfgeleidAdministratiefHistorie() != null && v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getSorteervolgorde();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getSorteervolgorde());
            }
        }
        return attributen;
    }
