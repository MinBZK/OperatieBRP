...
public class PersoonSoortGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon || brpObject instanceof PersoonHisVolledig) {
            final Attribuut attribuut = getAttribuut(brpObject);
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((SoortPersoonAttribuut) attribuut).getWaarde().getCode());
            }
        }
        return resultaat;
    }
