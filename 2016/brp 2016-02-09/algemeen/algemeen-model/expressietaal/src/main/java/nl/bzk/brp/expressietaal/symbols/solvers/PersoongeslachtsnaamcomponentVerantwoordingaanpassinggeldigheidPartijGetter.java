...
public class PersoongeslachtsnaamcomponentVerantwoordingaanpassinggeldigheidPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonGeslachtsnaamcomponentHisMoment) {
            ...
            {
                resultaat = v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getPartij();
            }
        }
        return resultaat;
    }
