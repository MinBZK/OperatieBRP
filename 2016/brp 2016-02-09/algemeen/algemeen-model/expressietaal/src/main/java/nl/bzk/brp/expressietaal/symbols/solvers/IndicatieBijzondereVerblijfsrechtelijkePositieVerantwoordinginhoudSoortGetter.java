 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingInhoud.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordinginhoudSoortGetter implements AttributeGetter {
