...
/**
 * Getter voor 'predicaat' in objecttype 'PersoonGeslachtsnaamcomponent'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoongeslachtsnaamcomponentPredicaatGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonGeslachtsnaamcomponent) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getPredicaat();
            }
        } else if (brpObject instanceof PersoonGeslachtsnaamcomponentHisVolledig) {
            ...
            if (v.getPersoonGeslachtsnaamcomponentHistorie() != null && v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord().getPredicaat();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonGeslachtsnaamcomponent) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getPredicaat());
            }
        }
        return attributen;
    }
