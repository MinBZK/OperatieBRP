...
/**
 * Getter voor groepattribuut 'geboorte.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeboorteVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getVerantwoordingInhoud() != null) {
                resultaat = v.getGeboorte().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
            ...
            if (v.getPersoonGeboorteHistorie() != null
                ...
                && v.getPersoonGeboorteHistorie().getActueleRecord().getVerantwoordingInhoud() != null)
            {
                resultaat = v.getPersoonGeboorteHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
