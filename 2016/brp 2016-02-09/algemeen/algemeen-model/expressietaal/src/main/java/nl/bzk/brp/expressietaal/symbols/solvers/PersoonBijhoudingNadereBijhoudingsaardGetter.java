...
/**
 * Getter voor 'bijhouding.nadere_bijhoudingsaard' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonBijhoudingNadereBijhoudingsaardGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((NadereBijhoudingsaardAttribuut) attribuut).getWaarde().getCode());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((NadereBijhoudingsaardAttribuut) attribuut).getWaarde().getCode()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getBijhouding() != null) {
                resultaat = v.getBijhouding().getNadereBijhoudingsaard();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final Persoon x = new PersoonView((PersoonHisVolledig) brpObject);
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getNadereBijhoudingsaard());
            }
        }
        return attributen;
    }
