...
/**
 * Getter voor groepattribuut 'datum_tijd_verval' in objecttype 'HisPersoonReisdocument'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonreisdocumentDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonReisdocumentHisVolledig) {
            ...
            if (v.getPersoonReisdocumentHistorie() != null && v.getPersoonReisdocumentHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonReisdocumentHistorie().getActueleRecord().getDatumTijdVerval();
            }
