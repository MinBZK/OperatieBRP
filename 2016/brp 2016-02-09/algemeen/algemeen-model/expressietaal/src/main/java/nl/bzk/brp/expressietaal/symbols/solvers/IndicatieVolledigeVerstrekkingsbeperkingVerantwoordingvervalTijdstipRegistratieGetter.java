 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingVerval.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieVolledigeVerstrekkingsbeperking() != null) {
                final ActieModel actieModel =
                        p.getIndicatieVolledigeVerstrekkingsbeperking().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingVerval();
                if (actieModel != null) {
