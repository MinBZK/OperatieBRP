...
/**
 * Getter voor partij van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingInhoud.partij' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordinginhoudPartijGetter implements AttributeGetter {
