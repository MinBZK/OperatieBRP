...
public class PersoonadresVerantwoordinginhoudPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdresHisMoment) {
            ...
            {
                resultaat = v.getPersoonAdresHistorie().getActueleRecord().getVerantwoordingInhoud().getPartij();
            }
        }
        return resultaat;
    }
