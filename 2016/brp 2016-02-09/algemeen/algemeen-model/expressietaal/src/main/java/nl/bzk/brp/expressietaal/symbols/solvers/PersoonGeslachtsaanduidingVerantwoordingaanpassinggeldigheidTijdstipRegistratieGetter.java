...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.verantwoordingAanpassingGeldigheid.tijdstip_registratie' in
 * objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingVerantwoordingaanpassinggeldigheidTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeslachtsaanduiding() != null && v.getGeslachtsaanduiding().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getGeslachtsaanduiding().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
