...
/**
 * Getter voor groepattribuut 'inschrijving.datum_tijd_verval' in objecttype 'HisPersoonInschrijving'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonInschrijvingDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonInschrijvingHistorie() != null && v.getPersoonInschrijvingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonInschrijvingHistorie().getActueleRecord().getDatumTijdVerval();
            }
            ...
            if (v.getInschrijving() != null) {
                resultaat = v.getInschrijving().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
