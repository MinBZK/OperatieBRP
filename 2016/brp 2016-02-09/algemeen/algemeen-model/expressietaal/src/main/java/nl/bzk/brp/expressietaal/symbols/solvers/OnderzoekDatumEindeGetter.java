...
/**
 * Getter voor 'datum_einde' in objecttype 'Onderzoek'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OnderzoekDatumEindeGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            ...
            if (v.getStandaard() != null) {
                resultaat = v.getStandaard().getDatumEinde();
            }
        } else if (brpObject instanceof OnderzoekHisVolledig) {
            ...
            if (v.getOnderzoekHistorie() != null && v.getOnderzoekHistorie().getActueleRecord() != null) {
                resultaat = v.getOnderzoekHistorie().getActueleRecord().getDatumEinde();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Onderzoek) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumEinde());
            }
        }
        return attributen;
    }
