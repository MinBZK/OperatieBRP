...
/**
 * Getter voor groepattribuut 'verantwoordingAanpassingGeldigheid.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonnationaliteitVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteitHisMoment) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getStandaard().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
        }
        return resultaat;
    }
