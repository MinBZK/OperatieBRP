...
/**
 * Getter voor tijdstip verval van indicatie 'indicatie.derde_heeft_gezag.datum_tijd_verval' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieDerdeHeeftGezag() != null) {
                resultaat = p.getIndicatieDerdeHeeftGezag().getPersoonIndicatieHistorie().getActueleRecord().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
