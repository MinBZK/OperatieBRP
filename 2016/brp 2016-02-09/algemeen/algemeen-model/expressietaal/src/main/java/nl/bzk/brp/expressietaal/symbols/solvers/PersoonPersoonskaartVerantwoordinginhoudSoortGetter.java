...
/**
 * Getter voor groepattribuut 'persoonskaart.verantwoordingInhoud.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonPersoonskaartVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getPersoonskaart() != null && v.getPersoonskaart().getVerantwoordingInhoud() != null) {
                resultaat = v.getPersoonskaart().getVerantwoordingInhoud().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
