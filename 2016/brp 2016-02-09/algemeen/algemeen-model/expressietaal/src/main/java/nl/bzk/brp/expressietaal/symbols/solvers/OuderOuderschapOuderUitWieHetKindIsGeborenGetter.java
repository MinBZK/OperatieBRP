...
/**
 * Getter voor 'ouderschap.ouder_uit_wie_het_kind_is_geboren' in objecttype 'Ouder'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapOuderUitWieHetKindIsGeborenGetter implements AttributeGetter {
