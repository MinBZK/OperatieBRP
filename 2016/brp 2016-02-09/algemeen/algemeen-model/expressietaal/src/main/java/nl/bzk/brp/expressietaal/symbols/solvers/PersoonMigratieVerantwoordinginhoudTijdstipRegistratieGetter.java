...
/**
 * Getter voor groepattribuut 'migratie.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getMigratie() != null && v.getMigratie().getVerantwoordingInhoud() != null) {
                resultaat = v.getMigratie().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
            ...
            if (v.getPersoonMigratieHistorie() != null
                ...
                && v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingInhoud() != null)
            {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
