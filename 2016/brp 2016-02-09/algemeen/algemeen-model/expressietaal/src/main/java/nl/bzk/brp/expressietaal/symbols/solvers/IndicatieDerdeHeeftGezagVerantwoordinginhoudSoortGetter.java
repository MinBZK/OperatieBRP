...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.derde_heeft_gezag.verantwoordingInhoud.soort' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieDerdeHeeftGezagVerantwoordinginhoudSoortGetter implements AttributeGetter {
