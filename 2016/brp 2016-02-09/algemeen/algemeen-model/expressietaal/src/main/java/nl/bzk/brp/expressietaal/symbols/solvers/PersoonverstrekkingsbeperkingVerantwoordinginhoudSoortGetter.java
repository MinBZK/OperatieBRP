...
public class PersoonverstrekkingsbeperkingVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisMoment) {
            ...
            if (v.getIdentiteit() != null && v.getIdentiteit().getVerantwoordingInhoud() != null) {
                resultaat = v.getIdentiteit().getVerantwoordingInhoud().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
