...
/**
 * Getter voor groepattribuut 'datum_tijd_registratie' in objecttype 'HisPersoonGeslachtsnaamcomponent'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoongeslachtsnaamcomponentDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonGeslachtsnaamcomponentHisVolledig) {
            ...
            if (v.getPersoonGeslachtsnaamcomponentHistorie() != null && v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeslachtsnaamcomponentHistorie().getActueleRecord().getTijdstipRegistratie();
            }
