...
public class PersoonnationaliteitVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonNationaliteitHisMoment) {
            ...
            {
                resultaat = v.getPersoonNationaliteitHistorie().getActueleRecord().getVerantwoordingInhoud().getDatumOntlening();
            }
        }
        return resultaat;
    }
