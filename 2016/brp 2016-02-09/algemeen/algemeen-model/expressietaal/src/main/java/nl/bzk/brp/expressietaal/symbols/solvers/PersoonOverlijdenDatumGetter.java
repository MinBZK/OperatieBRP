...
/**
 * Getter voor 'overlijden.datum' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonOverlijdenDatumGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null) {
                resultaat = v.getOverlijden().getDatumOverlijden();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonOverlijdenHistorie() != null && v.getPersoonOverlijdenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonOverlijdenHistorie().getActueleRecord().getDatumOverlijden();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getDatumOverlijden());
            }
        }
        return attributen;
    }
