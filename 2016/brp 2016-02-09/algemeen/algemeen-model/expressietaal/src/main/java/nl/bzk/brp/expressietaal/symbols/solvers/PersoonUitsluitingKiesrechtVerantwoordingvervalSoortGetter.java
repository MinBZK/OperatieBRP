...
/**
 * Getter voor groepattribuut 'uitsluiting_kiesrecht.verantwoordingVerval.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonUitsluitingKiesrechtVerantwoordingvervalSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getUitsluitingKiesrecht() != null && v.getUitsluitingKiesrecht().getVerantwoordingVerval() != null) {
                resultaat = v.getUitsluitingKiesrecht().getVerantwoordingVerval().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonUitsluitingKiesrechtHistorie().getActueleRecord().getVerantwoordingVerval().getSoort();
            }
        }
        return resultaat;
    }
