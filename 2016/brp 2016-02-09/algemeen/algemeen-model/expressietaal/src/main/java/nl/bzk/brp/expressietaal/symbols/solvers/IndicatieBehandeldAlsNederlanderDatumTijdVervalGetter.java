...
/**
 * Getter voor tijdstip verval van indicatie 'indicatie.behandeld_als_nederlander.datum_tijd_verval' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieBehandeldAlsNederlander() != null) {
                resultaat = p.getIndicatieBehandeldAlsNederlander().getPersoonIndicatieHistorie().getActueleRecord().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
