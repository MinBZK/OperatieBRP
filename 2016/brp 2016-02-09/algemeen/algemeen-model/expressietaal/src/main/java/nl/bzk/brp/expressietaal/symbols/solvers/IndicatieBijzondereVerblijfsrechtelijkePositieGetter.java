...
/**
 * Getter voor indicatie 'indicatie.bijzondere_verblijfsrechtelijke_positie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (p.getIndicatieBijzondereVerblijfsrechtelijkePositie() != null
                && p.getIndicatieBijzondereVerblijfsrechtelijkePositie().getStandaard() != null)
            {
                resultaat = p.getIndicatieBijzondereVerblijfsrechtelijkePositie().getStandaard().getWaarde();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieBijzondereVerblijfsrechtelijkePositie() != null) {
                resultaat = p.getIndicatieBijzondereVerblijfsrechtelijkePositie().getPersoonIndicatieHistorie().getActueleRecord().getWaarde();
            }
        }
        return resultaat;
    }
