 ...
 * 'indicatie.onder_curatele.verantwoordingVerval.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
