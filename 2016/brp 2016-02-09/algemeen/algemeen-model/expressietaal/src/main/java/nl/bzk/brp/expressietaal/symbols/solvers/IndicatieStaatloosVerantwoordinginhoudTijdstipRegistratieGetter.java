...
/**
 * Getter voor TSReg van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingInhoud.tijdstip_registratie'
 * in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie indicatie = persoonHisMoment.getIndicatieStaatloos();
            if (indicatie != null) {
            ...
            if (p.getIndicatieStaatloos() != null) {
                final ActieModel actieModel = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingInhoud();
                if (actieModel != null) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieStaatloos() != null) {
                final Iterator<HisPersoonIndicatieStaatloosModel> iterator = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().iterator();
