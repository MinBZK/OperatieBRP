...
/**
 * Getter voor groepattribuut 'migratie.verantwoordingAanpassingGeldigheid.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonMigratieVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getMigratie() != null && v.getMigratie().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getMigratie().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonMigratieHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getSoort();
            }
        }
        return resultaat;
    }
