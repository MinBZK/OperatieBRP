...
/**
 * Getter voor 'bijzondere_verblijfsrechtelijke_positie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonBijzondereVerblijfsrechtelijkePositieGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getIndicatieBijzondereVerblijfsrechtelijkePositie().getStandaard();
        }
        return resultaat;
    }
    ...
    public final List<Groep> getHistorischeGroepen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            final Iterator<nl.bzk.brp.model.operationeel.kern.HisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel> iterator =
                    p.getIndicatieBijzondereVerblijfsrechtelijkePositie().getPersoonIndicatieHistorie().getHistorie().iterator();
