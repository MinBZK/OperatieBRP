...
/**
 * Getter voor partij van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingVerval.partij' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordingvervalPartijGetter implements AttributeGetter {
