...
/**
 * Getter voor groepattribuut 'administratief.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonAdministratiefVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getAfgeleidAdministratief() != null && v.getAfgeleidAdministratief().getVerantwoordingInhoud() != null) {
                resultaat = v.getAfgeleidAdministratief().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig v = (PersoonHisVolledig) brpObject;
            if (v.getPersoonAfgeleidAdministratiefHistorie() != null
                && v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord() != null
                && v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingInhoud() != null)
            {
                resultaat = v.getPersoonAfgeleidAdministratiefHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            while (iterator.hasNext()) {
                final nl.bzk.brp.model.operationeel.kern.HisPersoonAfgeleidAdministratiefModel hisModel = iterator.next();
