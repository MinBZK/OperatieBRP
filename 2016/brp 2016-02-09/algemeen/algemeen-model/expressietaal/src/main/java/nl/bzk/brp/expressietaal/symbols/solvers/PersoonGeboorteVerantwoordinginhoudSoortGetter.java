...
/**
 * Getter voor groepattribuut 'geboorte.verantwoordingInhoud.soort' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeboorteVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeboorte() != null && v.getGeboorte().getVerantwoordingInhoud() != null) {
                resultaat = v.getGeboorte().getVerantwoordingInhoud().getSoort();
            }
            ...
            {
                resultaat = v.getPersoonGeboorteHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
