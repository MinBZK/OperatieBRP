...
/**
 * Getter voor groepattribuut 'persoonskaart.verantwoordingVerval.partij' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonPersoonskaartVerantwoordingvervalPartijGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getPersoonskaart() != null && v.getPersoonskaart().getVerantwoordingVerval() != null) {
                resultaat = v.getPersoonskaart().getVerantwoordingVerval().getPartij();
            }
            ...
            {
                resultaat = v.getPersoonPersoonskaartHistorie().getActueleRecord().getVerantwoordingVerval().getPartij();
            }
        }
        return resultaat;
    }
