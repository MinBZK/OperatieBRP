...
/**
 * Getter voor groepattribuut 'naamgebruik.datum_tijd_verval' in objecttype 'HisPersoonNaamgebruik'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonNaamgebruikDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonNaamgebruikHistorie() != null && v.getPersoonNaamgebruikHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNaamgebruikHistorie().getActueleRecord().getDatumTijdVerval();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getNaamgebruik() != null) {
                resultaat = v.getNaamgebruik().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
