...
/**
 * Getter voor groepattribuut 'ouderschap.verantwoordingVerval.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderschap() != null && v.getOuderschap().getVerantwoordingVerval() != null) {
                resultaat = v.getOuderschap().getVerantwoordingVerval().getTijdstipRegistratie();
            }
            ...
            if (v.getOuderOuderschapHistorie() != null
                ...
                && v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingVerval() != null)
            {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
