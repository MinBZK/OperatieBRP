...
/**
 * Getter voor 'deelname_eu_verkiezingen.deelname_eu_verkiezingen' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonDeelnameEuVerkiezingenDeelnameEuVerkiezingenGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getDeelnameEUVerkiezingen() != null) {
                resultaat = v.getDeelnameEUVerkiezingen().getIndicatieDeelnameEUVerkiezingen();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonDeelnameEUVerkiezingenHistorie() != null && v.getPersoonDeelnameEUVerkiezingenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonDeelnameEUVerkiezingenHistorie().getActueleRecord().getIndicatieDeelnameEUVerkiezingen();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieDeelnameEUVerkiezingen());
            }
        }
        return attributen;
    }
