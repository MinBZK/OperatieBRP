...
/**
 * Getter voor datum aanvang geldigheid van indicatie 'indicatie.onder_curatele.datum_aanvang_geldigheid' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleDatumAanvangGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            final PersoonIndicatie persoonIndicatie = persoonHisMoment.getIndicatieOnderCuratele();
            ...
            if (p.getIndicatieOnderCuratele() != null) {
                resultaat = p.getIndicatieOnderCuratele().getPersoonIndicatieHistorie().getActueleRecord().getDatumAanvangGeldigheid();
            }
        }
        return resultaat;
    }
