...
/**
 * Getter voor TSReg van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingVerval.tijdstip_registratie'
 * in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieStaatloos() != null) {
                final ActieModel actieModel = p.getIndicatieStaatloos().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingVerval();
                if (actieModel != null) {
