...
public class PersoonverstrekkingsbeperkingVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisMoment) {
            ...
            if (v.getIdentiteit() != null && v.getIdentiteit().getVerantwoordingInhoud() != null) {
                resultaat = v.getIdentiteit().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
            ...
            {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
