...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.staatloos.verantwoordingInhoud.soort' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieStaatloosVerantwoordinginhoudSoortGetter implements AttributeGetter {
