...
/**
 * Getter voor groepattribuut 'datum_tijd_verval' in objecttype 'HisPersoonVerstrekkingsbeperking'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonverstrekkingsbeperkingDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVerstrekkingsbeperkingHisVolledig) {
            ...
            if (v.getPersoonVerstrekkingsbeperkingHistorie() != null && v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVerstrekkingsbeperkingHistorie().getActueleRecord().getDatumTijdVerval();
            }
        } else if (brpObject instanceof PersoonVerstrekkingsbeperkingHisMoment) {
            final PersoonVerstrekkingsbeperkingHisMoment v = (PersoonVerstrekkingsbeperkingHisMoment) brpObject;
            if (v.getIdentiteit() != null) {
                resultaat = v.getIdentiteit().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
