...
/**
 * Getter voor indicatie 'indicatie.vastgesteld_niet_nederlander' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (p.getIndicatieVastgesteldNietNederlander() != null && p.getIndicatieVastgesteldNietNederlander().getStandaard() != null) {
                resultaat = p.getIndicatieVastgesteldNietNederlander().getStandaard().getWaarde();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            final PersoonHisVolledig p = (PersoonHisVolledig) brpObject;
            if (p.getIndicatieVastgesteldNietNederlander() != null) {
                resultaat = p.getIndicatieVastgesteldNietNederlander().getPersoonIndicatieHistorie().getActueleRecord().getWaarde();
            }
        }
        return resultaat;
    }
