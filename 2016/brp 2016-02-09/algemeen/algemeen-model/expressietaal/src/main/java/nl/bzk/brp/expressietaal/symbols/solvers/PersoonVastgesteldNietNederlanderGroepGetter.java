...
/**
 * Getter voor 'vastgesteld_niet_nederlander' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonVastgesteldNietNederlanderGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getIndicatieVastgesteldNietNederlander().getStandaard();
        }
        return resultaat;
    }
    ...
    public final List<Groep> getHistorischeGroepen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            final Iterator<nl.bzk.brp.model.operationeel.kern.HisPersoonIndicatieVastgesteldNietNederlanderModel> iterator =
                    p.getIndicatieVastgesteldNietNederlander().getPersoonIndicatieHistorie().getHistorie().iterator();
