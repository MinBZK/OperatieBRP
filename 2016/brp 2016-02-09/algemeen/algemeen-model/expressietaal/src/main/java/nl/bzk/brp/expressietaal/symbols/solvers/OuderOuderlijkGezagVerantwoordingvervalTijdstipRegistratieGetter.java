...
/**
 * Getter voor groepattribuut 'ouderlijk_gezag.verantwoordingVerval.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof OuderHisMoment) {
            ...
            if (v.getOuderlijkGezag() != null && v.getOuderlijkGezag().getVerantwoordingVerval() != null) {
                resultaat = v.getOuderlijkGezag().getVerantwoordingVerval().getTijdstipRegistratie();
            }
            ...
            if (v.getOuderOuderlijkGezagHistorie() != null
                ...
                && v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingVerval() != null)
            {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getVerantwoordingVerval().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
