...
/**
 * Getter voor 'ouderschap.ouder' in objecttype 'Ouder'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderschapOuderGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Ouder) {
            ...
            if (v.getOuderschap() != null) {
                resultaat = v.getOuderschap().getIndicatieOuder();
            }
        } else if (brpObject instanceof OuderHisVolledig) {
            ...
            if (v.getOuderOuderschapHistorie() != null && v.getOuderOuderschapHistorie().getActueleRecord() != null) {
                resultaat = v.getOuderOuderschapHistorie().getActueleRecord().getIndicatieOuder();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Ouder) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieOuder());
            }
        }
        return attributen;
    }
