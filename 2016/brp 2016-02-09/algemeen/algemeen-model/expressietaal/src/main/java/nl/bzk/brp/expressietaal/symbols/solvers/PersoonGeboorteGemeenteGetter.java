    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getGeboorte() != null) {
                resultaat = v.getGeboorte().getGemeenteGeboorte();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonGeboorteHistorie() != null && v.getPersoonGeboorteHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeboorteHistorie().getActueleRecord().getGemeenteGeboorte();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getGemeenteGeboorte());
            }
        }
        return attributen;
    }
