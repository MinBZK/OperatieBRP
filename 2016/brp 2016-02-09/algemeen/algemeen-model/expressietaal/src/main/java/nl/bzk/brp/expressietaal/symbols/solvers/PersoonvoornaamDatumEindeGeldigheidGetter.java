...
/**
 * Getter voor groepattribuut 'datum_einde_geldigheid' in objecttype 'HisPersoonVoornaam'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonvoornaamDatumEindeGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonVoornaamHisVolledig) {
            ...
            if (v.getPersoonVoornaamHistorie() != null && v.getPersoonVoornaamHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonVoornaamHistorie().getActueleRecord().getDatumEindeGeldigheid();
            }
