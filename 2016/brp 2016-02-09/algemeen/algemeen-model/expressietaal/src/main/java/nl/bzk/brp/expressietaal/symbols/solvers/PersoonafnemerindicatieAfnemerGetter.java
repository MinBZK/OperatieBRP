...
/**
 * Getter voor 'afnemer' in objecttype 'PersoonAfnemerindicatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonafnemerindicatieAfnemerGetter implements AttributeGetter {
