 ...
 * 'indicatie.behandeld_als_nederlander.verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
