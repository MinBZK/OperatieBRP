...
/**
 * Getter voor groepattribuut 'overlijden.datum_tijd_registratie' in objecttype 'HisPersoonOverlijden'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonOverlijdenDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonOverlijdenHistorie() != null && v.getPersoonOverlijdenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonOverlijdenHistorie().getActueleRecord().getTijdstipRegistratie();
            }
        } else if (brpObject instanceof PersoonHisMoment) {
            final PersoonHisMoment v = (PersoonHisMoment) brpObject;
            if (v.getOverlijden() != null) {
                resultaat = v.getOverlijden().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
