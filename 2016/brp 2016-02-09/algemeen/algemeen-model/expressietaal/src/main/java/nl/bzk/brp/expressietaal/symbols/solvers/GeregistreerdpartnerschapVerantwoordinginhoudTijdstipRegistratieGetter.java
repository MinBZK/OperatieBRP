...
/**
 * Getter voor groepattribuut 'verantwoordingInhoud.tijdstip_registratie' in objecttype 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class GeregistreerdpartnerschapVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof RelatieHisMoment) {
            ...
            if (v.getStandaard() != null && v.getStandaard().getVerantwoordingInhoud() != null) {
                resultaat = v.getStandaard().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        } else if (brpObject instanceof GeregistreerdPartnerschapHisVolledig) {
            final GeregistreerdPartnerschapHisVolledig v = (GeregistreerdPartnerschapHisVolledig) brpObject;
            ...
            {
                resultaat = v.getRelatieHistorie().getActueleRecord().getVerantwoordingInhoud().getTijdstipRegistratie();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof GeregistreerdPartnerschapHisVolledig) {
            final GeregistreerdPartnerschapHisVolledig p = (GeregistreerdPartnerschapHisVolledig) brpObject;
