...
public class GeregistreerdpartnerschapVerantwoordinginhoudSoortGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof RelatieHisMoment) {
            ...
            {
                resultaat = v.getRelatieHistorie().getActueleRecord().getVerantwoordingInhoud().getSoort();
            }
        }
        return resultaat;
    }
