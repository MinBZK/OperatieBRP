...
/**
 * Getter voor 'naamgebruik.geslachtsnaamstam' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonNaamgebruikGeslachtsnaamstamGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getNaamgebruik() != null) {
                resultaat = v.getNaamgebruik().getGeslachtsnaamstamNaamgebruik();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonNaamgebruikHistorie() != null && v.getPersoonNaamgebruikHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonNaamgebruikHistorie().getActueleRecord().getGeslachtsnaamstamNaamgebruik();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getGeslachtsnaamstamNaamgebruik());
            }
        }
        return attributen;
    }
