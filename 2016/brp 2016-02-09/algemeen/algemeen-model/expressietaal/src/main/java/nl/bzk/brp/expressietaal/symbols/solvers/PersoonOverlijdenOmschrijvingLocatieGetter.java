...
/**
 * Getter voor 'overlijden.omschrijving_locatie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonOverlijdenOmschrijvingLocatieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getOverlijden() != null) {
                resultaat = v.getOverlijden().getOmschrijvingLocatieOverlijden();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonOverlijdenHistorie() != null && v.getPersoonOverlijdenHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonOverlijdenHistorie().getActueleRecord().getOmschrijvingLocatieOverlijden();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getOmschrijvingLocatieOverlijden());
            }
        }
        return attributen;
    }
