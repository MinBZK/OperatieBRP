 ...
 * 'indicatie.volledige_verstrekkingsbeperking.verantwoordingInhoud.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVolledigeVerstrekkingsbeperkingVerantwoordinginhoudDatumOntleningGetter implements AttributeGetter {
