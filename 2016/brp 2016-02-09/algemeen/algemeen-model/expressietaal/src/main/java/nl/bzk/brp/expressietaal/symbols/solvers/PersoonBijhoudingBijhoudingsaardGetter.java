...
/**
 * Getter voor 'bijhouding.bijhoudingsaard' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonBijhoudingBijhoudingsaardGetter implements AttributeGetter {
    ...
    public final Expressie getAttribuutWaarde(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (attribuut != null) {
                resultaat = new StringLiteralExpressie(((BijhoudingsaardAttribuut) attribuut).getWaarde().getCode());
            }
            ...
            if (attributen != null) {
                ...
                for (final Attribuut attribuut : attributen) {
                    if (attribuut != null) {
                        elementen.add(new StringLiteralExpressie(((BijhoudingsaardAttribuut) attribuut).getWaarde().getCode()));
                    }
                }
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getBijhouding() != null) {
                resultaat = v.getBijhouding().getBijhoudingsaard();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getBijhoudingsaard());
            }
        }
        return attributen;
    }
