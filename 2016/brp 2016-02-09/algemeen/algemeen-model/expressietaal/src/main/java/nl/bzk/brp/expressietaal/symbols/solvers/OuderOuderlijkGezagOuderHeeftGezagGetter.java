...
/**
 * Getter voor 'ouderlijk_gezag.ouder_heeft_gezag' in objecttype 'Ouder'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class OuderOuderlijkGezagOuderHeeftGezagGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Ouder) {
            ...
            if (v.getOuderlijkGezag() != null) {
                resultaat = v.getOuderlijkGezag().getIndicatieOuderHeeftGezag();
            }
        } else if (brpObject instanceof OuderHisVolledig) {
            ...
            if (v.getOuderOuderlijkGezagHistorie() != null && v.getOuderOuderlijkGezagHistorie().getActueleRecord() != null) {
                resultaat = v.getOuderOuderlijkGezagHistorie().getActueleRecord().getIndicatieOuderHeeftGezag();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Ouder) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getIndicatieOuderHeeftGezag());
            }
        }
        return attributen;
    }
