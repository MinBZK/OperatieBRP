 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingInhoud.tijdstip_registratie' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieBijzondereVerblijfsrechtelijkePositie() != null) {
                final ActieModel actieModel =
                        p.getIndicatieBijzondereVerblijfsrechtelijkePositie().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingInhoud();
                if (actieModel != null) {
