...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.verantwoordingAanpassingGeldigheid.datum_ontlening' in objecttype
 * 'Actie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (v.getGeslachtsaanduiding() != null && v.getGeslachtsaanduiding().getVerantwoordingAanpassingGeldigheid() != null) {
                resultaat = v.getGeslachtsaanduiding().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
            ...
            if (v.getPersoonGeslachtsaanduidingHistorie() != null
                ...
                && v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid() != null)
            {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
        }
        return resultaat;
    }
