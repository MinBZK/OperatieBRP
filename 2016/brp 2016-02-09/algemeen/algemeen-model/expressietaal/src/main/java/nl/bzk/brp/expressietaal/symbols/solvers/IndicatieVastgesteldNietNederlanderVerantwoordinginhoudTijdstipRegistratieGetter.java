 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingInhoud.tijdstip_registratie' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordinginhoudTijdstipRegistratieGetter implements AttributeGetter {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieVastgesteldNietNederlander() != null) {
                final ActieModel actieModel =
                        p.getIndicatieVastgesteldNietNederlander().getPersoonIndicatieHistorie().getActueleRecord().getVerantwoordingInhoud();
                if (actieModel != null) {
