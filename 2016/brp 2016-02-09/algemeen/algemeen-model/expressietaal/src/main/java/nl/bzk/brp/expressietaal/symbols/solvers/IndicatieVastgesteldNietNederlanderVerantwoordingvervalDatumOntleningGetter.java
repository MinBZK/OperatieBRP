 ...
 * 'indicatie.vastgesteld_niet_nederlander.verantwoordingVerval.datum_ontlening' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieVastgesteldNietNederlanderVerantwoordingvervalDatumOntleningGetter implements AttributeGetter {
