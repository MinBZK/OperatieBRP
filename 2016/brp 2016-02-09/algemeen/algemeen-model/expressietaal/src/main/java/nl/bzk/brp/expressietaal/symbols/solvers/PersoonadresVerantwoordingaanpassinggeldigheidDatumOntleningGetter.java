...
public class PersoonadresVerantwoordingaanpassinggeldigheidDatumOntleningGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAdresHisMoment) {
            ...
            {
                resultaat = v.getPersoonAdresHistorie().getActueleRecord().getVerantwoordingAanpassingGeldigheid().getDatumOntlening();
            }
        }
        return resultaat;
    }
