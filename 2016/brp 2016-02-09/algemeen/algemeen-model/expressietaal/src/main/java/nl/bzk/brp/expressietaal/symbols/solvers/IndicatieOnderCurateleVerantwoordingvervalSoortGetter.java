...
/**
 * Getter voor soort van de verantwoording van indicatie 'indicatie.onder_curatele.verantwoordingVerval.soort' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieOnderCurateleVerantwoordingvervalSoortGetter implements AttributeGetter {
