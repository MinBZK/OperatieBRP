 ...
 * 'indicatie.bijzondere_verblijfsrechtelijke_positie.verantwoordingVerval.tijdstip_registratie' in objecttype
 * 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieVerantwoordingvervalTijdstipRegistratieGetter implements AttributeGetter {
