...
/**
 * Getter voor 'onder.curatele' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGroepGenerator")
public class PersoonOnderCurateleGroepGetter implements GroepGetter {
    ...
    public final Groep getGroep(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            resultaat = v.getIndicatieOnderCuratele().getStandaard();
        }
        return resultaat;
    }
    ...
    public final List<Groep> getHistorischeGroepen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            final Iterator<nl.bzk.brp.model.operationeel.kern.HisPersoonIndicatieOnderCurateleModel> iterator =
                    p.getIndicatieOnderCuratele().getPersoonIndicatieHistorie().getHistorie().iterator();
