...
/**
 * Getter voor groepattribuut 'geslachtsaanduiding.datum_einde_geldigheid' in objecttype
 * 'HisPersoonGeslachtsaanduiding'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonGeslachtsaanduidingDatumEindeGeldigheidGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonGeslachtsaanduidingHistorie() != null && v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonGeslachtsaanduidingHistorie().getActueleRecord().getDatumEindeGeldigheid();
            }
            ...
            if (v.getGeslachtsaanduiding() != null) {
                resultaat = v.getGeslachtsaanduiding().getDatumEindeGeldigheid();
            }
        }
        return resultaat;
    }
