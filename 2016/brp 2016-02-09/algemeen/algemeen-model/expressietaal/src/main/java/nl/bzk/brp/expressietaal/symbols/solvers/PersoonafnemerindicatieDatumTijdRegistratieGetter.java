...
/**
 * Getter voor groepattribuut 'datum_tijd_registratie' in objecttype 'HisPersoonAfnemerindicatie'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonafnemerindicatieDatumTijdRegistratieGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonAfnemerindicatieHisVolledig) {
            ...
            if (v.getPersoonAfnemerindicatieHistorie() != null && v.getPersoonAfnemerindicatieHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonAfnemerindicatieHistorie().getActueleRecord().getTijdstipRegistratie();
            }
