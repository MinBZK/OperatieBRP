...
/**
 * Getter voor 'inschrijving.versienummer' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class PersoonInschrijvingVersienummerGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            if (v.getInschrijving() != null) {
                resultaat = v.getInschrijving().getVersienummer();
            }
        } else if (brpObject instanceof PersoonHisVolledig) {
            ...
            if (v.getPersoonInschrijvingHistorie() != null && v.getPersoonInschrijvingHistorie().getActueleRecord() != null) {
                resultaat = v.getPersoonInschrijvingHistorie().getActueleRecord().getVersienummer();
            }
        }
        return resultaat;
    }
    ...
    public final List<Attribuut> getHistorischeAttributen(final BrpObject brpObject) {
        ...
        if (brpObject instanceof Persoon) {
            ...
            while (iterator.hasNext()) {
                attributen.add(iterator.next().getVersienummer());
            }
        }
        return attributen;
    }
