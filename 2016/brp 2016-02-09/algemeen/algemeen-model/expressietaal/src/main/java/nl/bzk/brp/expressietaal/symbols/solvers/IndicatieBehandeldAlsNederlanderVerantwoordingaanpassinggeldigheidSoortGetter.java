 ...
 * 'indicatie.behandeld_als_nederlander.verantwoordingAanpassingGeldigheid.soort' in objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBehandeldAlsNederlanderVerantwoordingaanpassinggeldigheidSoortGetter implements AttributeGetter {
