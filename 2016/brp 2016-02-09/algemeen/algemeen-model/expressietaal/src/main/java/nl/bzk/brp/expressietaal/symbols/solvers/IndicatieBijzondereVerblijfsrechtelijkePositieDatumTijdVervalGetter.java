...
/**
 * Getter voor tijdstip verval van indicatie 'indicatie.bijzondere_verblijfsrechtelijke_positie.datum_tijd_verval' in
 * objecttype 'Persoon'.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.SymbolTableGenerator")
public class IndicatieBijzondereVerblijfsrechtelijkePositieDatumTijdVervalGetter implements AttributeGetter {
    ...
    public final Attribuut getAttribuut(final BrpObject brpObject) {
        ...
        if (brpObject instanceof PersoonHisMoment) {
            ...
            if (p.getIndicatieBijzondereVerblijfsrechtelijkePositie() != null) {
                resultaat = p.getIndicatieBijzondereVerblijfsrechtelijkePositie().getPersoonIndicatieHistorie().getActueleRecord().getDatumTijdVerval();
            }
        }
        return resultaat;
    }
