...
public class PersoonIndicatieOnderCurateleHisVolledigImplBuilder extends
        PersoonIndicatieHisVolledigImplBuilder<HisPersoonIndicatieOnderCurateleModel, PersoonIndicatieOnderCurateleHisVolledigImplBuilder>
{
     ...
     */
    public PersoonIndicatieOnderCurateleHisVolledigImplBuilder(final PersoonHisVolledigImpl persoon) {
        super(persoon);
    }
     ...
     */
    public PersoonIndicatieOnderCurateleHisVolledigImplBuilder(final PersoonHisVolledigImpl persoon, final boolean defaultMagGeleverdWordenVoorAttributen)
    {
     ...
     *
     */
    public PersoonIndicatieOnderCurateleHisVolledigImplBuilder() {
        super();
    }
     ...
     * @param defaultMagGeleverdWordenVoorAttributen default waarde voor magGeleverdWorden voor attributen.
     */
    public PersoonIndicatieOnderCurateleHisVolledigImplBuilder(final boolean defaultMagGeleverdWordenVoorAttributen) {
     ...
     */
    @Override
    protected PersoonIndicatieOnderCurateleHisVolledigImpl maakPersoonIndicatieHisVolledig(final PersoonHisVolledigImpl persoon) {
        return new PersoonIndicatieOnderCurateleHisVolledigImpl(persoon);
    }
     ...
     */
    @Override
    protected HisPersoonIndicatieOnderCurateleModel maakHisPersoonIndicatieModel(final PersoonIndicatieStandaardGroep groep, final ActieModel actie) {
        HisPersoonIndicatieOnderCurateleModel record = new HisPersoonIndicatieOnderCurateleModel(build(), groep, actie, actie);
     ...
     */
    @Override
    public PersoonIndicatieOnderCurateleHisVolledigImpl build() {
        return (PersoonIndicatieOnderCurateleHisVolledigImpl) getHisVolledigImpl();
    }
