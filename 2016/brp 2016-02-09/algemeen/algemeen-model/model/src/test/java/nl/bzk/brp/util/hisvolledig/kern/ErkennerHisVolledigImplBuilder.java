...
/**
 * Builder klasse voor Erkenner.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigBuilderGenerator")
public class ErkennerHisVolledigImplBuilder {

    private ErkennerHisVolledigImpl hisVolledigImpl;
     ...
     */
    public ErkennerHisVolledigImplBuilder(final RelatieHisVolledigImpl relatie, final PersoonHisVolledigImpl persoon) {
        this.hisVolledigImpl = new ErkennerHisVolledigImpl(relatie, persoon);
    }
     ...
     */
    public ErkennerHisVolledigImplBuilder metVerantwoording(final ActieModel actie) {
     ...
     */
    public ErkennerHisVolledigImpl build() {
