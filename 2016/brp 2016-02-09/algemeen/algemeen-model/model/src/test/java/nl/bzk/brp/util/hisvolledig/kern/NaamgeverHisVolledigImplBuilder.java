...
/**
 * Builder klasse voor Naamgever.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigBuilderGenerator")
public class NaamgeverHisVolledigImplBuilder {

    private NaamgeverHisVolledigImpl hisVolledigImpl;
     ...
     */
    public NaamgeverHisVolledigImplBuilder(final RelatieHisVolledigImpl relatie, final PersoonHisVolledigImpl persoon) {
        this.hisVolledigImpl = new NaamgeverHisVolledigImpl(relatie, persoon);
    }
     ...
     */
    public NaamgeverHisVolledigImplBuilder metVerantwoording(final ActieModel actie) {
     ...
     */
    public NaamgeverHisVolledigImpl build() {
