...
public class LegeContainerPersoonOpAdresMetBetrokkenhedenTest extends
    AbstractVraagBerichtBindingUitIntegratieTest<GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht>
{
    ...
    @Test
    public void verwijdertMeldingenEnPersonenContainerAlsContainerLeeg() throws JiBXException, SAXException, IOException, XpathException {
        final GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht bericht = maakBericht();
    ...
    @Test
    public void verwijdertLegeContainersBinnenPersoonAlsContainerLeeg() throws JiBXException, SAXException, IOException, XpathException {
    ...
    @Test
    public void verwijdertAdministratieveHandelingenChildContainersAlsContainersLeeg() throws JiBXException, SAXException, IOException, XpathException {
        final PersoonHisVolledigImpl persoon = TestPersoonJohnnyJordaan.maak();
    ...
    @Test
    public void verwijdertLegeGerelateerdeBetrokkenhedenContainerAlsContainerLeeg() throws JiBXException, SAXException, IOException, XpathException {
        final PersoonHisVolledigImpl persoon = TestPersoonJohnnyJordaan.maak();
     ...
     * @return vul bericht
     */
    private GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht maakBericht() {
        final GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht bericht = new GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht();
    ...
    @Override
    protected Class<GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht> getBindingClass() {
