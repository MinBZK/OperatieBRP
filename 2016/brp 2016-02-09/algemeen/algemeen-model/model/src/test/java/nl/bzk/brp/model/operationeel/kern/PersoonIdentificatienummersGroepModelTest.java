...
public class PersoonIdentificatienummersGroepModelTest {
    ...
    public void testEquals() {
        ...
        Assert.assertNotEquals(identificatienummers, null);
        Assert.assertFalse(identificatienummers.equals(new BurgerservicenummerAttribuut(123456789)));
    ...
    public void testHashCodeEquality() {
        ...
        Assert.assertTrue(identificatienummers.hashCode() != (new BurgerservicenummerAttribuut(123456789)).hashCode());
        ...
        Assert.assertTrue(
                identificatienummers.hashCode() != bouwNummers(null, Long.parseLong("0987654321")).hashCode());
        Assert.assertTrue(identificatienummers.hashCode() != bouwNummers(234567890, Long.parseLong("0987654321"))
                .hashCode());
        ...
        Assert.assertTrue(identificatienummers.hashCode() == bouwNummers(123456789, Long.parseLong("0987654321"))
                .hashCode());
    }

    /**
     * Methode die de sortering van een lijst van {@link PersoonIdentificatienummersGroepModel} instanties test,
     * waarmee impliciet de
     * {@link PersoonIdentificatienummersGroepModel#compareTo (PersoonIdentificatienummersGroepModel)} methode wordt
     * getest.
     */
    @Test
    ...
    private PersoonIdentificatienummersGroepModel bouwNummers(final Integer bsn, final Long aNummer) {
        final BurgerservicenummerAttribuut bsnObj;
        final AdministratienummerAttribuut aNummerObj;

        if (bsn == null) {
            bsnObj = null;
        } else {
            bsnObj = new BurgerservicenummerAttribuut(bsn);
        }

        if (aNummer == null) {
            aNummerObj = null;
        } else {
            aNummerObj = new AdministratienummerAttribuut(aNummer);
        }
