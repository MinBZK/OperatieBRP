...
public class CommunicatieIdMapTest {
    ...
    public void testVoegToeMetAndereKey() {
        List<BerichtIdentificeerbaar> lijst = new ArrayList<BerichtIdentificeerbaar>();
        List<BerichtIdentificeerbaar> lijstNullKey = new ArrayList<BerichtIdentificeerbaar>();
