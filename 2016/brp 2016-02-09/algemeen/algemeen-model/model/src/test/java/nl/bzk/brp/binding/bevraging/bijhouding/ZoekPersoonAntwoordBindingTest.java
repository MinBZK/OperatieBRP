...
public class ZoekPersoonAntwoordBindingTest extends
        AbstractVraagBerichtBindingUitIntegratieTest<ZoekPersoonAntwoordBericht>
{

    @Override
    public Class<ZoekPersoonAntwoordBericht> getBindingClass() {
        return ZoekPersoonAntwoordBericht.class;
    }
    ...
    public void testOutBindingMetLeegResultaat() throws JiBXException, IOException, SAXException {
        final ZoekPersoonAntwoordBericht response = new ZoekPersoonAntwoordBericht();
        response.setStuurgegevens(maakStuurgegevensVoorAntwoordBericht("12345678-1234-1234-1234-123456789123", "12345678-1234-1234-1234-123456789123"));
        ...
        final String verwachteWaarde = bouwVerwachteAntwoordBericht("antwoordbericht_zoekPersoon_leeg_resultaat.xml");
    ...
    public void testOutBindingMetMelding() throws JiBXException, IOException, SAXException {
        ...
        final String verwachteWaarde = bouwVerwachteAntwoordBericht("antwoordbericht_zoekPersoon_met_melding.xml");
        assertXMLEqual(verwachteWaarde, xml);
    ...
    public void testOutBindingMetPersoonInResultaat() throws Exception {
        ...
        final String verwachteWaarde = bouwVerwachteAntwoordBericht("antwoordbericht_zoekPersoon.xml");
