...
/**
 * Builder klasse voor Instemmer.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigBuilderGenerator")
public class InstemmerHisVolledigImplBuilder {

    private InstemmerHisVolledigImpl hisVolledigImpl;
     ...
     */
    public InstemmerHisVolledigImplBuilder(final RelatieHisVolledigImpl relatie, final PersoonHisVolledigImpl persoon) {
        this.hisVolledigImpl = new InstemmerHisVolledigImpl(relatie, persoon);
    }
     ...
     */
    public InstemmerHisVolledigImplBuilder metVerantwoording(final ActieModel actie) {
     ...
     */
    public InstemmerHisVolledigImpl build() {
