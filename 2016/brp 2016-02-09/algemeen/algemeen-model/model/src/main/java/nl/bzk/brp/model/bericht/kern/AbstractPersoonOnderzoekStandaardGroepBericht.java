...
public abstract class AbstractPersoonOnderzoekStandaardGroepBericht extends AbstractFormeleHistorieGroepBericht implements Groep,
        PersoonOnderzoekStandaardGroepBasis, MetaIdentificeerbaar
{

    private static final Integer META_ID = 10763;
    private static final List<Integer> ONDERLIGGENDE_ATTRIBUTEN = Arrays.asList(10771);
     ...
     * @param rol Rol.
     */
    public void setRol(final SoortPersoonOnderzoekAttribuut rol) {
        this.rol = rol;
    }
