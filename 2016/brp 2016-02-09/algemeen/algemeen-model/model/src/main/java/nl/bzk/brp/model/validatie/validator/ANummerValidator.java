 ...
 */
public class ANummerValidator implements ConstraintValidator<ANummer, AdministratienummerAttribuut> {
    ...
    @Override
    public final void initialize(final ANummer constraintAnnotation) {
        // Niets om te initialiseren.
    }

    @Override
    public final boolean isValid(final AdministratienummerAttribuut aNummer, final ConstraintValidatorContext context) {
        return aNummer == null || aNummer.getWaarde() == null || isGeldigAnummer(aNummer);
    }

    /**
     * Controleert of de waarde een geldig A-nummer is.
     *
