...
@MappedSuperclass
public abstract class AbstractHisPersoonIndicatieStaatloosModel extends AbstractHisPersoonIndicatieMaterieleHistorieModel implements
        ElementIdentificeerbaar
{
     ...
     *
     */
    protected AbstractHisPersoonIndicatieStaatloosModel() {
    }
     ...
     */
    public AbstractHisPersoonIndicatieStaatloosModel(
        final PersoonIndicatieStaatloosHisVolledigImpl persoonIndicatieHisVolledig,
     ...
     * @param kopie kopie
     */
    public AbstractHisPersoonIndicatieStaatloosModel(final AbstractHisPersoonIndicatieStaatloosModel kopie) {
        super(kopie);
    }
     ...
     */
    @Override
    public HisPersoonIndicatieStaatloosModel kopieer() {
        return new HisPersoonIndicatieStaatloosModel(this);
    }
