 ...
 *
 */
public abstract class BetrokkenheidPredikaatView extends AbstractBetrokkenheidPredikaatView implements ModelMoment, BetrokkenheidHisMoment,
    ElementIdentificeerbaar
{
     ...
     */
    public BetrokkenheidPredikaatView(final BetrokkenheidHisVolledig betrokkenheid, final Predicate predikaat) {
