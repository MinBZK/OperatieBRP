 ...
 * ��nduidig blijken wanneer er sprake is van ��n of van meerdere exemplaren. In geval van Huwelijk en Geregistreerd
 * partnerschap is een hertrouwen van twee dezelfde personen een NIEUW Huwelijk (het opnieuw aangaan van Geregistreerd
 * partnerschap is ��k een tweede exemplaar, en een omzetting van Huwelijk in Geregistreerd partnerschap of vice versa
 ...
 * alle uitsluitsel geven over of we het over '��n' of 'meer' exemplaren hebben.
 *
 *
 *
 */
public abstract class HuwelijkGeregistreerdPartnerschapBericht extends AbstractHuwelijkGeregistreerdPartnerschapBericht implements BrpObject,
        HuwelijkGeregistreerdPartnerschap
{
     ...
     */
    public HuwelijkGeregistreerdPartnerschapBericht(final SoortRelatieAttribuut soort) {
        super(soort);
    }
     ...
     */
    public final Set<PartnerBericht> getPartnerBetrokkenheden() {
    ...
    /**
     * Is aanvang in Nederland.
     *
     * @return of het aanvang is in Nederland
     */
    @Override
    public final boolean isAanvangInNederland() {
    ...
    @Valid
    @Override
    public final RelatieStandaardGroepBericht getStandaard() {
