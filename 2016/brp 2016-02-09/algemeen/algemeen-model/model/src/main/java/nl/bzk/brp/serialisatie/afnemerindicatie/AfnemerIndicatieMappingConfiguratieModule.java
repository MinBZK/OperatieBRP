 ...
 */
public final class AfnemerIndicatieMappingConfiguratieModule extends SimpleModule {

    /**
     * Default constructor, registreert deze module.
     */
    public AfnemerIndicatieMappingConfiguratieModule() {
        super("AfnemerIndicatieMappingConfiguratieModule", new Version(0, 1, 0, null, "nl.bzk.brp", "model"));
    }
}
