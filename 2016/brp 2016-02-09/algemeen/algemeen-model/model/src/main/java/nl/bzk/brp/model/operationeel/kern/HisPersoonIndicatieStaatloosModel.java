...
public class HisPersoonIndicatieStaatloosModel extends AbstractHisPersoonIndicatieStaatloosModel {

    /**
     * Default lege constructor t.b.v. Hibernate / JPA
     */
    protected HisPersoonIndicatieStaatloosModel() {
        super();
    }
     ...
     */
    public HisPersoonIndicatieStaatloosModel(
     ...
     */
    public HisPersoonIndicatieStaatloosModel(
        final PersoonIndicatieStaatloosHisVolledigImpl persoonIndicatieHisVolledig, final JaAttribuut waarde,
     ...
     * @param kopie kopie
     */
    public HisPersoonIndicatieStaatloosModel(final AbstractHisPersoonIndicatieStaatloosModel kopie) {
        super(kopie);
    }

    @Override
    public final ElementEnum getElementIdentificatie() {
        return ElementEnum.PERSOON_INDICATIE_STAATLOOS_GROEP;
    }
}
