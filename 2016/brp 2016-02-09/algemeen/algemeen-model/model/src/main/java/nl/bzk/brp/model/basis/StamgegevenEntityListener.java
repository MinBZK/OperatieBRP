...
/**
 * Entity listener voor alle stamgegevens om te voorkomen dat via de BRP stamgegevens kunnen worden aangemaakt, aangepast of verwijderd.
 */
public final class StamgegevenEntityListener {
    ...
    @PreRemove
    @PreUpdate
    public void voorverwerking(final Object stamgegeven) {
