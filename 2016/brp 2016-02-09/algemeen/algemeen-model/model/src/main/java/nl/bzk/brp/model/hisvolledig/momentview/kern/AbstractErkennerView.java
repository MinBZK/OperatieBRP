...
public abstract class AbstractErkennerView extends BetrokkenheidView implements ModelMoment, ErkennerBasis, ElementIdentificeerbaar {
     ...
     */
    public AbstractErkennerView(
        final ErkennerHisVolledig betrokkenheid,
