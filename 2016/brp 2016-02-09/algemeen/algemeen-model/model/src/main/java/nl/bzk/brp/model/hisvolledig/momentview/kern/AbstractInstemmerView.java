...
public abstract class AbstractInstemmerView extends BetrokkenheidView implements ModelMoment, InstemmerBasis, ElementIdentificeerbaar {
     ...
     */
    public AbstractInstemmerView(
        final InstemmerHisVolledig betrokkenheid,
