...
import nl.bzk.brp.model.logisch.prot.LeveringsaantekeningBasis;
...
@MappedSuperclass
public abstract class AbstractLeveringsaantekeningModel extends AbstractDynamischObject implements LeveringsaantekeningBasis, ModelIdentificeerbaar<Long> {
     ...
     *
     */
    protected AbstractLeveringsaantekeningModel() {
    }
     ...
     */
    public AbstractLeveringsaantekeningModel(
    ...
    /**
     * Zet Toegang leveringsautorisatie van Leveringsaantekening.
     *
     * @param toegangLeveringsautorisatieId Toegang leveringsautorisatie.
     */
    ...
    /**
     * Zet Dienst van Leveringsaantekening.
     *
    ...
    /**
     * Zet Administratieve handeling van Leveringsaantekening.
     *
...
// handmatige wijziging: backrefs uitsluiten in generator
//        if (toegangLeveringsautorisatie != null) {
//            attributen.add(toegangLeveringsautorisatie);
//        }
//        if (dienst != null) {
