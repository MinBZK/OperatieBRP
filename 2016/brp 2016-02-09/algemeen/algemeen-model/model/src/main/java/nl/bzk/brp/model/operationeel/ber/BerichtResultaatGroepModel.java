...
public class BerichtResultaatGroepModel extends AbstractBerichtResultaatGroepModel implements BerichtResultaatGroep {
     ...
     */
    public BerichtResultaatGroepModel(final SoortMeldingAttribuut hoogsteMeldingsniveau,
        final VerwerkingsresultaatAttribuut verwerking, final BijhoudingsresultaatAttribuut bijhouding)
    {
