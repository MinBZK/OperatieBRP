...
@MappedSuperclass
public abstract class AbstractHisPersoonIndicatieVolledigeVerstrekkingsbeperkingModel extends AbstractHisPersoonIndicatieFormeleHistorieModel implements
        ElementIdentificeerbaar
{
     ...
     *
     */
    protected AbstractHisPersoonIndicatieVolledigeVerstrekkingsbeperkingModel() {
    }
     ...
     */
    public AbstractHisPersoonIndicatieVolledigeVerstrekkingsbeperkingModel(
     ...
     * @param kopie kopie
     */
    public AbstractHisPersoonIndicatieVolledigeVerstrekkingsbeperkingModel(final AbstractHisPersoonIndicatieVolledigeVerstrekkingsbeperkingModel kopie) {
        super(kopie);
    }
