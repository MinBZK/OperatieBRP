...
public abstract class AbstractKindBericht extends BetrokkenheidBericht implements BrpObject, KindBasis {

    /**
     * Constructor die het discriminator attribuut zet of doorgeeft.
     *
     */
    public AbstractKindBericht() {
        super(new SoortBetrokkenheidAttribuut(SoortBetrokkenheid.KIND));
    }
