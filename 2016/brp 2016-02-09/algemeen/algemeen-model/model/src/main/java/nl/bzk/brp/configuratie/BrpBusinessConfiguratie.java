...
public interface BrpBusinessConfiguratie {
    ...
    /**
     * Vraagt de locking time out property op welke geconfigureerd staat in het bestande brp.properties.
     *
     * @return Het aantal seconden voordat een locking time out optreedt
     */
    int getLockingTimeOutProperty();
}
