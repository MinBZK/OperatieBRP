 ...
 */
public class GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht extends BevragingAntwoordBericht {

    /**
     * Standaard constructor (die direct de soort van het bericht initialiseert/zet).
     */
    public GeefPersonenOpAdresMetBetrokkenhedenAntwoordBericht() {
        super(SoortBericht.BHG_BVG_GEEF_PERSONEN_OP_ADRES_MET_BETROKKENHEDEN_R);
    }
}
