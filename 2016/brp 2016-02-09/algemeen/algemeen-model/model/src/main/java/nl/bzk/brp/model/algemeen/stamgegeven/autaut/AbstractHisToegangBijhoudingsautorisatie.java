...
@MappedSuperclass
public abstract class AbstractHisToegangBijhoudingsautorisatie extends AbstractFormeelHistorischMetActieVerantwoording implements
        ModelIdentificeerbaar<Integer>
{
     ...
     *
     */
    protected AbstractHisToegangBijhoudingsautorisatie() {
    }
     ...
     */
    public AbstractHisToegangBijhoudingsautorisatie(
     ...
     */
    public AbstractHisToegangBijhoudingsautorisatie(final AbstractHisToegangBijhoudingsautorisatie kopie) {
        super(kopie);
