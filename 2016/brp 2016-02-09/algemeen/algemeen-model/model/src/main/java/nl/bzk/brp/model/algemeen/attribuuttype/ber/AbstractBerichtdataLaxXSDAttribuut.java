...
@MappedSuperclass
public abstract class AbstractBerichtdataLaxXSDAttribuut extends AbstractAttribuut<String> {
     ...
     *
     */
    protected AbstractBerichtdataLaxXSDAttribuut() {
        super(null);
    }
     ...
     */
    public AbstractBerichtdataLaxXSDAttribuut(final String waarde) {
        super(waarde);
    }
