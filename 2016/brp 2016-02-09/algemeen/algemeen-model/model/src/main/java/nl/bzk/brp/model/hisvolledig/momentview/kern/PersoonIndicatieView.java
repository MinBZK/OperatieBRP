 ...
 */
public final class PersoonIndicatieView extends AbstractPersoonIndicatieView implements PersoonIndicatie {
     ...
     */
    public PersoonIndicatieView(final PersoonIndicatieHisVolledig<?> persoonIndicatie,
        final DatumTijdAttribuut formeelPeilmoment, final DatumAttribuut materieelPeilmoment)
    {
        super(persoonIndicatie, formeelPeilmoment, materieelPeilmoment);
    }
