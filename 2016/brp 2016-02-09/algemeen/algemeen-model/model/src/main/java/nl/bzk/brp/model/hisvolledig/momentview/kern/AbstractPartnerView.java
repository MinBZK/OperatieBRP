...
public abstract class AbstractPartnerView extends BetrokkenheidView implements ModelMoment, PartnerBasis, ElementIdentificeerbaar {
     ...
     */
    public AbstractPartnerView(final PartnerHisVolledig betrokkenheid, final DatumTijdAttribuut formeelPeilmoment, final DatumAttribuut materieelPeilmoment)
    {
