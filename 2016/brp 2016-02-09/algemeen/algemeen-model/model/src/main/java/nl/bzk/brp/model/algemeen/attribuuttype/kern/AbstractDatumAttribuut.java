...
public abstract class AbstractDatumAttribuut extends AbstractDatumBasisAttribuut {
     ...
     */
    public AbstractDatumAttribuut(final Integer waarde) {
        super(waarde);
    }
