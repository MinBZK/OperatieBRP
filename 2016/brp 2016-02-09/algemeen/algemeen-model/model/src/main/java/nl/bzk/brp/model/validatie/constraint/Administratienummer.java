...
import nl.bzk.brp.model.validatie.validator.AdministratienummerValidator;
 ...
 */
@Documented
@Constraint(validatedBy = AdministratienummerValidator.class)
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE })
@Retention(RetentionPolicy.RUNTIME)
public @interface Administratienummer {
