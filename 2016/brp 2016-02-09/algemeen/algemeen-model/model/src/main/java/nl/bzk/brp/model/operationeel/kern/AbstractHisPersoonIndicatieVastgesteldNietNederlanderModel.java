...
@MappedSuperclass
public abstract class AbstractHisPersoonIndicatieVastgesteldNietNederlanderModel extends AbstractHisPersoonIndicatieMaterieleHistorieModel implements
        ElementIdentificeerbaar
{
     ...
     *
     */
    protected AbstractHisPersoonIndicatieVastgesteldNietNederlanderModel() {
    }
     ...
     */
    public AbstractHisPersoonIndicatieVastgesteldNietNederlanderModel(
        final PersoonIndicatieVastgesteldNietNederlanderHisVolledigImpl persoonIndicatieHisVolledig,
     ...
     * @param kopie kopie
     */
    public AbstractHisPersoonIndicatieVastgesteldNietNederlanderModel(final AbstractHisPersoonIndicatieVastgesteldNietNederlanderModel kopie) {
        super(kopie);
    }
     ...
     */
    @Override
    public HisPersoonIndicatieVastgesteldNietNederlanderModel kopieer() {
        return new HisPersoonIndicatieVastgesteldNietNederlanderModel(this);
    }
