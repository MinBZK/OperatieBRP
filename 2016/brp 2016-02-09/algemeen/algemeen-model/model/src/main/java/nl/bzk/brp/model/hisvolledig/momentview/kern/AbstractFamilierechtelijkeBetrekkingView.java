...
public abstract class AbstractFamilierechtelijkeBetrekkingView extends RelatieView implements ModelMoment, FamilierechtelijkeBetrekkingBasis,
        ElementIdentificeerbaar
{
     ...
     */
    public AbstractFamilierechtelijkeBetrekkingView(
        final FamilierechtelijkeBetrekkingHisVolledig relatie,
