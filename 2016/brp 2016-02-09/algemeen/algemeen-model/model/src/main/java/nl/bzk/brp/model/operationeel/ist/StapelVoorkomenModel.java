...
public class StapelVoorkomenModel extends AbstractStapelVoorkomenModel implements StapelVoorkomen,
    ModelIdentificeerbaar<Integer>, VolgnummerBevattend
{
     ...
     */
    protected StapelVoorkomenModel() {
        super();
    }
     ...
     */
    public StapelVoorkomenModel(final StapelModel stapel, final VolgnummerAttribuut volgnummer) {
