 ...
 */
public final class PersoonOnderzoekPredikaatView extends AbstractPersoonOnderzoekPredikaatView implements ModelMoment, PersoonOnderzoekHisMoment,
    ElementIdentificeerbaar
{
     ...
     */
    public PersoonOnderzoekPredikaatView(final PersoonOnderzoekHisVolledig persoonOnderzoek, final Predicate predikaat) {
        super(persoonOnderzoek, predikaat);
    }
