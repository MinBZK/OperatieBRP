...
public class HisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel extends
    AbstractHisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel
{

    /**
     * Default lege constructor t.b.v. Hibernate / JPA
     */
    protected HisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel() {
        super();
    }
     ...
     */
    public HisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel(
        final PersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentHisVolledigImpl persoonIndicatieHisVolledig,
     ...
     */
    public HisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel(
        final AbstractHisPersoonIndicatieSignaleringMetBetrekkingTotVerstrekkenReisdocumentModel kopie)
    {
        super(kopie);
    }
    ...
    public final ElementEnum getElementIdentificatie() {
        return ElementEnum.PERSOON_INDICATIE_SIGNALERINGMETBETREKKINGTOTVERSTREKKENREISDOCUMENT_GROEP;
    }
}
