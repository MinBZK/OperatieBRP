 ...
 * vastgelegd 6-1-2012.
 */
public final class PersoonIdentificatienummersGroepBericht extends AbstractPersoonIdentificatienummersGroepBericht implements
    PersoonIdentificatienummersGroep
{
    ...
    @nl.bzk.brp.model.validatie.constraint.Administratienummer(
        dbObject = DatabaseObjectKern.PERSOON__ADMINISTRATIENUMMER)
    @Override
