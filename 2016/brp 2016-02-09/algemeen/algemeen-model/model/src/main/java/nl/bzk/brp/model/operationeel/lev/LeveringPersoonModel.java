 ...
 * <p/>
 * Bij een Levering van Persoonsgegevens, zijn ��n of meer Personen het "onderwerp" van de Levering. Indien een Persoon onderwerp is van een Levering, dan
 * wordt de koppeling tussen deze Levering en de Persoon vastgelegd.
 */
@Entity
...
public class LeveringPersoonModel extends AbstractLeveringPersoonModel implements LeveringPersoon {
     ...
     */
    public LeveringPersoonModel(final LeveringModel levering, final Integer persoonId) {
