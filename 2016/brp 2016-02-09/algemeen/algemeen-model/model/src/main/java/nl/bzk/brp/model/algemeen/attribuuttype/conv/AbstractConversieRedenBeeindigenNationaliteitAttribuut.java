...
@MappedSuperclass
public abstract class AbstractConversieRedenBeeindigenNationaliteitAttribuut extends AbstractAttribuut<String> {
     ...
     *
     */
    protected AbstractConversieRedenBeeindigenNationaliteitAttribuut() {
        super(null);
    }
     ...
     */
    public AbstractConversieRedenBeeindigenNationaliteitAttribuut(final String waarde) {
        super(waarde);
    }
