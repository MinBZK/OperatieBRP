...
public class PersoonNationaliteitModel extends AbstractPersoonNationaliteitModel implements PersoonNationaliteit,
    Comparable<PersoonNationaliteitModel>
{

    private static final int HASHCODE_GETAL1 = 42345;
    private static final int HASHCODE_GETAL2 = 23421;
     ...
     */
    public PersoonNationaliteitModel(final PersoonModel persoon, final NationaliteitAttribuut nationaliteit) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == null || obj.getClass() != getClass()) {
            ...
            final PersoonNationaliteitModel nationaliteitModel = (PersoonNationaliteitModel) obj;
            isGelijk = new EqualsBuilder().append(this.getID(), nationaliteitModel.getID()).isEquals();
        }
        return isGelijk;
    }
