 ...
 * soort bijhoudingsbevoegdheid.
 *
 *
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.StatischeStamgegevensGenerator")
public enum SoortBevoegdheid implements BestaansPeriodeStamgegeven {
     ...
     */
    BIJHOUDEN("Bijhouden", "Bijhouden vanuit de bijhoudingsverantwoordelijkheid", new DatumEvtDeelsOnbekendAttribuut(0),
     ...
     */
    AUTOMATISCH_FIATTEREN("Automatisch fiatteren", "Bijhoudingsvoorstel met fiattering vooraf", new DatumEvtDeelsOnbekendAttribuut(0),
            new DatumEvtDeelsOnbekendAttribuut(99991231)),
    /**
     * Gemandateerd zijn om de bijhouding te verrichten..
     */
    MANDAAT("Mandaat", "Gemandateerd zijn om de bijhouding te verrichten.", new DatumEvtDeelsOnbekendAttribuut(0), new DatumEvtDeelsOnbekendAttribuut(
        99991231));
     ...
     * @param datumAanvangGeldigheid DatumAanvangGeldigheid voor SoortBevoegdheid
     * @param datumEindeGeldigheid DatumEindeGeldigheid voor SoortBevoegdheid
     */
    private SoortBevoegdheid(
        final String naam,
    ...
    /**
     * Retourneert de datum aanvang geldigheid voor Soort bevoegdheid.
     *
     * @return Datum aanvang geldigheid voor Soort bevoegdheid
     */
    ...
    /**
     * Retourneert de datum einde geldigheid voor Soort bevoegdheid.
     *
     * @return Datum einde geldigheid voor Soort bevoegdheid
     */
