...
/**
 * HisVolledig klasse voor Instemmer.
 *
 */
@Access(value = AccessType.FIELD)
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigModelGenerator")
@MappedSuperclass
public abstract class AbstractInstemmerHisVolledigImpl extends BetrokkenheidHisVolledigImpl implements InstemmerHisVolledigBasis, ElementIdentificeerbaar {

    /**
     * Default contructor voor JPA.
     *
     */
    protected AbstractInstemmerHisVolledigImpl() {
    }
     ...
     */
    public AbstractInstemmerHisVolledigImpl(final RelatieHisVolledigImpl relatie, final PersoonHisVolledigImpl persoon) {
