...
/**
 * Vorm van historie: beiden. Motivatie voor de materi�le tijdslijn: de bijhoudingsgemeente kan op een eerder moment dan technisch verwerkt de
 * verantwoordelijke gemeente zijn (geworden). Of te wel: formele tijdslijn kan anders liggen dan materi�le tijdslijn. Voor het OOK bestaan van datum
 * inschrijving: zie modelleringsbeslissing aldaar. RvdP 10 jan 2012.
 */
public interface PersoonBijhoudingsgemeenteGroepBasis extends Groep {
     ...
     */
    DatumAttribuut getDatumInschrijvingInGemeente();
