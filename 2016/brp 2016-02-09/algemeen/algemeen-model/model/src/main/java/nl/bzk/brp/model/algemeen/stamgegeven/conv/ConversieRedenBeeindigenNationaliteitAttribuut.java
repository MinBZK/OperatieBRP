...
/**
 * Attribuut wrapper klasse voor Conversie reden beëindigen nationaliteit.
 *
 */
@Embeddable
@Access(value = AccessType.PROPERTY)
@Generated(value = "nl.bzk.brp.generatoren.java.DynamischeStamgegevensGenerator")
public class ConversieRedenBeeindigenNationaliteitAttribuut extends AbstractAttribuut<ConversieRedenBeeindigenNationaliteit> {
     ...
     */
    public ConversieRedenBeeindigenNationaliteitAttribuut(final ConversieRedenBeeindigenNationaliteit waarde) {
        super(waarde);
    }
    ...
    public ConversieRedenBeeindigenNationaliteit getWaarde() {
