...
public class HisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel extends AbstractHisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel {

    /**
     * Default lege constructor t.b.v. Hibernate / JPA
     */
    protected HisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel() {
        super();
    }
     ...
     */
    public HisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel(
     ...
     * @param kopie kopie
     */
    public HisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel(final AbstractHisPersoonIndicatieBijzondereVerblijfsrechtelijkePositieModel kopie)
    {
        super(kopie);
    }
    ...
    public final ElementEnum getElementIdentificatie() {
        return ElementEnum.PERSOON_INDICATIE_BIJZONDEREVERBLIJFSRECHTELIJKEPOSITIE_GROEP;
    }
}
