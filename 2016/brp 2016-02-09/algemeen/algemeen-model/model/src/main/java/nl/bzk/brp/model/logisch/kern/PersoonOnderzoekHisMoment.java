...
public interface PersoonOnderzoekHisMoment extends PersoonOnderzoek {

    /**
     * Retourneert Standaard van Persoon \ Onderzoek.
     *
     * @return Standaard.
     */
    HisPersoonOnderzoekStandaardGroep getStandaard();
