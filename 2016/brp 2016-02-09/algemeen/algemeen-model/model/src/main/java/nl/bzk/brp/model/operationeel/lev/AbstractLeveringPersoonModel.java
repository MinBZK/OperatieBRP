...
import nl.bzk.brp.model.logisch.lev.LeveringPersoonBasis;
...
@MappedSuperclass
public abstract class AbstractLeveringPersoonModel extends AbstractDynamischObject implements LeveringPersoonBasis, ModelIdentificeerbaar<Long> {
     ...
     */
    public AbstractLeveringPersoonModel(final LeveringModel levering, final Integer persoonId) {
        this();
     ...
     */
    @Id
    @SequenceGenerator(name = "LEVERINGPERSOON", sequenceName = "prot.seq_levsaantekpers")
    ...
    /**
     * Zet Persoon van Levering \ Persoon.
     *
