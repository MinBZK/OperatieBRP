...
public class GeefPersonenOpAdresMetBetrokkenhedenBericht extends BevragingsBericht {

    /**
     * Standaard constructor (die direct de soort van het bericht initialiseert/zet).
     */
    public GeefPersonenOpAdresMetBetrokkenhedenBericht() {
        super(SoortBericht.BHG_BVG_GEEF_PERSONEN_OP_ADRES_MET_BETROKKENHEDEN);
    }
}
