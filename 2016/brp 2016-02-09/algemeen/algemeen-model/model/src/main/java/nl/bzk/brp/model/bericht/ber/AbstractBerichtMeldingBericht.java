...
import nl.bzk.brp.model.logisch.ber.BerichtMeldingBasis;

/**
 * Het voorkomen van een melding in een uitgaand bericht.
 *
 * Een bijhoudingsbericht (een inkomend bericht) kan leiden tot één of meer meldingen. Deze worden via een uitgaand
...
public abstract class AbstractBerichtMeldingBericht implements BrpObject, BerichtMeldingBasis {
