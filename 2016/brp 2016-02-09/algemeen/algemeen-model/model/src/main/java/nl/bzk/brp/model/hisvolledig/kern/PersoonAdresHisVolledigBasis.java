...
/**
 * Interface voor Persoon \ Adres.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigInterfaceModelGenerator")
public interface PersoonAdresHisVolledigBasis extends ModelPeriode, ModelIdentificeerbaar<Integer>, BrpObject {

    /**
     * Retourneert de historie van His Persoon \ Adres.
     *
     * @return Historie met His Persoon \ Adres
     */
    MaterieleHistorieSet<HisPersoonAdresModel> getPersoonAdresHistorie();

    /**
     * Retourneert Persoon van Persoon \ Adres.
     *
     * @return Persoon van Persoon \ Adres
     */
