...
public abstract class AbstractNaamskeuzeOngeborenVruchtHisVolledigView extends RelatieHisVolledigView implements
        NaamskeuzeOngeborenVruchtHisVolledigBasis, ElementIdentificeerbaar
{
     ...
     *
     * @param naamskeuzeOngeborenVruchtHisVolledig relatie
     * @param predikaat predikaat
     */
    public AbstractNaamskeuzeOngeborenVruchtHisVolledigView(
        final NaamskeuzeOngeborenVruchtHisVolledig naamskeuzeOngeborenVruchtHisVolledig,
        final Predicate predikaat)
    {
        this(naamskeuzeOngeborenVruchtHisVolledig, predikaat, null);
