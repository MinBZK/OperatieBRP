...
@MappedSuperclass
public abstract class AbstractConversieLO3RubriekNaamAttribuut extends AbstractAttribuut<String> {
     ...
     *
     */
    protected AbstractConversieLO3RubriekNaamAttribuut() {
        super(null);
    }
     ...
     */
    public AbstractConversieLO3RubriekNaamAttribuut(final String waarde) {
        super(waarde);
    }
