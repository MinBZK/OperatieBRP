 ...
 */
public final class PersoonVoornaamView extends AbstractPersoonVoornaamView implements PersoonVoornaamHisMoment {
     ...
     */
    public PersoonVoornaamView(final PersoonVoornaamHisVolledig persoonVoornaam,
        final DatumTijdAttribuut formeelPeilmoment, final DatumAttribuut materieelPeilmoment)
    {
        super(persoonVoornaam, formeelPeilmoment, materieelPeilmoment);
    }
