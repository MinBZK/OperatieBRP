...
public abstract class AbstractPersoonReisdocumentHisVolledigView extends AbstractHisVolledigPredikaatView implements PersoonReisdocumentHisVolledigBasis,
        ElementIdentificeerbaar
{

    protected final PersoonReisdocumentHisVolledig persoonReisdocument;
     ...
     */
    public AbstractPersoonReisdocumentHisVolledigView(final PersoonReisdocumentHisVolledig persoonReisdocumentHisVolledig, final Predicate predikaat) {
        this(persoonReisdocumentHisVolledig, predikaat, null);
     ...
     */
    public AbstractPersoonReisdocumentHisVolledigView(
    ...
    public PersoonHisVolledig getPersoon() {
        if (persoonReisdocument.getPersoon() != null) {
            return new PersoonHisVolledigView(persoonReisdocument.getPersoon(), getPredikaat(), getPeilmomentVoorAltijdTonenGroepen());
        }
        return null;
    }
     ...
     */
    @Override
    public final FormeleHistorieSet<HisPersoonReisdocumentModel> getPersoonReisdocumentHistorie() {
        final Set<HisPersoonReisdocumentModel> historie =
                new HashSet<HisPersoonReisdocumentModel>(persoonReisdocument.getPersoonReisdocumentHistorie().getHistorie());
        final Set<HisPersoonReisdocumentModel> teTonenHistorie = new HashSet<HisPersoonReisdocumentModel>();
        teTonenHistorie.addAll(historie);

        CollectionUtils.filter(teTonenHistorie, getPredikaat());
        if (HisVolledigPredikaatViewUtil.isAltijdTonenGroep(HisPersoonReisdocumentModel.class)
        ...
        final Set<HisPersoonReisdocumentModel> gesorteerdeHistorie =
                new TreeSet<HisPersoonReisdocumentModel>(new FormeleHistorieEntiteitComparator<HisPersoonReisdocumentModel>());
        gesorteerdeHistorie.addAll(teTonenHistorie);

        return new FormeleHistorieSetImpl<HisPersoonReisdocumentModel>(gesorteerdeHistorie);
    ...
    public Set<HistorieEntiteit> getAlleHistorieRecords() {
        ...
        resultaat.addAll(getPersoonReisdocumentHistorie().getHistorie());
        return resultaat;
    }
