...
public class HisPersoonIndicatieDerdeHeeftGezagModel extends AbstractHisPersoonIndicatieDerdeHeeftGezagModel {

    /**
     * Default lege constructor t.b.v. Hibernate / JPA
     */
    protected HisPersoonIndicatieDerdeHeeftGezagModel() {
        super();
    }
     ...
     */
    public HisPersoonIndicatieDerdeHeeftGezagModel(
     ...
     */
    public HisPersoonIndicatieDerdeHeeftGezagModel(
        final PersoonIndicatieDerdeHeeftGezagHisVolledigImpl persoonIndicatieHisVolledig, final JaAttribuut waarde,
     ...
     * @param kopie kopie
     */
    public HisPersoonIndicatieDerdeHeeftGezagModel(final AbstractHisPersoonIndicatieDerdeHeeftGezagModel kopie) {
        super(kopie);
    }

    @Override
    public final ElementEnum getElementIdentificatie() {
        return ElementEnum.PERSOON_INDICATIE_DERDEHEEFTGEZAG_GROEP;
    }
}
