...
/**
 * Het antwoord bericht voor bevragingen tbv levering.
 */
public final class GeefDetailsPersoonAntwoordBericht extends BevragingAntwoordBericht {

    /**
     * Standaard constructor (die direct de soort van het bericht initialiseert/zet).
     */
    public GeefDetailsPersoonAntwoordBericht() {
        super(SoortBericht.LVG_BVG_GEEF_DETAILS_PERSOON_R);
    }
     ...
     */
    public PersoonHisVolledigView getGevondenPersoon() {
