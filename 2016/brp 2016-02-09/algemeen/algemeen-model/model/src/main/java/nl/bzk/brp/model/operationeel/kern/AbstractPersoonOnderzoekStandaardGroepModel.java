...
@MappedSuperclass
public abstract class AbstractPersoonOnderzoekStandaardGroepModel implements PersoonOnderzoekStandaardGroepBasis {
     ...
     *
     */
    protected AbstractPersoonOnderzoekStandaardGroepModel() {
    }
     ...
     */
    public AbstractPersoonOnderzoekStandaardGroepModel(final SoortPersoonOnderzoekAttribuut rol) {
        this.rol = rol;
     ...
     */
    public AbstractPersoonOnderzoekStandaardGroepModel(final PersoonOnderzoekStandaardGroep persoonOnderzoekStandaardGroep) {
        this.rol = persoonOnderzoekStandaardGroep.getRol();
