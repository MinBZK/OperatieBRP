...
public class PartijOnderzoekModel extends AbstractPartijOnderzoekModel implements PartijOnderzoek,
    ModelIdentificeerbaar<Integer>
{
     ...
     */
    protected PartijOnderzoekModel() {
        super();
    }
     ...
     */
    public PartijOnderzoekModel(final PartijAttribuut partij, final OnderzoekModel onderzoek) {
