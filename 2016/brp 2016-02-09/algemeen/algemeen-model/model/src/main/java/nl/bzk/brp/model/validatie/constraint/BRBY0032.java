...
import nl.bzk.brp.model.validatie.validator.BRBY0032Validator;
 ...
 */
@Documented
@Constraint(validatedBy = BRBY0032Validator.class)
@Target({ ElementType.TYPE, ElementType.ANNOTATION_TYPE })
@Retention(RetentionPolicy.RUNTIME)
public @interface BRBY0032 {

    /**
     * Standaard validatie bericht.
     */
    String message() default "{BRBY0032}";
     ...
     */
    Regel code() default Regel.BRBY0032;
