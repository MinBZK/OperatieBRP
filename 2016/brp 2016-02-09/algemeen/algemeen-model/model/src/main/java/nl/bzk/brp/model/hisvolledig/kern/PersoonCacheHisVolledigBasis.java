...
/**
 * Interface voor Persoon cache.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigInterfaceModelGenerator")
public interface PersoonCacheHisVolledigBasis extends ModelPeriode, ModelIdentificeerbaar<Integer>, BrpObject {

    /**
     * Retourneert Persoon van Persoon cache.
     *
     * @return Persoon van Persoon cache
     */
