...
public abstract class AbstractPersoonAfnemerindicatieBericht extends AbstractBerichtEntiteit implements BrpObject, BerichtEntiteit, MetaIdentificeerbaar,
        PersoonAfnemerindicatieBasis
{

    private static final Integer META_ID = 10317;
    ...
    private PersoonAfnemerindicatieStandaardGroepBericht standaard;
    ...
    /**
     * Retourneert Afnemer van Identiteit.
     *
     * @return Afnemer.
     */
    ...
    /**
     * Retourneert Leveringsautorisatie van Identiteit.
     *
     ...
     */
    @Override
    public PersoonAfnemerindicatieStandaardGroepBericht getStandaard() {
        return standaard;
    }
    ...
    /**
     * Zet Afnemer van Identiteit.
     *
     * @param afnemerCode Afnemer.
     */
     ...
     */
    public void setAfnemer(final PartijAttribuut afnemer) {
        this.afnemer = afnemer;
    }

    /**
     * Zet Leveringsautorisatie van Identiteit.
     *
     ...
     */
    public void setStandaard(final PersoonAfnemerindicatieStandaardGroepBericht standaard) {
