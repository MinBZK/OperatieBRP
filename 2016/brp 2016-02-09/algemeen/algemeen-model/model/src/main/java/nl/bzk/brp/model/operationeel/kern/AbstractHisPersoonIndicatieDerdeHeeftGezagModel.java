...
@MappedSuperclass
public abstract class AbstractHisPersoonIndicatieDerdeHeeftGezagModel extends AbstractHisPersoonIndicatieMaterieleHistorieModel implements
        ElementIdentificeerbaar
{
     ...
     *
     */
    protected AbstractHisPersoonIndicatieDerdeHeeftGezagModel() {
    }
     ...
     */
    public AbstractHisPersoonIndicatieDerdeHeeftGezagModel(
        final PersoonIndicatieDerdeHeeftGezagHisVolledigImpl persoonIndicatieHisVolledig,
     ...
     * @param kopie kopie
     */
    public AbstractHisPersoonIndicatieDerdeHeeftGezagModel(final AbstractHisPersoonIndicatieDerdeHeeftGezagModel kopie) {
        super(kopie);
    }
     ...
     */
    @Override
    public HisPersoonIndicatieDerdeHeeftGezagModel kopieer() {
        return new HisPersoonIndicatieDerdeHeeftGezagModel(this);
    }
