...
/**
 * View klasse voor Geregistreerd partnerschap.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigMomentPredikaatViewModelGenerator")
public abstract class AbstractGeregistreerdPartnerschapPredikaatView extends HuwelijkGeregistreerdPartnerschapPredikaatView implements ModelMoment,
        GeregistreerdPartnerschapBasis, ElementIdentificeerbaar
{
     ...
     */
    public AbstractGeregistreerdPartnerschapPredikaatView(final GeregistreerdPartnerschapHisVolledig relatie, final Predicate predikaat) {
