...
public abstract class AbstractNaamgeverView extends BetrokkenheidView implements ModelMoment, NaamgeverBasis, ElementIdentificeerbaar {
     ...
     */
    public AbstractNaamgeverView(
        final NaamgeverHisVolledig betrokkenheid,
