...
/**
 * Het (aangaan van het en be�indigen van het) geregistreerd partnerschap zoals beschreven in Titel 5A van het Burgerlijk Wetboek Boek 1.
 * <p/>
 * Zie voor verdere toelichting de definitie en toelichting bij Huwelijk/Geregistreerd partnerschap, en bij Relatie.
 */
public final class GeregistreerdPartnerschapBericht extends AbstractGeregistreerdPartnerschapBericht implements
    GeregistreerdPartnerschap
{
    ...
    /**
     * Deze methode wordt gebruikt voor het samenstellen van een melding bericht.
     *
