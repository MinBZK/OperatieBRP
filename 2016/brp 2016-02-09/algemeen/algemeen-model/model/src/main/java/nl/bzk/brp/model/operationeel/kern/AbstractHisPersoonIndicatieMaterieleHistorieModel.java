...
@MappedSuperclass
public abstract class AbstractHisPersoonIndicatieMaterieleHistorieModel extends HisPersoonIndicatieModel implements
    MaterieelHistorisch, MaterieleHistorie, MaterieelVerantwoordbaar<ActieModel>, VerantwoordingTbvLeveringMutaties,
    HisPersoonIndicatieStandaardGroep
{
     ...
     */
    protected AbstractHisPersoonIndicatieMaterieleHistorieModel() {
    }
     ...
     */
    public AbstractHisPersoonIndicatieMaterieleHistorieModel(
     ...
     */
    public AbstractHisPersoonIndicatieMaterieleHistorieModel(
        final AbstractHisPersoonIndicatieMaterieleHistorieModel kopie)
    {
        super(kopie);
     ...
     */
    public AbstractHisPersoonIndicatieMaterieleHistorieModel(final PersoonIndicatieHisVolledigImpl<?> persoonIndicatie,
