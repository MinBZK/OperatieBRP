...
public abstract class AbstractPersoonReisdocumentBericht extends AbstractBerichtEntiteit implements BrpObject, BerichtEntiteit, MetaIdentificeerbaar,
        PersoonReisdocumentBasis
{

    private static final Integer META_ID = 3576;
    private PersoonBericht persoon;
    private String soortCode;
    private SoortNederlandsReisdocumentAttribuut soort;
    private PersoonReisdocumentStandaardGroepBericht standaard;
     ...
     */
    @Override
    public PersoonReisdocumentStandaardGroepBericht getStandaard() {
        return standaard;
    }

    /**
     * Zet Persoon van Persoon \ Reisdocument.
     *
     ...
     *
     * @param soortCode Soort.
     */
    public void setSoortCode(final String soortCode) {
        this.soortCode = soortCode;
    }

    /**
     * Zet Soort van Persoon \ Reisdocument.
     *
     * @param soort Soort.
     */
    public void setSoort(final SoortNederlandsReisdocumentAttribuut soort) {
        this.soort = soort;
    }
     ...
     */
    public void setStandaard(final PersoonReisdocumentStandaardGroepBericht standaard) {
