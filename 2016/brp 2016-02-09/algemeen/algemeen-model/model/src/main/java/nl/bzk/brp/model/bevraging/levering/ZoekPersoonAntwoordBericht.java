...
/**
 * Het antwoord bericht voor zoek persoon bevragingen.
 */
public final class ZoekPersoonAntwoordBericht extends BevragingAntwoordBericht {

    /**
     * Standaard constructor (die direct de soort van het bericht initialiseert/zet).
     */
    public ZoekPersoonAntwoordBericht() {
        super(SoortBericht.LVG_BVG_ZOEK_PERSOON_R);
    }
