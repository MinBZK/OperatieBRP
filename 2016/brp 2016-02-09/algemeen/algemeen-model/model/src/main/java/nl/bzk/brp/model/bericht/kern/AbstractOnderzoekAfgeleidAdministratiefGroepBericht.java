...
public abstract class AbstractOnderzoekAfgeleidAdministratiefGroepBericht extends AbstractFormeleHistorieGroepBericht implements Groep,
        OnderzoekAfgeleidAdministratiefGroepBasis, MetaIdentificeerbaar
{

    private static final Integer META_ID = 10841;
    private static final List<Integer> ONDERLIGGENDE_ATTRIBUTEN = Arrays.asList(10842);
