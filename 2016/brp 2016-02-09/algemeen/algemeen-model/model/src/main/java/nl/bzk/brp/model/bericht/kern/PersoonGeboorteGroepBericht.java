 ...
 */
public final class PersoonGeboorteGroepBericht extends AbstractPersoonGeboorteGroepBericht implements PersoonGeboorteGroep {

    @BRAL0102(dbObject = DatabaseObjectKern.PERSOON__DATUM_GEBOORTE)
    @Override
