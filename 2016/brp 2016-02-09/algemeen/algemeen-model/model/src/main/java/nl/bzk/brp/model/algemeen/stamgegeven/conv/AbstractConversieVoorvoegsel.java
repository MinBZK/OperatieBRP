...
@MappedSuperclass
public abstract class AbstractConversieVoorvoegsel {
     ...
     *
     */
    protected AbstractConversieVoorvoegsel() {
    }
     ...
     */
    protected AbstractConversieVoorvoegsel(
        final LO3VoorvoegselAttribuut rubriek0231Voorvoegsel,
        final NaamEnumeratiewaardeAttribuut voorvoegsel,
        final ScheidingstekenAttribuut scheidingsteken)
    {
        this.rubriek0231Voorvoegsel = rubriek0231Voorvoegsel;
     ...
     */
    public final LO3VoorvoegselAttribuut getRubriek0231Voorvoegsel() {
     ...
     * @return Voorvoegsel.
     */
    public final NaamEnumeratiewaardeAttribuut getVoorvoegsel() {
        return voorvoegsel;
    }
