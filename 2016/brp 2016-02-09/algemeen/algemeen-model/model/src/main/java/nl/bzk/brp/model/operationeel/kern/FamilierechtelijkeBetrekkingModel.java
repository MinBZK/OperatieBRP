...
public class FamilierechtelijkeBetrekkingModel extends AbstractFamilierechtelijkeBetrekkingModel implements FamilierechtelijkeBetrekking {
     ...
     */
    @Transient
    public final KindModel getKindBetrokkenheid() {
        for (final BetrokkenheidModel betrokkenheid : getBetrokkenheden()) {
     ...
     */
    @Transient
    public final Set<OuderModel> getOuderBetrokkenheden() {
        final Set<OuderModel> gesorteerdeSet = new TreeSet<>(new Comparator<BetrokkenheidModel>() {
