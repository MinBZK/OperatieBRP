 ...
 */
public final class OnderzoekPredikaatView extends AbstractOnderzoekPredikaatView implements ModelMoment, OnderzoekHisMoment, ElementIdentificeerbaar
{
     ...
     */
    public OnderzoekPredikaatView(final OnderzoekHisVolledig onderzoek, final Predicate predikaat) {
        super(onderzoek, predikaat);
    }
