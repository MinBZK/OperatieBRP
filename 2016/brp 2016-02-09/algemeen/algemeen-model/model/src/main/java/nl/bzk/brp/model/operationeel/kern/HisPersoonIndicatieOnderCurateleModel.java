...
public class HisPersoonIndicatieOnderCurateleModel extends AbstractHisPersoonIndicatieOnderCurateleModel {

    /**
     * Default lege constructor t.b.v. Hibernate / JPA
     */
    protected HisPersoonIndicatieOnderCurateleModel() {
        super();
    }
     ...
     */
    public HisPersoonIndicatieOnderCurateleModel(
     ...
     */
    public HisPersoonIndicatieOnderCurateleModel(
        final PersoonIndicatieOnderCurateleHisVolledigImpl persoonIndicatieHisVolledig, final JaAttribuut waarde,
     ...
     * @param kopie kopie
     */
    public HisPersoonIndicatieOnderCurateleModel(final AbstractHisPersoonIndicatieOnderCurateleModel kopie) {
        super(kopie);
    }

    @Override
    public final ElementEnum getElementIdentificatie() {
        return ElementEnum.PERSOON_INDICATIE_ONDERCURATELE_GROEP;
    }
}
