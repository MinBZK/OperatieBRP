...
/**
 * Interface voor Bericht \ Persoon.
 *
 */
@Generated(value = "nl.bzk.brp.generatoren.java.HisVolledigInterfaceModelGenerator")
public interface BerichtPersoonHisVolledigBasis extends ModelPeriode, ModelIdentificeerbaar<Long>, BrpObject {

    /**
     * Retourneert Bericht van Bericht \ Persoon.
     *
     * @return Bericht van Bericht \ Persoon
     */
    BerichtHisVolledig getBericht();

    /**
     * Retourneert Persoon van Bericht \ Persoon.
     *
     * @return Persoon van Bericht \ Persoon
     */
