...
import nl.bzk.brp.model.validatie.validator.GeenSpatieValidator;
 ...
 */
@Documented
@Constraint(validatedBy = GeenSpatieValidator.class)
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE })
@Retention(RetentionPolicy.RUNTIME)
public @interface GeenSpatie {

    /**
     * Standaard validatie bericht.
     */
    String message() default "{BRAL0501}";
     ...
     */
    Regel code() default Regel.BRAL0501;
