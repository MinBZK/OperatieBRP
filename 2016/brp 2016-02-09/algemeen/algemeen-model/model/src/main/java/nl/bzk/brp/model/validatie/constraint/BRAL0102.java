...
import nl.bzk.brp.model.validatie.validator.BRAL0102Validator;
 ...
 */
@Documented
@Constraint(validatedBy = BRAL0102Validator.class)
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE })
@Retention(RetentionPolicy.RUNTIME)
public @interface BRAL0102 {
     ...
     */
    Regel code() default Regel.BRAL0102;
