 ...
 * 2011
 */
public abstract class RelatieBericht extends AbstractRelatieBericht implements Relatie, BerichtRootObject {

    /**
     * De unieke (database) id van de relatie. Let op: dit veld is alleen voor 'intern' gebruik! Het zal meestal dan ook niet gevuld zijn, alleen in een
     * scenario waarbij dit binnen de logica 'door-gecommuniceerd' dient te worden.
     */
     ...
     */
    public RelatieBericht(final SoortRelatieAttribuut soort) {
        super(soort);
    }
