 ...
 */
public final class PersoonVoornaamPredikaatView extends AbstractPersoonVoornaamPredikaatView implements ModelMoment, PersoonVoornaamHisMoment,
    ElementIdentificeerbaar
{
     ...
     */
    public PersoonVoornaamPredikaatView(final PersoonVoornaamHisVolledig persoonVoornaam, final Predicate predikaat) {
        super(persoonVoornaam, predikaat);
    }
