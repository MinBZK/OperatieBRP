...
@MappedSuperclass
public abstract class AbstractHisPersoonIndicatieOnderCurateleModel extends AbstractHisPersoonIndicatieMaterieleHistorieModel implements
        ElementIdentificeerbaar
{
     ...
     *
     */
    protected AbstractHisPersoonIndicatieOnderCurateleModel() {
    }
     ...
     */
    public AbstractHisPersoonIndicatieOnderCurateleModel(
        final PersoonIndicatieOnderCurateleHisVolledigImpl persoonIndicatieHisVolledig,
     ...
     * @param kopie kopie
     */
    public AbstractHisPersoonIndicatieOnderCurateleModel(final AbstractHisPersoonIndicatieOnderCurateleModel kopie) {
        super(kopie);
    }
     ...
     */
    @Override
    public HisPersoonIndicatieOnderCurateleModel kopieer() {
        return new HisPersoonIndicatieOnderCurateleModel(this);
    }
