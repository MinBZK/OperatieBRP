...
/**
 * Tests for {@link nl.bzk.brp.bevraging.commands.CollecteerVrijgezelBsnStap}.
 */
@RunWith(MockitoJUnitRunner.class)
public class CollecteerVrijgezelBsnStapTest {
    ...
    @InjectMocks
    private CollecteerVrijgezelBsnStap collecteerBsnStap = new CollecteerVrijgezelBsnStap();
    ...
    public void executeReturnsTheRequiredResults() throws Exception {
        ...
        when(jdbcTemplate.queryForList(anyString(), argThat(new MapSqlParamterSourceMatcher()),
                                       eq(Integer.class))).thenReturn(Arrays.asList(12, 34, 54, 98, 909));
        ...
        // then
        List<Integer> result = (List) context.get("vrijgezelBsnList");
