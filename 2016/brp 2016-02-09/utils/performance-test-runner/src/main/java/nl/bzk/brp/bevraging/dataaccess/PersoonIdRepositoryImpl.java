...
public class PersoonIdRepositoryImpl implements PersoonIdRepository {
    ...
    @Override
    public List<Integer> vindAllePersoonIds() {
        TypedQuery<Integer> tQuery = entityManager.createQuery("SELECT p.id FROM PersoonModel p", Integer.class);
        return tQuery.getResultList();
    }

    @Override
    public List<Integer> vindPersoonIds(final int vanafId, final int aantalIds) {
    ...
    @Override
    public List<Integer> vindBijgehoudenPersoonIds(final Integer uren) {
