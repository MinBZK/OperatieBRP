...
public class JavaMutatorFunctie extends JavaFunctie implements Cloneable {
    ...
    /** De naam van de parameter van deze setter. */
    ...
    public JavaMutatorFunctie(final JavaVeld veld) {
        this(JavaAccessModifier.PUBLIC,
            String.format("set%s", GeneratieUtil.upperTheFirstCharacter(veld.getNaam())), veld.getNaam(), veld.getNaam());
    ...
    /**
     * Retourneert de parameter variabele naam.
     *
     * @return Parameter variabele naam.
     */
