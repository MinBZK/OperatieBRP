 ...
 *
 */
public class HisVolledigPredikaatViewModelNaamgevingStrategie extends AbstractModelSpecifiekeNaamgevingStrategie {

    @Override
    protected GeneratiePackage getModelSpecifiekePackageVoorObjectTypes() {
        return GeneratiePackage.OBJECTTYPE_HISVOLLEDIG_PREDIKAAT_VIEW_PACKAGE;
    }

    @Override
    protected GeneratiePackage getModelSpecifiekePackageVoorGroepen() {
        throw new UnsupportedOperationException("Het hisvolledig delta view model kent geen groepen.");
    }

    @Override
    protected GeneratiePackage getModelSpecifiekePackageVoorTuples() {
        throw new UnsupportedOperationException("Het hisvolledig delta view model kent geen tuples.");
    }
    ...
    {
        return new PrefixSuffix("", "HisVolledigView");
    }
