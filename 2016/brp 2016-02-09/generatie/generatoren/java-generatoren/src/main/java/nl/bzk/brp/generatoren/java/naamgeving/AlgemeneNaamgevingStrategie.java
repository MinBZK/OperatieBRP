...
public class AlgemeneNaamgevingStrategie extends AbstractNaamgevingStrategie {
     ...
     */
    public AlgemeneNaamgevingStrategie() {
    }
    ...
    protected final String bepaalPackageNaamVoorElement(final GeneriekElement element) {
        ...
        switch (soort) {
            case OBJECTTYPE:
                ...
                break;
            case ATTRIBUUTTYPE:
                packageNaam = concatPackages(GeneratiePackage.ATTRIBUUTTYPE_PACKAGE, getSchemaVoorElement(element));
                break;
            default:
    ...
    public final boolean heeftElementEenAlgemeneNaam(final GeneriekElement element) {
        final BmrElementSoort soort = BmrElementSoort.getBmrElementSoortBijCode(element.getSoortElement().getCode());
