...
/**
 * Implementatie van de {@link NaamgevingStrategie} interface voor HisMoment objecten binnen het logische model.
 *
 */
public final class HisMomentNaamgevingStrategie extends AbstractModelSpecifiekeNaamgevingStrategie {
    ...
    protected PrefixSuffix getModelSpecifiekePrefixSuffixVoorObjectType(final ObjectType element) {
        return new PrefixSuffix("", "HisMoment");
    }
