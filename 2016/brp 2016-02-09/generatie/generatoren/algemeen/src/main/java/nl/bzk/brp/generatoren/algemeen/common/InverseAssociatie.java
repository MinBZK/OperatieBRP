...
public class InverseAssociatie {
    ...
    private Character inverseAssociatieViewsPerDiscriminatorWaardeOnderdrukken;
     ...
     * @param inverseAssociatieViewsOnderdrukken onderdruk het aanmaken van associatie views?
     */
            ...
            final Character inverseAssociatieViewsPerDiscriminatorWaardeOnderdrukken)
    {
        ...
        this.inverseAssociatieViewsPerDiscriminatorWaardeOnderdrukken = inverseAssociatieViewsPerDiscriminatorWaardeOnderdrukken;
    }
    ...
    public Character getInverseAssociatieViewsPerDiscriminatorWaardeOnderdrukken() {
        return inverseAssociatieViewsPerDiscriminatorWaardeOnderdrukken;
    }
