...
public interface BmrDao {
    ...
    /**
     * Retourneert de enumeratie lijst van tuples voor een bepaald object type.
     * Zal alleen van toepassing zijn als hier tuples voor aanwezig zijn in het BMR.
     *
     * @param objectType een object type
     * @return de lijst van enumeratie waardes, kan leeg zijn
     */
    List<Tuple> getTupleEnumeratieVoorObjectType(final ObjectType objectType);
    ...
    /**
     * Retourneert attributen in andere object typen die van het type objecttype zijn.
     * Let op: deze methode filtert ook meteen op de attributen die een XSD inverse associatie ident code hebben.
     *
     * @param objectType Het object type dat inverse in andere object typen zit.
     * @return Lijst van attributen die in verschillende object typen zitten.
     */
    List<Attribuut> getXsdInverseAttributenVoorObjectType(final ObjectType objectType);
    ...
    /**
     * Bepaalt of een attribuut een logisch identiteit attribuut is.
     *
     * @param attribuut het te controleren attribuut
     * @return true indien attribuut een logische identiteit attribuut is
     */
    boolean isLogischIdentiteitAttribuut(final Attribuut attribuut);
    ...
    /**
     * Retourneert de attributen in de operationele laag die oorspronkelijk zijn afgeleid van het opgegeven (logische
     * laag) attribuut.
     *
     * @param attribuut het (logische laag) attribuut waarvoor de operationele attributen gezocht worden.
     * @return een lijst van (operationele laag) attributen.
     */
    List<Attribuut> getOperationeleLaagAttributenVoorLogischeLaagAttribuut(Attribuut attribuut);

    /**
     * Retourneet logische laag attribuut dat hoort bij het opgegeven operationele laag attribuut.
     *
     * @param ogmAttribuut operationele laag attribuut.
     * @return attribuut uit logische laag.
     */
    Attribuut getLogischeLaagAttribuutVoorOperationeleLaagAttribuut(Attribuut ogmAttribuut);

    /**
     * Retourneert lijst records van de VW_ELEMENT view uit BMR.
     * @return lijst met VwElement records
     */
    List<VwElement> getVwElementen();

    /**
     * Retourneert map van records van de VW_ELEMENT view uit BMR.
     * @return map met VwElement records en de keys bestaan uit ids
     */
    Map<Integer, VwElement> getVwElementenAlsMap();

    /**
     * Retourneert lijst records van de VW_ELEMENT view uit BMR.
     *
     * @param soort de soort (A=attribuut, G=groep, OT=objecttype)
     * @return the vw elementen van soort
     */
    List<VwElement> getVwElementenVanSoort(String soort);

    /**
     * Zoek een VW_ELEMENT view record bij een id.
     * @param id de is
     * @return record uit de VW_ELEMENT view
     */
    VwElement getVwElementMetId(int id);

    /**
     * Retourneert alle object types met syncid.
     *
     * @return map met object type met syncid
     */
    Map<Integer, ObjectType> getObjectTypesAlsMap();

    /**
     * Retourneert alle groepen met syncid.
     *
     * @return map met groep met syncid
     */
    Map<Integer, Groep> getGroepenAlsMap();
}
