...
public interface RapportageUitvoerder {
    ...
    /**
     * Of er daadwerkelijk inhoud in de rapportage staat.
     * Het kan namelijk zijn dat er niets te rapporteren valt.
     * Alleen aan te roepen na initialisatie en verwerken rapportage,
     * voor het wegschrijven ervan.
     *
     * @return of de rapportage inhoud heeft
     */
    boolean heeftRapportageInhoud();
