...
public class GeneratorConfiguratie {
    ...
    public String getGeneratorNaam() {
        return generatorNaam;
    }

    public void setGeneratorNaam(final String generatorNaam) {
        this.generatorNaam = generatorNaam;
    }
    ...
    public boolean isBehoudUserTypeAanpassingen() {
        return behoudUserTypeAanpassingen;
    }

    public void setBehoudUserTypeAanpassingen(final boolean behoudUserTypeAanpassingen) {
        this.behoudUserTypeAanpassingen = behoudUserTypeAanpassingen;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("naam", naam)
                                        ...
                                        .append("behoud user type aanpassingen", behoudUserTypeAanpassingen)
