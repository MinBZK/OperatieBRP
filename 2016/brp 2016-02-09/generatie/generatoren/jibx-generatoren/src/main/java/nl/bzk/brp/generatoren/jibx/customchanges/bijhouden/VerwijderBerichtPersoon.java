 ...
 */
public class VerwijderBerichtPersoon extends AbstractHandmatigeVerwijzing implements HandmatigeWijziging {

    @Override
    public void voerUit(final Document rootElementBinding)
            throws XPathFactoryConfigurationException, XPathExpressionException
    {
        removeNode(rootElementBinding, "/binding/mapping/structure[@map-as='Container_BerichtPersonen']");
        removeNode(rootElementBinding, "/binding/mapping/collection/structure[@map-as='Objecttype_BerichtPersoon']");
    }
}
