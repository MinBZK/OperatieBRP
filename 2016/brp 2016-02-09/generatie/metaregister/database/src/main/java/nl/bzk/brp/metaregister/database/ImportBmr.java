...
public class ImportBmr {
     ...
     * @throws IOException indien er problemen optreden bij het uitlezen van de properties of lezen van het
     * DBUnit data bestand.
     * @throws ClassNotFoundException indien de driver voor de lokale database niet gevonden kan worden.
     * @throws SQLException indien er fouten optreden bij het uitvoeren van de benodigde SQL queries op de database.
     * @throws DatabaseUnitException indien er fouten optreden bij het vullen van de database op basis van het DBUnit
     * data bestand.
     */
     ...
     * @throws DatabaseUnitException indien er fouten optreden bij het vullen van de database op basis van het DBUnit
     * data bestand.
     * @throws IOException indien er problemen optreden bij het lezen van het DBUnit data bestand.
     */
    public final void importeer() throws ClassNotFoundException, SQLException, DatabaseUnitException, IOException {
        ...
        try {
            ...
            // Tabel gefilterde database import
            ...
            // Zet de referentiele integrity weer aan
     ...
     * @throws SQLException indien er problemen zijn bij het zetten van de referential integrity.
     */
