...
public class ExportBmr {
            ...
            throws ClassNotFoundException, SQLException, DatabaseUnitException, IOException
    {
        ...
        try {
            ...
            String filename = properties.getProperty(EXPORT_BESTAND);
    ...
    private ITableFilter bouwTabelFilter() {
        ...
        tabelFilter.excludeTable("*EA_*");
        tabelFilter.excludeTable("*TRACE*");
        tabelFilter.excludeTable("TEKSTVERSIE");
        tabelFilter.excludeTable("REGEL_VERSIE");
        tabelFilter.excludeTable("REGEL_STATUS*");
        tabelFilter.excludeTable("WIJZIGING_IN_RELEASE");
        tabelFilter.excludeTable("BRP_ELEMENT_GEN_SYNC_REGEL*");
        tabelFilter.excludeTable("CONTROLE_RESULTAAT*");
        tabelFilter.excludeTable("DIAGRAM");
        tabelFilter.excludeTable("EXPORTREGEL");
        tabelFilter.excludeTable("OM_RESYNC_REGEL");
        tabelFilter.excludeTable("RAPPORTAGE");
        tabelFilter.excludeTable("RELEASE_");
        tabelFilter.excludeTable("WIJZIGING_IN_RELEASE");
        tabelFilter.excludeTable("TEKST_BIJ_RELEASE");
        tabelFilter.excludeTable("TAG_IN_CODE");
        tabelFilter.excludeTable("TESTVOORWAARDE*");
