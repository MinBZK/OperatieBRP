...
/**
 * Dit is de (platform/generator onafhankelijke) interface voor een Data Access Object voor het BMR. Onderstaande functies moeten een implementatie kennen
 * willen de generatoren met behulp van de DAO hun werk doen.
 */
public interface BmrDao {
     ...
     * @param <T>   Het type wat geretourneerd wordt, dit afhankelijk van het java type wat met de clazz param wordt aangegeven.
