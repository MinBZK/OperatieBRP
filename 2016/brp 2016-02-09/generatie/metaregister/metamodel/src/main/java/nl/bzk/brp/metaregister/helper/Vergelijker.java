 ...
 * ander algoritme wordt gebruikt voor de vergelijking.
 */
public class Vergelijker implements Comparator<Object> {

    // TODO: Deze hele class moet eens onder handen genomen worden om te kijken of het nog wel
    // zo zou moeten werken en hoe het misschien beter / efficienter / generieken kan.
    ...
    public final int compare(final Object o1, final Object o2) {
        ...
        if (o1 == o2) {
            ...
            } else if (o1 instanceof ObjectType) {
                // Nieuw geval voor ObjectType, aangezien er nu een subtypen collectie in ObjectType is, met
                // daarin ook ObjectType elementen. Deze hebben geen volgnummer, dus vergelijken we ze op ident code.
                resultaat = ((ObjectType) o1).getIdentCode().compareTo(((ObjectType) o2).getIdentCode());
            } else {
     ...
     * ondersteund (dus geen {@link nl.bzk.brp.metaregister.model.Element} of {@link
     * nl.bzk.brp.metaregister.model.GeneriekElement}), dan zal er een default waarde worden geretrourneerd van '0'.
     *
