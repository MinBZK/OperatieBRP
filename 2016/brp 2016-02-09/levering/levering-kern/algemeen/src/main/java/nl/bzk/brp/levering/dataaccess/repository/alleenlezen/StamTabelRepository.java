...
public interface StamTabelRepository {
    ...
    /**
     * Geef een lijst van alle elementen. Gebruikt door cache.
     *
     * @return lijst van alle elementen
     */
    ...
    /**
     * Haal alle stamgegevens records op van een bepaald type synchronisatie stamgegeven.
     *
     * @param stamgegevenClazz stamgegeven klasse
     * @return lijst van stamgegeven entities.
     */
    List<? extends SynchroniseerbaarStamgegeven> vindAlleStamgegevens(
            Class<? extends SynchroniseerbaarStamgegeven> stamgegevenClazz);
