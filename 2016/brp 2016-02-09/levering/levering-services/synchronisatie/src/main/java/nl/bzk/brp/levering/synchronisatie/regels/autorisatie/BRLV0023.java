...
/**
 * De persoon waarvoor de partij een synchronisatie verzoekt, moet binnen de doelbinding van het leveringsautorisatie van de partij vallen.
 *
 * @brp.bedrijfsregel BRLV0023
 */
@Named("BRLV0023")
@Regels(Regel.R1344)
public final class BRLV0023 extends AbstractLeveringRegel implements AutorisatieBedrijfsregel {
