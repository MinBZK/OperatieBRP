 ...
 */
public class BerichtGegevensValidatieStap extends AbstractBerichtValidatieStap<GeefSynchronisatiePersoonBericht,
        GeefSynchronisatiePersoonBericht, SynchronisatieBerichtContext, SynchronisatieResultaat>
{

    @Override
    public final boolean voerStapUit(final GeefSynchronisatiePersoonBericht bericht,
                               final SynchronisatieBerichtContext synchronisatieBerichtContext,
                               final SynchronisatieResultaat synchronisatieResultaat)
    {
        valideer(bericht, synchronisatieResultaat);
        return DOORGAAN;
    }
}
