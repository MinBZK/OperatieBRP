 ...
 */
public class VoorbereidVerwerkingStap extends AbstractBerichtVerwerkingStap<GeefSynchronisatiePersoonBericht,
    SynchronisatieBerichtContext, SynchronisatieResultaat>
{
        ...
        final SynchronisatieResultaat resultaat)
    {
        final Map<Integer, Map<String, List<Attribuut>>> persoonAttributenMap =
            bouwPersoonAttributenMap(Collections.singletonList(context.getPersoonHisVolledig()));
        ...
        final Map<Integer, Map<Integer, List<Attribuut>>> persoonOnderzoekenMap =
            bouwPersoonOnderzoekenMap(Collections.singletonList(context.getPersoonHisVolledig()), persoonAttributenMap, elementAttributenMap);
