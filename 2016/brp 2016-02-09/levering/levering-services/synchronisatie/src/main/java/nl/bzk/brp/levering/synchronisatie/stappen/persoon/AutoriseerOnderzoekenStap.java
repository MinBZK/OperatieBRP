...
public class AutoriseerOnderzoekenStap extends AbstractBerichtVerwerkingStap<GeefSynchronisatiePersoonBericht, SynchronisatieBerichtContext,
    SynchronisatieResultaat>
{
     ...
     */
    private void autoriseerOnderzoekenVanPersonen(final SynchronisatieBerichtContext context) {
     ...
     */
    private void autoriseerOnderzoeken(final PersoonHisVolledigView persoonHisVolledigView, final SynchronisatieBerichtContext context) {
