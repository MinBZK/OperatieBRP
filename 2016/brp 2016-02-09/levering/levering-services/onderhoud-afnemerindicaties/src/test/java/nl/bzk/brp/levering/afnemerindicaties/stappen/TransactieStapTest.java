...
public class TransactieStapTest {
    ...
    public final void testTransactieWordtGecreeerdMetJuisteParameters() {
        final RegistreerAfnemerindicatieBericht onderwerp = maakBericht();
        final OnderhoudAfnemerindicatiesBerichtContext context =
            new OnderhoudAfnemerindicatiesBerichtContextImpl(new BerichtenIds(1L, 2L),
                StatischeObjecttypeBuilder.PARTIJ_GEMEENTE_BREDA.getWaarde(), "ref-00001",
                new CommunicatieIdMap());
        final OnderhoudAfnemerindicatiesResultaat resultaat =
            new OnderhoudAfnemerindicatiesResultaat(Collections.<Melding>emptyList());
    ...
    public final void testGeenTransactionStatus() {
        ...
        final OnderhoudAfnemerindicatiesBerichtContext context =
            new OnderhoudAfnemerindicatiesBerichtContextImpl(new BerichtenIds(1L, 2L),
                StatischeObjecttypeBuilder.PARTIJ_GEMEENTE_BREDA.getWaarde(), "ref-00002",
                new CommunicatieIdMap());
        final OnderhoudAfnemerindicatiesResultaat resultaat =
            new OnderhoudAfnemerindicatiesResultaat(Collections.<Melding>emptyList());
    ...
    public final void testGeenSuccesvolResultaat() {
        ...
        final OnderhoudAfnemerindicatiesBerichtContext context =
            new OnderhoudAfnemerindicatiesBerichtContextImpl(new BerichtenIds(1L, 2L),
                StatischeObjecttypeBuilder.PARTIJ_GEMEENTE_BREDA.getWaarde(), "ref-00003",
                new CommunicatieIdMap());
        final OnderhoudAfnemerindicatiesResultaat resultaat = maakResultaatMetFoutMeldingen();
    ...
    public final void testFoutResultaatVeroorzaaktRollbackInNaverwerking() {
        ...
        final OnderhoudAfnemerindicatiesBerichtContext context =
            new OnderhoudAfnemerindicatiesBerichtContextImpl(new BerichtenIds(1L, 2L),
                StatischeObjecttypeBuilder.PARTIJ_GEMEENTE_BREDA.getWaarde(), "ref-00004",
                new CommunicatieIdMap());
        final OnderhoudAfnemerindicatiesResultaat resultaat = maakResultaatMetFoutMeldingen();
    ...
    public final void testRollbackStatusVeroorzaaktRollbackInNaverwerking() {
        ...
        final OnderhoudAfnemerindicatiesBerichtContext context =
            new OnderhoudAfnemerindicatiesBerichtContextImpl(new BerichtenIds(1L, 2L),
                StatischeObjecttypeBuilder.PARTIJ_GEMEENTE_BREDA.getWaarde(), "ref-00005",
                new CommunicatieIdMap());
        final OnderhoudAfnemerindicatiesResultaat resultaat =
            new OnderhoudAfnemerindicatiesResultaat(Collections.<Melding>emptyList());
    ...
    public final void testNormaleFlow() {
        ...
        final OnderhoudAfnemerindicatiesBerichtContext context =
            new OnderhoudAfnemerindicatiesBerichtContextImpl(new BerichtenIds(1L, 2L),
                StatischeObjecttypeBuilder.PARTIJ_GEMEENTE_BREDA.getWaarde(), "ref-00006",
                new CommunicatieIdMap());
        final OnderhoudAfnemerindicatiesResultaat resultaat =
            new OnderhoudAfnemerindicatiesResultaat(Collections.<Melding>emptyList());
    ...
    private RegistreerAfnemerindicatieBericht maakBericht() {
        final RegistreerAfnemerindicatieBericht bericht = new RegistreerAfnemerindicatieBericht();
    ...
    private OnderhoudAfnemerindicatiesResultaat maakResultaatMetFoutMeldingen() {
        final OnderhoudAfnemerindicatiesResultaat resultaat =
            new OnderhoudAfnemerindicatiesResultaat(new ArrayList<Melding>(1));
