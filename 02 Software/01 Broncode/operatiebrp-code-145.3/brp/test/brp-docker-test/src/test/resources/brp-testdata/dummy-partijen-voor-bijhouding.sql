...
INSERT INTO kern.gem (id,code,naam,partij,voortzettendegem,dataanvgel,dateindegel) VALUES('7024','7124','Gemeente wordt voortgezet door BRP 1','27024',7012,'19940101','19950101');
...
-- INSERT INTO kern.partijrol (partij, rol) VALUES ((select id from kern.partij where naam='Gemeente Amsterdam'), '2');
INSERT INTO kern.partijrol (partij, rol) VALUES ((select id from kern.partij where naam='Gemeente Eindhoven'), '2');

insert into kern.his_partijrol (partijrol,tsreg,datingang)values ((select id from kern.partijrol where partij = (select id from kern.partij where code =199902)), (now() at time zone 'UTC'),19900101);
