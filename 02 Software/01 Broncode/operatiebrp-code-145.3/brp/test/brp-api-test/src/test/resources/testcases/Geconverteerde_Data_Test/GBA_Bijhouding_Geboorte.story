...
Narrative:
Leveren van GBA Bijhouding Persoon wordt geboren

Scenario: 0.    Initiele vulling voor Geboorte van een kind
                LT:
                Verwacht resultaat:
                - Volledig bericht voor geboorte Kind
...
|bsn|773201993
Then is het antwoordbericht gelijk aan  /testcases/Geconverteerde_Data_Test/Expecteds/GDP_Voor_Geboorte_Kind.xml voor expressie //brp:lvg_bvgGeefDetailsPersoon_R
...
Scenario: 1.    GBA Geboorte van een kind
                LT:
                Verwacht resultaat:
                - Volledig bericht na geboorte Kind

!-- Mutatiebericht door administratieve handeling geboorte Kind
Given persoonsbeelden uit specials:specials/Bertha_Geboorte_Kind_xls
...
Then is het synchronisatiebericht gelijk aan /testcases/Geconverteerde_Data_Test/Expecteds/Mutatie_Geboorte_Kind.xml voor expressie //brp:lvg_synVerwerkPersoon
...
!-- Geef details persoon na geboorte Kind
Given verzoek geef details persoon:
|key|value
|leveringsautorisatieNaam|'Levering obv doelbinding'
|zendendePartijNaam|'Gemeente Utrecht'
...
Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/Geconverteerde_Data_Test/Expecteds/GDP_Na_Geboorte_Kind.xml voor expressie //brp:lvg_bvgGeefDetailsPersoon_R
