...
/**
 * Converteert een xml reponse bericht naar expected (m.a.w. '*' voor waarden actieInhoud, voorkomenSleutels etc.)
 */
public class AllesWegSterren {

    public static void main(String[] args) throws IOException, URISyntaxException {

        String pad = "./converteren/1_Resultaatset personen.xml";
