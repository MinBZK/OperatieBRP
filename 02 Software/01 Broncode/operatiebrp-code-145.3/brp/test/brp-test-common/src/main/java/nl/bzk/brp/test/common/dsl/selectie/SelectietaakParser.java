 ...
 */
public class SelectietaakParser {
    ...
    //is verplicht maar functioneel nog niet gebruikt
    private static AtomicInteger volgnummer = new AtomicInteger(0);
     ...
     */
    public static Selectietaak parse(final DslSectie sectie, final Function<DienstSleutel, Dienst> dienstResolver,
                                     final Function<DienstSleutel, ToegangLeveringsAutorisatie> tlaResolver) {
        ...
        final Dienst dienst = dienstResolver.apply(dienstSleutel);

        final Selectietaak selectietaak = new Selectietaak(dienst, tlaResolver.apply(dienstSleutel), volgnummer.incrementAndGet());
