...
Scenario: Blokkering is JA, SysDate groter gelijk DatIngang,SysDate kleiner DatEinde
          LT: MBHP09C10T110
...
When voer een bijhouding uit MBHP09C10T110.xml namens partij 'Gemeente BRP 1'

Then is het antwoordbericht gelijk aan /testcases/bijhouding/MBHP/expected/MBHP09C10T110.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
Given de database is aangepast met: delete from autaut.his_bijhouderfiatuitz where id =99999
And de database is aangepast met: delete from autaut.bijhouderfiatuitz where id =99999
