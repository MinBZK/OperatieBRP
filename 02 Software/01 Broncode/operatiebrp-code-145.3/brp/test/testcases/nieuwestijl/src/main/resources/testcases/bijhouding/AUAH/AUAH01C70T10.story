...
@regels                 R2269
@usecase                BY.1.AA
@sleutelwoorden         AUAH01C70T10, Geslaagd, Logging
...
Given voer enkele update uit: update kern.partij set datingang = to_number((to_char(now()+ interval '1 day', 'YYYYMMDD')),'99999999'), dateinde = to_number((to_char(now() + interval '2 day', 'YYYYMMDD')),'99999999') where naam = 'Gemeente BRP beeindigd 1'
Given voer enkele update uit: update kern.his_partij set datingang = to_number((to_char(now()+ interval '1 day', 'YYYYMMDD')),'99999999'), dateinde = to_number((to_char(now() + interval '2 day', 'YYYYMMDD')),'99999999') where naam = 'Gemeente BRP beeindigd 1'

Scenario: 2. De ondertekenaar is geen geldige partij(datum voor datingang)
          LT: AUAH01C70T10
...
And is het antwoordbericht gelijk aan /testcases/bijhouding/AUAH/expected/AUAH01C70T10.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
