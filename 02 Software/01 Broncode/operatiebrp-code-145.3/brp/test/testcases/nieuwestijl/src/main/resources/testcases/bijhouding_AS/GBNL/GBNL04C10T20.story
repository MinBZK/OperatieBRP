...
Scenario:   Registratie geborene in Nederland met OUWKIG(I) en een onbekende NOUWKIG
            LT: GBNL04C10T20

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T20-001.xls

When voer een bijhouding uit GBNL04C10T20.xml namens partij 'Gemeente BRP 1'
...
Then in kern heeft select sb.naam as soortrol, sp.naam as srtpersoon, p.voornamen
                   ...
                   left outer join kern.actie a on a.id = hre.actieinh
                   left outer join kern.srtactie sa on sa.id = a.srt
                   where sa.naam ='Registratie geborene' and sb.naam = 'Ouder' order by p.voornamen de volgende gegevens:
| veld                      | waarde                                        |
| soortrol                  | Ouder                                         |
| srtpersoon                | Ingeschrevene                                 |
| voornamen                 | Mama                                          |
