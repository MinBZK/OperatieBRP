...
Scenario:   Registratie geborene in Nederland met OUWKIG(I) en een juridisch niet aanwezige NOUWKIG
            LT: GBNL04C10T30

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T30-001.xls

When voer een bijhouding uit GBNL04C10T30.xml namens partij 'Gemeente BRP 1'
...
| geslnaamstamnaamgebruik   | Moeder                                        |
...
!-- Controleer dat betrokkenheid NOUWKIG niet aanwezig is
Then in kern heeft select sb.naam as soortrol, sp.naam as srtpersoon, p.voornamen
                   from kern.betr b
                   left outer join kern.pers p on b.pers = p.id
                   left outer join kern.srtbetr sb on sb.id = b.rol
                   ...
                   left outer join kern.actie a on a.id = hre.actieinh
                   left outer join kern.srtactie sa on sa.id = a.srt
                   where sa.naam ='Registratie geborene' order by p.voornamen de volgende gegevens:
| veld                      | waarde                                        |
| soortrol                  | Kind                                          |
| srtpersoon                | Ingeschrevene                                 |
| voornamen                 | Hendrik Jan                                   |
