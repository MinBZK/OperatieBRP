...
Scenario:   Registratie NL nationaliteit waardoor overige nationaliteit (in hetzelfde bericht wordt beeindigd) vervalt
            LT: GNNG04C80T20

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GNNG/GNNG04C80T20-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GNNG/GNNG04C80T20-002.xls

When voer een bijhouding uit GNNG04C80T20.xml namens partij 'Gemeente BRP 1'
...
Then in kern heeft select sainh.naam as actieInhoud, saav.naam as actieVerval, n.naam as nationaliteit, pn.rdnverk, hpn.dataanvgel, hpn.dateindegel, hpn.indbijhoudingbeeindigd, saaa.naam as actieAanp
                   ...
                   order by hpn.dataanvgel, hpn.dateindegel de volgende gegevens:
| veld                      | waarde                            |
