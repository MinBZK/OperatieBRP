...
Scenario:   2. Ontrelateren bij Beëindiging geregistreerd partnerschap in Nederland
            LT: ONTR02C10T40

Given enkel initiele vulling uit bestand /LO3PL-ONTR/ONTR02C10T40-001.xls
Given enkel initiele vulling uit bestand /LO3PL-ONTR/ONTR02C10T40-002.xls

When voer een bijhouding uit ONTR02C10T40a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONTR/expected/ONTR02C10T40a.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R

Given pas laatste relatie van soort 2 aan tussen persoon 621419497 en persoon 875720201 met relatie id 30010001 en betrokkenheid id 30010001

Then is in de database de persoon met bsn 621419497 wel als PARTNER betrokken bij een GEREGISTREERD_PARTNERSCHAP
Then is in de database de persoon met bsn 875720201 wel als PARTNER betrokken bij een GEREGISTREERD_PARTNERSCHAP
...
When voer een bijhouding uit ONTR02C10T40b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONTR/expected/ONTR02C10T40b.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
...
Then is in de database de persoon met bsn i:621419497 wel als PARTNER betrokken bij een GEREGISTREERD_PARTNERSCHAP
Then is in de database de persoon met bsn i:875720201 niet als PARTNER betrokken bij een GEREGISTREERD_PARTNERSCHAP
