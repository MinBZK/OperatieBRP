...
Scenario:   Bericht met een deblokkeerbare melding wordt de Administratieve handeling niet vastgelegd in de groep Standaard
            LT: ARBR04C10T40

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL/Libby-gebdat-deels-onbekend1.xls

When voer een bijhouding uit ARBR04C10T40.xml namens partij 'Gemeente Tiel'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ARBR/expected/ARBR04C10T40.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
...
| verwerking              | Foutief                                                 |
| bijhouding              | NULL                                                    |
| hoogstemeldingsniveau   | Deblokkeerbaar                                          |
| admhnd                  | NULL                                                    |
