 ...
 */
public abstract class AbstractVoerKlaarStoriesUit extends AbstractSpringJBehaveStories {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractSpringJBehaveStories.class);
}
