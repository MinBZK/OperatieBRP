...
Scenario:   Ongedaan maken van een huwelijk tussen BRP (I) en BRP (I), nav 'O', 1 bron, bijhoudingsgemeente persoon
            LT: ONHW04C10T10

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-ONHW/ONHW04C10T10-001.xls
Given enkel initiele vulling uit bestand /LO3PL-ONHW/ONHW04C10T10-002.xls

When voer een bijhouding uit ONHW04C10T10a.xml namens partij 'Gemeente BRP 1'

Given pas laatste relatie van soort 1 aan tussen persoon 355037257 en persoon 228180417 met relatie id 50000001 en betrokkenheid id 50000001
Then heeft het antwoordbericht verwerking Geslaagd

Then is in de database de persoon met bsn 355037257 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn 228180417 wel als PARTNER betrokken bij een HUWELIJK

When voer een bijhouding uit ONHW04C10T10b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Then is in de database de persoon met bsn 355037257 niet als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn 228180417 niet als PARTNER betrokken bij een HUWELIJK
...
Then in kern heeft select indag, dataanv from kern.relatie where srt = '1' de volgende gegevens:
| veld              | waarde                         |
| indag             | false                          |
| dataanv           | NULL                           |