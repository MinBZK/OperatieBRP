...
Scenario:   Erkenning met registratie niet NL nationaliteit waarbij Namenreeks op Ja
            LT: ERKE01C130T30

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-ERKE/ERKE01C130T30-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-ERKE/ERKE01C130T30-002.xls
...
When voer een bijhouding uit ERKE01C130T30a.xml namens partij 'Gemeente BRP 1'
...
Then heeft $NATI_ID$ de waarde van de volgende query: select n.id from kern.persnation n join kern.pers p on p.id = n.pers where p.bsn = '270902697'

When voer een bijhouding uit ERKE01C130T30b.xml namens partij 'Gemeente BRP 1'
