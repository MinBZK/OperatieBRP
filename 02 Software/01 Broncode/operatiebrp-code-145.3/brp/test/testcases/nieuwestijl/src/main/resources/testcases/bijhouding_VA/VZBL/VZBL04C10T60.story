...
Scenario:   Verwerking Hoofdactie Registratie migratie. Aangever is Inwonend ouder voor meerderjarig kind.
            LT: VZBL04C10T60

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-VA/LO3PL-VZBL/VZBL04C10T60.xls

When voer een bijhouding uit VZBL04C10T60.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Then is het antwoordbericht gelijk aan /testcases/bijhouding_VA/VZBL/expected/VZBL04C10T60.xml voor expressie //brp:bhg_vbaRegistreerVerhuizing_R
...
| Aangever                  | Inwonend ouder voor meerderjarig kind |
| Land                      | Aruba                                 |
