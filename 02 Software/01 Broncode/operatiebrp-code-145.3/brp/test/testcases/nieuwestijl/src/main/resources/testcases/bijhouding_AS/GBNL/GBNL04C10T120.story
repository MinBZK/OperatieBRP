...
Scenario:   Registratie geborene in Nederland met OUWKIG(I) (Met vervallen Bijz.VerblijfsR. Positie)
            LT: GBNL04C10T120

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T120-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T120-002.xls

When voer een bijhouding uit GBNL04C10T120a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

When voer een bijhouding uit GBNL04C10T120b.xml namens partij 'Gemeente BRP 1'
...
Then in kern heeft select si.naam, pi.waarde, sa.naam as actieverval, pe.voornamen
                   ...
                   left outer join kern.actie a on a.id = hpi.actieverval
                   left outer join kern.srtactie sa on sa.id = a.srt
                   left outer join kern.pers pe on pe.id = pi.pers
                   where si.naam = 'Bijzondere verblijfsrechtelijke positie?' de volgende gegevens:
| veld                      | waarde                                             |
| naam                      | Bijzondere verblijfsrechtelijke positie?           |
| waarde                    | NULL                                               |
| actieverval               | Beëindiging bijzondere verblijfsrechtelijke positie|
| voornamen                 | Mama                                               |
