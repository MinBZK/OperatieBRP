...
Scenario:   Registratie geborene in Nederland met OUWKIG(I) (Met verstrekkingsbeperking partij niet geldig op Datum geboorte van Kind) en NOUWKIG(I)
            LT: GBNL04C10T70

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T70-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T70-002.xls

When voer een bijhouding uit GBNL04C10T70a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Given de database is aangepast met: update kern.partij set dateinde = '19950101' where code = '850001'

Given maak bijhouding caches leeg

When voer een bijhouding uit GBNL04C10T70b.xml namens partij 'Gemeente BRP 1'
Then heeft het antwoordbericht verwerking Geslaagd
...
Then in kern heeft select vb.omsderde, vb. gemverordening, p.voornamen, pa.naam as naampartij
...
Given de database is aangepast met: update kern.partij set dateinde = NULL where code = '850001'
