...
Given enkel initiele vulling uit bestand /LO3PL-VA/LO3PL-VZBG/VZBG04C20T30-001.xls

When voer een bijhouding uit VZBG04C20T30.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding_VA/VZBG/expected/VZBG04C20T30.xml voor expressie //brp:bhg_vbaRegistreerVerhuizing_R
...
Then in kern heeft select count(1)
                   ...
                   where p.bsn ='162207141' de volgende gegevens:
| veld                      | waarde |
| count                     | 2      |
