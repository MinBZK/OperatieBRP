...
Scenario:   Verwerking Hoofdactie Registratie migratie. Aangever is een verzorger.
            LT: VZBL04C10T100

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-VA/LO3PL-VZBL/VZBL04C10T100.xls

When voer een bijhouding uit VZBL04C10T100.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Then is het antwoordbericht gelijk aan /testcases/bijhouding_VA/VZBL/expected/VZBL04C10T100.xml voor expressie //brp:bhg_vbaRegistreerVerhuizing_R
...
| dataanvgel                | 20170101                           |
| redenWijzigenMigratie     | Ministerieel besluit               |
| Land                      | Aruba                              |
...
!-- Controleer Persoon.Bijhouding op nadere bijhoudingsaard M ("Bijzondere status")
Then in kern heeft select count(*)
                   from   kern.his_persbijhouding
                   where  bijhaard in (select id from kern.bijhaard where code='N')
                   and    naderebijhaard in (select id from kern.naderebijhaard where code='M')
