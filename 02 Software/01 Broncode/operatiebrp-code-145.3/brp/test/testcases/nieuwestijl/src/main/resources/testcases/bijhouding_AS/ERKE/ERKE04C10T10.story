...
Scenario:   Erkenning waarbij de alle betrokken partijen een verschillende gemeente heeft
            LT: ERKE04C10T10

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-ERKE/ERKE04C10T10-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-ERKE/ERKE04C10T10-002.xls

When voer een bijhouding uit ERKE04C10T10a.xml namens partij 'Gemeente BRP 1'
Then heeft het antwoordbericht verwerking Geslaagd

Then staat er 0 notificatiebericht voor bijhouders op de queue

When voer een bijhouding uit ERKE04C10T10b.xml namens partij 'Gemeente BRP 2'
Then heeft het antwoordbericht verwerking Geslaagd

Then staat er 1 notificatiebericht voor bijhouders op de queue

When voer een bijhouding uit ERKE04C10T10c.xml namens partij 'Gemeente BRP 2'
Then heeft het antwoordbericht verwerking Geslaagd
...
When voer een bijhouding uit ERKE04C10T10d.xml namens partij 'Gemeente BRP 1'
Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding_AS/ERKE/expected/ERKE04C10T10.xml voor expressie /
...
Then in kern heeft select sb.naam as soortrol, sp.naam as srtpersoon, p.voornamen
                   ...
                   where b.relatie in (select relatie from kern.betr where pers in (select id from kern.pers where bsn='264484009'))
...
!-- Controleer dat de voornamen zijn bijgewerkt op Materiële Historie
Then in kern heeft select sainh.naam as actieInhoud, saav.naam as actieVerval, hpv.dataanvgel, hpv.dateindegel, hpv.naam, saaa.naam as actieAanp
                   ...
                   where p.bsn ='264484009'
                   and hpv.tsverval is NULL
...
!-- Controleer dat de voornamen zijn bijgewerkt op Formele Historie
Then in kern heeft select sainh.naam as actieInhoud, saav.naam as actieVerval, hpv.dataanvgel, hpv.dateindegel, hpv.naam, saaa.naam as actieAanp
                   from kern.his_persvoornaam hpv
                   left join kern.persvoornaam pv on pv.id = hpv.persvoornaam
                   left join kern.pers p on p.id = pv.pers
