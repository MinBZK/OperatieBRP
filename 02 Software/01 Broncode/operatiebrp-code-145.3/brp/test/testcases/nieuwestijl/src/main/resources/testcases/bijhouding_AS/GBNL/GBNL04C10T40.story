...
Scenario:   Registratie geborene in Nederland met OUWKIG(I) en NOUWKIG(NI), gegevens NOUWKIG wordt meegegeven in bericht
            LT: GBNL04C10T40

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T40-001.xls


When voer een bijhouding uit GBNL04C10T40.xml namens partij 'Gemeente BRP 1'
...
| admhndnaam                | Geboorte in Nederland                         |
| sorteervolgorde           | 1                                             |
...
Then in kern heeft select oud.dataanvgel, sa.naam, p.voornamen
...
!-- Controleer gerelateerde gegevens NOUWKIG
Then in kern heeft select id.bsn, id.anr, sg.indnreeks, sg.predicaat, sg.voornamen, sg.voorvoegsel, sg.scheidingsteken, sg.geslnaamstam,
                   pg.datgeboorte, pg.blplaatsgeboorte, pg.blregiogeboorte, lg.naam as land, gs.naam as geslacht
                   from kern.his_persids id
                   left outer join kern.his_perssamengesteldenaam sg on sg.pers = id.pers
                   left outer join kern.his_persgeboorte pg on pg.pers = id.pers
                   left outer join kern.landgebied lg on lg.id = pg.landgebiedgeboorte
                   left outer join kern.his_persgeslachtsaand ges on ges.pers = id.pers
                   left outer join kern.geslachtsaand gs on gs.id = ges.geslachtsaand
                   left outer join kern.pers p on p.id = ges.pers
...
| scheidingsteken           | '                                             |
| geslnaamstam              | Vader                                         |
| datgeboorte               | 19780101                                      |
| blplaatsgeboorte          | Vancouver                                     |
| blregiogeboorte           | BC                                            |
| land                      | Canada                                        |
| geslacht                  | Man                                           |
