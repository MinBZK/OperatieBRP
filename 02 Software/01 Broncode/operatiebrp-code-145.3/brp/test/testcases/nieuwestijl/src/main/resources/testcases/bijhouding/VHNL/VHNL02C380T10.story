...
Scenario: 2. Bij Relatie.Datum aanvang tussen A moeder en B dochter is er een verwantschap
          LT: VHNL02C380T10

!--Laden PL Moeder A
Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL/VHNL02C380T10.xls

!-- geboorte Dochter B
When voer een bijhouding uit VHNL02C380T10a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

!-- Huwelijk
When voer een bijhouding uit VHNL02C380T10b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/VHNL/expected/VHNL02C380T10.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
