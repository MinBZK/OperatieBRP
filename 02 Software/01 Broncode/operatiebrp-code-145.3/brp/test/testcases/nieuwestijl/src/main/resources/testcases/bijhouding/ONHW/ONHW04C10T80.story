...
Scenario:   2. Ongedaan maken van een huwelijk (van de niet ontbonden relatie) dat ontrelateerd is Ongedaan maken van een huwelijk (van de ontbonden relatie) dat ontrelateerd is
            LT: ONHW04C10T80

Given enkel initiele vulling uit bestand /LO3PL-ONHW/ONHW04C10T80-001.xls
Given enkel initiele vulling uit bestand /LO3PL-ONHW/ONHW04C10T80-002.xls

When voer een bijhouding uit ONHW04C10T80a.xml namens partij 'Gemeente BRP 1'

Given pas laatste relatie van soort 1 aan tussen persoon 185769433 en persoon 477660873 met relatie id 30010001 en betrokkenheid id 30010001

Then is in de database de persoon met bsn 185769433 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn 477660873 wel als PARTNER betrokken bij een HUWELIJK
...
When voer een bijhouding uit ONHW04C10T80b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd



Then is in de database de persoon met bsn i:185769433 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn i:477660873 niet als PARTNER betrokken bij een HUWELIJK

Given pas eerste relatie van soort 1 aan tussen persoon 185769433 en persoon 477660873 met relatie id 50000002 en betrokkenheid id 50000002

Given de database is aangepast met: delete from autaut.his_bijhouderfiatuitz where id =99999
And de database is aangepast met: delete from autaut.bijhouderfiatuitz where id =99999

When voer een bijhouding uit ONHW04C10T80c.xml namens partij 'Gemeente BRP 1'
Then heeft het antwoordbericht verwerking Geslaagd
