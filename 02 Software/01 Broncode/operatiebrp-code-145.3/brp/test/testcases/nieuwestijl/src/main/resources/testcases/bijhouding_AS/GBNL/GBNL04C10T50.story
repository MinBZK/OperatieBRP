...
Scenario:   Registratie geborene in Nederland met OUWKIG(I) en NOUWKIG(NI), gegevens NOUWKIG wordt meegegeven in bericht binnenland
            LT: GBNL04C10T50

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GBNL/GBNL04C10T50-001.xls


When voer een bijhouding uit GBNL04C10T50.xml namens partij 'Gemeente BRP 1'
...
Then in kern heeft select id.bsn, id.anr, sg.indnreeks, sg.predicaat, sg.voornamen, sg.voorvoegsel, sg.scheidingsteken, sg.geslnaamstam,
                   pg.datgeboorte, pg.gemgeboorte, pg.wplnaamgeboorte, lg.naam as land, gs.naam as geslacht
