...
Scenario:   2. Rechtsgrond is nog niet geldig
            LT: ONHW02C10T30
...
When voer een bijhouding uit ONHW02C10T30.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONHW/expected/ONHW02C10T30.xml voor expressie //brp:bhg_hgpCorrigeerHuwelijkGeregistreerdPartnerschap_R
