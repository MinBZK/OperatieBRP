...
Narrative: R2668 Bron moet een Document of een rechtsgrond bevatten
...
Scenario:   2. De bron van een actie is een verwijzing naar een document (zonder rechtsgrond)
            LT: CPHW02C10T40

Given alle personen zijn verwijderd

!-- Vulling van de partners
Given enkel initiele vulling uit bestand /LO3PL-CPHW/CPHW02C10T40-001.xls
Given enkel initiele vulling uit bestand /LO3PL-CPHW/CPHW02C10T40-002.xls
...
When voer een bijhouding uit CPHW02C10T40a.xml namens partij 'Gemeente BRP 1'
Then heeft het antwoordbericht verwerking Geslaagd

Given pas laatste relatie van soort 1 aan tussen persoon 917028041 en persoon 679110793 met relatie id 30010002 en betrokkenheid id 30010001
Given pas laatste relatie van soort 1 aan tussen persoon 679110793 en persoon 917028041 met relatie id 30010001 en betrokkenheid id 30010002
...
Then is in de database de persoon met bsn 917028041 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn 679110793 wel als PARTNER betrokken bij een HUWELIJK

When voer een bijhouding uit CPHW02C10T40b.xml namens partij 'Gemeente BRP 1'
Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/CPHW/expected/CPHW02C10T40.xml voor expressie //brp:bhg_hgpCorrigeerHuwelijkGeregistreerdPartnerschap_R
