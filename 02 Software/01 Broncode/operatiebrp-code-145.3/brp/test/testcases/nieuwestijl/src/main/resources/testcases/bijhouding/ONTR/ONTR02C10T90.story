...
Scenario:   2. DAG kopie-persoon is groter dan de aanvangsdatum van de relatie
            LT: ONTR02C10T90

Given enkel initiele vulling uit bestand /LO3PL-ONTR/ONTR02C10T90-001.xls
Given enkel initiele vulling uit bestand /LO3PL-ONTR/ONTR02C10T90-002.xls

When voer een bijhouding uit ONTR02C10T90a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONTR/expected/ONTR02C10T90a.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R

Given pas laatste relatie van soort 1 aan tussen persoon 195858025 en persoon 416299465 met relatie id 30010001 en betrokkenheid id 30010001

Then is in de database de persoon met bsn 195858025 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn 416299465 wel als PARTNER betrokken bij een HUWELIJK
...
When voer een bijhouding uit ONTR02C10T90b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONTR/expected/ONTR02C10T90b.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
...
Then in kern heeft select p.srt, hpid.dataanvgel, hpid.bsn, hpid.anr, hpsam.indafgeleid, hpsam.indnreeks, hpsam.predicaat, hpsam.voornamen, hpsam.adellijketitel, hpsam.voorvoegsel, hpsam.scheidingsteken, hpsam.geslnaamstam, hpges.geslachtsaand, hpgeb.datgeboorte, hpgeb.gemgeboorte, hpgeb.wplnaamgeboorte, hpgeb.blplaatsgeboorte, hpgeb.blregiogeboorte, hpgeb.omslocgeboorte, hpgeb.landgebiedgeboorte
...
Then is in de database de persoon met bsn i:195858025 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn i:416299465 niet als PARTNER betrokken bij een HUWELIJK
