...
Given enkel initiele vulling uit bestand /LO3PL-VA/LO3PL-VZBG/VZBG04C20T20-001.xls

When voer een bijhouding uit VZBG04C20T20.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding_VA/VZBG/expected/VZBG04C20T20.xml voor expressie //brp:bhg_vbaRegistreerVerhuizing_R
...
Then in kern heeft select count(1)
                   ...
                   where p.bsn ='105693212' de volgende gegevens:
| veld                      | waarde |
| count                     | 2      |
...
Then in kern heeft select sainh.naam as actieInhoud, saav.naam as actieVerval, hpad.dataanvgel, hpad.dateindegel, saaa.naam as actieAanpas, hpad.srt, hpad.rdnwijz,
                   ...
                   left join kern.actie ainh on ainh.id = hpad.actieinh
