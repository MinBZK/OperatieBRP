...
Scenario:   Ingaand bericht wordt gerefereerd aan een Persoon die niet bekend is in de BRP
            LT: ARBR04C10T110
...
When voer een bijhouding uit ARBR04C10T110.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ARBR/expected/ARBR04C10T110.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
