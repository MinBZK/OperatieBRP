...
Scenario:   Registratie overige nationaliteit waardoor niet beeindigd overige nationaliteit niet vervalt
            LT: GNNG04C80T50

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GNNG/GNNG04C80T50-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GNNG/GNNG04C80T50-002.xls

When voer een bijhouding uit GNNG04C80T50.xml namens partij 'Gemeente BRP 1'
...
Then in kern heeft select sainh.naam as actieInhoud, saav.naam as actieVerval, n.naam as nationaliteit, pn.rdnverk, hpn.dataanvgel, hpn.dateindegel, hpn.indbijhoudingbeeindigd
                   from kern.persnation pn
                   left join kern.his_persnation hpn on hpn.persnation = pn.id
                   left join kern.actie ainh on ainh.id = hpn.actieinh
                   left join kern.actie av on av.id = hpn.actieverval
