...
Given enkel initiele vulling uit bestand /LO3PL-CGPS/CGPS04C10T20-001.xls
Given enkel initiele vulling uit bestand /LO3PL-CGPS/CGPS04C10T20-002.xls

When voer een bijhouding uit CGPS04C10T20a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/CGPS/expected/CGPS04C10T20a.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R

Given pas laatste relatie van soort 2 aan tussen persoon 631636201 en persoon 643950473 met relatie id 30010001 en betrokkenheid id 30010001
And de database is aangepast met: update kern.his_relatie
                                  set    id = 9999 where id = (
				                                  select hr.id
...
Then is in de database de persoon met bsn 631636201 wel als PARTNER betrokken bij een GEREGISTREERD_PARTNERSCHAP
Then is in de database de persoon met bsn 643950473 wel als PARTNER betrokken bij een GEREGISTREERD_PARTNERSCHAP
...
When voer een bijhouding uit CGPS04C10T20b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/CGPS/expected/CGPS04C10T20b.xml voor expressie //brp:bhg_hgpCorrigeerHuwelijkGeregistreerdPartnerschap_R
...
When voer een bijhouding uit CGPS04C10T20c.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd
Then is het antwoordbericht gelijk aan /testcases/bijhouding/CGPS/expected/CGPS04C10T20c.xml voor expressie //brp:bhg_hgpCorrigeerHuwelijkGeregistreerdPartnerschap_R
