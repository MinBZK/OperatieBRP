...
Scenario:   Registratie geborene via "Geboorte in Nederland na geboortedatum"
            LT: GNNG04C10T10

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GNNG/GNNG04C10T10-001.xls
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-GNNG/GNNG04C10T10-002.xls

When voer een bijhouding uit GNNG04C10T10.xml namens partij 'Gemeente BRP 1'
...
Then in kern heeft select sb.naam as soortrol, sp.naam as srtpersoon from kern.betr b
                   ...
                   left outer join kern.srtpers sp on sp.id = p.srt
                    where p.voornamen = 'Jan' de volgende gegevens:
| veld                      | waarde                                        |
| soortrol                  | Kind                                          |
...
Then in kern heeft select pi.datinschr, pi.versienr, sa.naam as actieInhoud, sad.naam as AdmhndNaam, p.voornamen
                                      ...
                                      where sa.naam ='Registratie geborene' and p.voornamen = 'Jan' de volgende gegevens:
| veld                      | waarde                                                        |
| datinschr                 | 20160101                                                      |
| versienr                  | 1                                                             |
| actieinhoud               | Registratie geborene                                          |
...
Then in kern heeft select bh.naam as nmbijh, nb.naam as nmnbijh, p.naam as nmpartij, pb.dataanvgel, sa.naam as actieInhoud
                   ...
                   where sa.naam ='Registratie geborene' and pe.voornamen = 'Jan' de volgende gegevens:
| veld                      | waarde                                        |
| nmbijh                    | Ingezetene                                    |
| nmnbijh                   | Actueel                                       |
...
| daggslaand                | 20160101                                      |
| land                      | Nederland                                     |
| datgeboorte               | 20160101                                      |
| code                      | 7112                                          |
| wplnaamgeboorte           | Hoogerheide                                   |
| geslacht                  | Man                                           |
...
Then in kern heeft select sb.naam as soortrol, sp.naam as srtpersoon, p.voornamen
                   ...
                   left outer join kern.srtactie sa on sa.id = a.srt
                   where sa.naam ='Registratie geborene' and p.voornamen = 'Marie' de volgende gegevens:
| veld                      | waarde                                        |
| soortrol                  | Ouder                                         |
| srtpersoon                | Ingeschrevene                                 |
| voornamen                 | Marie                                          |
...
Then in kern heeft select sb.naam as soortrol, sp.naam as srtpersoon, p.voornamen
                   ...
                   left outer join kern.actie a on a.id = hre.actieinh
                   left outer join kern.srtactie sa on sa.id = a.srt
                   where sa.naam ='Registratie geborene' and p.voornamen = 'Henk' de volgende gegevens:
| veld                      | waarde                                        |
| soortrol                  | Ouder                                         |
| srtpersoon                | Ingeschrevene                                 |
| voornamen                 | Henk                                          |
