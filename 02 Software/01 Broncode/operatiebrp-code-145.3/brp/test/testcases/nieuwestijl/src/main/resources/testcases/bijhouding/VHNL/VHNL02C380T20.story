...
Scenario: 2. Bij Relatie.Datum aanvang tussen A oma en D kleindochter is er een verwantschap
          LT: VHNL02C380T20

!--Laden PL Moeder A
Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL/VHNL02C380T20.xls

!-- geboorte Dochter F
When voer een bijhouding uit VHNL02C380T20a.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

!-- geboorte Kleindochter D
When voer een bijhouding uit VHNL02C380T20b.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

!-- Huwelijk
When voer een bijhouding uit VHNL02C380T20c.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/VHNL/expected/VHNL02C380T20.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
