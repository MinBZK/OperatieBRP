 ...
 */
@AcceptanceTest
public class Koppelvlaktest_docker extends AbstractSpringJBehaveStories {
    @BeforeClass
    public static void setup() {
//        System.setProperty("omgeving","localhost-dok")
        System.setProperty("omgeving", "test-bij-hg-dok");
    }
    ...
    public List<String> includeFilter() {
        return new ArrayList<String>(Arrays.asList("**/testcases/bijhouding/**/*.story"));
    }
