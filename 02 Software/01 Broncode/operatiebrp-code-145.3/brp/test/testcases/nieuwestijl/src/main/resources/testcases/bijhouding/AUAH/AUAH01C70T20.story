...
@regels                 R2269
@usecase                BY.1.AA
@sleutelwoorden         AUAH01C70T20, Geslaagd, Logging
...
Given voer enkele update uit: update kern.partij set datingang = to_number((to_char(now(), 'YYYYMMDD')),'99999999'), dateinde = to_number((to_char(now() + interval '1 day', 'YYYYMMDD')),'99999999') where naam = 'Gemeente BRP beeindigd 1'
Given voer enkele update uit: update kern.his_partij set datingang = to_number((to_char(now(), 'YYYYMMDD')),'99999999'), dateinde = to_number((to_char(now() + interval '1 day', 'YYYYMMDD')),'99999999') where naam = 'Gemeente BRP beeindigd 1'

Given maak bijhouding caches leeg

Scenario: 2. De ondertekenaar is een geldige partij(datum op datingang)
          LT: AUAH01C70T20
Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-AUAH/AUAH01C70T10-sandy.xls
Given enkel initiele vulling uit bestand /LO3PL-AUAH/AUAH01C70T10-danny.xls

When voer een bijhouding uit AUAH01C70T10.xml met ondertekenaar 'Gemeente BRP beeindigd 1', en transporteur 'Gemeente voor autorisatietest'
...
And is het antwoordbericht gelijk aan /testcases/bijhouding/AUAH/expected/AUAH01C70T20.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R

Then is in de database de persoon met bsn 578163305 wel als PARTNER betrokken bij een HUWELIJK
Then is in de database de persoon met bsn 250695625 wel als PARTNER betrokken bij een HUWELIJK

Then lees persoon met anummer 7394173217 uit database en vergelijk met expected AUAH01C70T20-persoon1.xml
Then lees persoon met anummer 6016267041 uit database en vergelijk met expected AUAH01C70T20-persoon2.xml
