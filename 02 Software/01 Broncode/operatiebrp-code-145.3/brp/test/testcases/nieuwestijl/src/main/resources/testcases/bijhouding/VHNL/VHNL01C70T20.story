...
@status                 Klaar
@regels                 R1625
@sleutelwoorden         voltrekkingHuwelijkInNederland,TjieWah,VHNL01C70T20
@usecase                UCS-BY.HG
...
Scenario: R1625 De Geboorte is niet ingevuld
          LT: VHNL01C70T20
...
When voer een bijhouding uit VHNL01C70T20.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
And is het antwoordbericht gelijk aan /testcases/bijhouding/VHNL/expected/VHNL01C70T20.xml voor expressie //brp:bhg_hgpRegistreerHuwelijkGeregistreerdPartnerschap_R
