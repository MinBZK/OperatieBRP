...
Scenario:   2. Nadere aanduiding verval is gevuld met de waarde "S" en één rechtsgrond opgegeven die geen indicatie heeft
               LT: ONHW01C30T30
...
When voer een bijhouding uit ONHW01C30T30.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONHW/expected/ONHW01C30T30.xml voor expressie //brp:bhg_hgpCorrigeerHuwelijkGeregistreerdPartnerschap_R
