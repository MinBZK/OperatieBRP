...
Scenario:   voer een correcte verhuizing naar het buitenland uit. Nevenactie volledige verstrekkingsbeperking.
            LT: VZBL04C20T10

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-VA/LO3PL-VZBL/VZBL04C20T10.xls

When voer een bijhouding uit VZBL04C20T10.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Then is het antwoordbericht gelijk aan /testcases/bijhouding_VA/VZBL/expected/VZBL04C20T10.xml voor expressie //brp:bhg_vbaRegistreerVerhuizing_R
...
Then in kern heeft select count(1)
                   ...
                   where p.bsn ='993956105' de volgende gegevens:
| veld                      | waarde |
| count                     | 2      |
