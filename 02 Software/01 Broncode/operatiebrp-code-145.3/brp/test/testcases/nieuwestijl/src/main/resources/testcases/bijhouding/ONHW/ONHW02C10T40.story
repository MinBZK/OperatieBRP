...
Given de database is aangepast met: insert into kern.rechtsgrond
				    ...
				    select '111',
					    ...
					    true,
					    to_number((to_char(now() - interval '2 day', 'YYYYMMDD')), '99999999'),
...
Scenario:   2. Rechtsgrond is niet meer geldig
            LT: ONHW02C10T40
...
When voer een bijhouding uit ONHW02C10T40.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Foutief
Then is het antwoordbericht gelijk aan /testcases/bijhouding/ONHW/expected/ONHW02C10T40.xml voor expressie //brp:bhg_hgpCorrigeerHuwelijkGeregistreerdPartnerschap_R
