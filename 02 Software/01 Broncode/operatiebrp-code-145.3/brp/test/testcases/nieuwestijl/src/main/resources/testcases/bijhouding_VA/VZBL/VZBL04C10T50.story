...
Scenario:   Verwerking Hoofdactie Registratie migratie. Aangever is meerderjarig gemachtigde.
            LT: VZBL04C10T50

Given alle personen zijn verwijderd
Given enkel initiele vulling uit bestand /LO3PL-VA/LO3PL-VZBL/VZBL04C10T50.xls

When voer een bijhouding uit VZBL04C10T50.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Then is het antwoordbericht gelijk aan /testcases/bijhouding_VA/VZBL/expected/VZBL04C10T50.xml voor expressie //brp:bhg_vbaRegistreerVerhuizing_R
...
| Aangever                  | Meerderjarig gemachtigde           |
| Land                      | Aruba                              |
