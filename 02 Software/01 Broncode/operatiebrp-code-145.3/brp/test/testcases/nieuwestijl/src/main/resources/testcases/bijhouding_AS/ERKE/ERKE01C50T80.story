...
Scenario:   Verlies van de Nederlandse nationaliteit wijzigt bij geen Reisdocument
            LT: ERKE01C50T80

Given alle personen zijn verwijderd

!-- Init. vulling van het kind met een OUWKIG en reisdocument met indicatie inhouding
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-ERKE/ERKE01C50T80-001.xls

!-- Init. vulling van de NOUWKIG
Given enkel initiele vulling uit bestand /LO3PL-AS/LO3PL-ERKE/ERKE01C50T80-002.xls
...
When voer een bijhouding uit ERKE01C50T80.xml namens partij 'Gemeente BRP 1'

Then heeft het antwoordbericht verwerking Geslaagd

Then is het antwoordbericht gelijk aan /testcases/bijhouding_AS/ERKE/expected/ERKE01C50T80.xml voor expressie //brp:bhg_afsRegistreerErkenning_R