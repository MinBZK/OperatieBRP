...
-- Autorisaties voor testen m.b.v. Bevragen
insert into kern.partijrol (partij, rol, datingang, dateinde, indag) values ((select id from kern.partij p where p.code = '507013'), 1, 20010101, 20300101, true);
insert into kern.his_partijrol (partijrol, tsreg, datingang, dateinde) values ((select id from kern.partijrol where partij = (select id from kern.partij p where p.code = '507013') and rol = 1), now(), 20010101, 20300101);
insert into autaut.levsautorisatie (stelsel, datingang, dateinde, indmodelautorisatie, indag) values (1, 20010101, 20300101, false, true);
insert into autaut.dienstbundel (levsautorisatie, naam, datingang, dateinde, indag) values ((select max(id) from autaut.levsautorisatie), 'test bijhouding', 20010101, 20300101, true);
insert into autaut.dienst (dienstbundel, srt, datingang, dateinde, indag) values ((select max(id) from autaut.dienstbundel), 8, 20010101, 20300101, true);
insert into autaut.toeganglevsautorisatie (afleverpunt, geautoriseerde, levsautorisatie, datingang, dateinde, indag) values ('dummy', (select id from kern.partijrol where partij = (select id from kern.partij p where p.code = '507013') and rol = 1), (select max(id) from autaut.levsautorisatie), 20010101, 20300101, true);
insert into autaut.dienstbundelgroep (dienstbundel, groep, indformelehistorie, indmaterielehistorie, indverantwoording) values ((select max(id) from autaut.dienstbundel), (select groep from kern.element where naam = 'Persoon.Identificatienummers.Burgerservicenummer'), true, true, true);
insert into autaut.dienstbundelgroep (dienstbundel, groep, indformelehistorie, indmaterielehistorie, indverantwoording) values ((select max(id) from autaut.dienstbundel), (select groep from kern.element where naam = 'Persoon.Geboorte.Datum'), true, false, true);
insert into autaut.dienstbundelgroepattr (dienstbundelgroep, attr) values ((select id from autaut.dienstbundelgroep where groep = (select groep from kern.element where naam = 'Persoon.Identificatienummers.Burgerservicenummer')), (select id from kern.element where naam = 'Persoon.Identificatienummers.Burgerservicenummer'));
insert into autaut.dienstbundelgroepattr (dienstbundelgroep, attr) values ((select id from autaut.dienstbundelgroep where groep = (select groep from kern.element where naam = 'Persoon.Geboorte.Datum')), (select id from kern.element where naam = 'Persoon.Geboorte.Datum'));
