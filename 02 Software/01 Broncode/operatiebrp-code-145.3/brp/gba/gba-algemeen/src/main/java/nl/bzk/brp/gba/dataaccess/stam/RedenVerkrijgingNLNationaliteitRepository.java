 ...
 */
@Repository("gbaRedenVerkrijgingNLNationaliteitRepository")
public class RedenVerkrijgingNLNationaliteitRepository extends AbstractMasterRepositoryImpl<RedenVerkrijgingNLNationaliteit, Short, Short> {

    /**
     * Constructor.
     */
    public RedenVerkrijgingNLNationaliteitRepository() {
