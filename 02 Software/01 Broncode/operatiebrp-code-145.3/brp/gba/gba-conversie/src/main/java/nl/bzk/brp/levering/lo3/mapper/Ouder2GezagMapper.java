 ...
 */
@Component
public final class Ouder2GezagMapper extends AbstractOuderGezagMapper<BrpOuder2GezagInhoud> {
    ...
    @Override
    public BrpOuder2GezagInhoud mapInhoud(final MetaRecord identiteitRecord, final MetaRecord record, final OnderzoekMapper onderzoekMapper) {
        return new BrpOuder2GezagInhoud(
