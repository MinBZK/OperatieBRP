...
/**
 * Nabewerking voor persoon/verblijfsrecht (kopieer de datum mededeling naar de ingangsdatum
 * geldigheid).
 */

@Component
public final class PersoonVerblijfsrechtHistorieNabewerking implements HistorieNabewerking<Lo3VerblijfstitelInhoud, BrpVerblijfsrechtInhoud> {

    @Override
    public Lo3Historie bewerk(final Lo3Categorie<Lo3VerblijfstitelInhoud> categorie, final BrpGroep<BrpVerblijfsrechtInhoud> brpGroep,
