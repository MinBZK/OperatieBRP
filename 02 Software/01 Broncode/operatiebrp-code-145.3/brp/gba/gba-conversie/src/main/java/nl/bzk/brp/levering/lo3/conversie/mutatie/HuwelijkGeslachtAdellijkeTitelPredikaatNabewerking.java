 ...
 */
@Component
public final class HuwelijkGeslachtAdellijkeTitelPredikaatNabewerking {
    ...
    private Lo3Categorie<Lo3HuwelijkOfGpInhoud> verwerk(final Lo3Categorie<Lo3HuwelijkOfGpInhoud> categorie) {
        if (categorie != null
            ...
            final Lo3HuwelijkOfGpInhoud.Builder builder = new Lo3HuwelijkOfGpInhoud.Builder(categorie.getInhoud());
