 ...
 */
@Component
public class GeregistreerdPartnerschapGeboorteMutatieVerwerker extends AbstractFormeelMutatieVerwerker<Lo3HuwelijkOfGpInhoud, BrpGeboorteInhoud> {
    ...
    protected GeregistreerdPartnerschapGeboorteMutatieVerwerker(
        ...
        super(mapper, new GeboorteConverteerder(attribuutConverteerder), attribuutConverteerder, null, GeregistreerdPartnerschapGeboorteMapper.GROEP_ELEMENT,
                LOGGER);
    }
}
