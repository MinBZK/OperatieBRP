...
public class AdresantwoordTest {
    ...
    @Test
    public void test() {
        final Adresantwoord subject = new Adresantwoord();
    ...
    private void assertGelijk(final Adresantwoord expected, final Adresantwoord actual) {
    ...
    private Adresantwoord reserialize(final Adresantwoord object) {
        final String serialized = serializer.serialiseerNaarString(object);
        LOGGER.info("Serialized: {}", serialized);
        return serializer.deserialiseerVanuitString(serialized, Adresantwoord.class);
    }
}
