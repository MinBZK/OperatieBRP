 ...
 */
public class VerhuizingBinnenGemeenteParserTest extends AbstractParserTest {

    private static final String VERHUIZING_BINNENGEMEENTELIJK_XML = "verhuizingBinnenGemeente.xml";
