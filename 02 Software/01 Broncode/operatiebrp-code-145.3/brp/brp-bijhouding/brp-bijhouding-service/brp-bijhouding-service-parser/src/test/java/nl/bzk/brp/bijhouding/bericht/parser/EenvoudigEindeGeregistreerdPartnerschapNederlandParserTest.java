 ...
 */
public class EenvoudigEindeGeregistreerdPartnerschapNederlandParserTest extends AbstractParserTest {

    public static final String EENVOUDIG_BIJHOUDING_BERICHT = "eenvoudigEindeGeregistreerdPartnerschapNederlandBericht.xml";
    ...
    private void assertGeregistreerdPartnerschap(final GeregistreerdPartnerschapElement geregistreerdPartnerschap) {
        Assert.assertNotNull(geregistreerdPartnerschap);
