...
package nl.bzk.brp.bijhouding.bericht.parser.CPGP;
 ...
 */
public class CorrectiePartnerParserTest extends AbstractParserTest {
    private static final String ERKENNING = "corrigeerPartnerGegevensGerigistreerdPartnerschap.xml";
