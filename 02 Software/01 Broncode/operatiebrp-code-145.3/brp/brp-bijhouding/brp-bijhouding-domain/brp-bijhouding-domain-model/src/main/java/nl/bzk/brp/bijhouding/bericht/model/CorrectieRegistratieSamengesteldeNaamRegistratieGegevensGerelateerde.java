...
/**
 * De actie voor het registreren van een nieuw samengesteldenaam voorkomen (als onderdeel van een correctie) in de bijhouding.
 */
@XmlElement("correctieregistratieSamengesteldeNaamGerelateerde")
public class CorrectieRegistratieSamengesteldeNaamRegistratieGegevensGerelateerde extends AbstractCorrectieRegistratieGegevensGerelateerdeActieElement {
     ...
     */
    public CorrectieRegistratieSamengesteldeNaamRegistratieGegevensGerelateerde(
    ...
    public SoortActie getSoortActie() {
        return SoortActie.CORRECTIEREGISTRATIE_SAMENGESTELDE_NAAM_GERELATEERDE;
    }

    @Override
    protected Set bepaalSetVoorNieuwVoorkomen() {
        return getPartner().getPersoonEntiteit().getPersoonSamengesteldeNaamHistorieSet();
    }

    @Override
    protected FormeleHistorie maakNieuwVoorkomen() {
        return getPartner().getPersoonEntiteit().maakNieuweSamengesteldeNaamHistorieVoorCorrectie(getPartner().getSamengesteldeNaam());
    }
}
