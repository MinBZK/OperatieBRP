...
/**
 * Effect afnemerindicaties repository.
 */
@Repository
public class EffectAfnemerindicatiesRepository extends EnumReadonlyRepository<EffectAfnemerindicaties> {

    /**
     * Constructor.
     */
    public EffectAfnemerindicatiesRepository() {
        super(EffectAfnemerindicaties.class);
    }
}
