...
/**
 * LO3Severity repository.
 */
@Repository
public class Lo3SeverityRepository extends EnumReadonlyRepository<Lo3Severity> {

    /**
     * Constructor.
     */
    public Lo3SeverityRepository() {
        super(Lo3Severity.class);
    }
}
