 ...
 */
@Repository
public class EenheidSelectieIntervalRepository extends EnumReadonlyRepository<EenheidSelectieInterval> {

    /**
     * Constructor.
     */
    public EenheidSelectieIntervalRepository() {
        super(EenheidSelectieInterval.class);
    }
}
