...
/**
 * BijhouderFiatteringsuitzondering repository.
 */
@Master
@Transactional(propagation = Propagation.MANDATORY)
public interface BijhouderFiatteringsuitzonderingRepository extends ReadWriteRepository<BijhouderFiatteringsuitzondering, Integer> {
