...
/**
 * BurgerzakenModule repository.
 */
@Repository
public class BurgerzakenModuleRepository extends EnumReadonlyRepository<BurgerzakenModule> {

    /**
     * Constructor.
     */
    public BurgerzakenModuleRepository() {
        super(BurgerzakenModule.class);
    }
}
