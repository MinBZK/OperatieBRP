...
public class SecurityConfiguratie extends WebSecurityConfigurerAdapter {
     ...
     */
    @Inject
    public SecurityConfiguratie(final Environment environment) {
    ...
    private void configureInzien(final HttpSecurity http) throws Exception {
    ...
    private void configureDubbeleRollen(final HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(
                        HttpMethod.GET,
                        ControllerConstants.LEVERINGSAUTORISATIE_URI + ANT_ALL_MATCHER,
                        ControllerConstants.BIJHOUDINGSAUTORISATIE_URI + ANT_ALL_MATCHER,
                        ControllerConstants.BIJHOUDER_FIATTERINGSUITZONDERING_URI + ANT_ALL_MATCHER,
    ...
    private void configureAbonnementen(final HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(HttpMethod.DELETE, "/leveringsautorisaties/*/dienstbundels/*/dienstbundelgroepen/*")
                ...
                .antMatchers(
                        HttpMethod.GET,
                        ControllerConstants.ATTRIBUUT_URI + ANT_ALL_MATCHER,
                        ControllerConstants.DIENST_URI + ANT_ALL_MATCHER,
                        ControllerConstants.SOORT_DIENST_URI + ANT_ALL_MATCHER,
                        ControllerConstants.SOORT_DIENSTEN_URI + ANT_ALL_MATCHER,
                        ControllerConstants.DIENSTBUNDEL_URI + ANT_ALL_MATCHER,
                        ControllerConstants.DIENSTBUNDEL_GROEP_URI + ANT_ALL_MATCHER,
                        ControllerConstants.GROEP_URI + ANT_ALL_MATCHER,
                        ControllerConstants.TOEGANGABONNEMENT_URI + ANT_ALL_MATCHER,
                        ControllerConstants.TOEGANGBIJHOUDINGAUTORISATIE_URI + ANT_ALL_MATCHER,
    ...
    private void configurePostStamgegevens(final HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(
                        HttpMethod.POST,
    ...
    private void configureGetStamgegevens(final HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(
                        HttpMethod.GET,
                        ...
                        ControllerConstants.KOPPELVLAK_URI + ANT_ALL_MATCHER,
                        ControllerConstants.LAND_GEBIED_URI + ANT_ALL_MATCHER,
                        ...
                        ControllerConstants.VOORVOEGSEL_URI + ANT_ALL_MATCHER,
                        ControllerConstants.BLOKKERING_URI + ANT_ALL_MATCHER,
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        configureAbonnementen(http);
        configureDubbeleRollen(http);
        configureInzien(http);
        configureGetStamgegevens(http);
        configurePostStamgegevens(http);
