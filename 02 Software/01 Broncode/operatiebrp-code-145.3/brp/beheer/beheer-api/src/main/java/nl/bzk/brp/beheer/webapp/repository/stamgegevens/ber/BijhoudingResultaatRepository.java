 ...
 */
@Repository
public class BijhoudingResultaatRepository extends EnumReadonlyRepository<BijhoudingResultaat> {

    /**
     * Constructor.
     */
    public BijhoudingResultaatRepository() {
        super(BijhoudingResultaat.class);
    }
}
