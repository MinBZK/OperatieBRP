...
/**
 * Mix-in for {@link nl.bzk.algemeenbrp.dal.domein.brp.enums.Regel}.
 */
public abstract class AbstractRegelMixIn extends AbstractIdCodeEnumMixIn {

    /** @return soort */
    @JsonProperty
    abstract SoortMelding getSoortMelding();

    /**
     * @return melding
     */
    @JsonProperty("melding")
    abstract String getMelding();
}
