...
/**
 * Verwerkingswijze repository.
 */
@Repository
public class VerwerkingswijzeRepository extends EnumReadonlyRepository<Verwerkingswijze> {

    /**
     * Constructor.
     */
    public VerwerkingswijzeRepository() {
        super(Verwerkingswijze.class);
    }
}
