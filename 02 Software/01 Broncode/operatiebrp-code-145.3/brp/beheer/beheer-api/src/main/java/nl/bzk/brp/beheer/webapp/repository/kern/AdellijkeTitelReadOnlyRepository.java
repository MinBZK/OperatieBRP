...
/**
 * adellijke titel repository.
 */
@Repository
public class AdellijkeTitelReadOnlyRepository extends EnumReadonlyRepository<AdellijkeTitel> {

    /**
     * Constructor.
     */
    public AdellijkeTitelReadOnlyRepository() {
