...
/**
 * Mix-in for {@link nl.bzk.algemeenbrp.dal.domein.brp.enums.SoortIndicatie}.
 */
public abstract class AbstractSoortIndicatieMixIn extends AbstractEnumMixIn {

    /** @return omschrijving */
    @JsonProperty("omschrijving")
    abstract String getOmschrijving();

    /** @return indicatie materiele historie van toepassing */
    @JsonProperty("materieleHistorieVanToepassing")
    @JsonSerialize(using = BooleanStringSerializer.class)
    abstract String isMaterieleHistorieVanToepassing();
