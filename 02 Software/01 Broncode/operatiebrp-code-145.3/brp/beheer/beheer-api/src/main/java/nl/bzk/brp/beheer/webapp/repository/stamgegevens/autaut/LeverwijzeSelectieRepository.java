 ...
 */
@Repository
public class LeverwijzeSelectieRepository extends EnumReadonlyRepository<LeverwijzeSelectie> {

    /**
     * Constructor.
     */
    public LeverwijzeSelectieRepository() {
        super(LeverwijzeSelectie.class);
    }
}
