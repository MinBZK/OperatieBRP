...
public final class AdellijkeTitelController extends AbstractReadonlyController<AdellijkeTitel, Integer> {
     ...
     */
    @Inject
    protected AdellijkeTitelController(@Named("adellijkeTitelRepository") final ReadonlyRepository<AdellijkeTitel, Integer> repository) {
        super(repository);
    }
