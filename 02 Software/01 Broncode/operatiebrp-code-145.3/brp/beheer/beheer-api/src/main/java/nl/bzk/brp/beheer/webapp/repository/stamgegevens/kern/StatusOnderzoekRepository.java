...
/**
 * StatusOnderzoek repository.
 */
@Repository
public class StatusOnderzoekRepository extends EnumReadonlyRepository<StatusOnderzoek> {

    /**
     * Constructor.
     */
    public StatusOnderzoekRepository() {
        super(StatusOnderzoek.class);
    }
}
