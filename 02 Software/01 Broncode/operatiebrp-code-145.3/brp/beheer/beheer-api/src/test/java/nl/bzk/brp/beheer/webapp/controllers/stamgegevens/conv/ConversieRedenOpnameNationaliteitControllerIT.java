 ...
 */
public class ConversieRedenOpnameNationaliteitControllerIT extends AbstractIntegratieTest {
    ...
    public final void testConversieLO3RubriekFilter() throws Exception {
        final MvcResult result =
                mockMvc.perform(MockMvcRequestBuilders.get("/conversieredenopnamenationaliteit"))
