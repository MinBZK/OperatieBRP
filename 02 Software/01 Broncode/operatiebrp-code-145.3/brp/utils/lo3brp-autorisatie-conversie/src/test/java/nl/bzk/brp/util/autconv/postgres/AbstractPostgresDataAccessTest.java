...
@ContextConfiguration(classes = AbstractPostgresDataAccessTest.DataAccessTestConfiguratie.class)
abstract class AbstractPostgresDataAccessTest extends AbstractTransactionalJUnit4SpringContextTests implements DataSourceProvider {
    ...
    @Configuration
    @Import(PostgresTestPropertiesConfiguration.class)
    @ImportResource(value = {"classpath:delivery-dataaccess-beans.xml"})
