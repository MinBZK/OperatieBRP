...
/**
 * {@link OperatorType#GELIJK} vergelijker voor {@link ExpressieType#GETAL} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GELIJK, typeSupport = ExpressieType.GETAL)
final class GetalGelijkVergelijker implements Vergelijker<GetalLiteral, GetalLiteral> {
