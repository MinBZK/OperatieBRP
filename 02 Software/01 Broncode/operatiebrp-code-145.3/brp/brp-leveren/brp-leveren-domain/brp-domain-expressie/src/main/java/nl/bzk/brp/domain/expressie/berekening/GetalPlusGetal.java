...
/**
 * {@link GetalLiteral} plus {@link GetalLiteral} berekening.
 */
@Component
@BerekeningConfig(operator = OperatorType.PLUS, typeLinks = ExpressieType.GETAL, typeRechts = ExpressieType.GETAL)
