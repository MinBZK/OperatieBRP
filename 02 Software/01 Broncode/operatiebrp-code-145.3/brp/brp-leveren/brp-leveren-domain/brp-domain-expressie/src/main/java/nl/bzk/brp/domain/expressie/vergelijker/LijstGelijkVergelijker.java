...
/**
 * {@link OperatorType#GELIJK} vergelijker voor {@link ExpressieType#LIJST} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GELIJK, typeSupport = ExpressieType.LIJST)
final class LijstGelijkVergelijker implements Vergelijker<LijstExpressie, LijstExpressie> {
