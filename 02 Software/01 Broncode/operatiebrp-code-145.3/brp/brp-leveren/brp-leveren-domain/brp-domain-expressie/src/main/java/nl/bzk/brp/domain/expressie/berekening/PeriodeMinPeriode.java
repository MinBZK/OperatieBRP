...
/**
 * {@link PeriodeLiteral} min {@link PeriodeLiteral} berekening.
 */
@Component
@BerekeningConfig(operator = OperatorType.MIN, typeLinks = ExpressieType.PERIODE, typeRechts = ExpressieType.PERIODE)
final class PeriodeMinPeriode implements Berekening<PeriodeLiteral, PeriodeLiteral> {
