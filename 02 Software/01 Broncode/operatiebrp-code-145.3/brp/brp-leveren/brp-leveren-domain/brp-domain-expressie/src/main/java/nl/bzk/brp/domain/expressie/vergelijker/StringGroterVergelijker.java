 ...
 */
@Component
@VergelijkerConfig(operator = OperatorType.GROTER, typeSupport = ExpressieType.STRING)
final class StringGroterVergelijker implements Vergelijker<StringLiteral, StringLiteral> {
