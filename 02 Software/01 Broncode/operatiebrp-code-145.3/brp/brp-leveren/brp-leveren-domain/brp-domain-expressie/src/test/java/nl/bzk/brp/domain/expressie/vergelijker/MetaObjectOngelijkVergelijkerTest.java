...
public class MetaObjectOngelijkVergelijkerTest {

    @Test
    public void test() {
        final MetaObjectOngelijkVergelijker vergelijker = new MetaObjectOngelijkVergelijker();
        ...
        assertEquals(BooleanLiteral.ONWAAR, vergelijker.apply(metaObjectLiteral1a, metaObjectLiteral1a));
        assertEquals(BooleanLiteral.ONWAAR, vergelijker.apply(metaObjectLiteral1a, metaObjectLiteral1b));
        assertEquals(BooleanLiteral.WAAR, vergelijker.apply(metaObjectLiteral1a, metaObjectLiteral));
    }
}
