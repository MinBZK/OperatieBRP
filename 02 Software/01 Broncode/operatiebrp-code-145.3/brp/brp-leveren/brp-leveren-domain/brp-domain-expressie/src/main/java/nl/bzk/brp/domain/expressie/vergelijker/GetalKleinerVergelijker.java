...
/**
 * {@link OperatorType#KLEINER} vergelijker voor {@link ExpressieType#GETAL} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.KLEINER, typeSupport = ExpressieType.GETAL)
final class GetalKleinerVergelijker implements Vergelijker<GetalLiteral, GetalLiteral> {
