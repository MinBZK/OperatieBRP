...
/**
 * {@link DatumLiteral} plus {@link GetalLiteral} berekening.
 */
@Component
@BerekeningConfig(operator = OperatorType.PLUS, typeLinks = ExpressieType.DATUM, typeRechts = ExpressieType.GETAL)
final class DatumPlusGetal implements Berekening<DatumLiteral, GetalLiteral> {
    @Override
