...
public class DatumPlusGetalTest {

    @Test
    public void testDatumVolledigBekend() {
        final DatumLiteral datumLiteral = new DatumLiteral(20171221);
        final GetalLiteral getalLiteral = new GetalLiteral(10L);
        final Expressie res = new DatumPlusGetal().apply(datumLiteral, getalLiteral);

        assertEquals(new DatumLiteral(20171231).alsString(), res.alsString());
    }
