 ...
 */
@Service
public final class OngeprotocolleerdPersoonsvraagMaakBerichtServiceImpl extends AbstractMaakBerichtServiceImpl<OngeprotocolleerdPersoonsvraagVerzoek> {
     ...
     */
    @Inject
    public OngeprotocolleerdPersoonsvraagMaakBerichtServiceImpl(final LeveringsautorisatieValidatieService leveringsautorisatieService,
                                                                final PartijService partijService,
                                                                final ValideerZoekCriteriaService<OngeprotocolleerdPersoonsvraagVerzoek>
                                                                        valideerZoekPersoonZoekCriteriaService,
                                                                final ValideerGbaAutorisatieService valideerGbaAutorisatieService,
                                                                final ZoekPersoon.OphalenPersoonService<OngeprotocolleerdPersoonsvraagVerzoek>
    ...
    protected String getDienstSpecifiekeLoggingString() {
        return "Zoek Persoon (GBA) (ongeprotocolleerd)";
    }
}
