 ...
 */
@Component
public class PersoonsvraagArchiveerBerichtServiceImpl implements Bevraging.ArchiveerBerichtService<PersoonsvraagVerzoek, BevragingResultaat> {

    @Override
    public void archiveer(final PersoonsvraagVerzoek verzoek, final BevragingResultaat berichtResultaat,
