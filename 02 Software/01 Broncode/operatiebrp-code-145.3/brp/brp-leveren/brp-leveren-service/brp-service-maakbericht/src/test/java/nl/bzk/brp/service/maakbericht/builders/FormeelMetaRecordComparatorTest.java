...
/**
 * FormeelMetaRecordComparatorTest.
 */
public class FormeelMetaRecordComparatorTest {
    ...
    public void testVergelijkTijdstipregistratie() {
        ...
        groepBuilder.metGroepElement(Element.PERSOON_GEBOORTE.getId());
    ...
    public void testVergelijkTijdstipVerval() {
        ...
        //morgen voor vandaag (eerst verval vergelijken) en laatste vervallen eerst
        Assert.assertEquals(-1, compare);
    ...
    public void testVergelijkTijdstipVerval1Gevuld() {
        ...
        //record 2 geen verval, eeuwig dus eerst (vervallen onderaan dus)
        Assert.assertEquals(1, compare);
