...
/**
 * ApplicatieContextTest.
 */
@ContextConfiguration(classes = ApplicatieContextTest.SelectieBrokerTestConfiguratie.class)
public class ApplicatieContextTest extends AbstractDataAccessTest {
    ...
    @ImportResource(value =  {"classpath:brp-broker-context.xml"} )
    public static class SelectieBrokerTestConfiguratie {
    }
