...
public class VerzendingBijhoudingsNotificatieWebServiceClientImplTest {

    private VerzendingBijhoudingsNotificatieWebServiceClientImpl wsClient;

    @Before
    public void voorTest() {
        wsClient = new VerzendingBijhoudingsNotificatieWebServiceClientImpl();
    ...
    public void testInitWebServiceClient() throws Exception {
        Assert.assertEquals("verwerkBijhoudingsplan", wsClient.getSoapAction());
    ...
    public void testPropertyWaardenNaVerstuurRequest() throws Exception {
        ...
        Assert.assertEquals("verwerkBijhoudingsplan", client.getRequestContext().get(BindingProvider.SOAPACTION_URI_PROPERTY));
    }
