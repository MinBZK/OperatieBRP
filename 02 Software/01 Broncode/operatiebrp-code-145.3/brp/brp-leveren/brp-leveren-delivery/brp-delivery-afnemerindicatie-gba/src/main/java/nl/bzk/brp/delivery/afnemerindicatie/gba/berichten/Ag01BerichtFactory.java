...
package nl.bzk.brp.delivery.afnemerindicatie.gba.berichten;
...
/**
 * Factory voor het maken van Ag01 berichten.
 */
@Component
public final class Ag01BerichtFactory {
     ...
     */
    @Inject
    public Ag01BerichtFactory(final BerichtFactory berichtFactory, final Lo3FilterRubriekRepository lo3FilterRubriekRepository) {
        this.berichtFactory = berichtFactory;
        this.lo3FilterRubriekRepository = lo3FilterRubriekRepository;
    }

    /**
     * Maak een message creator Ag01 bericht.
     * @param dienst dienst
     * @param persoonslijst persoonsgegevens
     * @return Ag01 bericht string
     */
    public String maakAg01Bericht(final Dienst dienst, final Persoonslijst persoonslijst) {
        // Volg de bericht strategy (ook voor ontkoppeling van migratie code)
        final Bericht bericht = berichtFactory.maakAg01Bericht(persoonslijst);
