...
/**
 */
@ContextConfiguration(classes = ApplicatieContextTest.SelectieVerwerkerTestConfiguratie.class)
public class ApplicatieContextTest extends AbstractDataAccessTest {
    ...
    @ImportResource(value =  {"classpath:selectie-verwerker-delivery-beans.xml"} )
    @PropertySource(value = "selectieverwerker", factory = SelectieVerwerkerPropertySourceFactory.class)
    public static class SelectieVerwerkerTestConfiguratie {
    }

    static class SelectieVerwerkerPropertySourceFactory implements PropertySourceFactory {
