...
public class SelectieTaakQueueMessageListenerTest {

    @Mock
    private SelectieTaakVerwerker selectieTaakVerwerker;

    @InjectMocks
    private SelectieTaakQueueMessageListener selectieTaakQueueMessageListener;
    ...
    public void testHappyFlow() throws MessageNotWriteableException {
        ...
        activeMQTextMessage.setText(JSON_STRING_SERIALISEERDER.serialiseerNaarString(selectieTaak));
