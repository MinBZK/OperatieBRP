...
package nl.bzk.brp.delivery.selectie;
...
/**
 */
@ContextConfiguration(classes = ApplicatieContextTest.SelectieTestConfiguratie.class)
public class ApplicatieContextTest extends AbstractDataAccessTest {
    ...
    @ImportResource(value =  {"classpath:selectie-delivery-beans.xml"} )
    @PropertySource(value = "selectie", factory = SelectiePropertySourceFactory.class)
    public static class SelectieTestConfiguratie {
    }

    static class SelectiePropertySourceFactory implements PropertySourceFactory {
