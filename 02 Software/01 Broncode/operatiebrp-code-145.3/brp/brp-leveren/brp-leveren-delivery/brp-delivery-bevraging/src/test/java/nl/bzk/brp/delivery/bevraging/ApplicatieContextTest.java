...
/**
 */
@ContextConfiguration(classes = ApplicatieContextTest.BevragingTestConfiguratie.class)
public class ApplicatieContextTest extends AbstractDataAccessTest {
    ...
    @ImportResource(value =  {"classpath:bevraging-webservice-beans.xml"} )
    public static class BevragingTestConfiguratie {
    }
}
