 ...
 */
final class ZoekPersoonVerzoekParser extends AbstractZoekPersoonGeneriekVerzoekParser<ZoekPersoonVerzoek> {

    @Override
    public String getPrefix() {
        return SLASH + BRP_NAMESPACE_PREFIX + SoortBericht.LVG_BVG_ZOEK_PERSOON.getIdentifier();
    }

    @Override
    public void vulDienstSpecifiekeGegevens(final ZoekPersoonVerzoek verzoek, final Node node, final XPath xPath) {
