...
public interface DbService {
     ...
     */
    Lo3Bericht zoekLo3Bericht(final String aNummer);
     ...
     * @param lo3Bericht de Lo3Bericht
     ...
     */
    BrpPersoonslijst zoekBrpPersoonsLijst(final String aNummer);
     ...
     * @return De persoon
     */
    Persoon zoekPersoon(final String administratienummer);
