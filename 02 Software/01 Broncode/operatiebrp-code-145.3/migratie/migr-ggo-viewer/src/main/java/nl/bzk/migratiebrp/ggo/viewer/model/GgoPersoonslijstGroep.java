...
public class GgoPersoonslijstGroep {
     ...
     * @param volledigeNaam Volledige naam.
     * @param ggoLo3PL De Lo3 PL in viewer formaat.
     * @param ggoLo3PLTerugConversie De persoonslijst in lo3 formaat terugconverteerd van een brp pl.
     * @param ggoBrpPL De Brp PL in viewer formaat.
     * @param vergelijking De verschillen tussen de lo3Persoonslijst en teruggeconverteerd.
     * @param meldingen De meldingen van bcm, precondities, etc.
     * @param indexRegels De resultaat regels voor het tonen in de index.
