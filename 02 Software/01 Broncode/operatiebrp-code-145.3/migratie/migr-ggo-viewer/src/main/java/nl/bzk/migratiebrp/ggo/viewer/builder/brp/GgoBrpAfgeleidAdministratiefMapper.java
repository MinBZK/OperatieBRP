...
/**
 * Mapper voor de groep Afgeleid Administratief.
 */
public class GgoBrpAfgeleidAdministratiefMapper extends AbstractGgoBrpMapper<PersoonAfgeleidAdministratiefHistorie> {
     ...
     */
    @Inject
    public GgoBrpAfgeleidAdministratiefMapper(final GgoBrpGegevensgroepenBuilder ggoBrpGegevensgroepenBuilder, final GgoBrpActieBuilder ggoBrpActieBuilder,
    ...
    public final void verwerkInhoud(
        ...
        getGgoBrpValueConvert().verwerkElement(
                ...
                brpInhoud.getAdministratieveHandeling().getSoort());
        getGgoBrpValueConvert().verwerkElement(
                ggoInhoud,
                GgoBrpElementEnum.DATUM_TIJD_LAATSTE_WIJZIGING,
                brpInhoud.getDatumTijdLaatsteWijziging());
        getGgoBrpValueConvert().verwerkElement(
                ggoInhoud,
                GgoBrpElementEnum.DATUM_TIJD_LAATSTE_WIJZIGING_GBA,
                brpInhoud.getDatumTijdLaatsteWijzigingGba());
    }
}
