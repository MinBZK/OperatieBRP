...
public interface MailboxJmx {
     ...
     * @throws MailboxException als er een fout optreedt in de mailboxen.
     */
    void mailboxenLegen() throws MailboxException;

    /**
     * Leegt de meegegeven mailbox.
     * @param mailboxnr mailbox nummer welke geleegd moet worden
     * @throws MailboxException als er een fout optreedt in de mailboxen.
     */
     ...
     * @param mailboxnr mailbox nummer welke geleegd moet worden
     * @param status de status waar de mailbox op ingesteld moet worden
     * @throws MailboxException als er een fout optreedt in de mailboxen.
     */
     ...
     * @param mailboxnr mailbox nummer welke geleegd moet worden
     * @param wachtwoord het wachtwoord dat ingesteld moet worden
     * @throws MailboxException als er een fout optreedt in de mailboxen.
     */
