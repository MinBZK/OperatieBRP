...
public class Lo3AttribuutConverteerder {
    ...
    /**
     * Constructor.
     * @param conversietabellen een {@link ConversietabelFactory} voor de toegang tot de conversie tabellen. Mag NIET null zijn
     * @throws NullPointerException als de parameter conversietabellen null is
     */
    @Inject
    public Lo3AttribuutConverteerder(final ConversietabelFactory conversietabellen) {
        if (conversietabellen == null) {
            throw new NullPointerException("Parameter conversietabellen mag niet null zijn");
        }
     ...
     */
    final BrpCharacter converteerCharacter(final Lo3Character lo3Character) {
     ...
     */
    final BrpLong converteerLong(final Lo3Integer lo3Integer) {
     ...
     * @param datum lo3 datum, mag null zijn
     ...
     * @param datum lo3 datum
     * @return BRP integer, null als datum null is
     */
    final BrpInteger converteerDatumToInteger(final Lo3Datum datum) {
        return datum == null ? null : new BrpInteger(datum.getIntegerWaarde(), datum.getOnderzoek());
    }

    /**
     * Converteer een indicatie document.
     * @param waarde lo3 indicatie document, mag null zijn
     * @return true als indicatie aanwezig is, anders false
     */
    final BrpBoolean converteerIndicatieDocument(final Lo3IndicatieDocument waarde) {
     ...
     * @param huisnummer lo3 huisnummer, mag null zijn
     * @return brp huisnummer, null als huisnummer null is
     */
    final BrpInteger converteerHuisnummer(final Lo3Huisnummer huisnummer) {
     ...
     * @param indicatieGezagdMinderjarige LO3 waarde
     * @return BRP waarde
     */
    final BrpBoolean converteerDerdeHeeftGezag(final Lo3IndicatieGezagMinderjarige indicatieGezagdMinderjarige) {
     ...
     * @param indicatieGezagMinderjarige LO3 waarde
     * @return BRP waarde
     */
    final BrpBoolean converteerOuder1HeeftGezag(final Lo3IndicatieGezagMinderjarige indicatieGezagMinderjarige) {
     ...
     * @return BRP waarde
     */
    final BrpBoolean converteerOuder2HeeftGezag(final Lo3IndicatieGezagMinderjarige indicatieGezagMinderjarige) {
        if (!Lo3Validatie.isElementGevuld(indicatieGezagMinderjarige)) {
            return null;
        }
     ...
     * @param waarde LO3 waarde
     * @return BRP waarde
     */
    final BrpBoolean converteerOnderCuratele(final Lo3IndicatieCurateleregister waarde) {
     ...
     * @return BRP waarde
     */
    final BrpSoortDocumentCode converteerLo3Aktenummer(final Character waarde) {
     ...
     * @return BRP waarde
     */
    final BrpGemeenteCode converteerLo3GemeenteCode(final Lo3GemeenteCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpLandOfGebiedCode converteerLo3LandCode(final Lo3LandCode waarde) {
        return conversietabellen.createLandConversietabel().converteerNaarBrp(waarde);
    }

    /**
     * Converteer een autoriteit van afgifte buitenlands persoonsnummer.
     * @param waarde LO3 waarde
     * @return BRP waarde
     */
    final BrpAutoriteitVanAfgifteBuitenlandsPersoonsnummer converteerLo3AutoriteitVanAfgifteBuitenlandsPersoonsnummer(
            final Lo3NationaliteitCode waarde) {
        return conversietabellen.createAutoriteitVanAfgifteBuitenlandsPersoonsnummertabel().converteerNaarBrp(waarde);
    }
     ...
     * @return BRP waarde
     */
    final BrpBoolean converteerLo3IndicatiePKVolledigGeconverteerdCode(final Lo3IndicatiePKVolledigGeconverteerdCode waarde) {
    ...
    final BrpBoolean converteerLo3IndicatieGeheimCode(final Lo3IndicatieGeheimCode waarde) {
    ...
    final BrpNadereBijhoudingsaardCode converteerLo3RedenOpschortingBijhoudingCode(final Lo3RedenOpschortingBijhoudingCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpBoolean converteerLo3AanduidingUitgeslotenKiesrecht(final Lo3AanduidingUitgeslotenKiesrecht waarde) {
     ...
     * @return BRP waarde
     */
    final BrpBoolean converteerLo3AanduidingEuropeesKiesrecht(final Lo3AanduidingEuropeesKiesrecht waarde) {
     ...
     * @return BRP waarde
     */
    final BrpNationaliteitCode converteerLo3NationaliteitCode(final Lo3NationaliteitCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpRedenVerkrijgingNederlandschapCode converteerLo3RedenVerkrijgingNederlandschapCode(final Lo3RedenNederlandschapCode waarde) {
     ...
     */
    final BrpString converteerLo3RedenVerkrijgingNederlandschapCodeToBrpString(final Lo3RedenNederlandschapCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpRedenVerliesNederlandschapCode converteerLo3RedenVerliesNederlandschapCode(final Lo3RedenNederlandschapCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpNaamgebruikCode converteerLo3AanduidingNaamgebruikCode(final Lo3AanduidingNaamgebruikCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpAanduidingInhoudingOfVermissingReisdocumentCode converteerLo3AanduidingInhoudingVermissingNederlandReisdocument(
     ...
     * @return BRP waarde
     */
    final BrpSoortNederlandsReisdocumentCode converteerLo3ReisdocumentSoort(final Lo3SoortNederlandsReisdocument waarde) {
     ...
     * @return BRP waarde
     */
    final BrpReisdocumentAutoriteitVanAfgifteCode converteerLo3AutoriteitVanAfgifteNederlandsReisdocument(
     ...
     * @return BRP waarde
     */
    final BrpSoortAdresCode converteerLo3FunctieAdres(final Lo3FunctieAdres waarde) {
     ...
     * @return BRP waarde
     */
    final BrpRedenWijzigingVerblijfCode converteerLo3AangifteAdreshoudingNaarBrpRedenWijziging(final Lo3AangifteAdreshouding waarde) {
        final AangeverRedenWijzigingVerblijfPaar brpPaar = conversietabellen.createAangeverRedenWijzigingVerblijfConversietabel().converteerNaarBrp(waarde);
        if (brpPaar == null) {
            return null;
        }
     ...
     * @return BRP waarde
     */
    final BrpAangeverCode converteerLo3AangifteAdreshoudingNaarBrpAangeverAdreshouding(final Lo3AangifteAdreshouding waarde) {
        final AangeverRedenWijzigingVerblijfPaar brpPaar = conversietabellen.createAangeverRedenWijzigingVerblijfConversietabel().converteerNaarBrp(waarde);
        if (brpPaar == null) {
            return null;
        }
     ...
     * @return BRP waarde
     */
    final BrpVerblijfsrechtCode converteerLo3AanduidingVerblijfstitelCode(final Lo3AanduidingVerblijfstitelCode waarde) {
     ...
     * @return BRP waarde
     */
    final BrpAanduidingBijHuisnummerCode converteerAanduidingBijHuisnummer(final Lo3AanduidingHuisnummer waarde) {
     ...
     * @return BRP waarde
     */
    final BrpBoolean converteerSignalering(final Lo3Signalering waarde) {
     ...
     * @param nationaliteit Lo3 Nationaliteit code
     * @return BrpBoolean met de waarde true als de nationaliteit 'staatloos' is, anders null.
     */
    final BrpBoolean converteerStaatloosIndicatie(final Lo3NationaliteitCode nationaliteit) {
     ...
     * @param aanduiding aanduiding bijzonder Nederlandschap
     * @return BrpBoolean met waarde true als aanduiding 'Behandeld als Nederlander' is, anders null.
     */
    final BrpBoolean converteerBehandeldAlsNederlander(final Lo3AanduidingBijzonderNederlandschap aanduiding) {
        BrpBoolean result = null;
        if (aanduiding != null
     ...
     */
    final BrpBoolean converteerVastgesteldNietNederlander(final Lo3AanduidingBijzonderNederlandschap aanduiding) {
        BrpBoolean result = null;
        if (aanduiding != null
                && aanduiding.isInhoudelijkGevuld()
     ...
     * @param indicatieOnjuist de Lo3 indicatie onjuist
     * @return BRP character
     */
    final BrpCharacter converteerOnjuistIndicatie(final Lo3IndicatieOnjuist indicatieOnjuist) {
        return indicatieOnjuist == null ? null : new BrpCharacter(indicatieOnjuist.getCodeAsCharacter(), indicatieOnjuist.getOnderzoek());
    }

    /**
     * Converteer een lo3 selectiesoort naar een brp soort selectie.
     * @param waarde de lo3 selectiesoort (95.52)
     * @return brp soort selectie
     */
    public final SoortSelectie converteerSoortSelectie(final Integer waarde) {
        return conversietabellen.createSoortSelectieConversietabel().converteerNaarBrp(waarde);
    }

    /**
     * Converteer een lo3 berichtaanduiding naar een brp indicatie verzenden volledig bericht bij plaatsen.
     * @param waarde de lo3 berichtaanduiding (95.53)
     * @return brp indicatie verzenden volledig bericht bij plaatsen
     */
    public final Boolean converteerBerichtaanduiding(final Integer waarde) {
        return conversietabellen.createBerichtaanduidingConversietabel().converteerNaarBrp(waarde);
    }

    /**
     * Converteer een lo3 medium selectie naar een brp leverwijze selectie.
     * @param waarde de lo3 medium selectie (95.56)
     * @return brp leverwijze selectie
     */
    public final LeverwijzeSelectie converteerMediumSelectie(final String waarde) {
        return conversietabellen.createMediumSelectieConversietabel().converteerNaarBrp(waarde);
    }
}
