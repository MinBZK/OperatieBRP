 ...
 */
@Component
public final class RniDeelnemerVoorwaardeRegel extends AbstractGbaVoorwaardeRegel {
    ...
    public RniDeelnemerVoorwaardeRegel(
        ...
        standaardVoorwaardeRegelUtil = new StandaardVoorwaardeRegelUtil(gbaRubriekNaarBrpTypeVertaler, waarde ->
                conversieTabelFactory.createRNIDeelnemerConversietabel().converteerNaarBrp(new Lo3RNIDeelnemerCode(waarde)).getWaarde());
    }
