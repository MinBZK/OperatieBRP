 ...
 */
@Component
public final class SoortRelatieVoorwaardeRegel extends AbstractGbaVoorwaardeRegel {
    ...
    public SoortRelatieVoorwaardeRegel(
        ...
        standaardVoorwaardeRegelUtil = new StandaardVoorwaardeRegelUtil(gbaRubriekNaarBrpTypeVertaler, waarde ->
                conversieTabelFactory.createSoortRelatieConversietabel()
                        .converteerNaarBrp(new Lo3SoortVerbintenis(waarde.replaceAll("\"", "")))
                        .getWaarde()
        );
    }
