...
package nl.bzk.migratiebrp.conversie.regels.proces.foutmelding;
...
public final class Foutmelding {
     ...
     * @param lo3Herkomst de herkomst set
     * @param severity de ernst van de fout
     * @param soortMeldingCode de soort melding
     * @param lo3ElementNummer het lo3 element waar de melding betrekking op heeft. Alleen noodzakelijk als de omschrijving van de melding niet duidelijk maakt
     * op welke element deze betrekking heeft.
     */
    private Foutmelding(
     ...
     * @param severity de severety
     * @param soortMeldingCode de soort melding
     * @param lo3ElementNummer het lo3 element waar de melding betrekking op heeft. Alleen noodzakelijk als de omschrijving van de melding niet duidelijk maakt
     * op welke element deze betrekking heeft.
     * @return de foutmelding
     */
    public static Foutmelding maakMeldingFout(
            final Lo3Herkomst lo3Herkomst,
            final LogSeverity severity,
            final SoortMeldingCode soortMeldingCode,
            final Lo3ElementEnum lo3ElementNummer) {
    ...
    /**
     * Log een foutmelding voor de specifieke soort melding met severity: ERROR.
     * @param lo3Herkomst de herkomst
     * @param soortMeldingCode de soort melding
     * @param lo3ElementNummer het lo3 element waar de melding betrekking op heeft. Alleen noodzakelijk als de omschrijving van de melding niet duidelijk maakt
     * op welke element deze betrekking heeft.
     */
    public static void logMeldingFoutError(final Lo3Herkomst lo3Herkomst, final SoortMeldingCode soortMeldingCode, final Lo3ElementEnum lo3ElementNummer) {
        logMeldingFout(lo3Herkomst, LogSeverity.ERROR, soortMeldingCode, lo3ElementNummer);
    }
