 ...
 */
public class BrpIstAbstractConverteerder {

    /**
     * Comparator om Lo3 categorieen op herkomst te sorteren.
     */
    static final Comparator<Lo3Categorie<?>> LO3_HERKOMST_COMPARATOR = new Lo3HerkomstComparator();
    private static final Map<Lo3CategorieEnum, Class<? extends Lo3CategorieInhoud>> IST_CATEGORIEEN = new EnumMap<>(Lo3CategorieEnum.class);
    ...
    BrpIstAbstractConverteerder(final BrpAttribuutConverteerder attribuutConverteerder) {
        this.converteerder = attribuutConverteerder;
    }

    /**
     * Vult de Lo3 historie.
     * @param inhoud inhoud waaruit de Lo3 historie wordt gevuld
     * @return Lo3 historie
     */
    final Lo3Historie maakHistorie(final BrpIstStandaardGroepInhoud inhoud) {
        ...
        final Lo3Datum ingangsdatumGeldigheid = getAttribuutConverteerder().converteerDatum(inhoud.getRubriek8510IngangsdatumGeldigheid());
        final Lo3Datum datumVanOpneming = getAttribuutConverteerder().converteerDatum(inhoud.getRubriek8610DatumVanOpneming());
     ...
     * @param inhoud inhoud waaruit de Lo3 documentatie wordt gevuld
    ...
    final Lo3Documentatie maakDocumentatie(final BrpIstStandaardGroepInhoud inhoud) {
        ...
        final Lo3GemeenteCode gemeenteCode = getAttribuutConverteerder().converteerGemeenteCode(inhoud.getPartij());
        if (inhoud.getAktenummer() != null) {
            // Akte
            documentatie =
                    new Lo3Documentatie(0, gemeenteCode, getAttribuutConverteerder().converteerString(inhoud.getAktenummer()), null, null, null, null, null);
        } else if (inhoud.getDocumentOmschrijving() != null) {
            // Document
            final Lo3Datum lo3Datum = getAttribuutConverteerder().converteerDatum(inhoud.getRubriek8220DatumDocument());
            documentatie =
                    new Lo3Documentatie(
                            0,
                            null,
                            ...
                            gemeenteCode,
                            lo3Datum,
                            getAttribuutConverteerder().converteerString(inhoud.getDocumentOmschrijving()),
                            null,
                            null);
        }
     ...
     * @param inhoud inhoud waaruit de Lo3 onderzoek wordt gevuld
     ...
     * @param inhoud inhoud waaruit de Lo3 herkomst wordt gevuld
     * @return Lo3 herkomst
     */
     ...
     * @param gemeenteCode BRP gemeentecode
     * @param buitenlandsePlaats buitenlandse plaats
     * @param landCode BRP landcode
     * @param omschrijvingLocatie omschrijving locaie
    ...
    final Lo3GemeenteLand converteerPlaatsLand(
        ...
        return getAttribuutConverteerder().converteerLocatie(gemeenteCode, buitenlandsePlaats, null, landCode, omschrijvingLocatie);
    }

    /**
     * Converteert de geboorte land/gebied en plaats naar lo3 waarden.
     * @param inhoud brp ist inhoud
     ...
     */
    public final BrpAttribuutConverteerder getAttribuutConverteerder() {
     ...
     * @param element LO3 element waar aan het onderzoek moet worden toegevoegd.
     * @param onderzoek LO3 onderzoek dat aan het element gekoppeld wordt.
     * @param herkomst LO3 herkomst om te bepalen of het onderzoek aan het element gekoppeld moet worden.
     * @param elementNummer het element nummer waaraan onderzoek moet worden toegevoegd.
     * @param <V> type van het LO3 element.
     * @return kopie van element met onderzoek
     */
    static <V extends Lo3Element> V toevoegenOnderzoek(
            final V element,
    ...
    private static <V extends Lo3Element> V toevoegenOnderzoekAanElement(
        ...
        V result = null;
        if (classType != null && (waarde != null || toegevoegdOnderzoek != null)) {
            try {
     ...
     * Als onderzoek null is, dan wordt het onderzoek dat aan het element is gekoppeld, toegevoegd. Als element null is,
     * dan wordt er via het elementnummer het juiste type element gezocht en deze terug gegeven met onderzoek.
     * @param historie LO3 Historie waar het onderzoek aan zijn elementen moet worden toegevoegd.
     * @param onderzoek LO3 onderzoek dat aan het element gekoppeld wordt.
     * @param herkomst LO3 herkomst om te bepalen of het onderzoek aan het element gekoppeld moet worden.
     * @return kopie van historie met onderzoek
     */
    static Lo3Historie toevoegenOnderzoekHistorie(final Lo3Historie historie, final Lo3Onderzoek onderzoek, final Lo3Herkomst herkomst) {
     ...
     * Als onderzoek null is, dan wordt het onderzoek dat aan het element is gekoppeld, toegevoegd. Als element null is,
     * dan wordt er via het elementnummer het juiste type element gezocht en deze terug gegeven met onderzoek.
     * @param documentatie LO3 Documentatie waar het onderzoek aan zijn elementen moet worden toegevoegd.
     * @param onderzoek LO3 onderzoek dat aan het element gekoppeld wordt.
     * @param herkomst LO3 herkomst om te bepalen of het onderzoek aan het element gekoppeld moet worden.
     * @return kopie van documentatie met onderzoek
     */
    static Lo3Documentatie toevoegenOnderzoekDocumentatie(
