...
public interface ConverteerLo3NaarBrpService {
     ...
     * <li>Stap 2: opschonen verantwoording</li>
     * </ul>
     * @param lo3Autorisatie De te converteren autorisaties.
     * @return een BrpAutorisatie
     * @throws Lo3SyntaxException In het geval van een conversie probleem.
     */
    BrpAutorisatie converteerLo3Autorisatie(final Lo3Autorisatie lo3Autorisatie);
     ...
     * {@link nl.bzk.migratiebrp.conversie.regels.proces.lo3naarbrp.Lo3HistorieConversie})</li>
     * </ul>
     * @param lo3Afnemersindicaties De te converteren afnemers indicaties.
    ...
    /**
     * Converteert een Lo3ToevalligeGebeurtenis naar een BrpToevalligeGebeurtenis. Hiervoor worden de volgende stappen
     * uitgevoerd:
     *
     * <ul>
     * <li>Stap 1: conversie inhoud</li>
     * </ul>
     * @param lo3ToevalligeGebeurtenis De te converteren toevallige gebeurtenis
     * @return geconverteerde toevallige gebeurtenis
     */
    BrpToevalligeGebeurtenis converteerLo3ToevalligeGebeurtenis(final Lo3ToevalligeGebeurtenis lo3ToevalligeGebeurtenis);
}
