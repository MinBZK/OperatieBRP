 ...
 * Test.
 */
public class EnWaardeTest {

    @Test
    public void testEnWaarde() {
        ...
        final String verwacht = "(KV(element1) EN KV(element2))";
        final EnWaarde subject = new EnWaarde(elementWaarde1, elementWaarde2);
    ...
    final EnWaarde en = new EnWaarde();
    en.getBrpExpressie();
    }
}
