...
public class Casus05NaamTest extends AbstractCasusTest {
...

    {
        ...
        final BrpActie actie2 = buildBrpActie(BrpDatumTijd.fromDatum(19930202, null), "2A");
        final BrpActie actie3 = buildBrpActie(BrpDatumTijd.fromDatum(19950202, null), "3A");

        // @formatter:off
        // LO3 input
        lo3.vul(lo3Klaas, null, 19950201, 19950202, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 0));
        lo2.vul(lo3Jan, null, 19920301, 19930202, 2, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_51, 0, 1));
        lo1.vul(lo3Piet, null, 19920401, 19920508, 1, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_51, 0, 2));

        // verwachte BRP output
        brp1.vul(brpPiet, 19920401, 19950201, 19920508010000L, null, null, actie1, actie3, null);
        brp2.vul(brpJan, 19920301, 19920401, 19930202010000L, null, null, actie2, actie1, null);
        brp3.vul(brpKlaas, 19950201, null, 19950202010000L, null, null, actie3, null, null);
