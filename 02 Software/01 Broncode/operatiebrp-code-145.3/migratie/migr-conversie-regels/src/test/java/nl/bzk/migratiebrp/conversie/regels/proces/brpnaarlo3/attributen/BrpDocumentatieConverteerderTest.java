...
public class BrpDocumentatieConverteerderTest {
    ...
    private static final BrpPartijCode BRP_PARTIJ_DOCUMENT = new BrpPartijCode("001701");
    // Partij/gemeente is Usquert
    private static final BrpPartijCode BRP_PARTIJ_DOCUMENT_2 = new BrpPartijCode("004601");
    ...
    private static final String RNI_DEELNEMER_CODE = "000099";

    private BrpDocumentatieConverteerder conv;

    @Before
    public void setup() {
        final BrpAttribuutConverteerder attribuutConverteerder = mock(BrpAttribuutConverteerder.class);
        when(attribuutConverteerder.valideerRNIDeelnemerTegenBrp(argThat(new Rnideelnemer()))).thenReturn(true);
        when(attribuutConverteerder.valideerRNIDeelnemerTegenBrp(argThat(new NotRnideelnemer()))).thenReturn(false);
        ...
        when(attribuutConverteerder.converteerGemeenteCode(brpPartijCode.capture())).thenAnswer(invocationOnMock -> {
            if (brpPartijCode.getValue().getWaarde() == null) {
                return new Lo3GemeenteCode(LO3_GEMEENTE_CODE.getWaarde(), brpPartijCode.getValue().getOnderzoek());
            } else {
        ...
        conv = new BrpDocumentatieConverteerder(attribuutConverteerder);
    }
    ...
    public void testLegeDocumentStapels() {
        final BrpActie brpActie = new BrpActie(1L, null, BRP_PARTIJ_MIGRATIE, null, null, new ArrayList<>(), 0, null);
        final Lo3Documentatie lo3Doc = conv.maakDocumentatie(brpActie);
        assertNotNull(lo3Doc);
        assertNull(lo3Doc.getBeschrijvingDocument());
        assertNull(lo3Doc.getGemeenteAkte());
    ...
    public void testEnkelDocumentAkte() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER, null, BRP_PARTIJ_DOCUMENT);
    ...
    public void testEnkelDocumentDocument() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, null, DOC_OMSCHRIJVING, BRP_PARTIJ_DOCUMENT);
    ...
    public void testMeerdereDocumentenAlleDocument() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, null, DOC_OMSCHRIJVING, BRP_PARTIJ_DOCUMENT);
        final BrpDocumentInhoud docInhoud2 = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, null, DOC_OMSCHRIJVING_2, BRP_PARTIJ_DOCUMENT);
    ...
    public void testMeerdereDocumentenAlleAkten() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER, null, BRP_PARTIJ_DOCUMENT);
        final BrpDocumentInhoud docInhoud2 = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER_2, null, BRP_PARTIJ_DOCUMENT);
    ...
    public void testMeerdereDocumentenLeegDocumentEnGevuldAkte() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, LEGE_BRPSTRING, DOC_OMSCHRIJVING, BRP_PARTIJ_DOCUMENT);
        final BrpDocumentInhoud docInhoud2 = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER_2, LEGE_BRPSTRING, BRP_PARTIJ_DOCUMENT);
    ...
    public void testPreconditie085AllesNull() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, null, null, BRP_PARTIJ_DOCUMENT);

        final BrpActie brpActie = maakActie(maakDocumentStapel(docInhoud));
        testMaakDocumentatie(brpActie);
    }

    private void testMaakDocumentatie(final BrpActie brpActie) {
        try {
    ...
    public void testPreconditie085AllesLeeg() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, LEGE_BRPSTRING, LEGE_BRPSTRING, BRP_PARTIJ_DOCUMENT);
    ...
    public void testPreconditie085AkteNullDocumentLeeg() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, null, LEGE_BRPSTRING, BRP_PARTIJ_DOCUMENT);
    ...
    public void testPreconditie085AkteLeegDocumentNull() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, LEGE_BRPSTRING, null, BRP_PARTIJ_DOCUMENT);
    ...
    public void testPreconditie085AktenummerDocOmschrijvingGevuld() {
        final BrpDocumentInhoud docInhoud =
                new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, new BrpString("1 ABCD2", null), new BrpString("Omschrijving", null), BRP_PARTIJ_DOCUMENT);
    ...
    public void testPreconditie108VerschillendePartijen() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER, null, BRP_PARTIJ_DOCUMENT);
        final BrpDocumentInhoud docInhoud2 = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_DOCUMENT, null, DOC_OMSCHRIJVING, BRP_PARTIJ_DOCUMENT_2);
    ...
    public void testDocumentPartijNull() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER, null, null);
        final BrpActie brpActie = maakActie(maakDocumentStapel(docInhoud));
    ...
    public void testRechtsOmschrijvingRNIDeelnemerMetOmschrijvingVerdrag() {
        final BrpDocumentInhoud docInhoud = new BrpDocumentInhoud(BRP_SOORT_DOCUMENT_AKTE, AKTE_NUMMER, null, null);
        BrpPartijCode code = new BrpPartijCode(RNI_DEELNEMER_CODE);
    ...
    private BrpActie maakActie(final List<BrpActieBron> actieBronnen, final boolean heeftDatumOntlening, BrpPartijCode partijcode) {
        ...
        return new BrpActie(1L, BrpSoortActieCode.CONVERSIE_GBA, partijcode, DATUM_OPNEMING, datumOntlening, actieBronnen, 0, null);
    }
    ...
    class Rnideelnemer extends ArgumentMatcher<BrpPartijCode> {
        public boolean matches(Object code) {
            return code == null || Objects.equals(((BrpPartijCode) code).getWaarde(), RNI_DEELNEMER_CODE);
        }
    }
