...
public class NaamgebruikVoorwaardeRegelTest {

    @Inject
    private NaamgebruikVoorwaardeRegel instance;
    ...
    public void testGetBrpExpressie() throws Exception {
        testUtil.testVoorwaarde("01.61.10 GA1 \"E\"", "Persoon.Naamgebruik.Code E= \"E\"");
    }
}
