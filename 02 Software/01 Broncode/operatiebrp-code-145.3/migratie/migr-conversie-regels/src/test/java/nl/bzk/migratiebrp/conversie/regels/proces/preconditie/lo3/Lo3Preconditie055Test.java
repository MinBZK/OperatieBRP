...
public class Lo3Preconditie055Test {
    ...
    private final Lo3Historie lo3Historie3 = new Lo3Historie(new Lo3IndicatieOnjuist("O"), new Lo3Datum(20120101), new Lo3Datum(20130104));
    ...
    private void assertDatLoggingIsAangemaakt(final Logging logging) {
        ...
        assertEquals(SoortMeldingCode.PRE055.name(), logRegel.getSoortMeldingCode().name());
    ...
    private Lo3Stapel<Lo3GezagsverhoudingInhoud> maakStapelMetOnjuistMetSortering1() {
        ...
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie0, lo3Herkomst0));
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie1, lo3Herkomst1));
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie2, lo3Herkomst2));
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie3, lo3Herkomst3));
    ...
    private Lo3Stapel<Lo3GezagsverhoudingInhoud> maakStapelMetOnjuistMetSortering7() {
        ...
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie2, lo3Herkomst2));
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie3, lo3Herkomst3));
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie4, lo3Herkomst3));
        categorieen.add(new Lo3Categorie<>(inhoud, null, lo3Historie0, lo3Herkomst0));
        return new Lo3Stapel<>(categorieen);
    }
