...
public class IndicatieCurateleVoorwaardeRegelTest {

    @Inject
    private IndicatieCurateleVoorwaardeRegel instance;
    ...
    public void testGetBrpExpressie() throws Exception {
        testUtil.testVoorwaarde("11.33.10 GA1 1", "KV(Persoon.Indicatie.OnderCuratele.Waarde)");
    }
}
