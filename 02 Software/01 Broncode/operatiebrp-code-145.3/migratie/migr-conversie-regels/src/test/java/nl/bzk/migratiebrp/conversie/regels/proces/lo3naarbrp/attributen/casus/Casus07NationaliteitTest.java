...
public class Casus07NationaliteitTest extends AbstractCasusTest {
...

    {
        ...
        // @formatter:off
        // LO3 input
        // <leeg> 31-12-1994 3-1-1995 <A3>
        // <leeg> O 1-1-1995 2-1-1995 <A2>
        // Duits 1-1-1990 2-1-1990 <A1>
        lo3.vul(lo3Leeg, null, 19941231, 19950103, 3, new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0));
        ...
        // Duits 1-1-1990 31-12-1994 2-1-1990 xxxxxxxx A1 A3
        // Duits 1-1-1990 1-1-1995 2-1-1990 2-1-1990 A1 A2 A1
        brp1.vul(brpDuits, 19900101, 19941231, 19900102010000L, null, null, actie1, actie3, null);
