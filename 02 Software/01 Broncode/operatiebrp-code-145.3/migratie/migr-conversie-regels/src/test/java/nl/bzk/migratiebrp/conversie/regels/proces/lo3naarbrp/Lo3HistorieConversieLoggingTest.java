...
public class Lo3HistorieConversieLoggingTest extends AbstractLoggingTest {
    ...
    private static final Lo3Herkomst LO_3_HERKOMST_0 = new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_01, 0, 0);
    private static final Lo3Herkomst LO_3_HERKOMST_1 = new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_06, 0, 0);
    private static final Lo3Herkomst LO_3_HERKOMST_2 = new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_56, 0, 1);
    private static final Lo3Herkomst LO_3_HERKOMST_3 = new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 0, 0);
    private static final Lo3Herkomst LO_3_HERKOMST_4 = new Lo3Herkomst(Lo3CategorieEnum.CATEGORIE_04, 1, 0);
    ...
    public void testLogNietGeconverteerdeVoorkomensEnkelvoudigeStapel1() {
        ...
        Lo3HistorieConversieLogging.logNietGeconverteerdeVoorkomens(tussenPersoonslijst, new HashMap<>());
    ...
    public void testLogNietGeconverteerdeVoorkomensEnkelvoudigeStapel3() {
        ...
        final Map<Long, BrpActie> actieCache = new HashMap<>();
        final BrpActie actie = new BrpActie.Builder().id(2L).partijCode(BrpPartijCode.MIGRATIEVOORZIENING).lo3Herkomst(LO_3_HERKOMST_1).build();
        actie.setWordtGebruikt();
        actieCache.put(2L, actie);
        Lo3HistorieConversieLogging.logNietGeconverteerdeVoorkomens(tussenPersoonslijst, actieCache);
    ...
    public void testLogNietGeconverteerdeVoorkomensEnkelvoudigeStapel4() {
        ...
        final Map<Long, BrpActie> actieCache = new HashMap<>();
        final BrpActie actie3 = new BrpActie.Builder().id(3L).partijCode(BrpPartijCode.MIGRATIEVOORZIENING).lo3Herkomst(LO_3_HERKOMST_1).build();
        actie3.setWordtGebruikt();
        final BrpActie actie4 = new BrpActie.Builder().id(4L).partijCode(BrpPartijCode.MIGRATIEVOORZIENING).lo3Herkomst(LO_3_HERKOMST_2).build();
        actie4.setWordtGebruikt();
        actieCache.put(3L, actie3);
        actieCache.put(4L, actie4);
        Lo3HistorieConversieLogging.logNietGeconverteerdeVoorkomens(tussenPersoonslijst, actieCache);
    ...
    public void testLogNietGeconverteerdeVoorkomensMeervoudigeStapel2() {
        ...
        final Map<Long, BrpActie> actieCache = new HashMap<>();
        final BrpActie actie6 = new BrpActie.Builder().id(6L).partijCode(BrpPartijCode.MIGRATIEVOORZIENING).lo3Herkomst(LO_3_HERKOMST_3).build();
        actie6.setWordtGebruikt();
        final BrpActie actie7 = new BrpActie.Builder().id(7L).partijCode(BrpPartijCode.MIGRATIEVOORZIENING).lo3Herkomst(LO_3_HERKOMST_4).build();
        actie7.setWordtGebruikt();

        actieCache.put(6L, actie6);
        actieCache.put(7L, actie7);
        Lo3HistorieConversieLogging.logNietGeconverteerdeVoorkomens(tussenPersoonslijst, actieCache);
