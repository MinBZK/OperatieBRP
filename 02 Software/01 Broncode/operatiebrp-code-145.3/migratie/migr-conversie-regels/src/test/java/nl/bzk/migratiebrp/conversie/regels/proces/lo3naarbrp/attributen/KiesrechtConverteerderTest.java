...
public class KiesrechtConverteerderTest extends AbstractComponentTest {
    ...
    private KiesrechtConverteerder kiesrechtConverteerder = new KiesrechtConverteerder(new Lo3AttribuutConverteerder(new ConversietabelFactoryImpl()));
        ...
        final TussenStapel<BrpIdentificatienummersInhoud> identificatienummerStapel =
                new TussenStapel<>(
                        Collections.singletonList(
                                new TussenGroep<>(
                                        new BrpIdentificatienummersInhoud(new BrpString("1234567890", null), new BrpString("123456789", null)),
    ...
    public void testNullInputs2() {
        final Lo3Stapel<Lo3KiesrechtInhoud> kiesrechtStapel = new Lo3Stapel<>(Collections.singletonList(buildUitsluitingKiesrecht()));

        final Lo3Stapel<Lo3InschrijvingInhoud> inschrijvingStapel = new Lo3Stapel<>(Collections.singletonList(buildInschrijving()));
    ...
    public void testEmpty() {
        ...
        final TussenStapel<BrpDeelnameEuVerkiezingenInhoud> deelnameEuVerkiezingenStapel = tussenPersoonslijst.getDeelnameEuVerkiezingenStapel();
    ...
    private Lo3Categorie<Lo3KiesrechtInhoud> buildUitsluitingKiesrecht() {
        return new Lo3Categorie<>(
                new Lo3KiesrechtInhoud(
                        null, // aanduiding deelnameEuVerkiezingen kiesrecht
    ...
    private Lo3Categorie<Lo3KiesrechtInhoud> buildUitsluitingEuropeesKiesrecht() {
        return new Lo3Categorie<>(
                new Lo3KiesrechtInhoud(
                        Lo3AanduidingEuropeesKiesrechtEnum.UITGESLOTEN.asElement(), // aanduiding
    ...
    public void testUitsluitingEuropeesKiesrecht() {
        // Setup
        final Lo3Stapel<Lo3KiesrechtInhoud> kiesrechtStapel = new Lo3Stapel<>(Collections.singletonList(buildUitsluitingEuropeesKiesrecht()));
        final TussenPersoonslijstBuilder builder = buildMigratiePersoonslijstBuilder();
        final Lo3Stapel<Lo3InschrijvingInhoud> inschrijvingStapel = new Lo3Stapel<>(Collections.singletonList(buildInschrijving()));
    ...
    public void testUitsluitingBeide() {
        // Setup
        final Lo3Stapel<Lo3KiesrechtInhoud> kiesrechtStapel = new Lo3Stapel<>(Collections.singletonList(buildUitsluitingBeide()));
        final TussenPersoonslijstBuilder builder = buildMigratiePersoonslijstBuilder();
        final Lo3Stapel<Lo3InschrijvingInhoud> inschrijvingStapel = new Lo3Stapel<>(Collections.singletonList(buildInschrijving()));
