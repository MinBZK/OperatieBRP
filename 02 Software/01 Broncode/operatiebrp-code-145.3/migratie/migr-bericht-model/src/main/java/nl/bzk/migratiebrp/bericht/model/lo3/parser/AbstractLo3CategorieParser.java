 ...
 * @param <T> de LO3 categorie die geparsed wordt.
 */
public abstract class AbstractLo3CategorieParser<T extends Lo3CategorieInhoud> {

    private static final Set<Lo3CategorieEnum> CATS_ZONDER_GROEP_81 =
            EnumSet.of(Lo3CategorieEnum.CATEGORIE_04,
    ...
    private static final Set<Lo3CategorieEnum> CATS_ZONDER_GROEP_82 =
            EnumSet.of(Lo3CategorieEnum.CATEGORIE_07, Lo3CategorieEnum.CATEGORIE_08, Lo3CategorieEnum.CATEGORIE_10, Lo3CategorieEnum.CATEGORIE_21);
    private static final Set<Lo3CategorieEnum>
            CATS_ZONDER_GROEP_84 =
            EnumSet.of(Lo3CategorieEnum.CATEGORIE_07, Lo3CategorieEnum.CATEGORIE_12, Lo3CategorieEnum.CATEGORIE_13);
    private static final Set<Lo3CategorieEnum> CATS_ZONDER_GROEP_85 = EnumSet.of(Lo3CategorieEnum.CATEGORIE_07, Lo3CategorieEnum.CATEGORIE_13);
    private static final Set<Lo3CategorieEnum> CATS_ZONDER_GROEP_86 = EnumSet.of(Lo3CategorieEnum.CATEGORIE_07, Lo3CategorieEnum.CATEGORIE_13);
    private static final Set<Lo3CategorieEnum> CATS_ZONDER_GROEP_88 =
            EnumSet.of(Lo3CategorieEnum.CATEGORIE_02,
    ...
    /**
     * Parse een categorie.
     * @param categorieen de lijst met categorie waarden uit de kolom van de persoonslijst
    ...
    protected final Lo3Historie parseLo3Historie(
        ...
        final Lo3IndicatieOnjuist indicatieOnjuist =
                CATS_ZONDER_GROEP_84.contains(
                        categorie) ? null : Parser.parseLo3IndicatieOnjuist(elementen, Lo3ElementEnum.ELEMENT_8410, categorie, lo3Onderzoek);
