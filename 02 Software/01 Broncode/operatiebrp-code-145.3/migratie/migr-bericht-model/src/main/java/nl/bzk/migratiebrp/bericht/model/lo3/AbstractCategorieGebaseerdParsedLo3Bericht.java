...
public abstract class AbstractCategorieGebaseerdParsedLo3Bericht extends AbstractParsedLo3Bericht {
     ...
     */
    protected AbstractCategorieGebaseerdParsedLo3Bericht(final Lo3Header header, final Lo3SyntaxControle syntaxControle, final String berichtType,
                                                         final String startCyclus) {
        super(header, syntaxControle, berichtType, startCyclus);
    }
    ...
    @Override
    protected final void parseCategorieen(final List<Lo3CategorieWaarde> lo3Categorieen) throws BerichtInhoudException {
    ...
    public final void set(final Lo3CategorieEnum categorie, final Lo3ElementEnum element, final String waarde) {
        ...
        Lo3CategorieWaardeUtil.setElementWaarde(categorieen, Lo3CategorieEnum.bepaalActueleCategorie(categorie), 0, categorie.isActueel() ? 0 : 1, element,
                waarde);
    }
    ...
    public final String get(final Lo3CategorieEnum categorie, final Lo3ElementEnum element) {
        return Lo3CategorieWaardeUtil.getElementWaarde(categorieen, Lo3CategorieEnum.bepaalActueleCategorie(categorie), 0, categorie.isActueel() ? 0 : 1,
                element);
    }
