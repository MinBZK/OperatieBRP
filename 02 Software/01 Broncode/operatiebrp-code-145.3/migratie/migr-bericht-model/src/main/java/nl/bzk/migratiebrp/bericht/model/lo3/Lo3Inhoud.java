...
public final class Lo3Inhoud {
     ...
     * @param input categorieen
     * @return een bericht
     */
    public static String formatInhoud(final List<Lo3CategorieWaarde> input) {
        return formatLo3Inhoud(converteerNaarLo3Inhoud(input));
    }

    /**
     * Converteer een lijst van lo3 categorie waarden naar een lijst van lo3 inhoud categorie.
     * @param input lijst van Lo3CategorieWaarde
     * @return lijst van Lo3InhoudCategorie
     */
    public static List<Lo3InhoudCategorie> converteerNaarLo3Inhoud(final List<Lo3CategorieWaarde> input) {
    ...
    /**
     * Formateert een lijst van Lo3 inhoud categorieën naar een Lo3 string.
     * @param categorieen lijst van Lo3InhoudCategorie
     * @return geformateerde Lo3 string
     */
    public static String formatLo3Inhoud(final List<Lo3InhoudCategorie> categorieen) {
        int size = categorieen.stream().mapToInt(categorie -> categorie.getBytes().length).sum();
     ...
     * @param inhoud de inhoud, mag niet null zijn en moet beginnen met de berichtlengte
    ...
    private static List<Lo3CategorieWaarde> verwerkBericht(final String inhoud) throws BerichtSyntaxException, Lo3SyntaxException {
        ...
        while (cursor < berichtLengte) {
            ...
            if (cat.isActueel()) {
                stapel++;
                voorkomen = 0;
                if (vorigeCategorie == null || Lo3CategorieEnum.bepaalActueleCategorie(cat) != Lo3CategorieEnum.bepaalActueleCategorie(vorigeCategorie)) {
                    stapel = 0;
                }
            }
