 ...
 * Tb02.
 */
public final class Tb02Bericht extends AbstractCategorieGebaseerdParsedLo3Bericht implements Lo3Bericht, Serializable {
    ...
    private static final Lo3Header HEADER = new Lo3Header(Lo3HeaderVeld.RANDOM_KEY, Lo3HeaderVeld.BERICHTNUMMER, Lo3HeaderVeld.HERHALING, Lo3HeaderVeld.AANTAL,
            Lo3HeaderVeld.IDENTIFICERENDE_RUBRIEKEN, Lo3HeaderVeld.AKTENUMMER);

    /**
     * Constructor.
     */
    public Tb02Bericht() {
        super(HEADER, Lo3SyntaxControle.STANDAARD, "Tb02", "uc309");
    }
}
