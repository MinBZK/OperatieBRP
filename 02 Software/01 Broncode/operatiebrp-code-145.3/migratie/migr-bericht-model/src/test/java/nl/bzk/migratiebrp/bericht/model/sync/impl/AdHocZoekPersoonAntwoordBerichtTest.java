 ...
 */
public class AdHocZoekPersoonAntwoordBerichtTest extends AbstractSyncBerichtTestBasis {
    ...
    public void testTypeFoutreden() throws Exception {
        final AdHocZoekPersoonAntwoordType type = new AdHocZoekPersoonAntwoordType();
        type.setFoutreden(AdHocZoekAntwoordFoutReden.H);

        final AdHocZoekPersoonAntwoordBericht bericht = new AdHocZoekPersoonAntwoordBericht(type);
        Assert.assertEquals("foutreden moet overeenkomen", AdHocZoekAntwoordFoutReden.H, bericht.getFoutreden());
