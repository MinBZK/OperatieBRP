...
<style><![CDATA[
		...
		<h3>A-nummer&#160;<xsl:value-of select="/*/identificatienummerStapel/*[last()]/inhoud/administratienummer/waarde | /*/persoonStapel/*[last()]/inhoud/aNummer/waarde"/></h3>
			...
			<xsl:choose>
				<xsl:when test="local-name()='relatie'">
					<table>
                        ...
                        <xsl:if test="ikBetrokkenheid">
                        <tr><td colspan="2">
                            <xsl:for-each select="ikBetrokkenheid">
                                <xsl:call-template name="process-stapel">
                                    <xsl:with-param name="stapelnummer">1</xsl:with-param>
                                </xsl:call-template>
                            </xsl:for-each>
						...
						<xsl:if test="istOuder1Stapel">
                        <tr><td colspan="2">
                            <xsl:for-each select="istOuder1Stapel">
                                <xsl:call-template name="process-stapel">
                                    <xsl:with-param name="stapelnummer">1</xsl:with-param>
                                </xsl:call-template>
                            </xsl:for-each>
                        ...
                        <xsl:if test="istOuder2Stapel">
                        <tr><td colspan="2">
                            <xsl:for-each select="istOuder2Stapel">
                                <xsl:call-template name="process-stapel">
                                    <xsl:with-param name="stapelnummer">1</xsl:with-param>
                                </xsl:call-template>
                            </xsl:for-each>
                        ...
                        <xsl:if test="istHuwelijkOfGpStapel">
                        <tr><td colspan="2">
                            <xsl:for-each select="istHuwelijkOfGpStapel">
                                <xsl:call-template name="process-stapel">
                                    <xsl:with-param name="stapelnummer">1</xsl:with-param>
                                </xsl:call-template>
                            </xsl:for-each>
                        ...
                        <xsl:if test="istKindStapel">
                        <tr><td colspan="2">
                            <xsl:for-each select="istKindStapel">
                                <xsl:call-template name="process-stapel">
                                    <xsl:with-param name="stapelnummer">1</xsl:with-param>
                                </xsl:call-template>
                            </xsl:for-each>
                        ...
                        <xsl:if test="istGezagsverhoudingStapel">
                        <tr><td colspan="2">
                            <xsl:for-each select="istGezagsverhoudingStapel">
                                <xsl:call-template name="process-stapel">
                                    <xsl:with-param name="stapelnummer">1</xsl:with-param>
                                </xsl:call-template>
                            </xsl:for-each>
				...
				<xsl:when test="local-name()='betrokkenheid' or local-name()='ikBetrokkenheid'">
					<table>
						<tr><td><xsl:value-of select="rol" /></td></tr>
						<tr><td>
							<xsl:for-each select="identificatienummerStapel|samengesteldeNaamStapel|geslachtsaanduidingStapel|geboorteStapel|ouderlijkGezagStapel|ouderStapel|identiteitStapel">
								<xsl:call-template name="process-stapel">
									<xsl:with-param name="stapelnummer">1</xsl:with-param>
								</xsl:call-template>
							</xsl:for-each>
                ...
                <xsl:when test="local-name()='persoonId'">
