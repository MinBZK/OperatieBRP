 ...
 */
public final class GbaBerichtSorteerder {

    private static final Logger LOG = LoggerFactory.getLogger();

    private GbaBerichtSorteerder() {
        // Niet instantieerbaar
    }

    /**
     * Sorteer het bericht.
     * @param bericht Het te sorteren bericht.
    ...
    private static final class Lo3Stapel {
        ...
        /**
         * Default constructor.
         * @param actueleCategorie De actuele categorie van de stapel.
         */
         ...
         * @param categorie De toe te voegen categorie.
         */
