...
public interface TestCasusFactory {
     ...
     * @param thema het thema waaruit getest wordt
     */
     ...
     * @param outputFolder de folder waar de output heen moet
     */
     ...
     * @param expectedFolder de folder met verwachte resultaten
     */
    void setExpectedFolder(File expectedFolder);

    /**
     * Zet de folder waar het thema staat.
     * @param themaFolder de folder van het thema
     */
