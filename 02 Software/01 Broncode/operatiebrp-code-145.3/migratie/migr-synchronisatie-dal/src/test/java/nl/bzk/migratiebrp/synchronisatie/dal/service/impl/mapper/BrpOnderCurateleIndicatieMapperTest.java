    ...
    public void testMapInhoud() {
        final PersoonIndicatieHistorie historie =
                new PersoonIndicatieHistorie(
                        new PersoonIndicatie(new Persoon(SoortPersoon.INGESCHREVENE), SoortIndicatie.ONDER_CURATELE),
                        true);

        final BrpOnderCurateleIndicatieInhoud result = mapper.mapInhoud(historie, brpOnderzoekMapper);
