...
public interface Sleutel {
     ...
     * @param sleuteldeel de waarde van het sleuteldeel/veld
     */
     ...
     * @param id het ID van bv een {@link nl.bzk.algemeenbrp.dal.domein.brp.entity.BRPActie}
     */
    void setId(final Long id);

    /**
     * Geeft het optionele ID veld van bv een
     * {@link nl.bzk.algemeenbrp.dal.domein.brp.entity.BRPActie} terug.
     * @return het ID van bv een {@link nl.bzk.algemeenbrp.dal.domein.brp.entity.BRPActie}
     */
    Long getId();
