...
public final class AanduidingInhoudingVermissingReisdocumentConversietabel extends AbstractAanduidingInhoudingVermissingReisdocumentConversietabel {
     ...
     * @param aanduidingen de lijst met AanduidingInhoudingVermissingReisdocument conversies
     */
    ...
    private static List<Map.Entry<Lo3AanduidingInhoudingVermissingNederlandsReisdocument, BrpAanduidingInhoudingOfVermissingReisdocumentCode>>
    converteerAanduidingen(final List<AanduidingInhoudingVermissingReisdocument> aanduidingen) {
