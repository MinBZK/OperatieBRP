...
public interface Lo3BerichtRepository {
     ...
     * @param administratienummer het administratienummer van het LO3 bronbericht wat tot deze Lo3Bericht heeft geleid
     * @return de laatst toegevoegde Lo3Bericht entiteit of null
     */
    Lo3Bericht findLaatsteLo3PersoonslijstBerichtVoorANummer(String administratienummer);

    /**
     * Zoekt de laatst toegevoegde anummers uit de Lo3Bericht welke met de datum tijd stempel tussen vanaf en tot zit.
     * @param vanaf De datum tijd stempel is groter dan of gelijk aan vanaf.
     * @param tot De datum tijd stempel is kleiner dan tot.
     * @return Set met anummers die voldoen aan de criteria.
     */
    Set<String> findLaatsteBerichtLogAnrs(final Date vanaf, final Date tot);

    /**
     * Slaat de meegegeven BerichtLog op in de database.
     * @param bericht de Lo3Bericht entiteit die moet worden opgeslagen in de database
