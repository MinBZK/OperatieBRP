 ...
 */
public abstract class AbstractNietIngeschrevenPersoonHistorieMapperStrategie<T extends BrpGroepInhoud, H extends FormeleHistorie>
        extends AbstractPersoonHistorieMapperStrategie<T, H> {
    /**
     ...
     */
    public AbstractNietIngeschrevenPersoonHistorieMapperStrategie(
     ...
     * @param persoon de persoon waarvoor onderzoek gemapped moet worden
     * @param groepInhoud de migratie groep met de bron gegevens
     * @param historie de historie entiteit waaraan onderzoek gegevens gekoppeld moeten worden
     */
    protected final void mapOnderzoek(final Persoon persoon, final T groepInhoud, final H historie) {
        if (persoon.getSoortPersoon().equals(SoortPersoon.INGESCHREVENE)) {
        ...
        } else if (persoon.getSoortPersoon().equals(SoortPersoon.PSEUDO_PERSOON)) {
            ...
            switch (relatie.getSoortRelatie()) {
                case FAMILIERECHTELIJKE_BETREKKING:
                    mapOnderzoekOuder(persoon, groepInhoud, historie);
                    break;
                case HUWELIJK:
    ...
    private void mapOnderzoekOuder(final Persoon persoon, final T groepInhoud, final H historie) {
