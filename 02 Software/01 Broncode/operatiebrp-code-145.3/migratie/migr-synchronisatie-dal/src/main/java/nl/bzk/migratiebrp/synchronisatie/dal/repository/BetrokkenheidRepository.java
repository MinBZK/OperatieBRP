...
public interface BetrokkenheidRepository {
     ...
     * @param betrokkenheid de betrokkenheid waarvan de historie moet worden verwijderd
     */
    void removeBetrokkenheidHistorie(final Betrokkenheid betrokkenheid);

    /**
     * Verwijdert de betrokkenheid inclusief zijn historie.
     * @param ouderBetrokkenheid de betrokkenheid die moet worden verwijderd
     */
     ...
     * @param doel de betrokkenheid waarnaar de gegevens moeten worden gekopieerd
     * @param bron de betrokkenheid vanwaar de gegevens worden gekopieerd
     */
