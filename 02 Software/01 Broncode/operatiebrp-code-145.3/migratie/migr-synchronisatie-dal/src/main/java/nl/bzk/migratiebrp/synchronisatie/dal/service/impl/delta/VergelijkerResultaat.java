...
public interface VergelijkerResultaat {
     ...
     */
    void voegToeOfVervangVerschil(Verschil verschil);
    ...
    /**
     * @param sleutel de sleutel
     * @return het verschil binnen dit resultaat waarvan de sleutel gelijk is aan de gegeven sleutel, als deze niet gevonden wordt dan wordt null geretourneerd
     */
     ...
     */
    Verschil zoekVerschil(Sleutel zoekSleutel, VerschilType verschiltype);
     ...
     */
    void koppelHerkomstAanActie(BRPActie oudeActie, Lo3Voorkomen nieuweHerkomst);
     ...
     */
    void koppelNieuweActieMetBestaandeActie(BRPActie nieuweActie, BRPActie opgeslagenActie);
     ...
     * @param veldnaam het veldnaam waar op gezocht moet worden, kan null zijn als het veldnaam niet ingevuld is bij het verscihl
     * @return de set van verschillen die een verschilType hebben die voldoen aan het verschilType dat meegegeven is en een sleutel heeft die voor een stapel
     * is.
     */
    Set<Verschil> getVerschillen(VerschilType verschilType, String veldnaam);

    /**
     * Geeft de verschillen terug die voldoen aan het meegegeven verschilType, veldnaam en sleuteltype.
     * @param verschilType verschilType dat het verschil moet bevatten.
     * @param isVoorkomenSleutel true als de sleutel van het verschil een sleutel voor een stapelvoorkomen moet zijn. false als de sleutel een sleutel voor een
     * stapel moet zijn
     * @param veldnaam het veldnaam waar op gezocht moet worden, kan null zijn als het veldnaam niet ingevuld is bij het verscihl
     * @return de set van verschillen die een verschilType hebben die voldoen aan het verschilType en sleuteltype dat meegegeven is.
     */
    Set<Verschil> getVerschillen(VerschilType verschilType, boolean isVoorkomenSleutel, String veldnaam);
     ...
     * @param bestaandEntiteit bestaand {@link Entiteit}
     * @param nieuweEntiteit nieuw {@link Entiteit}
     */
    void addDeltaEntiteitPaar(Entiteit bestaandEntiteit, Entiteit nieuweEntiteit);
    ...
    /**
     * Zoekt een of meerdere verschillen die voldoen aan de {@link EntiteitSleutel} maar waarbij de sleuteldelen worden
     * genegeerd.
    ...
    /**
     * @param persoon persoon waar voor de controle uitgevoerd moet worden.
     * @return true als er alleen verschillen zijn gedetecteerd die betrekking hebben op een a-nummer wijziging.
     * @throws ReflectiveOperationException als het veld uit de {@link Sleutel} niet gevonden kan worden
     */
    boolean bevatAlleenAnummerWijzigingen(Persoon persoon) throws ReflectiveOperationException;

    /**
     * Voegt een ander {@link VergelijkerResultaat} toe aan deze {@link VergelijkerResultaat}.
     * @param controleResultaat een ander {@link VergelijkerResultaat}
     */
    void addVergelijkerResultaat(VergelijkerResultaat controleResultaat);
}
