 ...
 */
@Component
public final class BrpBehandeldAlsNederlanderIndicatieMapper
        extends AbstractBrpMapper<PersoonIndicatieHistorie, BrpBehandeldAlsNederlanderIndicatieInhoud> {

    @Override
    protected BrpBehandeldAlsNederlanderIndicatieInhoud mapInhoud(final PersoonIndicatieHistorie historie, final BrpOnderzoekMapper brpOnderzoekMapper) {
        final BrpBoolean indicatie =
                BrpBoolean.wrap(
                        historie.getWaarde(),
                        brpOnderzoekMapper.bepaalOnderzoek(historie, Element.PERSOON_INDICATIE_BEHANDELDALSNEDERLANDER_WAARDE, true));
        ...
        return new BrpBehandeldAlsNederlanderIndicatieInhoud(indicatie, migratieRedenOpnameNationaliteit, migratieRedenBeeindigingNationaliteit);
    }
