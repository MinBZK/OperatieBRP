 ...
 */
public class GbaVrijeBerichtenAntwoordKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaVrijeBerichtenAntwoord";

    /**
     * Constructor.
     */
    public GbaVrijeBerichtenAntwoordKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaVrijeBerichtenAntwoordQueue")
