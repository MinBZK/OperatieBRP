 ...
 */
public final class CheckSqlBrpKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "check_sql_brp";

    /**
     * Constructor.
     */
    public CheckSqlBrpKanaal() {
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            sqlHelper.checkSql(bericht.getBerichtReferentie(), brpDataSource, bericht.getInhoud());
        }
    }
}
