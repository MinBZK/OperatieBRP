 ...
 */
public class GbaVrijeBerichtenDlqKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public GbaVrijeBerichtenDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaVrijeBerichtenDlqQueue")
        private Destination destination;

        @Override
        public String getKanaal() {
            return "gbaVrijeBerichtenDlq";
        }
