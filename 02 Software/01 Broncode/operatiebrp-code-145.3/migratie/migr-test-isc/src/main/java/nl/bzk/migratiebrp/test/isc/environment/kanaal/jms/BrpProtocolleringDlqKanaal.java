...
/**
 * Kanaal om berichten te lezen: BRP Protocollering DLQ.
 */
public class BrpProtocolleringDlqKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "brpProtocolleringDlq";

    /**
     * Constructor.
     */
    public BrpProtocolleringDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        @Inject
        @Named("brpProtocolleringDlqQueue")
