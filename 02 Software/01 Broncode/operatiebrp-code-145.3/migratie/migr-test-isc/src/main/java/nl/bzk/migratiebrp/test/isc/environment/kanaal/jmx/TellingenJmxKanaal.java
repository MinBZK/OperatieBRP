 ...
 * BRP JMX Kanaal.
 */
public final class TellingenJmxKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public TellingenJmxKanaal() {
        super(new Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-jmx-tellingen.xml"));
    }
