...
/**
 */
public class GbaAdhocAdresvraagDlqKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaAdhocAdresvraag_dlq";

    /**
     * Constructor.
     */
    public GbaAdhocAdresvraagDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaAdhocAdresvraagDlqQueue")
