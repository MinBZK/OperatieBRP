...
/**
 */
public class GbaAdhocAdresvraagAntwoordDlqKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaAdhocAdresvraagAntwoord_dlq";

    /**
     * Constructor.
     */
    public GbaAdhocAdresvraagAntwoordDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaAdhocAdresvraagAntwoordDlqQueue")
