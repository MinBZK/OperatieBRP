...
/**
 */
public class GbaAdhocAdresvraagAntwoordKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaAdhocAdresvraagAntwoord";

    /**
     * Constructor.
     */
    public GbaAdhocAdresvraagAntwoordKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaAdhocAdresvraagAntwoordQueue")
