 ...
 */
public class GbaVrijeBerichtenAntwoordDlqKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public GbaVrijeBerichtenAntwoordDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaVrijeBerichtenAntwoordDlqQueue")
        private Destination destination;

        @Override
        public String getKanaal() {
            return "gbaVrijeBerichtenAntwoordDlq";
        }

        @Override
        protected String getCorrelatieIdentifier() {
            return GbaVrijeBerichtenKanaal.KANAAL;
        }
