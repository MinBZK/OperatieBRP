 ...
 * SQL BRP kanaal.
 */
public final class SqlBrpArchiveringKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "sql_brp_archivering";

    /**
     * Constructor.
     */
    public SqlBrpArchiveringKanaal() {
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            sqlHelper.uitvoerenSql(brpArchieveringDataSource, bericht.getInhoud(), false);
        }
    }
}
