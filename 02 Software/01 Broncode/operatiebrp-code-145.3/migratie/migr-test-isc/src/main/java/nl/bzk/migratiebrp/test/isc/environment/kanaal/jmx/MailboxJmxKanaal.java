 ...
 * BRP JMX Kanaal.
 */
public final class MailboxJmxKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public MailboxJmxKanaal() {
        super(new Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-jmx-mailbox.xml"));
    }
