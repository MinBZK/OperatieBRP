 ...
 */
public class GbaVrijeBerichtenKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaVrijeBerichten";

    /**
     * Constructor.
     */
    public GbaVrijeBerichtenKanaal() {
