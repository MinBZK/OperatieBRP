...
/**
 * Check SQL GBAV kanaal.
 */
public final class CheckSqlGbavKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "check_sql_gbav";

    /**
     * Constructor.
     */
    public CheckSqlGbavKanaal() {
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            sqlHelper.checkSql(bericht.getBerichtReferentie(), gbavDataSource, bericht.getInhoud());
        }
    }
}
