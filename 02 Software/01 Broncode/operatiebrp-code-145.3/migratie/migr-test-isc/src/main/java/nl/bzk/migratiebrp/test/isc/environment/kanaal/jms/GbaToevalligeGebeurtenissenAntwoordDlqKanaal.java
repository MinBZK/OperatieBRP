...
/**
 * Kanaal om berichten te lezen: Gba Toevallige Gebeurtenissen antwoord DLQ.
 */
public class GbaToevalligeGebeurtenissenAntwoordDlqKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public GbaToevalligeGebeurtenissenAntwoordDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaToevalligeGebeurtenissenAntwoordDlqQueue")
        private Destination destination;

        @Override
        public String getKanaal() {
            return "gbaToevalligeGebeurtenissenAntwoordDlq";
        }
