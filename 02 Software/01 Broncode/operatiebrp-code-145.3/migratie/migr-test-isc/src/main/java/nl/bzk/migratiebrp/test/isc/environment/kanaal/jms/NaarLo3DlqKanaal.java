 ...
 */
public class NaarLo3DlqKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "naarlo3_dlq";
     ...
     * Constructor.
     */
    public NaarLo3DlqKanaal() {
        super(new NaarLo3DlqKanaal.Worker(),
