...
/**
 */
public class GbaAdhocPersoonsvraagKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaAdhocPersoonsvraag";

    /**
     * Constructor.
     */
    public GbaAdhocPersoonsvraagKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaAdhocPersoonsvraagQueue")
