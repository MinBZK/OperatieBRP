...
/**
 * Kanaal om berichten te lezen en te schrijven op de BRP queue: gbaBijhouding.
 */
public class BrpProtocolleringKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "brpProtocollering";

    /**
     * Constructor.
     */
    public BrpProtocolleringKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        protected String getCorrelatieIdentifier() {
            return BrpProtocolleringKanaal.KANAAL;
        }
