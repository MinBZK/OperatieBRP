...
/**
 */
public class GbaAdhocPersoonsvraagAntwoordKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaAdhocPersoonsvraagAntwoord";

    /**
     * Constructor.
     */
    public GbaAdhocPersoonsvraagAntwoordKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaAdhocPersoonsvraagAntwoordQueue")
