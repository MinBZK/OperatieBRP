 ...
 * BRP JMX Kanaal.
 */
public final class HornetQJmxKanaal extends LazyLoadingKanaal {

    /**
     * Constructor.
     */
    public HornetQJmxKanaal() {
        super(new Worker(), new Configuration("classpath:configuratie.xml", "classpath:infra-jmx-hornetq.xml"));
    }
