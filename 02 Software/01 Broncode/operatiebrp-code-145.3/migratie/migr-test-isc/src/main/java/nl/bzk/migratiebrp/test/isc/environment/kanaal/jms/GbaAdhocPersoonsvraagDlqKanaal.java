...
/**
 */
public class GbaAdhocPersoonsvraagDlqKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "gbaAdhocPersoonsvraag_dlq";

    /**
     * Constructor.
     */
    public GbaAdhocPersoonsvraagDlqKanaal() {
    ...
    public static final class Worker extends AbstractQueueKanaal {
        ...
        @Inject
        @Named("gbaAdhocPersoonsvraagDlqQueue")
