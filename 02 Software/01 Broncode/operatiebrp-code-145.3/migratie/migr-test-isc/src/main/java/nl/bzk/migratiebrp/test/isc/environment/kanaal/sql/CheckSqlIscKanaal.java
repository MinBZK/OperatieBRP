...
/**
 * Check SQL ISC kanaal.
 */
public final class CheckSqlIscKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "check_sql_isc";

    /**
     * Constructor.
     */
    public CheckSqlIscKanaal() {
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            sqlHelper.checkSql(bericht.getBerichtReferentie(), iscDataSource, bericht.getInhoud());
        }
    }
}
