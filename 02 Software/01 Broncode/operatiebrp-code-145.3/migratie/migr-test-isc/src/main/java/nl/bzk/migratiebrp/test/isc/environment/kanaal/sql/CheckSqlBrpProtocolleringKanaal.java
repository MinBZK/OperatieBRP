...
/**
 * Check SQL BRP Protocollering kanaal.
 */
public final class CheckSqlBrpProtocolleringKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "check_sql_brp_protocollering";

    /**
     * Constructor.
     */
    public CheckSqlBrpProtocolleringKanaal() {
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            sqlHelper.checkSql(bericht.getBerichtReferentie(), brpProtocolleringDataSource, bericht.getInhoud());
        }
    }
}
