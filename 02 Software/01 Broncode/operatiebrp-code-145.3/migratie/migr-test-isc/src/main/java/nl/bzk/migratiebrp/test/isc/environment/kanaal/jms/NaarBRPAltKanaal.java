 ...
 */
public final class NaarBRPAltKanaal extends LazyLoadingKanaal {

    /**
     * Kanaal naam.
     */
    public static final String KANAAL = "naarbrp_alt";
    ...
    public static final class Worker extends AbstractKanaal {
        ...
        public Bericht verwerkInkomend(final TestCasusContext testCasus, final Bericht verwachtBericht) throws KanaalException {
            ...
            if (verwachtBericht.getCorrelatieReferentie() != null) {
                correlator.controleerUitgaand(verwachtBericht.getCorrelatieReferentie(), NaarBRPAltKanaal.KANAAL);
            ...
            if (message == null) {
                ...
                correlator.registreerInkomend(verwachtBericht.getBerichtReferentie(), NaarBRPAltKanaal.KANAAL, ontvangenBericht.getBerichtReferentie());
        ...
        public void verwerkUitgaand(final TestCasusContext testCasus, final Bericht bericht) throws KanaalException {
            ...
            correlator.registreerUitgaand(bericht.getBerichtReferentie(), NaarBRPAltKanaal.KANAAL, berichtReferentie);
