...
DELETE FROM kern.srtvrijber WHERE naam = 'Zoort' OR naam = 'Soort vrijber morgen geldig' OR naam =  'Soort vrijber niet meer geldig';
...
('Soort vrijber niet meer geldig', 20160101, (SELECT to_number(to_char(current_date, 'YYYYMMDD'), '99999999')));
...
-- update Partij BRP voorziening omdat oin en autorisatie voor Vrij bericht ontbreekt
UPDATE kern.partij SET oin = '199903', datovergangnaarbrp='20160101', datingangvrijber = '20160101', indagvrijber=true, afleverpuntvrijber='ergens' WHERE code='199903';

-- delete alle verzonden en ingekomen berichten
