...
delete from autaut.his_bijhautorisatie where bijhautorisatie = (select id from autaut.bijhautorisatie where naam='gbaEindeGP');
delete from autaut.bijhautorisatie where naam ='gbaEindeGP';

INSERT INTO autaut.bijhautorisatie(id, indmodelautorisatie, naam, datingang, dateinde, indblok) 
	VALUES (2, false, 'gbaEindeGP', 20010101, null, null);
INSERT INTO autaut.his_bijhautorisatie(id, bijhautorisatie, tsreg, tsverval, naam, datingang, dateinde, indblok) 
	VALUES (2, 2, now(), null, 'gbaEindeGP', 20010101, null, null);

INSERT INTO autaut.bijhautorisatiesrtadmhnd (id,bijhautorisatie,srtadmhnd) 
	VALUES (2, 2,(select id from kern.srtadmhnd where naam = 'GBA - Beëindiging geregistreerd partnerschap in Nederland'));
