...
delete from autaut.his_bijhautorisatie where bijhautorisatie = (select id from autaut.bijhautorisatie where naam='gbaScheiding');
delete from autaut.bijhautorisatie where naam ='gbaScheiding';

INSERT INTO autaut.bijhautorisatie(id, indmodelautorisatie, naam, datingang, dateinde, indblok) 
	VALUES (2, false, 'gbaScheiding', 20010101, 20020202, null);
INSERT INTO autaut.his_bijhautorisatie(id, bijhautorisatie, tsreg, tsverval, naam, datingang, dateinde, indblok) 
	VALUES (2, 2, now(), null, 'gbaScheiding', 20010101, 20020202, null);

INSERT INTO autaut.bijhautorisatiesrtadmhnd (id,bijhautorisatie,srtadmhnd) 
	VALUES (2, 2,(select id from kern.srtadmhnd where naam = 'GBA - Ontbinding huwelijk in Nederland'));
