...
delete from autaut.his_bijhautorisatie where bijhautorisatie = (select id from autaut.bijhautorisatie where naam='gbaAangaanGP');
delete from autaut.bijhautorisatie where naam ='gbaAangaanGP';

INSERT INTO autaut.bijhautorisatie(id, indmodelautorisatie, naam, datingang, dateinde, indblok) 
	VALUES (2, false, 'gbaAangaanGP', 20010101, null, null);
INSERT INTO autaut.his_bijhautorisatie(id, bijhautorisatie, tsreg, tsverval, naam, datingang, dateinde, indblok) 
	VALUES (2, 2, now(), null, 'gbaAangaanGP', 20010101, null, null);

INSERT INTO autaut.bijhautorisatiesrtadmhnd (id,bijhautorisatie,srtadmhnd) 
	VALUES (2, 2,(select id from kern.srtadmhnd where naam = 'GBA - Aangaan geregistreerd partnerschap in Nederland'));
...
INSERT INTO autaut.toegangbijhautorisatie (id,bijhautorisatie, geautoriseerde, ondertekenaar, transporteur, datingang, dateinde, indblok) 
	VALUES (2,2, (select id from kern.partijrol where partij = (select id from kern.partij where code='051801') and rol='2'), 2000,2000, 20000101, 20210828, null);
