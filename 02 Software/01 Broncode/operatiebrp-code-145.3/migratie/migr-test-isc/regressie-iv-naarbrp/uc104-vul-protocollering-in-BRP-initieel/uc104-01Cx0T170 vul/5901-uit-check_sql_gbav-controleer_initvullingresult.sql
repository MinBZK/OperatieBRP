...
AND pers_id=(SELECT id FROM kern.pers WHERE anr='6329029409')
AND bijhouding_opschort_reden IS NULL
AND toeganglevsautorisatie_id=(SELECT id FROM autaut.toeganglevsautorisatie WHERE levsautorisatie=(SELECT id FROM autaut.levsautorisatie WHERE naam='510248' AND datingang='20130101' AND dateinde='20140101'))
