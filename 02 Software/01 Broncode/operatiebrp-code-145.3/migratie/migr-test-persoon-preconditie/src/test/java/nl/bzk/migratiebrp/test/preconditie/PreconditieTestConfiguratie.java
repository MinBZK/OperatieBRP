...
public abstract class PreconditieTestConfiguratie extends TestConfiguratie {
    ...
    public TestCasusFactory getCasusFactory() {
        ...
        LOG.info("Returning new preconditie test casus factory...");
        return new PreconditieTestCasusFactory(context);
    }
}
