...
public class ReleaseIT extends AbstractIT {
    ...
    public void testSynchronisatie() throws InterruptedException, JMSException {
        ...
        verstuurBerichtViaMailbox("MSG-1", null, "0626010", "3000200", lg01);

        LOGGER.info("Controleren aantal personen in BRP ...");
        try {
            new Herhaal(1000, 30, Strategie.REGELMATIG).herhaal(() -> {
        ...
        final String archief = getContent(expectBrpMessage("GbaArchiveringQueue"));
