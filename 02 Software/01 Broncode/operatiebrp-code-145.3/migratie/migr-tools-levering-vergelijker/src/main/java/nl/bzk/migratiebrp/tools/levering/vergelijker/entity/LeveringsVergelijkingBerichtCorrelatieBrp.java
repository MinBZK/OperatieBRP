 ...
 */
@Entity
@Table(name = "mig_leveringsvergelijking_berichtcorrelatie_brp", schema = "public")
public class LeveringsVergelijkingBerichtCorrelatieBrp {
    ...
    @Column(name = "bijhouding_ber_eref", nullable = false)
    private Long bijhoudingBerichtMessageId;
    ...
    public Long getBijhoudingBerichtMessageId() {
        return bijhoudingBerichtMessageId;
    }
