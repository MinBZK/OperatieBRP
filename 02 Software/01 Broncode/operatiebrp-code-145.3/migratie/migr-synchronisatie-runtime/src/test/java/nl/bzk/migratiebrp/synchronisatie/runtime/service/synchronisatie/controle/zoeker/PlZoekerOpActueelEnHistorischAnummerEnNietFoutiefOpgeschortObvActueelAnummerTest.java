...
public class PlZoekerOpActueelEnHistorischAnummerEnNietFoutiefOpgeschortObvActueelAnummerTest {

    @Mock
    private PlService plService;

    @InjectMocks
    private PlZoekerOpActueelEnHistorischAnummerEnNietFoutiefOpgeschortObvActueelAnummer subject;
    ...
    public void test() {
        ...
        final BrpPersoonslijst dbPersoonslijst1 = maakPl("1111", "2222");
        ...
        Mockito.when(plService.zoekNietFoutievePersoonslijstOpActueelAnummer("1111")).thenReturn(dbPersoonslijst1);
        Mockito.when(plService.zoekNietFoutievePersoonslijstenOpHistorischAnummer("1111")).thenReturn(lijst2);
        ...
        Mockito.verify(plService).zoekNietFoutievePersoonslijstOpActueelAnummer("1111");
        Mockito.verify(plService).zoekNietFoutievePersoonslijstenOpHistorischAnummer("1111");
        ...
        Assert.assertEquals(4, cachedResultaat.size());
