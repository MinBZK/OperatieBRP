...
/**
 * Test voor de MessagCreator AdHoc Zoeken naar BRP
 */
@RunWith(MockitoJUnitRunner.class)
public class AdHocZoekenNaarBrpMessageCreatorTest {
    ...
    public void testAanmaakMessage() throws Exception {
        ...
        final AdHocZoekenNaarBrpMessageCreator creator = new AdHocZoekenNaarBrpMessageCreator(vraag, "verzoek");
