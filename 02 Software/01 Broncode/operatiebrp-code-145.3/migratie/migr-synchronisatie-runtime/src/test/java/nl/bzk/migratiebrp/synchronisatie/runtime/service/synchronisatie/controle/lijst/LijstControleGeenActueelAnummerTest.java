...
public class LijstControleGeenActueelAnummerTest {

    private LijstControleGeenActueelAnummer subject = new LijstControleGeenActueelAnummer();
    ...
    public void test() {
        ...
        Assert.assertFalse(subject.controleer(Collections.singletonList(maakPl(1))));
