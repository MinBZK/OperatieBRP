...
public class SynchronisatieVerwerkerIT extends AbstractSynchronisatieServiceIT {
    ...
    public void testRegulierToevoegen() throws Exception {
        ...
        verzoek.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3Persoonslijst)));
        verzoek.setVerzendendeGemeente("051801");
    ...
    public void testRegulierWijzigen() throws Exception {
        ...
        verzoek.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3PersoonslijstNieuw)));
        verzoek.setVerzendendeGemeente("051801");
        final SynchroniseerNaarBrpAntwoordBericht antwoord = subject.verwerkBericht(verzoek);
        ...
        Assert.assertEquals(verzoek.getMessageId(), antwoord.getCorrelationId());
        Assert.assertEquals(StatusType.VORIGE_HANDELINGEN_NIET_GELEVERD, antwoord.getStatus());

        // Update levering zodat de status overeenkomt met geleverd.
        final List<AdministratieveHandeling> nietGeleverdeAdministratieveHandelingen = zoekNietGeleverdeAdministratieveHandelingen();
        ...
        verzoek.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3PersoonslijstNieuw)));
        verzoek.setVerzendendeGemeente("051801");
        final SynchroniseerNaarBrpAntwoordBericht antwoord2 = subject.verwerkBericht(verzoek);

        // Verify
        System.out.println("\n\ntestRegulierWijzigen.melding:\n" + antwoord2.getMelding() + "\n\n");
        Assert.assertEquals(verzoek.getMessageId(), antwoord2.getCorrelationId());
    ...
    public void testRegulierVerhuizen() throws Exception {
        ...
        verzoek.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3PersoonslijstNieuw)));
        verzoek.setVerzendendeGemeente("059901");
        final SynchroniseerNaarBrpAntwoordBericht antwoord = subject.verwerkBericht(verzoek);
    ...
    public void testBeheerderNieuw() throws Exception {
        ...
        verzoek1.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3Persoonslijst)));
        verzoek1.setVerzendendeGemeente("051801");
        ...
        verzoek2.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3Persoonslijst)));
        verzoek2.setBeheerderKeuze(BeheerdersKeuzeType.TOEVOEGEN, null, null);
        verzoek2.setVerzendendeGemeente("051801");
    ...
    public void testBeheerderVervangen() throws Exception {
        ...
        verzoek1.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3PersoonslijstNieuw)));
        verzoek1.setVerzendendeGemeente("051801");
        final SynchroniseerNaarBrpAntwoordBericht antwoord1 = subject.verwerkBericht(verzoek1);
        ...
        final Long teVervangenPersoonId = result1.getPersoonId();
        ...
        verzoek2.setLo3PersoonslijstAlsTeletexString(Lo3Inhoud.formatInhoud(new Lo3PersoonslijstFormatter().format(lo3PersoonslijstNieuw)));
        verzoek2.setBeheerderKeuze(BeheerdersKeuzeType.VERVANGEN, teVervangenPersoonId, null);
        verzoek2.setVerzendendeGemeente("051801");
        SynchroniseerNaarBrpAntwoordBericht antwoord2 = subject.verwerkBericht(verzoek2);

        // Verify
        Assert.assertEquals(verzoek2.getMessageId(), antwoord2.getCorrelationId());
        Assert.assertEquals(StatusType.VORIGE_HANDELINGEN_NIET_GELEVERD, antwoord2.getStatus());
        ...
        antwoord2 = subject.verwerkBericht(verzoek2);
    ...
    private void vergelijkPersoonslijsten(final Lo3Persoonslijst lo3, final BrpPersoonslijst brp) {
        assertLo3BrpEquals(
                lo3.getInschrijvingStapel().getLo3ActueelVoorkomen().getInhoud().getVersienummer(),
                brp.getInschrijvingStapel().getActueel().getInhoud().getVersienummer());
