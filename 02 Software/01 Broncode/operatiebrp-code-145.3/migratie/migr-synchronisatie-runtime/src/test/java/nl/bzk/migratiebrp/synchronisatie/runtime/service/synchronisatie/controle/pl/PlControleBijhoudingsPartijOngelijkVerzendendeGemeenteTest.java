 ...
 * Test controle.
 */
public class PlControleBijhoudingsPartijOngelijkVerzendendeGemeenteTest {

    private PlControleBijhoudingsPartijOngelijkVerzendendeGemeente subject;

    @Before
    public void setup() {
        SynchronisatieLogging.init();
        subject = new PlControleBijhoudingsPartijOngelijkVerzendendeGemeente();
    }

    @Test
    public void testGelijk() {
        Assert.assertTrue(subject.controleer(new VerwerkingsContext(null, null, null, maakPl("051601", false), new BrpPartijCode("059901")), null));
    }

    @Test
    public void testOngelijk() {
        Assert.assertFalse(subject.controleer(new VerwerkingsContext(null, null, null, maakPl("051601", false), new BrpPartijCode("051601")), null));
    }
