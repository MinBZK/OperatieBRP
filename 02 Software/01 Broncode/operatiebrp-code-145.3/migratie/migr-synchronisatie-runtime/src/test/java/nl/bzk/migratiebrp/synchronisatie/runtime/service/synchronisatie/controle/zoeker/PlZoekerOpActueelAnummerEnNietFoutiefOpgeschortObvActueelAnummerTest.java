...
public class PlZoekerOpActueelAnummerEnNietFoutiefOpgeschortObvActueelAnummerTest {

    @Mock
    private PlService plService;

    private PlZoekerOpActueelAnummerEnNietFoutiefOpgeschortObvActueelAnummer subject;

    @Before
    public void setupLogging() {
        SynchronisatieLogging.init();
        subject = new PlZoekerOpActueelAnummerEnNietFoutiefOpgeschortObvActueelAnummer(plService);
    }
    ...
    public void testGevonden() {
        ...
        Mockito.when(plService.zoekNietFoutievePersoonslijstOpActueelAnummer("1111")).thenReturn(dbPersoonslijst);
    ...
    public void testNietGevonden() {
        ...
        Mockito.when(plService.zoekNietFoutievePersoonslijstOpActueelAnummer("1111")).thenReturn(null);
