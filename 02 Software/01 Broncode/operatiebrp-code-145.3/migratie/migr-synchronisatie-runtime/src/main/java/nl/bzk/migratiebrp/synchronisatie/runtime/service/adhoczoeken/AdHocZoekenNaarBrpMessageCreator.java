...
/**
 * MessagCreator voor versturen AdHoc zoek vraag.
 */
public class AdHocZoekenNaarBrpMessageCreator implements MessageCreator {

    private static final Logger LOG = LoggerFactory.getLogger();

    private final Basisvraag opdracht;
     ...
     */
    public AdHocZoekenNaarBrpMessageCreator(final Basisvraag opdracht, final String verzoekBerichtId) {
