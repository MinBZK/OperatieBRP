 ...
 */
public final class LijstControleGeenBurgerServicenummer implements LijstControle {

    @Override
    public boolean controleer(final List<BrpPersoonslijst> lijst) {
        final ControleLogging logging = new ControleLogging(ControleMelding.LIJST_CONTROLE_GEEN_BSN);
