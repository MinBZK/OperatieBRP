 ...
 */
public final class LijstControleEenActueelAnummer implements LijstControle {

    @Override
    public boolean controleer(final List<BrpPersoonslijst> lijst) {
        final ControleLogging logging = new ControleLogging(ControleMelding.LIJST_CONTROLE_EEN_ACTUEEL_ANR);
