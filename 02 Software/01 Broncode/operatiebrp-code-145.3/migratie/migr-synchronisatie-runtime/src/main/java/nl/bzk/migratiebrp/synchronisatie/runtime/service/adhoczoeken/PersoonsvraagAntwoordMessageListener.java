 ...
 */
public class PersoonsvraagAntwoordMessageListener implements MessageListener {
     ...
     */
    @Inject
    public PersoonsvraagAntwoordMessageListener(final AdHocZoekenNaarIscVerzender verzender) {
    ...
    public void onMessage(final Message message) {
        try {
            ...
            final Persoonsantwoord vertaaldBericht = JsonMapper.reader().forType(Persoonsantwoord.class).readValue(berichtInhoud);
            final AdHocZoekPersoonAntwoordBericht resultaat = verwerkAntwoord(vertaaldBericht, correlatieReferentie);
    ...
    private AdHocZoekPersoonAntwoordBericht verwerkAntwoord(Persoonsantwoord antwoord, String correlatieReferentie) {
        LOG.info("Verwerken antwoord");
        final AdHocZoekPersoonAntwoordBericht resultaat = new AdHocZoekPersoonAntwoordBericht();
