 ...
 */
public final class PlZoekerOpActueelEnHistorischVorigeAnummerEnNietFoutiefOpgeschortObvActueelAnummer implements PlZoeker {
     ...
     */
    public PlZoekerOpActueelEnHistorischVorigeAnummerEnNietFoutiefOpgeschortObvActueelAnummer(final PlService plService) {
    ...
    public List<BrpPersoonslijst> zoek(final VerwerkingsContext context) {
        ...
        if (context.bevatResultaatVoor(resultaatIdentifier)) {
            ...
            final List<BrpPersoonslijst> actueel = plService.zoekNietFoutievePersoonslijstenOpActueelVorigeAnummer(aNummer);
            final List<BrpPersoonslijst> historisch = plService.zoekNietFoutievePersoonslijstenOpHistorischVorigeAnummer(aNummer);
    ...
    private Identifier maakResultaatIdentifier(final String aNummer) {
        return new Identifier("PlZoekerOpActueelEnHistorischVorigAnummerEnNietFoutiefOpgeschortObvActueelAnummer", aNummer);
    }
}
