...
import nl.bzk.migratiebrp.synchronisatie.runtime.service.synchronisatie.controle.zoeker.PlZoekerOpActueelEnHistorischBurgerServicenummerEnNietFoutiefOpgeschortObvActueelBurgerServicenummer;
 ...
 * </ol>
 */
@Component(value = "controleReguliereWijziging")
public final class ControleReguliereWijziging implements Controle {
     ...
     */
    @Inject
    public ControleReguliereWijziging(final PlService plService, final BrpDalService brpDalService){
        ...
        this.plControleGevondenVersienummerKleiner = new PlControleGevondenVersienummerKleiner();
    ...
    public boolean controleer(final VerwerkingsContext context) {
        final ControleLogging logging = new ControleLogging(ControleMelding.CONTROLE_REGULIERE_WIJZIGING);
