...
import nl.bzk.migratiebrp.synchronisatie.runtime.service.synchronisatie.controle.pl.PlControleAangebodenAdressenGelijk;
import nl.bzk.migratiebrp.synchronisatie.runtime.service.synchronisatie.controle.pl.PlControleActueelBsnGelijk;
import nl.bzk.migratiebrp.synchronisatie.runtime.service.synchronisatie.controle.pl.PlControleBijhoudingsPartijGelijkRni;
...
/**
 * <p>
 * Samengestelde controle 'Emigratie'.
 * </p>
 * Er is sprake van emigratie als:
 * <ol>
 ...
 * <li>de gemeente van bijhouding van de aangeboden persoonslijst gelijk is aan ‘199901’, en</li>
 ...
 * persoonslijst, en</li>
 * <li>de gevonden persoonslijst in de BRP een adres en een historie van adressen heeft dat gelijk is aan adres en
 * historie van adressen op de aangeboden persoonslijst, en</li>
 ...
 * </ol>
 */
@Component(value = "controleEmigratie")
public final class ControleEmigratie implements Controle {
    ...
    private final PlControle plControleBijhoudingsPartijGelijkRni;
    ...
    private final PlControle plControleAangebodenAdressenGelijk;
     ...
     */
    @Inject
    public ControleEmigratie(final PlService plService, final BrpDalService brpDalService) {
        ...
        this.plControleBijhoudingsPartijGelijkRni = new PlControleBijhoudingsPartijGelijkRni();
        ...
        this.plControleAangebodenAdressenGelijk = new PlControleAangebodenAdressenGelijk();
    ...
    public boolean controleer(final VerwerkingsContext context) {
        final ControleLogging logging = new ControleLogging(ControleMelding.CONTROLE_EMIGRATIE);
        ...
        if (lijstControleEen.controleer(dbPersoonslijstenOpAnummer)) {
            ...
            result = result && plControleBijhoudingsPartijGelijkRni.controleer(context, dbPersoonslijst);
            ...
            result = result && plControleAangebodenAdressenGelijk.controleer(context, dbPersoonslijst);
