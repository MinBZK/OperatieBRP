...
/**
 * Controle dat bijhoudingspartij op aangeboden persoonslijst gelijk is aan de verzendende partij.
 */
public final class PlControleBijhoudingsPartijGelijkVerzendendeGemeente implements PlControle {
    ...
    public boolean controleer(final VerwerkingsContext context, final BrpPersoonslijst dbPersoonslijst) {
        ...
        final ControleLogging logging = new ControleLogging(ControleMelding.PL_CONTROLE_BIJHOUDINGSPARTIJ_GELIJK_AAN_VERZENDER);

        // Bijhoudingspartij aangeboden persoonslijst
