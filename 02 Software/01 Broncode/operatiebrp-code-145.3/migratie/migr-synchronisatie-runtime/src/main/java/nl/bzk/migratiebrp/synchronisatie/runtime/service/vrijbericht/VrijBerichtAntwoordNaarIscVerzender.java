 ...
 */
@Component
class VrijBerichtAntwoordNaarIscVerzender {
     ...
     */
    @Inject
    VrijBerichtAntwoordNaarIscVerzender(@Named("queueJmsTemplate") final JmsTemplate jmsTemplate,
     ...
     */
    void verstuurVrijBerichtAntwoord(final Bericht bericht) {
        jmsTemplate.send(destination, new VrijBerichtAntwoordNaarIscMessageCreator(bericht));
    }
}
