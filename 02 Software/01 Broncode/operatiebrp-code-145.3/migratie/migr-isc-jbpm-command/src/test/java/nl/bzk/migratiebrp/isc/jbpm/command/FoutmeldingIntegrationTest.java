...
public class FoutmeldingIntegrationTest extends AbstractIntegrationTestBasis {
    ...
    public void test() throws CommandException {
        ...
        final Long processInstanceId = jbpmInvoker.executeInContext(jbpmContext -> {
        ...
        // Signal
        final Long taskId = jbpmInvoker.executeInContext(jbpmContext -> {
            final ProcessInstance processInstance = jbpmContext.loadProcessInstance(processInstanceId);
        ...
        // Verwerk taak
        final Map<String, Serializable> taakVariabelenGewijzigd = new HashMap<>();
