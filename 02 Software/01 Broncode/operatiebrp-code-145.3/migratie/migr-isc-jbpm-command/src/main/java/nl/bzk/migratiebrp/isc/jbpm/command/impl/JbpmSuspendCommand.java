 ...
 */
public final class JbpmSuspendCommand implements Command<Void> {
    ...
    public Void doInContext(final JbpmContext jbpmContext) {
        ...
        processInstance.getLoggingInstance().addLog(new MessageLog("Beheerder heeft 'opschorten' uitgevoerd."));

        suspendProcessInstance(jbpmContext, processInstance);

        return null;
    }

    private void suspendProcessInstance(final JbpmContext context, final ProcessInstance processInstance) {
        ...
        for (final Token token : tokens) {
            ...
            if (subProcessInstance != null) {
                suspendProcessInstance(context, subProcessInstance);
            }
        }
