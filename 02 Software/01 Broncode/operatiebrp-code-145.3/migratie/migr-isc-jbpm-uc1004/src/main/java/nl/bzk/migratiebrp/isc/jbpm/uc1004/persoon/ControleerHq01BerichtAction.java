...
/**
 * Controleer Hq01 bericht op juistheid.
 */
@Component("uc1004ControleerHq01BerichtAction")
public class ControleerHq01BerichtAction implements SpringAction {
     ...
     */
    @Inject
    public ControleerHq01BerichtAction(final BerichtenDao berichtenDao, final PartijService partijRegisterService) {
