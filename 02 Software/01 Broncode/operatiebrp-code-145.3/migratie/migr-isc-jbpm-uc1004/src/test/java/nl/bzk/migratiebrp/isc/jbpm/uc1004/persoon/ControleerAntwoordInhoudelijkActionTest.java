...
/**
 * Test ControleerAntwoordInhoudelijkAction.
 */
@RunWith(MockitoJUnitRunner.class)
public class ControleerAntwoordInhoudelijkActionTest {

    @Mock
    private BerichtenDao berichtenDao;

    @InjectMocks
    private ControleerAntwoordInhoudelijkAction subject;

    @Test
    public void correctBerichtMetGevondenResultaat() {
        final Map<String, Object> parameters = new HashMap<>();
        parameters.put("zoekPersoonAntwoord", 1L);
    ...
    public void correctBerichtMetFoutreden() {
        ...
        final AdHocZoekPersoonAntwoordBericht antwoord = new AdHocZoekPersoonAntwoordBericht();
        antwoord.setFoutreden(AdHocZoekAntwoordFoutReden.H);
        ...
        Assert.assertTrue("Resultaat moet foutreden bevatten", resultaat.containsKey("hf01foutreden"));
        Assert.assertEquals("Foutreden moet H zijn", "H", resultaat.get("hf01foutreden"));
    }
