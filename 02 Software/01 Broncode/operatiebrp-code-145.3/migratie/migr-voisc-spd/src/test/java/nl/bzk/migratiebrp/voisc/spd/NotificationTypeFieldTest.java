...
public class NotificationTypeFieldTest {

    private final NotificationTypeField mandatorySubject = new NotificationTypeField("mandatorySubject", false);
    private final NotificationTypeField optionalSubject = new NotificationTypeField("optionalSubject", true);
    ...
    public void getValue() {
        mandatorySubject.setValue(SpdConstants.NotificationType.NON_RECEIPT);
        assertEquals(SpdConstants.NotificationType.NON_RECEIPT, mandatorySubject.getValue());
    }
    ...
    public void setRawValue() {
        mandatorySubject.setRawValue("1");
        assertEquals(SpdConstants.NotificationType.NON_RECEIPT, mandatorySubject.getValue());
    }
    ...
    public void validateOptionalAndNotEmpty() {
        optionalSubject.setValue(SpdConstants.NotificationType.NON_RECEIPT);
        assertEquals(true, optionalSubject.validate());
    }
