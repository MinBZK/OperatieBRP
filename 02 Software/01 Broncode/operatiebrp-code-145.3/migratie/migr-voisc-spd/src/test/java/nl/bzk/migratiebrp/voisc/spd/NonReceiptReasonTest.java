...
import static nl.bzk.migratiebrp.voisc.spd.SpdConstants.NonReceiptReason.EXPIRED;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.fail;

import org.junit.Test;

public class NonReceiptReasonTest {

    private final NonReceiptReasonField mandatorySubject = new NonReceiptReasonField("mandatorySubject", false);
    private final NonReceiptReasonField optionalSubject = new NonReceiptReasonField("optionalSubject", true);
    ...
    public void getValue() {
        mandatorySubject.setValue(EXPIRED);
        assertEquals(EXPIRED, mandatorySubject.getValue());
    }
    ...
    public void validateOptionalAndNotEmpty() {
        optionalSubject.setValue(EXPIRED);
        assertEquals(true, optionalSubject.validate());
    }
