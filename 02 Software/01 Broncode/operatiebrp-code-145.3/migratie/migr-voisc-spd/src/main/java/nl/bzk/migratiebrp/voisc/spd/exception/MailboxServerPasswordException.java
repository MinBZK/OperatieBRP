...
public class MailboxServerPasswordException extends VoaException {
     ...
     */
    public MailboxServerPasswordException(final MessagesCodes code) {
     ...
     */
    public MailboxServerPasswordException(final MessagesCodes code, final Object[] parameter) {
        super(code.getErrorCode(), parameter);
    }

    /**
     * This constructor makes it possible to pass the causing Exception as Trowable param.
     * @param code MessagesCodes the key used for finding the corresponding exception message
     ...
     */
    public MailboxServerPasswordException(final MessagesCodes code, final Object[] parameter, final Throwable cause) {
