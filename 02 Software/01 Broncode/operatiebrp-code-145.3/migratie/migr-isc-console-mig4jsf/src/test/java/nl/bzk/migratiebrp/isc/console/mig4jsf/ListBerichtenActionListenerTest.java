...
/**
 * test het ontbrekende pad.
 */
@RunWith(MockitoJUnitRunner.class)
public class ListBerichtenActionListenerTest {
    ...
    public void test() {
        ...
        final ListBerichtenActionListener listener = new ListBerichtenActionListener(targetExpression, pagerExpression, filterExpression);
