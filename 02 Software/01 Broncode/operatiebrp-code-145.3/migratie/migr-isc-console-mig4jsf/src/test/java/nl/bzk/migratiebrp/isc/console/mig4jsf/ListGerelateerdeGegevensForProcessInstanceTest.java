...
public class ListGerelateerdeGegevensForProcessInstanceTest extends AbstractTagTest {
    ...
    public void test() throws Exception {
        ...
        // Execute
        final JbpmActionListener subject = initializeSubject(ListGerelateerdeGegevensForProcessInstanceHandler.class);
        Assert.assertEquals("listGerelateerdeGegevensForProcessInstance", subject.getName());
        ...
        final Collection<GerelateerdGegeven> gerelateerdeGegevens = (Collection<GerelateerdGegeven>) getExpressionValues().get("target");
        Assert.assertNotNull(gerelateerdeGegevens);
        Assert.assertEquals(2, gerelateerdeGegevens.size());
    }
}
