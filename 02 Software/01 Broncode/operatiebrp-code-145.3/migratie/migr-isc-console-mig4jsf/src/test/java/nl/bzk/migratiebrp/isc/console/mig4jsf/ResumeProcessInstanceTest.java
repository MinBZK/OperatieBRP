...
public class ResumeProcessInstanceTest extends AbstractTagTest {
    ...
    public void testOk() throws Exception {
        ...
        // Execute
        final JbpmActionListener subject = initializeSubject(ResumeProcessInstanceHandler.class);
        Assert.assertEquals("resumeProcessInstance", subject.getName());
        subject.handleAction(jbpmJsfContext, actionEvent);

        // Verify
        final ArgumentCaptor<JbpmResumeCommand> commandCaptor = ArgumentCaptor.forClass(JbpmResumeCommand.class);
        ...
        final JbpmResumeCommand command = commandCaptor.getValue();
    ...
    public void testNull() throws Exception {
        ...
        // Verify
        Mockito.verify(jbpmJsfContext).setError("Het proces kon niet worden hervat.", "Geen process instantie doorgegeven");
