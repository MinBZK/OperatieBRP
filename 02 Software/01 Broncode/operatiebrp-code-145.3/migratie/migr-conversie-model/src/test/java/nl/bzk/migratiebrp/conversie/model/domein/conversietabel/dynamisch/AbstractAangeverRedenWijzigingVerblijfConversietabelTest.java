...
public class AbstractAangeverRedenWijzigingVerblijfConversietabelTest {
    private final AbstractAangeverRedenWijzigingVerblijfConversietabel subject =
            new AbstractAangeverRedenWijzigingVerblijfConversietabel(
    ...
    private static final AangeverRedenWijzigingVerblijfPaar BRP =
            new AangeverRedenWijzigingVerblijfPaar(new BrpAangeverCode('I'), new BrpRedenWijzigingVerblijfCode('P'));
    ...
    public void bepaalOnderzoekBrp() {
        ...
        Assert.assertEquals(
                ...
                subject.bepaalOnderzoekBrp(
                        new AangeverRedenWijzigingVerblijfPaar(new BrpAangeverCode('I', null), new BrpRedenWijzigingVerblijfCode('P', ONDERZOEK))));
        Assert.assertEquals(
                ONDERZOEK,
                subject.bepaalOnderzoekBrp(
                        new AangeverRedenWijzigingVerblijfPaar(new BrpAangeverCode('I', ONDERZOEK), new BrpRedenWijzigingVerblijfCode('P', null))));
    }
    ...
    public void voegOnderzoekToeBrp() {
        ...
        Assert.assertEquals(
                BRP.getBrpRedenWijzigingVerblijfCode().getWaarde(),
                subject.voegOnderzoekToeBrp(BRP, null).getBrpRedenWijzigingVerblijfCode().getWaarde());
        ...
        Assert.assertEquals(
                BRP.getBrpRedenWijzigingVerblijfCode().getWaarde(),
                subject.voegOnderzoekToeBrp(BRP, ONDERZOEK).getBrpRedenWijzigingVerblijfCode().getWaarde());
