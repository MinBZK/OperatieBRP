...
public class ModelTest {
    ...
    public void testPersoonsLijstInterface() {
        Persoonslijst pl = getPersoonsLijst("1212121212");
        assertEquals("1212121212", pl.getActueelAdministratienummer());
    }

    private Persoonslijst getPersoonsLijst(final String aNummer) {
        return BrpPersoonslijstBuilderTest.maakMinimaleBuilder(aNummer).build();
    }
}
