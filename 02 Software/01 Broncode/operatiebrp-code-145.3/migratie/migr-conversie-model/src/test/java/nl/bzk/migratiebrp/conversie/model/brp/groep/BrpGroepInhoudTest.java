...
public class BrpGroepInhoudTest {
    ...
    private static final String CODE_5678 = "5678";
    private static final String CODE_567 = "567";
    private static final String CODE_4321 = "4321";
    private static final String CODE_432 = "432";
    ...
    public void testEqualsHashcodeAndToString() throws NoSuchMethodException, IllegalAccessException {
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpGeboorteInhoud(
                        ...
                        new BrpLandOfGebiedCode(CODE_1234),
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                ...
                new BrpIdentificatienummersInhoud(new BrpString("1234567890"), new BrpString("123456789")),
                new BrpIdentificatienummersInhoud(new BrpString("2345678901"), new BrpString("234567890")));
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(new BrpNummerverwijzingInhoud(
                new BrpString("1234567890"),
                new BrpString("1234567891"),
                new BrpString("123456789"),
                new BrpString("987654321")), new BrpNummerverwijzingInhoud(
                new BrpString("1234567890"),
                new BrpString("1234567891"),
                new BrpString("123456789"),
                new BrpString("987654321")), new BrpNummerverwijzingInhoud(
                new BrpString("1234567899"),
                new BrpString("1234567892"),
                new BrpString("123456788"),
                new BrpString("987654322")));
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToStringBeperkt(
                new BrpNationaliteitInhoud(
                        ...
                        new BrpRedenVerliesNederlandschapCode(CODE_567),
                        null,
                        null,
                        null,
                        null),
                ...
                new BrpNationaliteitInhoud(
                        ...
                        new BrpNationaliteitCode(CODE_1234),
                        new BrpRedenVerkrijgingNederlandschapCode(CODE_432),
                        new BrpRedenVerliesNederlandschapCode("876"),
                        null,
                        null,
                        null,
                        null));
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(new BrpReisdocumentInhoud(
                        ...
                        new BrpReisdocumentAutoriteitVanAfgifteCode(CODE_1234),
                ...
                new BrpReisdocumentInhoud(
                        ...
                        new BrpDatum(
                                20110101,
                                null), new BrpDatum(20050101, null), new BrpReisdocumentAutoriteitVanAfgifteCode(CODE_1234), new BrpDatum(20100101, null),
                        new BrpDatum(
                                20080101,
                                null),
                        new BrpAanduidingInhoudingOfVermissingReisdocumentCode('I')),
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpVerblijfsrechtInhoud(new BrpVerblijfsrechtCode("01"), new BrpDatum(20100101, null), new BrpDatum(20150101, null),
                        new BrpDatum(20150102, null)),
                new BrpVerblijfsrechtInhoud(new BrpVerblijfsrechtCode("01"), new BrpDatum(20100101, null), new BrpDatum(20150101, null),
                        new BrpDatum(20150102, null)),
                new BrpVerblijfsrechtInhoud(new BrpVerblijfsrechtCode("02"), new BrpDatum(20110101, null), new BrpDatum(20160101, null),
                        new BrpDatum(20150102, null)));
    ...
    public void testAttributen() throws NoSuchMethodException, IllegalAccessException {
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(new BrpLandOfGebiedCode(CODE_6030), new BrpLandOfGebiedCode(CODE_6030),
                new BrpLandOfGebiedCode("6031"));

        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpNationaliteitCode(CODE_6030),
                new BrpNationaliteitCode(CODE_6030),
                new BrpNationaliteitCode("6031"));
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpRedenVerliesNederlandschapCode("001"),
                new BrpRedenVerliesNederlandschapCode("001"),
                new BrpRedenVerliesNederlandschapCode("002"));
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpVerblijfsrechtCode("01"),
                new BrpVerblijfsrechtCode("01"),
                new BrpVerblijfsrechtCode("02"));
    ...
    public void testIsLeegMethoden() {
        ...
        testIsNietLeeg(new BrpIdentificatienummersInhoud(new BrpString("1234567890"), new BrpString("123456789")));

        testIsNietLeeg(new BrpInschrijvingInhoud(new BrpDatum(20120101, null), new BrpLong(1L), BrpDatumTijd.fromDatum(20010101, null)));

        testIsNietLeeg(
                new BrpNummerverwijzingInhoud(new BrpString("1234567890"), new BrpString("1234567891"), new BrpString("123456789"),
                        new BrpString("987654321")));
        ...
        testIsNietLeeg(new BrpVerblijfsrechtInhoud(new BrpVerblijfsrechtCode("01"), new BrpDatum(20100101, null), new BrpDatum(20150101, null),
                new BrpDatum(20150102, null)));
    ...
    public void testBrpMigratie() throws NoSuchMethodException, IllegalAccessException {
        final BrpMigratieInhoud migratieInhoud2 =
                new BrpMigratieInhoud.Builder(BrpSoortMigratieCode.EMIGRATIE, new BrpLandOfGebiedCode("0002")).build();
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpMigratieInhoud.Builder(BrpSoortMigratieCode.IMMIGRATIE, new BrpLandOfGebiedCode("0001")).build(),
                new BrpMigratieInhoud.Builder(BrpSoortMigratieCode.IMMIGRATIE, new BrpLandOfGebiedCode("0001")).build(),
                migratieInhoud2);
        testIsNietLeeg(new BrpMigratieInhoud.Builder(BrpSoortMigratieCode.IMMIGRATIE, new BrpLandOfGebiedCode("0001")).build());
    ...
    public void testBrpBijhouding() throws NoSuchMethodException, IllegalAccessException {
        ...
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpBijhoudingInhoud(new BrpPartijCode("501801"), BrpBijhoudingsaardCode.INGEZETENE, null),
                new BrpBijhoudingInhoud(new BrpPartijCode("501801"), BrpBijhoudingsaardCode.INGEZETENE, null),
                new BrpBijhoudingInhoud(new BrpPartijCode("765401"), BrpBijhoudingsaardCode.INGEZETENE, null));

        testIsNietLeeg(new BrpBijhoudingInhoud(new BrpPartijCode("501801"), BrpBijhoudingsaardCode.INGEZETENE, null));
    }
    ...
    public void testBrpPersoonskaart() throws NoSuchMethodException, IllegalAccessException {
        EqualsAndHashcodeTester.testEqualsHashcodeAndToString(
                new BrpPersoonskaartInhoud(new BrpPartijCode("051801"), new BrpBoolean(true)),
                new BrpPersoonskaartInhoud(new BrpPartijCode("051801"), new BrpBoolean(true)),
                new BrpPersoonskaartInhoud(new BrpPartijCode("123401"), new BrpBoolean(false)));

        testIsNietLeeg(new BrpPersoonskaartInhoud(new BrpPartijCode("051801"), new BrpBoolean(true)));
