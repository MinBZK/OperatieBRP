...
public class SignaleringConversietabelTest {
    private final SignaleringConversietabel subject = new SignaleringConversietabel();
    ...
    public void converteerNaarBrp() {
        ...
        Assert.assertEquals(null, subject.converteerNaarBrp(new Lo3Signalering(null, ONDERZOEK)));
        Assert.assertEquals(true, subject.converteerNaarBrp(new Lo3Signalering("1", ONDERZOEK)).getWaarde());
        Assert.assertEquals(ONDERZOEK, subject.converteerNaarBrp(new Lo3Signalering("1", ONDERZOEK)).getOnderzoek());
        Assert.assertEquals(null, subject.converteerNaarBrp(new Lo3Signalering("2", ONDERZOEK)));
    }
    ...
    public void converteerNaarLo3() {
        ...
        Assert.assertEquals(ONDERZOEK, subject.converteerNaarLo3(new BrpBoolean(true, ONDERZOEK)).getOnderzoek());
    }

    @Test
    public void valideerLo3() {
        Assert.assertEquals(true, subject.valideerLo3(null));
        Assert.assertEquals(true, subject.valideerLo3(new Lo3Signalering(null, ONDERZOEK)));
        Assert.assertEquals(true, subject.valideerLo3(new Lo3Signalering("1", ONDERZOEK)));
        Assert.assertEquals(false, subject.valideerLo3(new Lo3Signalering("2", ONDERZOEK)));
    }
