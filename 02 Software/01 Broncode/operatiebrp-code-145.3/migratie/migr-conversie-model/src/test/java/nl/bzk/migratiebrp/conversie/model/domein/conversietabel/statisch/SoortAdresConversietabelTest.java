...
public class SoortAdresConversietabelTest {
    private final SoortAdresConversietabel tabel = new SoortAdresConversietabel();
    ...
    public void testBrpNaarLo3() {
        ...
        assertEquals(
                new Lo3FunctieAdres(Lo3FunctieAdresEnum.BRIEFADRES.getCode(), ONDERZOEK),
                tabel.converteerNaarLo3(new BrpSoortAdresCode("B", ONDERZOEK)));
        assertEquals(
                new Lo3FunctieAdres(Lo3FunctieAdresEnum.WOONADRES.getCode(), ONDERZOEK),
