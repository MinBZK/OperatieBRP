...
public class AbstractVerblijfsrechtConversietabelTest {
    private final AbstractVerblijfsrechtConversietabel subject = new AbstractVerblijfsrechtConversietabel(Collections.emptyList()) {
    };

    private static final Lo3AanduidingVerblijfstitelCode LO3 = new Lo3AanduidingVerblijfstitelCode("S");
    private static final BrpVerblijfsrechtCode BRP = new BrpVerblijfsrechtCode("01");
