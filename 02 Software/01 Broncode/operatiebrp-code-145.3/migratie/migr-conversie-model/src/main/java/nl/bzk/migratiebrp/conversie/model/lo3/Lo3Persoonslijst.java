...
public final class Lo3Persoonslijst implements Persoonslijst {
     ...
     * @param persoonStapel de persoon stapel, mag niet null zijn
     * @param ouder1Stapel de ouder 1 stapel, mag null zijn
     * @param ouder2Stapel de ouder 2 stapel, mag null zijn
     * @param nationaliteitStapels de lijst met nationaliteit stapels, mag null of leeg zijn
     * @param huwelijkOfGpStapels de lijst met huwelijk of geregistreerd partnerschap stapels, mag null of leeg zijn
     * @param overlijdenStapel de overlijden stapel, mag null zijn
     * @param inschrijvingStapel de inschrijving stapel, mag niet null zijn
     * @param verblijfplaatsStapel de verblijfplaats stapel, mag null zijn
     * @param kindStapels de lijst met kind stapels, mag null of leeg zijn
     * @param verblijfstitelStapel de verblijfstitel stapel, mag null zijn
     * @param gezagsverhoudingStapel de gezagsverhouding stapel, mag null zijn
     * @param reisdocumentStapels de lijst met reisdocument stapels, mag null of leeg zijn
     * @param kiesrechtStapel de kiesrecht stapel, mag null zijn
     * @throws NullPointerException als persoonStapel of inschrijvingStapel null zijn
     * @throws IllegalArgumentException als een inschrijving, reisdocument of kiesrecht historie heeft, of als een actuele categorie de indicatie onjuist heeft,
     * of als de datum registratie in enige categorie gedeeltelijk onbekend is
     */
    Lo3Persoonslijst(
        ...
        @ElementList(name = "kindStapels", entry = "kindStapel", type = Lo3Stapel.class,
                required = false) final List<Lo3Stapel<Lo3KindInhoud>> kindStapels,
    ...
    public String getActueelAdministratienummer() {
        return persoonStapel == null ? null : Lo3String.unwrap(persoonStapel.getLaatsteElement().getInhoud().getANummer());
    }
    ...
    public String getActueelBurgerservicenummer() {
        return persoonStapel == null ? null : Lo3String.unwrap(persoonStapel.getLaatsteElement().getInhoud().getBurgerservicenummer());
    }
     ...
     * @param isDummy checks if is dummy pl
     */
     ...
     * @throws NullPointerException als {@link #getInschrijvingStapel()} null is
     * @throws IllegalStateException groep 80 van de inschrijving
     */
    ...
    /**
     * Geeft aan of de gemeente van inschrijving in het actueel voorkomen van de Lo3Persoonslijst gevuld is of niet.
     * @return boolean, wel of niet gevuld.
     */
    public boolean isActueelVoorkomenGemeenteVanInschrijvingGevuld() {
        boolean gevuld = false;

        if (getVerblijfplaatsStapel() != null
                && getVerblijfplaatsStapel().getLo3ActueelVoorkomen() != null
                && getVerblijfplaatsStapel().getLo3ActueelVoorkomen().getInhoud() != null
                && getVerblijfplaatsStapel().getLo3ActueelVoorkomen().getInhoud().getGemeenteInschrijving() != null
                && getVerblijfplaatsStapel().getLo3ActueelVoorkomen().getInhoud().getGemeenteInschrijving().isInhoudelijkGevuld()) {
            gevuld = true;
        }
        return gevuld;
    }
