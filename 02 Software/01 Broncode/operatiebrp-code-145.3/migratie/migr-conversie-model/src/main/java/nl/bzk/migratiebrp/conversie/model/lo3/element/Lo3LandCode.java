...
public final class Lo3LandCode extends AbstractLo3Element {
     ...
     * @param waarde de LO3 code die een land in LO3 uniek identificeert
     */
     ...
     * @param waarde de LO3 code die een land in LO3 uniek identificeert
     * @param onderzoek het onderzoek waar deze landcode onder valt. Mag NULL zijn.
     */
    public Lo3LandCode(
     ...
     * @return true als code {@literal <>} 0000 en code {@literal <>} 9999 en code {@literal <>} 6030, anders false
     */
