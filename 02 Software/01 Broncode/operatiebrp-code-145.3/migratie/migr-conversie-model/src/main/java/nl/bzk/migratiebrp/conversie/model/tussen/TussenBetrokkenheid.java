...
public final class TussenBetrokkenheid {
     ...
     * @param rol rol
     * @param identificatienummersStapel identificatienummers (gerelateerde) stapel
     * @param geslachtsaanduidingStapel geslachtsaanduiding (gerelateerde) stapel
     * @param geboorteStapel geboorte (gerelateerde) stapel
     * @param ouderlijkGezagStapel ouderlijk gezag (gerelateerde) stapel
     * @param samengesteldeNaamStapel samengestelde naam (gerelateerde) stapel
    ...
    /**
     * Geef de waarde van rol van TussenBetrokkenheid.
     * @return de waarde van rol van TussenBetrokkenheid
     */
    ...
    /**
     * Geef de waarde van identificatienummers stapel van TussenBetrokkenheid.
     * @return de waarde van identificatienummers stapel van TussenBetrokkenheid
     */
    ...
    /**
     * Geef de waarde van geslachtsaanduiding stapel van TussenBetrokkenheid.
     * @return de waarde van geslachtsaanduiding stapel van TussenBetrokkenheid
     */
    ...
    /**
     * Geef de waarde van geboorte stapel van TussenBetrokkenheid.
     * @return de waarde van geboorte stapel van TussenBetrokkenheid
     */
    ...
    /**
     * Geef de waarde van samengestelde naam stapel van TussenBetrokkenheid.
     * @return de waarde van samengestelde naam stapel van TussenBetrokkenheid
     */
    ...
    /**
     * Geef de waarde van ouderlijk gezag stapel van TussenBetrokkenheid.
     * @return de waarde van ouderlijk gezag stapel van TussenBetrokkenheid
     */
    ...
    /**
     * Geef de waarde van ouder stapel van TussenBetrokkenheid.
     * @return de waarde van ouder stapel van TussenBetrokkenheid
     */
