...
/**
 * Deze class levert helper functionaliteit voor het doen van validaties BRP Gegevens.
 */
public final class BrpValidatie {
    private static final int MAX_DATUM_WAARDE = 9999_99_99;
    private static final long MAX_DATUM_TIJD_WAARDE = 9999_99_99_99_99_99L;

    /**
     * Explicit private constructor.
     */
    private BrpValidatie() {
     ...
     * @param attribuut BRP attribuut dat getest wordt
     ...
     * </ul>}
     * @param datum de datum invoer die gecontroleerd moet worden
     ...
     * </ul>}
     * @param datumTijd de datum invoer die gecontroleerd moet worden
     ...
     * @param parameters de lijst met string parameters die op lege waarden wordt gecontroleerd.
