 ...
 * Indicatie geheim.
 */
public final class Lo3IndicatieGeheimCode extends AbstractLo3Element {
     ...
     * @param waarde code
     */
    public Lo3IndicatieGeheimCode(final Integer waarde) {
     ...
     */
    public Lo3IndicatieGeheimCode(@Element(name = "waarde", required = false) final String waarde, @Element(name = "onderzoek",
