...
public interface BerichtenDao {
     ...
     * @param id Het id van het bericht waarvoor de meta data wordt opgehaald.
     ...
     * @param requestNonReceipt requestNonReceipt
     * @return bericht id
     */
    Long bewaar(
            final String kanaal,
     ...
     * @param berichtId bericht id
     * @param processInstanceId proces instantie id
     */
     ...
     * @param correlatieId correlatie id (van het antwoord bericht)
     * @param kanaal kanaal (van het antwoord bericht)
     * @param originator originator (van het antwoord bericht)
     * @param recipient recipient (van het antwoord bericht)
     ...
     * @param msSequenceNumber MsSequenceNumber
     * @param berichtId te negeren bericht
     ...
     * @param messageId message id (van het vraag bericht)
     * @param originator originator (van het vraag bericht)
     * @param recipient recipient (van het vraag bericht)
     * @param kanaal kanaal (van het vraag bericht)
     ...
     * @param berichtId bericht id
     * @param virtueelProcesId virtueel proces id
     */
     ...
     * @param virtueelProcesId virtueel proces id
     * @param processInstanceId jpbm proces instance id
     */
