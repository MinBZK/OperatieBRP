...
public interface RapportageDao {
     ...
     * @param procesnaam De procesnaam van het lopende proces.
     * @param berichtType Het berichttype van het startende bericht.
     * @param kanaal Het kanaal van het startende bericht.
     * @param procesInstantieId Het id van het lopende proces.
     * @param startdatum De startdatum van de foutafhandeling.
     */
     ...
     * @param procesInstantieId De proces instantie waarover we loggen.
     * @param wachtStartdatum De wachtStartDatum van het foutafhandelingsproces.
     ...
     * @param procesInstantieId De proces instantie waarover we loggen.
     * @param wachtEinddatum De wachtEindDatum van het foutafhandelingsproces.
     */
     ...
     * @param procesInstantieId De proces instantie waarover we loggen.
     * @param einddatum De eindDatum van het proces.
     */
