...
public class TableFormatter {
    ...
    private static char[] getPadCharArray(final String s, final int length, final char padChar) {
    ...
    private static String pad(final String s, final char[] padArray, final boolean padLeft) {
