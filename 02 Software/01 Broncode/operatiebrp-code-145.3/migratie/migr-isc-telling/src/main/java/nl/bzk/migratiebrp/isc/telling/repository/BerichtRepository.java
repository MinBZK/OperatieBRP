...
public interface BerichtRepository {
     ...
     * @param bericht de bericht entiteit die moet worden opgeslagen in de database
     ...
     * @param datumTot De datum tot wanneer de berichten worden meegenomen voor de telling.
     * @param limit Limiet aantal resultaten.
     ...
     * @param teUpdatenIds De ID's van de te markeren berichten.
