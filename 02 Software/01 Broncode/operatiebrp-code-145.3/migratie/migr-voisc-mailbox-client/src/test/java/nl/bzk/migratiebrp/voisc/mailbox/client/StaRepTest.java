...
@ContextConfiguration({"classpath:test-mailbox.xml", "classpath:voisc-mailbox-client.xml"})
public class StaRepTest {
    ...
    @Test
    public void testStaRep() throws VoaException, InterruptedException {
        ...
        starep.setBerichtInhoud("StaRep;0");
        ...
        Assert.assertEquals("BERICHT-0001", ontvangen.getCorrelationId());
        ...
        Assert.assertEquals("0", ontvangen.getNotificationType());
        Assert.assertEquals("1704010", ontvangen.getOriginator());
        Assert.assertEquals("1703010", ontvangen.getRecipient());
    ...
    @Test
    public void testStaRepDefault() throws VoaException {
        final nl.bzk.migratiebrp.voisc.database.entities.Mailbox mailbox1703 = new nl.bzk.migratiebrp.voisc.database.entities.Mailbox();
        mailbox1703.setMailboxnr("1703010");
        mailbox1703.setMailboxpwd("qwer1234");
        ...
        // Stuur starep
        final Bericht starep = new Bericht();
        starep.setBerichtInhoud("StaRep");
        starep.setMessageId("BERICHT-0002");
        starep.setCorrelationId("BERICHT-0001");
        starep.setRecipient("1703010");
        ...
        Assert.assertEquals(null, ontvangen.getMessageId());
        Assert.assertEquals(null, ontvangen.getNonDeliveryReason());
        Assert.assertEquals("1", ontvangen.getNotificationType());
        Assert.assertEquals("1704010", ontvangen.getOriginator());
        Assert.assertEquals("1703010", ontvangen.getRecipient());
        Assert.assertEquals(false, ontvangen.getRequestNonReceiptNotification());
        Assert.assertEquals(null, ontvangen.getStatus());
