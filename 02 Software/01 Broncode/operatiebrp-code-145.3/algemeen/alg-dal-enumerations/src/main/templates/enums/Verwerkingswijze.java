...
/**
 * Enumeratie voor statische stamtabel kern.verwerkingswijze.
 */
public enum Verwerkingswijze implements Enumeratie {
    ...
    || oms
    || '")'
    FROM  kern.verwerkingswijze
    ORDER BY id
    */    

    private static final EnumMetNaamParser<Verwerkingswijze> PARSER = new EnumMetNaamParser<>(Verwerkingswijze.class);
     ...
     */
    Verwerkingswijze(final int id, final String naam, final String omschrijving) {
        this.id = id;
        this.naam = naam;
     ...
     */
    public static Verwerkingswijze parseId(final Integer id) {
     ...
     * @return verwerkingswijze
     */
    public static Verwerkingswijze parseNaam(final String naam) {
