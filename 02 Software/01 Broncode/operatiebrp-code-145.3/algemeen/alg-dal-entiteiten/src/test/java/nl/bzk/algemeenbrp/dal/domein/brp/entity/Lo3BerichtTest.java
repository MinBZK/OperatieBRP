...
public class Lo3BerichtTest {
    ...
    private void createConversieBericht() {
        final Partij partij1 = new Partij(PARTIJ_1, "000001");
        final Partij partij2 = new Partij(PARTIJ_2, "000002");
        final AdministratieveHandeling administratieveHandeling =
                new AdministratieveHandeling(partij1, SoortAdministratieveHandeling.GBA_INITIELE_VULLING, new Timestamp(System.currentTimeMillis()));
