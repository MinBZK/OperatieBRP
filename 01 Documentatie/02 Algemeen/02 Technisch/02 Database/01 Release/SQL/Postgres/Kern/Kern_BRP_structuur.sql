...
CREATE TABLE AutAut.Dienst (
   ...
   Selcriterium                  Text                                                                   /* Populatiebeperking */,
...
CREATE TABLE Kern.Element (
   ...
   IndOnderzoekToestaan          Boolean                                 CHECK (IndOnderzoekToestaan IN (true))   /* Ja */,
   DatAanvGel                    Integer                                 CHECK (to_char(to_date(DatAanvGel::text, 'yyyymmdd'), 'yyyymmdd')=DatAanvGel::text)   /* Dat */,
   DatEindeGel                   Integer                                 CHECK (to_char(to_date(DatEindeGel::text, 'yyyymmdd'), 'yyyymmdd')=DatEindeGel::text)   /* Dat */,
...
CREATE TABLE Kern.SrtSelresultaatSet (
   ID                            Smallint                      NOT NULL                                 /* SrtSelresultaatsetID */,
   Naam                          Varchar(80)                   NOT NULL  CHECK (Naam <> '' )            /* NaamEnumeratiewaarde */,
   Oms                           Varchar(250)                  NOT NULL  CHECK (Oms <> '' )             /* OmsEnumeratiewaarde */,
   CONSTRAINT pk_SrtSelresultaatSet PRIMARY KEY (ID),
   CONSTRAINT uc_SrtSelresultaatSet_Naam UNIQUE (Naam)
);
...
CREATE SEQUENCE Kern.seq_Verwerkingssrt START WITH 1;
CREATE TABLE Kern.Verwerkingssrt (
   ID                            Smallint                      NOT NULL  DEFAULT nextval('Kern.seq_Verwerkingssrt')   /* VerwerkingssrtID */,
   Naam                          Varchar(80)                   NOT NULL  CHECK (Naam <> '' )            /* NaamEnumeratiewaarde */,
   Oms                           Varchar(250)                  NOT NULL  CHECK (Oms <> '' )             /* OmsEnumeratiewaarde */,
   CONSTRAINT pk_Verwerkingssrt PRIMARY KEY (ID),
   CONSTRAINT uc_Verwerkingssrt_Naam UNIQUE (Naam)
);
ALTER SEQUENCE Kern.seq_Verwerkingssrt OWNED BY Kern.Verwerkingssrt.ID;
...
CREATE SEQUENCE Kern.seq_Zoekoptie START WITH 1;
CREATE TABLE Kern.Zoekoptie (
   ID                            Smallint                      NOT NULL  DEFAULT nextval('Kern.seq_Zoekoptie')   /* ZoekoptieID */,
   Naam                          Varchar(80)                   NOT NULL  CHECK (Naam <> '' )            /* NaamEnumeratiewaarde */,
   Oms                           Varchar(250)                  NOT NULL  CHECK (Oms <> '' )             /* OmsEnumeratiewaarde */,
   CONSTRAINT pk_Zoekoptie PRIMARY KEY (ID),
   CONSTRAINT uc_Zoekoptie_Naam UNIQUE (Naam)
);
ALTER SEQUENCE Kern.seq_Zoekoptie OWNED BY Kern.Zoekoptie.ID;
...
CREATE TABLE IST.Stapel (
   ...
   Pers                          Bigint                        NOT NULL                                 /* PersID */,
   Categorie                     Char(2)                       NOT NULL  CHECK (Categorie ~ '^[0-9]+$' AND Length(Categorie) >= 2)   /* LO3Categorie */,
   Volgnr                        Integer                       NOT NULL                                 /* Volgnr */,
...
CREATE TABLE VerConv.LO3Voorkomen (
   ...
   LO3Categorie                  Char(2)                       NOT NULL  CHECK (LO3Categorie ~ '^[0-9]+$' AND Length(LO3Categorie) >= 2)   /* LO3Categorie */,
...
CREATE TABLE Kern.His_Betr (
   ...
   NadereAandVerval              Varchar(1)                              CHECK (NadereAandVerval IN ('O','S','P'))   /* NadereAandVerval */,
...
CREATE TABLE Kern.His_PersMigratie (
   ...
   RdnWijzMigratie               Smallint                                                               /* RdnWijzVerblijfID */,
   AangMigratie                  Smallint                                                               /* AangID */,
   LandGebiedMigratie            Integer                       NOT NULL                                 /* LandGebiedID */,
   BLAdresRegel1Migratie         Varchar(40)                             CHECK (BLAdresRegel1Migratie <> '' )   /* Adresregel */,
   BLAdresRegel2Migratie         Varchar(40)                             CHECK (BLAdresRegel2Migratie <> '' )   /* Adresregel */,
   BLAdresRegel3Migratie         Varchar(40)                             CHECK (BLAdresRegel3Migratie <> '' )   /* Adresregel */,
   BLAdresRegel4Migratie         Varchar(40)                             CHECK (BLAdresRegel4Migratie <> '' )   /* Adresregel */,
