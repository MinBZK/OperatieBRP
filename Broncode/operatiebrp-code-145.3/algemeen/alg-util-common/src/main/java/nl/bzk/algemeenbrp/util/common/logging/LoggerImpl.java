...
import nl.bzk.algemeenbrp.util.common.logging.MDC.MDCCloser;
...
final class LoggerImpl implements Logger {
    ...
    @Override
    public void trace(final Map<String, String> data, final String message) {
        doLogging(data, null, message, TRACE);
    }

    @Override
    public void trace(final Map<String, String> data, final String format, final Object... args) {
        doLogging(data, null, format, TRACE, args);
    }
    ...
    private void doLogging(final Map<String, String> data, final FunctioneleMelding melding, final String message, final String loggingType,
            final Object... args) {
    ...
    private void doTraceLogging(final String message, final Object[] args) {
        if (message != null) {
            if (args.length == 0) {
                delegate.trace(message);
            } else {
