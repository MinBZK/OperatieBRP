...
/**
 * Enumeratie voor statische stamtabel kern.verantwoording.
 */
public enum Verantwoording implements Enumeratie {
    ...
    || oms
    || '")'
    FROM  kern.verantwoording
    ORDER BY id
    */    

    private static final EnumMetNaamParser<Verantwoording> PARSER = new EnumMetNaamParser<>(Verantwoording.class);
     ...
     */
    Verantwoording(final int id, final String naam, final String omschrijving) {
        this.id = id;
        this.naam = naam;
     ...
     */
    public static Verantwoording parseId(final Integer id) {
     ...
     * @return soort melding
     */
    public static Verantwoording parseNaam(final String naam) {
    ...
    public String getCode() {
        throw new UnsupportedOperationException(String.format("De enumeratie %s heeft geen code", name()));
    }
