...
/**
 * De actie voor het registreren van een nieuw geboorte voorkomen (als onderdeel van een correctie) in de bijhouding.
 */
@XmlElement("correctieregistratieGeboorteGerelateerde")
public class CorrectieRegistratieGeboorteRegistratieGegevensGerelateerde extends AbstractCorrectieRegistratieGegevensGerelateerdeActieElement {
     ...
     */
    public CorrectieRegistratieGeboorteRegistratieGegevensGerelateerde(
    ...
    public SoortActie getSoortActie() {
        return SoortActie.CORRECTIEREGISTRATIE_GEBOORTE_GERELATEERDE;
    }
    @Override
    protected Set bepaalSetVoorNieuwVoorkomen() {
        return getPartner().getPersoonEntiteit().getPersoonGeboorteHistorieSet();
    }

    @Override
    protected FormeleHistorie maakNieuwVoorkomen() {
        return getPartner().getPersoonEntiteit().maakNieuweGeboorteHistorieVoorCorrectie(getPartner().getGeboorte());
    }
}
