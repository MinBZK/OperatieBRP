 ...
 */
@XmlElement("registratieGeslachtsaanduidingGerelateerde")
public class RegistratieGeslachtsaanduidingGerelateerdeActieElement extends AbstractWijzigenGerelateerdeGegevensActieElement {

    /**
     * Maakt een {@link RegistratieGeslachtsaanduidingGerelateerdeActieElement} object.
     ...
     */
    public RegistratieGeslachtsaanduidingGerelateerdeActieElement(final Map<String, String> basisAttribuutGroep,
    ...
    public SoortActie getSoortActie() {
        return SoortActie.REGISTRATIE_GESLACHTSAANDUIDING_GERELATEERDE;
    }
    ...
    public BRPActie verwerk(final BijhoudingVerzoekBericht bericht, final AdministratieveHandeling administratieveHandeling) {
        ...
        if (persoon.isVerwerkbaar()) {
            ...
            partnerPersoon
                    .voegPersoonGeslachtsaanduidingHistorieToe(partnerPersoonElement.getGeslachtsaanduiding(), actie, getDatumAanvangGeldigheid().getWaarde());
        }
        return actie;
    }
}
