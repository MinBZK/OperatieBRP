 ...
 */
//
@XmlElement("registratieAanvangHuwelijk")
public final class RegistratieAanvangHuwelijkActieElement extends AbstractRegistratieAanvangHuwelijkOfGpActieElement {
     ...
     */
    public RegistratieAanvangHuwelijkActieElement(
    ...
    public SoortActie getSoortActie() {
        return SoortActie.REGISTRATIE_AANVANG_HUWELIJK;
    }
}
