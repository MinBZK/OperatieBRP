...
/**
 * De actie voor het registreren van een geslachtsaanduiding voorkomen (als onderdeel van een correctie) in de bijhouding.
 */
@XmlElement("correctieregistratieGeslachtsaanduidingGerelateerde")
public class CorrectieRegistratieGeslachtsaanduidingRegistratieGegevensGerelateerde extends AbstractCorrectieRegistratieGegevensGerelateerdeActieElement {
     ...
     */
    public CorrectieRegistratieGeslachtsaanduidingRegistratieGegevensGerelateerde(
    ...
    public SoortActie getSoortActie() {
        return SoortActie.CORRECTIEREGISTRATIE_GESLACHTSAANDUIDING_GERELATEERDE;
    }
    @Override
    protected Set bepaalSetVoorNieuwVoorkomen() {
        return getPartner().getPersoonEntiteit().getPersoonGeslachtsaanduidingHistorieSet();
    }

    @Override
    protected FormeleHistorie maakNieuwVoorkomen() {
        return getPartner().getPersoonEntiteit().maakNieuweGeslachtsaanduidingHistorieVoorCorrectie(getPartner().getGeslachtsaanduiding());
    }
}
