...
/**
 * SoortElement repository.
 */
@Repository
public class SoortElementAutorisatieRepository extends EnumReadonlyRepository<SoortElementAutorisatie> {

    /**
     * Constructor.
     */
    public SoortElementAutorisatieRepository() {
        super(SoortElementAutorisatie.class);
    }
}
