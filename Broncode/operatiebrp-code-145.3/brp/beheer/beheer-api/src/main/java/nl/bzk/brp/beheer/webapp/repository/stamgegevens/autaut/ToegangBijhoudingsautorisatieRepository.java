...
/**
 * ToegangBijhoudingsautorisatie Repository.
 */
@Master
@Transactional(propagation = Propagation.MANDATORY)
public interface ToegangBijhoudingsautorisatieRepository extends ReadWriteRepository<ToegangBijhoudingsautorisatie, Integer> {
}
