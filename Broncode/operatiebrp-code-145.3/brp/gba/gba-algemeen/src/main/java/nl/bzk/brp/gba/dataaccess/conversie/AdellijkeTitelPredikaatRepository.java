...
/**
 * AdellijkeTitelPredikaat repository.
 */
@Repository
public class AdellijkeTitelPredikaatRepository extends AbstractMasterRepositoryImpl<AdellijkeTitelPredikaat, Integer, Integer> {

    /**
     * Constructor.
     */
    public AdellijkeTitelPredikaatRepository() {
