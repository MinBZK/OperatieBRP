 ...
 */
@Component
public final class HuwelijkGeslachtsaanduidingMutatieVerwerker extends AbstractMaterieelMutatieVerwerker<Lo3HuwelijkOfGpInhoud, BrpGeslachtsaanduidingInhoud> {
     ...
     */
    @Inject
    protected HuwelijkGeslachtsaanduidingMutatieVerwerker(final HuwelijkGeslachtsaanduidingMapper mapper,
        ...
        super(mapper, new GeslachtsaanduidingConverteerder(attribuutConverteerder), attribuutConverteerder, null,
                HuwelijkGeslachtsaanduidingMapper.GROEP_ELEMENT, LOGGER);
    }
}
