 ...
 */
@Component
public final class OuderGeslachtAdellijkeTitelPredikaatNabewerking {
     ...
     */
    public void voerNabewerkingUit(final Lo3Wijzigingen<Lo3OuderInhoud> wijziging) {
    ...
    private Lo3Categorie<Lo3OuderInhoud> verwerk(final Lo3Categorie<Lo3OuderInhoud> categorie) {
        if (categorie != null
            ...
            builder.adellijkeTitelPredikaatCode(lo3);
