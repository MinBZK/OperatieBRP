 ...
 */
@Component
public final class Ouder1GezagMutatieVerwerker extends AbstractMaterieelMutatieVerwerker<Lo3GezagsverhoudingInhoud, BrpOuder1GezagInhoud> {
     ...
     */
    @Inject
    protected Ouder1GezagMutatieVerwerker(final Ouder1GezagMapper mapper, final BrpAttribuutConverteerder attribuutConverteerder) {
        super(mapper, new GezagOuder1Converteerder(attribuutConverteerder), attribuutConverteerder, null, AbstractOuderGezagMapper.GROEP_ELEMENT, LOGGER);
    }
}
