...
/**
 * MutatieleveringVerwerkingssoortService.
 */
@FunctionalInterface
public interface MutatieleveringVerwerkingssoortService {
    /**
     * @param persoonslijst persoonslijst
     * @return verwerkingsoortMap
     */
    Map<MetaModel, Verwerkingssoort> execute(Persoonslijst persoonslijst);
}
