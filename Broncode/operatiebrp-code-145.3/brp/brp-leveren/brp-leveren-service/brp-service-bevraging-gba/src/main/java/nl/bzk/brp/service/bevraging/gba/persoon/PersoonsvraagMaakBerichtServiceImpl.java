 ...
 */
@Service
public final class PersoonsvraagMaakBerichtServiceImpl extends AbstractMaakBerichtServiceImpl<PersoonsvraagVerzoek> {
     ...
     */
    @Inject
    public PersoonsvraagMaakBerichtServiceImpl(final LeveringsautorisatieValidatieService leveringsautorisatieService, final PartijService partijService,
                                               final ValideerZoekCriteriaService<PersoonsvraagVerzoek> valideerZoekPersoonZoekCriteriaService,
                                               final ValideerGbaAutorisatieService valideerGbaAutorisatieService,
                                               final ZoekPersoon.OphalenPersoonService<PersoonsvraagVerzoek> zoekPersoonOphalenPersoonService) {
    ...
    protected String getDienstSpecifiekeLoggingString() {
        return "Zoek Persoon via Netwerkvraag (GBA)";
    }
}
