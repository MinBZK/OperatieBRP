...
@Service
class PersoonsvraagVerzoekCriteriaValidator implements ValideerZoekCriteriaService<PersoonsvraagVerzoek> {

    private final ValideerZoekCriteriaService<ZoekPersoonVraag> validator;

    @Inject
    PersoonsvraagVerzoekCriteriaValidator(ValideerZoekCriteriaService<ZoekPersoonVraag> validator) {
        this.validator = validator;
    }

    @Override
    public Set<Melding> valideerZoekCriteria(final PersoonsvraagVerzoek verzoek, final Autorisatiebundel autorisatiebundel) {
