...
/**
 * MaakVerwerkVrijBerichtService.
 */
@FunctionalInterface
public interface MaakVerwerkVrijBerichtService {
     ...
     */
    String maakVerwerkVrijBericht(VrijBerichtVerwerkBericht bericht) throws StapException;
}
