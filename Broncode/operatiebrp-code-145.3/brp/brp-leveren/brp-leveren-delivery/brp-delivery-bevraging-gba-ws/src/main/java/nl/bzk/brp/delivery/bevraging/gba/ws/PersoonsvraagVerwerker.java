...
@Component
class PersoonsvraagVerwerker implements AdhocvraagVerwerker<Persoonsvraag, Antwoord> {

    private final BevragingVerzoekVerwerker<PersoonsvraagWebserviceVerzoek> verzoekVerwerker;
    ...
    @Inject
    public PersoonsvraagVerwerker(final BevragingVerzoekVerwerker<PersoonsvraagWebserviceVerzoek> verzoekVerwerker,
    ...
    private Antwoord verwerkPersoonsvraag(final Persoonsvraag vraag, final String berichtReferentie, final Autorisatiebundel autorisatiebundel) {
        final PersoonsvraagWebserviceVerzoek verzoek = VerzoekMapper
                .mapZoekPersoonVerzoek(PersoonsvraagWebserviceVerzoek.class, vraag, autorisatiebundel, berichtReferentie);
