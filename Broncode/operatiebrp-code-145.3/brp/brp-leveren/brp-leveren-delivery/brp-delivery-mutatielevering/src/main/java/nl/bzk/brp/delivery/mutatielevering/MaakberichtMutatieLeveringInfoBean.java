...
@Component
@ManagedResource(
        objectName = "nl.bzk.brp:name=MutatieLevering2",
        description = "Metriek mbt MutatieLevering")
public class MaakberichtMutatieLeveringInfoBean {
     ...
     */
    public final void incrementAfnemerBericht() {
     ...
     * @param duur duur
     */
    public final void incrementHandeling(final long duur) {
        if (start == null) {
