...
/**
 * De parser voor plaatsing afnemerindicatie verzoeken.
 */
final class PlaatsAfnemerindicatieVerzoekParser extends AbstractAfnemerindicatieVerzoekParser {

    @Override
    protected String getDienstSpecifiekePrefix() {
        return getPrefix() + "/brp:plaatsingAfnemerindicatie";
    }

    @Override
    protected String getActieSpecifiekePrefix() {
        return getDienstSpecifiekePrefix() + "/brp:acties/brp:registratieAfnemerindicatie";
    }
