...
/**
 * {@link OperatorType#ONGELIJK} vergelijker voor {@link ExpressieType#LIJST} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.ONGELIJK, typeSupport = ExpressieType.LIJST)
final class LijstOngelijkVergelijker implements Vergelijker<LijstExpressie, LijstExpressie> {
