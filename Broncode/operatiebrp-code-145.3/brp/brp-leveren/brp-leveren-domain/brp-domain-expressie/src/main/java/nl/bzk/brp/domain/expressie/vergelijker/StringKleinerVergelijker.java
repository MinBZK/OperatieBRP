...
/**
 * {@link OperatorType#KLEINER} vergelijker voor {@link ExpressieType#STRING} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.KLEINER, typeSupport = ExpressieType.STRING)
final class StringKleinerVergelijker implements Vergelijker<StringLiteral, StringLiteral> {
