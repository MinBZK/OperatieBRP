...
/**
 * {@link OperatorType#KLEINER_OF_GELIJK} vergelijker voor {@link ExpressieType#STRING} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.KLEINER_OF_GELIJK, typeSupport = ExpressieType.STRING)
final class StringKleinerOfGelijkVergelijker implements Vergelijker<StringLiteral, StringLiteral> {
