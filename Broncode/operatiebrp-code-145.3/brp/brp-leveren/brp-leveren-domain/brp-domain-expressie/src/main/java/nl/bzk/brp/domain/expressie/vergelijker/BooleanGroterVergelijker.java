...
/**
 * {@link OperatorType#GROTER} vergelijker voor {@link ExpressieType#BOOLEAN} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GROTER, typeSupport = ExpressieType.BOOLEAN)
final class BooleanGroterVergelijker implements Vergelijker<BooleanLiteral, BooleanLiteral> {
