...
/**
 * {@link OperatorType#KLEINER} vergelijker voor {@link ExpressieType#NULL} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.KLEINER, typeSupport = ExpressieType.NULL)
public class NullKleinerVergelijker implements Vergelijker<Expressie, Expressie> {
