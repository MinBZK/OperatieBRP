...
/**
 * {@link OperatorType#KLEINER_OF_GELIJK} vergelijker voor {@link ExpressieType#GETAL} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.KLEINER_OF_GELIJK, typeSupport = ExpressieType.GETAL)
final class GetalKleinerOfGelijkVergelijker implements Vergelijker<GetalLiteral, GetalLiteral> {
