 ...
 */
@Component
@VergelijkerConfig(operator = OperatorType.GROTER, typeSupport = ExpressieType.NULL)
public class NullGroterVergelijker implements Vergelijker<Expressie, Expressie> {
