...
/**
 * {@link OperatorType#GELIJK} vergelijker voor {@link ExpressieType#BOOLEAN} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GELIJK, typeSupport = ExpressieType.BOOLEAN)
