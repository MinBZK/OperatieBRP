...
/**
 * {@link OperatorType#ONGELIJK} vergelijker voor {@link ExpressieType#BOOLEAN} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.ONGELIJK, typeSupport = ExpressieType.BOOLEAN)
final class BooleanOngelijkVergelijker implements Vergelijker<BooleanLiteral, BooleanLiteral> {
