...
/**
 * {@link OperatorType#GROTER} vergelijker voor {@link ExpressieType#GETAL} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GROTER, typeSupport = ExpressieType.GETAL)
final class GetalGroterVergelijker implements Vergelijker<GetalLiteral, GetalLiteral> {
