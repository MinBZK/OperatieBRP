...
/**
 * {@link OperatorType#GROTER_OF_GELIJK} vergelijker voor {@link ExpressieType#LIJST} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GROTER_OF_GELIJK, typeSupport = ExpressieType.LIJST)
final class LijstGroterOfGelijkVergelijker implements Vergelijker<LijstExpressie, LijstExpressie> {
