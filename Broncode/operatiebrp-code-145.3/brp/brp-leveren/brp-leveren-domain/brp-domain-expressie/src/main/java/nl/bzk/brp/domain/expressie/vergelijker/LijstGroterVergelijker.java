...
/**
 * {@link OperatorType#GROTER} vergelijker voor {@link ExpressieType#LIJST} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GROTER, typeSupport = ExpressieType.LIJST)
final class LijstGroterVergelijker implements Vergelijker<LijstExpressie, LijstExpressie> {
