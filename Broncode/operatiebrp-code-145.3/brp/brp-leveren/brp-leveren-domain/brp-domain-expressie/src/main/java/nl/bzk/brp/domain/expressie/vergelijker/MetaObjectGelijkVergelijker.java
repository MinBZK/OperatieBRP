...
/**
 * {@link OperatorType#GELIJK} vergelijker voor {@link ExpressieType#BRP_METAOBJECT} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.GELIJK, typeSupport = ExpressieType.BRP_METAOBJECT)
final class MetaObjectGelijkVergelijker implements Vergelijker<MetaObjectLiteral, MetaObjectLiteral> {
