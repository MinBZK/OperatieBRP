...
/**
 * {@link OperatorType#KLEINER} vergelijker voor {@link ExpressieType#LIJST} expressies.
 */
@Component
@VergelijkerConfig(operator = OperatorType.KLEINER, typeSupport = ExpressieType.LIJST)
final class LijstKleinerVergelijker implements Vergelijker<LijstExpressie, LijstExpressie> {
