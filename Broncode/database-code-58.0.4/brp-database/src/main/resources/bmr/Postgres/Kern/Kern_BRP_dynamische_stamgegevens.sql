...
-- Stamgegeven: Plaats
--------------------------------------------------------------------------------
-- Bron voor plaatsen: 9999WPL08042017-000001.xml
-- Datum/tijd genereren vulling: Mon Apr 10 19:41:57 CEST 2017
...
INSERT INTO Kern.Partij(Code, Naam, DatIngang, DatEinde, IndVerstrBeperkingMogelijk, IndAG, DatIngangVrijBer, IndAGVrijBer) VALUES
   ...
   ('250002', 'DigiD', 20070205, NULL, false, true, null, false),
   ...
   ('253101', 'Gemeenschappelijke regeling Hefpunt', 19980801, NULL, false, true, 19980801, true),
   ...
   ('254401', 'Belastingsamenwerking SaBeWa Samenwerking Belastingen en Waardebepaling Zeeland', 20131001, NULL, false, true, 20131001, true),
   ...
   ('300020', 'Verstrekkingsvoorziening (1)', 20051001, NULL, false, true, 20051001, true),
   ('300021', 'Verstrekkingsvoorziening (2)', 20060401, NULL, false, true, 20060401, true),
   ('300022', 'Verstrekkingsvoorziening (3)', 20060401, NULL, false, true, 20060401, true),
   ('300023', 'Verstrekkingsvoorziening (4)', 20060401, NULL, false, true, 20060401, true),
   ('300024', 'Stichting Vaarbewijs- en Marifoonexamens (VAMEX)', 20091101, NULL, false, true, null, false),
   ('300025', 'Verstrekkingsvoorziening afnemers (5)', 20120101, NULL, false, true, 20120101, true),
   ('300027', 'Verstrekkingsvoorziening RNI (6)', 20140106, NULL, false, true, 20140106, true),
   ...
   ('602201', 'MvVWS/Dienst Donorregister', 19980201, NULL, false, true, 19980201, true),
   ...
   ('700104', 'MvVenJ/Centraal Justitieel Incassobureau', 19950201, NULL, false, true, 19950201, true),
   ...
   ('700110', 'MvVenJ/Centraal Justitieel Incassobureau (2)', 20141001, NULL, false, true, null, false),
   ...
   ('701301', 'MvVenJ/Dienst Justis/BIBOB', 20131101, NULL, false, true, null, false),
   ...
   ('816001', 'ABN-AMRO Levensverzekering N.V.', 20080901, NULL, false, true, 20080901, true),
   ...
   ('817601', 'Legal & General Nederland', 20110901, NULL, false, true, 20110901, true),
   ...
   ('852102', 'SVB/VVA/AOW-ANW', 19920515, NULL, false, true, 19920515, true),
   ...
   ('853101', 'Inspectie SZW/Directie Opsporing', 20050901, NULL, false, true, null, false),
   ...
   ('601201', 'Rijksinstituut voor Volksgezondheid en Milieu (RIVM)/Onderzoek & crisissituaties', 20151201, NULL, false, true, null, false),
   ...
   ('700111', 'MvVenJ/Centraal Justitieel Incassobureau (3)', 20160401, NULL, false, true, null, false),
...
UPDATE Kern.Partij SET IndVerstrBeperkingMogelijk = True WHERE Code IN ('850001');

-- His_Partij opnemen
INSERT INTO Kern.His_Partij (Partij, TsReg, Naam, DatIngang, DatEinde, IndVerstrBeperkingMogelijk)
   SELECT ID, Now(), Naam, DatIngang, DatEinde, IndVerstrBeperkingMogelijk
   FROM Kern.Partij;
...
--------------------------------------------------------------------------------
-- Stamgegeven: Soort Actie \ Brongebruik
--------------------------------------------------------------------------------
INSERT INTO Kern.SrtActieBrongebruik (SrtActie, SrtAdmHnd, SrtDoc) VALUES
-- * Actie RegistratieAanvangHuwelijk
-- AH VoltrekkingHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Consulaire akte van een rechtsfeit in Nederland')),

-- AH VoltrekkingHuwelijkInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring onder eed of belofte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH GBA - Voltrekking huwelijk in Nederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Consulaire akte van een rechtsfeit in Nederland')),

-- * Actie RegistratieGeregistreerdPartnerschap
-- AH AangaanGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
-- AH AangaanGeregistreerdPartnerschapInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring onder eed of belofte')),
-- AH GBA - Aangaan geregistreerd partnerschap in Nederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie aanvang geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Aangaan geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),

-- * Actie RegistratieEindeHuwelijk
-- AH OntbindingHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overlijdensakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van echtscheiding')),
-- AH OntbindingHuwelijkInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring onder eed of belofte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH NietigverklaringHuwelijkinNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
-- AH GBA - Ontbinding huwelijk in Nederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overlijdensakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde huwelijk'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van echtscheiding')),

-- * Actie RegistratieEindeGeregistreerdPartnerschap
-- AH BeëindigingGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overlijdensakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van beëindiging partnerschapsregistratie')),
-- AH BeëindigingGeregistreerdPartnerschapInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van beëindiging partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring onder eed of belofte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OmzettingGeregistreerdPartnerschapInHuwelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Omzetting geregistreerd partnerschap in huwelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
-- AH NietigverklaringGeregistreerdPartnerschapinNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van beëindiging partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
-- AH GBA - BeëindigingGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overlijdensakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van beëindiging partnerschapsregistratie')),
-- AH GBA - OmzettingGeregistreerdPartnerschapInHuwelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie einde geregistreerd partnerschap'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Omzetting geregistreerd partnerschap in huwelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),

-- * Actie RegistratieNaamgebruik
-- AH VoltrekkingHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
-- AH AangaanGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
-- AH VoltrekkingHuwelijkInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Aangaan GeregistreerdPartnerschapInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OntbindingHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
-- AH OntbindingGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
-- AH OntbindingHuwelijkInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OntbindingGeregistreerdPartnerschapInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OmzettingGeregistreerdPartnerschapInHuwelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Omzetting geregistreerd partnerschap in huwelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
-- AH NietigverklaringHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),
-- AH NietigverklaringGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie naamgebruik'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verklaring of kennisgeving naamgebruik')),

-- * Actie RegistratieGeslachtsnaam
-- AH VoltrekkingHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Consulaire akte van een rechtsfeit in Nederland')),
-- AH AangaanGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
-- AH VoltrekkingHuwelijkInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Voltrekking huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Aangaan GeregistreerdPartnerschapInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Aangaan geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OntbindingHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van echtscheiding')),
-- AH OntbindingGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van beëindiging partnerschapsregistratie')),
-- AH OntbindingHuwelijkInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Ontbinding huwelijk in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OntbindingGeregistreerdPartnerschapInBuitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van beëindiging partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse rechterlijke uitspraak')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Beëindiging geregistreerd partnerschap in buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH OmzettingGeregistreerdPartnerschapInHuwelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Omzetting geregistreerd partnerschap in huwelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
-- AH NietigverklaringHuwelijkInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Huwelijksakte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring huwelijk in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
-- AH NietigverklaringGeregistreerdPartnerschapInNederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van partnerschapsregistratie')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Nietigverklaring geregistreerd partnerschap in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Nederlandse rechterlijke uitspraak')),
   
-- * Actie Registratie adres
-- AH Verhuizing binnengemeentelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie adres'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing binnengemeentelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Verhuizing intergemeentelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie adres'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing intergemeentelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH GBA - Verhuizing intergemeentelijk GBA naar BRP
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie adres'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Verhuizing intergemeentelijk GBA naar BRP'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Wijziging adres infrastructureel
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie adres'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging adres infrastructureel'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),

-- * Actie Registratie migratie
-- AH Verhuizing naar buitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie migratie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   
-- * Actie Registratie verstrekkingsbeperking
-- AH Verhuizing binnengemeentelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing binnengemeentelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing binnengemeentelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Verhuizing intergemeentelijk
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing intergemeentelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing intergemeentelijk'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Verhuizing intergemeentelijk GBA naar BRP
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Verhuizing intergemeentelijk GBA naar BRP'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'GBA - Verhuizing intergemeentelijk GBA naar BRP'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Verhuizing naar buitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   
-- * Actie Registratie verblijfsrecht
-- AH Wijziging verblijfsrecht
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verblijfsrecht'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging verblijfsrecht'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Mededeling Minister inzake verblijfsrecht')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verblijfsrecht'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging verblijfsrecht'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),   

-- * Actie Registratie bijzondere verblijfsrechtelijke positie
-- AH Wijziging bijzondere verblijfsrechtelijke positie
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Mededeling bijzondere verblijfsrechtelijke positie')),
-- AH Verhuizing naar buitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Mededeling bijzondere verblijfsrechtelijke positie')),

-- * Actie Beëindiging bijzondere verblijfsrechtelijke positie
-- AH Wijziging bijzondere verblijfsrechtelijke positie
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Beëindiging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Beëindiging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Wijziging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Mededeling bijzondere verblijfsrechtelijke positie')),
-- AH Verhuizing naar buitenland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Beëindiging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Beëindiging bijzondere verblijfsrechtelijke positie'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Verhuizing naar buitenland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Mededeling bijzondere verblijfsrechtelijke positie')),

-- *** Afstamming

-- * Actie Beëindiging nationaliteit
-- AH Erkenning
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Beëindiging nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
   
-- * Registratie geborene
-- AH Geboorte in Nederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geborene'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Geboorteakte')),
-- AH Geboorte in Nederland met erkenning na geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geborene'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning na geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Geboorteakte')),   
-- Geboorte in Nederland met erkenning op geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geborene'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning op geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Geboorteakte')),   
   
-- * Registratie geslachtsnaam/voornaam
-- AH Erkenning
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam/voornaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van erkenning')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam/voornaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Notariële akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam/voornaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam/voornaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam/voornaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Geboorte in Nederland met erkenning na geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie geslachtsnaam/voornaam'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning na geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Geboorteakte')),

-- * Registratie nationaliteit
-- AH Erkenning
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Beschikking/uitspraak vreemde nationaliteit')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Geschrift vreemde nationaliteit')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Geboorte in Nederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Geboorte in Nederland met erkenning na geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning na geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Geboorte in Nederland met erkenning op geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie nationaliteit'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning op geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),

-- * Registratie ouder
-- AH Erkenning
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie ouder'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Akte van erkenning')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie ouder'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Notariële akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie ouder'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlandse akte')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie ouder'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Buitenlands geschrift')),
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie ouder'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Erkenning'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Overig')),
-- AH Geboorte in Nederland met erkenning na geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie ouder'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning na geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Geboorteakte')),
   
-- * Registratie verstrekkingsbeperking
-- AH Geboorte in Nederland
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking')),
-- AH Geboorte in Nederland met erkenning na geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning na geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking')),   
-- AH Geboorte in Nederland met erkenning op geboortedatum
   ((SELECT ID FROM Kern.SrtActie WHERE Naam = 'Registratie verstrekkingsbeperking'), (SELECT ID FROM Kern.SrtAdmHnd WHERE Naam = 'Geboorte in Nederland met erkenning op geboortedatum'), (SELECT ID FROM Kern.SrtDoc WHERE Naam = 'Verzoek verstrekkingsbeperking'))
;
